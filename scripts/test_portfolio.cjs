...
(async () => {
  ...
  await page.locator('[data-world-step="1"]').click();
  ...
  console.log('PASS: filters, technology search/icons, artwork switch, personal collection controls, touch swipe, showcase tabs/arrows/source links, URL state, keyboard controls, mobile menu, theme/motion/Gear 5/layout persistence, 25 case routes, eight widths in both themes/layouts, no-JS fallback, and reduced motion.');
  await browser.close();
