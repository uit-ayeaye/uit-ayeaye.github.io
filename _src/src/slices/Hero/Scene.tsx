...
export default function Scene({}: Props) {
  ...
  return (
    <group ref={groupRef}>
      ...
      <FloatingCan ref={can3Ref} flavor="nami" floatSpeed={FLOAT_SPEED} />
      ...
      <FloatingCan ref={can5Ref} flavor="chopper" floatSpeed={FLOAT_SPEED} />

      {/* <OrbitControls /> */}
      <Environment files={asset("/hdr/lobby.hdr")} environmentIntensity={1.5} />
    </group>
  );
}
