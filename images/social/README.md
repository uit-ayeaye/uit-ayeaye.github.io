...
## Creative Builder update — September 21, 2026

`thomas-captains-studio-v4.jpg` is the current 1200 × 630 cover. The built-in image tool edited v3 with the instruction to change only the subtitle to “Software Engineer & Creative Builder”, preserving the captain, sea chart, colors, and composition. The generated image was resized and encoded with macOS sips. The versioned URL refreshes the shared cover without overwriting v3.
