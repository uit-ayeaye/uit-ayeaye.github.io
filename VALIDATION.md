...
## September 19 — expanded project log release

- Static verification: 37 generated pages; all local links/assets/anchors, one main heading on generated case pages, source credits, résumé template/PDF freshness, and SOM privacy boundaries pass.
- Browser: all 33 project cards opened the correct overview, preview image and case-study destination. A rapid open/close focus race was found and corrected; the complete sequence then passed.
- Browser: all 33 case-study pages loaded at 390px with no horizontal overflow. Six playable world routes, gallery, résumé and both articles loaded; shared voyage navigation remained present on standalone pages.
- Responsive project dialog and résumé: 320, 390, 650, 768, 1024, 1440 and 2560px; dialogs remain within viewport, no horizontal content overflow; résumé body remains 14px.
- Hero: captain, ship and wanted modes at all seven widths; exactly one visible artwork in every state. Wanted mode hides floating links to protect printed text.
- Keyboard: 18 consecutive Tab steps remain in the project dialog; Escape restores focus to the opening card. Story disclosure, source links, image inspection, and Campus One gallery switches verified.
- Search and collection expansion verified with new entries. Light-theme popup close contrast corrected and verified.
