var Kr=Object.defineProperty;var Qr=(e,o,n)=>o in e?Kr(e,o,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[o]=n;var ka=(e,o,n)=>Qr(e,typeof o!="symbol"?o+"":o,n);import{r as w,u as ae,j as t,d as Zs,f as xe,h as Xr,i as Zr}from"./vendor-C2HIMx-P.js";import{t as ze,c as z,aD as On,au as aa,d as sa,a5 as _e,aJ as qr,f as Jr,Y as ja,a0 as Sa,ag as R,h as ee,aK as ei,ay as ti,az as po,aA as fo,aq as qs,R as oi,M as ut,o as Mt,at as $t,ax as nt,aL as Qt,aM as mo,a4 as ni,a8 as Pt,ar as Xt,av as Js,aI as ai,aC as si,aw as ri,A as ii}from"./three-Zo_RlN_K.js";import{f as lo,m as Ao,w as $e,a as Jt,e as Ft,P as li,G as ci,S as hi,I as di}from"./index-C49fRdfL.js";const X={skyHigh:"#140f2b",skyLow:"#3a2a5c",cloud:"#2a2244",cloudLit:"#6b3f5e",seaDeep:"#080d1c",seaShallow:"#16294a",foam:"#c8d6e8",rock:"#2b2f3f",rockLit:"#4c5468",snow:"#aebdd4",pine:"#16202c",bolt:"#e9a8ff",boltGlow:"#a855f7",haze:"#1d1936",abyss:"#03121f",underGlow:"#7cbfe4",underHaze:"#0b2b40"},A={furnace:"#fff1c4",ember:"#ff9c2e",emberDeep:"#c9411a",lantern:"#ff7a3c",lanternFar:"#ffb066",vermilion:"#d63420",vermilionDeep:"#7e1c14",rockWarm:"#6d3a2c",gilt:"#e8a33d",sakura:"#f2a8c4",timber:"#6b4b34"},en={dir:[.72,.52,-.44],col:"#f2e9cf"},Bt={sea:.00105,bay:48e-5,deepGrade:210},ui=1.15;function ie(e){const o=new ze(e);return[o.r,o.g,o.b]}const pi=`
  varying vec3 vDir;
  void main() {
    vDir = position;
...
`,os={low:120,mid:340,high:700};function Xl({quality:e}){const o=w.useRef(),n=w.useMemo(()=>{const s=os[e]??os.high,i=[Pe[0],Pe[1],de,de],c=new Float32Array(s*3),h=new Float32Array(s),l=new Float32Array(s),u=new Float32Array(s);for(let m=0;m<s;m++){const g=i[m%i.length];c[m*3]=g.x+(Math.random()-.5)*74,c[m*3+1]=g.y+(Math.random()-.5)*30,c[m*3+2]=g.z+(Math.random()-.5)*26,h[m]=Math.random(),l[m]=.045+Math.random()*.055,u[m]=2+Math.random()*4}const b=new Pt;return b.setAttribute("position",new ee(c,3)),b.setAttribute("aPhase",new ee(h,1)),b.setAttribute("aRise",new ee(l,1)),b.setAttribute("aSize",new ee(u,1)),b.boundingSphere=new Xt(new z(0,300,-260),700),b},[e]),a=w.useMemo(()=>({uTime:{value:0},uColor:{value:new z(...ie(A.ember))}}),[]);return ae((s,i)=>{o.current&&(o.current.uniforms.uTime.value+=i)}),t.jsx("points",{geometry:n,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:Kl,fragmentShader:Ql,uniforms:a,transparent:!0,depthWrite:!1,blending:nt,fog:!1})})}function Zl({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(Wl,{quality:e}),t.jsx($l,{quality:e}),t.jsx(Xl,{quality:e})]})}const ql=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
...
`,ns={low:150,mid:380,high:620};function ec({whirl:e,quality:o}){const n=w.useRef(),a=w.useRef(),s=w.useMemo(()=>{const c=ns[o]??ns.high,h=new Float32Array(c*3),l=new Float32Array(c),u=new Float32Array(c),b=new Float32Array(c),m=new Float32Array(c),g=new Float32Array(c);for(let f=0;f<c;f++)l[f]=Math.random()*Math.PI*2,u[f]=Math.random(),b[f]=.05+Math.random()*.05,m[f]=3+Math.random()*6,g[f]=Math.random();const x=new Pt;return x.setAttribute("position",new ee(h,3)),x.setAttribute("aAngle",new ee(l,1)),x.setAttribute("aPhase",new ee(u,1)),x.setAttribute("aRate",new ee(b,1)),x.setAttribute("aSize",new ee(m,1)),x.setAttribute("aJitter",new ee(g,1)),x.boundingSphere=new Xt(new z(e.x,0,e.z),e.r*1.6+40),x},[o,e]),i=w.useMemo(()=>({uTime:{value:0},uCentre:{value:new sa(e.x,e.z)},uR:{value:e.r},uDepth:{value:e.depth},uDir:{value:e.dir},uColor:{value:new z(...ie(X.foam))},uGain:{value:1}}),[e]);return ae((c,h)=>{const l=n.current?.uniforms;if(!l)return;l.uTime.value+=h;const u=Math.hypot(c.camera.position.x-e.x,c.camera.position.z-e.z);l.uGain.value=1-R.smoothstep(u,1600,2400),a.current&&(a.current.visible=l.uGain.value>.02)}),t.jsx("points",{ref:a,geometry:s,renderOrder:2,children:t.jsx("shaderMaterial",{ref:n,vertexShader:ql,fragmentShader:Jl,uniforms:i,transparent:!0,depthWrite:!1,blending:nt,fog:!1})})}function tc({quality:e="high"}){const o=xe(n=>n.camera);return ae(()=>{let n=0;for(const a of Ue){const s=Math.hypot(o.position.x-a.x,o.position.z-a.z);n=Math.max(n,1-R.smoothstep(s,a.r*.3,a.r*2.2))}y.whirlNear+=(n-y.whirlNear)*.05}),t.jsx(t.Fragment,{children:Ue.map((n,a)=>t.jsx(ec,{whirl:n,quality:e},a))})}const V={rev:0,chain:null,step:0,hull:1,grip:0,clock:0,banner:null,done:!1,hits:0},uo={helm:[{text:"PASS THE OUTER GATE",hint:"The island’s marker, alone in open water. Straight through it.",test:e=>e.z<co-60},{text:"HOLD THE FAIRWAY",hint:"Whirlpools both flanks — the middle is the only clean water.",test:e=>e.toGate<420*H},{text:"RUN THE TORII",hint:"Between the columns — the batteries cannot depress that far.",test:e=>e.z<Ut-40},{text:"THREAD THE NECK",hint:"The walls close to a hundred metres. Mind your helm.",test:e=>e.z<120*H},{text:"MOOR AT THE PORT",hint:"Under the burning face. Come in slow.",test:e=>e.moored}],sub:[{text:"FORM UP WITH THE CAPTAINS",hint:"Surface between the Thousand Sunny and the Victoria Punk.",test:e=>{if(e.depth>12)return!1;const o=Va("straw-hats"),n=Va("kid");if(!o||!n)return!0;const a=(o.x+n.x)/2,s=(o.z+n.z)/2,i=Math.hypot(o.x-n.x,o.z-n.z);return Math.hypot(e.x-a,e.z-s)<Math.max(160,i*.75)}},{text:"TAKE HER DOWN",hint:"Below thirty-five metres the maelstroms cannot reach you.",test:e=>e.depth>35},{text:"RUN UNDER THE BACK-DOOR MAELSTROM",hint:"Straight through where the surface is turning. Stay deep.",test:e=>{const o=bi("back-door");return Math.hypot(e.x-o.x,e.z-o.z)<o.r*1.1&&e.depth>30}},{text:"FIND THE FJORD",hint:"North-east flank, a crack in the cliffs. It is not on any chart.",test:e=>e.toRear<420},{text:"SURFACE IN THE COVE",hint:"Blow ballast. The back door is above you.",test:e=>e.toRear<Y.pool*1.3&&e.depth<3}],foot:[{text:"GET INSIDE THE SKULL",hint:"The mouth above the port, or the gate at the back of the cove.",test:e=>e.area==="hall"},{text:"CROSS THE LIVE FLOOR",hint:"The stage is at the far end, under the keep.",test:e=>e.area==="hall"&&e.lz!=null&&e.lz<40},{text:"CLIMB TO THE STAGE",hint:"The vermilion ramps either side of the approach.",test:e=>e.fy!=null&&e.fy>60},{text:"TAKE THE ROOF",hint:"The stair tower on the east flank goes all the way up.",test:e=>e.fy!=null&&e.fy>230}]},oc=e=>uo[e]?uo[e].length:0,nc=()=>V.chain&&uo[V.chain]?uo[V.chain][V.step]??null:null;function Vn(e){V.chain=uo[e]?e:null,V.step=0,V.hull=1,V.grip=0,V.clock=0,V.done=!1,V.banner=null,V.rev++}function pn(e,o,n=3.4){V.banner={text:e,sub:o,until:V.clock+n},V.rev++}function Kt(e,o){V.hull<=0||(V.hull=Math.max(0,V.hull-e),V.hits++,V.hull<=0?pn("HULL BREACHED","She is going down — the raid goes on without you",5):o&&e>.04&&pn(o,null,2.2),V.rev++)}function zr(e,o){if(V.clock+=e,V.banner&&V.clock>V.banner.until&&(V.banner=null,V.rev++),!V.chain||V.done||!o)return;const n=uo[V.chain],a=n[V.step];if(!a)return;let s=!1;try{s=!!a.test(o)}catch{s=!1}s&&(V.step++,V.step>=n.length?(V.done=!0,pn("OBJECTIVE COMPLETE",ac[V.chain]??"",6)):pn(n[V.step].text,n[V.step].hint,3.6),V.rev++)}const ac={helm:"Moored under the face. The alliance is ashore.",sub:"Surfaced at the back door, unseen. Law would approve.",foot:"The roof of the demon castle. The whole bay is below you."};function Tr(e,{danger:o,headingX:n,headingZ:a,toCentreX:s,toCentreZ:i,speed:c,throttle:h}){if(o<=.001)return V.grip=Math.max(0,V.grip-e*.5),V.grip;const l=Math.hypot(s,i)||1,u=-s/l,b=-i/l,m=n*u+a*b,g=Math.min(1,Math.abs(c)/22),x=o*.42,f=Math.max(0,m)*g*(.35+.45*Math.min(1,Math.abs(h)));return V.grip=Math.max(0,Math.min(1,V.grip+(x-f)*e)),V.grip}const as=24,En=on.safe,ss=on.range,yo=2.1,sc=1.5,rs=22,rc=[Ut,co],ic=new ut,Rn=new z,is=new Mt,An=new z;function lc({quality:e="high"}){const o=w.useRef(),n=w.useMemo(()=>Array.from({length:as},()=>({live:!1,x:0,z:0,y0:0,t:0})),[]),a=w.useRef(0),s=w.useMemo(()=>{const i=new Js(.55,1,1,e==="low"?6:10,1,!0);return i.translate(0,.5,0),i},[e]);return ae((i,c)=>{const h=o.current;if(!h)return;const l=Math.min(c,.05),u=y.helm;if(y.helmActive&&u&&!u.onFoot&&!u.sub&&!u.moored){let g=null,x=1/0;for(const f of rc){const p=Math.hypot(u.x,u.z-f);p<En||p>ss||p<x&&(x=p,g=f)}if(g!==null&&(a.current-=l,a.current<=0)){const f=1-R.clamp((x-En)/(ss-En),0,1);a.current=R.lerp(4.5,1.9,f);const p=n.find(d=>!d.live);if(p){const d=yo*.55,v=R.lerp(230,105,f);p.x=u.x+Math.sin(u.heading)*u.speed*d+(Math.random()-.5)*v,p.z=u.z+Math.cos(u.heading)*u.speed*d+(Math.random()-.5)*v,p.y0=210+Math.random()*60,p.t=0,p.live=!0}}}let m=0;for(const g of n){if(!g.live)continue;const x=g.t;if(g.t+=l,g.t<yo){const f=g.t/yo;Rn.set(g.x,g.y0*(1-f*f),g.z),An.set(2.2,9,2.2)}else{if(x<yo){const d=Math.hypot(g.x-u.x,g.z-u.z);d<rs&&Kt(.03*(1-d/rs)+.008,"HIT — SHOT THROUGH THE RIGGING"),y.splash+=1}const f=(g.t-yo)/sc;if(f>=1){g.live=!1;continue}const p=Math.min(1,f*4);Rn.set(g.x,dt(g.x,g.z,y.t,1).y-4,g.z),An.set(11+f*9,78*p*(1-f*f*.75),11+f*9)}is.identity(),h.setMatrixAt(m,ic.compose(Rn,is,An)),m++}h.count=m,h.instanceMatrix.needsUpdate=!0,h.visible=m>0}),t.jsx("instancedMesh",{ref:o,args:[s,void 0,as],frustumCulled:!1,renderOrder:2,visible:!1,children:t.jsx("meshBasicMaterial",{color:X.foam,transparent:!0,opacity:.42,depthWrite:!1,toneMapped:!1,blending:nt,side:_e})})}const cc=`
  uniform float uTime;
  uniform vec3  uCam;
  uniform float uBox;
  attribute float aSpeed;
...
`,ls={low:700,mid:1800,high:3200},Do=260;function dc({quality:e}){const o=w.useRef(),n=w.useRef(),a=xe(c=>c.camera),s=w.useMemo(()=>{const c=ls[e]??ls.high,h=new Float32Array(c*3),l=new Float32Array(c),u=new Float32Array(c),b=new Float32Array(c);for(let g=0;g<c;g++)h[g*3]=Math.random()*Do,h[g*3+1]=Math.random()*Do,h[g*3+2]=Math.random()*Do,l[g]=.5+Math.random()*1.4,u[g]=1.2+Math.random()*3.2,b[g]=Math.random();const m=new Pt;return m.setAttribute("position",new ee(h,3)),m.setAttribute("aSpeed",new ee(l,1)),m.setAttribute("aSize",new ee(u,1)),m.setAttribute("aPhase",new ee(b,1)),m.boundingSphere=new Xt(new z,1e6),m},[e]),i=w.useMemo(()=>({uTime:{value:0},uCam:{value:new z},uBox:{value:Do},uColor:{value:new z(...ie("#cfeee6"))},uGain:{value:0}}),[]);return ae((c,h)=>{const l=o.current?.uniforms;l&&(l.uTime.value+=h,l.uCam.value.copy(a.position),l.uGain.value=y.underwater,n.current&&(n.current.visible=y.underwater>.02))}),t.jsx("points",{ref:n,geometry:s,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:o,vertexShader:cc,fragmentShader:hc,uniforms:i,transparent:!0,depthWrite:!1,fog:!1})})}const uc=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
  uniform float uDir;
...
`,hs=1100,ds={low:[4,9],mid:[6,13],high:[8,18]};function gc({whirl:e,quality:o="high"}){const n=w.useRef(),a=w.useRef(),s=xe(h=>h.camera),i=w.useMemo(()=>{const h=o==="low"?24:o==="mid"?34:48,l=new Js(e.r*1.02,e.r*.07,hs,h,6,!0);return l.translate(e.x,-hs/2-3,e.z),l.computeBoundingSphere(),l},[e,o]),c=w.useMemo(()=>({uTime:{value:0},uDir:{value:e.dir},uGain:{value:0},uColor:{value:new z(...ie(X.foam))},uDeep:{value:new z(...ie(X.underGlow))},uCameraPos:{value:new z},uFogDensity:{value:.0062},uFogColor:{value:new z(...ie(X.underHaze))}}),[e]);return ae((h,l)=>{const u=n.current?.uniforms;if(!u)return;u.uTime.value+=l,u.uCameraPos.value.copy(h.camera.position),u.uFogDensity.value=h.scene.fog?.density??.0062;const b=h.scene.fog?.color;b&&u.uFogColor.value.set(b.r,b.g,b.b);const m=Math.hypot(s.position.x-e.x,s.position.z-e.z),[g,x]=ds[o]??ds.high,f=1-R.smoothstep(m,e.r*g,e.r*x);u.uGain.value+=(y.underwater*f-u.uGain.value)*Math.min(1,l*4),a.current&&(a.current.visible=u.uGain.value>.012)}),t.jsx("mesh",{ref:a,geometry:i,renderOrder:2,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:fc,fragmentShader:mc,uniforms:c,transparent:!0,depthWrite:!1,side:_e,blending:nt,fog:!1})})}function xc({whirl:e,quality:o}){const n=w.useRef(),a=w.useRef(),s=xe(h=>h.camera),i=w.useMemo(()=>{const h=cs[o]??cs.high,l=new Float32Array(h*3),u=new Float32Array(h),b=new Float32Array(h),m=new Float32Array(h),g=new Float32Array(h),x=new Float32Array(h);for(let p=0;p<h;p++)u[p]=Math.random()*Math.PI*2,b[p]=Math.random(),m[p]=.07+Math.random()*.1,g[p]=.12+Math.pow(Math.random(),1.8)*.5,x[p]=2+Math.random()*5;const f=new Pt;return f.setAttribute("position",new ee(l,3)),f.setAttribute("aAngle",new ee(u,1)),f.setAttribute("aPhase",new ee(b,1)),f.setAttribute("aRate",new ee(m,1)),f.setAttribute("aRadius",new ee(g,1)),f.setAttribute("aSize",new ee(x,1)),f.boundingSphere=new Xt(new z(e.x,-180,e.z),e.r+260),f},[o,e]),c=w.useMemo(()=>({uTime:{value:0},uCentre:{value:new sa(e.x,e.z)},uR:{value:e.r},uDir:{value:e.dir},uDepth:{value:340},uColor:{value:new z(...ie(X.underGlow))},uGain:{value:0}}),[e]);return ae((h,l)=>{const u=n.current?.uniforms;if(!u)return;u.uTime.value+=l;const b=Math.hypot(s.position.x-e.x,s.position.z-e.z),m=1-R.smoothstep(b,e.r*1.2,e.r*4);u.uGain.value=y.underwater*m,a.current&&(a.current.visible=u.uGain.value>.015)}),t.jsx("points",{ref:a,geometry:i,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:uc,fragmentShader:pc,uniforms:c,transparent:!0,depthWrite:!1,blending:nt,fog:!1})})}function Er(e){if(typeof document>"u")return null;const o=document.createElement("canvas");o.width=o.height=128;const n=o.getContext("2d");n.fillStyle="#fff",e(n);const a=new Qt(o);return a.needsUpdate=!0,a}const us=Er(e=>{e.beginPath(),e.moveTo(64,16),e.bezierCurveTo(92,22,122,58,116,78),e.bezierCurveTo(104,74,84,62,70,60),e.lineTo(68,120),e.lineTo(60,120),e.lineTo(58,60),e.bezierCurveTo(44,62,24,74,12,78),e.bezierCurveTo(6,58,36,22,64,16),e.closePath(),e.fill()}),bc=Er(e=>{const o=e.createRadialGradient(64,44,4,64,52,46);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.55,"rgba(255,255,255,0.55)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.beginPath(),e.ellipse(64,46,34,28,0,Math.PI,0),e.bezierCurveTo(96,62,84,70,64,68),e.bezierCurveTo(44,70,32,62,30,46),e.closePath(),e.fill(),e.strokeStyle="rgba(255,255,255,0.5)",e.lineCap="round";for(let n=0;n<7;n++){const a=38+n*9;e.lineWidth=3.2-Math.abs(n-3)*.5,e.beginPath(),e.moveTo(a,64),e.quadraticCurveTo(a+(n%2?7:-7),92,a+(n%2?-4:4),120),e.stroke()}}),ps={low:0,mid:5,high:11},rt=420;function wc({quality:e="high"}){const o=w.useRef(),n=xe(h=>h.camera),a=ps[e]??ps.high,s=w.useMemo(()=>Array.from({length:a},(h,l)=>{const u=l%3===2;return{jelly:u,home:[l*97.13%1*rt,l*41.77%1*rt,l*63.31%1*rt],r:u?8+l*29.7%1*18:46+l*29.7%1*90,rate:u?.02+l*17.3%1*.03:.045+l*17.3%1*.055,phase:l*53.9%1*Math.PI*2,size:u?9+l*71.1%1*13:22+l*71.1%1*26}}),[a]),i=w.useRef([]),c=(h,l)=>(h%l+l)%l;return ae((h,l)=>{const u=o.current;if(!u)return;const b=1-R.smoothstep(y.depthBelow,120,330),m=R.smoothstep(y.depthBelow,90,260),g=y.underwater*Math.max(b,m);if(u.visible=g>.02,!u.visible)return;const x=y.t;for(let f=0;f<s.length;f++){const p=s[f],d=i.current[f];if(!d)continue;const v=p.phase+x*p.rate,j=p.home[0]+Math.cos(v)*p.r,S=p.home[1]+Math.sin(v*.7)*p.r*.18,k=p.home[2]+Math.sin(v)*p.r,E=n.position.x+c(j-n.position.x+rt/2,rt)-rt/2,r=n.position.y+c(S-n.position.y+rt/2,rt)-rt/2,T=n.position.z+c(k-n.position.z+rt/2,rt)-rt/2;d.position.set(E,r,T);const C=1+Math.sin(x*(.5+p.rate*4)+p.phase)*.16;d.scale.set(p.size*C,p.size,1);const P=Math.hypot(E-n.position.x,r-n.position.y,T-n.position.z),M=1-R.smoothstep(P,rt*.24,rt*.5),G=p.jelly?m:b;d.material.opacity=y.underwater*G*M*(p.jelly?.62:.5)}}),!a||!us?null:t.jsx("group",{ref:o,visible:!1,children:s.map((h,l)=>t.jsx("sprite",{ref:u=>i.current[l]=u,renderOrder:2,children:t.jsx("spriteMaterial",{map:h.jelly?bc:us,color:h.jelly?X.underGlow:X.abyss,transparent:!0,opacity:0,depthWrite:!1,blending:h.jelly?nt:ai,fog:!1})},l))})}function yc({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(dc,{quality:e}),t.jsx(kc,{quality:e}),t.jsx(wc,{quality:e}),Ue.map((o,n)=>t.jsx(xc,{whirl:o,quality:e},n)),Ue.map((o,n)=>t.jsx(gc,{whirl:o,quality:e},`w${n}`))]})}const Ho=260,fs={low:0,mid:90,high:220},vc=`
  uniform float uTime;
  uniform vec3 uCam;
  uniform float uBox;
  uniform float uGain;
...
`,Zh=`
  ...
  void main() {
    ...
    gl_FragColor = vec4(uColor, along * uGain);
  }
`;function qh({origin:e,loa:o}){const n=w.useRef(),a=w.useRef(),s=w.useMemo(()=>{const c=o*2.4,h=new ri(o*.3,c,20,1,!0);return h.rotateX(-Math.PI/2),h.translate(0,0,c/2),h},[o]),i=w.useMemo(()=>({uColor:{value:new z(...ie("#9ff0d8"))},uGain:{value:0}}),[]);return ae((c,h)=>{const l=a.current?.uniforms;if(!l)return;const u=.1+y.underwater*.62;l.uGain.value+=(u-l.uGain.value)*Math.min(1,h*3),n.current&&(n.current.visible=l.uGain.value>.02)}),t.jsx("mesh",{ref:n,geometry:s,position:e,renderOrder:3,children:t.jsx("shaderMaterial",{ref:a,vertexShader:Xh,fragmentShader:Zh,uniforms:i,transparent:!0,depthWrite:!1,side:_e,blending:nt,fog:!1})})}const Jh=`
  uniform float uTime;
  uniform float uGain;
  attribute float aPhase;
  attribute float aRate;
...
`;function t0(){const e=w.useRef(),o=w.useMemo(()=>{const s=new Float32Array(780),i=new Float32Array(260),c=new Float32Array(260),h=new Float32Array(260);for(let u=0;u<260;u++)s[u*3]=(Math.random()-.5)*3.4,s[u*3+1]=(Math.random()-.5)*2.6,s[u*3+2]=-14-Math.random()*4,i[u]=Math.random(),c[u]=.25+Math.random()*.3,h[u]=2+Math.random()*4;const l=new Pt;return l.setAttribute("position",new ee(s,3)),l.setAttribute("aPhase",new ee(i,1)),l.setAttribute("aRate",new ee(c,1)),l.setAttribute("aSize",new ee(h,1)),l.boundingSphere=new Xt(new z(0,0,-30),70),l},[]),n=w.useMemo(()=>({uTime:{value:0},uGain:{value:0},uColor:{value:new z(...ie(X.underGlow))}}),[]);return ae((a,s)=>{const i=e.current?.uniforms;if(!i)return;i.uTime.value+=s;const c=y.subActive?y.subThrottle*y.underwater:0;i.uGain.value+=(c-i.uGain.value)*.06}),t.jsx("points",{geometry:o,renderOrder:3,children:t.jsx("shaderMaterial",{ref:e,vertexShader:Jh,fragmentShader:e0,uniforms:n,transparent:!0,depthWrite:!1,blending:nt,fog:!1})})}const Ur=.42;let B=null,It=null,Se=null,na=!1,zt=!0;function o0(){try{const e=localStorage.getItem("oni.audio");e!==null&&(zt=e==="1")}catch{}return zt}function Cn(e){zt=e;try{localStorage.setItem("oni.audio",e?"1":"0")}catch{}return It&&B&&It.gain.setTargetAtTime(e?Ur:0,B.currentTime,.12),e&&B?.state==="suspended"&&B.resume(),zt}function n0(e){const o=e.sampleRate*2,n=e.createBuffer(1,o,e.sampleRate),a=n.getChannelData(0);for(let s=0;s<o;s++)a[s]=Math.random()*2-1;return n}function ko(e,o,n,a,s,i,c){const h=e.createBufferSource();h.buffer=o,h.loop=!0;const l=e.createBiquadFilter();l.type=n,l.frequency.value=a,l.Q.value=s;const u=e.createGain();return u.gain.value=i,h.connect(l).connect(u).connect(c),h.start(),{src:h,filt:l,gain:u}}function Pn(){if(na){B?.state==="suspended"&&B.resume();return}const e=window.AudioContext||window.webkitAudioContext;if(!e)return;B=new e,na=!0,It=B.createGain(),It.gain.value=zt?Ur:0;const o=B.createDynamicsCompressor();o.threshold.value=-18,o.knee.value=22,o.ratio.value=3.4,o.attack.value=.006,o.release.value=.26;const n=B.createBiquadFilter();n.type="lowpass",n.frequency.value=18e3,n.Q.value=.4,It.connect(n).connect(o).connect(B.destination);const a=n0(B),s=B.createGain();s.gain.value=1,s.connect(It);const i=ko(B,a,"bandpass",480,.7,.3,s),c=ko(B,a,"highpass",1900,.5,0,s),h=ko(B,a,"lowpass",220,1.1,.22,s),l=ko(B,a,"lowpass",96,1.6,0,s),u=B.createGain();u.gain.value=1,u.connect(o);const b=B.createOscillator();b.type="sawtooth",b.frequency.value=41;const m=B.createBiquadFilter();m.type="lowpass",m.frequency.value=190,m.Q.value=1.2;const g=B.createGain();g.gain.value=0,b.connect(m).connect(g).connect(u),b.start();const x=B.createOscillator(),f=B.createOscillator(),p=B.createGain();x.frequency.value=.07,f.frequency.value=.113,p.gain.value=260,x.connect(p),f.connect(p),p.connect(i.filt.frequency),x.start(),f.start();const d=B.createGain();d.gain.value=0,d.connect(It);const v=B.createGain();v.gain.value=.16,v.connect(d);for(const[S,k]of[[146.83,1],[220,.5],[293.66,.3]]){const E=B.createOscillator();E.type="sine",E.frequency.value=S;const r=B.createGain();r.gain.value=k;const T=B.createOscillator(),C=B.createGain();T.frequency.value=.21+Math.random()*.1,C.gain.value=S*.004,T.connect(C).connect(E.frequency),T.start(),E.connect(r).connect(v),E.start()}const j=ko(B,a,"bandpass",900,3.2,.05,d);return Se={stormBus:s,festBus:d,wind:i,rain:c,sea:h,roar:l,breath:j,buf:a,comp:o,muffle:n,humGain:g,subBus:u},B}function a0(){if(!B||!Se||!zt)return;const e=B.currentTime;for(const[o,n]of[[0,.16],[.9,.045]]){const a=B.createOscillator(),s=B.createGain();a.type="sine",a.frequency.setValueAtTime(1420,e+o),a.frequency.exponentialRampToValueAtTime(1180,e+o+.5),s.gain.setValueAtTime(0,e+o),s.gain.linearRampToValueAtTime(n,e+o+.012),s.gain.exponentialRampToValueAtTime(1e-4,e+o+1.4),a.connect(s).connect(Se.subBus),a.start(e+o),a.stop(e+o+1.5)}}function s0(e=1){if(!B||!Se||!zt)return;const o=B.currentTime,n=B.createBufferSource();n.buffer=Se.buf;const a=B.createBiquadFilter();a.type="bandpass",a.frequency.setValueAtTime(1500,o),a.frequency.exponentialRampToValueAtTime(240,o+.5),a.Q.value=.7;const s=B.createGain();s.gain.setValueAtTime(0,o),s.gain.linearRampToValueAtTime(.5*e,o+.02),s.gain.exponentialRampToValueAtTime(1e-4,o+.8),n.connect(a).connect(s).connect(It),n.start(o),n.stop(o+.9)}function ao(e,o=1,n=82){if(!B||!Se)return;const a=B.createOscillator(),s=B.createGain();a.type="sine",a.frequency.setValueAtTime(n*2.1,e),a.frequency.exponentialRampToValueAtTime(n,e+.06),a.frequency.exponentialRampToValueAtTime(n*.7,e+.5),s.gain.setValueAtTime(0,e),s.gain.linearRampToValueAtTime(o,e+.004),s.gain.exponentialRampToValueAtTime(1e-4,e+.62),a.connect(s).connect(Se.festBus),a.start(e),a.stop(e+.7);const i=B.createBufferSource();i.buffer=Se.buf;const c=B.createBiquadFilter();c.type="bandpass",c.frequency.value=1400,c.Q.value=.8;const h=B.createGain();h.gain.setValueAtTime(o*.5,e),h.gain.exponentialRampToValueAtTime(1e-4,e+.09),i.connect(c).connect(h).connect(Se.festBus),i.start(e),i.stop(e+.12)}function r0(e=1,o=0){if(!B||!Se||!zt)return;const n=B.currentTime+o,a=B.createBufferSource();a.buffer=Se.buf,a.loop=!0;const s=B.createBiquadFilter();s.type="lowpass",s.frequency.setValueAtTime(320,n),s.frequency.exponentialRampToValueAtTime(70,n+2.6),s.Q.value=.9;const i=B.createGain(),c=.5*e;i.gain.setValueAtTime(0,n),i.gain.linearRampToValueAtTime(c,n+.05),i.gain.exponentialRampToValueAtTime(c*.24,n+.7),i.gain.exponentialRampToValueAtTime(c*.42,n+1.35),i.gain.exponentialRampToValueAtTime(1e-4,n+3.4),a.connect(s).connect(i).connect(Se.stormBus),a.start(n),a.stop(n+3.6);const h=B.createOscillator(),l=B.createGain();h.type="sine",h.frequency.setValueAtTime(46,n),h.frequency.exponentialRampToValueAtTime(28,n+2.2),l.gain.setValueAtTime(0,n),l.gain.linearRampToValueAtTime(.32*e,n+.08),l.gain.exponentialRampToValueAtTime(1e-4,n+2.6),h.connect(l).connect(Se.stormBus),h.start(n),h.stop(n+2.8)}function i0(e=.5){if(!B||!Se||!zt)return;const o=B.currentTime;for(const[n,a,s]of[[1,1,9],[2.76,.5,6],[5.4,.28,3.6],[8.9,.15,2.2]]){const i=B.createOscillator(),c=B.createGain();i.type="sine",i.frequency.value=61*n,c.gain.setValueAtTime(0,o),c.gain.linearRampToValueAtTime(e*a,o+.008),c.gain.exponentialRampToValueAtTime(1e-4,o+s),i.connect(c).connect(It),i.start(o),i.stop(o+s+.1)}}let wt=0,Fn=0,Us=0,jo=0;function l0(e){if(!na||!B||!Se||!zt)return;const o=B.currentTime,n=e.shelter,a=e.underwater,s=e.subActive?.12:1,i=Math.sin(n*Math.PI*.5)*s*(1-a*.92);Se.stormBus.gain.setTargetAtTime(Math.cos(n*Math.PI*.5),o,.35),Se.festBus.gain.setTargetAtTime(i,o,.35),Se.rain.gain.gain.setTargetAtTime(.22*e.rain,o,.4),Se.wind.gain.gain.setTargetAtTime(.3*(.25+e.rain*.75),o,.5),Se.sea.gain.gain.setTargetAtTime(.22*(.3+e.rain*.7),o,.5),Se.roar.gain.gain.setTargetAtTime(.55*e.whirlNear*(1-a*.55),o,.3),Se.muffle.frequency.setTargetAtTime(18e3-a*17400,o,.18);const c=e.subActive?a*(.045+e.subThrottle*.11):e.helmActive?.03+e.helmSpeed*.1:0;if(Se.humGain.gain.setTargetAtTime(c,o,.25),e.splash!==Us&&(Us=e.splash,s0(1)),e.subActive&&a>.5?jo===0?jo=o+1.2:o>=jo&&(a0(),jo=o+6.5):jo=0,n>.06){const l=.9090909090909091;for(wt<o&&(wt=o+.1);wt<o+.35;){const u=Fn%8,b=n*.9;u===0?ao(wt,.85*b,74):u===2?ao(wt,.45*b,88):u===4?ao(wt,.7*b,74):u===6?ao(wt,.4*b,92):u===7&&(ao(wt,.3*b,96),ao(wt+l*.5,.36*b,96)),Fn++,wt+=l}}else wt=0,Fn=0}function c0(){const e=w.useRef(!1),o=w.useRef(-1);return ae(()=>{if(l0(y),y.flash>.55&&!e.current){e.current=!0;const n=y.flashDir,a=500+Math.abs(n.z)*900;r0(Math.min(1,.55+y.flash*.6),a/340)}else y.flash<.08&&(e.current=!1);y.shot!==o.current&&(y.shot===4&&o.current>=0&&i0(.55),o.current=y.shot)}),null}function h0({mode:e,vessel:o}){return y.mode=e,y.vessel=o,ae(()=>Cc(),-100),null}function d0(){const e=xe(s=>s.gl),o=xe(s=>s.camera),n=xe(s=>s.setSize),a=xe(s=>s.size);return w.useEffect(()=>{const s=()=>{const i=window.innerWidth,c=window.innerHeight;i<2||c<2||a.width>i*.5&&a.height>c*.5||(n(i,c),e.setSize(i,c,!1),o.aspect=i/c,o.updateProjectionMatrix())};return s(),window.addEventListener("resize",s),document.addEventListener("visibilitychange",s),()=>{window.removeEventListener("resize",s),document.removeEventListener("visibilitychange",s)}},[e,o,n,a.width,a.height]),null}function u0({every:e=12}){const o=xe(a=>a.gl),n=w.useRef(0);return w.useEffect(()=>(o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0,()=>{o.shadowMap.autoUpdate=!0}),[o]),ae(()=>{n.current+=1,n.current%e===0&&(o.shadowMap.needsUpdate=!0)}),null}function p0({budget:e}){const o=xe(a=>a.setDpr),n=w.useRef(e.dpr[1]);return t.jsx(Xr,{bounds:a=>a>90?[50,90]:[46,58],flipflops:3,onDecline:()=>{n.current=Math.max(e.dpr[0],n.current-.25),o(n.current)},onIncline:()=>{n.current=Math.min(e.dpr[1],n.current+.25),o(n.current)},onFallback:()=>{n.current=e.dpr[0],o(e.dpr[0])}})}function f0(){const e=xe(a=>a.gl),o=xe(a=>a.scene),n=xe(a=>a.camera);return w.useEffect(()=>{const a=setTimeout(()=>{try{e.compile(o,n)}catch(s){console.warn("[onigashima] pre-compile skipped",s)}},900);return()=>clearTimeout(a)},[e,o,n]),null}function m0(){const{camera:e,scene:o,gl:n}=xe();return w.useEffect(()=>{},[e,o,n]),null}const g0=new ze(X.haze),x0=new ze(X.underHaze),b0=new ze(X.abyss),Ws=new ze;function w0(){const e=xe(o=>o.scene);return ae(()=>{if(!e.fog)return;const o=R.clamp(y.depthBelow/Bt.deepGrade,0,1),n=R.lerp(.0062,.0142,o);e.fog.density=R.lerp(y.fog,n,y.underwater),Ws.copy(x0).lerp(b0,o*.8),e.fog.color.lerpColors(g0,Ws,y.underwater)}),null}function y0({quality:e,budget:o,onRails:n,playing:a,speed:s,onShot:i,mode:c,onMode:h,crew:l,vessel:u="sunny"}){return t.jsxs(t.Fragment,{children:[t.jsx("color",{attach:"background",args:[X.haze]}),t.jsx("fogExp2",{attach:"fog",args:[X.haze,y.fog]}),t.jsx(mi,{storm:y}),t.jsx(Ul,{quality:e,shadowMap:o.shadowMap,shadows:o.shadows}),t.jsx(_i,{quality:e,segments:o.segments}),t.jsx(Li,{quality:e,storm:y}),t.jsx(sl,{quality:e,shadows:o.shadows}),t.jsx(Ca,{quality:e,shadows:o.shadows}),e!=="low"&&t.jsx(Ca,{quality:e,shadows:!1,z:co,k:H*cr*1.5}),t.jsx(hl,{quality:e,shadows:o.shadows}),t.jsx(ul,{quality:e,shadows:o.shadows}),t.jsx(Nl,{quality:e}),t.jsx(_l,{shadows:o.shadows}),t.jsx(ah,{quality:e,shadows:o.shadows}),t.jsx(Zl,{quality:e}),t.jsx(tc,{quality:e}),t.jsx(lc,{quality:e}),t.jsx(yc,{quality:e}),t.jsx(Dc,{onRails:n&&c==="off",playing:a&&c==="off",speed:s,onShot:i,idle:c!=="off"}),t.jsx(h0,{mode:c,vessel:u}),t.jsx(ci,{}),t.jsx(hi,{}),t.jsx(di,{}),t.jsx(Hh,{mode:c,onMode:h,crew:l,vessel:u}),t.jsx(Qh,{mode:c,onMode:h}),t.jsx(c0,{}),t.jsx(d0,{}),t.jsx(w0,{}),t.jsx(m0,{}),t.jsx(f0,{}),t.jsx(p0,{budget:o}),o.shadows&&t.jsx(u0,{every:o.shadowEvery})]})}const To="#d63420",v0="rgba(8,6,16,0.72)",Ys="(max-width: 860px), (max-height: 520px)",Ln="min(7.5vh, 62px)",M0=3e3;function k0(e=2600,o=!0){const[n,a]=w.useState(!1);return w.useEffect(()=>{if(!o){a(!1);return}let s;const i=()=>{a(!1),clearTimeout(s),s=setTimeout(()=>a(!0),e)};i();for(const c of["pointermove","pointerdown","keydown","touchstart","wheel"])window.addEventListener(c,i,{passive:!0});return()=>{clearTimeout(s);for(const c of["pointermove","pointerdown","keydown","touchstart","wheel"])window.removeEventListener(c,i)}},[e,o]),n}function j0(){const[e,o]=w.useState(()=>typeof window<"u"&&window.matchMedia(Ys).matches);return w.useEffect(()=>{const n=window.matchMedia(Ys),a=()=>o(n.matches);return n.addEventListener?n.addEventListener("change",a):n.addListener(a),()=>{n.removeEventListener?n.removeEventListener("change",a):n.removeListener(a)}},[]),e}function Je({on:e,onClick:o,children:n,title:a,wide:s,block:i}){return t.jsx("button",{onClick:o,title:a,style:{appearance:"none",border:`1px solid ${e?To:"rgba(255,255,255,0.16)"}`,background:e?"rgba(214,52,32,0.22)":"rgba(8,6,16,0.5)",color:e?"#ffd9cf":"rgba(255,255,255,0.78)",borderRadius:3,padding:s||i?"8px 13px":"8px 10px",font:"600 10px/1 ui-monospace, SFMono-Regular, Menlo, monospace",letterSpacing:"0.13em",cursor:"pointer",backdropFilter:"blur(9px)",WebkitBackdropFilter:"blur(9px)",transition:"border-color .18s, background .18s, color .18s",whiteSpace:"nowrap",width:i?"100%":void 0,textAlign:i?"right":"center",minHeight:32},children:n})}function S0({shot:e,shotIndex:o,shotCount:n,total:a,playing:s,onRails:i,speed:c,tier:h,override:l,dev:u,onPlay:b,onRailsToggle:m,onSpeed:g,onQuality:x,onRestart:f,audio:p,onAudio:d,mode:v,onMode:j,crew:S,onCrew:k,vessel:E,onVessel:r,onSwap:T,stage:C,veiled:P=!1}){const M=v!=="off",G=j0(),[F,W]=w.useState(!1),[K,fe]=w.useState(()=>({...ve}));w.useEffect(()=>ga(_=>fe({..._})),[]);const O=k0(2600,!M&&!F),$=w.useRef(),te=w.useRef(),se=w.useRef(),me=w.useRef(),ue=w.useRef(),Fe=w.useRef(),We=i&&!M;w.useEffect(()=>W(!1),[v]),w.useEffect(()=>{let _,je=performance.now(),Ge=0,ct=0;const ft=Me=>{if(_=requestAnimationFrame(ft),$.current&&($.current.style.transform=`scaleX(${C.progress||0})`),se.current&&C.helm){const D=C.helm;if(D.onFoot)se.current.textContent=D.area==="deck"?`ON DECK · ${Math.round(Math.abs(D.speed)*1.94)} KN · BRG ${String(Math.round((D.heading*180/Math.PI+360)%360)).padStart(3,"0")}°   —  nobody is at the wheel`:D.area==="island"?D.toRear<220?"ASHORE · THE REAR COVE  —  the cave gate is in the cliff":D.nearPort?"ASHORE · THE PORT  —  the mouth is up the talus":`ASHORE · ONIGASHIMA   MOUTH ${Math.round(D.toMouth)}m`:"INSIDE THE SKULL DOME  ·  LIVE FLOOR";else if(D.sub){const re=Math.abs(D.speed)*1.94;if(D.berthing)se.current.textContent="BLOWING BALLAST — SURFACING IN THE REAR COVE";else{const Oe=D.maelstrom>.22?D.depth<26?"⚠ MAELSTROM PULL — DIVE":"MAELSTROM OVERHEAD — RUNNING UNDER":D.stress>.02?"⚠ HULL UNDER PRESSURE":D.scrape>.3?"HULL ON THE ROCK":"",q=Math.abs(D.relRear*180/Math.PI),ne=q<6?"· ON COURSE":D.relRear>0?`◀ ${q.toFixed(0)}°`:`${q.toFixed(0)}° ▶`,J=10,Te=Math.round(D.depth/D.maxDepth*J),Ee=Math.round(D.crushDepth/D.maxDepth*J);let Xe="";for(let Ze=0;Ze<J;Ze++)Xe+=Ze<Te?Ze>=Ee?"▓":"█":Ze===Ee?"┃":"·";const Fo=D.cruise===2?" ⟲FLK":D.cruise===1?" ⟲AHD":"";se.current.textContent=`DEPTH ${D.depth.toFixed(0).padStart(3,"0")}/${D.orderedDepth.toFixed(0).padStart(3,"0")}m ${Xe}  ${re.toFixed(0).padStart(2,"0")} KN${Fo}
...
`+(D.maelstrom>.2?"⚠ MAELSTROM — HARD OVER, FULL AHEAD":D.moored?"MOORING":D.aground>.3?"AGROUND — HELM OVER":D.underFire?`⚠ UNDER FIRE — STRAIGHT FOR THE ARCH    GATE ${Math.round(D.toGate)}m`:D.drift>.62?`MAKING LEEWAY — EASE THE HELM    GATE ${Math.round(D.toGate)}m`:`GATE ${Math.round(D.toGate)}m`)}}if(me.current){const D=nc(),re=oc(V.chain);me.current.textContent=V.done?"✔ OBJECTIVE COMPLETE":D?`▸ ${V.step+1}/${re}  ${D.text}`:"",me.current.style.color=V.done?"#8fe0a0":"#ffd9cf"}if(ue.current){const D=Math.max(0,Math.min(1,V.hull)),re=Math.max(0,Math.min(1,V.grip)),Oe=J=>{const Te=Math.round(J*12);return"█".repeat(Te)+"·".repeat(12-Te)},q=D>.6?"#8fe0a0":D>.3?"#ffc46b":"#ff6b5a",ne=re>.66?"#ff6b5a":re>.33?"#ffc46b":"rgba(255,255,255,0.45)";ue.current.innerHTML=`<span style="color:${q}">HULL ${Oe(D)}</span>`+(re>.02?`<span style="color:${ne};margin-left:14px">VORTEX ${Oe(re)}</span>`:"")}if(Fe.current){const D=V.banner,re=Fe.current;D&&re.dataset.text!==D.text&&(re.dataset.text=D.text,re.dataset.until=String(Me+M0),re.innerHTML=`<div class="og-banner-main">${D.text}</div>`+(D.sub?`<div class="og-banner-sub">${D.sub}</div>`:""),re.style.animation="none",re.offsetWidth,re.style.animation=""),D||(re.dataset.text="");const Oe=Number(re.dataset.until||0);re.style.opacity=re.dataset.text&&Me<Oe?"1":"0"}u&&te.current?(ct++,Ge+=Me-je,je=Me,Ge>400&&(te.current.textContent=`${Math.round(ct*1e3/Ge)} fps · shelter ${C.shelter.toFixed(2)} · fog ${(C.fog*1e4).toFixed(1)}e-4 · flash ${C.flash.toFixed(2)}`,Ge=0,ct=0)):je=Me};return _=requestAnimationFrame(ft),()=>cancelAnimationFrame(_)},[C,u]);const Z={opacity:O?.16:1,transform:O?"translateY(6px)":"none",transition:"opacity .5s ease, transform .5s ease"},be=[{key:"rails",on:!i,label:i?"FREE LOOK":"ON RAILS",title:"Take the camera off rails and look around",click:m,cinematicOnly:!0},{key:"helm",on:v==="helm",label:v==="helm"?"LEAVE HELM":"TAKE THE HELM",title:"Take the helm and sail the approach yourself",click:()=>j(v==="helm"?"off":"helm")},{key:"deck",on:!1,label:"WALK THE DECK",title:"Step back from the wheel and walk the deck as your pirate — she sails on",click:()=>{C.footSpawn="deck",j("foot")},helmOnly:!0},{key:"sub",on:v==="sub",label:v==="sub"?"LEAVE THE TANG":"DIVE THE POLAR TANG",title:"Dive under the maelstroms and take the back way in",click:()=>j(v==="sub"?"off":"sub")},{key:"foot",on:v==="foot",label:"LEAVE DOME",title:"Back to the approach",click:()=>j("off"),footOnly:!0}],Be=_=>v==="foot"?t.jsx(Je,{on:!0,wide:!0,block:_,title:"Swap between Luffy and Zoro, in their Wano gear",onClick:()=>k?.(S==="zoro"?"luffy":"zoro"),children:S==="zoro"?"ZORO · 和":"LUFFY · 和"}):null,at=_=>{if(!M||v==="foot")return null;const je=ma(v,E);return t.jsx(Je,{on:!0,wide:!0,block:_,title:`Take ${je.who}'s ship — the three of them are sailing abreast (Y)`,onClick:()=>T?.(),children:_?`⇄  ${je.name}`:`⇄ ${je.who}`})},lt=(_,je)=>t.jsx(Je,{on:_.on,onClick:_.click,title:_.title,wide:!0,block:je,children:_.label},_.key),kt=_=>M?t.jsxs(t.Fragment,{children:[t.jsx(Je,{on:K.comfort>.01,wide:!0,block:_,title:"Steady the camera: less roll, less shake, less lens movement. The fix if the motion is making you queasy.",onClick:zc,children:K.comfort>.9?"COMFORT · FULL":K.comfort>.01?"COMFORT · SOME":"COMFORT · OFF"}),t.jsx(Je,{on:K.freeCam,wide:!0,block:_,title:"Free camera: the view stays where you put it instead of swinging back behind the ship (V)",onClick:()=>io("freeCam"),children:K.freeCam?"CAM · FREE":"CAM · CHASE"}),t.jsx(Je,{on:Math.abs(K.lookSens-1)>.01,wide:!0,block:_,title:"How far a drag turns the view",onClick:Tc,children:`LOOK ${K.lookSens.toFixed(2).replace(/0$/,"")}×`}),t.jsx(Je,{on:K.invertY,wide:!0,block:_,title:"Invert the vertical look axis",onClick:()=>io("invertY"),children:K.invertY?"Y · INVERTED":"Y · NORMAL"})]}):null,Qe=()=>M?t.jsx(Je,{on:!K.hud,title:"Hide the readouts, the chart and the objective — just the picture (H)",onClick:()=>io("hud"),children:K.hud?"◱":"◰"}):null,pt=_=>t.jsxs(t.Fragment,{children:[!M&&t.jsxs(t.Fragment,{children:[t.jsx(Je,{on:s,onClick:b,title:"Play / pause the cinematic",block:_,children:s?_?"❙❙  PAUSE":"❙❙":_?"▶  PLAY":"▶"}),[.5,1,2].map(je=>t.jsxs(Je,{on:c===je,onClick:()=>g(je),title:`${je}× speed`,block:_,children:[je,"×"]},je))]}),t.jsx(Je,{on:!1,onClick:f,title:"Restart from the open sea",block:_,children:_?"↺  RESTART":"↺"}),t.jsx(Je,{on:p,onClick:d,title:"Storm, taiko and a temple bell — all synthesised",block:_,children:p?_?"♪  SOUND ON":"♪":_?"♪̸  SOUND OFF":"♪̸"}),t.jsx(Je,{on:l!=="auto",wide:!0,block:_,title:"Render tier",onClick:()=>x(l==="auto"?"low":l==="low"?"mobile":l==="mobile"?"high":"auto"),children:l==="auto"?`AUTO · ${h.toUpperCase()}`:l.toUpperCase()})]});return t.jsxs(t.Fragment,{children:[!P&&t.jsxs(t.Fragment,{children:[[0,1].map(_=>t.jsx("div",{style:{position:"fixed",left:0,right:0,[_?"bottom":"top"]:0,height:We?Ln:0,background:"#05040a",zIndex:8,pointerEvents:"none",transition:"height .7s cubic-bezier(.6,0,.2,1)"}},_)),t.jsxs("div",{className:"og-tategaki",style:{opacity:M||F?0:1,transition:"opacity .6s ease"},children:["鬼ヶ島",t.jsx("span",{className:"og-tategaki-sub",children:"ONIGASHIMA"})]}),t.jsx("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 26px)",zIndex:10,pointerEvents:"none",animation:"ogCaption .85s cubic-bezier(.2,.9,.2,1) both",transition:"bottom .7s cubic-bezier(.6,0,.2,1)",maxWidth:"min(70vw, 620px)",display:M?"none":"block"},children:t.jsxs("div",{style:{display:"inline-block",borderLeft:`2px solid ${To}`,paddingLeft:12},children:[t.jsx("div",{style:{font:'700 clamp(15px, 2.5vw, 27px)/1.15 "Hiragino Mincho ProN", "Yu Mincho", Georgia, serif',letterSpacing:"0.07em",color:"#fff6f0",textShadow:"0 2px 22px rgba(0,0,0,0.95), 0 0 44px rgba(0,0,0,0.7)"},children:e?.title}),t.jsx("div",{style:{marginTop:5,font:"500 clamp(9px, 1.15vw, 12px)/1.5 ui-monospace, Menlo, monospace",letterSpacing:"0.19em",color:"rgba(255,225,215,0.66)",textShadow:"0 1px 12px rgba(0,0,0,0.95)"},children:e?.sub})]})},e?.id),t.jsx("div",{style:{position:"fixed",left:0,right:0,bottom:"var(--og-bottom)",height:2,zIndex:10,background:"rgba(255,255,255,0.08)",pointerEvents:"none",opacity:M?0:1,transition:"bottom .7s cubic-bezier(.6,0,.2,1), opacity .4s ease"},children:t.jsx("div",{ref:$,style:{height:"100%",background:`linear-gradient(90deg, ${To}, #ff9c2e)`,transformOrigin:"0 50%",transform:"scaleX(0)",boxShadow:`0 0 14px ${To}`}})}),t.jsx("div",{className:`og-chrome${M?"":" og-chrome-bottom"}`,style:{...M?{top:"calc(var(--og-top) + 14px)"}:{bottom:"calc(var(--og-bottom) + 22px)"},...Z},children:G?t.jsxs(t.Fragment,{children:[M&&t.jsx(Je,{on:!0,onClick:()=>j("off"),wide:!0,title:"Back to the cinematic",children:"✕ EXIT"}),Qe(),t.jsx(Je,{on:F,onClick:()=>W(_=>!_),title:"Menu",children:F?"✕":"☰"}),F&&t.jsxs("div",{className:"og-menu",children:[M&&t.jsxs(t.Fragment,{children:[Be(!0),at(!0),kt(!0),t.jsx("div",{className:"og-menu-rule"})]}),be.filter(_=>!(_.cinematicOnly&&M)&&!(_.helmOnly&&v!=="helm")&&!(_.footOnly&&v!=="foot")).map(_=>lt(_,!0)),t.jsx("div",{className:"og-menu-rule"}),pt(!0)]})]}):t.jsxs(t.Fragment,{children:[Qe(),Be(!1),at(!1),kt(!1),pt(!1),be.filter(_=>!(_.cinematicOnly&&M)&&!(_.helmOnly&&v!=="helm")&&!(_.footOnly&&v!=="foot")).map(_=>lt(_,!1))]})}),!M&&t.jsxs("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",top:"calc(var(--og-top) + 18px)",zIndex:10,font:"600 10px/1 ui-monospace, Menlo, monospace",letterSpacing:"0.3em",color:"rgba(255,255,255,0.4)",textShadow:"0 1px 10px #000",transition:"top .7s cubic-bezier(.6,0,.2,1)",...Z,pointerEvents:"none"},children:[i?`SHOT ${String(o+1).padStart(2,"0")} / ${String(n).padStart(2,"0")}`:"FREE LOOK · DRAG ORBIT · WASD FLY · 2-FINGER / SHIFT-DRAG PAN · PINCH ZOOM · R HOME",t.jsx("span",{style:{opacity:.5},children:i?`  ·  ${Math.round(a)}s`:""})]}),M&&K.hud&&t.jsxs("div",{className:"og-instruments",children:[t.jsx("div",{ref:me,className:"og-objective"}),t.jsx("div",{ref:se,className:"og-readout"}),t.jsx("div",{ref:ue,className:"og-gauges"}),t.jsx("div",{className:"og-keys",children:v==="helm"?"W/S THROTTLE · A/D RUDDER · SHIFT FLANK · X ENGINE LATCH · B BURST · T WALK THE DECK · DRAG LOOK · R RECENTRE · V FREE CAM · WHEEL ZOOM":v==="sub"?"W/S THROTTLE · A/D RUDDER · SPACE RISE · C DIVE · SHIFT FLANK · X LATCH · F SURFACE · P PERISCOPE · DRAG LOOK · R RECENTRE · V FREE CAM":S==="zoro"?"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J ONIGIRI · U TATSUMAKI · K YAKKODORI · L SANZEN · G FLASH · H ASURA · DRAG ORBIT":"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J PISTOL · U GATLING · K BAZOOKA · L GIGANT · G ROCKET · H HAKI · N GEAR 2 · I BALLOON · DRAG ORBIT"})]}),M&&K.hud&&t.jsx("div",{ref:Fe,className:"og-banner"}),u&&t.jsx("div",{ref:te,style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 96px)",zIndex:14,font:"500 10px/1 ui-monospace, Menlo, monospace",color:"#7fe0a0",background:v0,padding:"5px 8px",borderRadius:3,pointerEvents:"none"}})]}),t.jsx("style",{children:`
      ...
      `})]})}const So="#d63420",z0=[{key:"sub",kanji:"潜",label:"DIVE THE POLAR TANG",sub:"Take Law’s submarine under the maelstroms to the back door",hero:!0,flag:"START HERE"},{key:"helm",kanji:"舵",label:"TAKE THE HELM",sub:"Sail the storm sea and run the gates"},{key:"off",kanji:"航",label:"WATCH THE APPROACH",sub:"Eight shots · 96 seconds · no controls"}];function T0({onPick:e}){const[o,n]=w.useState(!1),a=w.useRef(),s=620,i=l=>{o||(n(!0),e(l))},[c,h]=w.useState(!1);return w.useEffect(()=>{if(!o)return;const l=setTimeout(()=>h(!0),s);return()=>clearTimeout(l)},[o]),w.useEffect(()=>{const l=u=>{(u.key==="Escape"||u.key==="Enter")&&i("off")};return window.addEventListener("keydown",l),()=>window.removeEventListener("keydown",l)}),c?null:t.jsxs("div",{ref:a,className:"og-landing",style:{opacity:o?0:1,pointerEvents:o?"none":"auto",transition:`opacity ${s}ms cubic-bezier(.4,0,.2,1)`},children:[t.jsx("div",{className:"og-landing-veil"}),t.jsxs("div",{className:"og-landing-body",children:[t.jsx("div",{className:"og-landing-eyebrow",style:{animationDelay:".05s"},children:"WANO COUNTRY · NIGHT OF THE FIRE FESTIVAL"}),t.jsx("h1",{className:"og-landing-kanji",style:{animationDelay:".14s"},children:"鬼ヶ島"}),t.jsxs("div",{className:"og-landing-title",style:{animationDelay:".22s"},children:["ONIGASHIMA",t.jsx("span",{children:"THE RAID"})]}),t.jsx("p",{className:"og-landing-blurb",style:{animationDelay:".3s"},children:"A storm sea ringed with whirlpools, a demon’s skull carved into an island, and one channel in. Sail it, or go under it."}),t.jsx("div",{className:"og-landing-grid",children:z0.map((l,u)=>t.jsxs("button",{className:l.hero?"og-entry og-entry-hero":"og-entry",style:{animationDelay:`${.36+u*.07}s`},onClick:()=>i(l.key),children:[t.jsx("span",{className:"og-entry-kanji",children:l.kanji}),t.jsxs("span",{className:"og-entry-text",children:[l.flag&&t.jsx("span",{className:"og-entry-flag",children:l.flag}),t.jsx("span",{className:"og-entry-label",children:l.label}),t.jsx("span",{className:"og-entry-sub",children:l.sub})]}),t.jsx("span",{className:"og-entry-arrow",children:"›"})]},l.key))}),t.jsxs("div",{className:"og-landing-foot",style:{animationDelay:".7s"},children:[t.jsx("span",{children:"SOUND ON · HEADPHONES IF YOU HAVE THEM"}),t.jsx("span",{className:"og-landing-legal",children:"Fan-made and non-commercial. One Piece is Eiichiro Oda’s."})]})]}),t.jsx("style",{children:`
        ...
        .og-entry-hero .og-entry-arrow { color: ${So}; }
        .og-entry-flag {
      ...
      `})]})}const P0=168,F0=122,$s="(max-width: 860px), (max-height: 520px)",Gn=1950,Ks={x:0,z:340},tt={paper:"rgba(30,24,26,0.86)",sea:"rgba(16,14,24,0.55)",ring:"#6b5c48",land:"#3a2f28",skull:"#c2a578",skullInk:"#241c18",fairway:"rgba(226,198,150,0.10)",gate:"#d63420",port:"#f0ad50",rear:"#8fd4f2",whirl:"rgba(150,180,225,0.62)",you:"#ffe6a0",grid:"rgba(226,198,150,0.09)"},Yr=e=>({px:o=>(o-Ks.x)/Gn*(e/2)+e/2,pz:o=>(o-Ks.z)/Gn*(e/2)+e/2,pl:o=>o/Gn*(e/2)});function L0(e,o,n){const{px:a,pz:s,pl:i}=Yr(n);e.save(),e.scale(o,o),e.clearRect(0,0,n,n),e.fillStyle=tt.paper,e.fillRect(0,0,n,n),e.fillStyle=tt.sea,e.fillRect(0,0,n,n),e.strokeStyle=tt.grid,e.lineWidth=1;for(let m=1;m<5;m++){const g=m/5*n;e.beginPath(),e.moveTo(g,0),e.lineTo(g,n),e.moveTo(0,g),e.lineTo(n,g),e.stroke()}e.fillStyle=tt.fairway,e.fillRect(a(-tn.halfWidth),0,i(tn.halfWidth*2),n),e.strokeStyle=tt.ring,e.lineWidth=i(vt*.34),e.beginPath(),e.arc(a(pe.x),s(pe.z),i(vt),Math.PI*.34,Math.PI*.66,!0),e.stroke();const c=i(L.r*L.squash[0]),h=i(L.r*L.squash[2]),l=a(L.x),u=s(L.z);e.fillStyle=tt.skull;for(const m of[-1,1])e.beginPath(),e.moveTo(l+m*c*.62,u-h*.45),e.quadraticCurveTo(l+m*c*1.28,u-h*1.15,l+m*c*1.5,u-h*1.72),e.quadraticCurveTo(l+m*c*1.02,u-h*1.05,l+m*c*.3,u-h*.62),e.closePath(),e.fill();e.beginPath(),e.ellipse(l,u,c,h,0,0,Math.PI*2),e.fill(),e.fillStyle=tt.skullInk;for(const m of[-1,1])e.beginPath(),e.ellipse(l+m*c*.38,u+h*.22,c*.19,h*.15,0,0,Math.PI*2),e.fill();e.beginPath(),e.ellipse(l,u+h*.66,c*.26,h*.12,0,0,Math.PI*2),e.fill(),e.strokeStyle=tt.gate,e.lineWidth=1.4;for(const[m,g]of[[Ut,1],[co,1.5]]){const x=i(95*H*g),f=s(m),p=x*.55;e.beginPath(),e.moveTo(a(0)-x*1.15,f-p*.5),e.lineTo(a(0)+x*1.15,f-p*.5),e.moveTo(a(0)-x*.92,f),e.lineTo(a(0)+x*.92,f),e.moveTo(a(0)-x*.86,f-p*.55),e.lineTo(a(0)-x,f+p*.6),e.moveTo(a(0)+x*.86,f-p*.55),e.lineTo(a(0)+x,f+p*.6),e.stroke()}for(const m of Ue){const g=a(m.x),x=s(m.z),f=i(m.r);e.strokeStyle=tt.whirl,e.lineWidth=1,e.beginPath(),e.arc(g,x,f,0,Math.PI*2),e.stroke(),e.lineWidth=1.1;for(const p of[0,Math.PI]){e.beginPath();for(let d=0;d<=22;d++){const v=d/22,j=p+m.dir*v*Math.PI*1.9,S=f*(1-v*.86),k=g+Math.cos(j)*S,E=x+Math.sin(j)*S;d?e.lineTo(k,E):e.moveTo(k,E)}e.stroke()}}const b=(m,g,x,f=2.6)=>{e.fillStyle=x,e.beginPath(),e.arc(a(m),s(g),f,0,Math.PI*2),e.fill()};b(Q.x,Q.z,tt.port),b(de.x,de.z,tt.land,2),b(Y.gate.x,Y.gate.z,tt.rear),e.restore()}function G0({mode:e}){const o=w.useRef(),n=w.useRef(),a=typeof window>"u"?1:Math.min(2,window.devicePixelRatio||1),[s,i]=w.useState(()=>typeof window<"u"&&window.matchMedia($s).matches);w.useEffect(()=>{const b=window.matchMedia($s),m=()=>i(b.matches);return b.addEventListener?b.addEventListener("change",m):b.addListener(m),()=>{b.removeEventListener?b.removeEventListener("change",m):b.removeListener(m)}},[]);const[c,h]=w.useState(!0),l=s?F0:P0,u=w.useMemo(()=>{if(typeof document>"u")return null;const b=document.createElement("canvas");return b.width=l*a,b.height=l*a,L0(b.getContext("2d"),a,l),b},[a,l]);return w.useEffect(()=>{if(!n.current||!u||!c)return;const{px:b,pz:m}=Yr(l),g=n.current.getContext("2d");let x;const f=()=>{x=requestAnimationFrame(f);const p=y.helm;if(g.setTransform(1,0,0,1,0,0),g.clearRect(0,0,l*a,l*a),g.drawImage(u,0,0),!p||p.x===void 0)return;g.save(),g.scale(a,a);const d=b(p.x),v=m(p.z),j=p.sub&&p.depth>4;g.translate(d,v),p.heading!==void 0?(g.rotate(Math.PI-p.heading),g.beginPath(),g.moveTo(0,-5.5),g.lineTo(3.4,4),g.lineTo(0,2),g.lineTo(-3.4,4),g.closePath()):(g.beginPath(),g.arc(0,0,3,0,Math.PI*2)),g.fillStyle=j?"rgba(0,0,0,0)":tt.you,g.strokeStyle=tt.you,g.lineWidth=1.2,g.fill(),g.stroke(),g.restore(),j&&(g.save(),g.scale(a,a),g.fillStyle=tt.rear,g.font="600 9px ui-monospace, SFMono-Regular, Menlo, monospace",g.textAlign="right",g.fillText(`${Math.round(p.depth)}m DOWN`,l-6,l-6),g.restore())};return f(),()=>cancelAnimationFrame(x)},[u,a,e,c,l]),e==="off"?null:c?t.jsxs("div",{className:"og-minimap",style:{position:"fixed",left:14,bottom:14,zIndex:12,width:l,height:l,borderRadius:4,overflow:"hidden",border:"1px solid rgba(255,255,255,0.16)",backdropFilter:"blur(9px)",WebkitBackdropFilter:"blur(9px)",pointerEvents:"none"},children:[t.jsx("canvas",{ref:n,width:l*a,height:l*a,style:{width:l,height:l,display:"block"}}),t.jsx("div",{style:{position:"absolute",top:4,left:6,font:"600 8px/1 ui-monospace, SFMono-Regular, Menlo, monospace",letterSpacing:"0.16em",color:"rgba(255,255,255,0.5)"},children:"鬼ヶ島"}),t.jsx("button",{className:"og-map-close",onClick:()=>h(!1),"aria-label":"Hide the chart",children:"✕"}),t.jsx("canvas",{ref:o,style:{display:"none"}}),t.jsx("style",{children:Qs})]}):t.jsxs(t.Fragment,{children:[t.jsx("button",{className:"og-map-tab",title:"Show the chart",onClick:()=>h(!0),"aria-label":"Show the chart",children:"鬼ヶ島 CHART"}),t.jsx("style",{children:Qs})]})}const Qs=`
...
`,Xs={low:{dpr:[1,1.1],shadows:!1,aa:!1,shadowMap:512,segments:110,shadowEvery:24,scene:"low"},mobile:{dpr:[1,1.5],shadows:!0,aa:!1,shadowMap:1024,segments:168,shadowEvery:16,scene:"mid"},high:{dpr:[1,2],shadows:!0,aa:!0,shadowMap:2048,segments:240,shadowEvery:10,scene:"high"}};function O0(){if(typeof navigator>"u")return"high";const e=navigator.hardwareConcurrency||4,o=typeof navigator.deviceMemory=="number"?navigator.deviceMemory:null;return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&/Macintosh/.test(navigator.userAgent)?e<=3||o!==null&&o<=2?"low":"mobile":e<=2||o!==null&&o<=2?"low":"high"}const N0=null;function U0(){const e=w.useMemo(()=>!1,[]),[o]=w.useState(O0),[n,a]=w.useState("auto"),s=n==="auto"?o:n,i=Xs[s]??Xs.high;w.useEffect(()=>{Xi(i.scene!=="low")},[i.scene]),w.useMemo(()=>er(i.scene),[i.scene]),w.useMemo(()=>Rc(),[]),w.useEffect(()=>Ic(),[]);const c=w.useMemo(()=>typeof navigator>"u"?!1:typeof location<"u"&&new URLSearchParams(location.search).has("touch")?!0:navigator.maxTouchPoints>0,[]),[h,l]=w.useState(0),[u,b]=w.useState(!0),[m,g]=w.useState(!0),[x,f]=w.useState(1),[p,d]=w.useState(ms[0]),[v,j]=w.useState(0),[S,k]=w.useState(o0),[E,r]=w.useState(()=>{if(typeof location>"u")return"off";const Z=new URLSearchParams(location.search).get("mode");return Z==="helm"||Z==="sub"||Z==="foot"?Z:"off"}),[T,C]=w.useState(()=>typeof location>"u"?"luffy":new URLSearchParams(location.search).get("crew")==="zoro"?"zoro":"luffy"),[P,M]=w.useState(()=>typeof location>"u"?"sunny":new URLSearchParams(location.search).get("ship")==="punk"?"punk":"sunny");w.useEffect(()=>{if(!S)return;const Z=()=>{Pn(),Cn(!0)};for(const be of["pointerdown","keydown","touchstart"])window.addEventListener(be,Z,{once:!0,passive:!0});return()=>{for(const be of["pointerdown","keydown","touchstart"])window.removeEventListener(be,Z)}},[S]);const G=w.useCallback(()=>{k(Z=>{const be=!Z;return be&&Pn(),Cn(be),be})},[]),[F,W]=w.useState(()=>typeof location<"u"&&new URLSearchParams(location.search).has("enter")),K=w.useCallback(Z=>{S&&(Pn(),Cn(!0)),Z==="off"?(y.jumpTo=0,b(!0),g(!0)):r(Z),W(!0)},[S]),[fe,O]=w.useState(()=>ve.hud);w.useEffect(()=>ga(Z=>O(Z.hud)),[]);const[$,te]=w.useState(!1),se=w.useRef(!0);w.useEffect(()=>{if(qn(),se.current){se.current=!1;return}te(!0);const Z=setTimeout(()=>te(!1),210);return()=>clearTimeout(Z)},[E]);const me=w.useCallback(()=>{const Z=ma(E,P);qn(),M(Z.vessel),r(Z.mode)},[E,P]);w.useEffect(()=>{if(E==="off")return;let Z;const be=()=>{Z=requestAnimationFrame(be),I.swapQueued&&(I.swapQueued=!1,me())};return Z=requestAnimationFrame(be),()=>cancelAnimationFrame(Z)},[E,me]);const ue=w.useCallback((Z,be)=>{j(Z),d(be)},[]),Fe=w.useCallback(()=>{Qi(),l(Z=>Z+1),b(!0),g(!0)},[]),We=w.useMemo(()=>typeof location<"u"&&new URLSearchParams(location.search).has("dev"),[]);return e?t.jsx(w.Suspense,{fallback:null,children:t.jsx(N0,{})}):t.jsxs(t.Fragment,{children:[t.jsx(Zr,{shadows:i.shadows,dpr:i.dpr,gl:{antialias:i.aa,powerPreference:"high-performance",toneMapping:ii,toneMappingExposure:ui,preserveDrawingBuffer:!0},camera:{fov:52,near:1,far:8200,position:[-190,26,880]},frameloop:"always",children:t.jsx(w.Suspense,{fallback:null,children:t.jsx(y0,{quality:i.scene,budget:i,onRails:m,playing:u,speed:x,onShot:ue,mode:E,onMode:r,crew:T,vessel:P},h)})}),c&&F&&t.jsx(C0,{mode:E,crew:T,vessel:P,hud:fe,onSwap:me}),F&&fe&&t.jsx(G0,{mode:E}),t.jsx("div",{"aria-hidden":!0,style:{position:"fixed",inset:0,zIndex:30,background:"#05040a",pointerEvents:"none",opacity:$?1:0,transition:$?"opacity .2s ease-in":"opacity .42s ease-out"}}),!F&&t.jsx(T0,{onPick:K}),t.jsx(S0,{veiled:!F,shot:p,shotIndex:v,shotCount:ms.length,total:ta,playing:u,onRails:m,speed:x,tier:s,override:n,dev:We,onPlay:()=>b(Z=>!Z),onRailsToggle:()=>g(Z=>!Z),onSpeed:f,onQuality:a,onRestart:Fe,audio:S,onAudio:G,mode:E,onMode:r,crew:T,onCrew:C,vessel:P,onVessel:M,onSwap:me,stage:y})]})}export{U0 as default};
