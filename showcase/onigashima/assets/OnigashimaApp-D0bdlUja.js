var wr=Object.defineProperty;var yr=(e,o,n)=>o in e?wr(e,o,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[o]=n;var ps=(e,o,n)=>yr(e,typeof o!="symbol"?o+"":o,n);import{r as w,u as se,j as t,d as La,f as Me,h as vr,i as Mr}from"./vendor-C2HIMx-P.js";import{t as Se,c as S,aD as Tn,au as $n,d as Kn,a5 as _e,aJ as jr,f as kr,Y as fs,a0 as ms,ag as R,h as ne,aK as Sr,ay as zr,az as so,aA as ao,aq as Fa,R as Tr,M as at,o as yt,at as Bt,ax as pt,aL as ro,aM as io,a4 as Er,a8 as Dt,ar as lo,av as Pa,aC as Rr,A as Ar}from"./three-Zo_RlN_K.js";import{f as to,m as vo,w as Ye,a as Vt,e as Ct,P as Ir,G as Cr,S as Lr,I as Fr}from"./index-Ripq8MWH.js";const X={skyHigh:"#140f2b",skyLow:"#3a2a5c",cloud:"#2a2244",cloudLit:"#6b3f5e",seaDeep:"#080d1c",seaShallow:"#16294a",foam:"#c8d6e8",rock:"#2b2f3f",rockLit:"#4c5468",snow:"#aebdd4",pine:"#16202c",bolt:"#e9a8ff",boltGlow:"#a855f7",haze:"#1d1936",abyss:"#04161f",underGlow:"#7fc9c0",underHaze:"#0a2e35"},E={furnace:"#fff1c4",ember:"#ff9c2e",emberDeep:"#c9411a",lantern:"#ff7a3c",lanternFar:"#ffb066",vermilion:"#d63420",vermilionDeep:"#7e1c14",rockWarm:"#6d3a2c",gilt:"#e8a33d",sakura:"#f2a8c4",timber:"#6b4b34"},$o={dir:[.72,.52,-.44],col:"#f2e9cf"},Gt={sea:.00105,bay:48e-5,deepGrade:210},Pr=1.15;function ie(e){const o=new Se(e);return[o.r,o.g,o.b]}const Gr=`
  varying vec3 vDir;
  void main() {
    vDir = position;
...
`;function Dr({storm:e}){const o=w.useRef(),n=w.useMemo(()=>({uTime:{value:0},uHigh:{value:new S(...ie(X.skyHigh))},uLow:{value:new S(...ie(X.skyLow))},uCloud:{value:new S(...ie(X.cloud))},uCloudLit:{value:new S(...ie(X.cloudLit))},uEmber:{value:new S(...ie(E.ember))},uFlash:{value:0},uFlashColor:{value:new S(...ie(X.boltGlow))},uFlashDir:{value:new S(0,.4,-1)},uGlow:{value:1},uMoonDir:{value:new S(...$o.dir).normalize()},uMoonCol:{value:new S(...ie($o.col))},uUnder:{value:0},uUnderCol:{value:new S(...ie(X.underHaze))}}),[]);return se((s,r)=>{const i=o.current?.uniforms;i&&(i.uTime.value+=r,i.uFlash.value=e?.flash??0,e?.flashDir&&i.uFlashDir.value.copy(e.flashDir),i.uUnder.value=e?.underwater??0)}),t.jsxs("mesh",{frustumCulled:!1,renderOrder:-1,children:[t.jsx("sphereGeometry",{args:[1,32,20]}),t.jsx("shaderMaterial",{ref:o,vertexShader:Gr,fragmentShader:Or,uniforms:n,side:Tn,depthWrite:!1,depthTest:!1,fog:!1})]})}const _=1.9,V=e=>e*_,pe={x:0,z:V(-60)},wt=V(300),Bo=V(175),Nr=118,F={x:0,z:V(-402),r:V(215),baseY:300,squash:[1.18,1.04,.98]},wo=[[-.361,.301,.883],[.361,.301,.883]],Xn=[0,.02,.9998],Qn=[0,-.419,.908];function Zn(e,o=1){const[n,s,r]=F.squash;return{x:F.x+e[0]*F.r*n*o,y:F.baseY+e[1]*F.r*s*o,z:F.z+e[2]*F.r*r*o}}const Ie=wo.map(e=>Zn(e)),he={...Zn(Qn),halfWidth:74,height:62};Zn(Xn,.94);const K={x:V(-152),y:4.5,z:V(-104),r:V(78)},gs=2.35,Ht=[Math.sin(gs),Math.cos(gs)],W=(()=>{const e=wt+Bo*.35,o=pe.x+Ht[0]*e,n=pe.z+Ht[1]*e;return{x:o,z:n,pool:V(46),benchY:3.6,reach:V(560),gate:{x:o-Ht[0]*V(44),z:n-Ht[1]*V(44)},berth:{x:o+Ht[0]*V(12),z:n+Ht[1]*V(12)},dir:Ht}})(),Hr=[{rank:1,role:"east-south",ang:.75,dist:V(730),r:V(146),depth:36,dir:-1,speed:33},{rank:2,role:"west-south",ang:-.75,dist:V(730),r:V(144),depth:35,dir:1,speed:33},{rank:3,role:"back-door",ang:2.18,dist:V(770),r:V(142),depth:40,dir:1,speed:34},{rank:4,role:"east",ang:1.35,dist:V(690),r:V(155),depth:40,dir:1,speed:35},{rank:5,role:"west",ang:-1.35,dist:V(690),r:V(150),depth:38,dir:-1,speed:34},{rank:6,role:"west-north",ang:-2.05,dist:V(765),r:V(150),depth:42,dir:1,speed:35}],Be=[];function Ga(e){const o=e==="low"?3:e==="mid"?5:7;Be.length=0;for(const n of Hr)n.rank>o||Be.push({role:n.role,x:pe.x+Math.sin(n.ang)*n.dist,z:pe.z+Math.cos(n.ang)*n.dist,r:n.r,depth:n.depth,dir:n.dir,speed:n.speed});return Be}const _r=e=>Be.find(o=>o.role===e)??Be[0];Ga("high");function Oa(e,o,n=0){let s=0,r=0;const i=1-Ze(8,34,n);if(i<=0)return{vx:s,vz:r,danger:0};let l=0;for(const h of Be){const c=e-h.x,d=o-h.z,b=Math.hypot(c,d);if(b>h.r*1.7||b<.001)continue;const f=b/h.r,x=1-Ze(1,1.6,f),m=h.speed*(f/.3)*Math.exp(1-f/.3)*.62*x,p=h.speed*.55*Math.exp(-f*f*2.6)*x+h.speed*.1*x,g=1/b;s+=(-d*g*m*h.dir-c*g*p)*i,r+=(c*g*m*h.dir-d*g*p)*i,l=Math.max(l,(1-Ze(.15,1.15,f))*i)}return{vx:s,vz:r,danger:l}}const Ko={x:0,halfWidth:V(96)},Ot=V(258),oo=V(624),Xo={safe:260,range:640},Br=0,Uo=V(1500),Qo=e=>e<0?0:e>1?1:e;function Ur(e,o,n=4){let s=0,r=1,i=1,l=0;for(let h=0;h<n;h++){const c=1-Math.abs(to(e*i,o*i,1)*2-1);s+=c*c*r,l+=r,r*=.52,i*=2.07}return s/l}const Ze=(e,o,n)=>{const s=Qo((n-e)/(o-e));return s*s*(3-2*s)};function Wr(e){if(e>V(430))return 1e4;const o=1-Ze(V(430),V(205),e),n=Ze(V(150),V(-30),e);return Ko.halfWidth+o*V(620)+n*V(300)}function Yr(e){const o=(1-Math.cos(e))*.5,n=Math.sin(e);let s=Nr;return s+=o*190,s+=Math.max(0,n)*46,s-=Math.max(0,-n)*26,s}function re(e,o){const n=e-pe.x,s=o-pe.z,r=Math.hypot(n,s),i=Math.atan2(n,s),l=(r-wt)/Bo,h=Math.exp(-l*l*1.35)*Yr(i),c=Math.max(0,r-wt-Bo*.55),d=-Math.pow(c/210,1.6)*175,b=Math.max(0,wt-Bo*.5-r),f=-Ze(0,150,b)*46,x=Qo(h/60),m=(Ur(e*.0052/_+13,o*.0052/_-21,4)-.42)*168*x,p=(to(e*.0042/_+31,o*.0042/_-17,4)-.5)*84*x,g=(to(e*.021-5,o*.021+9,3)-.5)*17*x;let u=h+d+f+m+p+g;const v=Wr(o),T=1-Ze(v,v+V(105),Math.abs(e-Ko.x)),k=1-Ze(V(-40),V(-190),o),j=T*k;u=u*(1-j)+Math.min(u,-34)*j;const L=Math.hypot(e-F.x,o-F.z);u+=Math.exp(-Math.pow(L/(F.r*1.55),2))*62;const a=(e-K.x)/V(76),z=(o-K.z)/V(58),C=(1-Ze(.72,1.18,Math.hypot(a,z)))*Qo((u+34)/34);u=u*(1-C)+K.y*C;const A=e-W.x,M=o-W.z;if(Math.abs(A)+Math.abs(M)<W.reach+V(140)){const G=Math.max(0,Math.min(W.reach,A*W.dir[0]+M*W.dir[1])),P=A-W.dir[0]*G,O=M-W.dir[1]*G,oe=Math.hypot(P,O),ue=V(30)+G/W.reach*V(48),D=1-Ze(ue,ue+V(62),oe);u=u*(1-D)+Math.min(u,-26)*D;const $=Math.hypot(A,M),Q=1-Ze(W.pool*.55,W.pool,$);u=u*(1-Q)+Math.min(u,-14)*Q;const ae=(e-W.gate.x)/V(30),be=(o-W.gate.z)/V(24),de=1-Ze(.72,1.18,Math.hypot(ae,be));u=u*(1-de)+W.benchY*de}return u}function qn(e,o,n=3){const s=re(e+n,o)-re(e-n,o),r=re(e,o+n)-re(e,o-n),i=-s,l=2*n,h=-r,c=Math.hypot(i,l,h)||1;return[i/c,l/c,h/c]}function Vr(e,o,n=3){return Math.acos(qn(e,o,n)[1])}function Mo(e,o){const n=Ze(V(250),V(40),o),s=1-Ze(wt-V(40),wt+V(90),Math.hypot(e-pe.x,o-pe.z)),r=(1-Ze(V(60),V(170),Math.hypot(e-W.x,o-W.z)))*.85;return Qo(Math.max(Math.min(n,s),r))}const Da=[{dir:[.1,-1],amp:9.4,len:187},{dir:[-.42,-.91],amp:4.3,len:97},{dir:[.71,-.7],amp:2.1,len:61},{dir:[-.86,-.51],amp:1.15,len:37}],$r=Math.PI*2;function Kr(e,o,n){let s=0,r=0,i=0;for(const l of Be){const h=e-l.x,c=o-l.z,d=Math.max(1,Math.hypot(h,c));if(d>l.r*1.75)continue;const b=d/l.r,f=Math.exp(-3*b*b);s-=l.depth*f;const x=l.depth*6*b*f/l.r;r+=x*(h/d),i+=x*(c/d);const m=Math.atan2(c,h),p=Math.sin(m*3*l.dir+b*14-n*2.2),g=b*Math.exp(1-b)*(1-Xr(b));s+=p*g*1.6}return{y:s,dx:r,dz:i}}function Xr(e){const o=Math.min(1,Math.max(0,(e-1)/.6));return o*o*(3-2*o)}function xt(e,o,n,s=1){let r=0,i=0,l=0;for(const c of Da){const d=$r/c.len,b=Math.sqrt(9.81/d),f=Math.hypot(c.dir[0],c.dir[1]),x=c.dir[0]/f,m=c.dir[1]/f,p=d*(x*e+m*o-b*n),g=c.amp*s;r+=g*Math.sin(p);const u=g*d*Math.cos(p);i+=u*x,l+=u*m}const h=Kr(e,o,n);return r+=h.y,i+=h.dx,l+=h.dz,{y:r,dx:i,dz:l}}const Qr=Da.map(e=>`    gerstner(p, vec2(${e.dir[0].toFixed(3)}, ${e.dir[1].toFixed(3)}), ${e.amp.toFixed(2)} * amp, ${e.len.toFixed(1)}, uTime, disp, tangent, binormal, total);`).join(`
`),Zr=()=>Be.map(e=>`    whirl(p, vec2(${e.x.toFixed(1)}, ${e.z.toFixed(1)}), ${e.r.toFixed(1)}, ${e.depth.toFixed(1)}, ${e.dir.toFixed(1)}, uTime, disp, tangent, binormal);`).join(`
`),qr=()=>Be.map(e=>`    wm += whirlMark(vWorld.xz, vec2(${e.x.toFixed(1)}, ${e.z.toFixed(1)}), ${e.r.toFixed(1)}, ${e.dir.toFixed(1)}, uTime);`).join(`
`),Jr=`
...
`;function oi(e,o){const n=new Uint8Array(e*e*4);for(let r=0;r<e;r++)for(let i=0;i<e;i++){const l=pe.x+((i+.5)/e-.5)*o,h=pe.z+((r+.5)/e-.5)*o,c=re(l,h),d=R.clamp(-c/46,0,1),b=(r*e+i)*4;n[b]=Math.round(d*255),n[b+1]=n[b],n[b+2]=n[b],n[b+3]=255}const s=new jr(n,e,e,kr);return s.minFilter=fs,s.magFilter=fs,s.wrapS=ms,s.wrapT=ms,s.needsUpdate=!0,s}const Zo={low:112,mid:190,high:286},En=6400;function ni(e){const o=w.useRef(),n=En/(Zo[e]??Zo.high);return se(s=>{const r=o.current;r&&(r.position.x=Math.round((s.camera.position.x-pe.x)/n)*n,r.position.z=Math.round((s.camera.position.z-pe.z)/n)*n)}),o}function si({quality:e="high",storm:o}){const n=w.useRef(),s=ni(e),{geometry:r,uniforms:i,landTex:l,vert:h,frag:c}=w.useMemo(()=>{const d=Zo[e]??Zo.high,b=new $n(En,En,d,d);b.rotateX(-Math.PI/2),b.translate(pe.x,0,pe.z);const f=Uo*1.05,x=oi(e==="low"?160:256,f),m={uTime:{value:0},uLand:{value:x},uSpan:{value:f},uCentre:{value:new Kn(pe.x,pe.z)},uDeep:{value:new S(...ie(X.seaDeep))},uShallow:{value:new S(...ie(X.seaShallow))},uFoam:{value:new S(...ie(X.foam))},uSkyLow:{value:new S(...ie(X.skyLow))},uGilt:{value:new S(...ie(E.gilt))},uEmber:{value:new S(...ie(E.ember))},uFogColor:{value:new S(...ie(X.haze))},uFogDensity:{value:.0011},uUnderDeep:{value:new S(...ie(X.abyss))},uUnderGlow:{value:new S(...ie(X.underGlow))},uDepthFade:{value:0},uMoonDir:{value:ai.clone()},uMoonCol:{value:new S(...ie(ri))},uEyeA:{value:new S(Ie[0].x,Ie[0].y,Ie[0].z)},uEyeB:{value:new S(Ie[1].x,Ie[1].y,Ie[1].z)},uFlash:{value:0},uFlashColor:{value:new S(...ie(X.boltGlow))},uCameraPos:{value:new S}};return{geometry:b,uniforms:m,landTex:x,vert:ei(),frag:ti()}},[e]);return se((d,b)=>{const f=n.current?.uniforms;if(!f)return;f.uTime.value+=b,f.uCameraPos.value.copy(d.camera.position),f.uFlash.value=o?.flash??0,f.uFogDensity.value=o?.fog??.0011;const x=Math.min(1,Math.max(0,(o?.depthBelow??0)/Gt.deepGrade));f.uDepthFade.value=x,xs.copy(li).lerp(ci,x*.8),f.uFogColor.value.lerpVectors(ii,xs,o?.underwater??0)}),t.jsx("mesh",{ref:s,geometry:r,frustumCulled:!1,renderOrder:1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:h,fragmentShader:c,uniforms:i,transparent:!1,side:_e},l.uuid)})}const ai=new S(...$o.dir).normalize(),ri=$o.col,ii=new S(...ie(X.haze)),li=new S(...ie(X.underHaze)),ci=new S(...ie(X.abyss)),xs=new S;function hi({quality:e="high",segments:o=200}){const n=w.useMemo(()=>{const s=o,r=new $n(Uo,Uo,s,s);r.rotateX(-Math.PI/2);const i=r.attributes.position,l=i.count,h=new Float32Array(l*3),c=new Se(X.rock),d=new Se(X.rockLit),b=new Se("#0b0e18"),f=new Se(X.snow),x=new Se(E.rockWarm),m=new Se;for(let p=0;p<l;p++){const g=i.getX(p)+pe.x,u=i.getZ(p)+pe.z,v=re(g,u);i.setX(p,g),i.setY(p,v),i.setZ(p,u);const T=qn(g,u,Uo/s)[1],k=Math.max(0,(T-.55)/.45);m.copy(c).lerp(d,R.clamp(v/190,0,1));const j=1-R.clamp((v-Br)/13,0,1);m.lerp(b,j*.85);const L=R.clamp((g-pe.x)/260,0,1),a=96-L*42,z=R.clamp((v-a)/60,0,1)*k;m.lerp(f,z*(.45+L*.5));const C=Math.hypot(g-F.x,u-F.z),A=Math.exp(-Math.pow(C/330,2)),M=R.clamp((u-F.z)/260,0,1);m.lerp(x,A*M*.6*(1-z)),h[p*3]=m.r,h[p*3+1]=m.g,h[p*3+2]=m.b}return r.setAttribute("color",new ne(h,3)),r.computeVertexNormals(),r.computeBoundingSphere(),r},[o]);return t.jsx("mesh",{geometry:n,receiveShadow:e!=="low",castShadow:!1,frustumCulled:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,roughness:.86,metalness:.02,flatShading:e==="low"})})}const Jn=-30,es=330,ui=150,fe={x:he.x,y:he.y-40,z:he.z-ui-(Jn+es)},Fe={centre:[0,96,Jn],radii:[350,235,es]},Tt={x:fe.x+Fe.centre[0],y:fe.y+Fe.centre[1],z:fe.z+Fe.centre[2]};function di(e,o,n){const s=(e-Tt.x)/Fe.radii[0],r=(o-Tt.y)/Fe.radii[1],i=(n-Tt.z)/Fe.radii[2];return Math.sqrt(s*s+r*r+i*i)}function Rn(e,o=.06){const n=(e.x-Tt.x)/Fe.radii[0],s=(e.y-Tt.y)/Fe.radii[1],r=(e.z-Tt.z)/Fe.radii[2],i=Math.sqrt(n*n+s*s+r*r),l=1+o;if(i>=l)return null;const h=i<1e-4?0:l/i;return e.x=Tt.x+(h?n*h:0)*Fe.radii[0],e.y=Tt.y+(h?s*h:l)*Fe.radii[1],e.z=Tt.z+(h?r*h:0)*Fe.radii[2],e}const le={y:0,halfX:290,zFront:228,zBack:-240},De={y:40,z:Jn+es-40,halfX:96,depth:120},dt={zTop:De.z-54,zBottom:140,halfX:74,steps:16},N={z:-290,baseY:0,halfX:130,halfZ:76,plinth:34,storey:36,storeys:6,taper:.11},Re={y:74,z:N.z+N.halfZ+26,halfX:96,depth:40},Ft=Re.y+3.5,qe={y:-95,halfX:220,halfZ:175,ceiling:-34},Te={x:0,z:84,halfX:52,halfZ:40},ye={y:52,halfZ:205,x:252,tiers:3,tierRise:46},Eo=[[96,46,340,40],[140,-64,300,34],[70,-150,240,26],[196,-8,220,28]],ge={x:74,halfW:14,zFoot:N.z+N.halfZ+158,zTop:Re.z+Re.depth/2-6},Na=[{kind:"rampZ",x0:-74-ge.halfW,x1:-74+ge.halfW,z0:ge.zFoot,z1:ge.zTop,y0:0,y1:Ft},{kind:"rampZ",x0:ge.x-ge.halfW,x1:ge.x+ge.halfW,z0:ge.zFoot,z1:ge.zTop,y0:0,y1:Ft},{kind:"flat",x0:-96,x1:Re.halfX,z0:Re.z-Re.depth/2-2,z1:ge.zTop,y:Ft},{kind:"rampZ",x0:-290,x1:-214,z0:45,z1:-45,y0:0,y1:ye.y-.5},{kind:"flat",x0:-290,x1:-214,z0:-225,z1:-45,y:ye.y-.5},{kind:"flat",x0:ye.x-38,x1:ye.x+38,z0:-225,z1:ye.halfZ+20,y:ye.y-.5}],pi=e=>e<=0?0:e>=1?1:e*e*(3-2*e),Ha=(()=>{const e=[],o=[],n=[],s=N.halfX+6,r=[s,s+9],i=[s+11,s+20],l=[s,s+20],h=[-212,-200],c=[-264,-252],d=[Ft];for(let f=2;f<=N.storeys;f++)d.push(N.plinth+f*N.storey+1.5);e.push({kind:"flat",x0:Re.halfX-6,x1:s+20,z0:-212,z1:-196,y:Ft}),o.push([(Re.halfX-6+s+20)/2,Ft,-204,s+26-Re.halfX,16]);for(let f=0;f<d.length-1;f++){const x=d[f],m=d[f+1],p=(x+m)/2;e.push({kind:"rampZ",x0:r[0],x1:r[1],z0:h[0],z1:c[1],y0:x,y1:p}),n.push({x0:r[0],x1:r[1],z0:h[0],z1:c[1],y0:x,y1:p}),e.push({kind:"flat",x0:l[0],x1:l[1],z0:c[0],z1:c[1],y:p}),o.push([(l[0]+l[1])/2,p,(c[0]+c[1])/2,l[1]-l[0],c[1]-c[0]]),e.push({kind:"rampZ",x0:i[0],x1:i[1],z0:c[1],z1:h[0],y0:p,y1:m}),n.push({x0:i[0],x1:i[1],z0:c[1],z1:h[0],y0:p,y1:m}),e.push({kind:"flat",x0:l[0],x1:l[1],z0:h[0],z1:h[1],y:m}),o.push([(l[0]+l[1])/2,m,(h[0]+h[1])/2,l[1]-l[0],h[1]-h[0]])}for(let f=1;f<d.length-1;f++){const m=1-Math.min(N.storeys,f+2)*N.taper,p=N.halfX*m,g=N.z+N.halfZ*m,u=d[f];e.push({kind:"flat",x0:p-4,x1:s,z0:-224,z1:-212,y:u}),o.push([(p-4+s)/2,u,-218,s-p+4,12]),e.push({kind:"flat",x0:-p-6,x1:p+6,z0:g,z1:-212,y:u}),o.push([0,u,(g-212)/2,p*2+12,-212-g])}const b=d[d.length-1];return e.push({kind:"flat",x0:58,x1:s,z0:-248,z1:-212,y:b}),o.push([(s+58)/2,b,-230,s-58,36]),{walks:e,slabs:o,flights:n,tower:{x:[s,s+20],z:[c[0],h[1]]}}})();Na.push(...Ha.walks);const fi=1.1;function mi(e,o,n=1/0){const s=n+fi;let r=-1/0;for(const i of Na){if(e<i.x0||e>i.x1)continue;const l=Math.min(i.z0,i.z1),h=Math.max(i.z0,i.z1);if(o<l||o>h)continue;const c=i.kind==="flat"?i.y:i.y0+(i.y1-i.y0)*pi((o-i.z0)/(i.z1-i.z0));c<=s&&c>r&&(r=c)}return r===-1/0?0:Math.max(0,r)}function gi(e,o,n=1/0){const s=o>dt.zTop?De.y:o>dt.zBottom?De.y*(o-dt.zBottom)/(dt.zTop-dt.zBottom):0,r=mi(e,o,n);return Math.max(s,r)}function xi(e,o,n){const s=N.plinth+N.storeys*N.storey;if(n>s)return!1;const i=1-(n<=N.plinth?0:Math.min(N.storeys,Math.ceil((n-N.plinth)/N.storey)))*N.taper;return Math.abs(e)<N.halfX*i&&Math.abs(o-N.z)<N.halfZ*i}const y={t:0,flash:0,flashDir:new S(0,.4,-1),fog:Gt.sea,rain:1,progress:0,shelter:0,inside:0,shot:0,underwater:0,depthBelow:0,whirlNear:0,subActive:!1,subPos:new S(0,0,0),helmActive:!1,helmPos:new S(0,0,0),helmSpeed:0,ship:{x:0,y:0,z:0,heading:Math.PI,loa:64,deckY:8.3,mastY:42},subThrottle:0,vessel:"sunny",footSpawn:"hall",splash:0,onRails:!0,orbit:{yaw:0,pitch:.12,dist:120,target:new S(0,60,-200)}};function bi(){y.t=0,y.progress=0,y.flash=0,y.fog=Gt.sea,y.rain=1,y.shot=0,y.underwater=0,y.depthBelow=0,y.whirlNear=0,y.subActive=!1,y.subThrottle=0}const hn=new Map;let _a=!0;function wi(e){_a=!!e}function yi(e){const o=vo(e);return hn.has(o)||hn.set(o,fetch(o,{method:"HEAD"}).then(n=>n.ok?!(n.headers.get("content-type")||"").includes("text/html"):!1).catch(()=>!1)),hn.get(o)}function ot(e){const[o,n]=w.useState(!1);return w.useEffect(()=>{let s=!0;return yi(e).then(r=>{s&&n(r&&_a)}),()=>{s=!1}},[e]),o}const Et=wo.map(e=>new S(...e).normalize()),Ba=new S(...Xn).normalize(),An=new S(...Qn).normalize();function vi(e){let o=1;o+=Math.max(0,e.y)*.1,o-=Math.pow(Math.max(0,e.y),4)*.2;const n=Math.exp(-Math.pow((e.y-.52)/.16,2))*Math.max(0,e.z);o+=n*.13;for(const c of Et){const d=e.dot(c),b=Math.pow(Math.max(0,d),46);o-=b*.3}const s=Math.max(0,e.dot(Ba)),r=Math.pow(s,150)*(1-Math.max(0,e.y)*.5);o-=r*.19;for(const c of Et){const d=new S(c.x*1.5,c.y-.55,c.z*.7).normalize().dot(e);o+=Math.pow(Math.max(0,d),26)*.075}const i=Math.max(0,e.dot(An));o-=Math.pow(i,30)*.11,o-=Math.pow(Math.max(0,-e.y),3)*.28;const l=Math.pow(Math.max(0,e.dot(Et[0])),30)+Math.pow(Math.max(0,e.dot(Et[1])),30),h=1-Math.min(1,l);return o+=(to(e.x*3.1+7,e.z*3.1-3,3)-.5)*.085*h,o+=(to(e.x*9.4-2,e.y*9.4+5,2)-.5)*.032*h,o}const Mi=178*1.9,et=F.r/Mi;function bs(e,o){const n=e*et,s=[new S(n*74,96*et,-20*et),new S(n*142,176*et,-58*et),new S(n*196,268*et,-76*et),new S(n*222,356*et,-52*et),new S(n*206,424*et,8*et),new S(n*154,462*et,72*et)],r=new S;for(const b of s)r.set(F.x+b.x,F.baseY+b.y,F.z+b.z),Rn(r,.12)&&b.set(r.x-F.x,r.y-F.baseY,r.z-F.z);const i=new so(s),l=o==="low"?14:o==="mid"?22:34,h=o==="low"?6:10,c=new ao(i,l,1,h,!1),d=c.attributes.position;for(let b=0;b<=l;b++){const f=b/l,x=34*et*Math.pow(1-f,.72)*(1+Math.sin(f*Math.PI)*.16),m=i.getPoint(f);for(let p=0;p<=h;p++){const g=b*(h+1)+p;if(g>=d.count)continue;const u=d.getX(g)-m.x,v=d.getY(g)-m.y,T=d.getZ(g)-m.z;d.setXYZ(g,m.x+u*x,m.y+v*x,m.z+T*x)}}return d.needsUpdate=!0,c.computeVertexNormals(),c}const ji={low:4,mid:6,high:7},Ua="skull-island.opt.glb",uo={height:1,yaw:0,lift:.02},un=new Tr,ws=new S,Ro=new S;function ki(e,o,n){Ro.set(o[0],o[1],o[2]).normalize(),ws.copy(Ro).multiplyScalar(F.r*4),un.set(ws,Ro.clone().negate()),un.far=F.r*8;const s=un.intersectObject(e,!0)[0];return s?s.point.clone().addScaledVector(Ro,-n):null}function Si({shadows:e}){const{scene:o}=La(vo(Ua)),{object:n,eyes:s,nose:r,mouth:i}=w.useMemo(()=>{const l=o.clone(!0),h=new Fa().setFromObject(l),c=new S,d=new S;h.getSize(c),h.getCenter(d);const b=F.r*F.squash[1]*1.62,f=c.y>1e-4?b*uo.height/c.y:1,x=F.r*F.squash[1]*uo.lift;l.scale.setScalar(f),l.rotation.set(0,uo.yaw,0),l.position.set(0,-d.y*f+x,0);const m=d.x*f,p=d.z*f,g=Math.cos(uo.yaw),u=Math.sin(uo.yaw);l.position.x=-(m*g+p*u),l.position.z=-(-m*u+p*g),l.updateMatrixWorld(!0);let v=0,T=0;const k={x:0,y:0,z:0},j=new S,L=[];l.traverse(P=>{P.isMesh&&L.push(P)});for(const P of L){const O=P.geometry.clone();for(const D of["position","normal"]){const $=O.attributes[D];if(!$||$.array instanceof Float32Array)continue;const Q=new Float32Array($.count*3);for(let ae=0;ae<$.count;ae++)j.fromBufferAttribute($,ae),Q[ae*3]=j.x,Q[ae*3+1]=j.y,Q[ae*3+2]=j.z;O.setAttribute(D,new ne(Q,3))}O.applyMatrix4(P.matrixWorld);const oe=O.attributes.position;T+=oe.count;for(let D=0;D<oe.count;D++)k.x=oe.getX(D)+F.x,k.y=oe.getY(D)+F.baseY,k.z=oe.getZ(D)+F.z,Rn(k,.05)&&(oe.setXYZ(D,k.x-F.x,k.y-F.baseY,k.z-F.z),v++);v&&O.computeVertexNormals(),oe.needsUpdate=!0,O.computeBoundingSphere(),O.computeBoundingBox(),P.geometry=O,P.castShadow=e,P.receiveShadow=!1;const ue=Array.isArray(P.material)?P.material:[P.material];for(const D of ue)D.color?.multiply(zi),D.roughness=.94,D.metalness=.02}for(const P of[l,...L])P.position.set(0,0,0),P.quaternion.identity(),P.scale.set(1,1,1),P.updateMatrix();l.updateMatrixWorld(!0);const a=(P,O=1)=>{const[oe,ue,D]=F.squash;return new S(P[0]*F.r*oe*O,P[1]*F.r*ue*O,P[2]*F.r*D*O)},z=wo.map(P=>ki(l,P,F.r*.1)??a(P,.82)),C=new S().addVectors(z[0],z[1]).multiplyScalar(.5),A=new S().addVectors(a(wo[0],.82),a(wo[1],.82)).multiplyScalar(.5),M=C.clone().sub(A),G=P=>{const O={x:P.x+F.x,y:P.y+F.baseY,z:P.z+F.z};return Rn(O,.22)&&P.set(O.x-F.x,O.y-F.baseY,O.z-F.z),P};return{object:l,eyes:z.map(G),nose:G(a(Xn,.87).add(M)),mouth:G(a(Qn,.9).add(M))}},[o,e]);return t.jsxs(t.Fragment,{children:[t.jsx("primitive",{object:n}),t.jsx(Wa,{eyes:s,nose:r,mouth:i,teeth:null,cast:e})]})}const zi=new Se("#8f8a84");function Wa({eyes:e,nose:o,mouth:n,teeth:s,cast:r}){const i=w.useRef(),l=w.useRef(),h=w.useRef();return se(()=>{const c=y.t,d=.82+.18*Math.sin(c*2.3)*Math.sin(c*.71),b=.82+.18*Math.sin(c*1.9+2.1)*Math.sin(c*.63),f=.86+.14*Math.sin(c*1.4+.8);i.current&&(i.current.emissiveIntensity=5.2*d+y.flash*2),l.current&&(l.current.emissiveIntensity=5.2*b+y.flash*2),h.current&&(h.current.emissiveIntensity=3.4*f)}),t.jsxs(t.Fragment,{children:[e.map((c,d)=>t.jsxs("mesh",{position:c,rotation:[-.24,0,0],children:[t.jsx("sphereGeometry",{args:[F.r*.108,20,14,0,Math.PI*2,0,Math.PI*.5]}),t.jsx("meshStandardMaterial",{ref:d===0?i:l,color:E.furnace,emissive:E.ember,emissiveIntensity:5.2,toneMapped:!1,side:_e,roughness:1})]},d)),t.jsxs("mesh",{position:o,rotation:[Math.PI*.54,0,0],children:[t.jsx("coneGeometry",{args:[F.r*.046,F.r*.083,3]}),t.jsx("meshStandardMaterial",{color:E.emberDeep,emissive:E.emberDeep,emissiveIntensity:2.4,toneMapped:!1})]}),t.jsxs("group",{position:n,children:[t.jsxs("mesh",{position:[0,F.r*.05,-F.r*.16],children:[t.jsx("planeGeometry",{args:[F.r*.62,F.r*.34]}),t.jsx("meshStandardMaterial",{ref:h,color:E.ember,emissive:E.emberDeep,emissiveIntensity:3.4,toneMapped:!1,side:_e})]}),s?.map((c,d)=>t.jsxs("mesh",{position:c.pos,scale:c.scale,rotation:[0,0,c.rot],castShadow:r,children:[t.jsx("boxGeometry",{args:[1,1,1]}),t.jsx("meshStandardMaterial",{color:"#e6d9bc",emissive:E.emberDeep,emissiveIntensity:.42,roughness:.78})]},d))]})]})}const Ti=typeof location<"u"?new URLSearchParams(location.search).get("skull"):null;function Ei({quality:e="high",shadows:o=!0}){const s=ot(Ua)&&e!=="low"&&Ti!=="proc",{dome:r,hornL:i,hornR:l,teeth:h}=w.useMemo(()=>{const m=new Sr(F.r,ji[e]??7),p=m.attributes.position,g=new Float32Array(p.count*3),u=new Se(X.rock),v=new Se(E.rockWarm),T=new Se("#120b10"),k=new Se,j=new S;for(let C=0;C<p.count;C++){j.set(p.getX(C),p.getY(C),p.getZ(C)).normalize();const A=F.r*vi(j),[M,G,P]=F.squash;p.setXYZ(C,j.x*A*M,j.y*A*G,j.z*A*P);const O=Math.max(Math.pow(Math.max(0,j.dot(Et[0])),5),Math.pow(Math.max(0,j.dot(Et[1])),5),Math.pow(Math.max(0,j.dot(An)),6)*.9);k.copy(u).lerp(v,Math.min(1,O*1.5+Math.max(0,j.z)*.22));const oe=Math.max(Math.pow(Math.max(0,j.dot(Et[0])),40),Math.pow(Math.max(0,j.dot(Et[1])),40));k.lerp(T,oe),g[C*3]=k.r,g[C*3+1]=k.g,g[C*3+2]=k.b}m.setAttribute("color",new ne(g,3)),m.computeVertexNormals();const L=new zr(1,1,1),a=[],z=9;for(let C=0;C<z;C++){const A=C/(z-1)*2-1,M=he.halfWidth*2.1,G=A*M*.5,P=Math.pow(Math.abs(A),1.7)*14,O=46-Math.abs(A)*13+C%2*7;a.push({pos:[G,he.height*.5-P-O*.5,6],scale:[M/z*.76,O,52],rot:A*.13})}return L.dispose?.(),{dome:m,hornL:bs(-1,e),hornR:bs(1,e),teeth:a}},[e]),c=o,[d,b,f]=F.squash,x=(m,p)=>[m.x*F.r*d*p,m.y*F.r*b*p,m.z*F.r*f*p];return t.jsx("group",{position:[F.x,F.baseY,F.z],children:s?t.jsx(w.Suspense,{fallback:t.jsx(ys,{dome:r,hornL:i,hornR:l,cast:c}),children:t.jsx(Si,{shadows:c})}):t.jsxs(t.Fragment,{children:[t.jsx(ys,{dome:r,hornL:i,hornR:l,cast:c}),t.jsx(Wa,{eyes:Et.map(m=>x(m,.82)),nose:x(Ba,.87),mouth:x(An,.96),teeth:h,cast:c})]})})}function ys({dome:e,hornL:o,hornR:n,cast:s}){return t.jsxs(t.Fragment,{children:[t.jsx("mesh",{geometry:e,castShadow:s,receiveShadow:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,roughness:.92,metalness:.03})}),t.jsx("mesh",{geometry:o,castShadow:s,children:t.jsx("meshStandardMaterial",{color:"#241d28",roughness:.55,metalness:.12})}),t.jsx("mesh",{geometry:n,castShadow:s,children:t.jsx("meshStandardMaterial",{color:"#241d28",roughness:.55,metalness:.12})})]})}function bt({matrices:e,target:o}){const n=w.useRef(!1);return se(()=>{if(n.current||!o.current)return;const s=Math.min(e.length,o.current.count);for(let r=0;r<s;r++)o.current.setMatrixAt(r,e[r]);o.current.instanceMatrix.needsUpdate=!0,o.current.computeBoundingSphere(),n.current=!0}),null}const $t=190,Mt=130,Ao=9.5;function vs(e,o,n,s=24){const r=new so(e),i=new ao(r,s,1,4,!1),l=i.attributes.position,h=new S(0,1,0),c=new S,d=new S,b=new S,f=new S,x=new S;for(let m=0;m<=s;m++){const p=m/s;r.getPointAt(p,d),r.getTangentAt(p,c),f.crossVectors(c,h).normalize(),b.crossVectors(f,c).normalize();for(let g=0;g<=4;g++){const u=m*5+g;if(u>=l.count)continue;const v=g/4*Math.PI*2+Math.PI/4,T=Math.cos(v)*o*.7071,k=Math.sin(v)*n*.7071;x.copy(d).addScaledVector(f,T).addScaledVector(b,k),l.setXYZ(u,x.x,x.y,x.z)}}return l.needsUpdate=!0,i.computeVertexNormals(),i}function Ri(e,o,n,s=40){const r=[];for(let c=0;c<=10;c++){const d=c/10*2-1;r.push(new S(d*e,-30*(1-d*d),0))}const i=new so(r),l=new ao(i,s,n,8,!1),h=l.attributes.position;for(let c=0;c<=s;c++){const d=c/s*2-1,b=1+(1-d*d)*.85,f=i.getPointAt(c/s);for(let x=0;x<=8;x++){const m=c*9+x;m>=h.count||h.setXYZ(m,f.x+(h.getX(m)-f.x)*b,f.y+(h.getY(m)-f.y)*b,f.z+(h.getZ(m)-f.z)*b)}}return h.needsUpdate=!0,l.computeVertexNormals(),l}function Ms({quality:e="high",shadows:o=!0,z:n=Ot,k:s=_}){const r=w.useRef(),i=w.useRef(),l=w.useRef(),h=w.useRef(),c=w.useMemo(()=>{const g=$t/2,u=Mt,v=vs([new S(-g-40,u+6,0),new S(-g-22,u+15.5,0),new S(0,u+20,0),new S(g+22,u+15.5,0),new S(g+40,u+6,0)],16,9,30),T=vs([new S(-g-30,u+2,0),new S(0,u+8,0),new S(g+30,u+2,0)],11,5,18);return{kasagi:v,shimaki:T,rope:Ri(g-6,30,6.4,44)}},[]),{tileM:d,merlonM:b,cannonM:f,lanternM:x}=w.useMemo(()=>{const g=new at,u=new yt,v=new S,T=new S,k=[],j=e==="low"?26:54;for(let A=0;A<j;A++){const M=A/(j-1)*2-1,G=M*($t/2+40),P=Mt+20-Math.pow(Math.abs(M),1.9)*14+5,O=-Math.sign(M)*Math.pow(Math.abs(M),3)*.5;T.set(G,P,0),u.setFromEuler(new Bt(0,0,O)),v.set(1,1,1),k.push(g.clone().compose(T,u,v))}const L=[];for(const A of[-1,1])for(let M=0;M<7;M++)T.set(A*(58+M*12),26,0),u.identity(),v.set(1,1,1),L.push(g.clone().compose(T,u,v));const a=[];for(const A of[-1,1])for(let M=0;M<2;M++)for(let G=0;G<4-M;G++)T.set(A*(64+G*13+M*6),32+M*10,8),u.setFromEuler(new Bt(Math.PI/2-.16,0,0)),v.set(1,1,1),a.push(g.clone().compose(T,u,v));const z=[],C=e==="low"?10:22;for(let A=0;A<C;A++){const M=A/(C-1)*2-1,G=M*($t/2-12),P=30*(1-M*M);T.set(G,Mt-34-P-7.5,0),u.identity(),v.set(1,1,1),z.push(g.clone().compose(T,u,v))}return{tileM:k,merlonM:L,cannonM:a,lanternM:z}},[e]);se(()=>{const g=y.t;r.current&&(r.current.material.emissiveIntensity=2.6+Math.sin(g*3.1)*.22+Math.sin(g*7.7)*.1+y.flash*1.4)});const m=$t/2,p=o;return t.jsxs("group",{position:[0,0,n],scale:s,children:[[-1,1].map(g=>t.jsxs("group",{position:[g*m,0,0],children:[t.jsxs("mesh",{position:[0,Mt/2-30,0],castShadow:p,children:[t.jsx("cylinderGeometry",{args:[Ao*.86,Ao,Mt+60,14]}),t.jsx("meshStandardMaterial",{color:"#6d4d86",roughness:.72})]}),t.jsxs("mesh",{position:[0,6,0],castShadow:p,children:[t.jsx("cylinderGeometry",{args:[Ao*1.5,Ao*1.85,20,14]}),t.jsx("meshStandardMaterial",{color:"#3b3547",roughness:.94})]})]},g)),t.jsxs("mesh",{position:[0,Mt-26,0],castShadow:p,children:[t.jsx("boxGeometry",{args:[$t+56,12,13]}),t.jsx("meshStandardMaterial",{color:"#6d4d86",roughness:.72})]}),t.jsx("mesh",{geometry:c.shimaki,castShadow:p,children:t.jsx("meshStandardMaterial",{color:"#5c3f72",roughness:.76})}),t.jsx("mesh",{geometry:c.kasagi,castShadow:p,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.68})}),t.jsxs("instancedMesh",{ref:i,args:[null,null,d.length],castShadow:p,children:[t.jsx("cylinderGeometry",{args:[3.4,3.4,9.5,6,1,!1,0,Math.PI]}),t.jsx("meshStandardMaterial",{color:"#8c2a1c",roughness:.6}),t.jsx(bt,{matrices:d,target:i})]}),t.jsxs("mesh",{position:[0,Mt-6,0],castShadow:p,children:[t.jsx("boxGeometry",{args:[13,30,9]}),t.jsx("meshStandardMaterial",{color:"#4b3560",roughness:.8})]}),t.jsxs("mesh",{position:[0,Mt-6,5.2],children:[t.jsx("planeGeometry",{args:[17,24]}),t.jsx("meshStandardMaterial",{color:"#2f4438",emissive:"#1d3326",emissiveIntensity:.5,roughness:.9})]}),t.jsx("mesh",{geometry:c.rope,position:[0,Mt-34,2],castShadow:p,children:t.jsx("meshStandardMaterial",{color:"#cdc5b2",emissive:"#6a6053",emissiveIntensity:.55,roughness:.97})}),[-52,-18,18,52].map(g=>{const u=30*(1-(g/($t/2-6))**2);return t.jsx("group",{position:[g,Mt-34-u-4,2],children:[0,1,2].map(v=>t.jsxs("mesh",{position:[v%2?1.1:-1.1,-2.4-v*3.6,0],children:[t.jsx("boxGeometry",{args:[3.4,3.4,.35]}),t.jsx("meshStandardMaterial",{color:"#efece2",emissive:"#cfc9b8",emissiveIntensity:.5,roughness:1,side:_e})]},v))},g)}),[-1,1].map(g=>t.jsxs("group",{children:[t.jsxs("mesh",{position:[g*108,6,0],castShadow:p,receiveShadow:p,children:[t.jsx("boxGeometry",{args:[126,44,62]}),t.jsx("meshStandardMaterial",{color:"#39404f",roughness:.95})]}),t.jsxs("mesh",{position:[g*108,30,6],castShadow:p,children:[t.jsx("boxGeometry",{args:[118,12,44]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.88})]}),t.jsxs("mesh",{position:[g*162,44,10],children:[t.jsx("boxGeometry",{args:[9,13,9]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1})]})]},g)),t.jsxs("instancedMesh",{ref:h,args:[null,null,b.length],castShadow:p,children:[t.jsx("boxGeometry",{args:[8,11,44]}),t.jsx("meshStandardMaterial",{color:"#2f3542",roughness:.95}),t.jsx(bt,{matrices:b,target:h})]}),t.jsxs("instancedMesh",{ref:l,args:[null,null,f.length],castShadow:p,children:[t.jsx("cylinderGeometry",{args:[3.4,4.4,30,10]}),t.jsx("meshStandardMaterial",{color:"#15181f",roughness:.42,metalness:.75}),t.jsx(bt,{matrices:f,target:l})]}),t.jsxs("instancedMesh",{ref:r,args:[null,null,x.length],children:[t.jsx("cylinderGeometry",{args:[3.6,3.6,6.4,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.6,toneMapped:!1}),t.jsx(bt,{matrices:x,target:r})]})]})}const Ai=(()=>{if(typeof document>"u")return null;const e=128,o=document.createElement("canvas");o.width=o.height=e;const n=o.getContext("2d"),s=n.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2);s.addColorStop(0,"rgba(255,255,255,1)"),s.addColorStop(.12,"rgba(255,255,255,0.55)"),s.addColorStop(.4,"rgba(255,255,255,0.06)"),s.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=s,n.fillRect(0,0,e,e),n.translate(e/2,e/2);for(let i=0;i<4;i++){const l=n.createLinearGradient(0,0,e/2,0);l.addColorStop(0,"rgba(255,255,255,0.95)"),l.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=l,n.beginPath(),n.moveTo(0,-2.5),n.lineTo(e/2,0),n.lineTo(0,2.5),n.closePath(),n.fill(),n.rotate(Math.PI/2)}const r=new ro(o);return r.colorSpace=io,r})();function Ii(e,o,n,s){const r=[];for(let i=0;i<=s;i++){const l=i/s,h=l*2-1;r.push(new S(e[0]+(o[0]-e[0])*l,e[1]+(o[1]-e[1])*l-n*(1-h*h),e[2]+(o[2]-e[2])*l))}return r}const Ci=[[[-62,34,26],[-6,42,-12],14],[[-6,42,-12],[52,32,18],13],[[-46,28,-30],[18,36,-40],11],[[18,36,-40],[68,26,-20],11],[[-70,22,-4],[-16,30,36],10],[[16,30,40],[72,22,12],10],[[-36,48,-62],[34,50,-66],14]];function Li({quality:e="high",shadows:o=!0}){const n=w.useRef(),s=w.useRef(),r=w.useRef(),i=w.useRef(),{lanternM:l,lampM:h,pilingM:c,katanaY:d,ground:b}=w.useMemo(()=>{const m=new at,p=new yt,g=new S(1,1,1),u=new S,v=[],T=e==="low"?.42:e==="mid"?.72:1;for(const[a,z,C]of Ci){const A=Math.max(4,Math.round(C*T)),M=Ii(a,z,14,A);for(let G=1;G<M.length-1;G++){const P=.78+G*37%11/22;u.copy(M[G]).add(new S(0,-4.2*P,0)),p.setFromEuler(new Bt(0,G*1.7%Math.PI,(G%3-1)*.06)),v.push(m.clone().compose(u,p,g.clone().multiplyScalar(P)))}}const k=[],j=e==="low"?6:11;for(let a=0;a<j;a++){const z=a/(j-1);for(const C of[-1,1]){const A=R.lerp(K.x+46,he.x-6,z)+C*(26-z*9),M=R.lerp(K.z-26,he.z+32,z);u.set(A,re(A,M)+5,M),p.identity(),k.push(m.clone().compose(u,p,g))}}const L=[];for(let a=0;a<16;a++){const z=a%2,C=Math.floor(a/2);u.set(K.x+30+C*17,-2,K.z+34+z*26),p.setFromEuler(new Bt(0,0,(a%3-1)*.035)),L.push(m.clone().compose(u,p,g))}return{lanternM:v,lampM:k,pilingM:L,katanaY:re(K.x+118,K.z-58),ground:K.y}},[e]);se(()=>{const m=y.t;if(n.current&&(n.current.material.emissiveIntensity=2.4+Math.sin(m*2.7)*.2+Math.sin(m*6.1+1.3)*.12+y.flash*1.6),i.current){const p=46*(1+Math.sin(m*1.3)*.13);i.current.scale.set(p,p,1),i.current.material.rotation=m*.07}});const f=o,x=(m,p)=>re(K.x+m,K.z+p);return t.jsxs("group",{children:[t.jsxs("group",{position:[K.x,0,K.z],children:[t.jsxs("mesh",{position:[85,7.5,47],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[128,3,60]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.92})]}),t.jsxs("mesh",{position:[18,7,4],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[96,2.4,82]}),t.jsx("meshStandardMaterial",{color:"#5a4230",roughness:.94})]}),[0,1,2,3].map(m=>t.jsxs("group",{position:[52+m*26,1.5,92+m%2*13],rotation:[0,.4+m*.3,0],children:[t.jsxs("mesh",{castShadow:f,children:[t.jsx("boxGeometry",{args:[18,5,6.5]}),t.jsx("meshStandardMaterial",{color:"#4a3524",roughness:.9})]}),t.jsxs("mesh",{position:[0,9,0],children:[t.jsx("boxGeometry",{args:[.7,14,.7]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.9})]}),t.jsxs("mesh",{position:[1.5,12,0],children:[t.jsx("planeGeometry",{args:[9,11]}),t.jsx("meshStandardMaterial",{color:"#cbbfa4",roughness:1,side:_e})]})]},m))]}),t.jsxs("instancedMesh",{ref:r,args:[null,null,c.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.8,2.1,22,7]}),t.jsx("meshStandardMaterial",{color:"#33251a",roughness:.95}),t.jsx(bt,{matrices:c,target:r})]}),t.jsxs("group",{position:[K.x+118,d,K.z-58],rotation:[0,.5,.34],scale:.6,children:[t.jsxs("mesh",{position:[0,52,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[7,132,2.1]}),t.jsx("meshStandardMaterial",{color:"#cfd8e2",roughness:.16,metalness:.92})]}),t.jsxs("mesh",{position:[0,116,0],rotation:[Math.PI/2,0,0],castShadow:f,children:[t.jsx("torusGeometry",{args:[9,2.4,6,18]}),t.jsx("meshStandardMaterial",{color:"#2a2118",roughness:.4,metalness:.75})]}),t.jsxs("mesh",{position:[0,138,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[4.4,4.9,42,10]}),t.jsx("meshStandardMaterial",{color:"#20232b",roughness:.85})]}),t.jsxs("mesh",{position:[0,161,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[5.2,5.2,5,10]}),t.jsx("meshStandardMaterial",{color:"#8a7a4e",roughness:.5,metalness:.6})]}),t.jsx("sprite",{ref:i,position:[0,116,0],scale:[46,46,1],children:t.jsx("spriteMaterial",{map:Ai,color:E.furnace,transparent:!0,opacity:.75,blending:pt,depthWrite:!1,toneMapped:!1})})]}),[-1,1].map(m=>{const p=96+m*4,g=88*m;return t.jsxs("group",{position:[K.x+p,x(p,g),K.z+g],rotation:[0,-m*.5,0],children:[t.jsxs("mesh",{position:[0,7,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[13,14,13]}),t.jsx("meshStandardMaterial",{color:"#4a4a52",roughness:.95})]}),t.jsxs("mesh",{position:[0,21,1],rotation:[.22,0,0],castShadow:f,children:[t.jsx("capsuleGeometry",{args:[5,12,4,8]}),t.jsx("meshStandardMaterial",{color:"#c9c4b4",roughness:.86})]}),t.jsxs("mesh",{position:[0,32,5],castShadow:f,children:[t.jsx("sphereGeometry",{args:[5.4,12,10]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]}),[-1,1].map(u=>t.jsxs("mesh",{position:[u*3,37,4],rotation:[0,0,u*.3],castShadow:f,children:[t.jsx("coneGeometry",{args:[2.1,6.5,4]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]},u)),t.jsxs("mesh",{position:[0,26,-8],rotation:[-.7,0,0],castShadow:f,children:[t.jsx("coneGeometry",{args:[4,20,6]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]}),t.jsxs("mesh",{position:[0,26,6.4],rotation:[.3,0,0],children:[t.jsx("planeGeometry",{args:[9,8]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.9,side:_e})]})]},m)}),[-1,1].map(m=>{const p=40+m*34,g=-18+m*46;return t.jsxs("group",{position:[K.x+p,x(p,g)+12,K.z+g],rotation:[0,m*.8,0],children:[t.jsxs("mesh",{castShadow:f,children:[t.jsx("sphereGeometry",{args:[9,12,10]}),t.jsx("meshStandardMaterial",{color:"#7c6a52",roughness:.9})]}),[-1,1].map(u=>t.jsxs("mesh",{position:[u*5,7,-1],rotation:[0,0,u*-.5],castShadow:f,children:[t.jsx("coneGeometry",{args:[1.8,8,5]}),t.jsx("meshStandardMaterial",{color:"#4c4038",roughness:.85})]},u)),t.jsxs("mesh",{position:[0,-1,8],children:[t.jsx("sphereGeometry",{args:[4.2,10,8]}),t.jsx("meshStandardMaterial",{color:E.ember,emissive:E.ember,emissiveIntensity:2.2,toneMapped:!1})]}),t.jsxs("mesh",{position:[0,-8,13],rotation:[.4,0,0],children:[t.jsx("cylinderGeometry",{args:[1.5,2.6,20,6,1,!0]}),t.jsx("meshStandardMaterial",{color:"#cfe4ee",transparent:!0,opacity:.42,roughness:.25,side:_e})]})]},m)}),t.jsxs("group",{position:[K.x-34,x(-34,30)+2,K.z+30],children:[t.jsxs("mesh",{position:[0,30,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.1,1.4,60,8]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.92})]}),t.jsxs("mesh",{position:[0,58,0],castShadow:f,children:[t.jsx("coneGeometry",{args:[34,17,20,1,!0]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.88,side:_e,emissive:E.vermilionDeep,emissiveIntensity:.4})]}),Array.from({length:10},(m,p)=>{const g=p/10*Math.PI*2;return t.jsxs("mesh",{position:[Math.cos(g)*26,55.5,Math.sin(g)*26],rotation:[0,-g,-.42],children:[t.jsx("boxGeometry",{args:[34,.6,.6]}),t.jsx("meshStandardMaterial",{color:"#2a1c12",roughness:.9})]},p)}),Array.from({length:10},(m,p)=>{const g=p/10*Math.PI*2+.31;return t.jsxs("mesh",{position:[Math.cos(g)*32,44,Math.sin(g)*32],children:[t.jsx("cylinderGeometry",{args:[2.6,2.6,4.6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.5,toneMapped:!1})]},p)})]}),[0,1,2,3].map(m=>{const p=8+m*30,g=-70-m%2*14;return t.jsxs("group",{position:[K.x+p,x(p,g),K.z+g],children:[t.jsxs("mesh",{position:[0,26,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[.6,.6,52,6]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.9})]}),t.jsxs("mesh",{position:[5,34,0],children:[t.jsx("planeGeometry",{args:[10,34]}),t.jsx("meshStandardMaterial",{color:m%2?"#e8dcc4":E.vermilion,roughness:.95,side:_e})]})]},m)}),[0,1,2].map(m=>{const p=.28+m*.24,g=R.lerp(K.x+46,he.x,p),u=R.lerp(K.z-26,he.z+26,p),v=re(g,u),T=1-m*.1;return t.jsxs("group",{position:[g,v,u],scale:T,children:[[-1,1].map(k=>t.jsxs("mesh",{position:[k*15,17,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.7,2.1,34,10]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.7})]},k)),t.jsxs("mesh",{position:[0,36,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[44,3.4,4]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.68})]}),t.jsxs("mesh",{position:[0,29,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[36,2.4,3]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.75})]})]},m)}),t.jsx("group",{position:[K.x,b,K.z],children:t.jsxs("instancedMesh",{ref:n,args:[null,null,l.length],children:[t.jsx("cylinderGeometry",{args:[3.1,3.1,5.6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1}),t.jsx(bt,{matrices:l,target:n})]})}),t.jsxs("instancedMesh",{ref:s,args:[null,null,h.length],castShadow:f,children:[t.jsx("boxGeometry",{args:[6,12,6]}),t.jsx("meshStandardMaterial",{color:"#6c6458",emissive:E.lanternFar,emissiveIntensity:1.1,roughness:.95}),t.jsx(bt,{matrices:h,target:s})]})]})}const js={low:{pine:150,sakura:90,rock:60},mid:{pine:340,sakura:190,rock:130},high:{pine:620,sakura:340,rock:240}};function Fi(e){let o=e>>>0;return()=>(o=Math.imul(o,1664525)+1013904223>>>0,o/4294967296)}function Pi({quality:e="high",shadows:o=!0}){const n=w.useRef(),s=w.useRef(),r=w.useRef(),i=w.useRef(),{pineTrunkM:l,pineCanopyM:h,sakuraM:c,rockM:d}=w.useMemo(()=>{const f=js[e]??js.high,x=Fi(20250801),m=new at,p=new yt,g=new S,u=new S,v=new S(0,1,0),T=new S,k=[],j=[],L=[],a=f.pine+f.sakura+f.rock;let z=0,C=0;for(;z<a&&C<a*60;){C++;const A=x()*Math.PI*2,M=wt*(.55+x()*.62),G=pe.x+Math.sin(A)*M,P=pe.z+Math.cos(A)*M,O=re(G,P);if(O<5||O>300||Vr(G,P,6)>.72||Math.hypot(G-F.x,P-F.z)<F.r*1.35)continue;const oe=G>pe.x+(x()-.5)*90,ue=z;if(z++,u.set(G,O,P),ue<f.rock){const D=qn(G,P,5);T.set(D[0],D[1],D[2]),p.setFromUnitVectors(v,T),p.multiply(new yt().setFromEuler(new Bt(x()*.5,x()*6.28,x()*.5)));const $=2.5+x()*7;g.set($*(.7+x()*.6),$*(.5+x()*.5),$*(.7+x()*.6)),u.y-=$*.25,L.push(m.clone().compose(u,p,g))}else if(oe){if(k.length>=f.pine)continue;p.setFromEuler(new Bt(0,x()*6.28,(x()-.5)*.09));const D=.72+x()*.7;g.set(D,D*(.85+x()*.45),D),k.push(m.clone().compose(u,p,g))}else{if(j.length>=f.sakura)continue;p.setFromEuler(new Bt(0,x()*6.28,(x()-.5)*.13));const D=.7+x()*.75;g.set(D,D*(.8+x()*.5),D),j.push(m.clone().compose(u,p,g))}}return{pineTrunkM:k.map(A=>A.clone().multiply(Gi)).concat(j.map(A=>A.clone().multiply(Ni))),pineCanopyM:k.map(A=>A.clone().multiply(Oi)),sakuraM:j.map(A=>A.clone().multiply(Di)),rockM:L}},[e]),b=o;return t.jsxs(t.Fragment,{children:[t.jsxs("instancedMesh",{ref:n,args:[null,null,l.length],castShadow:b,children:[t.jsx("cylinderGeometry",{args:[.9,1.7,14,5]}),t.jsx("meshStandardMaterial",{color:"#1d1a1c",roughness:.96}),t.jsx(bt,{matrices:l,target:n})]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,h.length],castShadow:b,children:[t.jsx("coneGeometry",{args:[8.5,30,7]}),t.jsx("meshStandardMaterial",{color:X.pine,roughness:.93,flatShading:!0}),t.jsx(bt,{matrices:h,target:s})]}),t.jsxs("instancedMesh",{ref:r,args:[null,null,c.length],castShadow:b,children:[t.jsx("sphereGeometry",{args:[7.5,8,6]}),t.jsx("meshStandardMaterial",{color:E.sakura,roughness:.95,flatShading:!0,emissive:E.sakura,emissiveIntensity:.1}),t.jsx(bt,{matrices:c,target:r})]}),t.jsxs("instancedMesh",{ref:i,args:[null,null,d.length],castShadow:b,receiveShadow:b,children:[t.jsx("dodecahedronGeometry",{args:[1,0]}),t.jsx("meshStandardMaterial",{color:X.rock,roughness:.97,flatShading:!0}),t.jsx(bt,{matrices:d,target:i})]})]})}const Gi=new at().makeTranslation(0,7,0),Oi=new at().makeTranslation(0,26,0),Di=new at().compose(new S(0,13,0),new yt,new S(1,.72,1)),Ni=new at().compose(new S(0,5,0),new yt,new S(.75,.62,.75)),zt=Math.PI,ks={"ship-sunny.opt.glb":zt/2,"ship-tang.opt.glb":zt/2,"ship-punk.opt.glb":zt/2,"ship-lion.opt.glb":zt/2,"ship-bone.opt.glb":zt/2,"ship-junk.opt.glb":zt/2,"ship-warjunk.opt.glb":zt/2,"ship-sub.opt.glb":-zt/2},an=e=>e&&ks[e]!==void 0?ks[e]:zt/2,Hi={"ship-sunny.opt.glb":40,"ship-lion.opt.glb":40,"ship-punk.opt.glb":52,"ship-tang.opt.glb":32,"ship-sub.opt.glb":32,"ship-bone.opt.glb":50,"ship-junk.opt.glb":38,"ship-warjunk.opt.glb":60},co=1.6,Ss=Object.fromEntries(Object.entries(Hi).map(([e,o])=>[e,Math.round(o*co)])),zs={"ship-sunny.opt.glb":.6,"ship-lion.opt.glb":.8,"ship-punk.opt.glb":.62,"ship-tang.opt.glb":.62,"ship-sub.opt.glb":.72,"ship-bone.opt.glb":.72,"ship-junk.opt.glb":.53,"ship-warjunk.opt.glb":.6},rn=2,Ts={"ship-sunny.opt.glb":.513,"ship-lion.opt.glb":.274,"ship-punk.opt.glb":.264,"ship-tang.opt.glb":.208,"ship-sub.opt.glb":.261,"ship-bone.opt.glb":.353,"ship-junk.opt.glb":.313,"ship-warjunk.opt.glb":.415},Es={"ship-sunny.opt.glb":1.044,"ship-lion.opt.glb":.824,"ship-punk.opt.glb":.673,"ship-tang.opt.glb":1,"ship-sub.opt.glb":.641,"ship-bone.opt.glb":.771,"ship-junk.opt.glb":.915,"ship-warjunk.opt.glb":.702},Rs={"ship-sunny.opt.glb":.165,"ship-lion.opt.glb":.095,"ship-punk.opt.glb":.115,"ship-bone.opt.glb":.105,"ship-junk.opt.glb":.1,"ship-warjunk.opt.glb":.115,"ship-tang.opt.glb":.035,"ship-sub.opt.glb":.035},As={"ship-sunny.opt.glb":.28,"ship-lion.opt.glb":.144,"ship-punk.opt.glb":.148,"ship-tang.opt.glb":.41,"ship-sub.opt.glb":.214,"ship-bone.opt.glb":.158,"ship-junk.opt.glb":.21,"ship-warjunk.opt.glb":.244},ts=(e,o)=>(e&&As[e]!==void 0?As[e]:.2)*o/2,Wo=[[0,.26,0],[-.55,.02,.7],[.55,-.08,-.9],[0,-.27,Math.PI*.85]],os=(e,o,[n,s])=>[n*ts(e,o),s*o],Ya=e=>e==="low"?Wo.slice(0,1):e==="mid"?Wo.slice(0,2):Wo,_i=2.8,Va=_i*co,jo=e=>Va*(.72+.28*(e/(40*co))),qo=.28*co,Jo=5.2*co,Is={"ship-sunny.opt.glb":"#e6ded0","ship-punk.opt.glb":"#c9bfae","ship-tang.opt.glb":"#ece3cd","ship-lion.opt.glb":"#9a9188","ship-sub.opt.glb":"#9a9188","ship-bone.opt.glb":"#9a9188"},ns=(e,o="#9a9188")=>e&&Is[e]!==void 0?Is[e]:o,Bi={"ship-tang.opt.glb":["#e8c34a",.85],"ship-sub.opt.glb":["#e8c34a",.85],"ship-sunny.opt.glb":["#c9a06a",.2],"ship-punk.opt.glb":["#b06a5a",.2]},en=e=>e&&Bi[e]||null,ln=(e,o=34)=>e&&Ss[e]!==void 0?Ss[e]:o,cn=e=>e&&zs[e]!==void 0?zs[e]:1,Ui=e=>e&&Ts[e]!==void 0?Ts[e]:.2,$a=e=>e&&Rs[e]!==void 0?Rs[e]:.13,zo=e=>Math.max(0,Ui(e)-$a(e)),At=(e,o)=>$a(e)*o,ko=(e,o)=>((e&&Es[e]!==void 0?Es[e]:.8)-zo(e))*o,Cs={sunny:{id:"sunny",name:"THOUSAND SUNNY",crewName:"STRAW HAT",hulls:["ship-sunny.opt.glb","ship-lion.opt.glb"],flag:"straw",crew:"crew-straw.opt.glb",fleetId:"straw-hats",tint:"#c98a52",burst:{push:62,charge:9,label:"BURST",sub:"coup de"},topSpeed:64,accel:16,turn:.92},punk:{id:"punk",name:"VICTORIA PUNK",crewName:"KID",hulls:["ship-punk.opt.glb","ship-bone.opt.glb"],flag:"kid",crew:"crew-punk.opt.glb",fleetId:"kid",tint:"#9a6a4e",burst:{push:78,charge:13,label:"RAM",sub:"full ahead"},topSpeed:60,accel:12,turn:.74}},In=e=>Cs[e]??Cs.sunny,Ka=210,Ls={off:1,lead:.98*co*.77},dn={SPREAD:28,SWEEP:14,RANK:118},Fs=(e,o=0,n=0)=>({off:(e+(n?.5*Math.sign(e||1):0))*dn.SPREAD,lead:o-Math.abs(e)*dn.SWEEP-n*dn.RANK}),Ps={kozuki:{side:-1,from:2},yakuza:{side:1,from:2},mink:{side:0,from:9}};function Wi(e){const o={},n={};for(const s of e){const r=Yi[s.id];if(r){Object.assign(s,Fs(r[0],r[1]));continue}const i=Ps[s.faction]?s.faction:"kozuki",l=Ps[i],h=s.rank??0,c=`${i}:${h}`;o[c]===void 0&&(o[c]=l.from,n[c]=-1);const d=l.side||n[c];Object.assign(s,Fs(d*o[c],0,h)),l.side===0?(n[c]>0&&(o[c]+=1),n[c]=-n[c]):o[c]+=1}}const Yi={scabbards:[0,Ka],"straw-hats":[-1,150],kid:[1,150],heart:[0,60]},Vi=430*_;function $i(e,o=0){const n=(820+-670*e)*_+o;return[(Math.sin(e*2.4)*54-e*26)*_,n]}function Ki(e,o,n,s){const[r,i]=$i(n,s);return[r+o*_*Ls.off,i-e*_*Ls.lead]}const Xi=[{x:-300*_,z:100*_,yaw:.35},{x:330*_,z:360*_,yaw:-.55},{x:-390*_,z:470*_,yaw:.12},{x:420*_,z:830*_,yaw:-.28},{x:-455*_,z:930*_,yaw:.48},{x:400*_,z:1120*_,yaw:-.16},{x:-520*_,z:690*_,yaw:.22},{x:540*_,z:1290*_,yaw:-.42}],Qi=[{x:K.x+132*_*.72,z:K.z+96*_*.72,yaw:2.3},{x:K.x+168*_*.72,z:K.z+40*_*.72,yaw:1.9},{x:K.x+96*_*.72,z:K.z+150*_*.72,yaw:2.7}];function Zi({url:e,height:o,loa:n,slim:s=1,sink:r=0,rotation:i,tint:l,emissive:h,emissiveIntensity:c,glow:d,onMaterials:b}){const{scene:f}=La(e),x=w.useMemo(()=>f.clone(!0),[f]),m=w.useMemo(()=>{const p=new Fa().setFromObject(x),g=new S;p.getSize(g);const u=new S;if(p.getCenter(u),n){const T=g.x>=g.z,k=Math.max(T?g.x:g.z,1e-4),j=n/k,L=T?[j,j,j*s]:[j*s,j,j];return{scale:L,offset:[-u.x*L[0],-p.min.y*L[1]-n*r,-u.z*L[2]]}}const v=g.y>1e-4?o/g.y:1;return{scale:[v,v,v],offset:[-u.x*v,-p.min.y*v,-u.z*v]}},[x,o,n,s,r]);return w.useEffect(()=>{const p=[];x.traverse(g=>{if(!g.isMesh)return;g.castShadow=!0,g.receiveShadow=!0;const u=g.material?Array.isArray(g.material)?g.material:[g.material]:[];for(const v of u)p.push(v),l&&(v.color?.multiply(new Se(l)),h&&v.emissive&&(v.emissive.set(h),v.emissiveIntensity=c??.2)),d&&v.emissive&&(v.emissive.set(d[0]),v.emissiveIntensity=d[1],v.map&&!v.emissiveMap&&(v.emissiveMap=v.map),v.needsUpdate=!0)}),b?.(p)},[x,l,h,c,d,b]),t.jsx("group",{rotation:[0,i,0],scale:m.scale,position:m.offset,children:t.jsx("primitive",{object:x})})}class qi extends w.Component{constructor(){super(...arguments);ps(this,"state",{failed:!1})}static getDerivedStateFromError(){return{failed:!0}}componentDidCatch(n){}render(){return this.state.failed?this.props.fallback:this.props.children}}function xe({name:e,height:o,loa:n=null,slim:s=1,sink:r=0,rotation:i=0,position:l=[0,0,0],tint:h=null,emissive:c=null,emissiveIntensity:d=.2,glow:b=null,onMaterials:f=null,fallback:x=null}){const m=vo(e);return ot(e)?t.jsx("group",{position:l,children:t.jsx(qi,{url:m,fallback:x,children:t.jsx(w.Suspense,{fallback:x,children:t.jsx(Zi,{url:m,height:o,loa:n,slim:s,sink:r,rotation:i,tint:h,emissive:c,emissiveIntensity:d,glow:b,onMaterials:f})})})}):t.jsx("group",{position:l,children:x})}const Cn=(()=>{if(typeof document>"u")return null;const e=64,o=128,n=document.createElement("canvas");n.width=e,n.height=o;const s=n.getContext("2d"),r=s.createImageData(e,o);for(let l=0;l<o;l++){const h=l/(o-1),c=Math.pow(1-h,1.7);for(let d=0;d<e;d++){const b=d/(e-1)*2-1,f=Math.max(0,1-Math.abs(b)/(.35+h*.65)),x=.45+.55*Math.pow(Math.abs(b)/(.35+h*.65),1.5),m=c*Math.pow(f,1.4)*x,p=(l*e+d)*4;r.data[p]=255,r.data[p+1]=255,r.data[p+2]=255,r.data[p+3]=Math.round(Math.min(1,m)*255)}}s.putImageData(r,0,0);const i=new ro(n);return i.colorSpace=io,i})(),Ji=(()=>{if(typeof document>"u")return null;const e=64,o=document.createElement("canvas");o.width=e,o.height=e;const n=o.getContext("2d"),s=n.createImageData(e,e);for(let i=0;i<e;i++){const l=i/(e-1),h=Math.pow(1-l,1.5);for(let c=0;c<e;c++){const d=c/(e-1)*2-1,b=Math.max(0,1-Math.abs(d)),f=h*Math.pow(b,1.3),x=(i*e+c)*4;s.data[x]=255,s.data[x+1]=255,s.data[x+2]=255,s.data[x+3]=Math.round(Math.min(1,f)*255)}}n.putImageData(s,0,0);const r=new ro(o);return r.colorSpace=io,r})(),ss=(()=>{if(typeof document>"u")return null;const e=64,o=document.createElement("canvas");o.width=e,o.height=e;const n=o.getContext("2d"),s=n.createRadialGradient(e/2,e/2,2,e/2,e/2,e/2);s.addColorStop(0,"rgba(255,255,255,0.9)"),s.addColorStop(.4,"rgba(255,255,255,0.28)"),s.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=s,n.fillRect(0,0,e,e);const r=new ro(o);return r.colorSpace=io,r})(),Yo=160,Zt=112,qt="#e6dfcf",Xa="#0c0a15",Jt=Xa;typeof CanvasRenderingContext2D<"u"&&!CanvasRenderingContext2D.prototype.roundRect&&(CanvasRenderingContext2D.prototype.roundRect=function(e,o,n,s,r){const i=Math.min(r??0,Math.abs(n)/2,Math.abs(s)/2);return this.moveTo(e+i,o),this.arcTo(e+n,o,e+n,o+s,i),this.arcTo(e+n,o+s,e,o+s,i),this.arcTo(e,o+s,e,o,i),this.arcTo(e,o,e+n,o,i),this.closePath(),this});function _t(e){if(typeof document>"u")return null;const o=document.createElement("canvas");o.width=Yo,o.height=Zt;const n=o.getContext("2d"),s=n.createLinearGradient(0,0,0,Zt);s.addColorStop(0,"#14101f"),s.addColorStop(.5,Xa),s.addColorStop(1,"#08060f"),n.fillStyle=s,n.fillRect(0,0,Yo,Zt),n.fillStyle="rgba(255,255,255,0.07)",n.fillRect(0,0,5,Zt),n.save(),n.translate(Yo/2+4,Zt/2);try{e(n)}catch(i){console.warn("[onigashima] flag emblem skipped",i)}n.restore();const r=new ro(o);return r.colorSpace=io,r.anisotropy=4,r}function pn(e,o,n=qt){e.fillStyle=n,e.beginPath(),e.ellipse(0,-o*.12,o,o*.92,0,0,Math.PI*2),e.fill(),e.beginPath(),e.roundRect(-o*.52,o*.6,o*1.04,o*.5,o*.16),e.fill()}function fn(e,o,n=1){e.save(),e.fillStyle=Jt,e.beginPath(),e.ellipse(-o*.38,-o*.2,o*.27*n,o*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.ellipse(o*.38,-o*.2,o*.27*n,o*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.moveTo(0,o*.06),e.lineTo(-o*.14,o*.34),e.lineTo(o*.14,o*.34),e.closePath(),e.fill(),e.restore()}function Gs(e,o,n=4){e.save(),e.fillStyle=Jt;for(let s=1;s<n;s++){const r=-o*.5+s*o/n;e.fillRect(r-o*.035,o*.6,o*.07,o*.5)}e.fillRect(-o*.52,o*.78,o*1.04,o*.05),e.restore()}function Os(e,o,n=qt){e.save(),e.strokeStyle=n,e.lineWidth=o*.17,e.lineCap="round";for(const s of[1,-1]){e.save(),e.rotate(s*Math.PI/4.4),e.beginPath(),e.moveTo(-o*1.55,o*.55),e.lineTo(o*1.55,o*.55),e.stroke(),e.fillStyle=n;for(const r of[-1,1])for(const i of[-.16,.16])e.beginPath(),e.arc(r*o*1.55,o*.55+i*o,o*.15,0,Math.PI*2),e.fill();e.restore()}e.restore()}const el={straw:_t(e=>{Os(e,26),pn(e,26),fn(e,26),Gs(e,26),e.fillStyle="#e8c86a",e.beginPath(),e.ellipse(0,-26*.86,26*1.5,26*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.roundRect(-26*.78,-26*1.5,26*1.56,26*.7,26*.22),e.fill(),e.fillStyle="#d63420",e.fillRect(-26*.8,-26*1.06,26*1.6,26*.22)}),heart:_t(e=>{const n="#a8e8d4";e.fillStyle=n,e.beginPath(),e.ellipse(0,0,27*1.02,27*1,0,0,Math.PI*2),e.fill(),e.save(),e.fillStyle=Jt;for(const s of[-1,1])e.beginPath(),e.arc(s*27*.36,-27*.2,27*.2,0,Math.PI*2),e.fill();e.lineWidth=27*.13,e.strokeStyle=Jt,e.beginPath(),e.arc(0,27*.12,27*.52,.24*Math.PI,.76*Math.PI),e.stroke(),e.restore(),e.fillStyle="#d63420",e.beginPath(),e.moveTo(0,-27*1.34),e.bezierCurveTo(27*.5,-27*1.9,27*.9,-27*1.2,0,-27*.78),e.bezierCurveTo(-27*.9,-27*1.2,-27*.5,-27*1.9,0,-27*1.34),e.fill()}),kid:_t(e=>{Os(e,26,"#d8cfc0"),e.fillStyle=qt,e.beginPath(),e.moveTo(-26*1.05,-26*.5),e.lineTo(-26*.7,-26*1.05),e.lineTo(26*.7,-26*1.05),e.lineTo(26*1.05,-26*.5),e.lineTo(26*.72,26*.5),e.lineTo(-26*.72,26*.5),e.closePath(),e.fill(),e.beginPath(),e.roundRect(-26*.62,26*.42,26*1.24,26*.62,26*.1),e.fill(),e.save(),e.fillStyle=Jt;for(const n of[-1,1])e.save(),e.translate(n*26*.4,-26*.3),e.rotate(n*.35),e.beginPath(),e.roundRect(-26*.28,-26*.2,26*.56,26*.4,26*.1),e.fill(),e.restore();for(let n=0;n<6;n++){const s=-15.6+n*26*1.2/5;e.beginPath(),e.moveTo(s,26*.42),e.lineTo(s+26*.1,26*1.04),e.lineTo(s-26*.1,26*1.04),e.closePath(),e.fill()}e.restore()}),kozuki:_t(e=>{e.strokeStyle="#e8b06a",e.lineWidth=30*.1,e.beginPath(),e.arc(0,0,30*1.06,0,Math.PI*2),e.stroke(),e.fillStyle="#d63420";for(let n=0;n<5;n++){const s=n/5*Math.PI*2-Math.PI/2;e.save(),e.rotate(s),e.beginPath(),e.ellipse(0,-30*.52,30*.26,30*.42,0,0,Math.PI*2),e.fill(),e.restore()}e.fillStyle="#e8c86a",e.beginPath(),e.arc(0,0,30*.24,0,Math.PI*2),e.fill()}),yakuza:_t(e=>{e.strokeStyle="#e8c86a",e.lineWidth=28*.12,e.beginPath(),e.roundRect(-28*.86,-28*.86,28*1.72,28*1.72,28*.14),e.stroke(),e.fillStyle=qt;for(const n of[-.42,0,.42])e.fillRect(-28*.52,n*28-28*.07,28*1.04,28*.15);e.fillRect(-28*.09,-28*.55,28*.18,28*1.1),e.fillStyle="#d63420",e.beginPath(),e.arc(0,-28*1.32,28*.2,0,Math.PI*2),e.fill()}),mink:_t(e=>{e.fillStyle=qt;for(const n of[-1,1])e.beginPath(),e.moveTo(n*25*.5,-25*.85),e.lineTo(n*25*1.02,-25*1.72),e.lineTo(n*25*1.06,-25*.6),e.closePath(),e.fill();pn(e,25),e.beginPath(),e.roundRect(-25*.34,25*.42,25*.68,25*.78,25*.2),e.fill(),fn(e,25,.85),e.save(),e.fillStyle=Jt,e.fillRect(-25*.32,25*.72,25*.64,25*.06),e.restore(),e.fillStyle=qt;for(const n of[-1,1])e.beginPath(),e.moveTo(n*25*.3,25*.7),e.lineTo(n*25*.42,25*1.42),e.lineTo(n*25*.16,25*.78),e.closePath(),e.fill()}),beasts:_t(e=>{e.fillStyle="#cfd8e4";for(const n of[-1,1])e.beginPath(),e.moveTo(n*26*.62,-26*.78),e.quadraticCurveTo(n*26*1.5,-26*1.5,n*26*1.18,-26*2),e.quadraticCurveTo(n*26*1.42,-26*1.35,n*26*.86,-26*.5),e.closePath(),e.fill();pn(e,26,"#cfd8e4"),fn(e,26),Gs(e,26,5),e.fillStyle="#c9411a",e.beginPath(),e.roundRect(-26*.74,26*.34,26*1.48,26*.2,26*.1),e.fill()})},Qa={value:0},Ds=new Map;function tl(e){const o=Ds.get(e);if(o)return o;const n=el[e],s=new Er({map:n,emissiveMap:n,emissive:new Se("#9fb4d8"),emissiveIntensity:.95,roughness:.94,metalness:0,side:_e,transparent:!1});return s.onBeforeCompile=r=>{r.uniforms.uTime=Qa,r.vertexShader=`uniform float uTime;
`+r.vertexShader.replace("#include <begin_vertex>",`
      ...
      `)},s.customProgramCacheKey=()=>"onigashima-flag",Ds.set(e,s),s}function ol(){return se((e,o)=>{Qa.value+=Math.min(o,.05)}),null}const nl=(()=>{const e=new $n(1,1,14,5);return e.translate(.5,0,0),e})();function So({crew:e="straw",width:o=Va,position:n=[0,0,0],rotation:s=Math.PI/2,staff:r=!0}){const i=w.useMemo(()=>tl(e)??null,[e]),l=o*(Zt/Yo);return i?t.jsxs("group",{position:n,rotation:[0,s,0],children:[r&&t.jsxs("mesh",{position:[0,l*.1,0],children:[t.jsx("cylinderGeometry",{args:[o*.028,o*.028,l*1.5,4]}),t.jsx("meshStandardMaterial",{color:"#241a12",roughness:.9})]}),t.jsxs("mesh",{position:[-o*.02,-l*1.1,0],rotation:[0,0,-.06],children:[t.jsx("cylinderGeometry",{args:[o*.012,o*.012,l*2.4,3]}),t.jsx("meshStandardMaterial",{color:"#6b5f4a",emissive:"#6b5f4a",emissiveIntensity:.35,roughness:.9})]}),t.jsx("mesh",{geometry:nl,material:i,scale:[o,l,o]})]}):null}const Vo=[{id:"scabbards",flag:"kozuki",lead:Ka,off:-14,scale:.62,sail:null,hull:"#3d2a1c",lamp:E.lantern,open:!0},{id:"straw-hats",flag:"straw",lead:118,off:-88,scale:1.15,sail:"#f0e6cf",hull:"#c9762e",lamp:E.lantern,figurehead:!0,model2:"ship-sunny.opt.glb",model:"ship-lion.opt.glb",tint:"#c98a52",crew:"crew-straw.opt.glb",sailedBy:"helm"},{id:"kid",flag:"kid",lead:112,off:88,scale:1.1,sail:"#2a2233",hull:"#5b2233",lamp:"#ff5a3c",model2:"ship-punk.opt.glb",model:"ship-bone.opt.glb",tint:"#9a6a4e",crew:"crew-punk.opt.glb",sailedBy:"helm"},{id:"heart",flag:"heart",lead:156,off:2,scale:.8,sail:null,hull:"#c9b03a",lamp:"#ffe08a",sub:!0,model2:"ship-tang.opt.glb",model:"ship-sub.opt.glb",tint:"#c9b445",crew:"crew-heart.opt.glb",sailedBy:"sub"},{id:"kozuki-0",faction:"kozuki",flag:"kozuki",rank:0,scale:.86,sail:"#cfc4ac",hull:"#4a3728",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#8a7a62",crew:"crew-samurai.opt.glb"},{id:"kozuki-1",faction:"kozuki",flag:"kozuki",rank:0,scale:.848,sail:"#c6bba4",hull:"#453322",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#7e6f58",crew:"crew-samurai.opt.glb"},{id:"kozuki-2",faction:"kozuki",flag:"kozuki",rank:0,scale:.836,sail:"#c2b79f",hull:"#3a2d20",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#7a6c56",crew:"crew-samurai.opt.glb"},{id:"kozuki-3",faction:"kozuki",flag:"kozuki",rank:0,scale:.824,sail:"#bdb29a",hull:"#37291d",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6f6250",crew:"crew-samurai.opt.glb"},{id:"kozuki-4",faction:"kozuki",flag:"kozuki",rank:0,scale:.812,sail:"#c8bda6",hull:"#3c2e21",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#837458",crew:"crew-samurai.opt.glb"},{id:"kozuki-5",faction:"kozuki",flag:"kozuki",rank:0,scale:.8,sail:"#beb39b",hull:"#382a1e",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6a5c47",crew:"crew-samurai.opt.glb"},{id:"kozuki-6",faction:"kozuki",flag:"kozuki",rank:0,scale:.788,sail:"#bcb199",hull:"#362820",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6d5f4a",crew:"crew-samurai.opt.glb"},{id:"kozuki-7",faction:"kozuki",flag:"kozuki",rank:0,scale:.776,sail:"#c4b9a1",hull:"#382b1f",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#7b6c53",crew:"crew-samurai.opt.glb"},{id:"kozuki-8",faction:"kozuki",flag:"kozuki",rank:0,scale:.764,sail:"#c9bea7",hull:"#392c20",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#81725a",crew:"crew-samurai.opt.glb"},{id:"yakuza-0",faction:"yakuza",flag:"yakuza",rank:0,scale:.84,sail:"#b8a894",hull:"#4d3026",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#8a6a55",crew:"crew-samurai.opt.glb"},{id:"yakuza-1",faction:"yakuza",flag:"yakuza",rank:0,scale:.828,sail:"#b2a28e",hull:"#472b22",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#7f6150",crew:"crew-samurai.opt.glb"},{id:"yakuza-2",faction:"yakuza",flag:"yakuza",rank:0,scale:.816,sail:"#ad9d89",hull:"#42271f",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#78594a",crew:"crew-samurai.opt.glb"},{id:"yakuza-3",faction:"yakuza",flag:"yakuza",rank:0,scale:.804,sail:"#bfae99",hull:"#4a2e24",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#8d6d57",crew:"crew-samurai.opt.glb"},{id:"yakuza-4",faction:"yakuza",flag:"yakuza",rank:0,scale:.792,sail:"#a89884",hull:"#3d241d",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#715446",crew:"crew-samurai.opt.glb"},{id:"yakuza-5",faction:"yakuza",flag:"yakuza",rank:0,scale:.78,sail:"#b5a591",hull:"#452a21",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#83654f",crew:"crew-samurai.opt.glb"},{id:"yakuza-6",faction:"yakuza",flag:"yakuza",rank:0,scale:.768,sail:"#aa9a86",hull:"#402620",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#755949",crew:"crew-samurai.opt.glb"},{id:"yakuza-7",faction:"yakuza",flag:"yakuza",rank:0,scale:.756,sail:"#bcac97",hull:"#482c23",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#886851",crew:"crew-samurai.opt.glb"},{id:"yakuza-8",faction:"yakuza",flag:"yakuza",rank:0,scale:.744,sail:"#a5957f",hull:"#3a221b",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6d5142",crew:"crew-samurai.opt.glb"},{id:"mink-0",faction:"mink",flag:"mink",rank:0,scale:.9,sail:"#d2c7ae",hull:"#3f3a2c",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6e6a54",crew:"crew-samurai.opt.glb"},{id:"mink-1",faction:"mink",flag:"mink",rank:0,scale:.886,sail:"#cdc2aa",hull:"#42392b",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#68644e",crew:"crew-samurai.opt.glb"},{id:"mink-2",faction:"mink",flag:"mink",rank:0,scale:.872,sail:"#cbc0a8",hull:"#403729",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6c684f",crew:"crew-samurai.opt.glb"},{id:"mink-3",faction:"mink",flag:"mink",rank:0,scale:.858,sail:"#c6bba3",hull:"#3d352a",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#666249",crew:"crew-samurai.opt.glb"},{id:"kozuki-0b",faction:"kozuki",flag:"kozuki",rank:1,scale:.8,sail:"#cfc4ac",hull:"#4a3728",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#8a7a62",crew:"crew-samurai.opt.glb"},{id:"kozuki-1b",faction:"kozuki",flag:"kozuki",rank:1,scale:.788,sail:"#c6bba4",hull:"#453322",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#7e6f58",crew:"crew-samurai.opt.glb"},{id:"kozuki-2b",faction:"kozuki",flag:"kozuki",rank:1,scale:.776,sail:"#c2b79f",hull:"#3a2d20",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#7a6c56",crew:"crew-samurai.opt.glb"},{id:"kozuki-3b",faction:"kozuki",flag:"kozuki",rank:1,scale:.764,sail:"#bdb29a",hull:"#37291d",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6f6250",crew:"crew-samurai.opt.glb"},{id:"kozuki-4b",faction:"kozuki",flag:"kozuki",rank:1,scale:.752,sail:"#c8bda6",hull:"#3c2e21",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#837458",crew:"crew-samurai.opt.glb"},{id:"yakuza-0b",faction:"yakuza",flag:"yakuza",rank:1,scale:.78,sail:"#b8a894",hull:"#4d3026",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#8a6a55",crew:"crew-samurai.opt.glb"},{id:"yakuza-1b",faction:"yakuza",flag:"yakuza",rank:1,scale:.768,sail:"#b2a28e",hull:"#472b22",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#7f6150",crew:"crew-samurai.opt.glb"},{id:"yakuza-2b",faction:"yakuza",flag:"yakuza",rank:1,scale:.756,sail:"#ad9d89",hull:"#42271f",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#78594a",crew:"crew-samurai.opt.glb"},{id:"yakuza-3b",faction:"yakuza",flag:"yakuza",rank:1,scale:.744,sail:"#bfae99",hull:"#4a2e24",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#8d6d57",crew:"crew-samurai.opt.glb"},{id:"yakuza-4b",faction:"yakuza",flag:"yakuza",rank:1,scale:.732,sail:"#a89884",hull:"#3d241d",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#715446",crew:"crew-samurai.opt.glb"},{id:"mink-0b",faction:"mink",flag:"mink",rank:1,scale:.84,sail:"#cec3ab",hull:"#42392c",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6a6650",crew:"crew-samurai.opt.glb"},{id:"mink-1b",faction:"mink",flag:"mink",rank:1,scale:.826,sail:"#cabfa7",hull:"#40372a",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#6b674e",crew:"crew-samurai.opt.glb"},{id:"mink-2b",faction:"mink",flag:"mink",rank:1,scale:.812,sail:"#ccc1a9",hull:"#413828",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#69654d",crew:"crew-samurai.opt.glb"},{id:"mink-3b",faction:"mink",flag:"mink",rank:1,scale:.798,sail:"#c8bda5",hull:"#3f3629",lamp:E.lantern,model:"ship-junk.opt.glb",tint:"#676349",crew:"crew-samurai.opt.glb"}];Wi(Vo);function Ns({color:e,position:o,scale:n=1}){return t.jsxs("group",{position:o,children:[t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[qo*n,7,5]}),t.jsx("meshStandardMaterial",{color:e,emissive:e,emissiveIntensity:3.2,toneMapped:!1})]}),t.jsx("sprite",{scale:[Jo*n,Jo*n,1],children:t.jsx("spriteMaterial",{map:ss,color:e,transparent:!0,opacity:.5,depthWrite:!1,blending:pt,toneMapped:!1})})]})}function sl({spec:e,quality:o}){const n=w.useRef(),s=w.useRef(),r=w.useRef();se(()=>{const m=n.current;if(!m)return;const p=y.mode&&y.mode!=="off";if(m.visible=!(e.sailedBy==="sub"?y.mode==="sub":e.sailedBy==="helm"&&(y.mode==="helm"||y.mode==="foot")&&y.vessel===e.id),!m.visible)return;const g=p?0:R.clamp(y.progress*.82+.04,0,1),[u,v]=Ki(e.lead,e.off,g,p?Vi:0),T=Mo(u,v),k=R.clamp(-re(u,v)/46,0,1),j=R.lerp(1,.055,T)*R.smoothstep(k,0,.28),L=xt(u,v,y.t,j),a=e.sub?R.smoothstep(y.progress,.42,.6):0;m.position.set(u,L.y-a*40,v);const z=e.sub?.35:1;m.rotation.x=R.clamp(L.dz*1.35*z,-.32,.32),m.rotation.z=R.clamp(-L.dx*1.15*z,-.28,.28),m.rotation.y=Math.PI+Math.sin(y.t*.31+e.lead)*.05,s.current&&(s.current.scale.z=1+Math.sin(y.t*1.6+e.off)*.09,s.current.rotation.y=Math.sin(y.t*.9+e.lead*.1)*.05),r.current&&(r.current.material.opacity=.36*(.25+(1-T)*.75)*(1-a))});const i=e.scale,l=o==="low"?6:10,h=ot(e.model2??""),c=ot(e.model??""),d=h?e.model2:c?e.model:null,b=d==="ship-junk.opt.glb",f=ln(d,34)*(b?e.scale??1:1),x=ot(e.crew??"");return d?t.jsxs("group",{ref:n,children:[t.jsx(xe,{name:d,loa:f,slim:cn(d),sink:zo(d),rotation:an(d),tint:h?ns(d):e.tint,emissive:"#3a2a18",emissiveIntensity:.16,glow:en(d)}),x&&Ya(o).map((m,p)=>{const[g,u]=os(d,f,m);return t.jsx(xe,{name:e.crew,height:rn,rotation:m[2],position:[g,At(d,f),u]},`crew-${p}`)}),e.flag&&t.jsx(So,{crew:e.flag,width:jo(f),position:[0,ko(d,f)*(e.sub?.72:.9),-f*.1],staff:!!e.sub}),t.jsx(Ns,{color:e.lamp,position:[0,At(d,f)+qo*3,-f*.2]}),t.jsxs("mesh",{ref:r,position:[0,.6,-f*1.1],rotation:[-Math.PI/2,0,0],children:[t.jsx("planeGeometry",{args:[f*.55,f*2.3]}),t.jsx("meshBasicMaterial",{map:Cn,color:X.foam,transparent:!0,opacity:.42,depthWrite:!1,toneMapped:!1})]})]}):t.jsxs("group",{ref:n,children:[t.jsxs("group",{scale:i*1.7,children:[t.jsxs("mesh",{position:[0,1.6,0],scale:[1,.72,2.6],castShadow:!0,children:[t.jsx("capsuleGeometry",{args:[4.2,8,4,l]}),t.jsx("meshStandardMaterial",{color:e.hull,roughness:.86})]}),t.jsxs("mesh",{position:[0,4.4,0],children:[t.jsx("boxGeometry",{args:[7.4,.7,21]}),t.jsx("meshStandardMaterial",{color:"#6b4b34",roughness:.92})]}),t.jsxs("mesh",{position:[0,5.4,11.4],rotation:[.5,0,0],castShadow:!0,children:[t.jsx("boxGeometry",{args:[3.4,9,2.4]}),t.jsx("meshStandardMaterial",{color:e.hull,roughness:.88})]}),!e.open&&t.jsxs(t.Fragment,{children:[t.jsxs("mesh",{position:[0,7.6,-7.4],castShadow:!0,children:[t.jsx("boxGeometry",{args:[7,6.4,6.6]}),t.jsx("meshStandardMaterial",{color:e.hull,roughness:.88})]}),t.jsxs("mesh",{position:[0,13,1],castShadow:!0,children:[t.jsx("cylinderGeometry",{args:[.95,1.3,24,6]}),t.jsx("meshStandardMaterial",{color:"#2f2016",roughness:.9})]}),t.jsxs("mesh",{position:[0,21.5,1.2],rotation:[0,0,Math.PI/2],castShadow:!0,children:[t.jsx("cylinderGeometry",{args:[.55,.55,17,5]}),t.jsx("meshStandardMaterial",{color:"#241a12",roughness:.9})]}),t.jsxs("mesh",{ref:s,position:[0,14.5,1.4],children:[t.jsx("planeGeometry",{args:[15,13]}),t.jsx("meshStandardMaterial",{color:e.sail,roughness:1,side:_e,emissive:e.sail,emissiveIntensity:.3})]})]}),e.open&&[-1,1].map(m=>[0,1,2,3].map(p=>t.jsxs("mesh",{position:[m*5.6,3.4,-6+p*4],rotation:[0,0,m*.55],castShadow:!0,children:[t.jsx("cylinderGeometry",{args:[.28,.28,12,4]}),t.jsx("meshStandardMaterial",{color:"#33251a",roughness:.94})]},`${m}-${p}`))),e.flag&&t.jsx(So,{crew:e.flag,width:jo(f)/(i*1.7),position:e.open?[0,9,-4]:[0,25.5,1],staff:!!e.open}),e.figurehead&&t.jsxs("group",{position:[0,6.2,12.6],children:[t.jsxs("mesh",{castShadow:!0,children:[t.jsx("sphereGeometry",{args:[3.1,10,8]}),t.jsx("meshStandardMaterial",{color:"#e0a33c",roughness:.8})]}),t.jsxs("mesh",{position:[0,0,-1],rotation:[Math.PI/2,0,0],children:[t.jsx("torusGeometry",{args:[4.1,1.5,6,14]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.82})]})]}),t.jsx(Ns,{color:e.lamp,scale:1/(i*1.7),position:[0,e.open?5.6:9.4,e.open?7:-7.4]})]}),t.jsxs("mesh",{ref:r,position:[0,.6,-34*i],rotation:[-Math.PI/2,0,0],children:[t.jsx("planeGeometry",{args:[17*i,74*i]}),t.jsx("meshBasicMaterial",{map:Cn,color:X.foam,transparent:!0,opacity:.42,depthWrite:!1,toneMapped:!1})]})]})}function Hs({x:e,z:o,yaw:n,name:s,loa:r,tint:i,flag:l=null,crew:h=null,quality:c="high"}){const d=ln(s,r),b=w.useRef(),f=ot(s),x=ot(h??"");return se(()=>{const m=b.current;if(!m)return;const p=Mo(e,o),g=R.clamp(-re(e,o)/46,0,1),u=R.lerp(1,.055,p)*R.smoothstep(g,0,.28),v=xt(e,o,y.t,u);m.position.set(e,v.y,o),m.rotation.set(R.clamp(v.dz*1.1,-.25,.25),n+Math.sin(y.t*.22+e)*.04,R.clamp(-v.dx,-.22,.22))}),t.jsxs("group",{ref:b,children:[t.jsx(xe,{name:s,loa:d,slim:cn(s),sink:zo(s),rotation:an(s),tint:i,emissive:"#26180e",emissiveIntensity:.18,fallback:null}),h&&x&&f&&Ya(c).slice(0,2).map((m,p)=>{const[g,u]=os(s,d,m);return t.jsx(xe,{name:h,height:rn,rotation:m[2],position:[g,At(s,d),u]},`watch-${p}`)}),l&&f&&t.jsx(So,{crew:l,width:jo(d),position:[0,ko(s,d)*.9,-d*.1]})]})}function al({quality:e="high"}){const o=w.useMemo(()=>e==="low"?Vo.slice(0,7):e==="mid"?Vo.slice(0,22):Vo,[e]);return t.jsxs(t.Fragment,{children:[t.jsx(ol,{}),o.map(n=>t.jsx(sl,{spec:n,quality:e},n.id)),e!=="low"&&Xi.map((n,s)=>t.jsx(Hs,{quality:e,...n,name:"ship-warjunk.opt.glb",loa:62,tint:"#8a8560",flag:"beasts",crew:"crew-samurai.opt.glb"},`picket-${s}`)),e!=="low"&&Qi.map((n,s)=>t.jsx(Hs,{quality:e,...n,name:"ship-junk.opt.glb",loa:40,tint:"#7e7058",flag:"kozuki",crew:"crew-samurai.opt.glb"},`moored-${s}`))]})}const rl=2,_s={"powder-keg.opt.glb":2.4,"war-cannon.opt.glb":4.2,"bomb-sphere.opt.glb":3.6,"sake-tower.opt.glb":5,"wisteria-trellis.opt.glb":8,"banquet-table.opt.glb":2.4,"stone-lantern.opt.glb":4,"oni-daiko.opt.glb":6,"oni-guardian.opt.glb":13,"oni-throne.opt.glb":12,"kagura-stage.opt.glb":40,"treasure-kura.opt.glb":16,"rear-gatehouse.opt.glb":18,"keep-tier.opt.glb":56,"arch-bridge.opt.glb":14},ce=(e,o=6)=>e&&_s[e]!==void 0?_s[e]:o,Lt=30,il="#2e2a33",Ln="#3a4152",Fn=X.snow,tn="#cfe0f4";function Bs({position:e}){const o=ce("stone-lantern.opt.glb")/7.8;return t.jsx("group",{position:e,children:t.jsx(xe,{name:"stone-lantern.opt.glb",height:ce("stone-lantern.opt.glb"),tint:"#8a93a8",fallback:t.jsxs("group",{scale:o,children:[t.jsxs("mesh",{position:[0,1,0],castShadow:!0,children:[t.jsx("boxGeometry",{args:[2.4,2,2.4]}),t.jsx("meshStandardMaterial",{color:Ln,roughness:.95})]}),t.jsxs("mesh",{position:[0,3.4,0],castShadow:!0,children:[t.jsx("cylinderGeometry",{args:[.7,.9,3,6]}),t.jsx("meshStandardMaterial",{color:Ln,roughness:.95})]}),t.jsxs("mesh",{position:[0,5.6,0],castShadow:!0,children:[t.jsx("boxGeometry",{args:[2.2,1.8,2.2]}),t.jsx("meshStandardMaterial",{color:tn,emissive:tn,emissiveIntensity:.9,toneMapped:!1})]}),t.jsxs("mesh",{position:[0,7,0],castShadow:!0,children:[t.jsx("coneGeometry",{args:[2.2,1.6,4]}),t.jsx("meshStandardMaterial",{color:Fn,roughness:.9})]})]})})})}function ll({shadows:e=!0}){const o=w.useMemo(()=>Math.atan2(W.dir[0],W.dir[1]),[]);return t.jsxs("group",{position:[W.gate.x,W.benchY,W.gate.z],rotation:[0,o,0],children:[[0,1,2,3].map(n=>t.jsxs("mesh",{position:[0,.7+n*1.3,6-n*2.1],receiveShadow:!0,castShadow:e,children:[t.jsx("boxGeometry",{args:[26-n*2,1.4,2.4]}),t.jsx("meshStandardMaterial",{color:Ln,roughness:.92})]},n)),t.jsx(xe,{name:"rear-gatehouse.opt.glb",height:ce("rear-gatehouse.opt.glb"),rotation:Math.PI,position:[0,5,-6],tint:"#9aa0b5",emissive:"#1c2233",emissiveIntensity:.12,fallback:t.jsxs("group",{position:[0,0,0],children:[t.jsxs("mesh",{position:[0,8,0],castShadow:e,receiveShadow:!0,children:[t.jsx("boxGeometry",{args:[24,16,10]}),t.jsx("meshStandardMaterial",{color:il,roughness:.9})]}),t.jsxs("mesh",{position:[0,6,5.2],children:[t.jsx("boxGeometry",{args:[8,12,.6]}),t.jsx("meshStandardMaterial",{color:"#1d1a22",roughness:.85})]}),t.jsxs("mesh",{position:[0,17.4,2.9],rotation:[.6,0,0],castShadow:e,children:[t.jsx("boxGeometry",{args:[28,.9,8.4]}),t.jsx("meshStandardMaterial",{color:Fn,roughness:.85})]}),t.jsxs("mesh",{position:[0,17.4,-2.9],rotation:[-.6,0,0],castShadow:e,children:[t.jsx("boxGeometry",{args:[28,.9,8.4]}),t.jsx("meshStandardMaterial",{color:Fn,roughness:.85})]}),t.jsxs("group",{position:[0,19.6,0],children:[[-3.2,3.2].map(n=>t.jsxs("mesh",{position:[n,2.2,0],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[.5,.6,4.4,6]}),t.jsx("meshStandardMaterial",{color:"#5e2430",roughness:.8})]},n)),t.jsxs("mesh",{position:[0,4.6,0],rotation:[0,0,0],castShadow:e,children:[t.jsx("boxGeometry",{args:[9.6,.9,1.1]}),t.jsx("meshStandardMaterial",{color:"#5e2430",roughness:.8})]}),t.jsxs("mesh",{position:[0,3.4,0],children:[t.jsx("boxGeometry",{args:[7.6,.6,.9]}),t.jsx("meshStandardMaterial",{color:"#5e2430",roughness:.8})]})]}),t.jsxs("mesh",{position:[0,12.6,5.4],rotation:[0,0,Math.PI/2+.04],children:[t.jsx("cylinderGeometry",{args:[.5,.5,20,5]}),t.jsx("meshStandardMaterial",{color:"#c9b98a",roughness:1})]}),[-5,5].map(n=>t.jsxs("mesh",{position:[n,11.2,5.5],children:[t.jsx("boxGeometry",{args:[1.4,2.6,.1]}),t.jsx("meshStandardMaterial",{color:"#e8e4da",roughness:1,side:_e})]},n)),[-9,9].map(n=>t.jsxs("mesh",{position:[n,10.5,5.6],children:[t.jsx("sphereGeometry",{args:[1.5,8,6]}),t.jsx("meshStandardMaterial",{color:tn,emissive:tn,emissiveIntensity:1.4,toneMapped:!1})]},n))]})}),t.jsx(Bs,{position:[-14,0,10]}),t.jsx(Bs,{position:[14,0,10]}),[-8,0,8].map(n=>t.jsxs("mesh",{position:[n+20,1.2,26],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[.9,1.1,2.4,6]}),t.jsx("meshStandardMaterial",{color:"#262b38",roughness:.9})]},n))]})}const Io=new Se,Pn={color:"#7fd8c8",intensity:9e3,distance:320},mn={color:"#ffc48a",intensity:12e3,distance:300},cl=new Se(Pn.color),hl={low:1,mid:2,high:4},Kt=[{pos:[K.x,40,K.z],color:E.lantern,intensity:16e3,distance:460*_*.65},{pos:[0,78,Ot],color:E.lantern,intensity:15e3,distance:430},{pos:[he.x,he.y+6,he.z-30],color:E.emberDeep,intensity:3e4,distance:640},{pos:[W.gate.x,30,W.gate.z],color:"#9fc4e8",intensity:7e3,distance:340}];function ul({quality:e="high",shadowMap:o=2048,shadows:n=!0}){const s=w.useRef(),r=w.useRef(),i=w.useRef(),l=w.useRef(),h=w.useRef(),c=w.useRef(),d=Me(f=>f.camera),b=hl[e]??5;return se(()=>{if(s.current){s.current.intensity=y.flash*9e3;const m=y.flashDir;s.current.position.set(m.x*700,260+m.y*500,pe.z+m.z*700)}const f=y.t;r.current&&(r.current.intensity=62e3*(.86+.14*Math.sin(f*2.3)*Math.sin(f*.71))),i.current&&(i.current.intensity=62e3*(.86+.14*Math.sin(f*1.9+2.1)*Math.sin(f*.63)));const x=y.inside;if(h.current&&(h.current.intensity=.16+x*.3),c.current&&(c.current.intensity=.34+x*.26),l.current){const m=l.current,p=.06;let g=Kt[0],u=1/0;for(const v of Kt){const T=(d.position.x-v.pos[0])**2+(d.position.z-v.pos[2])**2;T<u&&(u=T,g=v)}if(y.subActive&&u>550*550){const v=y.subPos,T=Math.min(1,y.underwater/.35);m.position.x+=(v.x-m.position.x)*.3,m.position.y+=(v.y+14-m.position.y)*.3,m.position.z+=(v.z-m.position.z)*.3,Io.set(mn.color).lerp(cl,T),m.color.lerp(Io,p),m.intensity+=(R.lerp(mn.intensity,Pn.intensity,T)-m.intensity)*p,m.distance=R.lerp(mn.distance,Pn.distance,T)}else if(y.helmActive&&u>550*550){const v=y.helmPos;m.position.x+=(v.x-m.position.x)*.25,m.position.y+=(v.y+16-m.position.y)*.25,m.position.z+=(v.z-m.position.z)*.25,m.color.lerp(Io.set(E.lantern),p),m.intensity+=(11e3-m.intensity)*p,m.distance=300}else m.position.x+=(g.pos[0]-m.position.x)*p,m.position.y+=(g.pos[1]-m.position.y)*p,m.position.z+=(g.pos[2]-m.position.z)*p,m.color.lerp(Io.set(g.color),p),m.intensity+=(g.intensity-m.intensity)*p,m.distance=g.distance}}),t.jsxs(t.Fragment,{children:[t.jsx("ambientLight",{ref:h,intensity:.16,color:X.skyLow}),t.jsx("hemisphereLight",{ref:c,args:[X.skyLow,"#2a1810",.34]}),t.jsx("directionalLight",{position:[380,620,760],intensity:.62,color:"#9db4de",castShadow:n,"shadow-mapSize":[o,o],"shadow-camera-left":-520*(_/1.55),"shadow-camera-right":520*(_/1.55),"shadow-camera-top":520*(_/1.55),"shadow-camera-bottom":-520*(_/1.55),"shadow-camera-near":80,"shadow-camera-far":2600,"shadow-bias":-.0012,"shadow-normalBias":1.4}),t.jsx("pointLight",{ref:r,position:b>=2?[Ie[0].x,Ie[0].y,Ie[0].z]:[(Ie[0].x+Ie[1].x)/2,Ie[0].y,Ie[0].z],color:E.ember,intensity:62e3,distance:1250,decay:2}),b>=2&&t.jsx("pointLight",{ref:i,position:[Ie[1].x,Ie[1].y,Ie[1].z],color:E.ember,intensity:62e3,distance:1250,decay:2}),t.jsx("pointLight",{ref:l,position:Kt[0].pos,color:Kt[0].color,intensity:Kt[0].intensity,distance:Kt[0].distance,decay:2}),b>=3&&t.jsx("pointLight",{position:[he.x,he.y+4,he.z-34],color:E.emberDeep,intensity:3e4,distance:640,decay:2}),b>=4&&t.jsx("pointLight",{position:[0,78,Ot],color:E.lantern,intensity:15e3,distance:430,decay:2}),t.jsx("pointLight",{ref:s,position:[0,700,-700],color:X.boltGlow,intensity:0,distance:4200,decay:1.4})]})}function gn(e,o){let n=e>>>0;const s=()=>(n=Math.imul(n,1664525)+1013904223>>>0,n/4294967296),r=[],i=o==="low"?3:5,l=(p,g,u,v,T)=>{const k=[p.clone()],j=p.clone();for(let a=0;a<v;a++)j.add(new S((s()-.5)*u*.55,-u/v,(s()-.5)*u*.42)).add(g.clone().multiplyScalar(u/v*.3)),k.push(j.clone());const L=new ao(new so(k),v*2,T,i,!1);return r.push(L),k},h=l(new S(0,620,0),new S(0,0,0),620,9,3.4),c=o==="low"?1:3;for(let p=0;p<c;p++){const g=h[2+Math.floor(s()*(h.length-3))];l(g.clone(),new S(s()-.5,0,s()-.5).multiplyScalar(2),190+s()*130,4,1.5)}let d=0;for(const p of r)d+=p.attributes.position.count;const b=new Float32Array(d*3),f=new Float32Array(d*3);let x=0;for(const p of r)b.set(p.attributes.position.array,x*3),f.set(p.attributes.normal.array,x*3),x+=p.attributes.position.count,p.dispose();const m=new Dt;return m.setAttribute("position",new ne(b,3)),m.setAttribute("normal",new ne(f,3)),m}function dl({quality:e}){const o=[w.useRef(),w.useRef(),w.useRef()],n=w.useRef(2.5),s=w.useRef({i:0,t:-1,dur:0,flicker:0}),r=w.useMemo(()=>[gn(40503,e),gn(20973,e),gn(10196,e)],[e]);return se((i,l)=>{const h=Math.min(l,.05),c=s.current;if(n.current-=h,n.current<=0&&c.t<0){c.i=(c.i+1)%3,c.t=0,c.dur=.16+Math.random()*.26,c.flicker=2+Math.floor(Math.random()*3);const d=o[c.i].current;if(d){const b=(Math.random()-.5)*2.4-Math.PI*.5,f=620+Math.random()*760;d.position.set(pe.x+Math.cos(b)*f,40+Math.random()*120,pe.z+Math.sin(b)*f*.7-240),d.rotation.y=Math.random()*Math.PI*2;const x=.7+Math.random()*.8;d.scale.set(x,x,x),y.flashDir.set(d.position.x,d.position.y+400,d.position.z).normalize()}n.current=R.lerp(6.5,2.2,y.progress)*(.45+Math.random())}if(c.t>=0){c.t+=h;const d=c.t/c.dur,b=Math.abs(Math.sin(d*Math.PI*c.flicker)),f=Math.max(0,1-d);y.flash=f*f*b;const x=o[c.i].current;x&&(x.material.opacity=Math.min(1,y.flash*2.2)),d>=1&&(c.t=-1,y.flash=0,x&&(x.material.opacity=0))}else y.flash*=Math.pow(1e-4,h)}),t.jsx(t.Fragment,{children:r.map((i,l)=>t.jsx("mesh",{ref:o[l],geometry:i,frustumCulled:!1,renderOrder:4,children:t.jsx("meshBasicMaterial",{color:X.bolt,transparent:!0,opacity:0,blending:pt,depthWrite:!1,toneMapped:!1})},l))})}const pl=`
  uniform float uTime;
  uniform vec3  uCam;
  uniform float uBox;
  uniform float uFall;
...
`,Ws={low:120,mid:340,high:700};function bl({quality:e}){const o=w.useRef(),n=w.useMemo(()=>{const r=Ws[e]??Ws.high,i=[Ie[0],Ie[1],he,he],l=new Float32Array(r*3),h=new Float32Array(r),c=new Float32Array(r),d=new Float32Array(r);for(let f=0;f<r;f++){const x=i[f%i.length];l[f*3]=x.x+(Math.random()-.5)*74,l[f*3+1]=x.y+(Math.random()-.5)*30,l[f*3+2]=x.z+(Math.random()-.5)*26,h[f]=Math.random(),c[f]=.045+Math.random()*.055,d[f]=2+Math.random()*4}const b=new Dt;return b.setAttribute("position",new ne(l,3)),b.setAttribute("aPhase",new ne(h,1)),b.setAttribute("aRise",new ne(c,1)),b.setAttribute("aSize",new ne(d,1)),b.boundingSphere=new lo(new S(0,300,-260),700),b},[e]),s=w.useMemo(()=>({uTime:{value:0},uColor:{value:new S(...ie(E.ember))}}),[]);return se((r,i)=>{o.current&&(o.current.uniforms.uTime.value+=i)}),t.jsx("points",{geometry:n,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:gl,fragmentShader:xl,uniforms:s,transparent:!0,depthWrite:!1,blending:pt,fog:!1})})}function wl({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(dl,{quality:e}),t.jsx(ml,{quality:e}),t.jsx(bl,{quality:e})]})}const yl=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
...
`,Ys={low:150,mid:380,high:620};function Ml({whirl:e,quality:o}){const n=w.useRef(),s=w.useRef(),r=w.useMemo(()=>{const l=Ys[o]??Ys.high,h=new Float32Array(l*3),c=new Float32Array(l),d=new Float32Array(l),b=new Float32Array(l),f=new Float32Array(l),x=new Float32Array(l);for(let p=0;p<l;p++)c[p]=Math.random()*Math.PI*2,d[p]=Math.random(),b[p]=.05+Math.random()*.05,f[p]=3+Math.random()*6,x[p]=Math.random();const m=new Dt;return m.setAttribute("position",new ne(h,3)),m.setAttribute("aAngle",new ne(c,1)),m.setAttribute("aPhase",new ne(d,1)),m.setAttribute("aRate",new ne(b,1)),m.setAttribute("aSize",new ne(f,1)),m.setAttribute("aJitter",new ne(x,1)),m.boundingSphere=new lo(new S(e.x,0,e.z),e.r*1.6+40),m},[o,e]),i=w.useMemo(()=>({uTime:{value:0},uCentre:{value:new Kn(e.x,e.z)},uR:{value:e.r},uDepth:{value:e.depth},uDir:{value:e.dir},uColor:{value:new S(...ie(X.foam))},uGain:{value:1}}),[e]);return se((l,h)=>{const c=n.current?.uniforms;if(!c)return;c.uTime.value+=h;const d=Math.hypot(l.camera.position.x-e.x,l.camera.position.z-e.z);c.uGain.value=1-R.smoothstep(d,1600,2400),s.current&&(s.current.visible=c.uGain.value>.02)}),t.jsx("points",{ref:s,geometry:r,renderOrder:2,children:t.jsx("shaderMaterial",{ref:n,vertexShader:yl,fragmentShader:vl,uniforms:i,transparent:!0,depthWrite:!1,blending:pt,fog:!1})})}function jl({quality:e="high"}){const o=Me(n=>n.camera);return se(()=>{let n=0;for(const s of Be){const r=Math.hypot(o.position.x-s.x,o.position.z-s.z);n=Math.max(n,1-R.smoothstep(r,s.r*.3,s.r*2.2))}y.whirlNear+=(n-y.whirlNear)*.05}),t.jsx(t.Fragment,{children:Be.map((n,s)=>t.jsx(Ml,{whirl:n,quality:e},s))})}const Y={rev:0,chain:null,step:0,hull:1,grip:0,clock:0,banner:null,done:!1,hits:0},no={helm:[{text:"PASS THE OUTER GATE",hint:"The island’s marker, alone in open water. Straight through it.",test:e=>e.z<oo-60},{text:"HOLD THE FAIRWAY",hint:"Whirlpools both flanks — the middle is the only clean water.",test:e=>e.toGate<420*_},{text:"RUN THE TORII",hint:"Between the columns — the batteries cannot depress that far.",test:e=>e.z<Ot-40},{text:"THREAD THE NECK",hint:"The walls close to a hundred metres. Mind your helm.",test:e=>e.z<120*_},{text:"MOOR AT THE PORT",hint:"Under the burning face. Come in slow.",test:e=>e.moored}],sub:[{text:"TAKE HER DOWN",hint:"Below thirty-five metres the maelstroms cannot reach you.",test:e=>e.depth>35},{text:"RUN UNDER THE BACK-DOOR MAELSTROM",hint:"Straight through where the surface is turning. Stay deep.",test:e=>{const o=_r("back-door");return Math.hypot(e.x-o.x,e.z-o.z)<o.r*1.1&&e.depth>30}},{text:"FIND THE FJORD",hint:"North-east flank, a crack in the cliffs. It is not on any chart.",test:e=>e.toRear<420},{text:"SURFACE IN THE COVE",hint:"Blow ballast. The back door is above you.",test:e=>e.toRear<W.pool*1.3&&e.depth<3}],foot:[{text:"GET INSIDE THE SKULL",hint:"The mouth above the port, or the gate at the back of the cove.",test:e=>e.area==="hall"},{text:"CROSS THE LIVE FLOOR",hint:"The stage is at the far end, under the keep.",test:e=>e.area==="hall"&&e.lz!=null&&e.lz<40},{text:"CLIMB TO THE STAGE",hint:"The vermilion ramps either side of the approach.",test:e=>e.fy!=null&&e.fy>60},{text:"TAKE THE ROOF",hint:"The stair tower on the east flank goes all the way up.",test:e=>e.fy!=null&&e.fy>230}]},kl=e=>no[e]?no[e].length:0,Sl=()=>Y.chain&&no[Y.chain]?no[Y.chain][Y.step]??null:null;function Gn(e){Y.chain=no[e]?e:null,Y.step=0,Y.hull=1,Y.grip=0,Y.clock=0,Y.done=!1,Y.banner=null,Y.rev++}function on(e,o,n=3.4){Y.banner={text:e,sub:o,until:Y.clock+n},Y.rev++}function Ut(e,o){Y.hull<=0||(Y.hull=Math.max(0,Y.hull-e),Y.hits++,Y.hull<=0?on("HULL BREACHED","She is going down — the raid goes on without you",5):o&&e>.04&&on(o,null,2.2),Y.rev++)}function Za(e,o){if(Y.clock+=e,Y.banner&&Y.clock>Y.banner.until&&(Y.banner=null,Y.rev++),!Y.chain||Y.done||!o)return;const n=no[Y.chain],s=n[Y.step];if(!s)return;let r=!1;try{r=!!s.test(o)}catch{r=!1}r&&(Y.step++,Y.step>=n.length?(Y.done=!0,on("OBJECTIVE COMPLETE",zl[Y.chain]??"",6)):on(n[Y.step].text,n[Y.step].hint,3.6),Y.rev++)}const zl={helm:"Moored under the face. The alliance is ashore.",sub:"Surfaced at the back door, unseen. Law would approve.",foot:"The roof of the demon castle. The whole bay is below you."};function qa(e,{danger:o,headingX:n,headingZ:s,toCentreX:r,toCentreZ:i,speed:l,throttle:h}){if(o<=.001)return Y.grip=Math.max(0,Y.grip-e*.5),Y.grip;const c=Math.hypot(r,i)||1,d=-r/c,b=-i/c,f=n*d+s*b,x=Math.min(1,Math.abs(l)/22),m=o*.42,p=Math.max(0,f)*x*(.35+.45*Math.min(1,Math.abs(h)));return Y.grip=Math.max(0,Math.min(1,Y.grip+(m-p)*e)),Y.grip}const Vs=24,xn=Xo.safe,$s=Xo.range,po=2.1,Tl=1.5,Ks=22,El=[Ot,oo],Rl=new at,bn=new S,Xs=new yt,wn=new S;function Al({quality:e="high"}){const o=w.useRef(),n=w.useMemo(()=>Array.from({length:Vs},()=>({live:!1,x:0,z:0,y0:0,t:0})),[]),s=w.useRef(0),r=w.useMemo(()=>{const i=new Pa(.55,1,1,e==="low"?6:10,1,!0);return i.translate(0,.5,0),i},[e]);return se((i,l)=>{const h=o.current;if(!h)return;const c=Math.min(l,.05),d=y.helm;if(y.helmActive&&d&&!d.onFoot&&!d.sub&&!d.moored){let x=null,m=1/0;for(const p of El){const g=Math.hypot(d.x,d.z-p);g<xn||g>$s||g<m&&(m=g,x=p)}if(x!==null&&(s.current-=c,s.current<=0)){const p=1-R.clamp((m-xn)/($s-xn),0,1);s.current=R.lerp(4.5,1.9,p);const g=n.find(u=>!u.live);if(g){const u=po*.55,v=R.lerp(230,105,p);g.x=d.x+Math.sin(d.heading)*d.speed*u+(Math.random()-.5)*v,g.z=d.z+Math.cos(d.heading)*d.speed*u+(Math.random()-.5)*v,g.y0=210+Math.random()*60,g.t=0,g.live=!0}}}let f=0;for(const x of n){if(!x.live)continue;const m=x.t;if(x.t+=c,x.t<po){const p=x.t/po;bn.set(x.x,x.y0*(1-p*p),x.z),wn.set(2.2,9,2.2)}else{if(m<po){const u=Math.hypot(x.x-d.x,x.z-d.z);u<Ks&&Ut(.03*(1-u/Ks)+.008,"HIT — SHOT THROUGH THE RIGGING"),y.splash+=1}const p=(x.t-po)/Tl;if(p>=1){x.live=!1;continue}const g=Math.min(1,p*4);bn.set(x.x,xt(x.x,x.z,y.t,1).y-4,x.z),wn.set(11+p*9,78*g*(1-p*p*.75),11+p*9)}Xs.identity(),h.setMatrixAt(f,Rl.compose(bn,Xs,wn)),f++}h.count=f,h.instanceMatrix.needsUpdate=!0,h.visible=f>0}),t.jsx("instancedMesh",{ref:o,args:[r,void 0,Vs],frustumCulled:!1,renderOrder:2,visible:!1,children:t.jsx("meshBasicMaterial",{color:X.foam,transparent:!0,opacity:.42,depthWrite:!1,toneMapped:!1,blending:pt,side:_e})})}const Il=`
  uniform float uTime;
  uniform vec3  uCam;
  uniform float uBox;
  attribute float aSpeed;
...
`,Qs={low:700,mid:1800,high:3200},Lo=260;function Ll({quality:e}){const o=w.useRef(),n=w.useRef(),s=Me(l=>l.camera),r=w.useMemo(()=>{const l=Qs[e]??Qs.high,h=new Float32Array(l*3),c=new Float32Array(l),d=new Float32Array(l),b=new Float32Array(l);for(let x=0;x<l;x++)h[x*3]=Math.random()*Lo,h[x*3+1]=Math.random()*Lo,h[x*3+2]=Math.random()*Lo,c[x]=.5+Math.random()*1.4,d[x]=1.2+Math.random()*3.2,b[x]=Math.random();const f=new Dt;return f.setAttribute("position",new ne(h,3)),f.setAttribute("aSpeed",new ne(c,1)),f.setAttribute("aSize",new ne(d,1)),f.setAttribute("aPhase",new ne(b,1)),f.boundingSphere=new lo(new S,1e6),f},[e]),i=w.useMemo(()=>({uTime:{value:0},uCam:{value:new S},uBox:{value:Lo},uColor:{value:new S(...ie("#cfeee6"))},uGain:{value:0}}),[]);return se((l,h)=>{const c=o.current?.uniforms;c&&(c.uTime.value+=h,c.uCam.value.copy(s.position),c.uGain.value=y.underwater,n.current&&(n.current.visible=y.underwater>.02))}),t.jsx("points",{ref:n,geometry:r,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:o,vertexShader:Il,fragmentShader:Cl,uniforms:i,transparent:!0,depthWrite:!1,fog:!1})})}const Fl=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
  uniform float uDir;
...
`,Zs={low:260,mid:700,high:1300},Gl=`
  varying vec2 vUv;
  varying vec3 vWorld;
  void main() {
    vUv = uv;
...
`,qs=1100;function Dl({whirl:e,quality:o}){const n=w.useRef(),s=w.useRef(),r=Me(h=>h.camera),i=w.useMemo(()=>{const h=o==="low"?24:o==="mid"?34:48,c=new Pa(e.r*1.02,e.r*.07,qs,h,6,!0);return c.translate(e.x,-qs/2-3,e.z),c},[e,o]),l=w.useMemo(()=>({uTime:{value:0},uDir:{value:e.dir},uGain:{value:0},uColor:{value:new S(...ie(X.foam))},uDeep:{value:new S(...ie(X.underGlow))},uCameraPos:{value:new S},uFogDensity:{value:.0062},uFogColor:{value:new S(...ie(X.underHaze))}}),[e]);return se((h,c)=>{const d=n.current?.uniforms;if(!d)return;d.uTime.value+=c,d.uCameraPos.value.copy(h.camera.position),d.uFogDensity.value=h.scene.fog?.density??.0062;const b=h.scene.fog?.color;b&&d.uFogColor.value.set(b.r,b.g,b.b);const f=Math.hypot(r.position.x-e.x,r.position.z-e.z),x=1-R.smoothstep(f,e.r*8,e.r*24);d.uGain.value+=(y.underwater*x-d.uGain.value)*Math.min(1,c*4),s.current&&(s.current.visible=d.uGain.value>.012)}),t.jsx("mesh",{ref:s,geometry:i,frustumCulled:!1,renderOrder:2,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:Gl,fragmentShader:Ol,uniforms:l,transparent:!0,depthWrite:!1,side:_e,blending:pt,fog:!1})})}function Nl({whirl:e,quality:o}){const n=w.useRef(),s=w.useRef(),r=Me(h=>h.camera),i=w.useMemo(()=>{const h=Zs[o]??Zs.high,c=new Float32Array(h*3),d=new Float32Array(h),b=new Float32Array(h),f=new Float32Array(h),x=new Float32Array(h),m=new Float32Array(h);for(let g=0;g<h;g++)d[g]=Math.random()*Math.PI*2,b[g]=Math.random(),f[g]=.07+Math.random()*.1,x[g]=.12+Math.pow(Math.random(),1.8)*.5,m[g]=2+Math.random()*5;const p=new Dt;return p.setAttribute("position",new ne(c,3)),p.setAttribute("aAngle",new ne(d,1)),p.setAttribute("aPhase",new ne(b,1)),p.setAttribute("aRate",new ne(f,1)),p.setAttribute("aRadius",new ne(x,1)),p.setAttribute("aSize",new ne(m,1)),p.boundingSphere=new lo(new S(e.x,-60,e.z),e.r+140),p},[o,e]),l=w.useMemo(()=>({uTime:{value:0},uCentre:{value:new Kn(e.x,e.z)},uR:{value:e.r},uDir:{value:e.dir},uDepth:{value:340},uColor:{value:new S(...ie(X.underGlow))},uGain:{value:0}}),[e]);return se((h,c)=>{const d=n.current?.uniforms;if(!d)return;d.uTime.value+=c;const b=Math.hypot(r.position.x-e.x,r.position.z-e.z),f=1-R.smoothstep(b,e.r*1.2,e.r*4);d.uGain.value=y.underwater*f,s.current&&(s.current.visible=d.uGain.value>.015)}),t.jsx("points",{ref:s,geometry:i,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:Fl,fragmentShader:Pl,uniforms:l,transparent:!0,depthWrite:!1,blending:pt,fog:!1})})}function Hl({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(Ll,{quality:e}),Be.map((o,n)=>t.jsx(Nl,{whirl:o,quality:e},n)),Be.map((o,n)=>t.jsx(Dl,{whirl:o,quality:e},`w${n}`))]})}const nn=16/9,Ja=96,er=78;function On(e,o,n=Ja){if(!o||o>=nn)return e;const s=R.degToRad(e)/2,r=2*Math.atan(Math.tan(s)*nn/o);return Math.min(n,R.radToDeg(r))}function tr(e){return!e||e>=nn?1:R.clamp(.72+.28*(e/nn),.86,1)}function Dn(e,o,n,s=.06,r=Ja){const i=On(o,e.aspect,r);Math.abs(e.fov-i)<=.05||(e.fov+=(i-e.fov)*(1-Math.pow(s,n)),e.updateProjectionMatrix())}function Nn(e=1){const o=typeof window<"u"&&window.innerWidth||1280;return e*R.clamp(1280/o,.55,2.2)}const or="oni.settings.v1";function _l(){return typeof navigator>"u"?!1:typeof window<"u"&&window.matchMedia?.("(pointer: coarse)")?.matches?!0:navigator.maxTouchPoints>0}const ve={comfort:0,lookSens:1,invertY:!1,freeCam:!1,hud:!0},Hn=new Set;function nr(){for(const e of Hn)e(ve)}function as(e){return Hn.add(e),()=>Hn.delete(e)}function rs(e,o){e in ve&&(ve[e]=o,Wl(),nr())}function eo(e){rs(e,!ve[e])}function Bl(){rs("comfort",ve.comfort<.01?.55:ve.comfort<.9?1:0)}function Ul(){const e=[.6,.85,1,1.35,1.8],o=e.findIndex(n=>n>=ve.lookSens-1e-6);rs("lookSens",e[(o+1)%e.length])}function Wl(){try{localStorage.setItem(or,JSON.stringify(ve))}catch{}}function Yl(){let e=null;try{e=JSON.parse(localStorage.getItem(or)||"null")}catch{e=null}if(e&&typeof e=="object")for(const o of Object.keys(ve))o!=="hud"&&typeof e[o]==typeof ve[o]&&(ve[o]=e[o]);else ve.comfort=_l()?1:0;return nr(),ve}const Oe=(e,o)=>e+(o-e)*ve.comfort,fo=e=>e<-1?-1:e>1?1:e,I={throttle:0,rudder:0,planes:0,boost:!1,walk:{x:0,z:0},surfaceQueued:!1,periscopeQueued:!1,burstQueued:!1,recentreQueued:!1,jumpQueued:!1,boardQueued:!1,pistolQueued:!1,bazookaQueued:!1,gigantQueued:!1,rocketQueued:!1,hakiQueued:!1,gear2Queued:!1,gatlingHeld:!1,balloonHeld:!1,zoom:0},It={level:0},_n=new Set;function Vl(e){return _n.add(e),()=>_n.delete(e)}function is(e){if(It.level===e)return e;It.level=e;for(const o of _n)o(e);return e}function sr(){return is((It.level+1)%3)}const ee={active:!1,throttle:0,rudder:0,planes:0,boost:!1,walk:{x:0,z:0},gatling:!1,balloon:!1},yo=new Set,ft=(...e)=>e.some(o=>yo.has(o));function ar(){I.throttle=0,I.rudder=0,I.planes=0,I.boost=!1,I.walk.x=0,I.walk.z=0,I.surfaceQueued=!1,I.periscopeQueued=!1,I.burstQueued=!1,I.recentreQueued=!1,I.jumpQueued=!1,I.boardQueued=!1,I.zoom=0,I.pistolQueued=!1,I.bazookaQueued=!1,I.gigantQueued=!1,I.rocketQueued=!1,I.hakiQueued=!1,I.gear2Queued=!1,I.gatlingHeld=!1,I.balloonHeld=!1,ee.gatling=!1,ee.balloon=!1,is(0),ee.throttle=0,ee.rudder=0,ee.planes=0,ee.boost=!1,ee.walk.x=0,ee.walk.z=0,yo.clear()}function $l(){const e=r=>!!r&&(r.isContentEditable||/^(input|textarea|select)$/i.test(r.tagName??"")),o=r=>{if(r.metaKey||r.ctrlKey||r.altKey||e(r.target))return;const i=r.key.toLowerCase();yo.add(i),i==="f"&&(I.surfaceQueued=!0),i==="p"&&(I.periscopeQueued=!0),i==="b"&&!r.repeat&&(I.burstQueued=!0),i==="r"&&!r.repeat&&(I.recentreQueued=!0),i==="v"&&!r.repeat&&eo("freeCam"),i==="."&&!r.repeat&&eo("hud"),i==="x"&&!r.repeat&&sr(),i===" "&&!r.repeat&&(I.jumpQueued=!0),i==="t"&&!r.repeat&&(I.boardQueued=!0),i==="j"&&!r.repeat&&(I.pistolQueued=!0),i==="k"&&!r.repeat&&(I.bazookaQueued=!0),i==="l"&&!r.repeat&&(I.gigantQueued=!0),i==="g"&&!r.repeat&&(I.rocketQueued=!0),i==="h"&&!r.repeat&&(I.hakiQueued=!0),i==="n"&&!r.repeat&&(I.gear2Queued=!0),[" ","arrowup","arrowdown","arrowleft","arrowright"].includes(i)&&r.preventDefault()},n=r=>yo.delete(r.key.toLowerCase()),s=()=>ar();return window.addEventListener("keydown",o,{passive:!1}),window.addEventListener("keyup",n),window.addEventListener("blur",s),()=>{window.removeEventListener("keydown",o),window.removeEventListener("keyup",n),window.removeEventListener("blur",s),yo.clear()}}function Kl(){const e=ft("w","arrowup")?1:0,o=ft("s","arrowdown")?1:0,n=ft("a","arrowleft")?1:0,s=ft("d","arrowright")?1:0,r=ft("q"," ")?1:0,i=ft("e","c")?1:0,l=fo(e-o+ee.throttle);l<-.05&&It.level&&is(0),I.throttle=It.level>0?Math.max(l,1):l,I.rudder=fo(n-s+ee.rudder),I.planes=fo(r-i+ee.planes),I.boost=ft("shift")||ee.boost||It.level===2,I.zoom=(ft("]","=","+")?1:0)-(ft("[","-","_")?1:0),I.gatlingHeld=ft("u")||ee.gatling,I.balloonHeld=ft("i")||ee.balloon,I.walk.x=fo(s-n+ee.walk.x),I.walk.z=fo(e-o+ee.walk.z)}const Bn=[0,(Ie[0].y+Ie[1].y)/2,Ie[0].z],rr=[he.x,he.y,he.z],sn=W.dir,ir=[W.x+sn[0]*300,-36,W.z+sn[1]*300],lr=[W.x+sn[0]*46,34,W.z+sn[1]*46],cr=[W.gate.x,4,W.gate.z],hr=[W.gate.x,22,W.gate.z],Xl=1.55,Un=_/Xl,Ql=1+(Un-1)*.35,jt=[{id:"sea",title:"THE SEA IS FOR PIRATES",sub:"Wano Country · night of the Fire Festival",dur:13,fov:52,from:[-294,31,1364],to:[-186,23,1150],lookFrom:[62,140,465],lookTo:[16,108,294],swell:1},{id:"fleet",title:"THE ALLIANCE SAILS",sub:"Nine Red Scabbards · Straw Hats · Heart · Kid · Mink · Yakuza",dur:12,fov:46,from:[304,38,1299],to:[229,31,1150],lookFrom:[121,65,760],lookTo:[62,90,577],swell:1},{id:"torii",title:"THE TORII",sub:"First line of defence — the gate at sea",dur:14,fov:58,from:[53,24,877],to:[9,62,580],lookFrom:[0,115,400],lookTo:[0,205,400],swell:.7},{id:"neck",title:"THROUGH THE GATE",sub:"The channel — the only way in",dur:12,fov:64,from:[0,36,521],to:[-22,89,198],lookFrom:[0,161,186],lookTo:[-31,326,-232],swell:.35},{id:"bay",title:"ONIGASHIMA",sub:"鬼ヶ島 — the island of demons",dur:15,fov:56,from:[-31,134,276],to:[-81,182,68],lookFrom:[0,310,-264],lookTo:Bn,swell:.12},{id:"port",title:"THE PORT",sub:"Lanterns, and a sword in the ground",dur:13,fov:48,from:[143,55,102],to:[53,43,-12],lookFrom:[-149,59,-161],lookTo:[-53,205,-276],swell:.06},{id:"backdoor",title:"THE BACK DOOR",sub:"Heart Pirates — under the maelstroms, up the hidden fjord",dur:12,fov:60,from:ir,to:lr,lookFrom:cr,lookTo:hr,swell:0},{id:"face",title:"KAIDOU OF THE BEASTS",sub:"Skull Dome — the raid begins",dur:17,fov:50,from:[-149,41,40],to:[16,360,189],lookFrom:rr,lookTo:Bn,swell:0}],Zl=new Set([Bn,rr,ir,lr,cr,hr]),Fo=e=>Zl.has(e)?e:[e[0]*Un,e[1]*Ql,e[2]*Un];for(const e of jt)e.from=Fo(e.from),e.to=Fo(e.to),e.lookFrom=Fo(e.lookFrom),e.lookTo=Fo(e.lookTo);const Wn=jt.reduce((e,o)=>e+o.dur,0),Js=jt,ql=e=>e*e*(3-2*e),Jl=e=>1-Math.pow(1-e,2.2),Po=e=>new S(e[0],e[1],e[2]),Pt={dist:[24,3600],pitch:[-.95,1.44],y:[-260,1500],xz:4200};function ec(e,o){w.useEffect(()=>{if(!e)return;const n=o.domElement,s=new Map;let r=0,i=null;const l=(f,x)=>{const m=y.orbit,p=m.dist*.0016,g=Math.cos(m.yaw),u=-Math.sin(m.yaw);m.target.x-=g*f*p,m.target.z-=u*f*p;const v=Math.cos(m.pitch),T=Math.sin(m.pitch);m.target.y+=x*p*v,m.target.x+=Math.sin(m.yaw)*x*p*T,m.target.z+=Math.cos(m.yaw)*x*p*T,ur()},h=f=>{s.set(f.pointerId,{x:f.clientX,y:f.clientY});try{n.setPointerCapture?.(f.pointerId)}catch{}if(s.size===2){const[x,m]=[...s.values()];r=Math.hypot(x.x-m.x,x.y-m.y),i={x:(x.x+m.x)/2,y:(x.y+m.y)/2}}},c=f=>{const x=s.get(f.pointerId);if(!x)return;const m=f.clientX-x.x,p=f.clientY-x.y;if(x.x=f.clientX,x.y=f.clientY,s.size>=2){const[g,u]=[...s.values()],v=Math.hypot(g.x-u.x,g.y-u.y),T={x:(g.x+u.x)/2,y:(g.y+u.y)/2};if(r>8&&v>8){const k=y.orbit;k.dist=R.clamp(k.dist*(r/v),...Pt.dist)}i&&l(T.x-i.x,T.y-i.y),r=v,i=T,f.cancelable&&f.preventDefault();return}if(f.shiftKey||f.buttons===4)l(m,p);else{const g=y.orbit;g.yaw-=m*.005*Nn(),g.pitch=R.clamp(g.pitch+p*.004*Nn(),...Pt.pitch)}f.cancelable&&f.preventDefault()},d=f=>{s.delete(f.pointerId)&&s.size<2&&(r=0,i=null)},b=f=>{f.preventDefault();const x=y.orbit;x.dist=R.clamp(x.dist*(1+Math.sign(f.deltaY)*.11),...Pt.dist)};return n.addEventListener("pointerdown",h),n.addEventListener("pointermove",c,{passive:!1}),n.addEventListener("pointerup",d),n.addEventListener("pointercancel",d),window.addEventListener("pointerup",d),n.addEventListener("wheel",b,{passive:!1}),()=>{n.removeEventListener("pointerdown",h),n.removeEventListener("pointermove",c),n.removeEventListener("pointerup",d),n.removeEventListener("pointercancel",d),window.removeEventListener("pointerup",d),n.removeEventListener("wheel",b),s.clear()}},[e,o])}function ur(){const e=y.orbit;e.target.x=R.clamp(e.target.x,-4200,Pt.xz),e.target.z=R.clamp(e.target.z,-4200,Pt.xz),e.target.y=R.clamp(e.target.y,...Pt.y)}function tc({onRails:e,playing:o,speed:n=1,onShot:s,idle:r=!1}){const i=Me(b=>b.camera),l=Me(b=>b.gl),h=w.useRef(0),c=w.useRef(-1),d=w.useRef(new S(0,150,-260));return ec(!e&&!r,l),w.useEffect(()=>{if(e)return;const b=y.orbit,f=i.position.clone().sub(b.target);b.dist=R.clamp(f.length(),...Pt.dist),b.yaw=Math.atan2(f.x,f.z),b.pitch=Math.asin(R.clamp(f.y/(f.length()||1),-1,1))},[e,i]),se((b,f)=>{if(r)return;const x=Math.min(f,.05);if(y.t+=x,e){if(y.jumpTo!=null){let A=0;for(let M=0;M<y.jumpTo&&M<jt.length;M++)A+=jt[M].dur;h.current=A,y.jumpTo=null}o&&(h.current=(h.current+x*n)%Wn);let v=0,T=0;for(;T<jt.length&&!(h.current<v+jt[T].dur);T++)v+=jt[T].dur;const k=jt[Math.min(T,jt.length-1)],j=R.clamp((h.current-v)/k.dur,0,1);c.current!==T&&(c.current=T,y.shot=T,s?.(T,k));const L=Po(k.from).lerp(Po(k.to),Jl(j)),a=Po(k.lookFrom).lerp(Po(k.lookTo),ql(j)),z=k.swell??0;if(z>0){const A=y.t;L.y+=Math.sin(A*.62)*3.1*z+Math.sin(A*1.31+1.2)*1.2*z,L.x+=Math.sin(A*.44+.6)*2.2*z}L.x+=Math.sin(y.t*.83)*.35,L.y+=Math.sin(y.t*1.17+2)*.28,i.position.copy(L),d.current.lerp(a,1-Math.pow(1e-4,x)),i.lookAt(d.current),z>0&&i.rotateZ(Math.sin(y.t*.51)*.024*z);const C=On(k.fov,i.aspect);Math.abs(i.fov-C)>.01&&(i.fov+=(C-i.fov)*(1-Math.pow(.02,x)),i.updateProjectionMatrix()),y.progress=h.current/Wn}else{const v=y.orbit;I.recentreQueued&&(I.recentreQueued=!1,v.target.set(F.x,F.baseY*.55,F.z),v.dist=R.clamp(v.dist,260,1400));const T=I.walk.x,k=I.walk.z;if(T||k||I.planes||I.zoom){const a=v.dist*(I.boost?1.9:.7)*x,z=-Math.sin(v.yaw),C=-Math.cos(v.yaw);v.target.x+=(z*k-C*T)*a,v.target.z+=(C*k+z*T)*a,v.target.y+=I.planes*a,v.dist=R.clamp(v.dist*(1-I.zoom*.9*x),...Pt.dist),ur()}const j=Math.cos(v.pitch);i.position.set(v.target.x+Math.sin(v.yaw)*j*v.dist,v.target.y+Math.sin(v.pitch)*v.dist,v.target.z+Math.cos(v.yaw)*j*v.dist),i.lookAt(v.target);const L=On(55,i.aspect);Math.abs(i.fov-L)>.01&&(i.fov+=(L-i.fov)*(1-Math.pow(.02,x)),i.updateProjectionMatrix()),y.t+=0}const m=Mo(i.position.x,i.position.z);y.shelter+=(m-y.shelter)*(1-Math.pow(.06,x)),y.fog=R.lerp(Gt.sea,Gt.bay,y.shelter),y.rain=1-y.shelter*.92;const p=xt(i.position.x,i.position.z,y.t,1),g=R.clamp((p.y-i.position.y-1)/3,0,1);y.underwater+=(g-y.underwater)*(1-Math.pow(.002,x)),y.depthBelow=Math.max(0,p.y-i.position.y);const u=R.lerp(8200,1700,y.underwater);Math.abs(i.far-u)>20&&(i.far=u,i.updateProjectionMatrix()),b.camera.updateMatrixWorld()}),null}const ea={low:[24,16],mid:[40,26],high:[56,36]};function oc({quality:e="high",shadows:o=!0}){const n=w.useRef(),s=w.useRef(),r=w.useMemo(()=>{const[x,m]=ea[e]??ea.high,p=new Rr(1,x,m),g=p.attributes.position,u=new Float32Array(g.count*3),[v,T,k]=Fe.centre,[j,L,a]=Fe.radii,z=new Se("#241c22"),C=new Se(E.rockWarm),A=new Se;for(let M=0;M<g.count;M++){const G=g.getX(M),P=g.getY(M),O=g.getZ(M),oe=1+(to(G*2.4+5,O*2.4-9,3)-.5)*.14;g.setXYZ(M,v+G*j*oe,T+P*L*oe,k+O*a*oe);const ue=R.clamp((P+.2)/1.2,0,1);A.copy(z).lerp(C,(1-ue)*.55),u[M*3]=A.r,u[M*3+1]=A.g,u[M*3+2]=A.b}return p.setAttribute("color",new ne(u,3)),p.computeVertexNormals(),p},[e]),{stairM:i,brazierM:l,bayM:h,tableM:c,jarM:d,westStairM:b}=w.useMemo(()=>{const x=new at,m=new yt,p=new S(1,1,1),g=new S,u=[];for(let D=0;D<dt.steps;D++){const $=D/(dt.steps-1);g.set(0,R.lerp(De.y,le.y+2,$),R.lerp(dt.zTop,dt.zBottom,$)),m.identity(),u.push(x.clone().compose(g,m,p))}const v=[],T=e==="low"?5:9;for(const D of[-1,1])for(let $=0;$<T;$++){const Q=$/(T-1);g.set(D*176,le.y+9,R.lerp(le.zFront-40,le.zBack+40,Q)),m.identity(),v.push(x.clone().compose(g,m,p))}for(let D=0;D<6;D++)g.set(-110+D*44,le.y+9,N.z+N.halfZ+54),m.identity(),v.push(x.clone().compose(g,m,p));const k=[],j=e==="low"?5:9;for(const D of[-1,1])for(let $=0;$<ye.tiers;$++)for(let Q=0;Q<j;Q++){const ae=Q/(j-1);g.set(D*(ye.x-$*26),ye.y+$*ye.tierRise,R.lerp(-205,ye.halfZ,ae)),m.identity(),k.push(x.clone().compose(g,m,p))}const L=[],a=[],z=new yt,C=new S(0,1,0);let A=24301;const M=()=>(A=Math.imul(A,1664525)+1013904223>>>0,A/4294967296),G=e==="low"?1:2,P=e==="low"?5:8;for(const D of[-1,1])for(let $=0;$<G;$++)for(let Q=0;Q<P;Q++){const ae=D*(96+$*52+(M()-.5)*14),be=R.lerp(le.zBack+120,le.zFront-60,Q/(P-1))+(M()-.5)*16;if(!(Math.abs(ae)<Te.halfX+24&&Math.abs(be-Te.z)<Te.halfZ+20)&&!(Math.abs(Math.abs(ae)-ge.x)<26&&be<ge.zFoot+16&&be>ge.zTop-8)){g.set(ae,le.y+2.4,be),z.setFromAxisAngle(C,(M()-.5)*.5),L.push(x.clone().compose(g,z,p));for(let de=0;de<2;de++)g.set(ae+(M()-.5)*30,le.y+3.5,be+(M()>.5?8:-8)+(M()-.5)*6),z.setFromAxisAngle(C,M()*Math.PI),a.push(x.clone().compose(g,z,p))}}const O=[],oe=16,ue=D=>D*D*(3-2*D);for(let D=0;D<=oe;D++){const $=D/oe;g.set(-252,ue($)*(ye.y-.5)-1.3,R.lerp(45,-45,$)),m.identity(),O.push(x.clone().compose(g,m,p))}return{stairM:u,brazierM:v,bayM:k,tableM:L,jarM:a,westStairM:O}},[e]);se(()=>{const x=y.t;n.current&&(n.current.material.emissiveIntensity=2.6+Math.sin(x*4.1)*.3+Math.sin(x*9.3)*.15),s.current&&(s.current.material.emissiveIntensity=.85+Math.sin(x*.9)*.12)});const f=o;return t.jsxs("group",{children:[t.jsx("mesh",{geometry:r,side:Tn,receiveShadow:f,frustumCulled:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,side:Tn,roughness:.97,metalness:.02})}),[[0,(le.zFront+Te.z+Te.halfZ)/2,le.halfX*2,le.zFront-Te.z-Te.halfZ],[0,(le.zBack+Te.z-Te.halfZ)/2,le.halfX*2,Te.z-Te.halfZ-le.zBack],[-342/2-20,Te.z,le.halfX*2-Te.halfX*2,Te.halfZ*2],[(Te.halfX+le.halfX)/2+20,Te.z,le.halfX*2-Te.halfX*2,Te.halfZ*2]].map(([x,m,p,g],u)=>t.jsxs("mesh",{position:[x,le.y-3,m],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[Math.abs(p),6,Math.abs(g)]}),t.jsx("meshStandardMaterial",{color:"#4b3a2c",roughness:.93})]},u)),t.jsxs("mesh",{ref:s,position:[Te.x,qe.ceiling+2,Te.z],rotation:[-Math.PI/2,0,0],children:[t.jsx("planeGeometry",{args:[Te.halfX*2,Te.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#7fd6a0",emissive:"#2f8f5c",emissiveIntensity:.85,toneMapped:!1,side:_e})]}),t.jsxs("mesh",{position:[0,De.y-4,De.z],receiveShadow:f,castShadow:f,children:[t.jsx("boxGeometry",{args:[De.halfX*2.6,8,De.depth]}),t.jsx("meshStandardMaterial",{color:"#3f3126",roughness:.94})]}),t.jsxs("instancedMesh",{ref:null,args:[null,null,i.length],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[dt.halfX*2,3.2,6.4]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(nc,{matrices:i})]}),[-1,1].map(x=>Array.from({length:ye.tiers},(m,p)=>t.jsxs("mesh",{position:[x*(ye.x-p*26),ye.y+p*ye.tierRise-4,0],receiveShadow:f,castShadow:f,children:[t.jsx("boxGeometry",{args:[76-p*6,7,ye.halfZ*2+40]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.92})]},`${x}-${p}`))),t.jsxs("instancedMesh",{args:[null,null,h.length],children:[t.jsx("boxGeometry",{args:[3,15,22]}),t.jsx("meshStandardMaterial",{color:"#e8c98d",emissive:E.lanternFar,emissiveIntensity:1.05,roughness:.9}),t.jsx(ic,{matrices:h})]}),t.jsxs("instancedMesh",{args:[null,null,c.length],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[30,4.4,10]}),t.jsx("meshStandardMaterial",{color:"#5c3f28",roughness:.9}),t.jsx(sc,{matrices:c})]}),t.jsxs("instancedMesh",{args:[null,null,d.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[2.6,3.2,7,8]}),t.jsx("meshStandardMaterial",{color:"#b8a06a",roughness:.85}),t.jsx(ac,{matrices:d})]}),t.jsxs("instancedMesh",{args:[null,null,b.length],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[74,2.6,6.4]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(rc,{matrices:b})]}),t.jsxs("instancedMesh",{args:[null,null,l.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[7,4.5,12,8]}),t.jsx("meshStandardMaterial",{color:"#22201f",roughness:.7,metalness:.5}),t.jsx(lc,{matrices:l})]}),t.jsxs("instancedMesh",{ref:n,args:[null,null,l.length],children:[t.jsx("sphereGeometry",{args:[5.4,8,6]}),t.jsx("meshStandardMaterial",{color:E.furnace,emissive:E.ember,emissiveIntensity:2.6,toneMapped:!1}),t.jsx(cc,{matrices:l})]}),t.jsxs("mesh",{position:[0,qe.y-4,0],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[qe.halfX*2,8,qe.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#2a2622",roughness:.96})]}),[-1,1].map(x=>[-1,0,1].map(m=>t.jsxs("mesh",{position:[x*120,(qe.y+le.y)/2,m*96],castShadow:f,children:[t.jsx("boxGeometry",{args:[26,Math.abs(le.y-qe.y),26]}),t.jsx("meshStandardMaterial",{color:X.rock,roughness:.95})]},`${x}-${m}`)))]})}function nc({matrices:e}){const o=w.useRef();return t.jsx(Wt,{matrices:e,selfRef:o})}function sc({matrices:e}){const o=w.useRef();return t.jsx(Wt,{matrices:e,selfRef:o})}function ac({matrices:e}){const o=w.useRef();return t.jsx(Wt,{matrices:e,selfRef:o})}function rc({matrices:e}){const o=w.useRef();return t.jsx(Wt,{matrices:e,selfRef:o})}function ic({matrices:e}){const o=w.useRef();return t.jsx(Wt,{matrices:e,selfRef:o})}function lc({matrices:e}){const o=w.useRef();return t.jsx(Wt,{matrices:e,selfRef:o})}function cc({matrices:e}){const o=w.useRef();return t.jsx(Wt,{matrices:e,selfRef:o,offsetY:9})}function Wt({matrices:e,offsetY:o=0}){const n=w.useRef(),s=w.useRef(!1);return se(()=>{if(s.current)return;const r=n.current?.parent;if(!r?.isInstancedMesh)return;const i=new at,l=new at().makeTranslation(0,o,0);for(let h=0;h<Math.min(e.length,r.count);h++)i.copy(e[h]).multiply(l),r.setMatrixAt(h,i);r.instanceMatrix.needsUpdate=!0,r.computeBoundingSphere(),s.current=!0}),t.jsx("object3D",{ref:n})}const ta=(()=>{if(typeof document>"u")return null;const e=256,o=128,n=document.createElement("canvas");n.width=e,n.height=o;const s=n.getContext("2d"),r=s.createRadialGradient(e/2,o*.62,8,e/2,o*.62,e*.62);r.addColorStop(0,"#fff3c4"),r.addColorStop(.32,"#ffc95e"),r.addColorStop(.66,"#e06120"),r.addColorStop(1,"#7e1c14"),s.fillStyle=r,s.fillRect(0,0,e,o),s.globalAlpha=.14,s.fillStyle="#fff3c4";for(let l=0;l<12;l++){const h=l/12*Math.PI*2;s.save(),s.translate(e/2,o*.62),s.rotate(h),s.fillRect(-3,0,6,e),s.restore()}s.globalAlpha=.22,s.fillStyle="#5e1610";for(let l=8;l<e;l+=22)s.fillRect(l,0,3,o);s.globalAlpha=1;const i=new ro(n);return i.colorSpace=io,i})();function hc(e,o,n,s){const r=e+s,i=o+s,l=new Float32Array([-r,0,i,r,0,i,e*.18,n,o*.18,-r,0,i,e*.18,n,o*.18,-e*.18,n,o*.18,r,0,i,r,0,-i,e*.18,n,-o*.18,r,0,i,e*.18,n,-o*.18,e*.18,n,o*.18,r,0,-i,-r,0,-i,-e*.18,n,-o*.18,r,0,-i,-e*.18,n,-o*.18,e*.18,n,-o*.18,-r,0,-i,-r,0,i,-e*.18,n,o*.18,-r,0,-i,-e*.18,n,o*.18,-e*.18,n,-o*.18]),h=new Dt;return h.setAttribute("position",new ne(l,3)),h.computeVertexNormals(),h}function uc({quality:e="high",shadows:o=!0}){const n=w.useRef(),s=w.useRef(),r=ot("keep-hf.opt.glb"),i=w.useMemo(()=>{const h=[];for(let c=0;c<N.storeys;c++){const d=1-(c+1)*N.taper,b=N.plinth+c*N.storey;h.push({i:c,y:b,halfX:N.halfX*d,halfZ:N.halfZ*d,roof:hc(N.halfX*d,N.halfZ*d,c===N.storeys-1?30:16,11)})}return h},[]);se(()=>{const h=y.t;n.current&&(n.current.material.emissiveIntensity=2.2+Math.sin(h*2.2)*.3),s.current&&(s.current.material.emissiveIntensity=2.3+Math.sin(h*3.3)*.25)});const l=o;return t.jsxs("group",{position:[0,N.baseY,N.z],children:[t.jsxs("mesh",{position:[0,N.plinth/2,0],castShadow:l,receiveShadow:l,children:[t.jsx("boxGeometry",{args:[N.halfX*2.2,N.plinth,N.halfZ*2.2]}),t.jsx("meshStandardMaterial",{color:"#4a4640",roughness:.96})]}),r&&t.jsx(xe,{name:"keep-hf.opt.glb",height:N.plinth+N.storeys*N.storey+26,position:[0,N.plinth*.5,0],tint:"#9a8468",emissive:E.emberDeep,emissiveIntensity:.14}),!r&&i.map(h=>t.jsxs("group",{position:[0,h.y,0],children:[t.jsxs("mesh",{position:[0,N.storey/2,0],castShadow:l,receiveShadow:l,children:[t.jsx("boxGeometry",{args:[h.halfX*2,N.storey,h.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#d8cdb6",roughness:.9})]}),t.jsxs("mesh",{position:[0,N.storey*.55,h.halfZ+.6],children:[t.jsx("planeGeometry",{args:[h.halfX*1.75,N.storey*.38]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:1.5,toneMapped:!1})]}),t.jsxs("mesh",{position:[0,N.storey*.02,h.halfZ+8],castShadow:l,children:[t.jsx("boxGeometry",{args:[h.halfX*2+20,3,2.4]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.72})]}),t.jsxs("mesh",{position:[0,N.storey-1.4,0],children:[t.jsx("boxGeometry",{args:[h.halfX*2+3,1.6,h.halfZ*2+3]}),t.jsx("meshStandardMaterial",{color:"#c9a227",roughness:.4,metalness:.7})]}),t.jsx("mesh",{geometry:h.roof,position:[0,N.storey,0],castShadow:l,receiveShadow:l,children:t.jsx("meshStandardMaterial",{color:"#2e3038",roughness:.72,metalness:.14,flatShading:!0})})]},h.i)),[-1,1].map(h=>t.jsxs("mesh",{position:[h*14,N.plinth+N.storeys*N.storey+30,0],rotation:[0,0,h*.4],castShadow:l,children:[t.jsx("coneGeometry",{args:[5,15,5]}),t.jsx("meshStandardMaterial",{color:"#c9a227",roughness:.35,metalness:.85})]},h)),t.jsxs("group",{position:[0,Re.y,Re.z-N.z],children:[t.jsxs("mesh",{castShadow:l,receiveShadow:l,children:[t.jsx("boxGeometry",{args:[Re.halfX*2,7,Re.depth]}),t.jsx("meshStandardMaterial",{color:"#3a2a1e",roughness:.9})]}),t.jsxs("mesh",{ref:n,position:[0,26,-40/2],children:[t.jsx("planeGeometry",{args:[Re.halfX*2,48]}),t.jsx("meshStandardMaterial",{color:E.furnace,emissive:"#ffffff",emissiveMap:ta,map:ta,emissiveIntensity:2.2,toneMapped:!1,side:_e})]}),t.jsx(xe,{name:"oni-throne.opt.glb",height:ce("oni-throne.opt.glb"),position:[0,3.5,-8],rotation:0,tint:"#8a7f78",emissive:"#2a0e0a",emissiveIntensity:.25,fallback:t.jsxs("group",{position:[0,3.5,-8],scale:ce("oni-throne.opt.glb")/38,children:[t.jsxs("mesh",{position:[0,6,0],castShadow:l,children:[t.jsx("boxGeometry",{args:[18,12,14]}),t.jsx("meshStandardMaterial",{color:"#1c1a20",roughness:.6,metalness:.5})]}),t.jsxs("mesh",{position:[0,10.5,0],children:[t.jsx("boxGeometry",{args:[14,3,11]}),t.jsx("meshStandardMaterial",{color:"#6e1712",roughness:.9})]}),t.jsxs("mesh",{position:[0,20,-5],castShadow:l,children:[t.jsx("boxGeometry",{args:[16,20,3.4]}),t.jsx("meshStandardMaterial",{color:"#221e26",roughness:.6,metalness:.5})]}),[-1,1].map(h=>t.jsxs("mesh",{position:[h*8,32,-5],rotation:[0,0,h*-.55],castShadow:l,children:[t.jsx("coneGeometry",{args:[2.2,12,6]}),t.jsx("meshStandardMaterial",{color:"#d8cbb2",roughness:.55})]},h))]})}),t.jsx(xe,{name:"kagura-stage.opt.glb",height:ce("kagura-stage.opt.glb"),position:[0,3.5,-15],rotation:Math.PI,tint:"#c9743a",emissive:E.emberDeep,emissiveIntensity:.3,fallback:null}),[-1,1].map(h=>t.jsxs("mesh",{position:[h*Re.halfX*.9,28,Re.depth/2-4],castShadow:l,children:[t.jsx("cylinderGeometry",{args:[3.4,4,52,8]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.7})]},h)),t.jsxs("mesh",{position:[0,56,0],castShadow:l,children:[t.jsx("boxGeometry",{args:[Re.halfX*2.3,5,Re.depth+22]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.72})]}),[-1,1].map(h=>t.jsx(xe,{name:"oni-daiko.opt.glb",height:ce("oni-daiko.opt.glb"),position:[h*(Re.halfX-22),4,4],rotation:h*.4,tint:"#c98a5a",fallback:t.jsx("group",{position:[0,ce("oni-daiko.opt.glb")/2,0],rotation:[0,0,Math.PI/2],scale:ce("oni-daiko.opt.glb")/22,children:t.jsxs("mesh",{castShadow:l,children:[t.jsx("cylinderGeometry",{args:[11,11,15,14]}),t.jsx("meshStandardMaterial",{color:"#8e2118",roughness:.7})]})})},h))]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,18],children:[t.jsx("cylinderGeometry",{args:[3.4,3.4,6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.3,toneMapped:!1}),t.jsx(dc,{})]})]})}function dc(){const e=w.useRef(),o=w.useRef(!1);return se(()=>{if(o.current)return;const n=e.current?.parent;if(!n?.isInstancedMesh)return;const s=new at,r=new S,i=new yt,l=new S(1,1,1);for(let h=0;h<n.count;h++){const c=h/(n.count-1)*2-1;r.set(c*(N.halfX+26),Re.y+74-(1-c*c)*20,N.halfZ+22),n.setMatrixAt(h,s.compose(r,i,l))}n.instanceMatrix.needsUpdate=!0,n.computeBoundingSphere(),o.current=!0}),t.jsx("object3D",{ref:e})}function pc({shadows:e=!0}){const{slabs:o,flights:n,tower:s}=Ha,r=w.useMemo(()=>{const i=[],l=h=>h*h*(3-2*h);for(const h of n)for(let d=0;d<=9;d++){const b=d/9;i.push([(h.x0+h.x1)/2,h.y0+(h.y1-h.y0)*l(b)-1.2,R.lerp(h.z0,h.z1,b)])}return i},[n]);return t.jsxs("group",{children:[[s.x[0]+1,s.x[1]-1].map(i=>[s.z[0]+1,s.z[1]-1].map(l=>t.jsxs("mesh",{position:[i,128,l],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[2.2,3,256,6]}),t.jsx("meshStandardMaterial",{color:"#33261a",roughness:.92})]},`${i}${l}`))),t.jsxs("instancedMesh",{args:[null,null,r.length],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[9,2.4,5.6]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(fc,{points:r})]}),o.map(([i,l,h,c,d],b)=>t.jsxs("mesh",{position:[i,l-1.6,h],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[Math.abs(c),3.2,Math.abs(d)]}),t.jsx("meshStandardMaterial",{color:"#4b3a2c",roughness:.93})]},b)),o.map(([i,l,h,c,d],b)=>t.jsxs("mesh",{position:[i,l+5,h+Math.abs(d)/2-1],children:[t.jsx("boxGeometry",{args:[Math.abs(c),1.6,1.2]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})]},`r${b}`))]})}function fc({points:e}){const o=w.useRef(),n=w.useRef(!1);return se(()=>{if(n.current)return;const s=o.current?.parent;if(!s?.isInstancedMesh)return;const r=new at,i=new yt,l=new S(1,1,1),h=new S;for(let c=0;c<Math.min(e.length,s.count);c++)h.set(e[c][0],e[c][1],e[c][2]),s.setMatrixAt(c,r.compose(h,i,l));s.instanceMatrix.needsUpdate=!0,s.computeBoundingSphere(),n.current=!0}),t.jsx("object3D",{ref:o})}function mc({shadows:e=!0}){const o=w.useMemo(()=>{const n=[],r=i=>i*i*(3-2*i);for(const i of[-1,1])for(let l=0;l<=20;l++){const h=l/20;n.push({x:i*ge.x,y:r(h)*Ft,z:R.lerp(ge.zFoot,ge.zTop,h)})}return n},[]);return t.jsxs("group",{children:[o.map((n,s)=>t.jsxs("mesh",{position:[n.x,n.y-1.4,n.z],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[ge.halfW*2,2.8,9]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.75})]},s)),[-1,1].map(n=>{const s=i=>i*i*(3-2*i),r=i=>{const l=[];for(let h=0;h<=16;h++){const c=h/16;l.push(new S(n*ge.x+i,s(c)*Ft+7,R.lerp(ge.zFoot,ge.zTop,c)))}return new ao(new so(l),24,1.1,4,!1)};return t.jsxs("group",{children:[t.jsx("mesh",{geometry:r(-15),castShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})}),t.jsx("mesh",{geometry:r(ge.halfW+1),castShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})})]},n)})]})}function gc({shadows:e=!0}){const o=w.useMemo(()=>Eo.map(([,,n,s])=>{const r=[];for(let i=0;i<=12;i++){const l=i/12*2-1;r.push(new S(l*n*.5,s*(1-l*l),0))}return new ao(new so(r),26,4.6,4,!1)}),[]);return t.jsxs(t.Fragment,{children:[Eo.map(([n,s],r)=>t.jsxs("group",{position:[0,n,s],children:[t.jsx("mesh",{geometry:o[r],castShadow:e,receiveShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.74})}),[-7,7].map(i=>t.jsx("mesh",{geometry:o[r],position:[0,7,i],scale:[1,1,.3],children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})},i))]},r)),[-1,0,1].map(n=>t.jsxs("mesh",{position:[n*70,Eo[0][0]-12,Eo[0][1]],children:[t.jsx("cylinderGeometry",{args:[4,4,7,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1})]},n)),t.jsx("group",{position:[0,le.y,0]})]})}function dr(e){let o=e>>>0;return()=>(o=Math.imul(o,1664525)+1013904223>>>0,o/4294967296)}function xc({quality:e,shadows:o}){const n=w.useMemo(()=>{const r=dr(712273),i=[],l=e==="low"?34:e==="mid"?68:108;let h=0;for(;i.length<l&&h<l*40;){h++;const c=(r()*2-1)*(le.halfX-30),d=R.lerp(le.zBack+40,le.zFront-30,r());Math.abs(c)<62&&d>N.z+120||Math.abs(c)<70&&Math.abs(d-84)<58||Math.abs(Math.abs(c)-ge.x)<24&&d<ge.zFoot+18&&d>ge.zTop-10||i.push({x:c,z:d,kind:i.length%4,rot:r()*Math.PI*2,k:.82+r()*.5})}return i},[e]),s=o;return t.jsx(t.Fragment,{children:n.map((r,i)=>{const l=[r.x,le.y,r.z];if(r.kind===0){const c=ce("sake-tower.opt.glb")*r.k,d=c*.24;return t.jsx(xe,{name:"sake-tower.opt.glb",height:c,position:l,rotation:r.rot,tint:"#c9b48a",fallback:t.jsx("group",{position:l,children:[0,1,2].map(b=>t.jsxs("mesh",{position:[0,c*(.17+b*.3),0],castShadow:s,children:[t.jsx("cylinderGeometry",{args:[d-b*d*.16,d-b*d*.16,c*.29,10]}),t.jsx("meshStandardMaterial",{color:b%2?"#c9a86a":"#8e6a3c",roughness:.92})]},b))})},i)}if(r.kind===1){const c=ce("oni-guardian.opt.glb")*r.k;return t.jsx(xe,{name:"oni-guardian.opt.glb",height:c,position:l,rotation:r.rot,tint:"#9a9488",fallback:t.jsxs("group",{position:l,children:[t.jsxs("mesh",{position:[0,c*.17,0],castShadow:s,children:[t.jsx("boxGeometry",{args:[c*.43,c*.33,c*.43]}),t.jsx("meshStandardMaterial",{color:"#4a4a52",roughness:.95})]}),t.jsxs("mesh",{position:[0,c*.6,0],castShadow:s,children:[t.jsx("capsuleGeometry",{args:[c*.2,c*.33,4,8]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]}),[-1,1].map(d=>t.jsxs("mesh",{position:[d*c*.13,c*.93,0],rotation:[0,0,d*.5],castShadow:s,children:[t.jsx("coneGeometry",{args:[c*.067,c*.27,5]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]},d))]})},i)}if(r.kind===2){const c=ce("wisteria-trellis.opt.glb")*r.k;return t.jsx(xe,{name:"wisteria-trellis.opt.glb",height:c,position:l,rotation:r.rot,tint:"#b39ad8",fallback:t.jsxs("group",{position:l,children:[t.jsxs("mesh",{position:[0,c*.94,0],castShadow:s,children:[t.jsx("boxGeometry",{args:[c*.7,c*.07,c*.07]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.94})]}),[-.26,-.09,.09,.26].map(d=>t.jsxs("mesh",{position:[d*c,c*.47,0],children:[t.jsx("coneGeometry",{args:[c*.1,c*.88,6]}),t.jsx("meshStandardMaterial",{color:"#9d7fd0",roughness:.95,emissive:"#6b4fa0",emissiveIntensity:.22})]},d))]})},i)}const h=rl*4*r.k;return t.jsxs("group",{position:l,rotation:[0,r.rot,0],children:[t.jsxs("mesh",{position:[0,h/2,0],castShadow:s,children:[t.jsx("cylinderGeometry",{args:[h*.021,h*.021,h,6]}),t.jsx("meshStandardMaterial",{color:"#2f2118",roughness:.92})]}),t.jsxs("mesh",{position:[h*.12,h*.65,0],children:[t.jsx("planeGeometry",{args:[h*.235,h*.7]}),t.jsx("meshStandardMaterial",{color:i%2?E.vermilion:"#e8dcc4",roughness:.95,side:_e,emissive:i%2?E.vermilionDeep:"#8a8272",emissiveIntensity:.28})]})]},i)})})}function bc({shadows:e}){const o=w.useMemo(()=>{const n=dr(10560325),s=[];for(let r=0;r<52;r++)s.push({x:(n()*2-1)*(qe.halfX-40),z:(n()*2-1)*(qe.halfZ-40),rot:n()*Math.PI*2,keg:r%2===0});return s},[]);return t.jsx(t.Fragment,{children:o.map((n,s)=>n.keg?t.jsx(xe,{name:"powder-keg.opt.glb",height:ce("powder-keg.opt.glb"),position:[n.x,qe.y,n.z],rotation:n.rot,tint:"#6a6a72",fallback:t.jsxs("mesh",{position:[n.x,qe.y+ce("powder-keg.opt.glb")*.5,n.z],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[ce("powder-keg.opt.glb")*.4,ce("powder-keg.opt.glb")*.4,ce("powder-keg.opt.glb"),10]}),t.jsx("meshStandardMaterial",{color:"#1a1a20",roughness:.6,metalness:.4})]})},s):t.jsx(xe,{name:"war-cannon.opt.glb",height:ce("war-cannon.opt.glb"),position:[n.x,qe.y,n.z],rotation:n.rot,tint:"#7a7068",fallback:t.jsxs("mesh",{position:[n.x,qe.y+ce("war-cannon.opt.glb")*.42,n.z],rotation:[0,n.rot,Math.PI/2],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[ce("war-cannon.opt.glb")*.18,ce("war-cannon.opt.glb")*.23,ce("war-cannon.opt.glb")*1.9,8]}),t.jsx("meshStandardMaterial",{color:"#15181f",roughness:.45,metalness:.7})]})},s))})}function wc(){const e=Me(o=>o.camera);return se((o,n)=>{const s=Math.min(n,.05),r=(e.position.x-fe.x-Fe.centre[0])/Fe.radii[0],i=(e.position.y-fe.y-Fe.centre[1])/Fe.radii[1],l=(e.position.z-fe.z-Fe.centre[2])/Fe.radii[2],h=Math.sqrt(r*r+i*i+l*l),c=R.clamp(1-(h-1)/.5,0,1);y.inside+=(c-y.inside)*(1-Math.pow(.02,s))}),null}function yc({quality:e="high",shadows:o=!0}){return t.jsxs("group",{position:[fe.x,fe.y,fe.z],children:[t.jsx(wc,{}),t.jsx(oc,{quality:e,shadows:o}),t.jsx(uc,{quality:e,shadows:o}),t.jsx(gc,{shadows:o}),t.jsx(mc,{shadows:o}),t.jsx(pc,{shadows:o}),t.jsx(xc,{quality:e,shadows:o}),t.jsx(bc,{shadows:o}),[-1,1].flatMap(n=>[0,1,2,3,4].map(s=>t.jsx(xe,{name:"banquet-table.opt.glb",height:ce("banquet-table.opt.glb"),position:[n*(74+s%2*22),le.y,N.z+186+s*34],rotation:n*.35+Math.PI/2,tint:"#a98c66",fallback:null},`bq-${n}-${s}`))),t.jsx(xe,{name:"treasure-kura.opt.glb",height:ce("treasure-kura.opt.glb"),position:[ye.x-74,le.y,N.z+96],rotation:-.7,tint:"#b8ab98",emissive:"#141018",emissiveIntensity:.1,fallback:t.jsx("group",{position:[ye.x-74,le.y,N.z+96],rotation:[0,-.7,0],children:(()=>{const n=ce("treasure-kura.opt.glb");return t.jsxs(t.Fragment,{children:[[-1,1].map(s=>[-1,1].map(r=>t.jsxs("mesh",{position:[s*n*.3,n*.08,r*n*.22],castShadow:o,children:[t.jsx("boxGeometry",{args:[n*.1,n*.16,n*.1]}),t.jsx("meshStandardMaterial",{color:"#3a2d20",roughness:.92})]},`${s}${r}`))),t.jsxs("mesh",{position:[0,n*.34,0],castShadow:o,children:[t.jsx("boxGeometry",{args:[n*.85,n*.38,n*.65]}),t.jsx("meshStandardMaterial",{color:"#d8d2c2",roughness:.9})]}),t.jsxs("mesh",{position:[0,n*.6,0],castShadow:o,children:[t.jsx("coneGeometry",{args:[n*.65,n*.3,4]}),t.jsx("meshStandardMaterial",{color:"#7e2a1c",roughness:.8,flatShading:!0})]})]})})()})}),[[-120,-70,.4],[60,40,2.2],[150,-100,1.1],[-64,22,1.8],[104,-46,.2],[-176,-118,2.7],[18,-142,1.4],[-30,96,.9]].map(([n,s,r],i)=>t.jsx(xe,{name:"bomb-sphere.opt.glb",height:ce("bomb-sphere.opt.glb"),position:[n,qe.y,s],rotation:r,tint:"#5a5a64",fallback:t.jsxs("mesh",{position:[n,qe.y+ce("bomb-sphere.opt.glb")*.5,s],castShadow:o,children:[t.jsx("sphereGeometry",{args:[ce("bomb-sphere.opt.glb")*.5,12,10]}),t.jsx("meshStandardMaterial",{color:"#14161c",roughness:.5,metalness:.5})]})},`bomb-${i}`)),[-1,1].map(n=>t.jsx(xe,{name:"keep-tier.opt.glb",height:ce("keep-tier.opt.glb"),position:[n*(ye.x-40),ye.y+ye.tiers*ye.tierRise-6,N.z+140],rotation:n*.6,tint:"#a08c74",fallback:null},`turret-${n}`)),[-1,1].map(n=>t.jsx(xe,{name:"arch-bridge.opt.glb",height:ce("arch-bridge.opt.glb"),position:[n*74,le.y,84],rotation:Math.PI/2,tint:"#b87a5a",fallback:null},`span-${n}`)),[-1,1].map(n=>t.jsx(xe,{name:"oni-guardian.opt.glb",height:Lt,position:[n*(De.halfX+26),De.y,De.z-26],rotation:-n*.5,tint:"#8e8880",fallback:t.jsxs("group",{position:[n*(De.halfX+26),De.y,De.z-26],children:[t.jsxs("mesh",{position:[0,Lt*.17,0],castShadow:o,children:[t.jsx("boxGeometry",{args:[Lt*.41,Lt*.33,Lt*.41]}),t.jsx("meshStandardMaterial",{color:"#43434c",roughness:.95})]}),t.jsxs("mesh",{position:[0,Lt*.59,0],castShadow:o,children:[t.jsx("capsuleGeometry",{args:[Lt*.185,Lt*.33,4,10]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]})]})},n)),t.jsx("pointLight",{position:[0,Re.y+30,Re.z-N.z+N.z+40],color:E.ember,intensity:42e3,distance:900,decay:2}),t.jsx("pointLight",{position:[0,ye.y+120,60],color:E.lantern,intensity:3e4,distance:820,decay:2}),t.jsx("pointLight",{position:[0,qe.y+40,0],color:"#4fbf86",intensity:14e3,distance:420,decay:2}),t.jsx("pointLight",{position:[0,De.y+132,De.z-40],color:E.lantern,intensity:13e3,distance:620,decay:2})]})}const vc=Math.PI/2-.14,oa=4;function pr({enabled:e,dom:o,zoomMin:n=.34,zoomMax:s=2.6,zoom0:r=1,pitch0:i=.16,pitchMin:l=-.62,pitchMax:h=vc}){const c=w.useRef({yaw:0,pitch:i,zoom:r,smYaw:0,smPitch:i,smZoom:r,since:99,dragging:!1,recentre:!1,noRecentre:!1,pitchMin:l,pitchMax:h,zoomMin:n,zoomMax:s,pitch0:i}).current;return w.useEffect(()=>{if(!e||!o)return;const d=o,b=new Map;let f=0,x=0,m=null;const p=()=>b.size,g=k=>{b.set(k.pointerId,{x:k.clientX,y:k.clientY});try{d.setPointerCapture?.(k.pointerId)}catch{}if(p()===1)c.dragging=!0,m={x:k.clientX,y:k.clientY,t:k.timeStamp};else if(p()===2){c.dragging=!1;const[j,L]=[...b.values()];f=Math.hypot(j.x-L.x,j.y-L.y),m=null}},u=k=>{const j=b.get(k.pointerId);if(!j)return;const L=k.clientX-j.x,a=k.clientY-j.y;if(j.x=k.clientX,j.y=k.clientY,p()>=2){const[C,A]=[...b.values()],M=Math.hypot(C.x-A.x,C.y-A.y);f>8&&M>8&&(c.zoom=R.clamp(c.zoom*(f/M),c.zoomMin,c.zoomMax),c.since=0),f=M;return}if(!c.dragging)return;m&&Math.hypot(k.clientX-m.x,k.clientY-m.y)>14&&(m=null);const z=Nn()*ve.lookSens;c.yaw-=L*.005*z,c.pitch=R.clamp(c.pitch+a*.004*z*(ve.invertY?-1:1),c.pitchMin,c.pitchMax),c.since=0,k.cancelable&&k.preventDefault()},v=k=>{b.has(k.pointerId)&&(b.delete(k.pointerId),p()<2&&(f=0),p()===0&&(c.dragging=!1,m&&k.timeStamp-m.t<260&&(k.timeStamp-x<340?(c.recentre=!0,x=0):x=k.timeStamp),m=null))},T=k=>{k.preventDefault(),c.zoom=R.clamp(c.zoom*(1+Math.sign(k.deltaY)*.1),c.zoomMin,c.zoomMax),c.since=0};return d.addEventListener("pointerdown",g),d.addEventListener("pointermove",u,{passive:!1}),d.addEventListener("pointerup",v),d.addEventListener("pointercancel",v),window.addEventListener("pointerup",v),d.addEventListener("wheel",T,{passive:!1}),()=>{d.removeEventListener("pointerdown",g),d.removeEventListener("pointermove",u),d.removeEventListener("pointerup",v),d.removeEventListener("pointercancel",v),window.removeEventListener("pointerup",v),d.removeEventListener("wheel",T),b.clear(),c.dragging=!1}},[e,o,c]),c}function Yn(e,o,n=0){if(e.since+=o,I.zoom&&(e.zoom=R.clamp(e.zoom*(1-I.zoom*.9*o),e.zoomMin,e.zoomMax),e.since=0),e.yaw-=n,I.recentreQueued&&(I.recentreQueued=!1,e.recentre=!0),e.recentre&&(e.recentre=!1,e.since=oa+1,e.pitch+=(e.pitch0-e.pitch)*.5,e.noRecentre&&(e.pitch=e.pitch0)),!ve.freeCam&&!e.noRecentre&&!e.dragging&&e.since>oa){for(;e.yaw>Math.PI;)e.yaw-=Math.PI*2;for(;e.yaw<-Math.PI;)e.yaw+=Math.PI*2;e.yaw*=Math.pow(Oe(.5,.72),o),Math.abs(e.yaw)<.001&&(e.yaw=0)}const s=e.dragging?6e-4:Oe(.002,.02),r=1-Math.pow(s,o);let i=e.yaw-e.smYaw;for(;i>Math.PI;)i-=Math.PI*2;for(;i<-Math.PI;)i+=Math.PI*2;e.smYaw+=i*r,e.smPitch+=(e.pitch-e.smPitch)*r,e.smZoom+=(e.zoom-e.smZoom)*(1-Math.pow(.004,o))}const na=[{id:"luffy",modelId:"luffy-wano",name:"Luffy",role:"Captain",capeAxis:"y",capeWiden:.66,capeLength:.78,capeUrl:vo("coat-black.opt.glb"),height:1.74,speed:7,run:15,build:"normal",skin:"#f0c191",hair:{color:"#181410",style:"spiky"},helm:{kind:"none"},top:{color:"#c22d2a",style:"open"},bottom:{color:"#d98b3a"},sash:"#8f63c4",boots:{color:"#6b5238",fur:!1},scar:!0},{id:"zoro",modelId:"zoro-wano",name:"Zoro",role:"Swordsman",capeAxis:"y",capeWiden:.82,capeLength:.56,capeUrl:vo("haori-green.opt.glb"),height:1.81,speed:6.6,run:14,build:"tall",skin:"#e8b481",hair:{color:"#4f7d3a",style:"short"},helm:{kind:"none"},top:{color:"#f2f0ea",style:"open"},bottom:{color:"#f2f0ea"},sash:"#4b3f7a",boots:{color:"#1f2229",fur:!1},weapon:"swords",scar:!0}],Mc=e=>na.find(o=>o.id===e)??na[0],jc=.22,sa=13,kc=.09,Sc=.34,aa=9,zc=1.1,Tc=.55,ra=12,Ec=6,Rc=70,Ac=.55,yn=26,Ic=8,Cc=5,ia=.8,Lc=12,Fc=.3,Pc=.13,la=3.4,Gc=32,ca=.65,Oc=1.1,Dc=.5,Nc=6,ha=6,We=new S,mt=new S,mo=new S;function Hc(e,o,n,s,r,i,l,h){let d=0;for(let b=1;b<=16;b++){const f=b/16*l,x=e+s*f,m=o+r*f,p=n+i*f,g=h??re(x,p);if(m<=g){let u=d,v=f;for(let T=0;T<6;T++){const k=(u+v)/2,j=o+r*k,L=h??re(e+s*k,n+i*k);j<=L?v=k:u=k}return v}d=f}return null}function _c(e,o,n,s){const r=Math.min(e,.05),i=Ye.combat,l=Ee.move,h=i.style==="sword";s.x=0,s.y=0,s.z=0,We.set(Math.sin(o.yaw)*Math.cos(o.pitch),-Math.sin(o.pitch),Math.cos(o.yaw)*Math.cos(o.pitch)).normalize(),Ye.lookYaw=Math.atan2(We.x,We.z),Ye.playerFacing=o.yaw,i.bazookaCd=Math.max(0,i.bazookaCd-r),i.gigantCd=Math.max(0,i.gigantCd-r),i.hakiCd=Math.max(0,i.hakiCd-r),i.gear2Cd=Math.max(0,i.gear2Cd-r),n.gear2Queued&&(n.gear2Queued=!1,!i.gear2&&i.gear2Cd<=0&&!h&&(i.gear2=!0,i.gear2T=Ic,Vt(.25),mt.set(o.x,o.y+1,o.z),Ct(mt,1.6,"haki"))),i.gear2&&(i.gear2T=Math.max(0,i.gear2T-r),i.gear2T<=0&&(i.gear2=!1,i.gear2Cd=Cc));const c=i.gear2;i.balloon=R.damp(i.balloon,n.balloonHeld&&!h?1:0,8,r);const d=o.y+o.height*.9,b=Hc(o.x,d,o.z,We.x,We.y,We.z,Rc,o.floorY);Ye.aim.valid=b!=null,b!=null&&(Ye.aim.distance=b,Ye.aim.point.set(o.x,d,o.z).addScaledVector(We,b));const f=!l.kind;if(n.rocketQueued&&(n.rocketQueued=!1,f&&b!=null&&(m(h?"flash":"rocket",Ac),l.target.copy(Ye.aim.point))),n.pistolQueued&&(n.pistolQueued=!1,f&&(m(h?"onigiri":"pistol",h?Fc:jc),l.target.set(o.x,d,o.z).addScaledVector(We,h?8:16))),n.bazookaQueued&&(n.bazookaQueued=!1,f&&i.bazookaCd<=0))if(h){const p=Ye.waves.find(g=>!g.active);p&&(p.active=!0,p.k=0,p.pos.set(o.x,d*.92,o.z),p.dir.set(We.x,We.y*.35,We.z).normalize(),i.bazookaCd=Oc,m("wavecast",.22),l.hit=!0,l.target.copy(p.pos).addScaledVector(p.dir,8),Vt(.1))}else m("bazooka",Sc),l.target.set(o.x,d,o.z).addScaledVector(We,b!=null?Math.min(b,aa):aa),i.bazookaCd=zc;n.gigantQueued&&(n.gigantQueued=!1,f&&i.gigantCd<=0&&(m(h?"sanzen":"gigant",h?Dc:Tc),l.target.set(o.x,d,o.z).addScaledVector(We,b!=null?Math.min(b+1.5,ra):ra),i.gigantCd=h?Nc:Ec));for(const p of Ye.waves){if(!p.active)continue;const g=p.k;p.k=Math.min(1,p.k+r/ca),p.pos.addScaledVector(p.dir,Gc/ca*r);for(const v of[.35,.68,1])g<v&&p.k>=v&&Ct(p.pos,1.6,"slash");const u=o.floorY==null?re(p.pos.x,p.pos.z):o.floorY;(p.k>=1||p.pos.y<u+.4)&&(p.k<1&&Ct(p.pos,1.6,"slash"),p.active=!1)}if(n.hakiQueued&&(n.hakiQueued=!1,i.hakiCd<=0&&Ee.hakiT<=0&&(Ee.hakiT=ia,Ee.hakiFired=!1,i.hakiCd=Lc)),Ee.hakiT>0){Ee.hakiT=Math.max(0,Ee.hakiT-r);const p=1-Ee.hakiT/ia;if(i.haki=p,!Ee.hakiFired&&p>.35&&(Ee.hakiFired=!0,mt.set(o.x,o.y,o.z),Ct(mt,3,"haki"),Vt(.9),h))for(let g=0;g<8;g++){const u=g/8*Math.PI*2;mt.set(o.x+Math.cos(u)*ha,o.y+.6,o.z+Math.sin(u)*ha),Ct(mt,1.4,"slash")}}else i.haki=0;const x=n.gatlingHeld&&!l.kind;if(i.gatling=R.damp(i.gatling,x?1:0,14,r),i.gatling>.2&&Ye.gatlingAim.copy(We),x){if(Ee.gatT-=r,Ee.gatT<=0)if(h)Ee.gatT=Pc,Ee.tatsu+=1.9,mt.set(o.x+Math.cos(Ee.tatsu)*la,o.y+.6,o.z+Math.sin(Ee.tatsu)*la),Ct(mt,.7,"slash"),Vt(.04);else{Ee.gatT=kc*(c?.6:1);const p=b!=null?Math.min(b,sa):sa*.85;mt.set(o.x,d,o.z).addScaledVector(We,p),Ct(mt,.8,"punch"),Vt(.05)}}else Ee.gatT=0;if(l.kind){l.t+=r;const p=Math.min(1,l.t/l.dur);if(!l.hit&&p>.45){l.hit=!0;const g=l.kind==="gigant"||l.kind==="sanzen"?3:1.3;if(Ct(l.target,g,h?"slash":"punch"),Vt(l.kind==="gigant"||l.kind==="sanzen"?.7:.18),l.kind==="rocket"||l.kind==="flash"){mo.copy(l.target).sub(mt.set(o.x,o.y,o.z));const u=mo.length()||1;s.x=mo.x/u*yn,s.y=Math.max(0,mo.y/u*yn*.5),s.z=mo.z/u*yn}else(l.kind==="pistol"||l.kind==="onigiri")&&(s.x=We.x*6,s.z=We.z*6)}l.t>=l.dur&&(l.kind=null,l.t=0),i.move=l.kind,i.moveK=l.kind?Math.min(1,l.t/l.dur):0}else i.move=null,i.moveK=0;return Ye.shake=Math.max(0,Ye.shake-r*2.4),s;function m(p,g){l.kind=p,l.t=0,l.dur=g,l.hit=!1}}const Ee={move:{kind:null,t:0,dur:0,hit:!1,target:new S},hakiT:0,hakiFired:!1,gatT:0,tatsu:0};function Bc(e="rubber"){const o=Ye.combat;o.style=e,o.move=null,o.moveK=0,o.gatling=0,o.gear2=!1,o.gear2T=0,o.gear2Cd=0,o.bazookaCd=0,o.gigantCd=0,o.hakiCd=0,o.balloon=0,o.haki=0,Ee.move.kind=null,Ee.move.t=0,Ee.hakiT=0,Ee.gatT=0,Ye.shake=0;for(const n of Ye.waves)n.active=!1}const Go=64,Uc=19,Wc=16,Yc=.92,ua=.52,da=.3,Vc=.04,$c=.0016,Kc=.055,Xc=1.9,Qc=16,Zc=62,qc=9,pa={x:-.45,z:-2.4},fa=.075,Oo=new S,ma=new S;function Xt(e,o){return R.clamp(-re(e,o)/26,0,1)}const Do={x:60*_,z:1050*_},Jc=7,ga=15,Ge=1.85,xa=1.1,eh=26,ba=9.4,wa=21,th=.011;function oh({mode:e,onMode:o,crew:n="luffy",vessel:s="sunny"}){const r=Me(C=>C.camera),i=Me(C=>C.gl),l=w.useRef(),h=w.useRef(),c=w.useRef({speed:0,grounded:!0,maxSpeed:15}),d=w.useRef({x:0,y:0,z:0,yaw:0,pitch:0,height:1.74,floorY:null}).current,b=w.useRef({x:0,y:0,z:0}).current,f=Mc(n),x=w.useRef(),m=w.useRef(),p=w.useRef(),g=In(s),u=ot(g.hulls[0]),v=ot(g.hulls[1]??""),T=u||v,k=u?g.hulls[0]:v?g.hulls[1]:null,j=k?ln(k,34):30,L=ot(g.crew),a=w.useRef({x:Do.x,z:Do.z,heading:Math.PI,speed:0,vx:0,vz:0,throttle:0,rudder:0,flank:0,deckY:0,aground:0,heel:0,trim:0,spray:0,slam:0,bowY:0,drift:0,burst:1,burstFx:0,swallowed:0,fx:0,fy:0,fz:0,fyaw:Math.PI,fpitch:0,fvx:0,fvz:0,fvy:0,airborne:!1,landing:0,fyaw0:Math.PI,stride:0,area:"hall",dx:0,dz:0,snapCam:!0,boarded:!1}).current,z=pr({enabled:e==="helm"||e==="foot",dom:i.domElement,zoomMin:.28,zoomMax:4.2,pitch0:.14,pitchMin:-1,pitchMax:1.44});return w.useEffect(()=>{if(e==="helm")return a.x=Do.x,a.z=Do.z,a.heading=Math.PI,a.speed=0,a.vx=0,a.vz=0,a.throttle=0,a.flank=0,a.deckY=0,a.snapCam=!0,z.yaw=0,z.smYaw=0,z.pitch=.14,z.smPitch=.14,z.pitch0=.14,z.zoom=1,z.smZoom=1,z.noRecentre=!1,z.pitchMin=-1,z.pitchMax=1.44,a.swallowed=0,a.burst=1,a.burstFx=0,a.slam=0,a.drift=0,a.trim=0,a.bowY=xt(a.x,a.z,y.t,1).y,y.helm=null,Gn("helm"),()=>{y.helmActive=!1}},[e,s,a,z]),w.useEffect(()=>{if(e!=="foot")return;a.fvx=0,a.fvz=0,a.snapCam=!0,Y.chain!=="foot"&&Gn("foot"),Bc(f.weapon==="swords"?"sword":"rubber");const C=(M,G)=>{z.yaw=M,z.smYaw=M,z.pitch=G,z.smPitch=G,z.pitch0=0,z.noRecentre=!0,z.pitchMin=-1.28,z.pitchMax=1.28};a.fvy=0,a.airborne=!1,a.landing=0;const A=y.footSpawn;if(y.footSpawn="hall",A==="deck"){a.area="deck",a.dx=0,a.dz=-j*.2,a.fy=y.ship.y+y.ship.deckY+Ge,a.fyaw=a.heading,C(a.heading+Math.PI,.44);return}if(A==="port"){a.area="island",a.fx=K.x+40*_,a.fz=K.z+40*_,a.fy=re(a.fx,a.fz)+Ge,a.fyaw=Math.atan2(he.x-a.fx,he.z-a.fz),C(a.fyaw+Math.PI,-.06);return}if(A==="rear"){a.area="island",a.fx=W.gate.x+W.dir[0]*26,a.fz=W.gate.z+W.dir[1]*26,a.fy=re(a.fx,a.fz)+Ge,a.fyaw=Math.atan2(-W.dir[0],-W.dir[1]),C(a.fyaw+Math.PI,.02);return}a.area="hall",a.fx=fe.x,a.fy=fe.y+De.y,a.fz=fe.z+dt.zTop,a.fyaw=Math.PI,a.fpitch=-.05,C(0,.05)},[e,a,z]),se((C,A)=>{if(e!=="helm"&&e!=="foot")return;const M=Math.min(A,.05);y.t+=M;const G=e==="helm",P=e==="foot"&&a.area==="deck";if(G||P){const O=a.heading,oe=G?I.throttle:a.order,ue=G?I.rudder:0;G&&(a.order=I.throttle),a.throttle+=(oe-a.throttle)*(1-Math.pow(.02,M)),a.rudder+=(ue-a.rudder)*(1-Math.pow(.005,M)),a.flank+=((G&&I.boost?1:0)-a.flank)*(1-Math.pow(Vc,M));const D=(g.topSpeed??Go)*(1+da*a.flank),$=Math.sin(a.heading),Q=Math.cos(a.heading),ae=Math.cos(a.heading),be=-Math.sin(a.heading);let de=a.vx*$+a.vz*Q,Ce=a.vx*ae+a.vz*be;const J=1-y.shelter,Ae=a.throttle>=0?a.throttle*D:a.throttle*Uc,rt=g.accel??Wc;de+=R.clamp(Ae-de,-rt*2.5,rt)*M,a.burst=Math.min(1,a.burst+M/(g.burst?.charge??qc)),G&&I.burstQueued&&(I.burstQueued=!1,a.burst>=.999&&(a.burst=0,a.burstFx=1,de+=g.burst?.push??Zc,y.splash+=1)),a.burstFx*=Math.pow(.2,M);const Ne=xt(a.x,a.z,y.t,1);de-=(Ne.dx*$+Ne.dz*Q)*Qc*J*M,de-=de*Math.abs(de)*$c*M,Ce-=(Ce*Math.abs(Ce)*Kc+Ce*Xc)*M;const Je=R.clamp(Math.abs(de)/16,0,1);de*=Math.pow(1-.11*Math.abs(a.rudder)*Je,M),a.vx=$*de+ae*Ce,a.vz=Q*de+be*Ce,a.speed=de,a.drift+=(R.clamp(Math.abs(Ce)/11,0,1)-a.drift)*(1-Math.pow(.1,M)),a.heading+=a.rudder*(g.turn??Yc)*Je*Math.sign(de||1)*M;const it=a.x+a.vx*M,vt=a.z+a.vz*M,$e=j*ua,U=it+$*$e,je=vt+Q*$e;if(Xt(U,je)>.06)a.x=it,a.z=vt,a.aground+=(0-a.aground)*(1-Math.pow(.05,M));else{a.aground+=(1-a.aground)*(1-Math.pow(.02,M)),Ut(Math.abs(a.speed)*.0012*M*60,"AGROUND — SHE IS TAKING WATER");const ze=Math.pow(.06,M);a.speed*=ze,a.vx*=ze,a.vz*=ze;const st=6,Yt=Xt(a.x+st,a.z)-Xt(a.x-st,a.z),ho=Xt(a.x,a.z+st)-Xt(a.x,a.z-st),St=Math.hypot(Yt,ho)||1;a.x+=Yt/St*26*M,a.z+=ho/St*26*M}const He=Oa(a.x,a.z,0);a.x+=He.vx*M,a.z+=He.vz*M,a.x+=pa.x*J*M,a.z+=pa.z*J*M;const ct=Ne.dx*ae+Ne.dz*be;a.heading+=R.clamp(ct*.4,-fa,fa)*J*M;let Le=Be[0],H=1/0;for(const ze of Be){const st=(a.x-ze.x)**2+(a.z-ze.z)**2;st<H&&(H=st,Le=ze)}if(qa(M,{danger:He.danger,headingX:Math.sin(a.heading),headingZ:Math.cos(a.heading),toCentreX:Le.x-a.x,toCentreZ:Le.z-a.z,speed:a.speed,throttle:a.throttle})>=1||He.danger>.94){const ze=Le;a.x=ze.x+(ze.x>0?ze.r*1.85:-ze.r*1.85),a.z=ze.z+ze.r*1.5,a.speed=0,a.vx=0,a.vz=0,a.throttle=0,a.heading=Math.PI,a.swallowed+=1,a.aground=1,Y.grip=0,Ut(.25,"SWALLOWED — SHE BROACHED AND ROLLED"),y.splash+=1}const Pe=Mo(a.x,a.z),Ue=R.lerp(1,.055,Pe)*R.smoothstep(Xt(a.x,a.z),0,.3),Z=xt(a.x,a.z,y.t,Ue);y.helmActive=!0,y.helmPos.set(a.x,Z.y+j*.35,a.z),y.helmSpeed=R.clamp(Math.abs(a.speed)/(g.topSpeed??Go),0,1),y.ship.x=a.x,y.ship.y=Z.y,y.ship.z=a.z,y.ship.heading=a.heading,y.ship.loa=j,y.ship.deckY=k?At(k,j):j*.16,y.ship.mastY=k?ko(k,j):j*.6;const te=He.vx*Math.cos(a.heading)-He.vz*Math.sin(a.heading),q=R.clamp(Math.abs(a.speed)/(g.topSpeed??Go),0,1),we=R.clamp(a.rudder*Je*q*.4+te*.016,-.5,.5);a.heel+=(we-Ce*.012-a.heel)*(1-Math.pow(.15,M));const Ve=j*ua,ht=xt(a.x+$*Ve,a.z+Q*Ve,y.t,Ue).y,nt=R.clamp((a.bowY-ht)/Math.max(M,.001),0,60);a.bowY=ht;const Ke=R.clamp((nt-10)/24,0,1)*q*J;if(a.slam=Math.max(a.slam*Math.pow(.05,M),Ke),Ke>.25){const ze=Math.pow(1-.3*Ke,M);a.vx*=ze,a.vz*=ze}const Xe=q*.1*Math.sign(a.speed>=0?1:-1)+a.slam*.14+a.burstFx*.16;a.trim+=(Xe-a.trim)*(1-Math.pow(.1,M));const To=R.clamp(q*J*1.15+a.aground*.5+He.danger*.8+a.slam*1.3+a.burstFx,0,1);a.spray+=(To-a.spray)*(1-Math.pow(.08,M));const Nt=l.current;if(Nt&&(Nt.visible=!0,Nt.position.set(a.x,Z.y,a.z),Nt.rotation.set(R.clamp(Z.dz*1.2,-.3,.3)-a.trim,a.heading,R.clamp(-Z.dx,-.26,.26)+a.heel)),x.current&&(x.current.scale.z=1+Math.sin(y.t*1.6)*.08+a.burstFx*.4,x.current.scale.x=1+J*.06+a.burstFx*.12),m.current&&(m.current.material.opacity=a.spray*.42,m.current.scale.setScalar(.7+a.spray*.55)),p.current&&(p.current.material.opacity=R.clamp(.34*q+a.burstFx*.3,0,.62)*(.28+J*.72),p.current.scale.set(1+q*.75+a.drift*.6,1,1+q*.5)),a.deckY+=(Z.y-a.deckY)*(1-Math.pow(Oe(2e-4,.05),M)),G){Yn(z,M,a.heading-O);const ze=a.heading+Math.PI+z.smYaw,st=Math.cos(z.smPitch),Yt=Math.max(j*1.9,52)*z.smZoom*(1+q*Oe(.26,.1)+a.burstFx*Oe(.34,.12))*tr(r.aspect),ho=R.lerp(Z.y,a.deckY,ve.comfort),St=Oo.set(a.x+Math.sin(ze)*st*Yt,ho+j*.26+Math.sin(z.smPitch)*Yt,a.z+Math.cos(ze)*st*Yt),xr=xt(St.x,St.z,y.t,Ue);St.y=Math.max(St.y,xr.y+6),a.snapCam?(a.snapCam=!1,r.position.copy(St)):r.position.lerp(St,1-Math.pow(Oe(6e-4,.02),M));const br=Math.max(0,Math.cos(z.smYaw)),us=q*Oe(66,34)*br;r.lookAt(ma.set(a.x+($+ae*R.clamp(Ce/40,-.4,.4))*us,ho+12-a.trim*26*q*Oe(1,.35),a.z+(Q+be*R.clamp(Ce/40,-.4,.4))*us));const ds=Oe(1,0);ds>.001&&r.rotateZ((Math.sin(y.t*2.3)*.012*q+a.heel*.3+a.aground*Math.sin(y.t*21)*.02+a.slam*Math.sin(y.t*34)*.03+He.danger*Math.sin(y.t*2.7)*.03)*ds),Dn(r,60+q*Oe(7,2)+a.burstFx*Oe(10,3),M,.06,er)}const hs=Math.hypot(a.x-(K.x+60*_),a.z-(K.z+60*_));hs<90*_&&Math.abs(a.speed)<24&&(y.footSpawn="port",G?o?.("foot"):a.area==="deck"&&(a.area="island",a.fx=K.x+40*_,a.fz=K.z+40*_,a.fy=re(a.fx,a.fz)+Ge,a.fvx=0,a.fvz=0,a.fvy=0,a.fyaw=Math.atan2(he.x-a.fx,he.z-a.fz),z.yaw=z.smYaw=a.fyaw+Math.PI)),I.boardQueued&&(I.boardQueued=!1,G?(y.footSpawn="deck",o?.("foot")):a.area==="deck"&&o?.("helm")),G&&(y.helm={speed:a.speed,heading:a.heading,throttle:a.throttle,aground:a.aground,x:a.x,z:a.z,toGate:Math.min(Math.hypot(a.x,a.z-Ot),Math.hypot(a.x,a.z-oo)),underFire:[Ot,oo].some(ze=>{const st=Math.hypot(a.x,a.z-ze);return st>Xo.safe&&st<Xo.range}),moored:hs<180*_,maelstrom:He.danger,swallowed:a.swallowed,burst:a.burst,drift:a.drift,maxSpeed:D,cruise:It.level,flank:a.flank,freeCam:ve.freeCam},Za(M,y.helm)),y.shelter+=(Pe-y.shelter)*(1-Math.pow(.06,M)),y.underwater+=(0-y.underwater)*(1-Math.pow(.02,M))}if(e==="foot"){Yn(z,M,0);const O=I.boost?ga:Jc;a.fpitch+=(-z.smPitch-a.fpitch)*(1-Math.pow(1e-4,M));const oe=I.walk.x,ue=I.walk.z,D=Math.hypot(oe,ue),$=D>1?D:1,Q=-Math.sin(z.smYaw),ae=-Math.cos(z.smYaw),be=-ae,de=Q,Ce=(Q*(ue/$)+be*(oe/$))*O,J=(ae*(ue/$)+de*(oe/$))*O,Ae=(1-Math.pow(D>.02?2e-5:4e-7,M))*(a.airborne?.25:1);a.fvx+=(Ce-a.fvx)*Ae,a.fvz+=(J-a.fvz)*Ae;const rt=a.fvx*M,Ne=a.fvz*M,Je=a.area==="island"?(Z,te)=>re(Z,te):a.area==="deck"?()=>y.ship.y+y.ship.deckY:(Z,te,q)=>fe.y+gi(Z-fe.x,te-fe.z,q-fe.y),it=a.area==="hall"?(Z,te,q)=>xi(Z-fe.x,te-fe.z,q-fe.y)||di(Z,q,te)>.97:()=>!1;if(a.area==="deck"){const Z=Math.cos(-y.ship.heading),te=Math.sin(-y.ship.heading);a.dx+=rt*Z+Ne*-te,a.dz+=rt*te+Ne*Z;const q=y.ship.loa*.14,we=y.ship.loa*.42;Math.abs(a.dx)>q&&(a.dx=Math.sign(a.dx)*q,a.fvx=0,a.fvz=0),Math.abs(a.dz)>we&&(a.dz=Math.sign(a.dz)*we,a.fvx=0,a.fvz=0);const Ve=Math.cos(y.ship.heading),ht=Math.sin(y.ship.heading);a.fx=y.ship.x+a.dx*Ve+a.dz*ht,a.fz=y.ship.z-a.dx*ht+a.dz*Ve}else if(a.area==="island"){const Z=a.fx+rt,te=a.fz+Ne,q=re(a.fx,a.fz),we=re(Z,te),Ve=Math.hypot(rt,Ne)||1e-6,ht=(we-q)/Ve;(we<=.3||ht>=1.2&&we>=q)&&(a.fvx=0,a.fvz=0),we>.3&&(ht<1.2||we<q)&&(a.fx=Z,a.fz=te)}else{const Z=a.fx+rt,te=a.fz+Ne,q=a.fy-Ge,we=Je(a.fx,a.fz,q),Ve=a.airborne?q:we;Je(Z,te,Ve)-Ve>xa||it(Z,te,q)?(a.fvx=0,a.fvz=0):(a.fx=Z,a.fz=te)}const vt=a.fy-Ge,$e=Je(a.fx,a.fz,vt);if(a.airborne?(a.fvy-=eh*M,a.fy+=a.fvy*M,a.fy-Ge<=$e&&(a.landing=-a.fvy,a.fy=$e+Ge,a.fvy=0,a.airborne=!1,a.landing>wa&&(Ut((a.landing-wa)*th,"A LONG WAY DOWN"),Ye.roll=0))):a.area==="deck"?(a.fy=$e+Ge,a.fvy=0,a.landing=Math.max(0,a.landing-M*40),I.jumpQueued&&(I.jumpQueued=!1,a.fvy=ba,a.airborne=!0)):vt-$e>xa?(a.airborne=!0,a.fvy=0):(a.fy+=($e+Ge-a.fy)*(1-Math.pow(.002,M)),a.landing=Math.max(0,a.landing-M*40),I.jumpQueued&&(I.jumpQueued=!1,a.fvy=ba,a.airborne=!0)),I.jumpQueued=!1,a.area==="island"){const Z=Math.hypot(a.fx-he.x,a.fz-he.z),te=Math.hypot(a.fx-W.gate.x,a.fz-W.gate.z);Z<80?(a.area="hall",a.fx=fe.x,a.fz=fe.z+dt.zTop,a.fy=fe.y+De.y+Ge,a.fvy=0,a.airborne=!1,a.fyaw=Math.PI,z.yaw=z.smYaw=0,z.pitch=z.smPitch=.05):te<40&&(a.area="hall",a.fx=fe.x+60,a.fz=fe.z+N.z+150,a.fy=fe.y+Ge,a.fvy=0,a.airborne=!1,a.fyaw=0,z.yaw=z.smYaw=Math.PI,z.pitch=z.smPitch=.04),y.helm={onFoot:!0,area:"island",x:a.fx,z:a.fz,fy:a.fy-fe.y,toMouth:Z,toRear:te,nearPort:Math.hypot(a.fx-K.x,a.fz-K.z)<K.r*1.4};const q=Mo(a.fx,a.fz);y.shelter+=(q-y.shelter)*(1-Math.pow(.06,M))}else if(a.area==="deck")y.helm={onFoot:!0,area:"deck",x:a.fx,z:a.fz,speed:a.speed,heading:a.heading,throttle:a.throttle,maxSpeed:(g.topSpeed??Go)*(1+da*a.flank),moored:!1};else{const Z=a.fz-fe.z;Z>De.z+34&&(a.area="island",a.fx=he.x,a.fz=he.z+130,a.fy=re(a.fx,a.fz)+Ge,a.fvy=0,a.airborne=!1,a.fyaw=0,z.yaw=z.smYaw=Math.PI,z.pitch=z.smPitch=-.04),y.helm={onFoot:!0,area:"hall",x:a.fx,z:a.fz,lz:Z,fy:a.fy-fe.y},y.shelter+=(1-y.shelter)*(1-Math.pow(.06,M))}const U=Math.hypot(a.fvx,a.fvz);a.stride+=U*M;const je=f.height??1.74;if(U>.4){let te=Math.atan2(a.fvx,a.fvz)-a.fyaw;for(;te>Math.PI;)te-=Math.PI*2;for(;te<-Math.PI;)te+=Math.PI*2;a.fyaw+=te*(1-Math.pow(4e-4,M))}a.fpitch+=(-z.smPitch-a.fpitch)*(1-Math.pow(1e-4,M)),a.pace=U,c.current.speed=U,c.current.maxSpeed=ga,c.current.grounded=!a.airborne,c.current.vy=a.fvy,c.current.landing=a.landing,Ye.playerTurn=(a.fyaw-a.fyaw0)/Math.max(M,1e-4),a.fyaw0=a.fyaw,d.x=a.fx,d.y=a.fy-Ge,d.z=a.fz,d.yaw=z.smYaw+Math.PI,d.pitch=z.smPitch,d.height=je,d.floorY=a.area==="hall"?a.fy-Ge:null,_c(M,d,I,b),(b.x||b.z)&&(a.fvx+=b.x,a.fvz+=b.z);const lt=(a.area==="deck"?Math.max(je*2.6,y.ship.loa*.75):je*2.6)*z.smZoom,He=Math.cos(z.smPitch),ct=a.area==="deck"?R.lerp(a.fy,a.deckY+y.ship.deckY+Ge,ve.comfort):a.fy,Le=ct+Math.sin(a.stride*1.6)*.05*Oe(1,.3),H=a.fx+Math.sin(z.smYaw)*He*lt,me=a.fz+Math.cos(z.smYaw)*He*lt;let Pe=Le+je*.28+Math.sin(z.smPitch)*lt;const Ue=a.area==="island"?re(H,me):ct-Ge;Pe=Math.max(Pe,Ue+je*.6),a.area==="deck"&&(Pe=Math.max(Pe,ct-Ge+y.ship.mastY*1.06)),Oo.set(H,Pe,me),a.snapCam?(a.snapCam=!1,r.position.copy(Oo)):r.position.lerp(Oo,1-Math.pow(Oe(9e-4,.02),M)),r.lookAt(ma.set(a.fx,Le-je*.1,a.fz)),Dn(r,a.area==="hall"?72:64,M,.02),h.current&&(h.current.position.set(a.fx,a.fy-Ge,a.fz),h.current.rotation.y=a.fyaw),y.underwater+=(0-y.underwater)*(1-Math.pow(.02,M))}y.fog=R.lerp(Gt.sea,Gt.bay,y.shelter),y.rain=1-y.shelter*.92}),t.jsxs(t.Fragment,{children:[t.jsx("group",{ref:h,position:[0,-4e3,0],visible:e==="foot",children:t.jsx(Ir,{character:f,motion:c})}),t.jsxs("group",{ref:l,position:[0,-4e3,0],visible:e==="helm",children:[T&&t.jsx(xe,{name:k,loa:j,slim:cn(k),sink:zo(k),rotation:an(k),tint:ns(k,g.tint),emissive:"#3a2a18",emissiveIntensity:.24,glow:en(k)}),T&&L&&Wo.slice(0,2).map((C,A)=>{const[M,G]=os(k,j,C);return t.jsx(xe,{name:g.crew,height:rn,rotation:C[2],position:[M,At(k,j),G]},`crew-${A}`)}),t.jsxs("mesh",{position:[0,2,0],scale:[1,.74,2.7],castShadow:!0,visible:!T,children:[t.jsx("capsuleGeometry",{args:[5,9,4,12]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.84})]}),t.jsxs("mesh",{position:[0,5.4,0],visible:!T,children:[t.jsx("boxGeometry",{args:[8.6,.8,24]}),t.jsx("meshStandardMaterial",{color:"#6b4b34",roughness:.92})]}),t.jsxs("mesh",{position:[0,6.6,13],rotation:[.5,0,0],castShadow:!0,visible:!T,children:[t.jsx("boxGeometry",{args:[4,10,2.6]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.86})]}),t.jsxs("mesh",{position:[0,9,-8.5],castShadow:!0,visible:!T,children:[t.jsx("boxGeometry",{args:[8,7,7.5]}),t.jsx("meshStandardMaterial",{color:"#a85f24",roughness:.88})]}),t.jsxs("mesh",{position:[0,16,1],castShadow:!0,visible:!T,children:[t.jsx("cylinderGeometry",{args:[1.05,1.4,27,6]}),t.jsx("meshStandardMaterial",{color:"#2f2016",roughness:.9})]}),t.jsxs("mesh",{position:[0,25.5,1.2],rotation:[0,0,Math.PI/2],castShadow:!0,visible:!T,children:[t.jsx("cylinderGeometry",{args:[.6,.6,19,5]}),t.jsx("meshStandardMaterial",{color:"#241a12",roughness:.9})]}),t.jsxs("mesh",{ref:x,position:[0,17.5,1.5],visible:!T,children:[t.jsx("planeGeometry",{args:[17,15]}),t.jsx("meshStandardMaterial",{color:"#f0e6cf",roughness:1,side:_e,emissive:"#f0e6cf",emissiveIntensity:.3})]}),t.jsxs("group",{position:[0,7.4,14.6],visible:!T,children:[t.jsxs("mesh",{castShadow:!0,children:[t.jsx("sphereGeometry",{args:[3.4,10,8]}),t.jsx("meshStandardMaterial",{color:"#e0a33c",roughness:.8})]}),t.jsxs("mesh",{position:[0,0,-1.2],rotation:[Math.PI/2,0,0],children:[t.jsx("torusGeometry",{args:[4.5,1.6,6,14]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.82})]})]}),[-1,1].map(C=>t.jsxs("group",{position:[C*(T?ts(k,j)*.62:3.2),(T?At(k,j):8)+qo*3.4,-j*.19],children:[t.jsxs("mesh",{children:[t.jsx("sphereGeometry",{args:[qo,7,5]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:3.2,toneMapped:!1})]}),t.jsx("sprite",{scale:[Jo,Jo,1],children:t.jsx("spriteMaterial",{map:ss,color:E.lantern,transparent:!0,opacity:.5,depthWrite:!1,blending:pt,toneMapped:!1})})]},C)),t.jsx(So,{crew:g.flag,width:jo(j),position:[0,T?ko(k,j)*.9:26,-j*.06]}),t.jsxs("mesh",{ref:p,position:[0,.6,-j*1.05],rotation:[-Math.PI/2,0,0],children:[t.jsx("planeGeometry",{args:[j*.6,j*2.2]}),t.jsx("meshBasicMaterial",{map:Cn,color:X.foam,transparent:!0,opacity:.3,depthWrite:!1,toneMapped:!1})]}),t.jsxs("mesh",{ref:m,position:[0,j*.12,j*.56],rotation:[-.5,0,0],children:[t.jsx("planeGeometry",{args:[j*.85,j*.6]}),t.jsx("meshBasicMaterial",{map:Ji,color:X.foam,transparent:!0,opacity:0,depthWrite:!1,toneMapped:!1,blending:pt})]})]})]})}const ya=76,nh=24,va=26,sh=1.15,ah=.44,rh=.05,ih=.22,lh=70,No=340,Ma=7,ch=6,ja=60,Ho=185,hh=new S,ka=new S,_o={x:430*_,z:1e3*_};function uh({mode:e,onMode:o}){const n=Me(T=>T.camera),s=Me(T=>T.gl),r=w.useRef(),i=w.useRef(),l=w.useRef(),h=w.useRef(),c=w.useRef([]),d=w.useCallback(T=>{c.current=T},[]),b=ot("ship-tang.opt.glb"),f=ot("ship-sub.opt.glb"),x=b||f,m=ot("crew-heart.opt.glb"),p=b?"ship-tang.opt.glb":"ship-sub.opt.glb",g=ln(p,28),u=w.useRef({x:_o.x,z:_o.z,heading:Math.PI,speed:0,throttle:0,rudder:0,flank:0,depth:0,orderedDepth:0,pitch:0,heel:0,scrape:0,stress:0,berthing:0,snapCam:!0}).current,v=pr({enabled:e==="sub",dom:s.domElement,zoomMin:.32,zoomMax:3.4,pitch0:.15,pitchMin:-1.24,pitchMax:1.42});return w.useEffect(()=>{if(e==="sub")return u.x=_o.x,u.z=_o.z,u.heading=Math.PI,u.speed=0,u.throttle=0,u.flank=0,u.depth=0,u.orderedDepth=0,u.berthing=0,u.snapCam=!0,v.yaw=0,v.smYaw=0,v.pitch=.15,v.smPitch=.15,v.pitch0=.15,v.zoom=1,v.smZoom=1,v.noRecentre=!1,u.heel=0,y.subActive=!0,y.helm=null,Gn("sub"),()=>{y.subActive=!1,y.subThrottle=0}},[e,u,v]),se((T,k)=>{if(e!=="sub"){r.current&&r.current.position.set(0,-4e3,0);return}const j=Math.min(k,.05);y.t+=j;const L=u.heading,a=I.boost;u.throttle+=(I.throttle-u.throttle)*(1-Math.pow(.02,j)),u.flank+=((a?1:0)-u.flank)*(1-Math.pow(rh,j)),y.subThrottle=Math.abs(u.throttle),u.rudder+=(I.rudder-u.rudder)*(1-Math.pow(8e-4,j));const z=R.clamp(u.depth/15,0,1),C=ya*(.7+.3*z)*(1+ah*u.flank),A=u.throttle>=0?u.throttle*C:u.throttle*nh;u.speed+=R.clamp(A-u.speed,-va*2,va)*j,u.speed-=u.speed*Math.abs(u.speed)*.0016*j;const M=R.lerp(ih,1,R.clamp(Math.abs(u.speed)/7,0,1));u.heading+=u.rudder*sh*M*Math.sign(u.speed>=0?1:-1)*j,u.orderedDepth-=I.planes*lh*j,u.orderedDepth=R.clamp(u.orderedDepth,0,No),I.surfaceQueued&&(I.surfaceQueued=!1,u.orderedDepth=0),I.periscopeQueued&&(I.periscopeQueued=!1,u.orderedDepth=ch);const G=u.x+Math.sin(u.heading)*u.speed*j,P=u.z+Math.cos(u.heading)*u.speed*j,O=Oa(G,P,u.depth);u.x=G+O.vx*j,u.z=P+O.vz*j;const oe=O.vx*Math.cos(u.heading)-O.vz*Math.sin(u.heading);u.heading+=oe*.008*j;const ue=R.clamp(Math.abs(u.speed)/ya,0,1),D=R.clamp(oe*.02+u.rudder*M*ue*.34,-.6,.6);u.heel+=(D-u.heel)*(1-Math.pow(.12,j)),O.danger>.05&&(u.speed*=Math.pow(1-.22*O.danger,j));const $=re(u.x,u.z),Q=Math.max(2,-$-Ma),ae=u.depth<1.5;u.depth+=(u.orderedDepth-u.depth)*(1-Math.pow(.12,j)),u.depth>Q?(u.scrape+=(1-u.scrape)*(1-Math.pow(.02,j)),u.depth=Q,u.orderedDepth=Math.min(u.orderedDepth,Q-2),Ut(Math.abs(u.speed)*.0016*j*60,"GROUNDED ON THE SHELF"),u.speed*=Math.pow(.3,j)):u.scrape+=(0-u.scrape)*(1-Math.pow(.05,j));const be=(u.depth-Ho)/(No-Ho);u.stress=be>0?Math.min(1,be*be):0,u.stress>0&&Ut(u.stress*.06*j,"HULL UNDER PRESSURE — COME UP");const de=u.x+Math.sin(u.heading)*26,Ce=u.z+Math.cos(u.heading)*26;if(re(de,Ce)>-u.depth+Ma*.5){u.speed*=Math.pow(.1,j);const Ke=6,Xe=re(u.x+Ke,u.z)-re(u.x-Ke,u.z),To=re(u.x,u.z+Ke)-re(u.x,u.z-Ke),Nt=Math.hypot(Xe,To)||1;u.x-=Xe/Nt*20*j,u.z-=To/Nt*20*j,u.scrape=Math.max(u.scrape,.5)}const Ae=Math.hypot(u.x-W.x,u.z-W.z);if(Ae<W.pool*1.1&&u.berthing===0&&(u.berthing=1e-4),u.berthing>0){u.berthing=Math.min(1,u.berthing+j*.5),u.x+=(W.berth.x-u.x)*(1-Math.pow(.1,j)),u.z+=(W.berth.z-u.z)*(1-Math.pow(.1,j)),u.orderedDepth=0,u.speed*=Math.pow(.1,j);let Xe=Math.atan2(W.dir[0],W.dir[1])+Math.PI-u.heading;for(;Xe>Math.PI;)Xe-=Math.PI*2;for(;Xe<-Math.PI;)Xe+=Math.PI*2;u.heading+=Xe*(1-Math.pow(.2,j)),u.berthing>=1&&u.depth<1.2&&(y.footSpawn="rear",y.splash+=1,o?.("foot"))}u.depth<1.5!==ae&&(y.splash+=1);const Ne=xt(u.x,u.z,y.t,1),Je=1-R.clamp(u.depth/10,0,1),it=-u.depth+Ne.y*Je,vt=R.clamp((u.orderedDepth-u.depth)*.05,-.34,.34)*Math.sign(u.speed>=0?1:-1)+Ne.dz*.8*Je;u.pitch+=(vt-u.pitch)*(1-Math.pow(.05,j));const $e=r.current;$e&&($e.position.set(u.x,it,u.z),$e.rotation.set(u.pitch+u.scrape*Math.sin(y.t*23)*.02,u.heading,-Ne.dx*.5*Je+u.heel)),i.current&&(i.current.rotation.z+=u.throttle*9*j),l.current&&(l.current.visible=u.depth<2.5),h.current&&(h.current.visible=u.depth<7);const U=en(p);if(U){const Ke=U[1]*(1+y.underwater*1.1+R.clamp(u.depth/260,0,1)*.6);for(const Xe of c.current)Xe.emissiveIntensity=Ke}y.subPos.set(u.x,it,u.z),Yn(v,j,u.heading-L);const je=u.heading+Math.PI+v.smYaw,lt=Math.cos(v.smPitch),He=R.clamp(u.depth/240,0,1),ct=Math.max(g*2,52)*v.smZoom*(1-He*.2)*tr(n.aspect),Le=hh.set(u.x+Math.sin(je)*lt*ct,it+g*.12+Math.sin(v.smPitch)*ct,u.z+Math.cos(je)*lt*ct),H=re(Le.x,Le.z);Le.y=Math.max(Le.y,H+5),u.depth>10&&(Le.y=Math.min(Le.y,Ne.y-3)),u.snapCam?(u.snapCam=!1,n.position.copy(Le)):n.position.lerp(Le,1-Math.pow(Oe(8e-4,.02),j));const me=Math.max(0,Math.cos(v.smYaw)),Pe=ue*Oe(46,26)*me;ka.set(u.x+Math.sin(u.heading)*Pe,it+6-u.pitch*30*ue*Oe(1,.35),u.z+Math.cos(u.heading)*Pe),n.lookAt(ka);const Ue=Oe(1,0);Ue>.001&&n.rotateZ((u.scrape*Math.sin(y.t*19)*.015+u.heel*.35+O.danger*Math.sin(y.t*3.1)*.02)*Ue),Dn(n,64+ue*Oe(6,2)+u.flank*Oe(2,.6),j,.06,er);const Z=xt(n.position.x,n.position.z,y.t,1),te=R.clamp((Z.y-n.position.y-1)/3,0,1);y.underwater+=(te-y.underwater)*(1-Math.pow(.002,j)),y.depthBelow=Math.max(0,Z.y-n.position.y);const q=R.lerp(8200,1700,y.underwater);Math.abs(n.far-q)>20&&(n.far=q,n.updateProjectionMatrix()),y.shelter+=((Ae<W.pool*3?.85:0)-y.shelter)*(1-Math.pow(.06,j));let we=Be[0],Ve=1/0;for(const Ke of Be){const Xe=(u.x-Ke.x)**2+(u.z-Ke.z)**2;Xe<Ve&&(Ve=Xe,we=Ke)}qa(j,{danger:O.danger,headingX:Math.sin(u.heading),headingZ:Math.cos(u.heading),toCentreX:we.x-u.x,toCentreZ:we.z-u.z,speed:u.speed,throttle:u.throttle})>=1&&(Ut(.22,"CAUGHT IN THE VORTEX"),u.x=we.x+(u.x>we.x?1:-1)*we.r*1.9,u.z=we.z+we.r*1.5,u.speed=0,u.orderedDepth=Math.min(No,u.depth+18),Y.grip=0,y.splash+=1);let nt=Math.atan2(W.x-u.x,W.z-u.z)-u.heading;for(;nt>Math.PI;)nt-=Math.PI*2;for(;nt<-Math.PI;)nt+=Math.PI*2;y.helm={sub:!0,speed:u.speed,maxSpeed:C,heading:u.heading,depth:u.depth,orderedDepth:u.orderedDepth,scrape:u.scrape,stress:u.stress,maelstrom:O.danger,toRear:Ae,relRear:nt,berthing:u.berthing>0,x:u.x,z:u.z,maxDepth:No,crushDepth:Ho,cruise:It.level,flank:u.flank,freeCam:ve.freeCam,dark:R.clamp((u.depth-ja)/(Ho-ja),0,1)},Za(j,y.helm)}),t.jsxs("group",{ref:r,position:[0,-4e3,0],children:[x&&t.jsx(xe,{name:p,loa:g,slim:cn(p),glow:en(p),onMaterials:d,sink:zo(p),rotation:an(p),tint:ns(p,"#c9b445"),emissive:"#2a2410",emissiveIntensity:.22}),t.jsx("group",{ref:l,position:[0,At(p,g),-g*.07],children:m&&t.jsx(xe,{name:"crew-heart.opt.glb",height:rn,rotation:0})}),t.jsx("group",{ref:h,position:[0,At(p,g),-g*.2],children:t.jsx(So,{crew:"heart",width:jo(g),position:[0,ko(p,g)*.42,0],staff:!0})}),x&&[-1,1].map(T=>[0,1,2,3,4,5,6].map(k=>t.jsxs("mesh",{position:[T*ts(p,g)*.55,At(p,g)-g*.02,g*(.24-k*.08)],children:[t.jsx("sphereGeometry",{args:[g*.011,6,5]}),t.jsx("meshStandardMaterial",{color:"#b8ffe2",emissive:"#8fe8c9",emissiveIntensity:2.4,toneMapped:!1})]},`port-${T}-${k}`))),t.jsxs("group",{visible:!x,children:[t.jsxs("mesh",{castShadow:!0,scale:[1,.82,2.9],children:[t.jsx("capsuleGeometry",{args:[5.4,8,6,12]}),t.jsx("meshStandardMaterial",{color:"#c9b03a",roughness:.55,metalness:.18})]}),t.jsxs("mesh",{position:[0,4.6,0],children:[t.jsx("boxGeometry",{args:[7.6,.8,26]}),t.jsx("meshStandardMaterial",{color:"#8a7a3a",roughness:.8})]}),t.jsxs("mesh",{position:[0,8,5],castShadow:!0,children:[t.jsx("cylinderGeometry",{args:[2.6,3,7,8]}),t.jsx("meshStandardMaterial",{color:"#d8cebf",roughness:.6})]}),t.jsxs("mesh",{position:[0,12,5],castShadow:!0,children:[t.jsx("coneGeometry",{args:[2.8,3,8]}),t.jsx("meshStandardMaterial",{color:"#5a6b8a",roughness:.6})]}),t.jsxs("mesh",{position:[0,3,-15],castShadow:!0,children:[t.jsx("boxGeometry",{args:[.9,10,5]}),t.jsx("meshStandardMaterial",{color:"#b09a32",roughness:.6})]}),t.jsxs("mesh",{position:[0,.4,-14],rotation:[0,0,Math.PI/2],children:[t.jsx("boxGeometry",{args:[.8,12,4]}),t.jsx("meshStandardMaterial",{color:"#b09a32",roughness:.6})]}),[-1,1].map(T=>[0,1,2,3].map(k=>t.jsxs("mesh",{position:[T*5.1,1.2,8-k*5],children:[t.jsx("sphereGeometry",{args:[.55,6,5]}),t.jsx("meshStandardMaterial",{color:"#8fe8c9",emissive:"#8fe8c9",emissiveIntensity:2.6,toneMapped:!1})]},`${T}-${k}`)))]}),t.jsxs("mesh",{position:[0,g*.02,g*.5],children:[t.jsx("sphereGeometry",{args:[1.7,10,8]}),t.jsx("meshStandardMaterial",{color:"#b8ffe2",emissive:"#8fe8c9",emissiveIntensity:4.2,toneMapped:!1})]}),t.jsx("sprite",{position:[0,g*.02,g*.6],scale:[g*.9,g*.9,1],children:t.jsx("spriteMaterial",{map:ss,color:"#7fe8c9",transparent:!0,opacity:.5,depthWrite:!1,blending:pt})}),t.jsxs("mesh",{position:[0,g*.24,-g*.42],children:[t.jsx("sphereGeometry",{args:[.9,8,6]}),t.jsx("meshStandardMaterial",{color:"#ffb066",emissive:"#ffb066",emissiveIntensity:3,toneMapped:!1})]}),t.jsxs("mesh",{ref:i,position:[0,g*.012,-g*.52],children:[t.jsx("torusGeometry",{args:[1.6,.5,6,10]}),t.jsx("meshStandardMaterial",{color:"#6b5a20",roughness:.5,metalness:.4})]}),t.jsx(fh,{})]})}const dh=`
  uniform float uTime;
  uniform float uGain;
  attribute float aPhase;
  attribute float aRate;
...
`+(H.maelstrom>.2?"⚠ MAELSTROM — HARD OVER, FULL AHEAD":H.moored?"MOORING":H.aground>.3?"AGROUND — HELM OVER":H.underFire?`⚠ UNDER FIRE — STRAIGHT FOR THE ARCH    GATE ${Math.round(H.toGate)}m`:H.drift>.62?`MAKING LEEWAY — EASE THE HELM    GATE ${Math.round(H.toGate)}m`:`GATE ${Math.round(H.toGate)}m`)}}if(ae.current){const H=Sl(),me=kl(Y.chain);ae.current.textContent=Y.done?"✔ OBJECTIVE COMPLETE":H?`▸ ${Y.step+1}/${me}  ${H.text}`:"",ae.current.style.color=Y.done?"#8fe0a0":"#ffd9cf"}if(be.current){const H=Math.max(0,Math.min(1,Y.hull)),me=Math.max(0,Math.min(1,Y.grip)),Pe=te=>{const q=Math.round(te*12);return"█".repeat(q)+"·".repeat(12-q)},Ue=H>.6?"#8fe0a0":H>.3?"#ffc46b":"#ff6b5a",Z=me>.66?"#ff6b5a":me>.33?"#ffc46b":"rgba(255,255,255,0.45)";be.current.innerHTML=`<span style="color:${Ue}">HULL ${Pe(H)}</span>`+(me>.02?`<span style="color:${Z};margin-left:14px">VORTEX ${Pe(me)}</span>`:"")}if(de.current){const H=Y.banner,me=de.current;H?(me.dataset.text!==H.text&&(me.dataset.text=H.text,me.innerHTML=`<div class="og-banner-main">${H.text}</div>`+(H.sub?`<div class="og-banner-sub">${H.sub}</div>`:""),me.style.animation="none",me.offsetWidth,me.style.animation=""),me.style.opacity="1"):(me.style.opacity="0",me.dataset.text="")}d&&$.current?(He++,lt+=Le-je,je=Le,lt>400&&($.current.textContent=`${Math.round(He*1e3/lt)} fps · shelter ${z.shelter.toFixed(2)} · fog ${(z.fog*1e4).toFixed(1)}e-4 · flash ${z.flash.toFixed(2)}`,lt=0,He=0)):je=Le};return U=requestAnimationFrame(ct),()=>cancelAnimationFrame(U)},[z,d]);const J={opacity:ue?.16:1,transform:ue?"translateY(6px)":"none",transition:"opacity .5s ease, transform .5s ease"},Ae=[{key:"rails",on:!i,label:i?"FREE LOOK":"ON RAILS",title:"Take the camera off rails and look around",click:f,cinematicOnly:!0},{key:"helm",on:v==="helm",label:v==="helm"?"LEAVE HELM":"TAKE THE HELM",title:"Take the helm and sail the approach yourself",click:()=>T(v==="helm"?"off":"helm")},{key:"deck",on:!1,label:"WALK THE DECK",title:"Step back from the wheel and walk the deck as your pirate — she sails on",click:()=>{z.footSpawn="deck",T("foot")},helmOnly:!0},{key:"sub",on:v==="sub",label:v==="sub"?"LEAVE THE TANG":"DIVE THE POLAR TANG",title:"Dive under the maelstroms and take the back way in",click:()=>T(v==="sub"?"off":"sub")},{key:"foot",on:v==="foot",label:v==="foot"?"LEAVE DOME":"ENTER THE DOME",title:"Walk the Live Floor inside the Skull Dome",click:()=>T(v==="foot"?"off":"foot")}],rt=U=>v==="foot"?t.jsx(Qe,{on:!0,wide:!0,block:U,title:"Swap between Luffy and Zoro, in their Wano gear",onClick:()=>j?.(k==="zoro"?"luffy":"zoro"),children:k==="zoro"?"ZORO · 和":"LUFFY · 和"}):null,Ne=U=>v==="helm"?t.jsx(Qe,{on:!0,wide:!0,block:U,title:"Swap between the Thousand Sunny and Kid's Victoria Punk",onClick:()=>a?.(L==="punk"?"sunny":"punk"),children:L==="punk"?"VICTORIA PUNK":"THOUSAND SUNNY"}):null,Je=(U,je)=>t.jsx(Qe,{on:U.on,onClick:U.click,title:U.title,wide:!0,block:je,children:U.label},U.key),it=U=>A?t.jsxs(t.Fragment,{children:[t.jsx(Qe,{on:O.comfort>.01,wide:!0,block:U,title:"Steady the camera: less roll, less shake, less lens movement. The fix if the motion is making you queasy.",onClick:Bl,children:O.comfort>.9?"COMFORT · FULL":O.comfort>.01?"COMFORT · SOME":"COMFORT · OFF"}),t.jsx(Qe,{on:O.freeCam,wide:!0,block:U,title:"Free camera: the view stays where you put it instead of swinging back behind the ship (V)",onClick:()=>eo("freeCam"),children:O.freeCam?"CAM · FREE":"CAM · CHASE"}),t.jsx(Qe,{on:Math.abs(O.lookSens-1)>.01,wide:!0,block:U,title:"How far a drag turns the view",onClick:Ul,children:`LOOK ${O.lookSens.toFixed(2).replace(/0$/,"")}×`}),t.jsx(Qe,{on:O.invertY,wide:!0,block:U,title:"Invert the vertical look axis",onClick:()=>eo("invertY"),children:O.invertY?"Y · INVERTED":"Y · NORMAL"})]}):null,vt=()=>A?t.jsx(Qe,{on:!O.hud,title:"Hide the readouts, the chart and the objective — just the picture (H)",onClick:()=>eo("hud"),children:O.hud?"◱":"◰"}):null,$e=U=>t.jsxs(t.Fragment,{children:[!A&&t.jsxs(t.Fragment,{children:[t.jsx(Qe,{on:r,onClick:b,title:"Play / pause the cinematic",block:U,children:r?U?"❙❙  PAUSE":"❙❙":U?"▶  PLAY":"▶"}),[.5,1,2].map(je=>t.jsxs(Qe,{on:l===je,onClick:()=>x(je),title:`${je}× speed`,block:U,children:[je,"×"]},je))]}),t.jsx(Qe,{on:!1,onClick:p,title:"Restart from the open sea",block:U,children:U?"↺  RESTART":"↺"}),t.jsx(Qe,{on:g,onClick:u,title:"Storm, taiko and a temple bell — all synthesised",block:U,children:g?U?"♪  SOUND ON":"♪":U?"♪̸  SOUND OFF":"♪̸"}),t.jsx(Qe,{on:c!=="auto",wide:!0,block:U,title:"Render tier",onClick:()=>m(c==="auto"?"low":c==="low"?"mobile":c==="mobile"?"high":"auto"),children:c==="auto"?`AUTO · ${h.toUpperCase()}`:c.toUpperCase()})]});return t.jsxs(t.Fragment,{children:[!C&&t.jsxs(t.Fragment,{children:[[0,1].map(U=>t.jsx("div",{style:{position:"fixed",left:0,right:0,[U?"bottom":"top"]:0,height:Ce?kn:0,background:"#05040a",zIndex:8,pointerEvents:"none",transition:"height .7s cubic-bezier(.6,0,.2,1)"}},U)),t.jsxs("div",{className:"og-tategaki",style:{opacity:A||G?0:1,transition:"opacity .6s ease"},children:["鬼ヶ島",t.jsx("span",{className:"og-tategaki-sub",children:"ONIGASHIMA"})]}),t.jsx("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 26px)",zIndex:10,pointerEvents:"none",animation:"ogCaption .85s cubic-bezier(.2,.9,.2,1) both",transition:"bottom .7s cubic-bezier(.6,0,.2,1)",maxWidth:"min(70vw, 620px)",display:A?"none":"block"},children:t.jsxs("div",{style:{display:"inline-block",borderLeft:`2px solid ${bo}`,paddingLeft:12},children:[t.jsx("div",{style:{font:'700 clamp(15px, 2.5vw, 27px)/1.15 "Hiragino Mincho ProN", "Yu Mincho", Georgia, serif',letterSpacing:"0.07em",color:"#fff6f0",textShadow:"0 2px 22px rgba(0,0,0,0.95), 0 0 44px rgba(0,0,0,0.7)"},children:e?.title}),t.jsx("div",{style:{marginTop:5,font:"500 clamp(9px, 1.15vw, 12px)/1.5 ui-monospace, Menlo, monospace",letterSpacing:"0.19em",color:"rgba(255,225,215,0.66)",textShadow:"0 1px 12px rgba(0,0,0,0.95)"},children:e?.sub})]})},e?.id),t.jsx("div",{style:{position:"fixed",left:0,right:0,bottom:"var(--og-bottom)",height:2,zIndex:10,background:"rgba(255,255,255,0.08)",pointerEvents:"none",opacity:A?0:1,transition:"bottom .7s cubic-bezier(.6,0,.2,1), opacity .4s ease"},children:t.jsx("div",{ref:D,style:{height:"100%",background:`linear-gradient(90deg, ${bo}, #ff9c2e)`,transformOrigin:"0 50%",transform:"scaleX(0)",boxShadow:`0 0 14px ${bo}`}})}),t.jsx("div",{className:`og-chrome${A?"":" og-chrome-bottom"}`,style:{...A?{top:"calc(var(--og-top) + 14px)"}:{bottom:"calc(var(--og-bottom) + 22px)"},...J},children:M?t.jsxs(t.Fragment,{children:[A&&t.jsx(Qe,{on:!0,onClick:()=>T("off"),wide:!0,title:"Back to the cinematic",children:"✕ EXIT"}),vt(),t.jsx(Qe,{on:G,onClick:()=>P(U=>!U),title:"Menu",children:G?"✕":"☰"}),G&&t.jsxs("div",{className:"og-menu",children:[A&&t.jsxs(t.Fragment,{children:[rt(!0),Ne(!0),it(!0),t.jsx("div",{className:"og-menu-rule"})]}),Ae.filter(U=>!(U.cinematicOnly&&A)&&!(U.helmOnly&&v!=="helm")).map(U=>Je(U,!0)),t.jsx("div",{className:"og-menu-rule"}),$e(!0)]})]}):t.jsxs(t.Fragment,{children:[vt(),rt(!1),Ne(!1),it(!1),$e(!1),Ae.filter(U=>!(U.cinematicOnly&&A)&&!(U.helmOnly&&v!=="helm")).map(U=>Je(U,!1))]})}),!A&&t.jsxs("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",top:"calc(var(--og-top) + 18px)",zIndex:10,font:"600 10px/1 ui-monospace, Menlo, monospace",letterSpacing:"0.3em",color:"rgba(255,255,255,0.4)",textShadow:"0 1px 10px #000",transition:"top .7s cubic-bezier(.6,0,.2,1)",...J,pointerEvents:"none"},children:[i?`SHOT ${String(o+1).padStart(2,"0")} / ${String(n).padStart(2,"0")}`:"FREE LOOK · DRAG ORBIT · WASD FLY · 2-FINGER / SHIFT-DRAG PAN · PINCH ZOOM · R HOME",t.jsx("span",{style:{opacity:.5},children:i?`  ·  ${Math.round(s)}s`:""})]}),A&&O.hud&&t.jsxs("div",{className:"og-instruments",children:[t.jsx("div",{ref:ae,className:"og-objective"}),t.jsx("div",{ref:Q,className:"og-readout"}),t.jsx("div",{ref:be,className:"og-gauges"}),t.jsx("div",{className:"og-keys",children:v==="helm"?"W/S THROTTLE · A/D RUDDER · SHIFT FLANK · X ENGINE LATCH · B BURST · T WALK THE DECK · DRAG LOOK · R RECENTRE · V FREE CAM · WHEEL ZOOM":v==="sub"?"W/S THROTTLE · A/D RUDDER · SPACE RISE · C DIVE · SHIFT FLANK · X LATCH · F SURFACE · P PERISCOPE · DRAG LOOK · R RECENTRE · V FREE CAM":k==="zoro"?"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J ONIGIRI · U TATSUMAKI · K YAKKODORI · L SANZEN · G FLASH · H ASURA · DRAG ORBIT":"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J PISTOL · U GATLING · K BAZOOKA · L GIGANT · G ROCKET · H HAKI · N GEAR 2 · I BALLOON · DRAG ORBIT"})]}),A&&O.hud&&t.jsx("div",{ref:de,className:"og-banner"}),d&&t.jsx("div",{ref:$,style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 96px)",zIndex:14,font:"500 10px/1 ui-monospace, Menlo, monospace",color:"#7fe0a0",background:Fh,padding:"5px 8px",borderRadius:3,pointerEvents:"none"}})]}),t.jsx("style",{children:`
      ...
      `})]})}const ls="#d63420",cs="#4aa9c9",Hh=(e,o,n)=>e<o?o:e>n?n:e;function mr(e,o,n){const s=w.useRef(o);s.current=o;const r=w.useRef(null),i=w.useRef({x:0,y:0});w.useEffect(()=>{const l=e.current;if(!l||!n)return;const h=f=>{if(r.current===null){r.current=f.pointerId,i.current={x:f.clientX,y:f.clientY};try{l.setPointerCapture?.(f.pointerId)}catch{}s.current.onMove(0,0,f.clientX,f.clientY),f.preventDefault()}},c=f=>{if(f.pointerId!==r.current)return;const x=i.current;s.current.onMove(f.clientX-x.x,f.clientY-x.y,x.x,x.y),f.preventDefault()},d=f=>{f.pointerId===r.current&&(r.current=null,s.current.onEnd(),f.cancelable&&f.preventDefault())};l.addEventListener("pointerdown",h),l.addEventListener("pointermove",c),l.addEventListener("pointerup",d),l.addEventListener("pointercancel",d),window.addEventListener("pointerup",d),window.addEventListener("pointercancel",d);const b=()=>{r.current!==null&&(r.current=null,s.current.onEnd())};return window.addEventListener("blur",b),()=>{l.removeEventListener("pointerdown",h),l.removeEventListener("pointermove",c),l.removeEventListener("pointerup",d),l.removeEventListener("pointercancel",d),window.removeEventListener("pointerup",d),window.removeEventListener("pointercancel",d),window.removeEventListener("blur",b)}},[e,n])}function Ea({label:e,sub:o,onDown:n,onUp:s,tone:r="plain",wide:i=!1}){const[l,h]=w.useState(!1),c=w.useRef();w.useEffect(()=>{const b=c.current;if(!b)return;let f=null;const x=p=>{f=p.pointerId;try{b.setPointerCapture?.(f)}catch{}h(!0),n(),p.preventDefault(),p.stopPropagation()},m=p=>{p.pointerId===f&&(f=null,h(!1),s(),p.preventDefault(),p.stopPropagation())};return b.addEventListener("pointerdown",x),b.addEventListener("pointerup",m),b.addEventListener("pointercancel",m),b.addEventListener("pointerleave",m),()=>{b.removeEventListener("pointerdown",x),b.removeEventListener("pointerup",m),b.removeEventListener("pointercancel",m),b.removeEventListener("pointerleave",m)}},[n,s]);const d=r==="hot"?ls:r==="cool"?cs:"rgba(255,255,255,0.22)";return t.jsxs("div",{ref:c,className:`og-btn${i?" og-btn-wide":""}`,style:{border:`1px solid ${l?d:"rgba(255,255,255,0.18)"}`,background:l?`color-mix(in srgb, ${d} 34%, rgba(8,6,16,0.5))`:"rgba(8,6,16,0.46)",color:l?"#fff6f0":"rgba(255,255,255,0.8)"},children:[t.jsx("span",{style:{fontSize:"1em",letterSpacing:"0.1em"},children:e}),o&&t.jsx("span",{className:"og-btn-sub",children:o})]})}function tt({label:e,sub:o,onTap:n,on:s,tone:r="plain",wide:i=!1}){const l=w.useRef(),h=w.useRef(n);h.current=n,w.useEffect(()=>{const d=l.current;if(!d)return;const b=f=>{h.current(),f.preventDefault(),f.stopPropagation()};return d.addEventListener("pointerdown",b),()=>d.removeEventListener("pointerdown",b)},[]);const c=r==="hot"?ls:r==="cool"?cs:"rgba(255,255,255,0.22)";return t.jsxs("div",{ref:l,className:`og-btn${i?" og-btn-wide":""}`,style:{border:`1px solid ${s?c:"rgba(255,255,255,0.18)"}`,background:s?`color-mix(in srgb, ${c} 30%, rgba(8,6,16,0.5))`:"rgba(8,6,16,0.46)",color:s?"#fff6f0":"rgba(255,255,255,0.8)"},children:[t.jsx("span",{style:{fontSize:"1em",letterSpacing:"0.1em"},children:e}),o&&t.jsx("span",{className:"og-btn-sub",children:o})]})}function _h(){const[e,o]=w.useState(It.level);return w.useEffect(()=>Vl(o),[]),t.jsx(tt,{label:e===2?"FLANK":e===1?"AHEAD":"ENGINE",sub:e?"set · tap":"latch",tone:e===2?"hot":"cool",on:e>0,onTap:sr})}function Bh({simple:e=!1}){const[o,n]=w.useState(ve.freeCam);w.useEffect(()=>as(r=>n(r.freeCam)),[]);const s=w.useRef(null);return e?t.jsx(tt,{label:"LEVEL",sub:"view",onTap:()=>I.recentreQueued=!0}):t.jsx(tt,{label:o?"CAM FREE":"RECENTRE",sub:o?"tap×2 chase":"tap×2 free",on:o,onTap:()=>{const r=performance.now();if(s.current&&r-s.current<420){s.current=null,eo("freeCam"),I.recentreQueued=!0;return}s.current=r,I.recentreQueued=!0}})}function Uh({active:e}){const o=w.useRef(),n=w.useRef(),s=w.useRef(),r=78;return w.useEffect(()=>{if(!e)return;let i;const l=()=>{i=requestAnimationFrame(l);const h=s.current,c=y.helm;h&&(h.textContent=c?.sub?String(Math.round(c.orderedDepth)):"⇕")};return i=requestAnimationFrame(l),()=>cancelAnimationFrame(i)},[e]),mr(o,{onMove:(i,l,h,c)=>{const d=o.current;if(!d)return;const b=d.getBoundingClientRect(),f=b.top+b.height/2,x=Hh((c+l-f)/r,-1,1),m=Math.abs(x)<.1?0:x;ee.active=!0,ee.planes=-m;const p=n.current;p&&(p.style.transform=`translate(-50%, calc(-50% + ${x*r}px))`,p.style.borderColor=cs,p.style.background="rgba(74,169,201,0.34)")},onEnd:()=>{ee.planes=0;const i=n.current;i&&(i.style.transform="translate(-50%, -50%)",i.style.borderColor="rgba(255,255,255,0.3)",i.style.background="rgba(8,6,16,0.55)")}},e),t.jsxs("div",{ref:o,className:"og-planes",children:[t.jsx("div",{className:"og-planes-rail"}),t.jsx("span",{className:"og-planes-cap og-planes-up",children:"RISE"}),t.jsx("span",{className:"og-planes-cap og-planes-dn",children:"DIVE"}),t.jsxs("div",{ref:n,className:"og-planes-knob",children:[t.jsx("span",{ref:s,children:"⇕"}),t.jsx("span",{className:"og-planes-unit",children:"m"})]})]})}function Wh({mode:e,crew:o="luffy",vessel:n="sunny",hud:s=!0}){const[r,i]=w.useState(!1);w.useEffect(()=>{if(e!=="foot"){i(!1);return}const v=setInterval(()=>i(y.helm?.area==="deck"),200);return()=>clearInterval(v)},[e]);const l=w.useRef(),h=w.useRef(),c=w.useRef(),d=w.useRef(),b=62,f=7,x=w.useRef(e);if(x.current=e,mr(l,{onMove:(v,T,k,j)=>{const L=Math.hypot(v,T),a=L>b?b/L:1,z=v*a,C=T*a,A=h.current,M=c.current;A&&(A.style.transform=`translate(${k-b}px, ${j-b}px)`,A.style.opacity="1"),M&&(M.style.transform=`translate(${k+z-26}px, ${j+C-26}px)`,M.style.opacity="1"),d.current&&(d.current.style.opacity="0");const G=Math.abs(z)<f?0:z/b,P=Math.abs(C)<f?0:C/b;ee.active=!0,x.current==="foot"?(ee.walk.x=G,ee.walk.z=-P):(ee.throttle=-P,ee.rudder=-G)},onEnd:()=>{h.current&&(h.current.style.opacity="0"),c.current&&(c.current.style.opacity="0"),d.current&&(d.current.style.opacity=""),ee.throttle=0,ee.rudder=0,ee.walk.x=0,ee.walk.z=0}},e!=="off"),w.useEffect(()=>(document.documentElement.classList.add("og-touch"),()=>document.documentElement.classList.remove("og-touch")),[]),w.useEffect(()=>()=>{ee.throttle=0,ee.rudder=0,ee.planes=0,ee.boost=!1,ee.walk.x=0,ee.walk.z=0},[e]),e==="off")return null;const m=e==="sub",p=e==="foot",g=r,u=o==="zoro";return t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:l,style:{position:"fixed",left:0,top:0,width:"50vw",height:"100vh",zIndex:12,touchAction:"none",background:"transparent"}}),t.jsx("div",{ref:h,style:{position:"fixed",left:0,top:0,width:b*2,height:b*2,borderRadius:"50%",border:"1.5px solid rgba(255,255,255,0.22)",background:"rgba(8,6,16,0.3)",pointerEvents:"none",opacity:0,zIndex:12,transition:"opacity .18s"}}),t.jsx("div",{ref:c,style:{position:"fixed",left:0,top:0,width:52,height:52,borderRadius:"50%",border:`1.5px solid ${ls}`,background:"rgba(214,52,32,0.3)",boxShadow:"0 0 22px rgba(214,52,32,0.45)",pointerEvents:"none",opacity:0,zIndex:12,transition:"opacity .18s"}}),s&&t.jsxs("div",{ref:d,className:"og-hint",style:{left:"max(26px, 5vw)"},children:[t.jsx("div",{className:"og-ring"}),t.jsx("span",{children:p?"DRAG TO WALK":"DRAG TO STEER"})]}),s&&t.jsx("div",{className:"og-hint og-hint-right",children:t.jsx("span",{children:"LOOK · PINCH TO ZOOM · TAP×2 RECENTRE"})}),t.jsxs("div",{className:"og-right",children:[m&&t.jsx(Uh,{active:!0}),t.jsxs("div",{className:"og-actions",children:[m&&t.jsx(tt,{label:"SURFACE",sub:"blow all",onTap:()=>I.surfaceQueued=!0}),m&&t.jsx(tt,{label:"PERISCOPE",sub:"6m",tone:"cool",onTap:()=>I.periscopeQueued=!0}),e==="helm"&&t.jsx(tt,{label:In(n).burst?.label??"BURST",sub:In(n).burst?.sub??"coup de",tone:"cool",onTap:()=>I.burstQueued=!0}),(e==="helm"||g)&&t.jsx(tt,{label:g?"TAKE WHEEL":"WALK DECK",sub:g?"back to it":"she sails on",onTap:()=>I.boardQueued=!0}),p&&t.jsx(tt,{label:"JUMP",sub:"↑",onTap:()=>I.jumpQueued=!0}),p&&t.jsxs(t.Fragment,{children:[t.jsx(tt,{label:u?"ONIGIRI":"PISTOL",sub:"strike",tone:"hot",onTap:()=>I.pistolQueued=!0}),t.jsx(tt,{label:u?"YAKKO":"BAZOOKA",sub:u?"flying cut":"both fists",tone:"cool",onTap:()=>I.bazookaQueued=!0}),t.jsx(tt,{label:u?"SANZEN":"GIGANT",sub:"heavy",tone:"hot",onTap:()=>I.gigantQueued=!0}),t.jsx(tt,{label:u?"FLASH":"ROCKET",sub:"dash",tone:"cool",onTap:()=>I.rocketQueued=!0}),t.jsx(tt,{label:u?"ASURA":"HAKI",sub:"burst",onTap:()=>I.hakiQueued=!0}),!u&&t.jsx(tt,{label:"GEAR 2",sub:"overdrive",onTap:()=>I.gear2Queued=!0}),t.jsx(Ea,{label:u?"TATSUMAKI":"GATLING",sub:"hold",tone:"hot",onDown:()=>ee.gatling=!0,onUp:()=>ee.gatling=!1})]}),!p&&t.jsx(_h,{}),t.jsx(Ea,{label:p?"RUN":"FLANK",sub:p?"»":"over",tone:"hot",onDown:()=>ee.boost=!0,onUp:()=>ee.boost=!1}),t.jsx(Bh,{simple:p})]})]}),t.jsx("style",{children:`
        .og-btn {
          border-radius: 10px;
...
`,Ca={low:{dpr:[1,1.1],shadows:!1,aa:!1,shadowMap:512,segments:110,shadowEvery:24,scene:"low"},mobile:{dpr:[1,1.5],shadows:!0,aa:!1,shadowMap:1024,segments:168,shadowEvery:16,scene:"mid"},high:{dpr:[1,2],shadows:!0,aa:!0,shadowMap:2048,segments:240,shadowEvery:10,scene:"high"}};function Xh(){if(typeof navigator>"u")return"high";const e=navigator.hardwareConcurrency||4,o=typeof navigator.deviceMemory=="number"?navigator.deviceMemory:null;return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&/Macintosh/.test(navigator.userAgent)?e<=3||o!==null&&o<=2?"low":"mobile":e<=2||o!==null&&o<=2?"low":"high"}const Qh=null;function t0(){const e=w.useMemo(()=>!1,[]),[o]=w.useState(Xh),[n,s]=w.useState("auto"),r=n==="auto"?o:n,i=Ca[r]??Ca.high;w.useEffect(()=>{wi(i.scene!=="low")},[i.scene]),w.useMemo(()=>Ga(i.scene),[i.scene]),w.useMemo(()=>Yl(),[]),w.useEffect(()=>$l(),[]);const l=w.useMemo(()=>typeof navigator>"u"?!1:typeof location<"u"&&new URLSearchParams(location.search).has("touch")?!0:navigator.maxTouchPoints>0,[]),[h,c]=w.useState(0),[d,b]=w.useState(!0),[f,x]=w.useState(!0),[m,p]=w.useState(1),[g,u]=w.useState(Js[0]),[v,T]=w.useState(0),[k,j]=w.useState(mh),[L,a]=w.useState(()=>{if(typeof location>"u")return"off";const J=new URLSearchParams(location.search).get("mode");return J==="helm"||J==="sub"||J==="foot"?J:"off"}),[z,C]=w.useState(()=>typeof location>"u"?"luffy":new URLSearchParams(location.search).get("crew")==="zoro"?"zoro":"luffy"),[A,M]=w.useState(()=>typeof location>"u"?"sunny":new URLSearchParams(location.search).get("ship")==="punk"?"punk":"sunny");w.useEffect(()=>{if(!k)return;const J=()=>{Mn(),vn(!0)};for(const Ae of["pointerdown","keydown","touchstart"])window.addEventListener(Ae,J,{once:!0,passive:!0});return()=>{for(const Ae of["pointerdown","keydown","touchstart"])window.removeEventListener(Ae,J)}},[k]);const G=w.useCallback(()=>{j(J=>{const Ae=!J;return Ae&&Mn(),vn(Ae),Ae})},[]),[P,O]=w.useState(()=>typeof location<"u"&&new URLSearchParams(location.search).has("enter")),oe=w.useCallback(J=>{k&&(Mn(),vn(!0)),J==="off"?(y.jumpTo=0,b(!0),x(!0)):a(J),O(!0)},[k]),[ue,D]=w.useState(()=>ve.hud);w.useEffect(()=>as(J=>D(J.hud)),[]);const[$,Q]=w.useState(!1),ae=w.useRef(!0);w.useEffect(()=>{if(ar(),ae.current){ae.current=!1;return}Q(!0);const J=setTimeout(()=>Q(!1),210);return()=>clearTimeout(J)},[L]);const be=w.useCallback((J,Ae)=>{T(J),u(Ae)},[]),de=w.useCallback(()=>{bi(),c(J=>J+1),b(!0),x(!0)},[]),Ce=w.useMemo(()=>typeof location<"u"&&new URLSearchParams(location.search).has("dev"),[]);return e?t.jsx(w.Suspense,{fallback:null,children:t.jsx(Qh,{})}):t.jsxs(t.Fragment,{children:[t.jsx(Mr,{shadows:i.shadows,dpr:i.dpr,gl:{antialias:i.aa,powerPreference:"high-performance",toneMapping:Ar,toneMappingExposure:Pr,preserveDrawingBuffer:!0},camera:{fov:52,near:1,far:8200,position:[-190,26,880]},frameloop:"always",children:t.jsx(w.Suspense,{fallback:null,children:t.jsx(Lh,{quality:i.scene,budget:i,onRails:f,playing:d,speed:m,onShot:be,mode:L,onMode:a,crew:z,vessel:A},h)})}),l&&P&&t.jsx(Wh,{mode:L,crew:z,vessel:A,hud:ue}),P&&ue&&t.jsx(Kh,{mode:L}),t.jsx("div",{"aria-hidden":!0,style:{position:"fixed",inset:0,zIndex:30,background:"#05040a",pointerEvents:"none",opacity:$?1:0,transition:$?"opacity .2s ease-in":"opacity .42s ease-out"}}),!P&&t.jsx(Nh,{onPick:oe}),t.jsx(Oh,{veiled:!P,shot:g,shotIndex:v,shotCount:Js.length,total:Wn,playing:d,onRails:f,speed:m,tier:r,override:n,dev:Ce,onPlay:()=>b(J=>!J),onRailsToggle:()=>x(J=>!J),onSpeed:p,onQuality:s,onRestart:de,audio:k,onAudio:G,mode:L,onMode:a,crew:z,onCrew:C,vessel:A,onVessel:M,stage:y})]})}export{t0 as default};
