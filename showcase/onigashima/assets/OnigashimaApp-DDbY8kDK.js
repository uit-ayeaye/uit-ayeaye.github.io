var sa=Object.defineProperty;var aa=(e,o,n)=>o in e?sa(e,o,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[o]=n;var Rn=(e,o,n)=>aa(e,typeof o!="symbol"?o+"":o,n);import{r as g,u as J,j as t,d as js,f as Me,h as ra,i as ia}from"./vendor-C2HIMx-P.js";import{t as fe,c as j,aD as Yo,au as un,d as pn,a5 as Te,aJ as la,f as ca,Y as An,a0 as Fn,ag as S,h as q,aK as ha,ay as da,az as Ot,aA as Dt,aq as Ss,R as ua,M as _e,o as Qe,at as vt,ax as ot,aL as eo,aM as to,a4 as pa,a8 as xt,ar as Nt,av as zs,aC as ma,A as fa}from"./three-Zo_RlN_K.js";import{f as Gt,m as mn}from"./index-A2uIQfgC.js";const X={skyHigh:"#140f2b",skyLow:"#3a2a5c",cloud:"#2a2244",cloudLit:"#6b3f5e",seaDeep:"#080d1c",seaShallow:"#16294a",foam:"#c8d6e8",rock:"#2b2f3f",rockLit:"#4c5468",snow:"#aebdd4",pine:"#16202c",bolt:"#e9a8ff",boltGlow:"#a855f7",haze:"#1d1936",abyss:"#04161f",underGlow:"#7fc9c0",underHaze:"#0a2e35"},T={furnace:"#fff1c4",ember:"#ff9c2e",emberDeep:"#c9411a",lantern:"#ff7a3c",lanternFar:"#ffb066",vermilion:"#d63420",vermilionDeep:"#7e1c14",rockWarm:"#6d3a2c",gilt:"#e8a33d",sakura:"#f2a8c4",timber:"#6b4b34"},wo={dir:[.72,.52,-.44],col:"#f2e9cf"},ft={sea:.00105,bay:48e-5,deepGrade:210},xa=1.15;function te(e){const o=new fe(e);return[o.r,o.g,o.b]}const ga=`
  varying vec3 vDir;
  void main() {
    vDir = position;
...
`,Kn={low:1600,mid:3800,high:7e3},ro=460;function Pr({quality:e}){const o=g.useRef(),n=Me(l=>l.camera),a=g.useMemo(()=>{const l=Kn[e]??Kn.high,c=new Float32Array(l*3),h=new Float32Array(l),d=new Float32Array(l);for(let x=0;x<l;x++)c[x*3]=Math.random()*ro,c[x*3+1]=Math.random()*ro,c[x*3+2]=Math.random()*ro,h[x]=.7+Math.random()*.6,d[x]=.55+Math.random()*.85;const p=new xt;return p.setAttribute("position",new q(c,3)),p.setAttribute("aSpeed",new q(h,1)),p.setAttribute("aLen",new q(d,1)),p.boundingSphere=new Nt(new j,1e6),p},[e]),i=g.useMemo(()=>({uTime:{value:0},uCam:{value:new j},uBox:{value:ro},uFall:{value:118},uSize:{value:2.4},uColor:{value:new j(...te("#b9c8e4"))},uOpacity:{value:.5}}),[]);return J((l,c)=>{const h=o.current?.uniforms;h&&(h.uTime.value+=c,h.uCam.value.copy(n.position),h.uOpacity.value=.5*y.rain*y.rain+y.flash*.3)}),t.jsx("points",{geometry:a,frustumCulled:!1,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:Lr,fragmentShader:Gr,uniforms:i,transparent:!0,depthWrite:!1,fog:!1})})}const Or=`
  uniform float uTime;
...
`,Zn={low:120,mid:340,high:700};function Nr({quality:e}){const o=g.useRef(),n=g.useMemo(()=>{const i=Zn[e]??Zn.high,l=[be[0],be[1],ce,ce],c=new Float32Array(i*3),h=new Float32Array(i),d=new Float32Array(i),p=new Float32Array(i);for(let u=0;u<i;u++){const m=l[u%l.length];c[u*3]=m.x+(Math.random()-.5)*74,c[u*3+1]=m.y+(Math.random()-.5)*30,c[u*3+2]=m.z+(Math.random()-.5)*26,h[u]=Math.random(),d[u]=.045+Math.random()*.055,p[u]=2+Math.random()*4}const x=new xt;return x.setAttribute("position",new q(c,3)),x.setAttribute("aPhase",new q(h,1)),x.setAttribute("aRise",new q(d,1)),x.setAttribute("aSize",new q(p,1)),x.boundingSphere=new Nt(new j(0,300,-260),700),x},[e]),a=g.useMemo(()=>({uTime:{value:0},uColor:{value:new j(...te(T.ember))}}),[]);return J((i,l)=>{o.current&&(o.current.uniforms.uTime.value+=l)}),t.jsx("points",{geometry:n,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:Or,fragmentShader:Dr,uniforms:a,transparent:!0,depthWrite:!1,blending:ot,fog:!1})})}function Hr({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(Ir,{quality:e}),t.jsx(Pr,{quality:e}),t.jsx(Nr,{quality:e})]})}const _r=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
...
`,os={low:700,mid:1800,high:3200},io=260;function ei({quality:e}){const o=g.useRef(),n=g.useRef(),a=Me(c=>c.camera),i=g.useMemo(()=>{const c=os[e]??os.high,h=new Float32Array(c*3),d=new Float32Array(c),p=new Float32Array(c),x=new Float32Array(c);for(let m=0;m<c;m++)h[m*3]=Math.random()*io,h[m*3+1]=Math.random()*io,h[m*3+2]=Math.random()*io,d[m]=.5+Math.random()*1.4,p[m]=1.2+Math.random()*3.2,x[m]=Math.random();const u=new xt;return u.setAttribute("position",new q(h,3)),u.setAttribute("aSpeed",new q(d,1)),u.setAttribute("aSize",new q(p,1)),u.setAttribute("aPhase",new q(x,1)),u.boundingSphere=new Nt(new j,1e6),u},[e]),l=g.useMemo(()=>({uTime:{value:0},uCam:{value:new j},uBox:{value:io},uColor:{value:new j(...te("#cfeee6"))},uGain:{value:0}}),[]);return J((c,h)=>{const d=o.current?.uniforms;d&&(d.uTime.value+=h,d.uCam.value.copy(a.position),d.uGain.value=y.underwater,n.current&&(n.current.visible=y.underwater>.02))}),t.jsx("points",{ref:n,geometry:i,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:o,vertexShader:qr,fragmentShader:Jr,uniforms:l,transparent:!0,depthWrite:!1,fog:!1})})}const ti=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
  uniform float uDir;
...
`,ns={low:260,mid:700,high:1300},ni=`
  varying vec2 vUv;
  varying vec3 vWorld;
  void main() {
    vUv = uv;
...
`;function fl(){const e=g.useRef(),o=g.useMemo(()=>{const i=new Float32Array(780),l=new Float32Array(260),c=new Float32Array(260),h=new Float32Array(260);for(let p=0;p<260;p++)i[p*3]=(Math.random()-.5)*3.4,i[p*3+1]=(Math.random()-.5)*2.6,i[p*3+2]=-14-Math.random()*4,l[p]=Math.random(),c[p]=.25+Math.random()*.3,h[p]=2+Math.random()*4;const d=new xt;return d.setAttribute("position",new q(i,3)),d.setAttribute("aPhase",new q(l,1)),d.setAttribute("aRate",new q(c,1)),d.setAttribute("aSize",new q(h,1)),d.boundingSphere=new Nt(new j(0,0,-30),70),d},[]),n=g.useMemo(()=>({uTime:{value:0},uGain:{value:0},uColor:{value:new j(...te(X.underGlow))}}),[]);return J((a,i)=>{const l=e.current?.uniforms;if(!l)return;l.uTime.value+=i;const c=y.subActive?y.subThrottle*y.underwater:0;l.uGain.value+=(c-l.uGain.value)*.06}),t.jsx("points",{geometry:o,renderOrder:3,children:t.jsx("shaderMaterial",{ref:e,vertexShader:pl,fragmentShader:ml,uniforms:n,transparent:!0,depthWrite:!1,blending:ot,fog:!1})})}const oa=.42;let D=null,lt=null,me=null,dn=!1,tt=!0;function xl(){try{const e=localStorage.getItem("oni.audio");e!==null&&(tt=e==="1")}catch{}return tt}function Bo(e){tt=e;try{localStorage.setItem("oni.audio",e?"1":"0")}catch{}return lt&&D&&lt.gain.setTargetAtTime(e?oa:0,D.currentTime,.12),e&&D?.state==="suspended"&&D.resume(),tt}function gl(e){const o=e.sampleRate*2,n=e.createBuffer(1,o,e.sampleRate),a=n.getChannelData(0);for(let i=0;i<o;i++)a[i]=Math.random()*2-1;return n}function $t(e,o,n,a,i,l,c){const h=e.createBufferSource();h.buffer=o,h.loop=!0;const d=e.createBiquadFilter();d.type=n,d.frequency.value=a,d.Q.value=i;const p=e.createGain();return p.gain.value=l,h.connect(d).connect(p).connect(c),h.start(),{src:h,filt:d,gain:p}}function Uo(){if(dn){D?.state==="suspended"&&D.resume();return}const e=window.AudioContext||window.webkitAudioContext;if(!e)return;D=new e,dn=!0,lt=D.createGain(),lt.gain.value=tt?oa:0;const o=D.createDynamicsCompressor();o.threshold.value=-18,o.knee.value=22,o.ratio.value=3.4,o.attack.value=.006,o.release.value=.26;const n=D.createBiquadFilter();n.type="lowpass",n.frequency.value=18e3,n.Q.value=.4,lt.connect(n).connect(o).connect(D.destination);const a=gl(D),i=D.createGain();i.gain.value=1,i.connect(lt);const l=$t(D,a,"bandpass",480,.7,.3,i),c=$t(D,a,"highpass",1900,.5,0,i),h=$t(D,a,"lowpass",220,1.1,.22,i),d=$t(D,a,"lowpass",96,1.6,0,i),p=D.createGain();p.gain.value=1,p.connect(o);const x=D.createOscillator();x.type="sawtooth",x.frequency.value=41;const u=D.createBiquadFilter();u.type="lowpass",u.frequency.value=190,u.Q.value=1.2;const m=D.createGain();m.gain.value=0,x.connect(u).connect(m).connect(p),x.start();const r=D.createOscillator(),s=D.createOscillator(),f=D.createGain();r.frequency.value=.07,s.frequency.value=.113,f.gain.value=260,r.connect(f),s.connect(f),f.connect(l.filt.frequency),r.start(),s.start();const b=D.createGain();b.gain.value=0,b.connect(lt);const w=D.createGain();w.gain.value=.16,w.connect(b);for(const[M,R]of[[146.83,1],[220,.5],[293.66,.3]]){const E=D.createOscillator();E.type="sine",E.frequency.value=M;const F=D.createGain();F.gain.value=R;const A=D.createOscillator(),C=D.createGain();A.frequency.value=.21+Math.random()*.1,C.gain.value=M*.004,A.connect(C).connect(E.frequency),A.start(),E.connect(F).connect(w),E.start()}const v=$t(D,a,"bandpass",900,3.2,.05,b);return me={stormBus:i,festBus:b,wind:l,rain:c,sea:h,roar:d,breath:v,buf:a,comp:o,muffle:n,humGain:m,subBus:p},D}function wl(){if(!D||!me||!tt)return;const e=D.currentTime;for(const[o,n]of[[0,.16],[.9,.045]]){const a=D.createOscillator(),i=D.createGain();a.type="sine",a.frequency.setValueAtTime(1420,e+o),a.frequency.exponentialRampToValueAtTime(1180,e+o+.5),i.gain.setValueAtTime(0,e+o),i.gain.linearRampToValueAtTime(n,e+o+.012),i.gain.exponentialRampToValueAtTime(1e-4,e+o+1.4),a.connect(i).connect(me.subBus),a.start(e+o),a.stop(e+o+1.5)}}function yl(e=1){if(!D||!me||!tt)return;const o=D.currentTime,n=D.createBufferSource();n.buffer=me.buf;const a=D.createBiquadFilter();a.type="bandpass",a.frequency.setValueAtTime(1500,o),a.frequency.exponentialRampToValueAtTime(240,o+.5),a.Q.value=.7;const i=D.createGain();i.gain.setValueAtTime(0,o),i.gain.linearRampToValueAtTime(.5*e,o+.02),i.gain.exponentialRampToValueAtTime(1e-4,o+.8),n.connect(a).connect(i).connect(lt),n.start(o),n.stop(o+.9)}function At(e,o=1,n=82){if(!D||!me)return;const a=D.createOscillator(),i=D.createGain();a.type="sine",a.frequency.setValueAtTime(n*2.1,e),a.frequency.exponentialRampToValueAtTime(n,e+.06),a.frequency.exponentialRampToValueAtTime(n*.7,e+.5),i.gain.setValueAtTime(0,e),i.gain.linearRampToValueAtTime(o,e+.004),i.gain.exponentialRampToValueAtTime(1e-4,e+.62),a.connect(i).connect(me.festBus),a.start(e),a.stop(e+.7);const l=D.createBufferSource();l.buffer=me.buf;const c=D.createBiquadFilter();c.type="bandpass",c.frequency.value=1400,c.Q.value=.8;const h=D.createGain();h.gain.setValueAtTime(o*.5,e),h.gain.exponentialRampToValueAtTime(1e-4,e+.09),l.connect(c).connect(h).connect(me.festBus),l.start(e),l.stop(e+.12)}function bl(e=1,o=0){if(!D||!me||!tt)return;const n=D.currentTime+o,a=D.createBufferSource();a.buffer=me.buf,a.loop=!0;const i=D.createBiquadFilter();i.type="lowpass",i.frequency.setValueAtTime(320,n),i.frequency.exponentialRampToValueAtTime(70,n+2.6),i.Q.value=.9;const l=D.createGain(),c=.5*e;l.gain.setValueAtTime(0,n),l.gain.linearRampToValueAtTime(c,n+.05),l.gain.exponentialRampToValueAtTime(c*.24,n+.7),l.gain.exponentialRampToValueAtTime(c*.42,n+1.35),l.gain.exponentialRampToValueAtTime(1e-4,n+3.4),a.connect(i).connect(l).connect(me.stormBus),a.start(n),a.stop(n+3.6);const h=D.createOscillator(),d=D.createGain();h.type="sine",h.frequency.setValueAtTime(46,n),h.frequency.exponentialRampToValueAtTime(28,n+2.2),d.gain.setValueAtTime(0,n),d.gain.linearRampToValueAtTime(.32*e,n+.08),d.gain.exponentialRampToValueAtTime(1e-4,n+2.6),h.connect(d).connect(me.stormBus),h.start(n),h.stop(n+2.8)}function vl(e=.5){if(!D||!me||!tt)return;const o=D.currentTime;for(const[n,a,i]of[[1,1,9],[2.76,.5,6],[5.4,.28,3.6],[8.9,.15,2.2]]){const l=D.createOscillator(),c=D.createGain();l.type="sine",l.frequency.value=61*n,c.gain.setValueAtTime(0,o),c.gain.linearRampToValueAtTime(e*a,o+.008),c.gain.exponentialRampToValueAtTime(1e-4,o+i),l.connect(c).connect(lt),l.start(o),l.stop(o+i+.1)}}let Ye=0,Wo=0,ys=0,Vt=0;function Ml(e){if(!dn||!D||!me||!tt)return;const o=D.currentTime,n=e.shelter,a=e.underwater,i=e.subActive?.12:1,l=Math.sin(n*Math.PI*.5)*i*(1-a*.92);me.stormBus.gain.setTargetAtTime(Math.cos(n*Math.PI*.5),o,.35),me.festBus.gain.setTargetAtTime(l,o,.35),me.rain.gain.gain.setTargetAtTime(.22*e.rain,o,.4),me.wind.gain.gain.setTargetAtTime(.3*(.25+e.rain*.75),o,.5),me.sea.gain.gain.setTargetAtTime(.22*(.3+e.rain*.7),o,.5),me.roar.gain.gain.setTargetAtTime(.55*e.whirlNear*(1-a*.55),o,.3),me.muffle.frequency.setTargetAtTime(18e3-a*17400,o,.18);const c=e.subActive?a*(.045+e.subThrottle*.11):e.helmActive?.03+e.helmSpeed*.1:0;if(me.humGain.gain.setTargetAtTime(c,o,.25),e.splash!==ys&&(ys=e.splash,yl(1)),e.subActive&&a>.5?Vt===0?Vt=o+1.2:o>=Vt&&(wl(),Vt=o+6.5):Vt=0,n>.06){const d=.9090909090909091;for(Ye<o&&(Ye=o+.1);Ye<o+.35;){const p=Wo%8,x=n*.9;p===0?At(Ye,.85*x,74):p===2?At(Ye,.45*x,88):p===4?At(Ye,.7*x,74):p===6?At(Ye,.4*x,92):p===7&&(At(Ye,.3*x,96),At(Ye+d*.5,.36*x,96)),Wo++,Ye+=d}}else Ye=0,Wo=0}function jl(){const e=g.useRef(!1),o=g.useRef(-1);return J(()=>{if(Ml(y),y.flash>.55&&!e.current){e.current=!0;const n=y.flashDir,a=500+Math.abs(n.z)*900;bl(Math.min(1,.55+y.flash*.6),a/340)}else y.flash<.08&&(e.current=!1);y.shot!==o.current&&(y.shot===4&&o.current>=0&&vl(.55),o.current=y.shot)}),null}function Sl({mode:e}){return y.mode=e,J(()=>fi(),-100),null}function zl({every:e=12}){const o=Me(a=>a.gl),n=g.useRef(0);return g.useEffect(()=>(o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0,()=>{o.shadowMap.autoUpdate=!0}),[o]),J(()=>{n.current+=1,n.current%e===0&&(o.shadowMap.needsUpdate=!0)}),null}function kl({budget:e}){const o=Me(a=>a.setDpr),n=g.useRef(e.dpr[1]);return t.jsx(ra,{bounds:a=>a>90?[50,90]:[46,58],flipflops:3,onDecline:()=>{n.current=Math.max(e.dpr[0],n.current-.25),o(n.current)},onIncline:()=>{n.current=Math.min(e.dpr[1],n.current+.25),o(n.current)},onFallback:()=>{n.current=e.dpr[0],o(e.dpr[0])}})}function Tl(){const e=Me(a=>a.gl),o=Me(a=>a.scene),n=Me(a=>a.camera);return g.useEffect(()=>{const a=setTimeout(()=>{try{e.compile(o,n)}catch(i){console.warn("[onigashima] pre-compile skipped",i)}},900);return()=>clearTimeout(a)},[e,o,n]),null}function El(){const{camera:e,scene:o,gl:n}=Me();return g.useEffect(()=>{},[e,o,n]),null}const Rl=new fe(X.haze),Al=new fe(X.underHaze),Fl=new fe(X.abyss),bs=new fe;function Cl(){const e=Me(o=>o.scene);return J(()=>{if(!e.fog)return;const o=S.clamp(y.depthBelow/ft.deepGrade,0,1),n=S.lerp(.0062,.0142,o);e.fog.density=S.lerp(y.fog,n,y.underwater),bs.copy(Al).lerp(Fl,o*.8),e.fog.color.lerpColors(Rl,bs,y.underwater)}),null}function Il({quality:e,budget:o,onRails:n,playing:a,speed:i,onShot:l,mode:c,onMode:h}){return t.jsxs(t.Fragment,{children:[t.jsx("color",{attach:"background",args:[X.haze]}),t.jsx("fogExp2",{attach:"fog",args:[X.haze,y.fog]}),t.jsx(ya,{storm:y}),t.jsx(Cr,{quality:e,shadowMap:o.shadowMap,shadows:o.shadows}),t.jsx($a,{quality:e,segments:o.segments}),t.jsx(Na,{quality:e,storm:y}),t.jsx(ar,{quality:e,shadows:o.shadows}),t.jsx(Dn,{quality:e,shadows:o.shadows}),e!=="low"&&t.jsx(Dn,{quality:e,shadows:!1,z:Qt,k:U*1.5}),t.jsx(hr,{quality:e,shadows:o.shadows}),t.jsx(ur,{quality:e,shadows:o.shadows}),t.jsx(Tr,{quality:e}),t.jsx(Rr,{shadows:o.shadows}),t.jsx(_i,{quality:e,shadows:o.shadows}),t.jsx(Hr,{quality:e}),t.jsx(Wr,{quality:e}),t.jsx(Qr,{quality:e}),t.jsx(ii,{quality:e}),t.jsx(Mi,{onRails:n&&c==="off",playing:a&&c==="off",speed:i,onShot:l,idle:c!=="off"}),t.jsx(Sl,{mode:c}),t.jsx(ol,{mode:c,onMode:h}),t.jsx(dl,{mode:c,onMode:h}),t.jsx(jl,{}),t.jsx(Cl,{}),t.jsx(El,{}),t.jsx(Tl,{}),t.jsx(kl,{budget:o}),o.shadows&&t.jsx(zl,{every:o.shadowEvery})]})}const Yt="#d63420",Ll="rgba(8,6,16,0.72)",vs="(max-width: 860px), (max-height: 520px)",$o="min(7.5vh, 62px)";function Gl(e=2600,o=!0){const[n,a]=g.useState(!1);return g.useEffect(()=>{if(!o){a(!1);return}let i;const l=()=>{a(!1),clearTimeout(i),i=setTimeout(()=>a(!0),e)};l();for(const c of["pointermove","pointerdown","keydown","touchstart","wheel"])window.addEventListener(c,l,{passive:!0});return()=>{clearTimeout(i);for(const c of["pointermove","pointerdown","keydown","touchstart","wheel"])window.removeEventListener(c,l)}},[e,o]),n}function Pl(){const[e,o]=g.useState(()=>typeof window<"u"&&window.matchMedia(vs).matches);return g.useEffect(()=>{const n=window.matchMedia(vs),a=()=>o(n.matches);return n.addEventListener?n.addEventListener("change",a):n.addListener(a),()=>{n.removeEventListener?n.removeEventListener("change",a):n.removeListener(a)}},[]),e}function Ue({on:e,onClick:o,children:n,title:a,wide:i,block:l}){return t.jsx("button",{onClick:o,title:a,style:{appearance:"none",border:`1px solid ${e?Yt:"rgba(255,255,255,0.16)"}`,background:e?"rgba(214,52,32,0.22)":"rgba(8,6,16,0.5)",color:e?"#ffd9cf":"rgba(255,255,255,0.78)",borderRadius:3,padding:i||l?"8px 13px":"8px 10px",font:"600 10px/1 ui-monospace, SFMono-Regular, Menlo, monospace",letterSpacing:"0.13em",cursor:"pointer",backdropFilter:"blur(9px)",WebkitBackdropFilter:"blur(9px)",transition:"border-color .18s, background .18s, color .18s",whiteSpace:"nowrap",width:l?"100%":void 0,textAlign:l?"right":"center",minHeight:32},children:n})}function Ol({shot:e,shotIndex:o,shotCount:n,total:a,playing:i,onRails:l,speed:c,tier:h,override:d,dev:p,onPlay:x,onRailsToggle:u,onSpeed:m,onQuality:r,onRestart:s,audio:f,onAudio:b,mode:w,onMode:v,stage:M,veiled:R=!1}){const E=w!=="off",F=Pl(),[A,C]=g.useState(!1),[z,k]=g.useState(()=>({...ye}));g.useEffect(()=>$s(Y=>k({...Y})),[]);const N=Gl(2600,!E&&!A),I=g.useRef(),V=g.useRef(),Z=g.useRef(),oe=g.useRef(),G=g.useRef(),L=g.useRef(),Q=l&&!E;g.useEffect(()=>C(!1),[w]),g.useEffect(()=>{let Y,je=performance.now(),Be=0,Le=0;const Ge=dt=>{if(Y=requestAnimationFrame(Ge),I.current&&(I.current.style.transform=`scaleX(${M.progress||0})`),Z.current&&M.helm){const P=M.helm;if(P.onFoot)Z.current.textContent=P.area==="island"?P.toRear<220?"ASHORE · THE REAR COVE  —  the cave gate is in the cliff":P.nearPort?"ASHORE · THE PORT  —  the mouth is up the talus":`ASHORE · ONIGASHIMA   MOUTH ${Math.round(P.toMouth)}m`:"INSIDE THE SKULL DOME  ·  LIVE FLOOR";else if(P.sub){const le=Math.abs(P.speed)*1.94;if(P.berthing)Z.current.textContent="BLOWING BALLAST — SURFACING IN THE REAR COVE";else{const ke=P.maelstrom>.22?P.depth<26?"⚠ MAELSTROM PULL — DIVE":"MAELSTROM OVERHEAD — RUNNING UNDER":P.stress>.02?"⚠ HULL UNDER PRESSURE":P.scrape>.3?"HULL ON THE ROCK":"",De=Math.abs(P.relRear*180/Math.PI),nt=De<6?"· ON COURSE":P.relRear>0?`◀ ${De.toFixed(0)}°`:`${De.toFixed(0)}° ▶`,Pe=10,st=Math.round(P.depth/P.maxDepth*Pe),gt=Math.round(P.crushDepth/P.maxDepth*Pe);let ut="";for(let Ee=0;Ee<Pe;Ee++)ut+=Ee<st?Ee>=gt?"▓":"█":Ee===gt?"┃":"·";const wt=P.cruise===2?" ⟲FLK":P.cruise===1?" ⟲AHD":"";Z.current.textContent=`DEPTH ${P.depth.toFixed(0).padStart(3,"0")}/${P.orderedDepth.toFixed(0).padStart(3,"0")}m ${ut}  ${le.toFixed(0).padStart(2,"0")} KN${wt}
...
`+(P.maelstrom>.2?"⚠ MAELSTROM — HARD OVER, FULL AHEAD":P.moored?"MOORING":P.aground>.3?"AGROUND — HELM OVER":P.underFire?`⚠ UNDER FIRE — STRAIGHT FOR THE ARCH    GATE ${Math.round(P.toGate)}m`:P.drift>.62?`MAKING LEEWAY — EASE THE HELM    GATE ${Math.round(P.toGate)}m`:`GATE ${Math.round(P.toGate)}m`)}}if(oe.current){const P=Vr(),le=$r(B.chain);oe.current.textContent=B.done?"✔ OBJECTIVE COMPLETE":P?`▸ ${B.step+1}/${le}  ${P.text}`:"",oe.current.style.color=B.done?"#8fe0a0":"#ffd9cf"}if(G.current){const P=Math.max(0,Math.min(1,B.hull)),le=Math.max(0,Math.min(1,B.grip)),ke=Pe=>{const st=Math.round(Pe*12);return"█".repeat(st)+"·".repeat(12-st)},De=P>.6?"#8fe0a0":P>.3?"#ffc46b":"#ff6b5a",nt=le>.66?"#ff6b5a":le>.33?"#ffc46b":"rgba(255,255,255,0.45)";G.current.innerHTML=`<span style="color:${De}">HULL ${ke(P)}</span>`+(le>.02?`<span style="color:${nt};margin-left:14px">VORTEX ${ke(le)}</span>`:"")}if(L.current){const P=B.banner,le=L.current;P?(le.dataset.text!==P.text&&(le.dataset.text=P.text,le.innerHTML=`<div class="og-banner-main">${P.text}</div>`+(P.sub?`<div class="og-banner-sub">${P.sub}</div>`:""),le.style.animation="none",le.offsetWidth,le.style.animation=""),le.style.opacity="1"):(le.style.opacity="0",le.dataset.text="")}p&&V.current?(Le++,Be+=dt-je,je=dt,Be>400&&(V.current.textContent=`${Math.round(Le*1e3/Be)} fps · shelter ${M.shelter.toFixed(2)} · fog ${(M.fog*1e4).toFixed(1)}e-4 · flash ${M.flash.toFixed(2)}`,Be=0,Le=0)):je=dt};return Y=requestAnimationFrame(Ge),()=>cancelAnimationFrame(Y)},[M,p]);const ae={opacity:N?.16:1,transform:N?"translateY(6px)":"none",transition:"opacity .5s ease, transform .5s ease"},xe=[{key:"rails",on:!l,label:l?"FREE LOOK":"ON RAILS",title:"Take the camera off rails and look around",click:u,cinematicOnly:!0},{key:"helm",on:w==="helm",label:w==="helm"?"LEAVE HELM":"TAKE THE HELM",title:"Take the helm and sail the approach yourself",click:()=>v(w==="helm"?"off":"helm")},{key:"sub",on:w==="sub",label:w==="sub"?"LEAVE THE TANG":"DIVE THE POLAR TANG",title:"Dive under the maelstroms and take the back way in",click:()=>v(w==="sub"?"off":"sub")},{key:"foot",on:w==="foot",label:w==="foot"?"LEAVE DOME":"ENTER THE DOME",title:"Walk the Live Floor inside the Skull Dome",click:()=>v(w==="foot"?"off":"foot")}],ne=(Y,je)=>t.jsx(Ue,{on:Y.on,onClick:Y.click,title:Y.title,wide:!0,block:je,children:Y.label},Y.key),We=Y=>E?t.jsxs(t.Fragment,{children:[t.jsx(Ue,{on:z.comfort>.01,wide:!0,block:Y,title:"Steady the camera: less roll, less shake, less lens movement. The fix if the motion is making you queasy.",onClick:ci,children:z.comfort>.9?"COMFORT · FULL":z.comfort>.01?"COMFORT · SOME":"COMFORT · OFF"}),t.jsx(Ue,{on:z.freeCam,wide:!0,block:Y,title:"Free camera: the view stays where you put it instead of swinging back behind the ship (V)",onClick:()=>zo("freeCam"),children:z.freeCam?"CAM · FREE":"CAM · CHASE"}),t.jsx(Ue,{on:Math.abs(z.lookSens-1)>.01,wide:!0,block:Y,title:"How far a drag turns the view",onClick:hi,children:`LOOK ${z.lookSens.toFixed(2).replace(/0$/,"")}×`}),t.jsx(Ue,{on:z.invertY,wide:!0,block:Y,title:"Invert the vertical look axis",onClick:()=>zo("invertY"),children:z.invertY?"Y · INVERTED":"Y · NORMAL"})]}):null,Ie=Y=>t.jsxs(t.Fragment,{children:[!E&&t.jsxs(t.Fragment,{children:[t.jsx(Ue,{on:i,onClick:x,title:"Play / pause the cinematic",block:Y,children:i?Y?"❙❙  PAUSE":"❙❙":Y?"▶  PLAY":"▶"}),[.5,1,2].map(je=>t.jsxs(Ue,{on:c===je,onClick:()=>m(je),title:`${je}× speed`,block:Y,children:[je,"×"]},je))]}),t.jsx(Ue,{on:!1,onClick:s,title:"Restart from the open sea",block:Y,children:Y?"↺  RESTART":"↺"}),t.jsx(Ue,{on:f,onClick:b,title:"Storm, taiko and a temple bell — all synthesised",block:Y,children:f?Y?"♪  SOUND ON":"♪":Y?"♪̸  SOUND OFF":"♪̸"}),t.jsx(Ue,{on:d!=="auto",wide:!0,block:Y,title:"Render tier",onClick:()=>r(d==="auto"?"low":d==="low"?"mobile":d==="mobile"?"high":"auto"),children:d==="auto"?`AUTO · ${h.toUpperCase()}`:d.toUpperCase()})]});return t.jsxs(t.Fragment,{children:[!R&&t.jsxs(t.Fragment,{children:[[0,1].map(Y=>t.jsx("div",{style:{position:"fixed",left:0,right:0,[Y?"bottom":"top"]:0,height:Q?$o:0,background:"#05040a",zIndex:8,pointerEvents:"none",transition:"height .7s cubic-bezier(.6,0,.2,1)"}},Y)),t.jsxs("div",{className:"og-tategaki",style:{opacity:E||A?0:1,transition:"opacity .6s ease"},children:["鬼ヶ島",t.jsx("span",{className:"og-tategaki-sub",children:"ONIGASHIMA"})]}),t.jsx("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 26px)",zIndex:10,pointerEvents:"none",animation:"ogCaption .85s cubic-bezier(.2,.9,.2,1) both",transition:"bottom .7s cubic-bezier(.6,0,.2,1)",maxWidth:"min(70vw, 620px)",display:E?"none":"block"},children:t.jsxs("div",{style:{display:"inline-block",borderLeft:`2px solid ${Yt}`,paddingLeft:12},children:[t.jsx("div",{style:{font:'700 clamp(15px, 2.5vw, 27px)/1.15 "Hiragino Mincho ProN", "Yu Mincho", Georgia, serif',letterSpacing:"0.07em",color:"#fff6f0",textShadow:"0 2px 22px rgba(0,0,0,0.95), 0 0 44px rgba(0,0,0,0.7)"},children:e?.title}),t.jsx("div",{style:{marginTop:5,font:"500 clamp(9px, 1.15vw, 12px)/1.5 ui-monospace, Menlo, monospace",letterSpacing:"0.19em",color:"rgba(255,225,215,0.66)",textShadow:"0 1px 12px rgba(0,0,0,0.95)"},children:e?.sub})]})},e?.id),t.jsx("div",{style:{position:"fixed",left:0,right:0,bottom:"var(--og-bottom)",height:2,zIndex:10,background:"rgba(255,255,255,0.08)",pointerEvents:"none",opacity:E?0:1,transition:"bottom .7s cubic-bezier(.6,0,.2,1), opacity .4s ease"},children:t.jsx("div",{ref:I,style:{height:"100%",background:`linear-gradient(90deg, ${Yt}, #ff9c2e)`,transformOrigin:"0 50%",transform:"scaleX(0)",boxShadow:`0 0 14px ${Yt}`}})}),t.jsx("div",{className:`og-chrome${E?"":" og-chrome-bottom"}`,style:{...E?{top:"calc(var(--og-top) + 14px)"}:{bottom:"calc(var(--og-bottom) + 22px)"},...ae},children:F?t.jsxs(t.Fragment,{children:[E&&t.jsx(Ue,{on:!0,onClick:()=>v("off"),wide:!0,title:"Back to the cinematic",children:"✕ EXIT"}),t.jsx(Ue,{on:A,onClick:()=>C(Y=>!Y),title:"Menu",children:A?"✕":"☰"}),A&&t.jsxs("div",{className:"og-menu",children:[E&&t.jsxs(t.Fragment,{children:[We(!0),t.jsx("div",{className:"og-menu-rule"})]}),xe.filter(Y=>!(Y.cinematicOnly&&E)).map(Y=>ne(Y,!0)),t.jsx("div",{className:"og-menu-rule"}),Ie(!0)]})]}):t.jsxs(t.Fragment,{children:[We(!1),Ie(!1),xe.filter(Y=>!(Y.cinematicOnly&&E)).map(Y=>ne(Y,!1))]})}),!E&&t.jsxs("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",top:"calc(var(--og-top) + 18px)",zIndex:10,font:"600 10px/1 ui-monospace, Menlo, monospace",letterSpacing:"0.3em",color:"rgba(255,255,255,0.4)",textShadow:"0 1px 10px #000",transition:"top .7s cubic-bezier(.6,0,.2,1)",...ae,pointerEvents:"none"},children:[l?`SHOT ${String(o+1).padStart(2,"0")} / ${String(n).padStart(2,"0")}`:"FREE LOOK · DRAG ORBIT · WASD FLY · 2-FINGER / SHIFT-DRAG PAN · PINCH ZOOM · R HOME",t.jsx("span",{style:{opacity:.5},children:l?`  ·  ${Math.round(a)}s`:""})]}),E&&t.jsxs("div",{className:"og-instruments",children:[t.jsx("div",{ref:oe,className:"og-objective"}),t.jsx("div",{ref:Z,className:"og-readout"}),t.jsx("div",{ref:G,className:"og-gauges"}),t.jsx("div",{className:"og-keys",children:w==="helm"?"W/S THROTTLE · A/D RUDDER · SHIFT FLANK · X ENGINE LATCH · B BURST · DRAG LOOK · R RECENTRE · V FREE CAM · WHEEL ZOOM":w==="sub"?"W/S THROTTLE · A/D RUDDER · SPACE RISE · C DIVE · SHIFT FLANK · X LATCH · F SURFACE · P PERISCOPE · DRAG LOOK · R RECENTRE · V FREE CAM":"WASD MOVE · SHIFT RUN · DRAG LOOK · R LEVEL VIEW"})]}),E&&t.jsx("div",{ref:L,className:"og-banner"}),p&&t.jsx("div",{ref:V,style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 96px)",zIndex:14,font:"500 10px/1 ui-monospace, Menlo, monospace",color:"#7fe0a0",background:Ll,padding:"5px 8px",borderRadius:3,pointerEvents:"none"}})]}),t.jsx("style",{children:`
      ...
      `})]})}const jn="#d63420",Sn="#4aa9c9",Hl=(e,o,n)=>e<o?o:e>n?n:e;function na(e,o,n){const a=g.useRef(o);a.current=o;const i=g.useRef(null),l=g.useRef({x:0,y:0});g.useEffect(()=>{const c=e.current;if(!c||!n)return;const h=u=>{if(i.current===null){i.current=u.pointerId,l.current={x:u.clientX,y:u.clientY};try{c.setPointerCapture?.(u.pointerId)}catch{}a.current.onMove(0,0,u.clientX,u.clientY),u.preventDefault()}},d=u=>{if(u.pointerId!==i.current)return;const m=l.current;a.current.onMove(u.clientX-m.x,u.clientY-m.y,m.x,m.y),u.preventDefault()},p=u=>{u.pointerId===i.current&&(i.current=null,a.current.onEnd(),u.cancelable&&u.preventDefault())};c.addEventListener("pointerdown",h),c.addEventListener("pointermove",d),c.addEventListener("pointerup",p),c.addEventListener("pointercancel",p),window.addEventListener("pointerup",p),window.addEventListener("pointercancel",p);const x=()=>{i.current!==null&&(i.current=null,a.current.onEnd())};return window.addEventListener("blur",x),()=>{c.removeEventListener("pointerdown",h),c.removeEventListener("pointermove",d),c.removeEventListener("pointerup",p),c.removeEventListener("pointercancel",p),window.removeEventListener("pointerup",p),window.removeEventListener("pointercancel",p),window.removeEventListener("blur",x)}},[e,n])}function _l({label:e,sub:o,onDown:n,onUp:a,tone:i="plain",wide:l=!1}){const[c,h]=g.useState(!1),d=g.useRef();g.useEffect(()=>{const x=d.current;if(!x)return;let u=null;const m=s=>{u=s.pointerId;try{x.setPointerCapture?.(u)}catch{}h(!0),n(),s.preventDefault(),s.stopPropagation()},r=s=>{s.pointerId===u&&(u=null,h(!1),a(),s.preventDefault(),s.stopPropagation())};return x.addEventListener("pointerdown",m),x.addEventListener("pointerup",r),x.addEventListener("pointercancel",r),x.addEventListener("pointerleave",r),()=>{x.removeEventListener("pointerdown",m),x.removeEventListener("pointerup",r),x.removeEventListener("pointercancel",r),x.removeEventListener("pointerleave",r)}},[n,a]);const p=i==="hot"?jn:i==="cool"?Sn:"rgba(255,255,255,0.22)";return t.jsxs("div",{ref:d,className:`og-btn${l?" og-btn-wide":""}`,style:{border:`1px solid ${c?p:"rgba(255,255,255,0.18)"}`,background:c?`color-mix(in srgb, ${p} 34%, rgba(8,6,16,0.5))`:"rgba(8,6,16,0.46)",color:c?"#fff6f0":"rgba(255,255,255,0.8)"},children:[t.jsx("span",{style:{fontSize:"1em",letterSpacing:"0.1em"},children:e}),o&&t.jsx("span",{className:"og-btn-sub",children:o})]})}function Lt({label:e,sub:o,onTap:n,on:a,tone:i="plain",wide:l=!1}){const c=g.useRef(),h=g.useRef(n);h.current=n,g.useEffect(()=>{const p=c.current;if(!p)return;const x=u=>{h.current(),u.preventDefault(),u.stopPropagation()};return p.addEventListener("pointerdown",x),()=>p.removeEventListener("pointerdown",x)},[]);const d=i==="hot"?jn:i==="cool"?Sn:"rgba(255,255,255,0.22)";return t.jsxs("div",{ref:c,className:`og-btn${l?" og-btn-wide":""}`,style:{border:`1px solid ${a?d:"rgba(255,255,255,0.18)"}`,background:a?`color-mix(in srgb, ${d} 30%, rgba(8,6,16,0.5))`:"rgba(8,6,16,0.46)",color:a?"#fff6f0":"rgba(255,255,255,0.8)"},children:[t.jsx("span",{style:{fontSize:"1em",letterSpacing:"0.1em"},children:e}),o&&t.jsx("span",{className:"og-btn-sub",children:o})]})}function Bl(){const[e,o]=g.useState(ht.level);return g.useEffect(()=>pi(o),[]),t.jsx(Lt,{label:e===2?"FLANK":e===1?"AHEAD":"ENGINE",sub:e?"set · tap":"latch",tone:e===2?"hot":"cool",on:e>0,onTap:Vs})}function Ul({simple:e=!1}){const[o,n]=g.useState(ye.freeCam);g.useEffect(()=>$s(i=>n(i.freeCam)),[]);const a=g.useRef(null);return e?t.jsx(Lt,{label:"LEVEL",sub:"view",onTap:()=>H.recentreQueued=!0}):t.jsx(Lt,{label:o?"CAM FREE":"RECENTRE",sub:o?"tap×2 chase":"tap×2 free",on:o,onTap:()=>{const i=performance.now();if(a.current&&i-a.current<420){a.current=null,zo("freeCam"),H.recentreQueued=!0;return}a.current=i,H.recentreQueued=!0}})}function Wl({active:e}){const o=g.useRef(),n=g.useRef(),a=g.useRef(),i=78;return g.useEffect(()=>{if(!e)return;let l;const c=()=>{l=requestAnimationFrame(c);const h=a.current,d=y.helm;h&&(h.textContent=d?.sub?String(Math.round(d.orderedDepth)):"⇕")};return l=requestAnimationFrame(c),()=>cancelAnimationFrame(l)},[e]),na(o,{onMove:(l,c,h,d)=>{const p=o.current;if(!p)return;const x=p.getBoundingClientRect(),u=x.top+x.height/2,m=Hl((d+c-u)/i,-1,1),r=Math.abs(m)<.1?0:m;ee.active=!0,ee.planes=-r;const s=n.current;s&&(s.style.transform=`translate(-50%, calc(-50% + ${m*i}px))`,s.style.borderColor=Sn,s.style.background="rgba(74,169,201,0.34)")},onEnd:()=>{ee.planes=0;const l=n.current;l&&(l.style.transform="translate(-50%, -50%)",l.style.borderColor="rgba(255,255,255,0.3)",l.style.background="rgba(8,6,16,0.55)")}},e),t.jsxs("div",{ref:o,className:"og-planes",children:[t.jsx("div",{className:"og-planes-rail"}),t.jsx("span",{className:"og-planes-cap og-planes-up",children:"RISE"}),t.jsx("span",{className:"og-planes-cap og-planes-dn",children:"DIVE"}),t.jsxs("div",{ref:n,className:"og-planes-knob",children:[t.jsx("span",{ref:a,children:"⇕"}),t.jsx("span",{className:"og-planes-unit",children:"m"})]})]})}function $l({mode:e}){const o=g.useRef(),n=g.useRef(),a=g.useRef(),i=g.useRef(),l=62,c=7,h=g.useRef(e);if(h.current=e,na(o,{onMove:(x,u,m,r)=>{const s=Math.hypot(x,u),f=s>l?l/s:1,b=x*f,w=u*f,v=n.current,M=a.current;v&&(v.style.transform=`translate(${m-l}px, ${r-l}px)`,v.style.opacity="1"),M&&(M.style.transform=`translate(${m+b-26}px, ${r+w-26}px)`,M.style.opacity="1"),i.current&&(i.current.style.opacity="0");const R=Math.abs(b)<c?0:b/l,E=Math.abs(w)<c?0:w/l;ee.active=!0,h.current==="foot"?(ee.walk.x=R,ee.walk.z=-E):(ee.throttle=-E,ee.rudder=-R)},onEnd:()=>{n.current&&(n.current.style.opacity="0"),a.current&&(a.current.style.opacity="0"),i.current&&(i.current.style.opacity=""),ee.throttle=0,ee.rudder=0,ee.walk.x=0,ee.walk.z=0}},e!=="off"),g.useEffect(()=>(document.documentElement.classList.add("og-touch"),()=>document.documentElement.classList.remove("og-touch")),[]),g.useEffect(()=>()=>{ee.throttle=0,ee.rudder=0,ee.planes=0,ee.boost=!1,ee.walk.x=0,ee.walk.z=0},[e]),e==="off")return null;const d=e==="sub",p=e==="foot";return t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:o,style:{position:"fixed",left:0,top:0,width:"50vw",height:"100vh",zIndex:12,touchAction:"none",background:"transparent"}}),t.jsx("div",{ref:n,style:{position:"fixed",left:0,top:0,width:l*2,height:l*2,borderRadius:"50%",border:"1.5px solid rgba(255,255,255,0.22)",background:"rgba(8,6,16,0.3)",pointerEvents:"none",opacity:0,zIndex:12,transition:"opacity .18s"}}),t.jsx("div",{ref:a,style:{position:"fixed",left:0,top:0,width:52,height:52,borderRadius:"50%",border:`1.5px solid ${jn}`,background:"rgba(214,52,32,0.3)",boxShadow:"0 0 22px rgba(214,52,32,0.45)",pointerEvents:"none",opacity:0,zIndex:12,transition:"opacity .18s"}}),t.jsxs("div",{ref:i,className:"og-hint",style:{left:"max(26px, 5vw)"},children:[t.jsx("div",{className:"og-ring"}),t.jsx("span",{children:p?"DRAG TO WALK":"DRAG TO STEER"})]}),t.jsx("div",{className:"og-hint og-hint-right",children:t.jsx("span",{children:"LOOK · PINCH TO ZOOM · TAP×2 RECENTRE"})}),t.jsxs("div",{className:"og-right",children:[d&&t.jsx(Wl,{active:!0}),t.jsxs("div",{className:"og-actions",children:[d&&t.jsx(Lt,{label:"SURFACE",sub:"blow all",onTap:()=>H.surfaceQueued=!0}),d&&t.jsx(Lt,{label:"PERISCOPE",sub:"6m",tone:"cool",onTap:()=>H.periscopeQueued=!0}),e==="helm"&&t.jsx(Lt,{label:"BURST",sub:"coup de",tone:"cool",onTap:()=>H.burstQueued=!0}),!p&&t.jsx(Bl,{}),t.jsx(_l,{label:p?"RUN":"FLANK",sub:p?"»":"over",tone:"hot",onDown:()=>ee.boost=!0,onUp:()=>ee.boost=!1}),t.jsx(Ul,{simple:p})]})]}),t.jsx("style",{children:`
        .og-btn {
          border-radius: 10px;
