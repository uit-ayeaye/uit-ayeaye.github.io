var Kr=Object.defineProperty;var Qr=(e,o,n)=>o in e?Kr(e,o,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[o]=n;var ja=(e,o,n)=>Qr(e,typeof o!="symbol"?o+"":o,n);import{r as w,u as ae,j as t,d as qs,f as xe,h as Xr,i as Zr}from"./vendor-C2HIMx-P.js";import{t as ze,c as z,aD as On,au as aa,d as sa,a5 as Be,aJ as qr,f as Jr,Y as Sa,a0 as za,ag as R,h as ee,aK as ei,ay as ti,az as po,aA as fo,aq as Js,R as oi,M as ut,o as Mt,at as $t,ax as it,aL as Xt,aM as mo,a4 as ni,a8 as Pt,ar as Zt,av as er,aI as ai,aC as si,A as ri}from"./three-Zo_RlN_K.js";import{f as co,m as Ao,w as $e,a as eo,e as Lt,P as ii,G as li,S as ci,I as hi}from"./index-B_lVtYqs.js";const X={skyHigh:"#140f2b",skyLow:"#3a2a5c",cloud:"#2a2244",cloudLit:"#6b3f5e",seaDeep:"#080d1c",seaShallow:"#16294a",foam:"#c8d6e8",rock:"#2b2f3f",rockLit:"#4c5468",snow:"#aebdd4",pine:"#16202c",bolt:"#e9a8ff",boltGlow:"#a855f7",haze:"#1d1936",abyss:"#03121f",underGlow:"#7cbfe4",underHaze:"#0b2b40"},A={furnace:"#fff1c4",ember:"#ff9c2e",emberDeep:"#c9411a",lantern:"#ff7a3c",lanternFar:"#ffb066",vermilion:"#d63420",vermilionDeep:"#7e1c14",rockWarm:"#6d3a2c",gilt:"#e8a33d",sakura:"#f2a8c4",timber:"#6b4b34"},en={dir:[.72,.52,-.44],col:"#f2e9cf"},Bt={sea:.00105,bay:48e-5,deepGrade:210},di=1.15;function ie(e){const o=new ze(e);return[o.r,o.g,o.b]}const ui=`
  varying vec3 vDir;
  void main() {
    vDir = position;
...
`;function fi({storm:e}){const o=w.useRef(),n=w.useMemo(()=>({uTime:{value:0},uHigh:{value:new z(...ie(X.skyHigh))},uLow:{value:new z(...ie(X.skyLow))},uCloud:{value:new z(...ie(X.cloud))},uCloudLit:{value:new z(...ie(X.cloudLit))},uEmber:{value:new z(...ie(A.ember))},uFlash:{value:0},uFlashColor:{value:new z(...ie(X.boltGlow))},uFlashDir:{value:new z(0,.4,-1)},uGlow:{value:1},uMoonDir:{value:new z(...en.dir).normalize()},uMoonCol:{value:new z(...ie(en.col))},uUnder:{value:0},uUnderCol:{value:new z(...ie(X.underHaze))}}),[]);return ae((a,s)=>{const i=o.current?.uniforms;i&&(i.uTime.value+=s,i.uFlash.value=e?.flash??0,e?.flashDir&&i.uFlashDir.value.copy(e.flashDir),i.uUnder.value=e?.underwater??0)}),t.jsxs("mesh",{frustumCulled:!1,renderOrder:-1,children:[t.jsx("sphereGeometry",{args:[1,32,20]}),t.jsx("shaderMaterial",{ref:o,vertexShader:ui,fragmentShader:pi,uniforms:n,side:On,depthWrite:!1,depthTest:!1,fog:!1})]})}const H=1.9,U=e=>e*H,pe={x:0,z:U(-60)},vt=U(300),Qo=U(175),mi=118,F={x:0,z:U(-402),r:U(215),baseY:300,squash:[1.18,1.04,.98]},Eo=[[-.361,.301,.883],[.361,.301,.883]],ra=[0,.02,.9998],ia=[0,-.419,.908];function la(e,o=1){const[n,a,s]=F.squash;return{x:F.x+e[0]*F.r*n*o,y:F.baseY+e[1]*F.r*a*o,z:F.z+e[2]*F.r*s*o}}const Pe=Eo.map(e=>la(e)),de={...la(ia),halfWidth:74,height:62};la(ra,.94);const Q={x:U(-152),y:4.5,z:U(-104),r:U(78)},Ta=2.35,Yt=[Math.sin(Ta),Math.cos(Ta)],Y=(()=>{const e=vt+Qo*.35,o=pe.x+Yt[0]*e,n=pe.z+Yt[1]*e;return{x:o,z:n,pool:U(46),benchY:3.6,reach:U(560),gate:{x:o-Yt[0]*U(44),z:n-Yt[1]*U(44)},berth:{x:o+Yt[0]*U(12),z:n+Yt[1]*U(12)},dir:Yt}})(),gi=[{rank:1,role:"east-flank",ang:1.05,dist:U(700),r:U(150),depth:38,dir:-1,speed:46},{rank:2,role:"west-flank",ang:-1.05,dist:U(700),r:U(148),depth:37,dir:1,speed:46},{rank:3,role:"back-door",ang:2.18,dist:U(770),r:U(142),depth:40,dir:1,speed:48},{rank:4,role:"east",ang:1.58,dist:U(716),r:U(158),depth:42,dir:1,speed:50},{rank:5,role:"west",ang:-1.58,dist:U(716),r:U(154),depth:41,dir:-1,speed:50},{rank:6,role:"east-outer",ang:1.32,dist:U(950),r:U(144),depth:36,dir:1,speed:44},{rank:7,role:"west-outer",ang:-1.32,dist:U(950),r:U(142),depth:36,dir:-1,speed:44},{rank:8,role:"east-north",ang:1.86,dist:U(950),r:U(152),depth:41,dir:-1,speed:46},{rank:9,role:"west-north",ang:-1.86,dist:U(950),r:U(150),depth:42,dir:1,speed:46}],Ue=[];function tr(e){const o=e==="low"?3:e==="mid"?6:9;Ue.length=0;for(const n of gi)n.rank>o||Ue.push({role:n.role,x:pe.x+Math.sin(n.ang)*n.dist,z:pe.z+Math.cos(n.ang)*n.dist,r:n.r,depth:n.depth,dir:n.dir,speed:n.speed});return Ue}const xi=e=>Ue.find(o=>o.role===e)??Ue[0];tr("high");function or(e,o,n=0){let a=0,s=0;const c=Math.max(.22*(1-Ke(180,620,n)),1-Ke(10,46,n));if(c<=0)return{vx:a,vz:s,danger:0};let h=0;for(const l of Ue){const u=e-l.x,b=o-l.z,m=Math.hypot(u,b);if(m>l.r*2.05||m<.001)continue;const g=m/l.r,x=1-Ke(1.15,1.95,g),f=l.speed*(g/.3)*Math.exp(1-g/.3)*.68*x,p=l.speed*.58*Math.exp(-g*g*2.6)*x+l.speed*.13*x,d=1/m;a+=(-b*d*f*l.dir-u*d*p)*c,s+=(u*d*f*l.dir-b*d*p)*c,h=Math.max(h,(1-Ke(.15,1.35,g))*c)}return{vx:a,vz:s,danger:h}}const tn={x:0,halfWidth:U(96)},Ut=U(258),ho=U(624),on={safe:260,range:640},bi=0,Xo=U(1500),nn=e=>e<0?0:e>1?1:e;function wi(e,o,n=4){let a=0,s=1,i=1,c=0;for(let h=0;h<n;h++){const l=1-Math.abs(co(e*i,o*i,1)*2-1);a+=l*l*s,c+=s,s*=.52,i*=2.07}return a/c}const Ke=(e,o,n)=>{const a=nn((n-e)/(o-e));return a*a*(3-2*a)};function yi(e){if(e>U(430))return 1e4;const o=1-Ke(U(430),U(205),e),n=Ke(U(150),U(-30),e);return tn.halfWidth+o*U(620)+n*U(300)}function vi(e){const o=(1-Math.cos(e))*.5,n=Math.sin(e);let a=mi;return a+=o*190,a+=Math.max(0,n)*46,a-=Math.max(0,-n)*26,a}function le(e,o){const n=e-pe.x,a=o-pe.z,s=Math.hypot(n,a),i=Math.atan2(n,a),c=(s-vt)/Qo,h=Math.exp(-c*c*1.35)*vi(i),l=Math.max(0,s-vt-Qo*.55),u=-Math.pow(l/210,1.6)*175,b=Math.max(0,vt-Qo*.5-s),m=-Ke(0,150,b)*46,g=nn(h/60),x=(wi(e*.0052/H+13,o*.0052/H-21,4)-.42)*168*g,f=(co(e*.0042/H+31,o*.0042/H-17,4)-.5)*84*g,p=(co(e*.021-5,o*.021+9,3)-.5)*17*g;let d=h+u+m+x+f+p;const v=yi(o),j=1-Ke(v,v+U(105),Math.abs(e-tn.x)),S=1-Ke(U(-40),U(-190),o),k=j*S;d=d*(1-k)+Math.min(d,-34)*k;const E=Math.hypot(e-F.x,o-F.z);d+=Math.exp(-Math.pow(E/(F.r*1.55),2))*62;const r=(e-Q.x)/U(76),T=(o-Q.z)/U(58),C=(1-Ke(.72,1.18,Math.hypot(r,T)))*nn((d+34)/34);d=d*(1-C)+Q.y*C;const P=e-Y.x,M=o-Y.z;if(Math.abs(P)+Math.abs(M)<Y.reach+U(140)){const G=Math.max(0,Math.min(Y.reach,P*Y.dir[0]+M*Y.dir[1])),L=P-Y.dir[0]*G,W=M-Y.dir[1]*G,K=Math.hypot(L,W),fe=U(30)+G/Y.reach*U(48),O=1-Ke(fe,fe+U(62),K);d=d*(1-O)+Math.min(d,-26)*O;const $=Math.hypot(P,M),te=1-Ke(Y.pool*.55,Y.pool,$);d=d*(1-te)+Math.min(d,-14)*te;const se=(e-Y.gate.x)/U(30),me=(o-Y.gate.z)/U(24),ue=1-Ke(.72,1.18,Math.hypot(se,me));d=d*(1-ue)+Y.benchY*ue}return d}function ca(e,o,n=3){const a=le(e+n,o)-le(e-n,o),s=le(e,o+n)-le(e,o-n),i=-a,c=2*n,h=-s,l=Math.hypot(i,c,h)||1;return[i/l,c/l,h/l]}function Mi(e,o,n=3){return Math.acos(ca(e,o,n)[1])}function Io(e,o){const n=Ke(U(250),U(40),o),a=1-Ke(vt-U(40),vt+U(90),Math.hypot(e-pe.x,o-pe.z)),s=(1-Ke(U(60),U(170),Math.hypot(e-Y.x,o-Y.z)))*.85;return nn(Math.max(Math.min(n,a),s))}const nr=[{dir:[.1,-1],amp:9.4,len:187},{dir:[-.42,-.91],amp:4.3,len:97},{dir:[.71,-.7],amp:2.1,len:61},{dir:[-.86,-.51],amp:1.15,len:37}],ki=Math.PI*2;function ji(e,o,n){let a=0,s=0,i=0;for(const c of Ue){const h=e-c.x,l=o-c.z,u=Math.max(1,Math.hypot(h,l));if(u>c.r*1.75)continue;const b=u/c.r,m=Math.exp(-3*b*b);a-=c.depth*m;const g=c.depth*6*b*m/c.r;s+=g*(h/u),i+=g*(l/u);const x=Math.atan2(l,h),f=Math.sin(x*3*c.dir+b*14-n*2.2),p=b*Math.exp(1-b)*(1-Si(b));a+=f*p*1.6}return{y:a,dx:s,dz:i}}function Si(e){const o=Math.min(1,Math.max(0,(e-1)/.6));return o*o*(3-2*o)}function dt(e,o,n,a=1){let s=0,i=0,c=0;for(const l of nr){const u=ki/l.len,b=Math.sqrt(9.81/u),m=Math.hypot(l.dir[0],l.dir[1]),g=l.dir[0]/m,x=l.dir[1]/m,f=u*(g*e+x*o-b*n),p=l.amp*a;s+=p*Math.sin(f);const d=p*u*Math.cos(f);i+=d*g,c+=d*x}const h=ji(e,o,n);return s+=h.y,i+=h.dx,c+=h.dz,{y:s,dx:i,dz:c}}const zi=nr.map(e=>`    gerstner(p, vec2(${e.dir[0].toFixed(3)}, ${e.dir[1].toFixed(3)}), ${e.amp.toFixed(2)} * amp, ${e.len.toFixed(1)}, uTime, disp, tangent, binormal, total);`).join(`
`),Ti=()=>Ue.map(e=>`    whirl(p, vec2(${e.x.toFixed(1)}, ${e.z.toFixed(1)}), ${e.r.toFixed(1)}, ${e.depth.toFixed(1)}, ${e.dir.toFixed(1)}, uTime, disp, tangent, binormal);`).join(`
`),Ei=()=>Ue.map(e=>`    wm += whirlMark(vWorld.xz, vec2(${e.x.toFixed(1)}, ${e.z.toFixed(1)}), ${e.r.toFixed(1)}, ${e.dir.toFixed(1)}, uTime);`).join(`
`),Ri=`
...
`;function Ci(e,o){const n=new Uint8Array(e*e*4);for(let s=0;s<e;s++)for(let i=0;i<e;i++){const c=pe.x+((i+.5)/e-.5)*o,h=pe.z+((s+.5)/e-.5)*o,l=le(c,h),u=R.clamp(-l/46,0,1),b=(s*e+i)*4;n[b]=Math.round(u*255),n[b+1]=n[b],n[b+2]=n[b],n[b+3]=255}const a=new qr(n,e,e,Jr);return a.minFilter=Sa,a.magFilter=Sa,a.wrapS=za,a.wrapT=za,a.needsUpdate=!0,a}const an={low:112,mid:190,high:286},Nn=6400;function Pi(e){const o=w.useRef(),n=Nn/(an[e]??an.high);return ae(a=>{const s=o.current;s&&(s.position.x=Math.round((a.camera.position.x-pe.x)/n)*n,s.position.z=Math.round((a.camera.position.z-pe.z)/n)*n)}),o}function Li({quality:e="high",storm:o}){const n=w.useRef(),a=Pi(e),{geometry:s,uniforms:i,landTex:c,vert:h,frag:l}=w.useMemo(()=>{const u=an[e]??an.high,b=new aa(Nn,Nn,u,u);b.rotateX(-Math.PI/2),b.translate(pe.x,0,pe.z);const m=Xo*1.05,g=Ci(e==="low"?160:256,m),x={uTime:{value:0},uLand:{value:g},uSpan:{value:m},uCentre:{value:new sa(pe.x,pe.z)},uDeep:{value:new z(...ie(X.seaDeep))},uShallow:{value:new z(...ie(X.seaShallow))},uFoam:{value:new z(...ie(X.foam))},uSkyLow:{value:new z(...ie(X.skyLow))},uGilt:{value:new z(...ie(A.gilt))},uEmber:{value:new z(...ie(A.ember))},uFogColor:{value:new z(...ie(X.haze))},uFogDensity:{value:.0011},uUnderDeep:{value:new z(...ie(X.abyss))},uUnderGlow:{value:new z(...ie(X.underGlow))},uDepthFade:{value:0},uMoonDir:{value:Fi.clone()},uMoonCol:{value:new z(...ie(Gi))},uEyeA:{value:new z(Pe[0].x,Pe[0].y,Pe[0].z)},uEyeB:{value:new z(Pe[1].x,Pe[1].y,Pe[1].z)},uFlash:{value:0},uFlashColor:{value:new z(...ie(X.boltGlow))},uCameraPos:{value:new z}};return{geometry:b,uniforms:x,landTex:g,vert:Ai(),frag:Ii()}},[e]);return ae((u,b)=>{const m=n.current?.uniforms;if(!m)return;m.uTime.value+=b,m.uCameraPos.value.copy(u.camera.position),m.uFlash.value=o?.flash??0,m.uFogDensity.value=o?.fog??.0011;const g=Math.min(1,Math.max(0,(o?.depthBelow??0)/Bt.deepGrade));m.uDepthFade.value=g,Ea.copy(Ni).lerp(Di,g*.8),m.uFogColor.value.lerpVectors(Oi,Ea,o?.underwater??0)}),t.jsx("mesh",{ref:a,geometry:s,frustumCulled:!1,renderOrder:1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:h,fragmentShader:l,uniforms:i,transparent:!1,side:Be},c.uuid)})}const Fi=new z(...en.dir).normalize(),Gi=en.col,Oi=new z(...ie(X.haze)),Ni=new z(...ie(X.underHaze)),Di=new z(...ie(X.abyss)),Ea=new z;function Hi({quality:e="high",segments:o=200}){const n=w.useMemo(()=>{const a=o,s=new aa(Xo,Xo,a,a);s.rotateX(-Math.PI/2);const i=s.attributes.position,c=i.count,h=new Float32Array(c*3),l=new ze(X.rock),u=new ze(X.rockLit),b=new ze("#0b0e18"),m=new ze(X.snow),g=new ze(A.rockWarm),x=new ze;for(let f=0;f<c;f++){const p=i.getX(f)+pe.x,d=i.getZ(f)+pe.z,v=le(p,d);i.setX(f,p),i.setY(f,v),i.setZ(f,d);const j=ca(p,d,Xo/a)[1],S=Math.max(0,(j-.55)/.45);x.copy(l).lerp(u,R.clamp(v/190,0,1));const k=1-R.clamp((v-bi)/13,0,1);x.lerp(b,k*.85);const E=R.clamp((p-pe.x)/260,0,1),r=96-E*42,T=R.clamp((v-r)/60,0,1)*S;x.lerp(m,T*(.45+E*.5));const C=Math.hypot(p-F.x,d-F.z),P=Math.exp(-Math.pow(C/330,2)),M=R.clamp((d-F.z)/260,0,1);x.lerp(g,P*M*.6*(1-T)),h[f*3]=x.r,h[f*3+1]=x.g,h[f*3+2]=x.b}return s.setAttribute("color",new ee(h,3)),s.computeVertexNormals(),s.computeBoundingSphere(),s},[o]);return t.jsx("mesh",{geometry:n,receiveShadow:e!=="low",castShadow:!1,frustumCulled:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,roughness:.86,metalness:.02,flatShading:e==="low"})})}const ha=-30,da=330,_i=150,ge={x:de.x,y:de.y-40,z:de.z-_i-(ha+da)},Fe={centre:[0,96,ha],radii:[350,235,da]},Rt={x:ge.x+Fe.centre[0],y:ge.y+Fe.centre[1],z:ge.z+Fe.centre[2]};function Bi(e,o,n){const a=(e-Rt.x)/Fe.radii[0],s=(o-Rt.y)/Fe.radii[1],i=(n-Rt.z)/Fe.radii[2];return Math.sqrt(a*a+s*s+i*i)}function Dn(e,o=.06){const n=(e.x-Rt.x)/Fe.radii[0],a=(e.y-Rt.y)/Fe.radii[1],s=(e.z-Rt.z)/Fe.radii[2],i=Math.sqrt(n*n+a*a+s*s),c=1+o;if(i>=c)return null;const h=i<1e-4?0:c/i;return e.x=Rt.x+(h?n*h:0)*Fe.radii[0],e.y=Rt.y+(h?a*h:c)*Fe.radii[1],e.z=Rt.z+(h?s*h:0)*Fe.radii[2],e}const ce={y:0,halfX:290,zFront:228,zBack:-240},He={y:40,z:ha+da-40,halfX:96,depth:120},gt={zTop:He.z-54,zBottom:140,halfX:74,steps:16},N={z:-290,baseY:0,halfX:130,halfZ:76,plinth:34,storey:36,storeys:6,taper:.11},Ce={y:74,z:N.z+N.halfZ+26,halfX:96,depth:40},Dt=Ce.y+3.5,ot={y:-95,halfX:220,halfZ:175,ceiling:-34},Ae={x:0,z:84,halfX:52,halfZ:40},ke={y:52,halfZ:205,x:252,tiers:3,tierRise:46},Fo=[[96,46,340,40],[140,-64,300,34],[70,-150,240,26],[196,-8,220,28]],we={x:74,halfW:14,zFoot:N.z+N.halfZ+158,zTop:Ce.z+Ce.depth/2-6},ar=[{kind:"rampZ",x0:-74-we.halfW,x1:-74+we.halfW,z0:we.zFoot,z1:we.zTop,y0:0,y1:Dt},{kind:"rampZ",x0:we.x-we.halfW,x1:we.x+we.halfW,z0:we.zFoot,z1:we.zTop,y0:0,y1:Dt},{kind:"flat",x0:-96,x1:Ce.halfX,z0:Ce.z-Ce.depth/2-2,z1:we.zTop,y:Dt},{kind:"rampZ",x0:-290,x1:-214,z0:45,z1:-45,y0:0,y1:ke.y-.5},{kind:"flat",x0:-290,x1:-214,z0:-225,z1:-45,y:ke.y-.5},{kind:"flat",x0:ke.x-38,x1:ke.x+38,z0:-225,z1:ke.halfZ+20,y:ke.y-.5}],Ui=e=>e<=0?0:e>=1?1:e*e*(3-2*e),sr=(()=>{const e=[],o=[],n=[],a=N.halfX+6,s=[a,a+9],i=[a+11,a+20],c=[a,a+20],h=[-212,-200],l=[-264,-252],u=[Dt];for(let m=2;m<=N.storeys;m++)u.push(N.plinth+m*N.storey+1.5);e.push({kind:"flat",x0:Ce.halfX-6,x1:a+20,z0:-212,z1:-196,y:Dt}),o.push([(Ce.halfX-6+a+20)/2,Dt,-204,a+26-Ce.halfX,16]);for(let m=0;m<u.length-1;m++){const g=u[m],x=u[m+1],f=(g+x)/2;e.push({kind:"rampZ",x0:s[0],x1:s[1],z0:h[0],z1:l[1],y0:g,y1:f}),n.push({x0:s[0],x1:s[1],z0:h[0],z1:l[1],y0:g,y1:f}),e.push({kind:"flat",x0:c[0],x1:c[1],z0:l[0],z1:l[1],y:f}),o.push([(c[0]+c[1])/2,f,(l[0]+l[1])/2,c[1]-c[0],l[1]-l[0]]),e.push({kind:"rampZ",x0:i[0],x1:i[1],z0:l[1],z1:h[0],y0:f,y1:x}),n.push({x0:i[0],x1:i[1],z0:l[1],z1:h[0],y0:f,y1:x}),e.push({kind:"flat",x0:c[0],x1:c[1],z0:h[0],z1:h[1],y:x}),o.push([(c[0]+c[1])/2,x,(h[0]+h[1])/2,c[1]-c[0],h[1]-h[0]])}for(let m=1;m<u.length-1;m++){const x=1-Math.min(N.storeys,m+2)*N.taper,f=N.halfX*x,p=N.z+N.halfZ*x,d=u[m];e.push({kind:"flat",x0:f-4,x1:a,z0:-224,z1:-212,y:d}),o.push([(f-4+a)/2,d,-218,a-f+4,12]),e.push({kind:"flat",x0:-f-6,x1:f+6,z0:p,z1:-212,y:d}),o.push([0,d,(p-212)/2,f*2+12,-212-p])}const b=u[u.length-1];return e.push({kind:"flat",x0:58,x1:a,z0:-248,z1:-212,y:b}),o.push([(a+58)/2,b,-230,a-58,36]),{walks:e,slabs:o,flights:n,tower:{x:[a,a+20],z:[l[0],h[1]]}}})();ar.push(...sr.walks);const Wi=1.1;function Yi(e,o,n=1/0){const a=n+Wi;let s=-1/0;for(const i of ar){if(e<i.x0||e>i.x1)continue;const c=Math.min(i.z0,i.z1),h=Math.max(i.z0,i.z1);if(o<c||o>h)continue;const l=i.kind==="flat"?i.y:i.y0+(i.y1-i.y0)*Ui((o-i.z0)/(i.z1-i.z0));l<=a&&l>s&&(s=l)}return s===-1/0?0:Math.max(0,s)}function Vi(e,o,n=1/0){const a=o>gt.zTop?He.y:o>gt.zBottom?He.y*(o-gt.zBottom)/(gt.zTop-gt.zBottom):0,s=Yi(e,o,n);return Math.max(a,s)}function $i(e,o,n){const a=N.plinth+N.storeys*N.storey;if(n>a)return!1;const i=1-(n<=N.plinth?0:Math.min(N.storeys,Math.ceil((n-N.plinth)/N.storey)))*N.taper;return Math.abs(e)<N.halfX*i&&Math.abs(o-N.z)<N.halfZ*i}const y={t:0,flash:0,flashDir:new z(0,.4,-1),fog:Bt.sea,rain:1,progress:0,shelter:0,inside:0,shot:0,underwater:0,depthBelow:0,whirlNear:0,subActive:!1,subPos:new z(0,0,0),helmActive:!1,helmPos:new z(0,0,0),helmSpeed:0,ship:{x:0,y:0,z:0,heading:Math.PI,loa:64,deckY:8.3,mastY:42},subThrottle:0,vessel:"sunny",footSpawn:"hall",splash:0,onRails:!0,orbit:{yaw:0,pitch:.12,dist:120,target:new z(0,60,-200)}};function Ki(){y.t=0,y.progress=0,y.flash=0,y.fog=Bt.sea,y.rain=1,y.shot=0,y.underwater=0,y.depthBelow=0,y.whirlNear=0,y.subActive=!1,y.subThrottle=0}const yn=new Map;let rr=!0;function Qi(e){rr=!!e}function Xi(e){const o=Ao(e);return yn.has(o)||yn.set(o,fetch(o,{method:"HEAD"}).then(n=>n.ok?!(n.headers.get("content-type")||"").includes("text/html"):!1).catch(()=>!1)),yn.get(o)}function rt(e){const[o,n]=w.useState(!1);return w.useEffect(()=>{let a=!0;return Xi(e).then(s=>{a&&n(s&&rr)}),()=>{a=!1}},[e]),o}const At=Eo.map(e=>new z(...e).normalize()),ir=new z(...ra).normalize(),Hn=new z(...ia).normalize();function Zi(e){let o=1;o+=Math.max(0,e.y)*.1,o-=Math.pow(Math.max(0,e.y),4)*.2;const n=Math.exp(-Math.pow((e.y-.52)/.16,2))*Math.max(0,e.z);o+=n*.13;for(const l of At){const u=e.dot(l),b=Math.pow(Math.max(0,u),46);o-=b*.3}const a=Math.max(0,e.dot(ir)),s=Math.pow(a,150)*(1-Math.max(0,e.y)*.5);o-=s*.19;for(const l of At){const u=new z(l.x*1.5,l.y-.55,l.z*.7).normalize().dot(e);o+=Math.pow(Math.max(0,u),26)*.075}const i=Math.max(0,e.dot(Hn));o-=Math.pow(i,30)*.11,o-=Math.pow(Math.max(0,-e.y),3)*.28;const c=Math.pow(Math.max(0,e.dot(At[0])),30)+Math.pow(Math.max(0,e.dot(At[1])),30),h=1-Math.min(1,c);return o+=(co(e.x*3.1+7,e.z*3.1-3,3)-.5)*.085*h,o+=(co(e.x*9.4-2,e.y*9.4+5,2)-.5)*.032*h,o}const qi=178*1.9,at=F.r/qi;function Ra(e,o){const n=e*at,a=[new z(n*74,96*at,-20*at),new z(n*142,176*at,-58*at),new z(n*196,268*at,-76*at),new z(n*222,356*at,-52*at),new z(n*206,424*at,8*at),new z(n*154,462*at,72*at)],s=new z;for(const b of a)s.set(F.x+b.x,F.baseY+b.y,F.z+b.z),Dn(s,.12)&&b.set(s.x-F.x,s.y-F.baseY,s.z-F.z);const i=new po(a),c=o==="low"?14:o==="mid"?22:34,h=o==="low"?6:10,l=new fo(i,c,1,h,!1),u=l.attributes.position;for(let b=0;b<=c;b++){const m=b/c,g=34*at*Math.pow(1-m,.72)*(1+Math.sin(m*Math.PI)*.16),x=i.getPoint(m);for(let f=0;f<=h;f++){const p=b*(h+1)+f;if(p>=u.count)continue;const d=u.getX(p)-x.x,v=u.getY(p)-x.y,j=u.getZ(p)-x.z;u.setXYZ(p,x.x+d*g,x.y+v*g,x.z+j*g)}}return u.needsUpdate=!0,l.computeVertexNormals(),l}const Ji={low:4,mid:6,high:7},lr="skull-island.opt.glb",wo={height:1,yaw:0,lift:.02},vn=new oi,Aa=new z,Go=new z;function el(e,o,n){Go.set(o[0],o[1],o[2]).normalize(),Aa.copy(Go).multiplyScalar(F.r*4),vn.set(Aa,Go.clone().negate()),vn.far=F.r*8;const a=vn.intersectObject(e,!0)[0];return a?a.point.clone().addScaledVector(Go,-n):null}function tl({shadows:e}){const{scene:o}=qs(Ao(lr)),{object:n,eyes:a,nose:s,mouth:i}=w.useMemo(()=>{const c=o.clone(!0),h=new Js().setFromObject(c),l=new z,u=new z;h.getSize(l),h.getCenter(u);const b=F.r*F.squash[1]*1.62,m=l.y>1e-4?b*wo.height/l.y:1,g=F.r*F.squash[1]*wo.lift;c.scale.setScalar(m),c.rotation.set(0,wo.yaw,0),c.position.set(0,-u.y*m+g,0);const x=u.x*m,f=u.z*m,p=Math.cos(wo.yaw),d=Math.sin(wo.yaw);c.position.x=-(x*p+f*d),c.position.z=-(-x*d+f*p),c.updateMatrixWorld(!0);let v=0,j=0;const S={x:0,y:0,z:0},k=new z,E=[];c.traverse(L=>{L.isMesh&&E.push(L)});for(const L of E){const W=L.geometry.clone();for(const O of["position","normal"]){const $=W.attributes[O];if(!$||$.array instanceof Float32Array)continue;const te=new Float32Array($.count*3);for(let se=0;se<$.count;se++)k.fromBufferAttribute($,se),te[se*3]=k.x,te[se*3+1]=k.y,te[se*3+2]=k.z;W.setAttribute(O,new ee(te,3))}W.applyMatrix4(L.matrixWorld);const K=W.attributes.position;j+=K.count;for(let O=0;O<K.count;O++)S.x=K.getX(O)+F.x,S.y=K.getY(O)+F.baseY,S.z=K.getZ(O)+F.z,Dn(S,.05)&&(K.setXYZ(O,S.x-F.x,S.y-F.baseY,S.z-F.z),v++);v&&W.computeVertexNormals(),K.needsUpdate=!0,W.computeBoundingSphere(),W.computeBoundingBox(),L.geometry=W,L.castShadow=e,L.receiveShadow=!1;const fe=Array.isArray(L.material)?L.material:[L.material];for(const O of fe)O.color?.multiply(ol),O.roughness=.94,O.metalness=.02}for(const L of[c,...E])L.position.set(0,0,0),L.quaternion.identity(),L.scale.set(1,1,1),L.updateMatrix();c.updateMatrixWorld(!0);const r=(L,W=1)=>{const[K,fe,O]=F.squash;return new z(L[0]*F.r*K*W,L[1]*F.r*fe*W,L[2]*F.r*O*W)},T=Eo.map(L=>el(c,L,F.r*.1)??r(L,.82)),C=new z().addVectors(T[0],T[1]).multiplyScalar(.5),P=new z().addVectors(r(Eo[0],.82),r(Eo[1],.82)).multiplyScalar(.5),M=C.clone().sub(P),G=L=>{const W={x:L.x+F.x,y:L.y+F.baseY,z:L.z+F.z};return Dn(W,.22)&&L.set(W.x-F.x,W.y-F.baseY,W.z-F.z),L};return{object:c,eyes:T.map(G),nose:G(r(ra,.87).add(M)),mouth:G(r(ia,.9).add(M))}},[o,e]);return t.jsxs(t.Fragment,{children:[t.jsx("primitive",{object:n}),t.jsx(cr,{eyes:a,nose:s,mouth:i,teeth:null,cast:e})]})}const ol=new ze("#8f8a84");function cr({eyes:e,nose:o,mouth:n,teeth:a,cast:s}){const i=w.useRef(),c=w.useRef(),h=w.useRef();return ae(()=>{const l=y.t,u=.82+.18*Math.sin(l*2.3)*Math.sin(l*.71),b=.82+.18*Math.sin(l*1.9+2.1)*Math.sin(l*.63),m=.86+.14*Math.sin(l*1.4+.8);i.current&&(i.current.emissiveIntensity=5.2*u+y.flash*2),c.current&&(c.current.emissiveIntensity=5.2*b+y.flash*2),h.current&&(h.current.emissiveIntensity=3.4*m)}),t.jsxs(t.Fragment,{children:[e.map((l,u)=>t.jsxs("mesh",{position:l,rotation:[-.24,0,0],children:[t.jsx("sphereGeometry",{args:[F.r*.108,20,14,0,Math.PI*2,0,Math.PI*.5]}),t.jsx("meshStandardMaterial",{ref:u===0?i:c,color:A.furnace,emissive:A.ember,emissiveIntensity:5.2,toneMapped:!1,side:Be,roughness:1})]},u)),t.jsxs("mesh",{position:o,rotation:[Math.PI*.54,0,0],children:[t.jsx("coneGeometry",{args:[F.r*.046,F.r*.083,3]}),t.jsx("meshStandardMaterial",{color:A.emberDeep,emissive:A.emberDeep,emissiveIntensity:2.4,toneMapped:!1})]}),t.jsxs("group",{position:n,children:[t.jsxs("mesh",{position:[0,F.r*.05,-F.r*.16],children:[t.jsx("planeGeometry",{args:[F.r*.62,F.r*.34]}),t.jsx("meshStandardMaterial",{ref:h,color:A.ember,emissive:A.emberDeep,emissiveIntensity:3.4,toneMapped:!1,side:Be})]}),a?.map((l,u)=>t.jsxs("mesh",{position:l.pos,scale:l.scale,rotation:[0,0,l.rot],castShadow:s,children:[t.jsx("boxGeometry",{args:[1,1,1]}),t.jsx("meshStandardMaterial",{color:"#e6d9bc",emissive:A.emberDeep,emissiveIntensity:.42,roughness:.78})]},u))]})]})}const nl=typeof location<"u"?new URLSearchParams(location.search).get("skull"):null;function al({quality:e="high",shadows:o=!0}){const a=rt(lr)&&e!=="low"&&nl!=="proc",{dome:s,hornL:i,hornR:c,teeth:h}=w.useMemo(()=>{const x=new ei(F.r,Ji[e]??7),f=x.attributes.position,p=new Float32Array(f.count*3),d=new ze(X.rock),v=new ze(A.rockWarm),j=new ze("#120b10"),S=new ze,k=new z;for(let C=0;C<f.count;C++){k.set(f.getX(C),f.getY(C),f.getZ(C)).normalize();const P=F.r*Zi(k),[M,G,L]=F.squash;f.setXYZ(C,k.x*P*M,k.y*P*G,k.z*P*L);const W=Math.max(Math.pow(Math.max(0,k.dot(At[0])),5),Math.pow(Math.max(0,k.dot(At[1])),5),Math.pow(Math.max(0,k.dot(Hn)),6)*.9);S.copy(d).lerp(v,Math.min(1,W*1.5+Math.max(0,k.z)*.22));const K=Math.max(Math.pow(Math.max(0,k.dot(At[0])),40),Math.pow(Math.max(0,k.dot(At[1])),40));S.lerp(j,K),p[C*3]=S.r,p[C*3+1]=S.g,p[C*3+2]=S.b}x.setAttribute("color",new ee(p,3)),x.computeVertexNormals();const E=new ti(1,1,1),r=[],T=9;for(let C=0;C<T;C++){const P=C/(T-1)*2-1,M=de.halfWidth*2.1,G=P*M*.5,L=Math.pow(Math.abs(P),1.7)*14,W=46-Math.abs(P)*13+C%2*7;r.push({pos:[G,de.height*.5-L-W*.5,6],scale:[M/T*.76,W,52],rot:P*.13})}return E.dispose?.(),{dome:x,hornL:Ra(-1,e),hornR:Ra(1,e),teeth:r}},[e]),l=o,[u,b,m]=F.squash,g=(x,f)=>[x.x*F.r*u*f,x.y*F.r*b*f,x.z*F.r*m*f];return t.jsx("group",{position:[F.x,F.baseY,F.z],children:a?t.jsx(w.Suspense,{fallback:t.jsx(Ia,{dome:s,hornL:i,hornR:c,cast:l}),children:t.jsx(tl,{shadows:l})}):t.jsxs(t.Fragment,{children:[t.jsx(Ia,{dome:s,hornL:i,hornR:c,cast:l}),t.jsx(cr,{eyes:At.map(x=>g(x,.82)),nose:g(ir,.87),mouth:g(Hn,.96),teeth:h,cast:l})]})})}function Ia({dome:e,hornL:o,hornR:n,cast:a}){return t.jsxs(t.Fragment,{children:[t.jsx("mesh",{geometry:e,castShadow:a,receiveShadow:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,roughness:.92,metalness:.03})}),t.jsx("mesh",{geometry:o,castShadow:a,children:t.jsx("meshStandardMaterial",{color:"#241d28",roughness:.55,metalness:.12})}),t.jsx("mesh",{geometry:n,castShadow:a,children:t.jsx("meshStandardMaterial",{color:"#241d28",roughness:.55,metalness:.12})})]})}function yt({matrices:e,target:o}){const n=w.useRef(!1);return ae(()=>{if(n.current||!o.current)return;const a=Math.min(e.length,o.current.count);for(let s=0;s<a;s++)o.current.setMatrixAt(s,e[s]);o.current.instanceMatrix.needsUpdate=!0,o.current.computeBoundingSphere(),n.current=!0}),null}const to=190,jt=130,Oo=9.5;function Ca(e,o,n,a=24){const s=new po(e),i=new fo(s,a,1,4,!1),c=i.attributes.position,h=new z(0,1,0),l=new z,u=new z,b=new z,m=new z,g=new z;for(let x=0;x<=a;x++){const f=x/a;s.getPointAt(f,u),s.getTangentAt(f,l),m.crossVectors(l,h).normalize(),b.crossVectors(m,l).normalize();for(let p=0;p<=4;p++){const d=x*5+p;if(d>=c.count)continue;const v=p/4*Math.PI*2+Math.PI/4,j=Math.cos(v)*o*.7071,S=Math.sin(v)*n*.7071;g.copy(u).addScaledVector(m,j).addScaledVector(b,S),c.setXYZ(d,g.x,g.y,g.z)}}return c.needsUpdate=!0,i.computeVertexNormals(),i}function sl(e,o,n,a=40){const s=[];for(let l=0;l<=10;l++){const u=l/10*2-1;s.push(new z(u*e,-30*(1-u*u),0))}const i=new po(s),c=new fo(i,a,n,8,!1),h=c.attributes.position;for(let l=0;l<=a;l++){const u=l/a*2-1,b=1+(1-u*u)*.85,m=i.getPointAt(l/a);for(let g=0;g<=8;g++){const x=l*9+g;x>=h.count||h.setXYZ(x,m.x+(h.getX(x)-m.x)*b,m.y+(h.getY(x)-m.y)*b,m.z+(h.getZ(x)-m.z)*b)}}return h.needsUpdate=!0,c.computeVertexNormals(),c}const hr=.76;function Pa({quality:e="high",shadows:o=!0,z:n=Ut,k:a=H*hr}){const s=w.useRef(),i=w.useRef(),c=w.useRef(),h=w.useRef(),l=w.useMemo(()=>{const p=to/2,d=jt,v=Ca([new z(-p-40,d+6,0),new z(-p-22,d+15.5,0),new z(0,d+20,0),new z(p+22,d+15.5,0),new z(p+40,d+6,0)],16,9,30),j=Ca([new z(-p-30,d+2,0),new z(0,d+8,0),new z(p+30,d+2,0)],11,5,18);return{kasagi:v,shimaki:j,rope:sl(p-6,30,6.4,44)}},[]),{tileM:u,merlonM:b,cannonM:m,lanternM:g}=w.useMemo(()=>{const p=new ut,d=new Mt,v=new z,j=new z,S=[],k=e==="low"?26:54;for(let P=0;P<k;P++){const M=P/(k-1)*2-1,G=M*(to/2+40),L=jt+20-Math.pow(Math.abs(M),1.9)*14+5,W=-Math.sign(M)*Math.pow(Math.abs(M),3)*.5;j.set(G,L,0),d.setFromEuler(new $t(0,0,W)),v.set(1,1,1),S.push(p.clone().compose(j,d,v))}const E=[];for(const P of[-1,1])for(let M=0;M<7;M++)j.set(P*(58+M*12),26,0),d.identity(),v.set(1,1,1),E.push(p.clone().compose(j,d,v));const r=[];for(const P of[-1,1])for(let M=0;M<2;M++)for(let G=0;G<4-M;G++)j.set(P*(64+G*13+M*6),32+M*10,8),d.setFromEuler(new $t(Math.PI/2-.16,0,0)),v.set(1,1,1),r.push(p.clone().compose(j,d,v));const T=[],C=e==="low"?10:22;for(let P=0;P<C;P++){const M=P/(C-1)*2-1,G=M*(to/2-12),L=30*(1-M*M);j.set(G,jt-34-L-7.5,0),d.identity(),v.set(1,1,1),T.push(p.clone().compose(j,d,v))}return{tileM:S,merlonM:E,cannonM:r,lanternM:T}},[e]);ae(()=>{const p=y.t;s.current&&(s.current.material.emissiveIntensity=2.6+Math.sin(p*3.1)*.22+Math.sin(p*7.7)*.1+y.flash*1.4)});const x=to/2,f=o;return t.jsxs("group",{position:[0,0,n],scale:a,children:[[-1,1].map(p=>t.jsxs("group",{position:[p*x,0,0],children:[t.jsxs("mesh",{position:[0,jt/2-30,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[Oo*.86,Oo,jt+60,14]}),t.jsx("meshStandardMaterial",{color:"#6d4d86",roughness:.72})]}),t.jsxs("mesh",{position:[0,6,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[Oo*1.5,Oo*1.85,20,14]}),t.jsx("meshStandardMaterial",{color:"#3b3547",roughness:.94})]})]},p)),t.jsxs("mesh",{position:[0,jt-26,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[to+56,12,13]}),t.jsx("meshStandardMaterial",{color:"#6d4d86",roughness:.72})]}),t.jsx("mesh",{geometry:l.shimaki,castShadow:f,children:t.jsx("meshStandardMaterial",{color:"#5c3f72",roughness:.76})}),t.jsx("mesh",{geometry:l.kasagi,castShadow:f,children:t.jsx("meshStandardMaterial",{color:A.vermilionDeep,roughness:.68})}),t.jsxs("instancedMesh",{ref:i,args:[null,null,u.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[3.4,3.4,9.5,6,1,!1,0,Math.PI]}),t.jsx("meshStandardMaterial",{color:"#8c2a1c",roughness:.6}),t.jsx(yt,{matrices:u,target:i})]}),t.jsxs("mesh",{position:[0,jt-6,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[13,30,9]}),t.jsx("meshStandardMaterial",{color:"#4b3560",roughness:.8})]}),t.jsxs("mesh",{position:[0,jt-6,5.2],children:[t.jsx("planeGeometry",{args:[17,24]}),t.jsx("meshStandardMaterial",{color:"#2f4438",emissive:"#1d3326",emissiveIntensity:.5,roughness:.9})]}),t.jsx("mesh",{geometry:l.rope,position:[0,jt-34,2],castShadow:f,children:t.jsx("meshStandardMaterial",{color:"#cdc5b2",emissive:"#6a6053",emissiveIntensity:.55,roughness:.97})}),[-52,-18,18,52].map(p=>{const d=30*(1-(p/(to/2-6))**2);return t.jsx("group",{position:[p,jt-34-d-4,2],children:[0,1,2].map(v=>t.jsxs("mesh",{position:[v%2?1.1:-1.1,-2.4-v*3.6,0],children:[t.jsx("boxGeometry",{args:[3.4,3.4,.35]}),t.jsx("meshStandardMaterial",{color:"#efece2",emissive:"#cfc9b8",emissiveIntensity:.5,roughness:1,side:Be})]},v))},p)}),[-1,1].map(p=>t.jsxs("group",{children:[t.jsxs("mesh",{position:[p*108,6,0],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[126,44,62]}),t.jsx("meshStandardMaterial",{color:"#39404f",roughness:.95})]}),t.jsxs("mesh",{position:[p*108,30,6],castShadow:f,children:[t.jsx("boxGeometry",{args:[118,12,44]}),t.jsx("meshStandardMaterial",{color:A.timber,roughness:.88})]}),t.jsxs("mesh",{position:[p*162,44,10],children:[t.jsx("boxGeometry",{args:[9,13,9]}),t.jsx("meshStandardMaterial",{color:A.lantern,emissive:A.lantern,emissiveIntensity:2.4,toneMapped:!1})]})]},p)),t.jsxs("instancedMesh",{ref:h,args:[null,null,b.length],castShadow:f,children:[t.jsx("boxGeometry",{args:[8,11,44]}),t.jsx("meshStandardMaterial",{color:"#2f3542",roughness:.95}),t.jsx(yt,{matrices:b,target:h})]}),t.jsxs("instancedMesh",{ref:c,args:[null,null,m.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[3.4,4.4,30,10]}),t.jsx("meshStandardMaterial",{color:"#15181f",roughness:.42,metalness:.75}),t.jsx(yt,{matrices:m,target:c})]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,g.length],children:[t.jsx("cylinderGeometry",{args:[3.6,3.6,6.4,8]}),t.jsx("meshStandardMaterial",{color:A.lantern,emissive:A.lantern,emissiveIntensity:2.6,toneMapped:!1}),t.jsx(yt,{matrices:g,target:s})]})]})}const rl=(()=>{if(typeof document>"u")return null;const e=128,o=document.createElement("canvas");o.width=o.height=e;const n=o.getContext("2d"),a=n.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2);a.addColorStop(0,"rgba(255,255,255,1)"),a.addColorStop(.12,"rgba(255,255,255,0.55)"),a.addColorStop(.4,"rgba(255,255,255,0.06)"),a.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=a,n.fillRect(0,0,e,e),n.translate(e/2,e/2);for(let i=0;i<4;i++){const c=n.createLinearGradient(0,0,e/2,0);c.addColorStop(0,"rgba(255,255,255,0.95)"),c.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=c,n.beginPath(),n.moveTo(0,-2.5),n.lineTo(e/2,0),n.lineTo(0,2.5),n.closePath(),n.fill(),n.rotate(Math.PI/2)}const s=new Xt(o);return s.colorSpace=mo,s})();function il(e,o,n,a){const s=[];for(let i=0;i<=a;i++){const c=i/a,h=c*2-1;s.push(new z(e[0]+(o[0]-e[0])*c,e[1]+(o[1]-e[1])*c-n*(1-h*h),e[2]+(o[2]-e[2])*c))}return s}const ll=[[[-62,34,26],[-6,42,-12],14],[[-6,42,-12],[52,32,18],13],[[-46,28,-30],[18,36,-40],11],[[18,36,-40],[68,26,-20],11],[[-70,22,-4],[-16,30,36],10],[[16,30,40],[72,22,12],10],[[-36,48,-62],[34,50,-66],14]];function cl({quality:e="high",shadows:o=!0}){const n=w.useRef(),a=w.useRef(),s=w.useRef(),i=w.useRef(),{lanternM:c,lampM:h,pilingM:l,katanaY:u,ground:b}=w.useMemo(()=>{const x=new ut,f=new Mt,p=new z(1,1,1),d=new z,v=[],j=e==="low"?.42:e==="mid"?.72:1;for(const[r,T,C]of ll){const P=Math.max(4,Math.round(C*j)),M=il(r,T,14,P);for(let G=1;G<M.length-1;G++){const L=.78+G*37%11/22;d.copy(M[G]).add(new z(0,-4.2*L,0)),f.setFromEuler(new $t(0,G*1.7%Math.PI,(G%3-1)*.06)),v.push(x.clone().compose(d,f,p.clone().multiplyScalar(L)))}}const S=[],k=e==="low"?6:11;for(let r=0;r<k;r++){const T=r/(k-1);for(const C of[-1,1]){const P=R.lerp(Q.x+46,de.x-6,T)+C*(26-T*9),M=R.lerp(Q.z-26,de.z+32,T);d.set(P,le(P,M)+5,M),f.identity(),S.push(x.clone().compose(d,f,p))}}const E=[];for(let r=0;r<16;r++){const T=r%2,C=Math.floor(r/2);d.set(Q.x+30+C*17,-2,Q.z+34+T*26),f.setFromEuler(new $t(0,0,(r%3-1)*.035)),E.push(x.clone().compose(d,f,p))}return{lanternM:v,lampM:S,pilingM:E,katanaY:le(Q.x+118,Q.z-58),ground:Q.y}},[e]);ae(()=>{const x=y.t;if(n.current&&(n.current.material.emissiveIntensity=2.4+Math.sin(x*2.7)*.2+Math.sin(x*6.1+1.3)*.12+y.flash*1.6),i.current){const f=46*(1+Math.sin(x*1.3)*.13);i.current.scale.set(f,f,1),i.current.material.rotation=x*.07}});const m=o,g=(x,f)=>le(Q.x+x,Q.z+f);return t.jsxs("group",{children:[t.jsxs("group",{position:[Q.x,0,Q.z],children:[t.jsxs("mesh",{position:[85,7.5,47],castShadow:m,receiveShadow:m,children:[t.jsx("boxGeometry",{args:[128,3,60]}),t.jsx("meshStandardMaterial",{color:A.timber,roughness:.92})]}),t.jsxs("mesh",{position:[18,7,4],receiveShadow:m,children:[t.jsx("boxGeometry",{args:[96,2.4,82]}),t.jsx("meshStandardMaterial",{color:"#5a4230",roughness:.94})]}),[0,1,2,3].map(x=>t.jsxs("group",{position:[52+x*26,1.5,92+x%2*13],rotation:[0,.4+x*.3,0],children:[t.jsxs("mesh",{castShadow:m,children:[t.jsx("boxGeometry",{args:[18,5,6.5]}),t.jsx("meshStandardMaterial",{color:"#4a3524",roughness:.9})]}),t.jsxs("mesh",{position:[0,9,0],children:[t.jsx("boxGeometry",{args:[.7,14,.7]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.9})]}),t.jsxs("mesh",{position:[1.5,12,0],children:[t.jsx("planeGeometry",{args:[9,11]}),t.jsx("meshStandardMaterial",{color:"#cbbfa4",roughness:1,side:Be})]})]},x))]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,l.length],castShadow:m,children:[t.jsx("cylinderGeometry",{args:[1.8,2.1,22,7]}),t.jsx("meshStandardMaterial",{color:"#33251a",roughness:.95}),t.jsx(yt,{matrices:l,target:s})]}),t.jsxs("group",{position:[Q.x+118,u,Q.z-58],rotation:[0,.5,.34],scale:.6,children:[t.jsxs("mesh",{position:[0,52,0],castShadow:m,children:[t.jsx("boxGeometry",{args:[7,132,2.1]}),t.jsx("meshStandardMaterial",{color:"#cfd8e2",roughness:.16,metalness:.92})]}),t.jsxs("mesh",{position:[0,116,0],rotation:[Math.PI/2,0,0],castShadow:m,children:[t.jsx("torusGeometry",{args:[9,2.4,6,18]}),t.jsx("meshStandardMaterial",{color:"#2a2118",roughness:.4,metalness:.75})]}),t.jsxs("mesh",{position:[0,138,0],castShadow:m,children:[t.jsx("cylinderGeometry",{args:[4.4,4.9,42,10]}),t.jsx("meshStandardMaterial",{color:"#20232b",roughness:.85})]}),t.jsxs("mesh",{position:[0,161,0],castShadow:m,children:[t.jsx("cylinderGeometry",{args:[5.2,5.2,5,10]}),t.jsx("meshStandardMaterial",{color:"#8a7a4e",roughness:.5,metalness:.6})]}),t.jsx("sprite",{ref:i,position:[0,116,0],scale:[46,46,1],children:t.jsx("spriteMaterial",{map:rl,color:A.furnace,transparent:!0,opacity:.75,blending:it,depthWrite:!1,toneMapped:!1})})]}),[-1,1].map(x=>{const f=96+x*4,p=88*x;return t.jsxs("group",{position:[Q.x+f,g(f,p),Q.z+p],rotation:[0,-x*.5,0],children:[t.jsxs("mesh",{position:[0,7,0],castShadow:m,children:[t.jsx("boxGeometry",{args:[13,14,13]}),t.jsx("meshStandardMaterial",{color:"#4a4a52",roughness:.95})]}),t.jsxs("mesh",{position:[0,21,1],rotation:[.22,0,0],castShadow:m,children:[t.jsx("capsuleGeometry",{args:[5,12,4,8]}),t.jsx("meshStandardMaterial",{color:"#c9c4b4",roughness:.86})]}),t.jsxs("mesh",{position:[0,32,5],castShadow:m,children:[t.jsx("sphereGeometry",{args:[5.4,12,10]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]}),[-1,1].map(d=>t.jsxs("mesh",{position:[d*3,37,4],rotation:[0,0,d*.3],castShadow:m,children:[t.jsx("coneGeometry",{args:[2.1,6.5,4]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]},d)),t.jsxs("mesh",{position:[0,26,-8],rotation:[-.7,0,0],castShadow:m,children:[t.jsx("coneGeometry",{args:[4,20,6]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]}),t.jsxs("mesh",{position:[0,26,6.4],rotation:[.3,0,0],children:[t.jsx("planeGeometry",{args:[9,8]}),t.jsx("meshStandardMaterial",{color:A.vermilion,roughness:.9,side:Be})]})]},x)}),[-1,1].map(x=>{const f=40+x*34,p=-18+x*46;return t.jsxs("group",{position:[Q.x+f,g(f,p)+12,Q.z+p],rotation:[0,x*.8,0],children:[t.jsxs("mesh",{castShadow:m,children:[t.jsx("sphereGeometry",{args:[9,12,10]}),t.jsx("meshStandardMaterial",{color:"#7c6a52",roughness:.9})]}),[-1,1].map(d=>t.jsxs("mesh",{position:[d*5,7,-1],rotation:[0,0,d*-.5],castShadow:m,children:[t.jsx("coneGeometry",{args:[1.8,8,5]}),t.jsx("meshStandardMaterial",{color:"#4c4038",roughness:.85})]},d)),t.jsxs("mesh",{position:[0,-1,8],children:[t.jsx("sphereGeometry",{args:[4.2,10,8]}),t.jsx("meshStandardMaterial",{color:A.ember,emissive:A.ember,emissiveIntensity:2.2,toneMapped:!1})]}),t.jsxs("mesh",{position:[0,-8,13],rotation:[.4,0,0],children:[t.jsx("cylinderGeometry",{args:[1.5,2.6,20,6,1,!0]}),t.jsx("meshStandardMaterial",{color:"#cfe4ee",transparent:!0,opacity:.42,roughness:.25,side:Be})]})]},x)}),t.jsxs("group",{position:[Q.x-34,g(-34,30)+2,Q.z+30],children:[t.jsxs("mesh",{position:[0,30,0],castShadow:m,children:[t.jsx("cylinderGeometry",{args:[1.1,1.4,60,8]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.92})]}),t.jsxs("mesh",{position:[0,58,0],castShadow:m,children:[t.jsx("coneGeometry",{args:[34,17,20,1,!0]}),t.jsx("meshStandardMaterial",{color:A.vermilion,roughness:.88,side:Be,emissive:A.vermilionDeep,emissiveIntensity:.4})]}),Array.from({length:10},(x,f)=>{const p=f/10*Math.PI*2;return t.jsxs("mesh",{position:[Math.cos(p)*26,55.5,Math.sin(p)*26],rotation:[0,-p,-.42],children:[t.jsx("boxGeometry",{args:[34,.6,.6]}),t.jsx("meshStandardMaterial",{color:"#2a1c12",roughness:.9})]},f)}),Array.from({length:10},(x,f)=>{const p=f/10*Math.PI*2+.31;return t.jsxs("mesh",{position:[Math.cos(p)*32,44,Math.sin(p)*32],children:[t.jsx("cylinderGeometry",{args:[2.6,2.6,4.6,8]}),t.jsx("meshStandardMaterial",{color:A.lantern,emissive:A.lantern,emissiveIntensity:2.5,toneMapped:!1})]},f)})]}),[0,1,2,3].map(x=>{const f=8+x*30,p=-70-x%2*14;return t.jsxs("group",{position:[Q.x+f,g(f,p),Q.z+p],children:[t.jsxs("mesh",{position:[0,26,0],castShadow:m,children:[t.jsx("cylinderGeometry",{args:[.6,.6,52,6]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.9})]}),t.jsxs("mesh",{position:[5,34,0],children:[t.jsx("planeGeometry",{args:[10,34]}),t.jsx("meshStandardMaterial",{color:x%2?"#e8dcc4":A.vermilion,roughness:.95,side:Be})]})]},x)}),[0,1,2].map(x=>{const f=.28+x*.24,p=R.lerp(Q.x+46,de.x,f),d=R.lerp(Q.z-26,de.z+26,f),v=le(p,d),j=1-x*.1;return t.jsxs("group",{position:[p,v,d],scale:j,children:[[-1,1].map(S=>t.jsxs("mesh",{position:[S*15,17,0],castShadow:m,children:[t.jsx("cylinderGeometry",{args:[1.7,2.1,34,10]}),t.jsx("meshStandardMaterial",{color:A.vermilion,roughness:.7})]},S)),t.jsxs("mesh",{position:[0,36,0],castShadow:m,children:[t.jsx("boxGeometry",{args:[44,3.4,4]}),t.jsx("meshStandardMaterial",{color:A.vermilion,roughness:.68})]}),t.jsxs("mesh",{position:[0,29,0],castShadow:m,children:[t.jsx("boxGeometry",{args:[36,2.4,3]}),t.jsx("meshStandardMaterial",{color:A.vermilionDeep,roughness:.75})]})]},x)}),t.jsx("group",{position:[Q.x,b,Q.z],children:t.jsxs("instancedMesh",{ref:n,args:[null,null,c.length],children:[t.jsx("cylinderGeometry",{args:[3.1,3.1,5.6,8]}),t.jsx("meshStandardMaterial",{color:A.lantern,emissive:A.lantern,emissiveIntensity:2.4,toneMapped:!1}),t.jsx(yt,{matrices:c,target:n})]})}),t.jsxs("instancedMesh",{ref:a,args:[null,null,h.length],castShadow:m,children:[t.jsx("boxGeometry",{args:[6,12,6]}),t.jsx("meshStandardMaterial",{color:"#6c6458",emissive:A.lanternFar,emissiveIntensity:1.1,roughness:.95}),t.jsx(yt,{matrices:h,target:a})]})]})}const La={low:{pine:150,sakura:90,rock:60},mid:{pine:340,sakura:190,rock:130},high:{pine:620,sakura:340,rock:240}};function hl(e){let o=e>>>0;return()=>(o=Math.imul(o,1664525)+1013904223>>>0,o/4294967296)}function dl({quality:e="high",shadows:o=!0}){const n=w.useRef(),a=w.useRef(),s=w.useRef(),i=w.useRef(),{pineTrunkM:c,pineCanopyM:h,sakuraM:l,rockM:u}=w.useMemo(()=>{const m=La[e]??La.high,g=hl(20250801),x=new ut,f=new Mt,p=new z,d=new z,v=new z(0,1,0),j=new z,S=[],k=[],E=[],r=m.pine+m.sakura+m.rock;let T=0,C=0;for(;T<r&&C<r*60;){C++;const P=g()*Math.PI*2,M=vt*(.55+g()*.62),G=pe.x+Math.sin(P)*M,L=pe.z+Math.cos(P)*M,W=le(G,L);if(W<5||W>300||Mi(G,L,6)>.72||Math.hypot(G-F.x,L-F.z)<F.r*1.35)continue;const K=G>pe.x+(g()-.5)*90,fe=T;if(T++,d.set(G,W,L),fe<m.rock){const O=ca(G,L,5);j.set(O[0],O[1],O[2]),f.setFromUnitVectors(v,j),f.multiply(new Mt().setFromEuler(new $t(g()*.5,g()*6.28,g()*.5)));const $=2.5+g()*7;p.set($*(.7+g()*.6),$*(.5+g()*.5),$*(.7+g()*.6)),d.y-=$*.25,E.push(x.clone().compose(d,f,p))}else if(K){if(S.length>=m.pine)continue;f.setFromEuler(new $t(0,g()*6.28,(g()-.5)*.09));const O=.72+g()*.7;p.set(O,O*(.85+g()*.45),O),S.push(x.clone().compose(d,f,p))}else{if(k.length>=m.sakura)continue;f.setFromEuler(new $t(0,g()*6.28,(g()-.5)*.13));const O=.7+g()*.75;p.set(O,O*(.8+g()*.5),O),k.push(x.clone().compose(d,f,p))}}return{pineTrunkM:S.map(P=>P.clone().multiply(ul)).concat(k.map(P=>P.clone().multiply(ml))),pineCanopyM:S.map(P=>P.clone().multiply(pl)),sakuraM:k.map(P=>P.clone().multiply(fl)),rockM:E}},[e]),b=o;return t.jsxs(t.Fragment,{children:[t.jsxs("instancedMesh",{ref:n,args:[null,null,c.length],castShadow:b,children:[t.jsx("cylinderGeometry",{args:[.9,1.7,14,5]}),t.jsx("meshStandardMaterial",{color:"#1d1a1c",roughness:.96}),t.jsx(yt,{matrices:c,target:n})]}),t.jsxs("instancedMesh",{ref:a,args:[null,null,h.length],castShadow:b,children:[t.jsx("coneGeometry",{args:[8.5,30,7]}),t.jsx("meshStandardMaterial",{color:X.pine,roughness:.93,flatShading:!0}),t.jsx(yt,{matrices:h,target:a})]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,l.length],castShadow:b,children:[t.jsx("sphereGeometry",{args:[7.5,8,6]}),t.jsx("meshStandardMaterial",{color:A.sakura,roughness:.95,flatShading:!0,emissive:A.sakura,emissiveIntensity:.1}),t.jsx(yt,{matrices:l,target:s})]}),t.jsxs("instancedMesh",{ref:i,args:[null,null,u.length],castShadow:b,receiveShadow:b,children:[t.jsx("dodecahedronGeometry",{args:[1,0]}),t.jsx("meshStandardMaterial",{color:X.rock,roughness:.97,flatShading:!0}),t.jsx(yt,{matrices:u,target:i})]})]})}const ul=new ut().makeTranslation(0,7,0),pl=new ut().makeTranslation(0,26,0),fl=new ut().compose(new z(0,13,0),new Mt,new z(1,.72,1)),ml=new ut().compose(new z(0,5,0),new Mt,new z(.75,.62,.75)),Et=Math.PI,Fa={"ship-sunny.opt.glb":Et/2,"ship-tang.opt.glb":Et/2,"ship-punk.opt.glb":Et/2,"ship-lion.opt.glb":Et/2,"ship-bone.opt.glb":Et/2,"ship-junk.opt.glb":Et/2,"ship-warjunk.opt.glb":Et/2,"ship-sub.opt.glb":-Et/2},gn=e=>e&&Fa[e]!==void 0?Fa[e]:Et/2,gl={"ship-sunny.opt.glb":40,"ship-lion.opt.glb":40,"ship-punk.opt.glb":52,"ship-tang.opt.glb":32,"ship-sub.opt.glb":32,"ship-bone.opt.glb":50,"ship-junk.opt.glb":38,"ship-warjunk.opt.glb":60},go=1.9,Ga=Object.fromEntries(Object.entries(gl).map(([e,o])=>[e,Math.round(o*go)])),Oa={"ship-sunny.opt.glb":.6,"ship-lion.opt.glb":.8,"ship-punk.opt.glb":.62,"ship-tang.opt.glb":.62,"ship-sub.opt.glb":.72,"ship-bone.opt.glb":.72,"ship-junk.opt.glb":.53,"ship-warjunk.opt.glb":.6},xn=2,Na={"ship-sunny.opt.glb":.513,"ship-lion.opt.glb":.274,"ship-punk.opt.glb":.264,"ship-tang.opt.glb":.208,"ship-sub.opt.glb":.261,"ship-bone.opt.glb":.353,"ship-junk.opt.glb":.313,"ship-warjunk.opt.glb":.415},Da={"ship-sunny.opt.glb":1.044,"ship-lion.opt.glb":.824,"ship-punk.opt.glb":.673,"ship-tang.opt.glb":1,"ship-sub.opt.glb":.641,"ship-bone.opt.glb":.771,"ship-junk.opt.glb":.915,"ship-warjunk.opt.glb":.702},Ha={"ship-sunny.opt.glb":.165,"ship-lion.opt.glb":.095,"ship-punk.opt.glb":.115,"ship-bone.opt.glb":.105,"ship-junk.opt.glb":.1,"ship-warjunk.opt.glb":.115,"ship-tang.opt.glb":.035,"ship-sub.opt.glb":.035},_a={"ship-sunny.opt.glb":.28,"ship-lion.opt.glb":.144,"ship-punk.opt.glb":.148,"ship-tang.opt.glb":.41,"ship-sub.opt.glb":.214,"ship-bone.opt.glb":.158,"ship-junk.opt.glb":.21,"ship-warjunk.opt.glb":.244},xl=(e,o)=>(e&&_a[e]!==void 0?_a[e]:.2)*o/2,dr={"ship-sunny.opt.glb":[.047,.057,.057,.107,.154,.154,.113,.079,.079],"ship-lion.opt.glb":[.076,.109,.104,.098,.103,.082,.051,.017,.017],"ship-punk.opt.glb":[.073,.073,.078,.078,.079,.081,.066,.057,.057],"ship-tang.opt.glb":[.069,.089,.097,.108,.227,.227,.155,.157,.157],"ship-sub.opt.glb":[.105,.12,.16,.161,.171,.179,.145,.144,.144],"ship-bone.opt.glb":[.087,.134,.116,.116,.12,.12,.107,.107,.107],"ship-junk.opt.glb":[.065,.086,.108,.124,.141,.141,.086,.043,.043],"ship-warjunk.opt.glb":[.071,.071,.071,.123,.064,.117,.108,.018,.018]},ua=(e,o,n)=>{const a=e&&dr[e]||null;if(!a)return xl(e,o);const s=Math.min(.9999,Math.max(0,n+.5))*(a.length-1),i=Math.floor(s);return(a[i]+(a[i+1]-a[i])*(s-i))*o},Ba={"ship-sunny.opt.glb":-.061,"ship-lion.opt.glb":-.206,"ship-punk.opt.glb":-.09,"ship-tang.opt.glb":.192,"ship-sub.opt.glb":-.05,"ship-bone.opt.glb":-.064,"ship-junk.opt.glb":.093,"ship-warjunk.opt.glb":-.044},bl=(e,o)=>(e&&Ba[e]!==void 0?Ba[e]:0)*o,ur=(e,o)=>{const n=e&&dr[e]||null;if(!n)return o;const a=Math.max(...n)*.35,s=n.length,i=h=>-.5+h/(s-1),c=Math.round((o+.5)*(s-1));for(let h=0;h<s;h++)for(const l of[c-h,c+h])if(!(l<0||l>=s||n[l]<a))return h===0?o:i(l);return 0},Zo=[[0,.25,0],[-.5,0,.7],[.5,-.125,-.9],[0,-.25,Math.PI*.85]],pa=(e,o,[n,a])=>{const s=ur(e,a);return[n*ua(e,o,s),s*o]},pr=e=>e==="low"?Zo.slice(0,1):e==="mid"?Zo.slice(0,2):Zo,Tt=["ship-tang.opt.glb","ship-sub.opt.glb"],fr=[{what:"flag",mast:.9,onMast:!0,r:.03,deep:.5},{what:"lantern port",kind:"lantern",except:Tt,beam:-.6,deck:!0,up:.012,z:-.125,r:.008},{what:"lantern stbd",kind:"lantern",except:Tt,beam:.6,deck:!0,up:.012,z:-.125,r:.008},{what:"lantern bow",kind:"lantern",close:!0,except:Tt,beam:0,deck:!0,up:.014,z:.25,r:.008},{what:"lantern waist port",kind:"lantern",close:!0,except:Tt,beam:-.62,deck:!0,up:.012,z:0,r:.008},{what:"lantern waist stbd",kind:"lantern",close:!0,except:Tt,beam:.62,deck:!0,up:.012,z:0,r:.008},{what:"casing lamp port",kind:"lantern",only:Tt,beam:-.88,deck:!0,up:.006,z:-.02,r:.008},{what:"casing lamp stbd",kind:"lantern",only:Tt,beam:.88,deck:!0,up:.006,z:-.02,r:.008},{what:"headlamp",only:Tt,beam:0,deck:!0,up:-.012,z:.4,r:.028,snap:!1},{what:"screw",only:Tt,beam:0,deck:!0,up:-.012,z:-.39,r:.022,snap:!1,deep:.12}],wl=e=>fr.filter(o=>(!o.only||o.only.includes(e))&&!(o.except&&o.except.includes(e))),fa=(e,o=!1)=>wl(e).filter(n=>n.kind==="lantern"&&(o||!n.close)),Ht=(e,o,n)=>{const a=n.onMast?bl(e,o)/o:n.snap===!1?n.z??0:ur(e,n.z??0);return[(n.beam??0)*ua(e,o,a),n.deck?Qt(e,o)+(n.up??0)*o:(n.mast??0)*wr(e,o),a*o]},Co=e=>fr.find(o=>o.what===e),yl={"ship-sunny.opt.glb":!0,"ship-punk.opt.glb":!0,"ship-tang.opt.glb":!0},mr=e=>!!(e&&yl[e]),vl=2.8,gr=vl*go,sn=e=>gr*(.72+.28*(e/(40*go))),xr=.28*go,rn=5.2*go,Ua={"ship-sunny.opt.glb":"#e6ded0","ship-punk.opt.glb":"#c9bfae","ship-tang.opt.glb":"#ece3cd","ship-lion.opt.glb":"#9a9188","ship-sub.opt.glb":"#9a9188","ship-bone.opt.glb":"#9a9188"},ma=(e,o="#9a9188")=>e&&Ua[e]!==void 0?Ua[e]:o,Ml={"ship-tang.opt.glb":["#e8c34a",1.15],"ship-sub.opt.glb":["#e8c34a",1.15],"ship-sunny.opt.glb":["#c9a06a",.28],"ship-punk.opt.glb":["#b06a5a",.28]},ln=e=>e&&Ml[e]||null,bn=(e,o=34)=>e&&Ga[e]!==void 0?Ga[e]:o,wn=e=>e&&Oa[e]!==void 0?Oa[e]:1,kl=e=>e&&Na[e]!==void 0?Na[e]:.2,br=e=>e&&Ha[e]!==void 0?Ha[e]:.13,Po=e=>Math.max(0,kl(e)-br(e)),Qt=(e,o)=>br(e)*o,wr=(e,o)=>((e&&Da[e]!==void 0?Da[e]:.8)-Po(e))*o,Wa={sunny:{id:"sunny",name:"THOUSAND SUNNY",crewName:"STRAW HAT",hulls:["ship-sunny.opt.glb","ship-lion.opt.glb"],flag:"straw",crew:"crew-straw.opt.glb",fleetId:"straw-hats",tint:"#c98a52",burst:{push:76,charge:9,label:"BURST",sub:"coup de"},topSpeed:84,accel:21,turn:1.05},punk:{id:"punk",name:"VICTORIA PUNK",crewName:"KID",hulls:["ship-punk.opt.glb","ship-bone.opt.glb"],flag:"kid",crew:"crew-punk.opt.glb",fleetId:"kid",tint:"#9a6a4e",burst:{push:95,charge:13,label:"RAM",sub:"full ahead"},topSpeed:78,accel:16,turn:.86}},cn=e=>Wa[e]??Wa.sunny,io=[{id:"sunny",mode:"helm",vessel:"sunny",name:"THOUSAND SUNNY",who:"LUFFY"},{id:"punk",mode:"helm",vessel:"punk",name:"VICTORIA PUNK",who:"KID"},{id:"tang",mode:"sub",vessel:"tang",name:"POLAR TANG",who:"LAW"}],jl=(e,o)=>e==="sub"?io[2]:io.find(n=>n.vessel===o)??io[0],ga=(e,o)=>{const n=io.indexOf(jl(e,o));return io[(n+1)%io.length]},yr=210,Ya={off:1,lead:.98*go*.77},Mn={SPREAD:28,SWEEP:14,RANK:118},_n=(e,o=0,n=0)=>({off:(e+(n?.5*Math.sign(e||1):0))*Mn.SPREAD,lead:o-Math.abs(e)*Mn.SWEEP-n*Mn.RANK}),Va={kozuki:{side:-1,from:2},yakuza:{side:1,from:2},mink:{side:0,from:9}};function Sl(e){const o={},n={};for(const a of e){const s=vr[a.id];if(s){Object.assign(a,_n(s[0],s[1]));continue}const i=Va[a.faction]?a.faction:"kozuki",c=Va[i],h=a.rank??0,l=`${i}:${h}`;o[l]===void 0&&(o[l]=c.from,n[l]=-1);const u=c.side||n[l];Object.assign(a,_n(u*o[l],0,h)),c.side===0?(n[l]>0&&(o[l]+=1),n[l]=-n[l]):o[l]+=1}}const vr={scabbards:[0,yr],"straw-hats":[-1,150],kid:[1,150],heart:[0,60]},Mr=680*H,kn={z:1100},Bn={sunny:{x:0*H,z:kn.z*H},punk:{x:96*H,z:(kn.z-18)*H},tang:{x:-104*H,z:(kn.z-30)*H}};function zl(e,o=0){const n=(820+-670*e)*H+o;return[(Math.sin(e*2.4)*54-e*26)*H,n]}function kr(e,o,n,a){const[s,i]=zl(n,a);return[s+o*H*Ya.off,i-e*H*Ya.lead]}function $a(e){const o=vr[e];if(!o)return null;const{lead:n,off:a}=_n(o[0],o[1]),[s,i]=kr(n,a,0,Mr);return{x:s,z:i}}const Tl=[{x:-300*H,z:100*H,yaw:.35},{x:330*H,z:360*H,yaw:-.55},{x:-390*H,z:470*H,yaw:.12},{x:420*H,z:830*H,yaw:-.28},{x:-455*H,z:930*H,yaw:.48},{x:400*H,z:1120*H,yaw:-.16},{x:-520*H,z:690*H,yaw:.22},{x:540*H,z:1290*H,yaw:-.42}],El=[{x:Q.x+132*H*.72,z:Q.z+96*H*.72,yaw:2.3},{x:Q.x+168*H*.72,z:Q.z+40*H*.72,yaw:1.9},{x:Q.x+96*H*.72,z:Q.z+150*H*.72,yaw:2.7}];function Rl({url:e,height:o,loa:n,slim:a=1,sink:s=0,rotation:i,tint:c,emissive:h,emissiveIntensity:l,glow:u,onMaterials:b}){const{scene:m}=qs(e),g=w.useMemo(()=>m.clone(!0),[m]),x=w.useMemo(()=>{const f=new Js().setFromObject(g),p=new z;f.getSize(p);const d=new z;if(f.getCenter(d),n){const j=p.x>=p.z,S=Math.max(j?p.x:p.z,1e-4),k=n/S,E=j?[k,k,k*a]:[k*a,k,k];return{scale:E,offset:[-d.x*E[0],-f.min.y*E[1]-n*s,-d.z*E[2]]}}const v=p.y>1e-4?o/p.y:1;return{scale:[v,v,v],offset:[-d.x*v,-f.min.y*v,-d.z*v]}},[g,o,n,a,s]);return w.useEffect(()=>{const f=[];g.traverse(p=>{if(!p.isMesh)return;p.castShadow=!0,p.receiveShadow=!0;const d=p.material?Array.isArray(p.material)?p.material:[p.material]:[];for(const v of d)f.push(v),c&&(v.color?.multiply(new ze(c)),h&&v.emissive&&(v.emissive.set(h),v.emissiveIntensity=l??.2)),u&&v.emissive&&(v.emissive.set(u[0]),v.emissiveIntensity=u[1],v.map&&!v.emissiveMap&&(v.emissiveMap=v.map),v.needsUpdate=!0)}),b?.(f)},[g,c,h,l,u,b]),t.jsx("group",{rotation:[0,i,0],scale:x.scale,position:x.offset,children:t.jsx("primitive",{object:g})})}class Al extends w.Component{constructor(){super(...arguments);ja(this,"state",{failed:!1})}static getDerivedStateFromError(){return{failed:!0}}componentDidCatch(n){}render(){return this.state.failed?this.props.fallback:this.props.children}}function ye({name:e,height:o,loa:n=null,slim:a=1,sink:s=0,rotation:i=0,position:c=[0,0,0],tint:h=null,emissive:l=null,emissiveIntensity:u=.2,glow:b=null,onMaterials:m=null,fallback:g=null}){const x=Ao(e);return rt(e)?t.jsx("group",{position:c,children:t.jsx(Al,{url:x,fallback:g,children:t.jsx(w.Suspense,{fallback:g,children:t.jsx(Rl,{url:x,height:o,loa:n,slim:a,sink:s,rotation:i,tint:h,emissive:l,emissiveIntensity:u,glow:b,onMaterials:m})})})}):t.jsx("group",{position:c,children:g})}const Un=(()=>{if(typeof document>"u")return null;const e=64,o=128,n=document.createElement("canvas");n.width=e,n.height=o;const a=n.getContext("2d"),s=a.createImageData(e,o);for(let c=0;c<o;c++){const h=c/(o-1),l=Math.pow(1-h,1.7);for(let u=0;u<e;u++){const b=u/(e-1)*2-1,m=Math.max(0,1-Math.abs(b)/(.35+h*.65)),g=.45+.55*Math.pow(Math.abs(b)/(.35+h*.65),1.5),x=l*Math.pow(m,1.4)*g,f=(c*e+u)*4;s.data[f]=255,s.data[f+1]=255,s.data[f+2]=255,s.data[f+3]=Math.round(Math.min(1,x)*255)}}a.putImageData(s,0,0);const i=new Xt(n);return i.colorSpace=mo,i})(),Il=(()=>{if(typeof document>"u")return null;const e=64,o=document.createElement("canvas");o.width=e,o.height=e;const n=o.getContext("2d"),a=n.createImageData(e,e);for(let i=0;i<e;i++){const c=i/(e-1),h=Math.pow(1-c,1.5);for(let l=0;l<e;l++){const u=l/(e-1)*2-1,b=Math.max(0,1-Math.abs(u)),m=h*Math.pow(b,1.3),g=(i*e+l)*4;a.data[g]=255,a.data[g+1]=255,a.data[g+2]=255,a.data[g+3]=Math.round(Math.min(1,m)*255)}}n.putImageData(a,0,0);const s=new Xt(o);return s.colorSpace=mo,s})(),hn=(()=>{if(typeof document>"u")return null;const e=64,o=document.createElement("canvas");o.width=e,o.height=e;const n=o.getContext("2d"),a=n.createRadialGradient(e/2,e/2,2,e/2,e/2,e/2);a.addColorStop(0,"rgba(255,255,255,0.9)"),a.addColorStop(.4,"rgba(255,255,255,0.28)"),a.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=a,n.fillRect(0,0,e,e);const s=new Xt(o);return s.colorSpace=mo,s})(),qo=160,ro=112,Nt="#e6dfcf",jr="#0c0a15",Vt=jr;typeof CanvasRenderingContext2D<"u"&&!CanvasRenderingContext2D.prototype.roundRect&&(CanvasRenderingContext2D.prototype.roundRect=function(e,o,n,a,s){const i=Math.min(s??0,Math.abs(n)/2,Math.abs(a)/2);return this.moveTo(e+i,o),this.arcTo(e+n,o,e+n,o+a,i),this.arcTo(e+n,o+a,e,o+a,i),this.arcTo(e,o+a,e,o,i),this.arcTo(e,o,e+n,o,i),this.closePath(),this});function Ft(e){if(typeof document>"u")return null;const o=document.createElement("canvas");o.width=qo,o.height=ro;const n=o.getContext("2d"),a=n.createLinearGradient(0,0,0,ro);a.addColorStop(0,"#14101f"),a.addColorStop(.5,jr),a.addColorStop(1,"#08060f"),n.fillStyle=a,n.fillRect(0,0,qo,ro),n.fillStyle="rgba(255,255,255,0.07)",n.fillRect(0,0,5,ro),n.save(),n.translate(qo/2+4,ro/2);try{e(n)}catch(i){console.warn("[onigashima] flag emblem skipped",i)}n.restore();const s=new Xt(o);return s.colorSpace=mo,s.anisotropy=4,s}function jn(e,o,n=Nt){e.fillStyle=n,e.beginPath(),e.ellipse(0,-o*.12,o,o*.92,0,0,Math.PI*2),e.fill(),e.beginPath(),e.roundRect(-o*.52,o*.6,o*1.04,o*.5,o*.16),e.fill()}function Sn(e,o,n=1){e.save(),e.fillStyle=Vt,e.beginPath(),e.ellipse(-o*.38,-o*.2,o*.27*n,o*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.ellipse(o*.38,-o*.2,o*.27*n,o*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.moveTo(0,o*.06),e.lineTo(-o*.14,o*.34),e.lineTo(o*.14,o*.34),e.closePath(),e.fill(),e.restore()}function Ka(e,o,n=4){e.save(),e.fillStyle=Vt;for(let a=1;a<n;a++){const s=-o*.5+a*o/n;e.fillRect(s-o*.035,o*.6,o*.07,o*.5)}e.fillRect(-o*.52,o*.78,o*1.04,o*.05),e.restore()}function zn(e,o,n=Nt){e.save(),e.strokeStyle=n,e.lineWidth=o*.17,e.lineCap="round";for(const a of[1,-1]){e.save(),e.rotate(a*Math.PI/4.4),e.beginPath(),e.moveTo(-o*1.55,o*.55),e.lineTo(o*1.55,o*.55),e.stroke(),e.fillStyle=n;for(const s of[-1,1])for(const i of[-.16,.16])e.beginPath(),e.arc(s*o*1.55,o*.55+i*o,o*.15,0,Math.PI*2),e.fill();e.restore()}e.restore()}const Cl={straw:Ft(e=>{zn(e,26),jn(e,26),Sn(e,26),Ka(e,26),e.fillStyle="#e8c86a",e.beginPath(),e.ellipse(0,-26*.86,26*1.5,26*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.roundRect(-26*.78,-26*1.5,26*1.56,26*.7,26*.22),e.fill(),e.fillStyle="#d63420",e.fillRect(-26*.8,-26*1.06,26*1.6,26*.22)}),heart:Ft(e=>{const n="#a8e8d4";e.fillStyle=n,e.beginPath(),e.ellipse(0,0,27*1.02,27*1,0,0,Math.PI*2),e.fill(),e.save(),e.fillStyle=Vt;for(const a of[-1,1])e.beginPath(),e.arc(a*27*.36,-27*.2,27*.2,0,Math.PI*2),e.fill();e.lineWidth=27*.13,e.strokeStyle=Vt,e.beginPath(),e.arc(0,27*.12,27*.52,.24*Math.PI,.76*Math.PI),e.stroke(),e.restore(),e.fillStyle="#d63420",e.beginPath(),e.moveTo(0,-27*1.34),e.bezierCurveTo(27*.5,-27*1.9,27*.9,-27*1.2,0,-27*.78),e.bezierCurveTo(-27*.9,-27*1.2,-27*.5,-27*1.9,0,-27*1.34),e.fill()}),kid:Ft(e=>{zn(e,26,"#d8cfc0"),e.fillStyle=Nt,e.beginPath(),e.moveTo(-26*1.05,-26*.5),e.lineTo(-26*.7,-26*1.05),e.lineTo(26*.7,-26*1.05),e.lineTo(26*1.05,-26*.5),e.lineTo(26*.72,26*.5),e.lineTo(-26*.72,26*.5),e.closePath(),e.fill(),e.beginPath(),e.roundRect(-26*.62,26*.42,26*1.24,26*.62,26*.1),e.fill(),e.save(),e.fillStyle=Vt;for(const n of[-1,1])e.save(),e.translate(n*26*.4,-26*.3),e.rotate(n*.35),e.beginPath(),e.roundRect(-26*.28,-26*.2,26*.56,26*.4,26*.1),e.fill(),e.restore();for(let n=0;n<6;n++){const a=-15.6+n*26*1.2/5;e.beginPath(),e.moveTo(a,26*.42),e.lineTo(a+26*.1,26*1.04),e.lineTo(a-26*.1,26*1.04),e.closePath(),e.fill()}e.restore()}),kozuki:Ft(e=>{e.strokeStyle="#e8b06a",e.lineWidth=30*.1,e.beginPath(),e.arc(0,0,30*1.06,0,Math.PI*2),e.stroke(),e.fillStyle="#d63420";for(let n=0;n<5;n++){const a=n/5*Math.PI*2-Math.PI/2;e.save(),e.rotate(a),e.beginPath(),e.ellipse(0,-30*.52,30*.26,30*.42,0,0,Math.PI*2),e.fill(),e.restore()}e.fillStyle="#e8c86a",e.beginPath(),e.arc(0,0,30*.24,0,Math.PI*2),e.fill()}),alliance:Ft(e=>{zn(e,27,"#dcd4c4"),e.fillStyle=Nt,e.beginPath();for(let n=0;n<16;n++){const a=n/16*Math.PI*2;e.moveTo(Math.cos(a)*27*1.02+27*.17,Math.sin(a)*27*1.02),e.arc(Math.cos(a)*27*1.02,Math.sin(a)*27*1.02,27*.17,0,Math.PI*2)}e.fill(),e.beginPath(),e.arc(0,0,27*1.02,0,Math.PI*2),e.fill(),e.fillStyle=Vt,e.beginPath(),e.arc(0,0,27*.9,0,Math.PI*2),e.fill(),e.fillStyle=Nt;for(const n of[-1,1])e.beginPath(),e.moveTo(n*27*.1,27*.42),e.quadraticCurveTo(n*27*.92,27*.1,n*27*.62,-27*.78),e.quadraticCurveTo(n*27*.5,-27*.2,n*27*.06,27*.3),e.closePath(),e.fill();e.beginPath(),e.ellipse(27*.02,-27*.02,27*.15,27*.19,0,0,Math.PI*2),e.fill(),e.beginPath(),e.moveTo(-27*.08,-27*.02),e.lineTo(-27*.36,27*.04),e.lineTo(-27*.08,27*.1),e.closePath(),e.fill(),e.beginPath(),e.arc(0,27*.52,27*.12,0,Math.PI*2),e.fill();for(let n=0;n<8;n++){const a=n/8*Math.PI*2;e.beginPath(),e.arc(Math.cos(a)*27*.26,27*.52+Math.sin(a)*27*.26,27*.055,0,Math.PI*2),e.fill()}}),yakuza:Ft(e=>{e.strokeStyle="#e8c86a",e.lineWidth=28*.12,e.beginPath(),e.roundRect(-28*.86,-28*.86,28*1.72,28*1.72,28*.14),e.stroke(),e.fillStyle=Nt;for(const n of[-.42,0,.42])e.fillRect(-28*.52,n*28-28*.07,28*1.04,28*.15);e.fillRect(-28*.09,-28*.55,28*.18,28*1.1),e.fillStyle="#d63420",e.beginPath(),e.arc(0,-28*1.32,28*.2,0,Math.PI*2),e.fill()}),mink:Ft(e=>{e.fillStyle=Nt;for(const n of[-1,1])e.beginPath(),e.moveTo(n*25*.5,-25*.85),e.lineTo(n*25*1.02,-25*1.72),e.lineTo(n*25*1.06,-25*.6),e.closePath(),e.fill();jn(e,25),e.beginPath(),e.roundRect(-25*.34,25*.42,25*.68,25*.78,25*.2),e.fill(),Sn(e,25,.85),e.save(),e.fillStyle=Vt,e.fillRect(-25*.32,25*.72,25*.64,25*.06),e.restore(),e.fillStyle=Nt;for(const n of[-1,1])e.beginPath(),e.moveTo(n*25*.3,25*.7),e.lineTo(n*25*.42,25*1.42),e.lineTo(n*25*.16,25*.78),e.closePath(),e.fill()}),beasts:Ft(e=>{e.fillStyle="#cfd8e4";for(const n of[-1,1])e.beginPath(),e.moveTo(n*26*.62,-26*.78),e.quadraticCurveTo(n*26*1.5,-26*1.5,n*26*1.18,-26*2),e.quadraticCurveTo(n*26*1.42,-26*1.35,n*26*.86,-26*.5),e.closePath(),e.fill();jn(e,26,"#cfd8e4"),Sn(e,26),Ka(e,26,5),e.fillStyle="#c9411a",e.beginPath(),e.roundRect(-26*.74,26*.34,26*1.48,26*.2,26*.1),e.fill()})},Sr={value:0},Qa=new Map;function Pl(e){const o=Qa.get(e);if(o)return o;const n=Cl[e],a=new ni({map:n,emissiveMap:n,emissive:new ze("#9fb4d8"),emissiveIntensity:.95,roughness:.94,metalness:0,side:Be,transparent:!1});return a.onBeforeCompile=s=>{s.uniforms.uTime=Sr,s.vertexShader=`uniform float uTime;
...
`,ns={low:120,mid:340,high:700};function Ql({quality:e}){const o=w.useRef(),n=w.useMemo(()=>{const s=ns[e]??ns.high,i=[Pe[0],Pe[1],de,de],c=new Float32Array(s*3),h=new Float32Array(s),l=new Float32Array(s),u=new Float32Array(s);for(let m=0;m<s;m++){const g=i[m%i.length];c[m*3]=g.x+(Math.random()-.5)*74,c[m*3+1]=g.y+(Math.random()-.5)*30,c[m*3+2]=g.z+(Math.random()-.5)*26,h[m]=Math.random(),l[m]=.045+Math.random()*.055,u[m]=2+Math.random()*4}const b=new Pt;return b.setAttribute("position",new ee(c,3)),b.setAttribute("aPhase",new ee(h,1)),b.setAttribute("aRise",new ee(l,1)),b.setAttribute("aSize",new ee(u,1)),b.boundingSphere=new Zt(new z(0,300,-260),700),b},[e]),a=w.useMemo(()=>({uTime:{value:0},uColor:{value:new z(...ie(A.ember))}}),[]);return ae((s,i)=>{o.current&&(o.current.uniforms.uTime.value+=i)}),t.jsx("points",{geometry:n,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:$l,fragmentShader:Kl,uniforms:a,transparent:!0,depthWrite:!1,blending:it,fog:!1})})}function Xl({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(Ul,{quality:e}),t.jsx(Vl,{quality:e}),t.jsx(Ql,{quality:e})]})}const Zl=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
...
`,as={low:150,mid:380,high:620};function Jl({whirl:e,quality:o}){const n=w.useRef(),a=w.useRef(),s=w.useMemo(()=>{const c=as[o]??as.high,h=new Float32Array(c*3),l=new Float32Array(c),u=new Float32Array(c),b=new Float32Array(c),m=new Float32Array(c),g=new Float32Array(c);for(let f=0;f<c;f++)l[f]=Math.random()*Math.PI*2,u[f]=Math.random(),b[f]=.05+Math.random()*.05,m[f]=3+Math.random()*6,g[f]=Math.random();const x=new Pt;return x.setAttribute("position",new ee(h,3)),x.setAttribute("aAngle",new ee(l,1)),x.setAttribute("aPhase",new ee(u,1)),x.setAttribute("aRate",new ee(b,1)),x.setAttribute("aSize",new ee(m,1)),x.setAttribute("aJitter",new ee(g,1)),x.boundingSphere=new Zt(new z(e.x,0,e.z),e.r*1.6+40),x},[o,e]),i=w.useMemo(()=>({uTime:{value:0},uCentre:{value:new sa(e.x,e.z)},uR:{value:e.r},uDepth:{value:e.depth},uDir:{value:e.dir},uColor:{value:new z(...ie(X.foam))},uGain:{value:1}}),[e]);return ae((c,h)=>{const l=n.current?.uniforms;if(!l)return;l.uTime.value+=h;const u=Math.hypot(c.camera.position.x-e.x,c.camera.position.z-e.z);l.uGain.value=1-R.smoothstep(u,1600,2400),a.current&&(a.current.visible=l.uGain.value>.02)}),t.jsx("points",{ref:a,geometry:s,renderOrder:2,children:t.jsx("shaderMaterial",{ref:n,vertexShader:Zl,fragmentShader:ql,uniforms:i,transparent:!0,depthWrite:!1,blending:it,fog:!1})})}function ec({quality:e="high"}){const o=xe(n=>n.camera);return ae(()=>{let n=0;for(const a of Ue){const s=Math.hypot(o.position.x-a.x,o.position.z-a.z);n=Math.max(n,1-R.smoothstep(s,a.r*.3,a.r*2.2))}y.whirlNear+=(n-y.whirlNear)*.05}),t.jsx(t.Fragment,{children:Ue.map((n,a)=>t.jsx(Jl,{whirl:n,quality:e},a))})}const V={rev:0,chain:null,step:0,hull:1,grip:0,clock:0,banner:null,done:!1,hits:0},uo={helm:[{text:"PASS THE OUTER GATE",hint:"The island’s marker, alone in open water. Straight through it.",test:e=>e.z<ho-60},{text:"HOLD THE FAIRWAY",hint:"Whirlpools both flanks — the middle is the only clean water.",test:e=>e.toGate<420*H},{text:"RUN THE TORII",hint:"Between the columns — the batteries cannot depress that far.",test:e=>e.z<Ut-40},{text:"THREAD THE NECK",hint:"The walls close to a hundred metres. Mind your helm.",test:e=>e.z<120*H},{text:"MOOR AT THE PORT",hint:"Under the burning face. Come in slow.",test:e=>e.moored}],sub:[{text:"FORM UP WITH THE CAPTAINS",hint:"Surface between the Thousand Sunny and the Victoria Punk.",test:e=>{if(e.depth>12)return!1;const o=$a("straw-hats"),n=$a("kid");if(!o||!n)return!0;const a=(o.x+n.x)/2,s=(o.z+n.z)/2,i=Math.hypot(o.x-n.x,o.z-n.z);return Math.hypot(e.x-a,e.z-s)<Math.max(160,i*.75)}},{text:"TAKE HER DOWN",hint:"Below thirty-five metres the maelstroms cannot reach you.",test:e=>e.depth>35},{text:"RUN UNDER THE BACK-DOOR MAELSTROM",hint:"Straight through where the surface is turning. Stay deep.",test:e=>{const o=xi("back-door");return Math.hypot(e.x-o.x,e.z-o.z)<o.r*1.1&&e.depth>30}},{text:"FIND THE FJORD",hint:"North-east flank, a crack in the cliffs. It is not on any chart.",test:e=>e.toRear<420},{text:"SURFACE IN THE COVE",hint:"Blow ballast. The back door is above you.",test:e=>e.toRear<Y.pool*1.3&&e.depth<3}],foot:[{text:"GET INSIDE THE SKULL",hint:"The mouth above the port, or the gate at the back of the cove.",test:e=>e.area==="hall"},{text:"CROSS THE LIVE FLOOR",hint:"The stage is at the far end, under the keep.",test:e=>e.area==="hall"&&e.lz!=null&&e.lz<40},{text:"CLIMB TO THE STAGE",hint:"The vermilion ramps either side of the approach.",test:e=>e.fy!=null&&e.fy>60},{text:"TAKE THE ROOF",hint:"The stair tower on the east flank goes all the way up.",test:e=>e.fy!=null&&e.fy>230}]},tc=e=>uo[e]?uo[e].length:0,oc=()=>V.chain&&uo[V.chain]?uo[V.chain][V.step]??null:null;function Vn(e){V.chain=uo[e]?e:null,V.step=0,V.hull=1,V.grip=0,V.clock=0,V.done=!1,V.banner=null,V.rev++}function pn(e,o,n=3.4){V.banner={text:e,sub:o,until:V.clock+n},V.rev++}function Kt(e,o){V.hull<=0||(V.hull=Math.max(0,V.hull-e),V.hits++,V.hull<=0?pn("HULL BREACHED","She is going down — the raid goes on without you",5):o&&e>.04&&pn(o,null,2.2),V.rev++)}function zr(e,o){if(V.clock+=e,V.banner&&V.clock>V.banner.until&&(V.banner=null,V.rev++),!V.chain||V.done||!o)return;const n=uo[V.chain],a=n[V.step];if(!a)return;let s=!1;try{s=!!a.test(o)}catch{s=!1}s&&(V.step++,V.step>=n.length?(V.done=!0,pn("OBJECTIVE COMPLETE",nc[V.chain]??"",6)):pn(n[V.step].text,n[V.step].hint,3.6),V.rev++)}const nc={helm:"Moored under the face. The alliance is ashore.",sub:"Surfaced at the back door, unseen. Law would approve.",foot:"The roof of the demon castle. The whole bay is below you."};function Tr(e,{danger:o,headingX:n,headingZ:a,toCentreX:s,toCentreZ:i,speed:c,throttle:h}){if(o<=.001)return V.grip=Math.max(0,V.grip-e*.5),V.grip;const l=Math.hypot(s,i)||1,u=-s/l,b=-i/l,m=n*u+a*b,g=Math.min(1,Math.abs(c)/22),x=o*.42,f=Math.max(0,m)*g*(.35+.45*Math.min(1,Math.abs(h)));return V.grip=Math.max(0,Math.min(1,V.grip+(x-f)*e)),V.grip}const ss=24,En=on.safe,rs=on.range,yo=2.1,ac=1.5,is=22,sc=[Ut,ho],rc=new ut,Rn=new z,ls=new Mt,An=new z;function ic({quality:e="high"}){const o=w.useRef(),n=w.useMemo(()=>Array.from({length:ss},()=>({live:!1,x:0,z:0,y0:0,t:0})),[]),a=w.useRef(0),s=w.useMemo(()=>{const i=new er(.55,1,1,e==="low"?6:10,1,!0);return i.translate(0,.5,0),i},[e]);return ae((i,c)=>{const h=o.current;if(!h)return;const l=Math.min(c,.05),u=y.helm;if(y.helmActive&&u&&!u.onFoot&&!u.sub&&!u.moored){let g=null,x=1/0;for(const f of sc){const p=Math.hypot(u.x,u.z-f);p<En||p>rs||p<x&&(x=p,g=f)}if(g!==null&&(a.current-=l,a.current<=0)){const f=1-R.clamp((x-En)/(rs-En),0,1);a.current=R.lerp(4.5,1.9,f);const p=n.find(d=>!d.live);if(p){const d=yo*.55,v=R.lerp(230,105,f);p.x=u.x+Math.sin(u.heading)*u.speed*d+(Math.random()-.5)*v,p.z=u.z+Math.cos(u.heading)*u.speed*d+(Math.random()-.5)*v,p.y0=210+Math.random()*60,p.t=0,p.live=!0}}}let m=0;for(const g of n){if(!g.live)continue;const x=g.t;if(g.t+=l,g.t<yo){const f=g.t/yo;Rn.set(g.x,g.y0*(1-f*f),g.z),An.set(2.2,9,2.2)}else{if(x<yo){const d=Math.hypot(g.x-u.x,g.z-u.z);d<is&&Kt(.03*(1-d/is)+.008,"HIT — SHOT THROUGH THE RIGGING"),y.splash+=1}const f=(g.t-yo)/ac;if(f>=1){g.live=!1;continue}const p=Math.min(1,f*4);Rn.set(g.x,dt(g.x,g.z,y.t,1).y-4,g.z),An.set(11+f*9,78*p*(1-f*f*.75),11+f*9)}ls.identity(),h.setMatrixAt(m,rc.compose(Rn,ls,An)),m++}h.count=m,h.instanceMatrix.needsUpdate=!0,h.visible=m>0}),t.jsx("instancedMesh",{ref:o,args:[s,void 0,ss],frustumCulled:!1,renderOrder:2,visible:!1,children:t.jsx("meshBasicMaterial",{color:X.foam,transparent:!0,opacity:.42,depthWrite:!1,toneMapped:!1,blending:it,side:Be})})}const lc=`
  uniform float uTime;
  uniform vec3  uCam;
  uniform float uBox;
  attribute float aSpeed;
...
`,cs={low:700,mid:1800,high:3200},Do=260;function hc({quality:e}){const o=w.useRef(),n=w.useRef(),a=xe(c=>c.camera),s=w.useMemo(()=>{const c=cs[e]??cs.high,h=new Float32Array(c*3),l=new Float32Array(c),u=new Float32Array(c),b=new Float32Array(c);for(let g=0;g<c;g++)h[g*3]=Math.random()*Do,h[g*3+1]=Math.random()*Do,h[g*3+2]=Math.random()*Do,l[g]=.5+Math.random()*1.4,u[g]=1.2+Math.random()*3.2,b[g]=Math.random();const m=new Pt;return m.setAttribute("position",new ee(h,3)),m.setAttribute("aSpeed",new ee(l,1)),m.setAttribute("aSize",new ee(u,1)),m.setAttribute("aPhase",new ee(b,1)),m.boundingSphere=new Zt(new z,1e6),m},[e]),i=w.useMemo(()=>({uTime:{value:0},uCam:{value:new z},uBox:{value:Do},uColor:{value:new z(...ie("#cfeee6"))},uGain:{value:0}}),[]);return ae((c,h)=>{const l=o.current?.uniforms;l&&(l.uTime.value+=h,l.uCam.value.copy(a.position),l.uGain.value=y.underwater,n.current&&(n.current.visible=y.underwater>.02))}),t.jsx("points",{ref:n,geometry:s,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:o,vertexShader:lc,fragmentShader:cc,uniforms:i,transparent:!0,depthWrite:!1,fog:!1})})}const dc=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
  uniform float uDir;
...
`,hs={low:260,mid:700,high:1300},pc=`
  varying vec2 vUv;
  varying vec3 vWorld;
  void main() {
    vUv = uv;
...
`,ds=1100,us={low:[4,9],mid:[6,13],high:[8,18]};function mc({whirl:e,quality:o="high"}){const n=w.useRef(),a=w.useRef(),s=xe(h=>h.camera),i=w.useMemo(()=>{const h=o==="low"?24:o==="mid"?34:48,l=new er(e.r*1.02,e.r*.07,ds,h,6,!0);return l.translate(e.x,-ds/2-3,e.z),l.computeBoundingSphere(),l},[e,o]),c=w.useMemo(()=>({uTime:{value:0},uDir:{value:e.dir},uGain:{value:0},uColor:{value:new z(...ie(X.foam))},uDeep:{value:new z(...ie(X.underGlow))},uCameraPos:{value:new z},uFogDensity:{value:.0062},uFogColor:{value:new z(...ie(X.underHaze))}}),[e]);return ae((h,l)=>{const u=n.current?.uniforms;if(!u)return;u.uTime.value+=l,u.uCameraPos.value.copy(h.camera.position),u.uFogDensity.value=h.scene.fog?.density??.0062;const b=h.scene.fog?.color;b&&u.uFogColor.value.set(b.r,b.g,b.b);const m=Math.hypot(s.position.x-e.x,s.position.z-e.z),[g,x]=us[o]??us.high,f=1-R.smoothstep(m,e.r*g,e.r*x);u.uGain.value+=(y.underwater*f-u.uGain.value)*Math.min(1,l*4),a.current&&(a.current.visible=u.uGain.value>.012)}),t.jsx("mesh",{ref:a,geometry:i,renderOrder:2,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:pc,fragmentShader:fc,uniforms:c,transparent:!0,depthWrite:!1,side:Be,blending:it,fog:!1})})}function gc({whirl:e,quality:o}){const n=w.useRef(),a=w.useRef(),s=xe(h=>h.camera),i=w.useMemo(()=>{const h=hs[o]??hs.high,l=new Float32Array(h*3),u=new Float32Array(h),b=new Float32Array(h),m=new Float32Array(h),g=new Float32Array(h),x=new Float32Array(h);for(let p=0;p<h;p++)u[p]=Math.random()*Math.PI*2,b[p]=Math.random(),m[p]=.07+Math.random()*.1,g[p]=.12+Math.pow(Math.random(),1.8)*.5,x[p]=2+Math.random()*5;const f=new Pt;return f.setAttribute("position",new ee(l,3)),f.setAttribute("aAngle",new ee(u,1)),f.setAttribute("aPhase",new ee(b,1)),f.setAttribute("aRate",new ee(m,1)),f.setAttribute("aRadius",new ee(g,1)),f.setAttribute("aSize",new ee(x,1)),f.boundingSphere=new Zt(new z(e.x,-180,e.z),e.r+260),f},[o,e]),c=w.useMemo(()=>({uTime:{value:0},uCentre:{value:new sa(e.x,e.z)},uR:{value:e.r},uDir:{value:e.dir},uDepth:{value:340},uColor:{value:new z(...ie(X.underGlow))},uGain:{value:0}}),[e]);return ae((h,l)=>{const u=n.current?.uniforms;if(!u)return;u.uTime.value+=l;const b=Math.hypot(s.position.x-e.x,s.position.z-e.z),m=1-R.smoothstep(b,e.r*1.2,e.r*4);u.uGain.value=y.underwater*m,a.current&&(a.current.visible=u.uGain.value>.015)}),t.jsx("points",{ref:a,geometry:i,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:dc,fragmentShader:uc,uniforms:c,transparent:!0,depthWrite:!1,blending:it,fog:!1})})}function Er(e){if(typeof document>"u")return null;const o=document.createElement("canvas");o.width=o.height=128;const n=o.getContext("2d");n.fillStyle="#fff",e(n);const a=new Xt(o);return a.needsUpdate=!0,a}const ps=Er(e=>{e.beginPath(),e.moveTo(64,16),e.bezierCurveTo(92,22,122,58,116,78),e.bezierCurveTo(104,74,84,62,70,60),e.lineTo(68,120),e.lineTo(60,120),e.lineTo(58,60),e.bezierCurveTo(44,62,24,74,12,78),e.bezierCurveTo(6,58,36,22,64,16),e.closePath(),e.fill()}),xc=Er(e=>{const o=e.createRadialGradient(64,44,4,64,52,46);o.addColorStop(0,"rgba(255,255,255,1)"),o.addColorStop(.55,"rgba(255,255,255,0.55)"),o.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=o,e.beginPath(),e.ellipse(64,46,34,28,0,Math.PI,0),e.bezierCurveTo(96,62,84,70,64,68),e.bezierCurveTo(44,70,32,62,30,46),e.closePath(),e.fill(),e.strokeStyle="rgba(255,255,255,0.5)",e.lineCap="round";for(let n=0;n<7;n++){const a=38+n*9;e.lineWidth=3.2-Math.abs(n-3)*.5,e.beginPath(),e.moveTo(a,64),e.quadraticCurveTo(a+(n%2?7:-7),92,a+(n%2?-4:4),120),e.stroke()}}),fs={low:0,mid:5,high:11},st=420;function bc({quality:e="high"}){const o=w.useRef(),n=xe(h=>h.camera),a=fs[e]??fs.high,s=w.useMemo(()=>Array.from({length:a},(h,l)=>{const u=l%3===2;return{jelly:u,home:[l*97.13%1*st,l*41.77%1*st,l*63.31%1*st],r:u?8+l*29.7%1*18:46+l*29.7%1*90,rate:u?.02+l*17.3%1*.03:.045+l*17.3%1*.055,phase:l*53.9%1*Math.PI*2,size:u?9+l*71.1%1*13:22+l*71.1%1*26}}),[a]),i=w.useRef([]),c=(h,l)=>(h%l+l)%l;return ae((h,l)=>{const u=o.current;if(!u)return;const b=1-R.smoothstep(y.depthBelow,120,330),m=R.smoothstep(y.depthBelow,90,260),g=y.underwater*Math.max(b,m);if(u.visible=g>.02,!u.visible)return;const x=y.t;for(let f=0;f<s.length;f++){const p=s[f],d=i.current[f];if(!d)continue;const v=p.phase+x*p.rate,j=p.home[0]+Math.cos(v)*p.r,S=p.home[1]+Math.sin(v*.7)*p.r*.18,k=p.home[2]+Math.sin(v)*p.r,E=n.position.x+c(j-n.position.x+st/2,st)-st/2,r=n.position.y+c(S-n.position.y+st/2,st)-st/2,T=n.position.z+c(k-n.position.z+st/2,st)-st/2;d.position.set(E,r,T);const C=1+Math.sin(x*(.5+p.rate*4)+p.phase)*.16;d.scale.set(p.size*C,p.size,1);const P=Math.hypot(E-n.position.x,r-n.position.y,T-n.position.z),M=1-R.smoothstep(P,st*.24,st*.5),G=p.jelly?m:b;d.material.opacity=y.underwater*G*M*(p.jelly?.62:.5)}}),!a||!ps?null:t.jsx("group",{ref:o,visible:!1,children:s.map((h,l)=>t.jsx("sprite",{ref:u=>i.current[l]=u,renderOrder:2,children:t.jsx("spriteMaterial",{map:h.jelly?xc:ps,color:h.jelly?X.underGlow:X.abyss,transparent:!0,opacity:0,depthWrite:!1,blending:h.jelly?it:ai,fog:!1})},l))})}function wc({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(hc,{quality:e}),t.jsx(Mc,{quality:e}),t.jsx(bc,{quality:e}),Ue.map((o,n)=>t.jsx(gc,{whirl:o,quality:e},n)),Ue.map((o,n)=>t.jsx(mc,{whirl:o,quality:e},`w${n}`))]})}const Ho=260,ms={low:0,mid:90,high:220},yc=`
  uniform float uTime;
  uniform vec3 uCam;
  uniform float uBox;
  uniform float uGain;
...
`+(D.maelstrom>.2?"⚠ MAELSTROM — HARD OVER, FULL AHEAD":D.moored?"MOORING":D.aground>.3?"AGROUND — HELM OVER":D.underFire?`⚠ UNDER FIRE — STRAIGHT FOR THE ARCH    GATE ${Math.round(D.toGate)}m`:D.drift>.62?`MAKING LEEWAY — EASE THE HELM    GATE ${Math.round(D.toGate)}m`:`GATE ${Math.round(D.toGate)}m`)}}if(me.current){const D=oc(),re=tc(V.chain);me.current.textContent=V.done?"✔ OBJECTIVE COMPLETE":D?`▸ ${V.step+1}/${re}  ${D.text}`:"",me.current.style.color=V.done?"#8fe0a0":"#ffd9cf"}if(ue.current){const D=Math.max(0,Math.min(1,V.hull)),re=Math.max(0,Math.min(1,V.grip)),Oe=J=>{const Te=Math.round(J*12);return"█".repeat(Te)+"·".repeat(12-Te)},q=D>.6?"#8fe0a0":D>.3?"#ffc46b":"#ff6b5a",ne=re>.66?"#ff6b5a":re>.33?"#ffc46b":"rgba(255,255,255,0.45)";ue.current.innerHTML=`<span style="color:${q}">HULL ${Oe(D)}</span>`+(re>.02?`<span style="color:${ne};margin-left:14px">VORTEX ${Oe(re)}</span>`:"")}if(Le.current){const D=V.banner,re=Le.current;D&&re.dataset.text!==D.text&&(re.dataset.text=D.text,re.dataset.until=String(Me+b0),re.innerHTML=`<div class="og-banner-main">${D.text}</div>`+(D.sub?`<div class="og-banner-sub">${D.sub}</div>`:""),re.style.animation="none",re.offsetWidth,re.style.animation=""),D||(re.dataset.text="");const Oe=Number(re.dataset.until||0);re.style.opacity=re.dataset.text&&Me<Oe?"1":"0"}u&&te.current?(ct++,Ge+=Me-je,je=Me,Ge>400&&(te.current.textContent=`${Math.round(ct*1e3/Ge)} fps · shelter ${C.shelter.toFixed(2)} · fog ${(C.fog*1e4).toFixed(1)}e-4 · flash ${C.flash.toFixed(2)}`,Ge=0,ct=0)):je=Me};return _=requestAnimationFrame(ft),()=>cancelAnimationFrame(_)},[C,u]);const Z={opacity:O?.16:1,transform:O?"translateY(6px)":"none",transition:"opacity .5s ease, transform .5s ease"},be=[{key:"rails",on:!i,label:i?"FREE LOOK":"ON RAILS",title:"Take the camera off rails and look around",click:m,cinematicOnly:!0},{key:"helm",on:v==="helm",label:v==="helm"?"LEAVE HELM":"TAKE THE HELM",title:"Take the helm and sail the approach yourself",click:()=>j(v==="helm"?"off":"helm")},{key:"deck",on:!1,label:"WALK THE DECK",title:"Step back from the wheel and walk the deck as your pirate — she sails on",click:()=>{C.footSpawn="deck",j("foot")},helmOnly:!0},{key:"sub",on:v==="sub",label:v==="sub"?"LEAVE THE TANG":"DIVE THE POLAR TANG",title:"Dive under the maelstroms and take the back way in",click:()=>j(v==="sub"?"off":"sub")},{key:"foot",on:v==="foot",label:"LEAVE DOME",title:"Back to the approach",click:()=>j("off"),footOnly:!0}],_e=_=>v==="foot"?t.jsx(Je,{on:!0,wide:!0,block:_,title:"Swap between Luffy and Zoro, in their Wano gear",onClick:()=>k?.(S==="zoro"?"luffy":"zoro"),children:S==="zoro"?"ZORO · 和":"LUFFY · 和"}):null,nt=_=>{if(!M||v==="foot")return null;const je=ga(v,E);return t.jsx(Je,{on:!0,wide:!0,block:_,title:`Take ${je.who}'s ship — the three of them are sailing abreast (Y)`,onClick:()=>T?.(),children:_?`⇄  ${je.name}`:`⇄ ${je.who}`})},lt=(_,je)=>t.jsx(Je,{on:_.on,onClick:_.click,title:_.title,wide:!0,block:je,children:_.label},_.key),kt=_=>M?t.jsxs(t.Fragment,{children:[t.jsx(Je,{on:K.comfort>.01,wide:!0,block:_,title:"Steady the camera: less roll, less shake, less lens movement. The fix if the motion is making you queasy.",onClick:Sc,children:K.comfort>.9?"COMFORT · FULL":K.comfort>.01?"COMFORT · SOME":"COMFORT · OFF"}),t.jsx(Je,{on:K.freeCam,wide:!0,block:_,title:"Free camera: the view stays where you put it instead of swinging back behind the ship (V)",onClick:()=>lo("freeCam"),children:K.freeCam?"CAM · FREE":"CAM · CHASE"}),t.jsx(Je,{on:Math.abs(K.lookSens-1)>.01,wide:!0,block:_,title:"How far a drag turns the view",onClick:zc,children:`LOOK ${K.lookSens.toFixed(2).replace(/0$/,"")}×`}),t.jsx(Je,{on:K.invertY,wide:!0,block:_,title:"Invert the vertical look axis",onClick:()=>lo("invertY"),children:K.invertY?"Y · INVERTED":"Y · NORMAL"})]}):null,Qe=()=>M?t.jsx(Je,{on:!K.hud,title:"Hide the readouts, the chart and the objective — just the picture (H)",onClick:()=>lo("hud"),children:K.hud?"◱":"◰"}):null,pt=_=>t.jsxs(t.Fragment,{children:[!M&&t.jsxs(t.Fragment,{children:[t.jsx(Je,{on:s,onClick:b,title:"Play / pause the cinematic",block:_,children:s?_?"❙❙  PAUSE":"❙❙":_?"▶  PLAY":"▶"}),[.5,1,2].map(je=>t.jsxs(Je,{on:c===je,onClick:()=>g(je),title:`${je}× speed`,block:_,children:[je,"×"]},je))]}),t.jsx(Je,{on:!1,onClick:f,title:"Restart from the open sea",block:_,children:_?"↺  RESTART":"↺"}),t.jsx(Je,{on:p,onClick:d,title:"Storm, taiko and a temple bell — all synthesised",block:_,children:p?_?"♪  SOUND ON":"♪":_?"♪̸  SOUND OFF":"♪̸"}),t.jsx(Je,{on:l!=="auto",wide:!0,block:_,title:"Render tier",onClick:()=>x(l==="auto"?"low":l==="low"?"mobile":l==="mobile"?"high":"auto"),children:l==="auto"?`AUTO · ${h.toUpperCase()}`:l.toUpperCase()})]});return t.jsxs(t.Fragment,{children:[!P&&t.jsxs(t.Fragment,{children:[[0,1].map(_=>t.jsx("div",{style:{position:"fixed",left:0,right:0,[_?"bottom":"top"]:0,height:We?Fn:0,background:"#05040a",zIndex:8,pointerEvents:"none",transition:"height .7s cubic-bezier(.6,0,.2,1)"}},_)),t.jsxs("div",{className:"og-tategaki",style:{opacity:M||L?0:1,transition:"opacity .6s ease"},children:["鬼ヶ島",t.jsx("span",{className:"og-tategaki-sub",children:"ONIGASHIMA"})]}),t.jsx("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 26px)",zIndex:10,pointerEvents:"none",animation:"ogCaption .85s cubic-bezier(.2,.9,.2,1) both",transition:"bottom .7s cubic-bezier(.6,0,.2,1)",maxWidth:"min(70vw, 620px)",display:M?"none":"block"},children:t.jsxs("div",{style:{display:"inline-block",borderLeft:`2px solid ${To}`,paddingLeft:12},children:[t.jsx("div",{style:{font:'700 clamp(15px, 2.5vw, 27px)/1.15 "Hiragino Mincho ProN", "Yu Mincho", Georgia, serif',letterSpacing:"0.07em",color:"#fff6f0",textShadow:"0 2px 22px rgba(0,0,0,0.95), 0 0 44px rgba(0,0,0,0.7)"},children:e?.title}),t.jsx("div",{style:{marginTop:5,font:"500 clamp(9px, 1.15vw, 12px)/1.5 ui-monospace, Menlo, monospace",letterSpacing:"0.19em",color:"rgba(255,225,215,0.66)",textShadow:"0 1px 12px rgba(0,0,0,0.95)"},children:e?.sub})]})},e?.id),t.jsx("div",{style:{position:"fixed",left:0,right:0,bottom:"var(--og-bottom)",height:2,zIndex:10,background:"rgba(255,255,255,0.08)",pointerEvents:"none",opacity:M?0:1,transition:"bottom .7s cubic-bezier(.6,0,.2,1), opacity .4s ease"},children:t.jsx("div",{ref:$,style:{height:"100%",background:`linear-gradient(90deg, ${To}, #ff9c2e)`,transformOrigin:"0 50%",transform:"scaleX(0)",boxShadow:`0 0 14px ${To}`}})}),t.jsx("div",{className:`og-chrome${M?"":" og-chrome-bottom"}`,style:{...M?{top:"calc(var(--og-top) + 14px)"}:{bottom:"calc(var(--og-bottom) + 22px)"},...Z},children:G?t.jsxs(t.Fragment,{children:[M&&t.jsx(Je,{on:!0,onClick:()=>j("off"),wide:!0,title:"Back to the cinematic",children:"✕ EXIT"}),Qe(),t.jsx(Je,{on:L,onClick:()=>W(_=>!_),title:"Menu",children:L?"✕":"☰"}),L&&t.jsxs("div",{className:"og-menu",children:[M&&t.jsxs(t.Fragment,{children:[_e(!0),nt(!0),kt(!0),t.jsx("div",{className:"og-menu-rule"})]}),be.filter(_=>!(_.cinematicOnly&&M)&&!(_.helmOnly&&v!=="helm")&&!(_.footOnly&&v!=="foot")).map(_=>lt(_,!0)),t.jsx("div",{className:"og-menu-rule"}),pt(!0)]})]}):t.jsxs(t.Fragment,{children:[Qe(),_e(!1),nt(!1),kt(!1),pt(!1),be.filter(_=>!(_.cinematicOnly&&M)&&!(_.helmOnly&&v!=="helm")&&!(_.footOnly&&v!=="foot")).map(_=>lt(_,!1))]})}),!M&&t.jsxs("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",top:"calc(var(--og-top) + 18px)",zIndex:10,font:"600 10px/1 ui-monospace, Menlo, monospace",letterSpacing:"0.3em",color:"rgba(255,255,255,0.4)",textShadow:"0 1px 10px #000",transition:"top .7s cubic-bezier(.6,0,.2,1)",...Z,pointerEvents:"none"},children:[i?`SHOT ${String(o+1).padStart(2,"0")} / ${String(n).padStart(2,"0")}`:"FREE LOOK · DRAG ORBIT · WASD FLY · 2-FINGER / SHIFT-DRAG PAN · PINCH ZOOM · R HOME",t.jsx("span",{style:{opacity:.5},children:i?`  ·  ${Math.round(a)}s`:""})]}),M&&K.hud&&t.jsxs("div",{className:"og-instruments",children:[t.jsx("div",{ref:me,className:"og-objective"}),t.jsx("div",{ref:se,className:"og-readout"}),t.jsx("div",{ref:ue,className:"og-gauges"}),t.jsx("div",{className:"og-keys",children:v==="helm"?"W/S THROTTLE · A/D RUDDER · SHIFT FLANK · X ENGINE LATCH · B BURST · T WALK THE DECK · DRAG LOOK · R RECENTRE · V FREE CAM · WHEEL ZOOM":v==="sub"?"W/S THROTTLE · A/D RUDDER · SPACE RISE · C DIVE · SHIFT FLANK · X LATCH · F SURFACE · P PERISCOPE · DRAG LOOK · R RECENTRE · V FREE CAM":S==="zoro"?"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J ONIGIRI · U TATSUMAKI · K YAKKODORI · L SANZEN · G FLASH · H ASURA · DRAG ORBIT":"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J PISTOL · U GATLING · K BAZOOKA · L GIGANT · G ROCKET · H HAKI · N GEAR 2 · I BALLOON · DRAG ORBIT"})]}),M&&K.hud&&t.jsx("div",{ref:Le,className:"og-banner"}),u&&t.jsx("div",{ref:te,style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 96px)",zIndex:14,font:"500 10px/1 ui-monospace, Menlo, monospace",color:"#7fe0a0",background:x0,padding:"5px 8px",borderRadius:3,pointerEvents:"none"}})]}),t.jsx("style",{children:`
      ...
      `})]})}const R0=168,A0=122,Ks="(max-width: 860px), (max-height: 520px)",Gn=1950,Qs={x:0,z:340},tt={paper:"rgba(30,24,26,0.86)",sea:"rgba(16,14,24,0.55)",ring:"#6b5c48",land:"#3a2f28",skull:"#c2a578",skullInk:"#241c18",fairway:"rgba(226,198,150,0.10)",gate:"#d63420",port:"#f0ad50",rear:"#8fd4f2",whirl:"rgba(150,180,225,0.62)",you:"#ffe6a0",grid:"rgba(226,198,150,0.09)"},Yr=e=>({px:o=>(o-Qs.x)/Gn*(e/2)+e/2,pz:o=>(o-Qs.z)/Gn*(e/2)+e/2,pl:o=>o/Gn*(e/2)});function I0(e,o,n){const{px:a,pz:s,pl:i}=Yr(n);e.save(),e.scale(o,o),e.clearRect(0,0,n,n),e.fillStyle=tt.paper,e.fillRect(0,0,n,n),e.fillStyle=tt.sea,e.fillRect(0,0,n,n),e.strokeStyle=tt.grid,e.lineWidth=1;for(let m=1;m<5;m++){const g=m/5*n;e.beginPath(),e.moveTo(g,0),e.lineTo(g,n),e.moveTo(0,g),e.lineTo(n,g),e.stroke()}e.fillStyle=tt.fairway,e.fillRect(a(-tn.halfWidth),0,i(tn.halfWidth*2),n),e.strokeStyle=tt.ring,e.lineWidth=i(vt*.34),e.beginPath(),e.arc(a(pe.x),s(pe.z),i(vt),Math.PI*.34,Math.PI*.66,!0),e.stroke();const c=i(F.r*F.squash[0]),h=i(F.r*F.squash[2]),l=a(F.x),u=s(F.z);e.fillStyle=tt.skull;for(const m of[-1,1])e.beginPath(),e.moveTo(l+m*c*.62,u-h*.45),e.quadraticCurveTo(l+m*c*1.28,u-h*1.15,l+m*c*1.5,u-h*1.72),e.quadraticCurveTo(l+m*c*1.02,u-h*1.05,l+m*c*.3,u-h*.62),e.closePath(),e.fill();e.beginPath(),e.ellipse(l,u,c,h,0,0,Math.PI*2),e.fill(),e.fillStyle=tt.skullInk;for(const m of[-1,1])e.beginPath(),e.ellipse(l+m*c*.38,u+h*.22,c*.19,h*.15,0,0,Math.PI*2),e.fill();e.beginPath(),e.ellipse(l,u+h*.66,c*.26,h*.12,0,0,Math.PI*2),e.fill(),e.strokeStyle=tt.gate,e.lineWidth=1.4;for(const[m,g]of[[Ut,1],[ho,1.5]]){const x=i(95*H*g),f=s(m),p=x*.55;e.beginPath(),e.moveTo(a(0)-x*1.15,f-p*.5),e.lineTo(a(0)+x*1.15,f-p*.5),e.moveTo(a(0)-x*.92,f),e.lineTo(a(0)+x*.92,f),e.moveTo(a(0)-x*.86,f-p*.55),e.lineTo(a(0)-x,f+p*.6),e.moveTo(a(0)+x*.86,f-p*.55),e.lineTo(a(0)+x,f+p*.6),e.stroke()}for(const m of Ue){const g=a(m.x),x=s(m.z),f=i(m.r);e.strokeStyle=tt.whirl,e.lineWidth=1,e.beginPath(),e.arc(g,x,f,0,Math.PI*2),e.stroke(),e.lineWidth=1.1;for(const p of[0,Math.PI]){e.beginPath();for(let d=0;d<=22;d++){const v=d/22,j=p+m.dir*v*Math.PI*1.9,S=f*(1-v*.86),k=g+Math.cos(j)*S,E=x+Math.sin(j)*S;d?e.lineTo(k,E):e.moveTo(k,E)}e.stroke()}}const b=(m,g,x,f=2.6)=>{e.fillStyle=x,e.beginPath(),e.arc(a(m),s(g),f,0,Math.PI*2),e.fill()};b(Q.x,Q.z,tt.port),b(de.x,de.z,tt.land,2),b(Y.gate.x,Y.gate.z,tt.rear),e.restore()}function C0({mode:e}){const o=w.useRef(),n=w.useRef(),a=typeof window>"u"?1:Math.min(2,window.devicePixelRatio||1),[s,i]=w.useState(()=>typeof window<"u"&&window.matchMedia(Ks).matches);w.useEffect(()=>{const b=window.matchMedia(Ks),m=()=>i(b.matches);return b.addEventListener?b.addEventListener("change",m):b.addListener(m),()=>{b.removeEventListener?b.removeEventListener("change",m):b.removeListener(m)}},[]);const[c,h]=w.useState(!0),l=s?A0:R0,u=w.useMemo(()=>{if(typeof document>"u")return null;const b=document.createElement("canvas");return b.width=l*a,b.height=l*a,I0(b.getContext("2d"),a,l),b},[a,l]);return w.useEffect(()=>{if(!n.current||!u||!c)return;const{px:b,pz:m}=Yr(l),g=n.current.getContext("2d");let x;const f=()=>{x=requestAnimationFrame(f);const p=y.helm;if(g.setTransform(1,0,0,1,0,0),g.clearRect(0,0,l*a,l*a),g.drawImage(u,0,0),!p||p.x===void 0)return;g.save(),g.scale(a,a);const d=b(p.x),v=m(p.z),j=p.sub&&p.depth>4;g.translate(d,v),p.heading!==void 0?(g.rotate(Math.PI-p.heading),g.beginPath(),g.moveTo(0,-5.5),g.lineTo(3.4,4),g.lineTo(0,2),g.lineTo(-3.4,4),g.closePath()):(g.beginPath(),g.arc(0,0,3,0,Math.PI*2)),g.fillStyle=j?"rgba(0,0,0,0)":tt.you,g.strokeStyle=tt.you,g.lineWidth=1.2,g.fill(),g.stroke(),g.restore(),j&&(g.save(),g.scale(a,a),g.fillStyle=tt.rear,g.font="600 9px ui-monospace, SFMono-Regular, Menlo, monospace",g.textAlign="right",g.fillText(`${Math.round(p.depth)}m DOWN`,l-6,l-6),g.restore())};return f(),()=>cancelAnimationFrame(x)},[u,a,e,c,l]),e==="off"?null:c?t.jsxs("div",{className:"og-minimap",style:{position:"fixed",left:14,bottom:14,zIndex:12,width:l,height:l,borderRadius:4,overflow:"hidden",border:"1px solid rgba(255,255,255,0.16)",backdropFilter:"blur(9px)",WebkitBackdropFilter:"blur(9px)",pointerEvents:"none"},children:[t.jsx("canvas",{ref:n,width:l*a,height:l*a,style:{width:l,height:l,display:"block"}}),t.jsx("div",{style:{position:"absolute",top:4,left:6,font:"600 8px/1 ui-monospace, SFMono-Regular, Menlo, monospace",letterSpacing:"0.16em",color:"rgba(255,255,255,0.5)"},children:"鬼ヶ島"}),t.jsx("button",{className:"og-map-close",onClick:()=>h(!1),"aria-label":"Hide the chart",children:"✕"}),t.jsx("canvas",{ref:o,style:{display:"none"}}),t.jsx("style",{children:Xs})]}):t.jsxs(t.Fragment,{children:[t.jsx("button",{className:"og-map-tab",title:"Show the chart",onClick:()=>h(!0),"aria-label":"Show the chart",children:"鬼ヶ島 CHART"}),t.jsx("style",{children:Xs})]})}const Xs=`
...
`,Zs={low:{dpr:[1,1.1],shadows:!1,aa:!1,shadowMap:512,segments:110,shadowEvery:24,scene:"low"},mobile:{dpr:[1,1.5],shadows:!0,aa:!1,shadowMap:1024,segments:168,shadowEvery:16,scene:"mid"},high:{dpr:[1,2],shadows:!0,aa:!0,shadowMap:2048,segments:240,shadowEvery:10,scene:"high"}};function P0(){if(typeof navigator>"u")return"high";const e=navigator.hardwareConcurrency||4,o=typeof navigator.deviceMemory=="number"?navigator.deviceMemory:null;return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&/Macintosh/.test(navigator.userAgent)?e<=3||o!==null&&o<=2?"low":"mobile":e<=2||o!==null&&o<=2?"low":"high"}const L0=null;function D0(){const e=w.useMemo(()=>!1,[]),[o]=w.useState(P0),[n,a]=w.useState("auto"),s=n==="auto"?o:n,i=Zs[s]??Zs.high;w.useEffect(()=>{Qi(i.scene!=="low")},[i.scene]),w.useMemo(()=>tr(i.scene),[i.scene]),w.useMemo(()=>Ec(),[]),w.useEffect(()=>Ac(),[]);const c=w.useMemo(()=>typeof navigator>"u"?!1:typeof location<"u"&&new URLSearchParams(location.search).has("touch")?!0:navigator.maxTouchPoints>0,[]),[h,l]=w.useState(0),[u,b]=w.useState(!0),[m,g]=w.useState(!0),[x,f]=w.useState(1),[p,d]=w.useState(gs[0]),[v,j]=w.useState(0),[S,k]=w.useState(qh),[E,r]=w.useState(()=>{if(typeof location>"u")return"off";const Z=new URLSearchParams(location.search).get("mode");return Z==="helm"||Z==="sub"||Z==="foot"?Z:"off"}),[T,C]=w.useState(()=>typeof location>"u"?"luffy":new URLSearchParams(location.search).get("crew")==="zoro"?"zoro":"luffy"),[P,M]=w.useState(()=>typeof location>"u"?"sunny":new URLSearchParams(location.search).get("ship")==="punk"?"punk":"sunny");w.useEffect(()=>{if(!S)return;const Z=()=>{Pn(),Cn(!0)};for(const be of["pointerdown","keydown","touchstart"])window.addEventListener(be,Z,{once:!0,passive:!0});return()=>{for(const be of["pointerdown","keydown","touchstart"])window.removeEventListener(be,Z)}},[S]);const G=w.useCallback(()=>{k(Z=>{const be=!Z;return be&&Pn(),Cn(be),be})},[]),[L,W]=w.useState(()=>typeof location<"u"&&new URLSearchParams(location.search).has("enter")),K=w.useCallback(Z=>{S&&(Pn(),Cn(!0)),Z==="off"?(y.jumpTo=0,b(!0),g(!0)):r(Z),W(!0)},[S]),[fe,O]=w.useState(()=>ve.hud);w.useEffect(()=>xa(Z=>O(Z.hud)),[]);const[$,te]=w.useState(!1),se=w.useRef(!0);w.useEffect(()=>{if(qn(),se.current){se.current=!1;return}te(!0);const Z=setTimeout(()=>te(!1),210);return()=>clearTimeout(Z)},[E]);const me=w.useCallback(()=>{const Z=ga(E,P);qn(),M(Z.vessel),r(Z.mode)},[E,P]);w.useEffect(()=>{if(E==="off")return;let Z;const be=()=>{Z=requestAnimationFrame(be),I.swapQueued&&(I.swapQueued=!1,me())};return Z=requestAnimationFrame(be),()=>cancelAnimationFrame(Z)},[E,me]);const ue=w.useCallback((Z,be)=>{j(Z),d(be)},[]),Le=w.useCallback(()=>{Ki(),l(Z=>Z+1),b(!0),g(!0)},[]),We=w.useMemo(()=>typeof location<"u"&&new URLSearchParams(location.search).has("dev"),[]);return e?t.jsx(w.Suspense,{fallback:null,children:t.jsx(L0,{})}):t.jsxs(t.Fragment,{children:[t.jsx(Zr,{shadows:i.shadows,dpr:i.dpr,gl:{antialias:i.aa,powerPreference:"high-performance",toneMapping:ri,toneMappingExposure:di,preserveDrawingBuffer:!0},camera:{fov:52,near:1,far:8200,position:[-190,26,880]},frameloop:"always",children:t.jsx(w.Suspense,{fallback:null,children:t.jsx(g0,{quality:i.scene,budget:i,onRails:m,playing:u,speed:x,onShot:ue,mode:E,onMode:r,crew:T,vessel:P},h)})}),c&&L&&t.jsx(E0,{mode:E,crew:T,vessel:P,hud:fe,onSwap:me}),L&&fe&&t.jsx(C0,{mode:E}),t.jsx("div",{"aria-hidden":!0,style:{position:"fixed",inset:0,zIndex:30,background:"#05040a",pointerEvents:"none",opacity:$?1:0,transition:$?"opacity .2s ease-in":"opacity .42s ease-out"}}),!L&&t.jsx(k0,{onPick:K}),t.jsx(v0,{veiled:!L,shot:p,shotIndex:v,shotCount:gs.length,total:ta,playing:u,onRails:m,speed:x,tier:s,override:n,dev:We,onPlay:()=>b(Z=>!Z),onRailsToggle:()=>g(Z=>!Z),onSpeed:f,onQuality:a,onRestart:Le,audio:S,onAudio:G,mode:E,onMode:r,crew:T,onCrew:C,vessel:P,onVessel:M,onSwap:me,stage:y})]})}export{D0 as default};
