var or=Object.defineProperty;var nr=(e,o,n)=>o in e?or(e,o,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[o]=n;var os=(e,o,n)=>nr(e,typeof o!="symbol"?o+"":o,n);import{r as w,u as ne,j as t,d as ma,f as we,h as sr,i as ar}from"./vendor-C2HIMx-P.js";import{t as ve,c as j,aD as vn,au as Hn,d as _n,a5 as De,aJ as rr,f as ir,Y as ns,a0 as ss,ag as T,h as oe,aK as lr,ay as cr,az as to,aA as oo,aq as ga,R as hr,M as rt,o as mt,at as Dt,ax as bt,aL as no,aM as so,a4 as dr,a8 as Lt,ar as ao,av as xa,aC as ur,A as pr}from"./three-Zo_RlN_K.js";import{f as qt,m as wo,w as Ue,a as Ut,e as Et,P as fr,G as mr,S as gr,I as xr}from"./index-1EjGKgfc.js";const Z={skyHigh:"#140f2b",skyLow:"#3a2a5c",cloud:"#2a2244",cloudLit:"#6b3f5e",seaDeep:"#080d1c",seaShallow:"#16294a",foam:"#c8d6e8",rock:"#2b2f3f",rockLit:"#4c5468",snow:"#aebdd4",pine:"#16202c",bolt:"#e9a8ff",boltGlow:"#a855f7",haze:"#1d1936",abyss:"#04161f",underGlow:"#7fc9c0",underHaze:"#0a2e35"},E={furnace:"#fff1c4",ember:"#ff9c2e",emberDeep:"#c9411a",lantern:"#ff7a3c",lanternFar:"#ffb066",vermilion:"#d63420",vermilionDeep:"#7e1c14",rockWarm:"#6d3a2c",gilt:"#e8a33d",sakura:"#f2a8c4",timber:"#6b4b34"},Wo={dir:[.72,.52,-.44],col:"#f2e9cf"},Ft={sea:.00105,bay:48e-5,deepGrade:210},wr=1.15;function ie(e){const o=new ve(e);return[o.r,o.g,o.b]}const br=`
  varying vec3 vDir;
  void main() {
    vDir = position;
...
`;function vr({storm:e}){const o=w.useRef(),n=w.useMemo(()=>({uTime:{value:0},uHigh:{value:new j(...ie(Z.skyHigh))},uLow:{value:new j(...ie(Z.skyLow))},uCloud:{value:new j(...ie(Z.cloud))},uCloudLit:{value:new j(...ie(Z.cloudLit))},uEmber:{value:new j(...ie(E.ember))},uFlash:{value:0},uFlashColor:{value:new j(...ie(Z.boltGlow))},uFlashDir:{value:new j(0,.4,-1)},uGlow:{value:1},uMoonDir:{value:new j(...Wo.dir).normalize()},uMoonCol:{value:new j(...ie(Wo.col))},uUnder:{value:0},uUnderCol:{value:new j(...ie(Z.underHaze))}}),[]);return ne((s,i)=>{const a=o.current?.uniforms;a&&(a.uTime.value+=i,a.uFlash.value=e?.flash??0,e?.flashDir&&a.uFlashDir.value.copy(e.flashDir),a.uUnder.value=e?.underwater??0)}),t.jsxs("mesh",{frustumCulled:!1,renderOrder:-1,children:[t.jsx("sphereGeometry",{args:[1,32,20]}),t.jsx("shaderMaterial",{ref:o,vertexShader:br,fragmentShader:yr,uniforms:n,side:vn,depthWrite:!1,depthTest:!1,fog:!1})]})}const N=1.9,V=e=>e*N,de={x:0,z:V(-60)},ft=V(300),No=V(175),Mr=118,L={x:0,z:V(-402),r:V(215),baseY:300,squash:[1.18,1.04,.98]},mo=[[-.361,.301,.883],[.361,.301,.883]],Bn=[0,.02,.9998],Un=[0,-.419,.908];function Wn(e,o=1){const[n,s,i]=L.squash;return{x:L.x+e[0]*L.r*n*o,y:L.baseY+e[1]*L.r*s*o,z:L.z+e[2]*L.r*i*o}}const Ae=mo.map(e=>Wn(e)),he={...Wn(Un),halfWidth:74,height:62};Wn(Bn,.94);const Q={x:V(-152),y:4.5,z:V(-104),r:V(78)},as=2.35,Gt=[Math.sin(as),Math.cos(as)],U=(()=>{const e=ft+No*.35,o=de.x+Gt[0]*e,n=de.z+Gt[1]*e;return{x:o,z:n,pool:V(46),benchY:3.6,reach:V(560),gate:{x:o-Gt[0]*V(44),z:n-Gt[1]*V(44)},berth:{x:o+Gt[0]*V(12),z:n+Gt[1]*V(12)},dir:Gt}})(),jr=[{rank:1,role:"east-south",ang:.75,dist:V(730),r:V(146),depth:36,dir:-1,speed:33},{rank:2,role:"west-south",ang:-.75,dist:V(730),r:V(144),depth:35,dir:1,speed:33},{rank:3,role:"back-door",ang:2.18,dist:V(770),r:V(142),depth:40,dir:1,speed:34},{rank:4,role:"east",ang:1.35,dist:V(690),r:V(155),depth:40,dir:1,speed:35},{rank:5,role:"west",ang:-1.35,dist:V(690),r:V(150),depth:38,dir:-1,speed:34},{rank:6,role:"west-north",ang:-2.05,dist:V(765),r:V(150),depth:42,dir:1,speed:35}],Ne=[];function wa(e){const o=e==="low"?3:e==="mid"?5:7;Ne.length=0;for(const n of jr)n.rank>o||Ne.push({role:n.role,x:de.x+Math.sin(n.ang)*n.dist,z:de.z+Math.cos(n.ang)*n.dist,r:n.r,depth:n.depth,dir:n.dir,speed:n.speed});return Ne}const Sr=e=>Ne.find(o=>o.role===e)??Ne[0];wa("high");function ba(e,o,n=0){let s=0,i=0;const a=1-Xe(8,34,n);if(a<=0)return{vx:s,vz:i,danger:0};let c=0;for(const d of Ne){const h=e-d.x,p=o-d.z,g=Math.hypot(h,p);if(g>d.r*1.7||g<.001)continue;const f=g/d.r,m=1-Xe(1,1.6,f),l=d.speed*(f/.3)*Math.exp(1-f/.3)*.62*m,u=d.speed*.55*Math.exp(-f*f*2.6)*m+d.speed*.1*m,x=1/g;s+=(-p*x*l*d.dir-h*x*u)*a,i+=(h*x*l*d.dir-p*x*u)*a,c=Math.max(c,(1-Xe(.15,1.15,f))*a)}return{vx:s,vz:i,danger:c}}const Yo={x:0,halfWidth:V(96)},Pt=V(258),Jt=V(624),Vo={safe:260,range:1150},kr=0,Ho=V(1500),$o=e=>e<0?0:e>1?1:e;function zr(e,o,n=4){let s=0,i=1,a=1,c=0;for(let d=0;d<n;d++){const h=1-Math.abs(qt(e*a,o*a,1)*2-1);s+=h*h*i,c+=i,i*=.52,a*=2.07}return s/c}const Xe=(e,o,n)=>{const s=$o((n-e)/(o-e));return s*s*(3-2*s)};function Tr(e){if(e>V(430))return 1e4;const o=1-Xe(V(430),V(205),e),n=Xe(V(150),V(-30),e);return Yo.halfWidth+o*V(620)+n*V(300)}function Er(e){const o=(1-Math.cos(e))*.5,n=Math.sin(e);let s=Mr;return s+=o*190,s+=Math.max(0,n)*46,s-=Math.max(0,-n)*26,s}function re(e,o){const n=e-de.x,s=o-de.z,i=Math.hypot(n,s),a=Math.atan2(n,s),c=(i-ft)/No,d=Math.exp(-c*c*1.35)*Er(a),h=Math.max(0,i-ft-No*.55),p=-Math.pow(h/210,1.6)*175,g=Math.max(0,ft-No*.5-i),f=-Xe(0,150,g)*46,m=$o(d/60),l=(zr(e*.0052/N+13,o*.0052/N-21,4)-.42)*168*m,u=(qt(e*.0042/N+31,o*.0042/N-17,4)-.5)*84*m,x=(qt(e*.021-5,o*.021+9,3)-.5)*17*m;let v=d+p+f+l+u+x;const b=Tr(o),k=1-Xe(b,b+V(105),Math.abs(e-Yo.x)),z=1-Xe(V(-40),V(-190),o),r=k*z;v=v*(1-r)+Math.min(v,-34)*r;const M=Math.hypot(e-L.x,o-L.z);v+=Math.exp(-Math.pow(M/(L.r*1.55),2))*62;const F=(e-Q.x)/V(76),C=(o-Q.z)/V(58),S=(1-Xe(.72,1.18,Math.hypot(F,C)))*$o((v+34)/34);v=v*(1-S)+Q.y*S;const R=e-U.x,A=o-U.z;if(Math.abs(R)+Math.abs(A)<U.reach+V(140)){const B=Math.max(0,Math.min(U.reach,R*U.dir[0]+A*U.dir[1])),G=R-U.dir[0]*B,$=A-U.dir[1]*B,q=Math.hypot(G,$),ee=V(30)+B/U.reach*V(48),P=1-Xe(ee,ee+V(62),q);v=v*(1-P)+Math.min(v,-26)*P;const K=Math.hypot(R,A),ae=1-Xe(U.pool*.55,U.pool,K);v=v*(1-ae)+Math.min(v,-14)*ae;const H=(e-U.gate.x)/V(30),te=(o-U.gate.z)/V(24),be=1-Xe(.72,1.18,Math.hypot(H,te));v=v*(1-be)+U.benchY*be}return v}function Yn(e,o,n=3){const s=re(e+n,o)-re(e-n,o),i=re(e,o+n)-re(e,o-n),a=-s,c=2*n,d=-i,h=Math.hypot(a,c,d)||1;return[a/h,c/h,d/h]}function Rr(e,o,n=3){return Math.acos(Yn(e,o,n)[1])}function bo(e,o){const n=Xe(V(250),V(40),o),s=1-Xe(ft-V(40),ft+V(90),Math.hypot(e-de.x,o-de.z)),i=(1-Xe(V(60),V(170),Math.hypot(e-U.x,o-U.z)))*.85;return $o(Math.max(Math.min(n,s),i))}const ya=[{dir:[.1,-1],amp:9.4,len:187},{dir:[-.42,-.91],amp:4.3,len:97},{dir:[.71,-.7],amp:2.1,len:61},{dir:[-.86,-.51],amp:1.15,len:37}],Ar=Math.PI*2;function Ir(e,o,n){let s=0,i=0,a=0;for(const c of Ne){const d=e-c.x,h=o-c.z,p=Math.max(1,Math.hypot(d,h));if(p>c.r*1.75)continue;const g=p/c.r,f=Math.exp(-3*g*g);s-=c.depth*f;const m=c.depth*6*g*f/c.r;i+=m*(d/p),a+=m*(h/p);const l=Math.atan2(h,d),u=Math.sin(l*3*c.dir+g*14-n*2.2),x=g*Math.exp(1-g)*(1-Cr(g));s+=u*x*1.6}return{y:s,dx:i,dz:a}}function Cr(e){const o=Math.min(1,Math.max(0,(e-1)/.6));return o*o*(3-2*o)}function ut(e,o,n,s=1){let i=0,a=0,c=0;for(const h of ya){const p=Ar/h.len,g=Math.sqrt(9.81/p),f=Math.hypot(h.dir[0],h.dir[1]),m=h.dir[0]/f,l=h.dir[1]/f,u=p*(m*e+l*o-g*n),x=h.amp*s;i+=x*Math.sin(u);const v=x*p*Math.cos(u);a+=v*m,c+=v*l}const d=Ir(e,o,n);return i+=d.y,a+=d.dx,c+=d.dz,{y:i,dx:a,dz:c}}const Fr=ya.map(e=>`    gerstner(p, vec2(${e.dir[0].toFixed(3)}, ${e.dir[1].toFixed(3)}), ${e.amp.toFixed(2)} * amp, ${e.len.toFixed(1)}, uTime, disp, tangent, binormal, total);`).join(`
`),Pr=()=>Ne.map(e=>`    whirl(p, vec2(${e.x.toFixed(1)}, ${e.z.toFixed(1)}), ${e.r.toFixed(1)}, ${e.depth.toFixed(1)}, ${e.dir.toFixed(1)}, uTime, disp, tangent, binormal);`).join(`
`),Lr=()=>Ne.map(e=>`    wm += whirlMark(vWorld.xz, vec2(${e.x.toFixed(1)}, ${e.z.toFixed(1)}), ${e.r.toFixed(1)}, ${e.dir.toFixed(1)}, uTime);`).join(`
`),Gr=`
...
`;function Nr(e,o){const n=new Uint8Array(e*e*4);for(let i=0;i<e;i++)for(let a=0;a<e;a++){const c=de.x+((a+.5)/e-.5)*o,d=de.z+((i+.5)/e-.5)*o,h=re(c,d),p=T.clamp(-h/46,0,1),g=(i*e+a)*4;n[g]=Math.round(p*255),n[g+1]=n[g],n[g+2]=n[g],n[g+3]=255}const s=new rr(n,e,e,ir);return s.minFilter=ns,s.magFilter=ns,s.wrapS=ss,s.wrapT=ss,s.needsUpdate=!0,s}const Ko={low:112,mid:190,high:286},Mn=6400;function Hr(e){const o=w.useRef(),n=Mn/(Ko[e]??Ko.high);return ne(s=>{const i=o.current;i&&(i.position.x=Math.round((s.camera.position.x-de.x)/n)*n,i.position.z=Math.round((s.camera.position.z-de.z)/n)*n)}),o}function _r({quality:e="high",storm:o}){const n=w.useRef(),s=Hr(e),{geometry:i,uniforms:a,landTex:c,vert:d,frag:h}=w.useMemo(()=>{const p=Ko[e]??Ko.high,g=new Hn(Mn,Mn,p,p);g.rotateX(-Math.PI/2),g.translate(de.x,0,de.z);const f=Ho*1.05,m=Nr(e==="low"?160:256,f),l={uTime:{value:0},uLand:{value:m},uSpan:{value:f},uCentre:{value:new _n(de.x,de.z)},uDeep:{value:new j(...ie(Z.seaDeep))},uShallow:{value:new j(...ie(Z.seaShallow))},uFoam:{value:new j(...ie(Z.foam))},uSkyLow:{value:new j(...ie(Z.skyLow))},uGilt:{value:new j(...ie(E.gilt))},uEmber:{value:new j(...ie(E.ember))},uFogColor:{value:new j(...ie(Z.haze))},uFogDensity:{value:.0011},uUnderDeep:{value:new j(...ie(Z.abyss))},uUnderGlow:{value:new j(...ie(Z.underGlow))},uDepthFade:{value:0},uMoonDir:{value:Br.clone()},uMoonCol:{value:new j(...ie(Ur))},uEyeA:{value:new j(Ae[0].x,Ae[0].y,Ae[0].z)},uEyeB:{value:new j(Ae[1].x,Ae[1].y,Ae[1].z)},uFlash:{value:0},uFlashColor:{value:new j(...ie(Z.boltGlow))},uCameraPos:{value:new j}};return{geometry:g,uniforms:l,landTex:m,vert:Or(),frag:Dr()}},[e]);return ne((p,g)=>{const f=n.current?.uniforms;if(!f)return;f.uTime.value+=g,f.uCameraPos.value.copy(p.camera.position),f.uFlash.value=o?.flash??0,f.uFogDensity.value=o?.fog??.0011;const m=Math.min(1,Math.max(0,(o?.depthBelow??0)/Ft.deepGrade));f.uDepthFade.value=m,rs.copy(Yr).lerp(Vr,m*.8),f.uFogColor.value.lerpVectors(Wr,rs,o?.underwater??0)}),t.jsx("mesh",{ref:s,geometry:i,frustumCulled:!1,renderOrder:1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:d,fragmentShader:h,uniforms:a,transparent:!1,side:De},c.uuid)})}const Br=new j(...Wo.dir).normalize(),Ur=Wo.col,Wr=new j(...ie(Z.haze)),Yr=new j(...ie(Z.underHaze)),Vr=new j(...ie(Z.abyss)),rs=new j;function $r({quality:e="high",segments:o=200}){const n=w.useMemo(()=>{const s=o,i=new Hn(Ho,Ho,s,s);i.rotateX(-Math.PI/2);const a=i.attributes.position,c=a.count,d=new Float32Array(c*3),h=new ve(Z.rock),p=new ve(Z.rockLit),g=new ve("#0b0e18"),f=new ve(Z.snow),m=new ve(E.rockWarm),l=new ve;for(let u=0;u<c;u++){const x=a.getX(u)+de.x,v=a.getZ(u)+de.z,b=re(x,v);a.setX(u,x),a.setY(u,b),a.setZ(u,v);const k=Yn(x,v,Ho/s)[1],z=Math.max(0,(k-.55)/.45);l.copy(h).lerp(p,T.clamp(b/190,0,1));const r=1-T.clamp((b-kr)/13,0,1);l.lerp(g,r*.85);const M=T.clamp((x-de.x)/260,0,1),F=96-M*42,C=T.clamp((b-F)/60,0,1)*z;l.lerp(f,C*(.45+M*.5));const S=Math.hypot(x-L.x,v-L.z),R=Math.exp(-Math.pow(S/330,2)),A=T.clamp((v-L.z)/260,0,1);l.lerp(m,R*A*.6*(1-C)),d[u*3]=l.r,d[u*3+1]=l.g,d[u*3+2]=l.b}return i.setAttribute("color",new oe(d,3)),i.computeVertexNormals(),i.computeBoundingSphere(),i},[o]);return t.jsx("mesh",{geometry:n,receiveShadow:e!=="low",castShadow:!1,frustumCulled:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,roughness:.86,metalness:.02,flatShading:e==="low"})})}const Vn=-30,$n=330,Kr=150,pe={x:he.x,y:he.y-40,z:he.z-Kr-(Vn+$n)},Ce={centre:[0,96,Vn],radii:[350,235,$n]},jt={x:pe.x+Ce.centre[0],y:pe.y+Ce.centre[1],z:pe.z+Ce.centre[2]};function Xr(e,o,n){const s=(e-jt.x)/Ce.radii[0],i=(o-jt.y)/Ce.radii[1],a=(n-jt.z)/Ce.radii[2];return Math.sqrt(s*s+i*i+a*a)}function jn(e,o=.06){const n=(e.x-jt.x)/Ce.radii[0],s=(e.y-jt.y)/Ce.radii[1],i=(e.z-jt.z)/Ce.radii[2],a=Math.sqrt(n*n+s*s+i*i),c=1+o;if(a>=c)return null;const d=a<1e-4?0:c/a;return e.x=jt.x+(d?n*d:0)*Ce.radii[0],e.y=jt.y+(d?s*d:c)*Ce.radii[1],e.z=jt.z+(d?i*d:0)*Ce.radii[2],e}const le={y:0,halfX:290,zFront:228,zBack:-240},Le={y:40,z:Vn+$n-40,halfX:96,depth:120},lt={zTop:Le.z-54,zBottom:140,halfX:74,steps:16},O={z:-290,baseY:0,halfX:130,halfZ:76,plinth:34,storey:36,storeys:6,taper:.11},Ee={y:74,z:O.z+O.halfZ+26,halfX:96,depth:40},It=Ee.y+3.5,Qe={y:-95,halfX:220,halfZ:175,ceiling:-34},ke={x:0,z:84,halfX:52,halfZ:40},xe={y:52,halfZ:205,x:252,tiers:3,tierRise:46},ko=[[96,46,340,40],[140,-64,300,34],[70,-150,240,26],[196,-8,220,28]],me={x:74,halfW:14,zFoot:O.z+O.halfZ+158,zTop:Ee.z+Ee.depth/2-6},va=[{kind:"rampZ",x0:-74-me.halfW,x1:-74+me.halfW,z0:me.zFoot,z1:me.zTop,y0:0,y1:It},{kind:"rampZ",x0:me.x-me.halfW,x1:me.x+me.halfW,z0:me.zFoot,z1:me.zTop,y0:0,y1:It},{kind:"flat",x0:-96,x1:Ee.halfX,z0:Ee.z-Ee.depth/2-2,z1:me.zTop,y:It},{kind:"rampZ",x0:-290,x1:-214,z0:45,z1:-45,y0:0,y1:xe.y-.5},{kind:"flat",x0:-290,x1:-214,z0:-225,z1:-45,y:xe.y-.5},{kind:"flat",x0:xe.x-38,x1:xe.x+38,z0:-225,z1:xe.halfZ+20,y:xe.y-.5}],Qr=e=>e<=0?0:e>=1?1:e*e*(3-2*e),Ma=(()=>{const e=[],o=[],n=[],s=O.halfX+6,i=[s,s+9],a=[s+11,s+20],c=[s,s+20],d=[-212,-200],h=[-264,-252],p=[It];for(let f=2;f<=O.storeys;f++)p.push(O.plinth+f*O.storey+1.5);e.push({kind:"flat",x0:Ee.halfX-6,x1:s+20,z0:-212,z1:-196,y:It}),o.push([(Ee.halfX-6+s+20)/2,It,-204,s+26-Ee.halfX,16]);for(let f=0;f<p.length-1;f++){const m=p[f],l=p[f+1],u=(m+l)/2;e.push({kind:"rampZ",x0:i[0],x1:i[1],z0:d[0],z1:h[1],y0:m,y1:u}),n.push({x0:i[0],x1:i[1],z0:d[0],z1:h[1],y0:m,y1:u}),e.push({kind:"flat",x0:c[0],x1:c[1],z0:h[0],z1:h[1],y:u}),o.push([(c[0]+c[1])/2,u,(h[0]+h[1])/2,c[1]-c[0],h[1]-h[0]]),e.push({kind:"rampZ",x0:a[0],x1:a[1],z0:h[1],z1:d[0],y0:u,y1:l}),n.push({x0:a[0],x1:a[1],z0:h[1],z1:d[0],y0:u,y1:l}),e.push({kind:"flat",x0:c[0],x1:c[1],z0:d[0],z1:d[1],y:l}),o.push([(c[0]+c[1])/2,l,(d[0]+d[1])/2,c[1]-c[0],d[1]-d[0]])}for(let f=1;f<p.length-1;f++){const l=1-Math.min(O.storeys,f+2)*O.taper,u=O.halfX*l,x=O.z+O.halfZ*l,v=p[f];e.push({kind:"flat",x0:u-4,x1:s,z0:-224,z1:-212,y:v}),o.push([(u-4+s)/2,v,-218,s-u+4,12]),e.push({kind:"flat",x0:-u-6,x1:u+6,z0:x,z1:-212,y:v}),o.push([0,v,(x-212)/2,u*2+12,-212-x])}const g=p[p.length-1];return e.push({kind:"flat",x0:58,x1:s,z0:-248,z1:-212,y:g}),o.push([(s+58)/2,g,-230,s-58,36]),{walks:e,slabs:o,flights:n,tower:{x:[s,s+20],z:[h[0],d[1]]}}})();va.push(...Ma.walks);const Zr=1.1;function qr(e,o,n=1/0){const s=n+Zr;let i=-1/0;for(const a of va){if(e<a.x0||e>a.x1)continue;const c=Math.min(a.z0,a.z1),d=Math.max(a.z0,a.z1);if(o<c||o>d)continue;const h=a.kind==="flat"?a.y:a.y0+(a.y1-a.y0)*Qr((o-a.z0)/(a.z1-a.z0));h<=s&&h>i&&(i=h)}return i===-1/0?0:Math.max(0,i)}function Jr(e,o,n=1/0){const s=o>lt.zTop?Le.y:o>lt.zBottom?Le.y*(o-lt.zBottom)/(lt.zTop-lt.zBottom):0,i=qr(e,o,n);return Math.max(s,i)}function ei(e,o,n){const s=O.plinth+O.storeys*O.storey;if(n>s)return!1;const a=1-(n<=O.plinth?0:Math.min(O.storeys,Math.ceil((n-O.plinth)/O.storey)))*O.taper;return Math.abs(e)<O.halfX*a&&Math.abs(o-O.z)<O.halfZ*a}const y={t:0,flash:0,flashDir:new j(0,.4,-1),fog:Ft.sea,rain:1,progress:0,shelter:0,inside:0,shot:0,underwater:0,depthBelow:0,whirlNear:0,subActive:!1,subPos:new j(0,0,0),helmActive:!1,helmPos:new j(0,0,0),helmSpeed:0,ship:{x:0,y:0,z:0,heading:Math.PI,loa:42,deckY:5.5},subThrottle:0,footSpawn:"hall",splash:0,onRails:!0,orbit:{yaw:0,pitch:.12,dist:120,target:new j(0,60,-200)}};function ti(){y.t=0,y.progress=0,y.flash=0,y.fog=Ft.sea,y.rain=1,y.shot=0,y.underwater=0,y.depthBelow=0,y.whirlNear=0,y.subActive=!1,y.subThrottle=0}const an=new Map;let ja=!0;function oi(e){ja=!!e}function ni(e){const o=wo(e);return an.has(o)||an.set(o,fetch(o,{method:"HEAD"}).then(n=>n.ok?!(n.headers.get("content-type")||"").includes("text/html"):!1).catch(()=>!1)),an.get(o)}function ot(e){const[o,n]=w.useState(!1);return w.useEffect(()=>{let s=!0;return ni(e).then(i=>{s&&n(i&&ja)}),()=>{s=!1}},[e]),o}const St=mo.map(e=>new j(...e).normalize()),Sa=new j(...Bn).normalize(),Sn=new j(...Un).normalize();function si(e){let o=1;o+=Math.max(0,e.y)*.1,o-=Math.pow(Math.max(0,e.y),4)*.2;const n=Math.exp(-Math.pow((e.y-.52)/.16,2))*Math.max(0,e.z);o+=n*.13;for(const h of St){const p=e.dot(h),g=Math.pow(Math.max(0,p),46);o-=g*.3}const s=Math.max(0,e.dot(Sa)),i=Math.pow(s,150)*(1-Math.max(0,e.y)*.5);o-=i*.19;for(const h of St){const p=new j(h.x*1.5,h.y-.55,h.z*.7).normalize().dot(e);o+=Math.pow(Math.max(0,p),26)*.075}const a=Math.max(0,e.dot(Sn));o-=Math.pow(a,30)*.11,o-=Math.pow(Math.max(0,-e.y),3)*.28;const c=Math.pow(Math.max(0,e.dot(St[0])),30)+Math.pow(Math.max(0,e.dot(St[1])),30),d=1-Math.min(1,c);return o+=(qt(e.x*3.1+7,e.z*3.1-3,3)-.5)*.085*d,o+=(qt(e.x*9.4-2,e.y*9.4+5,2)-.5)*.032*d,o}const ai=178*1.9,et=L.r/ai;function is(e,o){const n=e*et,s=[new j(n*74,96*et,-20*et),new j(n*142,176*et,-58*et),new j(n*196,268*et,-76*et),new j(n*222,356*et,-52*et),new j(n*206,424*et,8*et),new j(n*154,462*et,72*et)],i=new j;for(const g of s)i.set(L.x+g.x,L.baseY+g.y,L.z+g.z),jn(i,.12)&&g.set(i.x-L.x,i.y-L.baseY,i.z-L.z);const a=new to(s),c=o==="low"?14:o==="mid"?22:34,d=o==="low"?6:10,h=new oo(a,c,1,d,!1),p=h.attributes.position;for(let g=0;g<=c;g++){const f=g/c,m=34*et*Math.pow(1-f,.72)*(1+Math.sin(f*Math.PI)*.16),l=a.getPoint(f);for(let u=0;u<=d;u++){const x=g*(d+1)+u;if(x>=p.count)continue;const v=p.getX(x)-l.x,b=p.getY(x)-l.y,k=p.getZ(x)-l.z;p.setXYZ(x,l.x+v*m,l.y+b*m,l.z+k*m)}}return p.needsUpdate=!0,h.computeVertexNormals(),h}const ri={low:4,mid:6,high:7},ka="skull-island.opt.glb",io={height:1,yaw:0,lift:.02},rn=new hr,ls=new j,zo=new j;function ii(e,o,n){zo.set(o[0],o[1],o[2]).normalize(),ls.copy(zo).multiplyScalar(L.r*4),rn.set(ls,zo.clone().negate()),rn.far=L.r*8;const s=rn.intersectObject(e,!0)[0];return s?s.point.clone().addScaledVector(zo,-n):null}function li({shadows:e}){const{scene:o}=ma(wo(ka)),{object:n,eyes:s,nose:i,mouth:a}=w.useMemo(()=>{const c=o.clone(!0),d=new ga().setFromObject(c),h=new j,p=new j;d.getSize(h),d.getCenter(p);const g=L.r*L.squash[1]*1.62,f=h.y>1e-4?g*io.height/h.y:1,m=L.r*L.squash[1]*io.lift;c.scale.setScalar(f),c.rotation.set(0,io.yaw,0),c.position.set(0,-p.y*f+m,0);const l=p.x*f,u=p.z*f,x=Math.cos(io.yaw),v=Math.sin(io.yaw);c.position.x=-(l*x+u*v),c.position.z=-(-l*v+u*x),c.updateMatrixWorld(!0);let b=0,k=0;const z={x:0,y:0,z:0},r=new j,M=[];c.traverse(G=>{G.isMesh&&M.push(G)});for(const G of M){const $=G.geometry.clone();for(const P of["position","normal"]){const K=$.attributes[P];if(!K||K.array instanceof Float32Array)continue;const ae=new Float32Array(K.count*3);for(let H=0;H<K.count;H++)r.fromBufferAttribute(K,H),ae[H*3]=r.x,ae[H*3+1]=r.y,ae[H*3+2]=r.z;$.setAttribute(P,new oe(ae,3))}$.applyMatrix4(G.matrixWorld);const q=$.attributes.position;k+=q.count;for(let P=0;P<q.count;P++)z.x=q.getX(P)+L.x,z.y=q.getY(P)+L.baseY,z.z=q.getZ(P)+L.z,jn(z,.05)&&(q.setXYZ(P,z.x-L.x,z.y-L.baseY,z.z-L.z),b++);b&&$.computeVertexNormals(),q.needsUpdate=!0,$.computeBoundingSphere(),$.computeBoundingBox(),G.geometry=$,G.castShadow=e,G.receiveShadow=!1;const ee=Array.isArray(G.material)?G.material:[G.material];for(const P of ee)P.color?.multiply(ci),P.roughness=.94,P.metalness=.02}for(const G of[c,...M])G.position.set(0,0,0),G.quaternion.identity(),G.scale.set(1,1,1),G.updateMatrix();c.updateMatrixWorld(!0);const F=(G,$=1)=>{const[q,ee,P]=L.squash;return new j(G[0]*L.r*q*$,G[1]*L.r*ee*$,G[2]*L.r*P*$)},C=mo.map(G=>ii(c,G,L.r*.1)??F(G,.82)),S=new j().addVectors(C[0],C[1]).multiplyScalar(.5),R=new j().addVectors(F(mo[0],.82),F(mo[1],.82)).multiplyScalar(.5),A=S.clone().sub(R),B=G=>{const $={x:G.x+L.x,y:G.y+L.baseY,z:G.z+L.z};return jn($,.22)&&G.set($.x-L.x,$.y-L.baseY,$.z-L.z),G};return{object:c,eyes:C.map(B),nose:B(F(Bn,.87).add(A)),mouth:B(F(Un,.9).add(A))}},[o,e]);return t.jsxs(t.Fragment,{children:[t.jsx("primitive",{object:n}),t.jsx(za,{eyes:s,nose:i,mouth:a,teeth:null,cast:e})]})}const ci=new ve("#8f8a84");function za({eyes:e,nose:o,mouth:n,teeth:s,cast:i}){const a=w.useRef(),c=w.useRef(),d=w.useRef();return ne(()=>{const h=y.t,p=.82+.18*Math.sin(h*2.3)*Math.sin(h*.71),g=.82+.18*Math.sin(h*1.9+2.1)*Math.sin(h*.63),f=.86+.14*Math.sin(h*1.4+.8);a.current&&(a.current.emissiveIntensity=5.2*p+y.flash*2),c.current&&(c.current.emissiveIntensity=5.2*g+y.flash*2),d.current&&(d.current.emissiveIntensity=3.4*f)}),t.jsxs(t.Fragment,{children:[e.map((h,p)=>t.jsxs("mesh",{position:h,rotation:[-.24,0,0],children:[t.jsx("sphereGeometry",{args:[L.r*.108,20,14,0,Math.PI*2,0,Math.PI*.5]}),t.jsx("meshStandardMaterial",{ref:p===0?a:c,color:E.furnace,emissive:E.ember,emissiveIntensity:5.2,toneMapped:!1,side:De,roughness:1})]},p)),t.jsxs("mesh",{position:o,rotation:[Math.PI*.54,0,0],children:[t.jsx("coneGeometry",{args:[L.r*.046,L.r*.083,3]}),t.jsx("meshStandardMaterial",{color:E.emberDeep,emissive:E.emberDeep,emissiveIntensity:2.4,toneMapped:!1})]}),t.jsxs("group",{position:n,children:[t.jsxs("mesh",{position:[0,L.r*.05,-L.r*.16],children:[t.jsx("planeGeometry",{args:[L.r*.62,L.r*.34]}),t.jsx("meshStandardMaterial",{ref:d,color:E.ember,emissive:E.emberDeep,emissiveIntensity:3.4,toneMapped:!1,side:De})]}),s?.map((h,p)=>t.jsxs("mesh",{position:h.pos,scale:h.scale,rotation:[0,0,h.rot],castShadow:i,children:[t.jsx("boxGeometry",{args:[1,1,1]}),t.jsx("meshStandardMaterial",{color:"#e6d9bc",emissive:E.emberDeep,emissiveIntensity:.42,roughness:.78})]},p))]})]})}const hi=typeof location<"u"?new URLSearchParams(location.search).get("skull"):null;function di({quality:e="high",shadows:o=!0}){const s=ot(ka)&&e!=="low"&&hi!=="proc",{dome:i,hornL:a,hornR:c,teeth:d}=w.useMemo(()=>{const l=new lr(L.r,ri[e]??7),u=l.attributes.position,x=new Float32Array(u.count*3),v=new ve(Z.rock),b=new ve(E.rockWarm),k=new ve("#120b10"),z=new ve,r=new j;for(let S=0;S<u.count;S++){r.set(u.getX(S),u.getY(S),u.getZ(S)).normalize();const R=L.r*si(r),[A,B,G]=L.squash;u.setXYZ(S,r.x*R*A,r.y*R*B,r.z*R*G);const $=Math.max(Math.pow(Math.max(0,r.dot(St[0])),5),Math.pow(Math.max(0,r.dot(St[1])),5),Math.pow(Math.max(0,r.dot(Sn)),6)*.9);z.copy(v).lerp(b,Math.min(1,$*1.5+Math.max(0,r.z)*.22));const q=Math.max(Math.pow(Math.max(0,r.dot(St[0])),40),Math.pow(Math.max(0,r.dot(St[1])),40));z.lerp(k,q),x[S*3]=z.r,x[S*3+1]=z.g,x[S*3+2]=z.b}l.setAttribute("color",new oe(x,3)),l.computeVertexNormals();const M=new cr(1,1,1),F=[],C=9;for(let S=0;S<C;S++){const R=S/(C-1)*2-1,A=he.halfWidth*2.1,B=R*A*.5,G=Math.pow(Math.abs(R),1.7)*14,$=46-Math.abs(R)*13+S%2*7;F.push({pos:[B,he.height*.5-G-$*.5,6],scale:[A/C*.76,$,52],rot:R*.13})}return M.dispose?.(),{dome:l,hornL:is(-1,e),hornR:is(1,e),teeth:F}},[e]),h=o,[p,g,f]=L.squash,m=(l,u)=>[l.x*L.r*p*u,l.y*L.r*g*u,l.z*L.r*f*u];return t.jsx("group",{position:[L.x,L.baseY,L.z],children:s?t.jsx(w.Suspense,{fallback:t.jsx(cs,{dome:i,hornL:a,hornR:c,cast:h}),children:t.jsx(li,{shadows:h})}):t.jsxs(t.Fragment,{children:[t.jsx(cs,{dome:i,hornL:a,hornR:c,cast:h}),t.jsx(za,{eyes:St.map(l=>m(l,.82)),nose:m(Sa,.87),mouth:m(Sn,.96),teeth:d,cast:h})]})})}function cs({dome:e,hornL:o,hornR:n,cast:s}){return t.jsxs(t.Fragment,{children:[t.jsx("mesh",{geometry:e,castShadow:s,receiveShadow:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,roughness:.92,metalness:.03})}),t.jsx("mesh",{geometry:o,castShadow:s,children:t.jsx("meshStandardMaterial",{color:"#241d28",roughness:.55,metalness:.12})}),t.jsx("mesh",{geometry:n,castShadow:s,children:t.jsx("meshStandardMaterial",{color:"#241d28",roughness:.55,metalness:.12})})]})}function pt({matrices:e,target:o}){const n=w.useRef(!1);return ne(()=>{if(n.current||!o.current)return;const s=Math.min(e.length,o.current.count);for(let i=0;i<s;i++)o.current.setMatrixAt(i,e[i]);o.current.instanceMatrix.needsUpdate=!0,o.current.computeBoundingSphere(),n.current=!0}),null}const Wt=190,gt=130,To=9.5;function hs(e,o,n,s=24){const i=new to(e),a=new oo(i,s,1,4,!1),c=a.attributes.position,d=new j(0,1,0),h=new j,p=new j,g=new j,f=new j,m=new j;for(let l=0;l<=s;l++){const u=l/s;i.getPointAt(u,p),i.getTangentAt(u,h),f.crossVectors(h,d).normalize(),g.crossVectors(f,h).normalize();for(let x=0;x<=4;x++){const v=l*5+x;if(v>=c.count)continue;const b=x/4*Math.PI*2+Math.PI/4,k=Math.cos(b)*o*.7071,z=Math.sin(b)*n*.7071;m.copy(p).addScaledVector(f,k).addScaledVector(g,z),c.setXYZ(v,m.x,m.y,m.z)}}return c.needsUpdate=!0,a.computeVertexNormals(),a}function ui(e,o,n,s=40){const i=[];for(let h=0;h<=10;h++){const p=h/10*2-1;i.push(new j(p*e,-30*(1-p*p),0))}const a=new to(i),c=new oo(a,s,n,8,!1),d=c.attributes.position;for(let h=0;h<=s;h++){const p=h/s*2-1,g=1+(1-p*p)*.85,f=a.getPointAt(h/s);for(let m=0;m<=8;m++){const l=h*9+m;l>=d.count||d.setXYZ(l,f.x+(d.getX(l)-f.x)*g,f.y+(d.getY(l)-f.y)*g,f.z+(d.getZ(l)-f.z)*g)}}return d.needsUpdate=!0,c.computeVertexNormals(),c}function ds({quality:e="high",shadows:o=!0,z:n=Pt,k:s=N}){const i=w.useRef(),a=w.useRef(),c=w.useRef(),d=w.useRef(),h=w.useMemo(()=>{const x=Wt/2,v=gt,b=hs([new j(-x-40,v+6,0),new j(-x-22,v+15.5,0),new j(0,v+20,0),new j(x+22,v+15.5,0),new j(x+40,v+6,0)],16,9,30),k=hs([new j(-x-30,v+2,0),new j(0,v+8,0),new j(x+30,v+2,0)],11,5,18);return{kasagi:b,shimaki:k,rope:ui(x-6,30,6.4,44)}},[]),{tileM:p,merlonM:g,cannonM:f,lanternM:m}=w.useMemo(()=>{const x=new rt,v=new mt,b=new j,k=new j,z=[],r=e==="low"?26:54;for(let R=0;R<r;R++){const A=R/(r-1)*2-1,B=A*(Wt/2+40),G=gt+20-Math.pow(Math.abs(A),1.9)*14+5,$=-Math.sign(A)*Math.pow(Math.abs(A),3)*.5;k.set(B,G,0),v.setFromEuler(new Dt(0,0,$)),b.set(1,1,1),z.push(x.clone().compose(k,v,b))}const M=[];for(const R of[-1,1])for(let A=0;A<7;A++)k.set(R*(58+A*12),26,0),v.identity(),b.set(1,1,1),M.push(x.clone().compose(k,v,b));const F=[];for(const R of[-1,1])for(let A=0;A<2;A++)for(let B=0;B<4-A;B++)k.set(R*(64+B*13+A*6),32+A*10,8),v.setFromEuler(new Dt(Math.PI/2-.16,0,0)),b.set(1,1,1),F.push(x.clone().compose(k,v,b));const C=[],S=e==="low"?10:22;for(let R=0;R<S;R++){const A=R/(S-1)*2-1,B=A*(Wt/2-12),G=30*(1-A*A);k.set(B,gt-34-G-7.5,0),v.identity(),b.set(1,1,1),C.push(x.clone().compose(k,v,b))}return{tileM:z,merlonM:M,cannonM:F,lanternM:C}},[e]);ne(()=>{const x=y.t;i.current&&(i.current.material.emissiveIntensity=2.6+Math.sin(x*3.1)*.22+Math.sin(x*7.7)*.1+y.flash*1.4)});const l=Wt/2,u=o;return t.jsxs("group",{position:[0,0,n],scale:s,children:[[-1,1].map(x=>t.jsxs("group",{position:[x*l,0,0],children:[t.jsxs("mesh",{position:[0,gt/2-30,0],castShadow:u,children:[t.jsx("cylinderGeometry",{args:[To*.86,To,gt+60,14]}),t.jsx("meshStandardMaterial",{color:"#6d4d86",roughness:.72})]}),t.jsxs("mesh",{position:[0,6,0],castShadow:u,children:[t.jsx("cylinderGeometry",{args:[To*1.5,To*1.85,20,14]}),t.jsx("meshStandardMaterial",{color:"#3b3547",roughness:.94})]})]},x)),t.jsxs("mesh",{position:[0,gt-26,0],castShadow:u,children:[t.jsx("boxGeometry",{args:[Wt+56,12,13]}),t.jsx("meshStandardMaterial",{color:"#6d4d86",roughness:.72})]}),t.jsx("mesh",{geometry:h.shimaki,castShadow:u,children:t.jsx("meshStandardMaterial",{color:"#5c3f72",roughness:.76})}),t.jsx("mesh",{geometry:h.kasagi,castShadow:u,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.68})}),t.jsxs("instancedMesh",{ref:a,args:[null,null,p.length],castShadow:u,children:[t.jsx("cylinderGeometry",{args:[3.4,3.4,9.5,6,1,!1,0,Math.PI]}),t.jsx("meshStandardMaterial",{color:"#8c2a1c",roughness:.6}),t.jsx(pt,{matrices:p,target:a})]}),t.jsxs("mesh",{position:[0,gt-6,0],castShadow:u,children:[t.jsx("boxGeometry",{args:[13,30,9]}),t.jsx("meshStandardMaterial",{color:"#4b3560",roughness:.8})]}),t.jsxs("mesh",{position:[0,gt-6,5.2],children:[t.jsx("planeGeometry",{args:[17,24]}),t.jsx("meshStandardMaterial",{color:"#2f4438",emissive:"#1d3326",emissiveIntensity:.5,roughness:.9})]}),t.jsx("mesh",{geometry:h.rope,position:[0,gt-34,2],castShadow:u,children:t.jsx("meshStandardMaterial",{color:"#cdc5b2",emissive:"#6a6053",emissiveIntensity:.55,roughness:.97})}),[-52,-18,18,52].map(x=>{const v=30*(1-(x/(Wt/2-6))**2);return t.jsx("group",{position:[x,gt-34-v-4,2],children:[0,1,2].map(b=>t.jsxs("mesh",{position:[b%2?1.1:-1.1,-2.4-b*3.6,0],children:[t.jsx("boxGeometry",{args:[3.4,3.4,.35]}),t.jsx("meshStandardMaterial",{color:"#efece2",emissive:"#cfc9b8",emissiveIntensity:.5,roughness:1,side:De})]},b))},x)}),[-1,1].map(x=>t.jsxs("group",{children:[t.jsxs("mesh",{position:[x*108,6,0],castShadow:u,receiveShadow:u,children:[t.jsx("boxGeometry",{args:[126,44,62]}),t.jsx("meshStandardMaterial",{color:"#39404f",roughness:.95})]}),t.jsxs("mesh",{position:[x*108,30,6],castShadow:u,children:[t.jsx("boxGeometry",{args:[118,12,44]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.88})]}),t.jsxs("mesh",{position:[x*162,44,10],children:[t.jsx("boxGeometry",{args:[9,13,9]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1})]})]},x)),t.jsxs("instancedMesh",{ref:d,args:[null,null,g.length],castShadow:u,children:[t.jsx("boxGeometry",{args:[8,11,44]}),t.jsx("meshStandardMaterial",{color:"#2f3542",roughness:.95}),t.jsx(pt,{matrices:g,target:d})]}),t.jsxs("instancedMesh",{ref:c,args:[null,null,f.length],castShadow:u,children:[t.jsx("cylinderGeometry",{args:[3.4,4.4,30,10]}),t.jsx("meshStandardMaterial",{color:"#15181f",roughness:.42,metalness:.75}),t.jsx(pt,{matrices:f,target:c})]}),t.jsxs("instancedMesh",{ref:i,args:[null,null,m.length],children:[t.jsx("cylinderGeometry",{args:[3.6,3.6,6.4,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.6,toneMapped:!1}),t.jsx(pt,{matrices:m,target:i})]})]})}const pi=(()=>{if(typeof document>"u")return null;const e=128,o=document.createElement("canvas");o.width=o.height=e;const n=o.getContext("2d"),s=n.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2);s.addColorStop(0,"rgba(255,255,255,1)"),s.addColorStop(.12,"rgba(255,255,255,0.55)"),s.addColorStop(.4,"rgba(255,255,255,0.06)"),s.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=s,n.fillRect(0,0,e,e),n.translate(e/2,e/2);for(let a=0;a<4;a++){const c=n.createLinearGradient(0,0,e/2,0);c.addColorStop(0,"rgba(255,255,255,0.95)"),c.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=c,n.beginPath(),n.moveTo(0,-2.5),n.lineTo(e/2,0),n.lineTo(0,2.5),n.closePath(),n.fill(),n.rotate(Math.PI/2)}const i=new no(o);return i.colorSpace=so,i})();function fi(e,o,n,s){const i=[];for(let a=0;a<=s;a++){const c=a/s,d=c*2-1;i.push(new j(e[0]+(o[0]-e[0])*c,e[1]+(o[1]-e[1])*c-n*(1-d*d),e[2]+(o[2]-e[2])*c))}return i}const mi=[[[-62,34,26],[-6,42,-12],14],[[-6,42,-12],[52,32,18],13],[[-46,28,-30],[18,36,-40],11],[[18,36,-40],[68,26,-20],11],[[-70,22,-4],[-16,30,36],10],[[16,30,40],[72,22,12],10],[[-36,48,-62],[34,50,-66],14]];function gi({quality:e="high",shadows:o=!0}){const n=w.useRef(),s=w.useRef(),i=w.useRef(),a=w.useRef(),{lanternM:c,lampM:d,pilingM:h,katanaY:p,ground:g}=w.useMemo(()=>{const l=new rt,u=new mt,x=new j(1,1,1),v=new j,b=[],k=e==="low"?.42:e==="mid"?.72:1;for(const[F,C,S]of mi){const R=Math.max(4,Math.round(S*k)),A=fi(F,C,14,R);for(let B=1;B<A.length-1;B++){const G=.78+B*37%11/22;v.copy(A[B]).add(new j(0,-4.2*G,0)),u.setFromEuler(new Dt(0,B*1.7%Math.PI,(B%3-1)*.06)),b.push(l.clone().compose(v,u,x.clone().multiplyScalar(G)))}}const z=[],r=e==="low"?6:11;for(let F=0;F<r;F++){const C=F/(r-1);for(const S of[-1,1]){const R=T.lerp(Q.x+46,he.x-6,C)+S*(26-C*9),A=T.lerp(Q.z-26,he.z+32,C);v.set(R,re(R,A)+5,A),u.identity(),z.push(l.clone().compose(v,u,x))}}const M=[];for(let F=0;F<16;F++){const C=F%2,S=Math.floor(F/2);v.set(Q.x+30+S*17,-2,Q.z+34+C*26),u.setFromEuler(new Dt(0,0,(F%3-1)*.035)),M.push(l.clone().compose(v,u,x))}return{lanternM:b,lampM:z,pilingM:M,katanaY:re(Q.x+118,Q.z-58),ground:Q.y}},[e]);ne(()=>{const l=y.t;if(n.current&&(n.current.material.emissiveIntensity=2.4+Math.sin(l*2.7)*.2+Math.sin(l*6.1+1.3)*.12+y.flash*1.6),a.current){const u=46*(1+Math.sin(l*1.3)*.13);a.current.scale.set(u,u,1),a.current.material.rotation=l*.07}});const f=o,m=(l,u)=>re(Q.x+l,Q.z+u);return t.jsxs("group",{children:[t.jsxs("group",{position:[Q.x,0,Q.z],children:[t.jsxs("mesh",{position:[85,7.5,47],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[128,3,60]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.92})]}),t.jsxs("mesh",{position:[18,7,4],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[96,2.4,82]}),t.jsx("meshStandardMaterial",{color:"#5a4230",roughness:.94})]}),[0,1,2,3].map(l=>t.jsxs("group",{position:[52+l*26,1.5,92+l%2*13],rotation:[0,.4+l*.3,0],children:[t.jsxs("mesh",{castShadow:f,children:[t.jsx("boxGeometry",{args:[18,5,6.5]}),t.jsx("meshStandardMaterial",{color:"#4a3524",roughness:.9})]}),t.jsxs("mesh",{position:[0,9,0],children:[t.jsx("boxGeometry",{args:[.7,14,.7]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.9})]}),t.jsxs("mesh",{position:[1.5,12,0],children:[t.jsx("planeGeometry",{args:[9,11]}),t.jsx("meshStandardMaterial",{color:"#cbbfa4",roughness:1,side:De})]})]},l))]}),t.jsxs("instancedMesh",{ref:i,args:[null,null,h.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.8,2.1,22,7]}),t.jsx("meshStandardMaterial",{color:"#33251a",roughness:.95}),t.jsx(pt,{matrices:h,target:i})]}),t.jsxs("group",{position:[Q.x+118,p,Q.z-58],rotation:[0,.5,.34],scale:.6,children:[t.jsxs("mesh",{position:[0,52,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[7,132,2.1]}),t.jsx("meshStandardMaterial",{color:"#cfd8e2",roughness:.16,metalness:.92})]}),t.jsxs("mesh",{position:[0,116,0],rotation:[Math.PI/2,0,0],castShadow:f,children:[t.jsx("torusGeometry",{args:[9,2.4,6,18]}),t.jsx("meshStandardMaterial",{color:"#2a2118",roughness:.4,metalness:.75})]}),t.jsxs("mesh",{position:[0,138,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[4.4,4.9,42,10]}),t.jsx("meshStandardMaterial",{color:"#20232b",roughness:.85})]}),t.jsxs("mesh",{position:[0,161,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[5.2,5.2,5,10]}),t.jsx("meshStandardMaterial",{color:"#8a7a4e",roughness:.5,metalness:.6})]}),t.jsx("sprite",{ref:a,position:[0,116,0],scale:[46,46,1],children:t.jsx("spriteMaterial",{map:pi,color:E.furnace,transparent:!0,opacity:.75,blending:bt,depthWrite:!1,toneMapped:!1})})]}),[-1,1].map(l=>{const u=96+l*4,x=88*l;return t.jsxs("group",{position:[Q.x+u,m(u,x),Q.z+x],rotation:[0,-l*.5,0],children:[t.jsxs("mesh",{position:[0,7,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[13,14,13]}),t.jsx("meshStandardMaterial",{color:"#4a4a52",roughness:.95})]}),t.jsxs("mesh",{position:[0,21,1],rotation:[.22,0,0],castShadow:f,children:[t.jsx("capsuleGeometry",{args:[5,12,4,8]}),t.jsx("meshStandardMaterial",{color:"#c9c4b4",roughness:.86})]}),t.jsxs("mesh",{position:[0,32,5],castShadow:f,children:[t.jsx("sphereGeometry",{args:[5.4,12,10]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]}),[-1,1].map(v=>t.jsxs("mesh",{position:[v*3,37,4],rotation:[0,0,v*.3],castShadow:f,children:[t.jsx("coneGeometry",{args:[2.1,6.5,4]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]},v)),t.jsxs("mesh",{position:[0,26,-8],rotation:[-.7,0,0],castShadow:f,children:[t.jsx("coneGeometry",{args:[4,20,6]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]}),t.jsxs("mesh",{position:[0,26,6.4],rotation:[.3,0,0],children:[t.jsx("planeGeometry",{args:[9,8]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.9,side:De})]})]},l)}),[-1,1].map(l=>{const u=40+l*34,x=-18+l*46;return t.jsxs("group",{position:[Q.x+u,m(u,x)+12,Q.z+x],rotation:[0,l*.8,0],children:[t.jsxs("mesh",{castShadow:f,children:[t.jsx("sphereGeometry",{args:[9,12,10]}),t.jsx("meshStandardMaterial",{color:"#7c6a52",roughness:.9})]}),[-1,1].map(v=>t.jsxs("mesh",{position:[v*5,7,-1],rotation:[0,0,v*-.5],castShadow:f,children:[t.jsx("coneGeometry",{args:[1.8,8,5]}),t.jsx("meshStandardMaterial",{color:"#4c4038",roughness:.85})]},v)),t.jsxs("mesh",{position:[0,-1,8],children:[t.jsx("sphereGeometry",{args:[4.2,10,8]}),t.jsx("meshStandardMaterial",{color:E.ember,emissive:E.ember,emissiveIntensity:2.2,toneMapped:!1})]}),t.jsxs("mesh",{position:[0,-8,13],rotation:[.4,0,0],children:[t.jsx("cylinderGeometry",{args:[1.5,2.6,20,6,1,!0]}),t.jsx("meshStandardMaterial",{color:"#cfe4ee",transparent:!0,opacity:.42,roughness:.25,side:De})]})]},l)}),t.jsxs("group",{position:[Q.x-34,m(-34,30)+2,Q.z+30],children:[t.jsxs("mesh",{position:[0,30,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.1,1.4,60,8]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.92})]}),t.jsxs("mesh",{position:[0,58,0],castShadow:f,children:[t.jsx("coneGeometry",{args:[34,17,20,1,!0]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.88,side:De,emissive:E.vermilionDeep,emissiveIntensity:.4})]}),Array.from({length:10},(l,u)=>{const x=u/10*Math.PI*2;return t.jsxs("mesh",{position:[Math.cos(x)*26,55.5,Math.sin(x)*26],rotation:[0,-x,-.42],children:[t.jsx("boxGeometry",{args:[34,.6,.6]}),t.jsx("meshStandardMaterial",{color:"#2a1c12",roughness:.9})]},u)}),Array.from({length:10},(l,u)=>{const x=u/10*Math.PI*2+.31;return t.jsxs("mesh",{position:[Math.cos(x)*32,44,Math.sin(x)*32],children:[t.jsx("cylinderGeometry",{args:[2.6,2.6,4.6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.5,toneMapped:!1})]},u)})]}),[0,1,2,3].map(l=>{const u=8+l*30,x=-70-l%2*14;return t.jsxs("group",{position:[Q.x+u,m(u,x),Q.z+x],children:[t.jsxs("mesh",{position:[0,26,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[.6,.6,52,6]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.9})]}),t.jsxs("mesh",{position:[5,34,0],children:[t.jsx("planeGeometry",{args:[10,34]}),t.jsx("meshStandardMaterial",{color:l%2?"#e8dcc4":E.vermilion,roughness:.95,side:De})]})]},l)}),[0,1,2].map(l=>{const u=.28+l*.24,x=T.lerp(Q.x+46,he.x,u),v=T.lerp(Q.z-26,he.z+26,u),b=re(x,v),k=1-l*.1;return t.jsxs("group",{position:[x,b,v],scale:k,children:[[-1,1].map(z=>t.jsxs("mesh",{position:[z*15,17,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.7,2.1,34,10]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.7})]},z)),t.jsxs("mesh",{position:[0,36,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[44,3.4,4]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.68})]}),t.jsxs("mesh",{position:[0,29,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[36,2.4,3]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.75})]})]},l)}),t.jsx("group",{position:[Q.x,g,Q.z],children:t.jsxs("instancedMesh",{ref:n,args:[null,null,c.length],children:[t.jsx("cylinderGeometry",{args:[3.1,3.1,5.6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1}),t.jsx(pt,{matrices:c,target:n})]})}),t.jsxs("instancedMesh",{ref:s,args:[null,null,d.length],castShadow:f,children:[t.jsx("boxGeometry",{args:[6,12,6]}),t.jsx("meshStandardMaterial",{color:"#6c6458",emissive:E.lanternFar,emissiveIntensity:1.1,roughness:.95}),t.jsx(pt,{matrices:d,target:s})]})]})}const us={low:{pine:150,sakura:90,rock:60},mid:{pine:340,sakura:190,rock:130},high:{pine:620,sakura:340,rock:240}};function xi(e){let o=e>>>0;return()=>(o=Math.imul(o,1664525)+1013904223>>>0,o/4294967296)}function wi({quality:e="high",shadows:o=!0}){const n=w.useRef(),s=w.useRef(),i=w.useRef(),a=w.useRef(),{pineTrunkM:c,pineCanopyM:d,sakuraM:h,rockM:p}=w.useMemo(()=>{const f=us[e]??us.high,m=xi(20250801),l=new rt,u=new mt,x=new j,v=new j,b=new j(0,1,0),k=new j,z=[],r=[],M=[],F=f.pine+f.sakura+f.rock;let C=0,S=0;for(;C<F&&S<F*60;){S++;const R=m()*Math.PI*2,A=ft*(.55+m()*.62),B=de.x+Math.sin(R)*A,G=de.z+Math.cos(R)*A,$=re(B,G);if($<5||$>300||Rr(B,G,6)>.72||Math.hypot(B-L.x,G-L.z)<L.r*1.35)continue;const q=B>de.x+(m()-.5)*90,ee=C;if(C++,v.set(B,$,G),ee<f.rock){const P=Yn(B,G,5);k.set(P[0],P[1],P[2]),u.setFromUnitVectors(b,k),u.multiply(new mt().setFromEuler(new Dt(m()*.5,m()*6.28,m()*.5)));const K=2.5+m()*7;x.set(K*(.7+m()*.6),K*(.5+m()*.5),K*(.7+m()*.6)),v.y-=K*.25,M.push(l.clone().compose(v,u,x))}else if(q){if(z.length>=f.pine)continue;u.setFromEuler(new Dt(0,m()*6.28,(m()-.5)*.09));const P=.72+m()*.7;x.set(P,P*(.85+m()*.45),P),z.push(l.clone().compose(v,u,x))}else{if(r.length>=f.sakura)continue;u.setFromEuler(new Dt(0,m()*6.28,(m()-.5)*.13));const P=.7+m()*.75;x.set(P,P*(.8+m()*.5),P),r.push(l.clone().compose(v,u,x))}}return{pineTrunkM:z.map(R=>R.clone().multiply(bi)).concat(r.map(R=>R.clone().multiply(Mi))),pineCanopyM:z.map(R=>R.clone().multiply(yi)),sakuraM:r.map(R=>R.clone().multiply(vi)),rockM:M}},[e]),g=o;return t.jsxs(t.Fragment,{children:[t.jsxs("instancedMesh",{ref:n,args:[null,null,c.length],castShadow:g,children:[t.jsx("cylinderGeometry",{args:[.9,1.7,14,5]}),t.jsx("meshStandardMaterial",{color:"#1d1a1c",roughness:.96}),t.jsx(pt,{matrices:c,target:n})]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,d.length],castShadow:g,children:[t.jsx("coneGeometry",{args:[8.5,30,7]}),t.jsx("meshStandardMaterial",{color:Z.pine,roughness:.93,flatShading:!0}),t.jsx(pt,{matrices:d,target:s})]}),t.jsxs("instancedMesh",{ref:i,args:[null,null,h.length],castShadow:g,children:[t.jsx("sphereGeometry",{args:[7.5,8,6]}),t.jsx("meshStandardMaterial",{color:E.sakura,roughness:.95,flatShading:!0,emissive:E.sakura,emissiveIntensity:.1}),t.jsx(pt,{matrices:h,target:i})]}),t.jsxs("instancedMesh",{ref:a,args:[null,null,p.length],castShadow:g,receiveShadow:g,children:[t.jsx("dodecahedronGeometry",{args:[1,0]}),t.jsx("meshStandardMaterial",{color:Z.rock,roughness:.97,flatShading:!0}),t.jsx(pt,{matrices:p,target:a})]})]})}const bi=new rt().makeTranslation(0,7,0),yi=new rt().makeTranslation(0,26,0),vi=new rt().compose(new j(0,13,0),new mt,new j(1,.72,1)),Mi=new rt().compose(new j(0,5,0),new mt,new j(.75,.62,.75)),Mt=Math.PI,ps={"ship-sunny.opt.glb":Mt/2,"ship-tang.opt.glb":Mt/2,"ship-punk.opt.glb":Mt/2,"ship-lion.opt.glb":Mt/2,"ship-bone.opt.glb":Mt/2,"ship-junk.opt.glb":Mt/2,"ship-warjunk.opt.glb":Mt/2,"ship-sub.opt.glb":-Mt/2},en=e=>e&&ps[e]!==void 0?ps[e]:Mt/2,ji={"ship-sunny.opt.glb":40,"ship-lion.opt.glb":40,"ship-punk.opt.glb":52,"ship-tang.opt.glb":32,"ship-sub.opt.glb":32,"ship-bone.opt.glb":50,"ship-junk.opt.glb":38,"ship-warjunk.opt.glb":60},Ta=1.6,fs=Object.fromEntries(Object.entries(ji).map(([e,o])=>[e,Math.round(o*Ta)])),ms={"ship-sunny.opt.glb":.6,"ship-lion.opt.glb":.8,"ship-punk.opt.glb":.62,"ship-tang.opt.glb":.62,"ship-sub.opt.glb":.72,"ship-bone.opt.glb":.72,"ship-junk.opt.glb":.53,"ship-warjunk.opt.glb":.6},tn=2,gs={"ship-sunny.opt.glb":.513,"ship-lion.opt.glb":.213,"ship-punk.opt.glb":.118,"ship-tang.opt.glb":.208,"ship-sub.opt.glb":.256,"ship-bone.opt.glb":.308,"ship-junk.opt.glb":.313,"ship-warjunk.opt.glb":.415},xs={"ship-sunny.opt.glb":1.044,"ship-lion.opt.glb":.824,"ship-punk.opt.glb":.673,"ship-tang.opt.glb":1,"ship-sub.opt.glb":.641,"ship-bone.opt.glb":.771,"ship-junk.opt.glb":.915,"ship-warjunk.opt.glb":.702},ws={"ship-sunny.opt.glb":.13,"ship-lion.opt.glb":.13,"ship-punk.opt.glb":.075,"ship-bone.opt.glb":.13,"ship-junk.opt.glb":.13,"ship-warjunk.opt.glb":.13,"ship-tang.opt.glb":.05,"ship-sub.opt.glb":.05},_o=[[0,.26,0],[-.1,.02,.7],[.1,-.08,-.9],[0,-.27,Math.PI*.85]],Ea=e=>e==="low"?_o.slice(0,1):e==="mid"?_o.slice(0,2):_o,on=(e,o=34)=>e&&fs[e]!==void 0?fs[e]:o,nn=e=>e&&ms[e]!==void 0?ms[e]:1,Si=e=>e&&gs[e]!==void 0?gs[e]:.2,Ra=e=>e&&ws[e]!==void 0?ws[e]:.13,vo=e=>Math.max(0,Si(e)-Ra(e)),Nt=(e,o)=>Ra(e)*o,sn=(e,o)=>((e&&xs[e]!==void 0?xs[e]:.8)-vo(e))*o,Aa=210,bs={off:1,lead:.98*Ta*.77},ys={SPREAD:28,SWEEP:14},vs=(e,o=0)=>({off:e*ys.SPREAD,lead:o-Math.abs(e)*ys.SWEEP}),ki={scabbards:[0,Aa],"straw-hats":[-1,150],kid:[1,150],heart:[0,60]},zi=430*N;function Ti(e,o=0){const n=(820+-670*e)*N+o;return[(Math.sin(e*2.4)*54-e*26)*N,n]}function Ei(e,o,n,s){const[i,a]=Ti(n,s);return[i+o*N*bs.off,a-e*N*bs.lead]}const Ri=[{x:-300*N,z:100*N,yaw:.35},{x:330*N,z:360*N,yaw:-.55},{x:-390*N,z:470*N,yaw:.12},{x:420*N,z:830*N,yaw:-.28},{x:-455*N,z:930*N,yaw:.48},{x:400*N,z:1120*N,yaw:-.16},{x:-520*N,z:690*N,yaw:.22},{x:540*N,z:1290*N,yaw:-.42}],Ai=[{x:Q.x+132*N*.72,z:Q.z+96*N*.72,yaw:2.3},{x:Q.x+168*N*.72,z:Q.z+40*N*.72,yaw:1.9},{x:Q.x+96*N*.72,z:Q.z+150*N*.72,yaw:2.7}];function Ii({url:e,height:o,loa:n,slim:s=1,sink:i=0,rotation:a,tint:c,emissive:d,emissiveIntensity:h}){const{scene:p}=ma(e),g=w.useMemo(()=>p.clone(!0),[p]),f=w.useMemo(()=>{const m=new ga().setFromObject(g),l=new j;m.getSize(l);const u=new j;if(m.getCenter(u),n){const v=l.x>=l.z,b=Math.max(v?l.x:l.z,1e-4),k=n/b,z=v?[k,k,k*s]:[k*s,k,k];return{scale:z,offset:[-u.x*z[0],-m.min.y*z[1]-n*i,-u.z*z[2]]}}const x=l.y>1e-4?o/l.y:1;return{scale:[x,x,x],offset:[-u.x*x,-m.min.y*x,-u.z*x]}},[g,o,n,s,i]);return w.useEffect(()=>{g.traverse(m=>{if(m.isMesh&&(m.castShadow=!0,m.receiveShadow=!0,c&&m.material)){const l=Array.isArray(m.material)?m.material:[m.material];for(const u of l)u.color?.multiply(new ve(c)),d&&u.emissive&&(u.emissive.set(d),u.emissiveIntensity=h??.2)}})},[g,c,d,h]),t.jsx("group",{rotation:[0,a,0],scale:f.scale,position:f.offset,children:t.jsx("primitive",{object:g})})}class Ci extends w.Component{constructor(){super(...arguments);os(this,"state",{failed:!1})}static getDerivedStateFromError(){return{failed:!0}}componentDidCatch(n){}render(){return this.state.failed?this.props.fallback:this.props.children}}function ge({name:e,height:o,loa:n=null,slim:s=1,sink:i=0,rotation:a=0,position:c=[0,0,0],tint:d=null,emissive:h=null,emissiveIntensity:p=.2,fallback:g=null}){const f=wo(e);return ot(e)?t.jsx("group",{position:c,children:t.jsx(Ci,{url:f,fallback:g,children:t.jsx(w.Suspense,{fallback:g,children:t.jsx(Ii,{url:f,height:o,loa:n,slim:s,sink:i,rotation:a,tint:d,emissive:h,emissiveIntensity:p})})})}):t.jsx("group",{position:c,children:g})}const kn=(()=>{if(typeof document>"u")return null;const e=64,o=128,n=document.createElement("canvas");n.width=e,n.height=o;const s=n.getContext("2d"),i=s.createImageData(e,o);for(let c=0;c<o;c++){const d=c/(o-1),h=Math.pow(1-d,1.7);for(let p=0;p<e;p++){const g=p/(e-1)*2-1,f=Math.max(0,1-Math.abs(g)/(.35+d*.65)),m=.45+.55*Math.pow(Math.abs(g)/(.35+d*.65),1.5),l=h*Math.pow(f,1.4)*m,u=(c*e+p)*4;i.data[u]=255,i.data[u+1]=255,i.data[u+2]=255,i.data[u+3]=Math.round(Math.min(1,l)*255)}}s.putImageData(i,0,0);const a=new no(n);return a.colorSpace=so,a})(),Fi=(()=>{if(typeof document>"u")return null;const e=64,o=document.createElement("canvas");o.width=e,o.height=e;const n=o.getContext("2d"),s=n.createImageData(e,e);for(let a=0;a<e;a++){const c=a/(e-1),d=Math.pow(1-c,1.5);for(let h=0;h<e;h++){const p=h/(e-1)*2-1,g=Math.max(0,1-Math.abs(p)),f=d*Math.pow(g,1.3),m=(a*e+h)*4;s.data[m]=255,s.data[m+1]=255,s.data[m+2]=255,s.data[m+3]=Math.round(Math.min(1,f)*255)}}n.putImageData(s,0,0);const i=new no(o);return i.colorSpace=so,i})(),Bo=160,Qt=112,go="#e6dfcf",Ia="#0c0a15",Zt=Ia;typeof CanvasRenderingContext2D<"u"&&!CanvasRenderingContext2D.prototype.roundRect&&(CanvasRenderingContext2D.prototype.roundRect=function(e,o,n,s,i){const a=Math.min(i??0,Math.abs(n)/2,Math.abs(s)/2);return this.moveTo(e+a,o),this.arcTo(e+n,o,e+n,o+s,a),this.arcTo(e+n,o+s,e,o+s,a),this.arcTo(e,o+s,e,o,a),this.arcTo(e,o,e+n,o,a),this.closePath(),this});function Yt(e){if(typeof document>"u")return null;const o=document.createElement("canvas");o.width=Bo,o.height=Qt;const n=o.getContext("2d"),s=n.createLinearGradient(0,0,0,Qt);s.addColorStop(0,"#14101f"),s.addColorStop(.5,Ia),s.addColorStop(1,"#08060f"),n.fillStyle=s,n.fillRect(0,0,Bo,Qt),n.fillStyle="rgba(255,255,255,0.07)",n.fillRect(0,0,5,Qt),n.save(),n.translate(Bo/2+4,Qt/2);try{e(n)}catch(a){console.warn("[onigashima] flag emblem skipped",a)}n.restore();const i=new no(o);return i.colorSpace=so,i.anisotropy=4,i}function ln(e,o,n=go){e.fillStyle=n,e.beginPath(),e.ellipse(0,-o*.12,o,o*.92,0,0,Math.PI*2),e.fill(),e.beginPath(),e.roundRect(-o*.52,o*.6,o*1.04,o*.5,o*.16),e.fill()}function cn(e,o,n=1){e.save(),e.fillStyle=Zt,e.beginPath(),e.ellipse(-o*.38,-o*.2,o*.27*n,o*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.ellipse(o*.38,-o*.2,o*.27*n,o*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.moveTo(0,o*.06),e.lineTo(-o*.14,o*.34),e.lineTo(o*.14,o*.34),e.closePath(),e.fill(),e.restore()}function Ms(e,o,n=4){e.save(),e.fillStyle=Zt;for(let s=1;s<n;s++){const i=-o*.5+s*o/n;e.fillRect(i-o*.035,o*.6,o*.07,o*.5)}e.fillRect(-o*.52,o*.78,o*1.04,o*.05),e.restore()}function js(e,o,n=go){e.save(),e.strokeStyle=n,e.lineWidth=o*.17,e.lineCap="round";for(const s of[1,-1]){e.save(),e.rotate(s*Math.PI/4.4),e.beginPath(),e.moveTo(-o*1.55,o*.55),e.lineTo(o*1.55,o*.55),e.stroke(),e.fillStyle=n;for(const i of[-1,1])for(const a of[-.16,.16])e.beginPath(),e.arc(i*o*1.55,o*.55+a*o,o*.15,0,Math.PI*2),e.fill();e.restore()}e.restore()}const Pi={straw:Yt(e=>{js(e,26),ln(e,26),cn(e,26),Ms(e,26),e.fillStyle="#e8c86a",e.beginPath(),e.ellipse(0,-26*.86,26*1.5,26*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.roundRect(-26*.78,-26*1.5,26*1.56,26*.7,26*.22),e.fill(),e.fillStyle="#d63420",e.fillRect(-26*.8,-26*1.06,26*1.6,26*.22)}),heart:Yt(e=>{const n="#a8e8d4";e.fillStyle=n,e.beginPath(),e.ellipse(0,0,27*1.02,27*1,0,0,Math.PI*2),e.fill(),e.save(),e.fillStyle=Zt;for(const s of[-1,1])e.beginPath(),e.arc(s*27*.36,-27*.2,27*.2,0,Math.PI*2),e.fill();e.lineWidth=27*.13,e.strokeStyle=Zt,e.beginPath(),e.arc(0,27*.12,27*.52,.24*Math.PI,.76*Math.PI),e.stroke(),e.restore(),e.fillStyle="#d63420",e.beginPath(),e.moveTo(0,-27*1.34),e.bezierCurveTo(27*.5,-27*1.9,27*.9,-27*1.2,0,-27*.78),e.bezierCurveTo(-27*.9,-27*1.2,-27*.5,-27*1.9,0,-27*1.34),e.fill()}),kid:Yt(e=>{js(e,26,"#d8cfc0"),e.fillStyle=go,e.beginPath(),e.moveTo(-26*1.05,-26*.5),e.lineTo(-26*.7,-26*1.05),e.lineTo(26*.7,-26*1.05),e.lineTo(26*1.05,-26*.5),e.lineTo(26*.72,26*.5),e.lineTo(-26*.72,26*.5),e.closePath(),e.fill(),e.beginPath(),e.roundRect(-26*.62,26*.42,26*1.24,26*.62,26*.1),e.fill(),e.save(),e.fillStyle=Zt;for(const n of[-1,1])e.save(),e.translate(n*26*.4,-26*.3),e.rotate(n*.35),e.beginPath(),e.roundRect(-26*.28,-26*.2,26*.56,26*.4,26*.1),e.fill(),e.restore();for(let n=0;n<6;n++){const s=-15.6+n*26*1.2/5;e.beginPath(),e.moveTo(s,26*.42),e.lineTo(s+26*.1,26*1.04),e.lineTo(s-26*.1,26*1.04),e.closePath(),e.fill()}e.restore()}),kozuki:Yt(e=>{e.strokeStyle="#e8b06a",e.lineWidth=30*.1,e.beginPath(),e.arc(0,0,30*1.06,0,Math.PI*2),e.stroke(),e.fillStyle="#d63420";for(let n=0;n<5;n++){const s=n/5*Math.PI*2-Math.PI/2;e.save(),e.rotate(s),e.beginPath(),e.ellipse(0,-30*.52,30*.26,30*.42,0,0,Math.PI*2),e.fill(),e.restore()}e.fillStyle="#e8c86a",e.beginPath(),e.arc(0,0,30*.24,0,Math.PI*2),e.fill()}),mink:Yt(e=>{e.fillStyle=go;for(const n of[-1,1])e.beginPath(),e.moveTo(n*25*.5,-25*.85),e.lineTo(n*25*1.02,-25*1.72),e.lineTo(n*25*1.06,-25*.6),e.closePath(),e.fill();ln(e,25),e.beginPath(),e.roundRect(-25*.34,25*.42,25*.68,25*.78,25*.2),e.fill(),cn(e,25,.85),e.save(),e.fillStyle=Zt,e.fillRect(-25*.32,25*.72,25*.64,25*.06),e.restore(),e.fillStyle=go;for(const n of[-1,1])e.beginPath(),e.moveTo(n*25*.3,25*.7),e.lineTo(n*25*.42,25*1.42),e.lineTo(n*25*.16,25*.78),e.closePath(),e.fill()}),beasts:Yt(e=>{e.fillStyle="#cfd8e4";for(const n of[-1,1])e.beginPath(),e.moveTo(n*26*.62,-26*.78),e.quadraticCurveTo(n*26*1.5,-26*1.5,n*26*1.18,-26*2),e.quadraticCurveTo(n*26*1.42,-26*1.35,n*26*.86,-26*.5),e.closePath(),e.fill();ln(e,26,"#cfd8e4"),cn(e,26),Ms(e,26,5),e.fillStyle="#c9411a",e.beginPath(),e.roundRect(-26*.74,26*.34,26*1.48,26*.2,26*.1),e.fill()})},Ca={value:0},Ss=new Map;function Li(e){const o=Ss.get(e);if(o)return o;const n=Pi[e],s=new dr({map:n,emissiveMap:n,emissive:new ve("#9fb4d8"),emissiveIntensity:.62,roughness:.94,metalness:0,side:De,transparent:!1});return s.onBeforeCompile=i=>{i.uniforms.uTime=Ca,i.vertexShader=`uniform float uTime;
...
`,Es={low:1600,mid:3800,high:7e3},Ro=460;function Xi({quality:e}){const o=w.useRef(),n=we(a=>a.camera),s=w.useMemo(()=>{const a=Es[e]??Es.high,c=new Float32Array(a*3),d=new Float32Array(a),h=new Float32Array(a);for(let g=0;g<a;g++)c[g*3]=Math.random()*Ro,c[g*3+1]=Math.random()*Ro,c[g*3+2]=Math.random()*Ro,d[g]=.7+Math.random()*.6,h[g]=.55+Math.random()*.85;const p=new Lt;return p.setAttribute("position",new oe(c,3)),p.setAttribute("aSpeed",new oe(d,1)),p.setAttribute("aLen",new oe(h,1)),p.boundingSphere=new ao(new j,1e6),p},[e]),i=w.useMemo(()=>({uTime:{value:0},uCam:{value:new j},uBox:{value:Ro},uFall:{value:118},uSize:{value:2.4},uColor:{value:new j(...ie("#b9c8e4"))},uOpacity:{value:.5}}),[]);return ne((a,c)=>{const d=o.current?.uniforms;d&&(d.uTime.value+=c,d.uCam.value.copy(n.position),d.uOpacity.value=.5*y.rain*y.rain+y.flash*.3)}),t.jsx("points",{geometry:s,frustumCulled:!1,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:$i,fragmentShader:Ki,uniforms:i,transparent:!0,depthWrite:!1,fog:!1})})}const Qi=`
  uniform float uTime;
...
`,Rs={low:120,mid:340,high:700};function qi({quality:e}){const o=w.useRef(),n=w.useMemo(()=>{const i=Rs[e]??Rs.high,a=[Ae[0],Ae[1],he,he],c=new Float32Array(i*3),d=new Float32Array(i),h=new Float32Array(i),p=new Float32Array(i);for(let f=0;f<i;f++){const m=a[f%a.length];c[f*3]=m.x+(Math.random()-.5)*74,c[f*3+1]=m.y+(Math.random()-.5)*30,c[f*3+2]=m.z+(Math.random()-.5)*26,d[f]=Math.random(),h[f]=.045+Math.random()*.055,p[f]=2+Math.random()*4}const g=new Lt;return g.setAttribute("position",new oe(c,3)),g.setAttribute("aPhase",new oe(d,1)),g.setAttribute("aRise",new oe(h,1)),g.setAttribute("aSize",new oe(p,1)),g.boundingSphere=new ao(new j(0,300,-260),700),g},[e]),s=w.useMemo(()=>({uTime:{value:0},uColor:{value:new j(...ie(E.ember))}}),[]);return ne((i,a)=>{o.current&&(o.current.uniforms.uTime.value+=a)}),t.jsx("points",{geometry:n,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:Qi,fragmentShader:Zi,uniforms:s,transparent:!0,depthWrite:!1,blending:bt,fog:!1})})}function Ji({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(Vi,{quality:e}),t.jsx(Xi,{quality:e}),t.jsx(qi,{quality:e})]})}const el=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
...
`,As={low:150,mid:380,high:620};function ol({whirl:e,quality:o}){const n=w.useRef(),s=w.useRef(),i=w.useMemo(()=>{const c=As[o]??As.high,d=new Float32Array(c*3),h=new Float32Array(c),p=new Float32Array(c),g=new Float32Array(c),f=new Float32Array(c),m=new Float32Array(c);for(let u=0;u<c;u++)h[u]=Math.random()*Math.PI*2,p[u]=Math.random(),g[u]=.05+Math.random()*.05,f[u]=3+Math.random()*6,m[u]=Math.random();const l=new Lt;return l.setAttribute("position",new oe(d,3)),l.setAttribute("aAngle",new oe(h,1)),l.setAttribute("aPhase",new oe(p,1)),l.setAttribute("aRate",new oe(g,1)),l.setAttribute("aSize",new oe(f,1)),l.setAttribute("aJitter",new oe(m,1)),l.boundingSphere=new ao(new j(e.x,0,e.z),e.r*1.6+40),l},[o,e]),a=w.useMemo(()=>({uTime:{value:0},uCentre:{value:new _n(e.x,e.z)},uR:{value:e.r},uDepth:{value:e.depth},uDir:{value:e.dir},uColor:{value:new j(...ie(Z.foam))},uGain:{value:1}}),[e]);return ne((c,d)=>{const h=n.current?.uniforms;if(!h)return;h.uTime.value+=d;const p=Math.hypot(c.camera.position.x-e.x,c.camera.position.z-e.z);h.uGain.value=1-T.smoothstep(p,1600,2400),s.current&&(s.current.visible=h.uGain.value>.02)}),t.jsx("points",{ref:s,geometry:i,renderOrder:2,children:t.jsx("shaderMaterial",{ref:n,vertexShader:el,fragmentShader:tl,uniforms:a,transparent:!0,depthWrite:!1,blending:bt,fog:!1})})}function nl({quality:e="high"}){const o=we(n=>n.camera);return ne(()=>{let n=0;for(const s of Ne){const i=Math.hypot(o.position.x-s.x,o.position.z-s.z);n=Math.max(n,1-T.smoothstep(i,s.r*.3,s.r*2.2))}y.whirlNear+=(n-y.whirlNear)*.05}),t.jsx(t.Fragment,{children:Ne.map((n,s)=>t.jsx(ol,{whirl:n,quality:e},s))})}const Y={rev:0,chain:null,step:0,hull:1,grip:0,clock:0,banner:null,done:!1,hits:0},eo={helm:[{text:"PASS THE OUTER GATE",hint:"The island’s marker, alone in open water. Straight through it.",test:e=>e.z<Jt-60},{text:"HOLD THE FAIRWAY",hint:"Whirlpools both flanks — the middle is the only clean water.",test:e=>e.toGate<420*N},{text:"RUN THE TORII",hint:"Between the columns — the batteries cannot depress that far.",test:e=>e.z<Pt-40},{text:"THREAD THE NECK",hint:"The walls close to a hundred metres. Mind your helm.",test:e=>e.z<120*N},{text:"MOOR AT THE PORT",hint:"Under the burning face. Come in slow.",test:e=>e.moored}],sub:[{text:"TAKE HER DOWN",hint:"Below thirty-five metres the maelstroms cannot reach you.",test:e=>e.depth>35},{text:"RUN UNDER THE BACK-DOOR MAELSTROM",hint:"Straight through where the surface is turning. Stay deep.",test:e=>{const o=Sr("back-door");return Math.hypot(e.x-o.x,e.z-o.z)<o.r*1.1&&e.depth>30}},{text:"FIND THE FJORD",hint:"North-east flank, a crack in the cliffs. It is not on any chart.",test:e=>e.toRear<420},{text:"SURFACE IN THE COVE",hint:"Blow ballast. The back door is above you.",test:e=>e.toRear<U.pool*1.3&&e.depth<3}],foot:[{text:"GET INSIDE THE SKULL",hint:"The mouth above the port, or the gate at the back of the cove.",test:e=>e.area==="hall"},{text:"CROSS THE LIVE FLOOR",hint:"The stage is at the far end, under the keep.",test:e=>e.area==="hall"&&e.lz!=null&&e.lz<40},{text:"CLIMB TO THE STAGE",hint:"The vermilion ramps either side of the approach.",test:e=>e.fy!=null&&e.fy>60},{text:"TAKE THE ROOF",hint:"The stair tower on the east flank goes all the way up.",test:e=>e.fy!=null&&e.fy>230}]},sl=e=>eo[e]?eo[e].length:0,al=()=>Y.chain&&eo[Y.chain]?eo[Y.chain][Y.step]??null:null;function Rn(e){Y.chain=eo[e]?e:null,Y.step=0,Y.hull=1,Y.grip=0,Y.clock=0,Y.done=!1,Y.banner=null,Y.rev++}function Qo(e,o,n=3.4){Y.banner={text:e,sub:o,until:Y.clock+n},Y.rev++}function Ht(e,o){Y.hull<=0||(Y.hull=Math.max(0,Y.hull-e),Y.hits++,Y.hull<=0?Qo("HULL BREACHED","She is going down — the raid goes on without you",5):o&&e>.04&&Qo(o,null,2.2),Y.rev++)}function Fa(e,o){if(Y.clock+=e,Y.banner&&Y.clock>Y.banner.until&&(Y.banner=null,Y.rev++),!Y.chain||Y.done||!o)return;const n=eo[Y.chain],s=n[Y.step];if(!s)return;let i=!1;try{i=!!s.test(o)}catch{i=!1}i&&(Y.step++,Y.step>=n.length?(Y.done=!0,Qo("OBJECTIVE COMPLETE",rl[Y.chain]??"",6)):Qo(n[Y.step].text,n[Y.step].hint,3.6),Y.rev++)}const rl={helm:"Moored under the face. The alliance is ashore.",sub:"Surfaced at the back door, unseen. Law would approve.",foot:"The roof of the demon castle. The whole bay is below you."};function Pa(e,{danger:o,headingX:n,headingZ:s,toCentreX:i,toCentreZ:a,speed:c,throttle:d}){if(o<=.001)return Y.grip=Math.max(0,Y.grip-e*.5),Y.grip;const h=Math.hypot(i,a)||1,p=-i/h,g=-a/h,f=n*p+s*g,m=Math.min(1,Math.abs(c)/22),l=o*.42,u=Math.max(0,f)*m*(.35+.45*Math.min(1,Math.abs(d)));return Y.grip=Math.max(0,Math.min(1,Y.grip+(l-u)*e)),Y.grip}const Is=24,un=Vo.safe,Cs=Vo.range,lo=2.1,il=1.5,Fs=22,ll=[Pt,Jt],cl=new rt,pn=new j,Ps=new mt,fn=new j;function hl({quality:e="high"}){const o=w.useRef(),n=w.useMemo(()=>Array.from({length:Is},()=>({live:!1,x:0,z:0,y0:0,t:0})),[]),s=w.useRef(0),i=w.useMemo(()=>{const a=new xa(.55,1,1,e==="low"?6:10,1,!0);return a.translate(0,.5,0),a},[e]);return ne((a,c)=>{const d=o.current;if(!d)return;const h=Math.min(c,.05),p=y.helm;if(y.helmActive&&p&&!p.onFoot&&!p.sub&&!p.moored){let m=null,l=1/0;for(const u of ll){const x=Math.hypot(p.x,p.z-u);x<un||x>Cs||x<l&&(l=x,m=u)}if(m!==null&&(s.current-=h,s.current<=0)){const u=1-T.clamp((l-un)/(Cs-un),0,1);s.current=T.lerp(4.5,1.9,u);const x=n.find(v=>!v.live);if(x){const v=lo*.55,b=T.lerp(230,105,u);x.x=p.x+Math.sin(p.heading)*p.speed*v+(Math.random()-.5)*b,x.z=p.z+Math.cos(p.heading)*p.speed*v+(Math.random()-.5)*b,x.y0=210+Math.random()*60,x.t=0,x.live=!0}}}let f=0;for(const m of n){if(!m.live)continue;const l=m.t;if(m.t+=h,m.t<lo){const u=m.t/lo;pn.set(m.x,m.y0*(1-u*u),m.z),fn.set(2.2,9,2.2)}else{if(l<lo){const v=Math.hypot(m.x-p.x,m.z-p.z);v<Fs&&Ht(.03*(1-v/Fs)+.008,"HIT — SHOT THROUGH THE RIGGING"),y.splash+=1}const u=(m.t-lo)/il;if(u>=1){m.live=!1;continue}const x=Math.min(1,u*4);pn.set(m.x,ut(m.x,m.z,y.t,1).y-4,m.z),fn.set(11+u*9,78*x*(1-u*u*.75),11+u*9)}Ps.identity(),d.setMatrixAt(f,cl.compose(pn,Ps,fn)),f++}d.count=f,d.instanceMatrix.needsUpdate=!0,d.visible=f>0}),t.jsx("instancedMesh",{ref:o,args:[i,void 0,Is],frustumCulled:!1,renderOrder:2,visible:!1,children:t.jsx("meshBasicMaterial",{color:Z.foam,transparent:!0,opacity:.42,depthWrite:!1,toneMapped:!1,blending:bt,side:De})})}const dl=`
  uniform float uTime;
  uniform vec3  uCam;
  uniform float uBox;
  attribute float aSpeed;
...
`,Ls={low:700,mid:1800,high:3200},Ao=260;function pl({quality:e}){const o=w.useRef(),n=w.useRef(),s=we(c=>c.camera),i=w.useMemo(()=>{const c=Ls[e]??Ls.high,d=new Float32Array(c*3),h=new Float32Array(c),p=new Float32Array(c),g=new Float32Array(c);for(let m=0;m<c;m++)d[m*3]=Math.random()*Ao,d[m*3+1]=Math.random()*Ao,d[m*3+2]=Math.random()*Ao,h[m]=.5+Math.random()*1.4,p[m]=1.2+Math.random()*3.2,g[m]=Math.random();const f=new Lt;return f.setAttribute("position",new oe(d,3)),f.setAttribute("aSpeed",new oe(h,1)),f.setAttribute("aSize",new oe(p,1)),f.setAttribute("aPhase",new oe(g,1)),f.boundingSphere=new ao(new j,1e6),f},[e]),a=w.useMemo(()=>({uTime:{value:0},uCam:{value:new j},uBox:{value:Ao},uColor:{value:new j(...ie("#cfeee6"))},uGain:{value:0}}),[]);return ne((c,d)=>{const h=o.current?.uniforms;h&&(h.uTime.value+=d,h.uCam.value.copy(s.position),h.uGain.value=y.underwater,n.current&&(n.current.visible=y.underwater>.02))}),t.jsx("points",{ref:n,geometry:i,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:o,vertexShader:dl,fragmentShader:ul,uniforms:a,transparent:!0,depthWrite:!1,fog:!1})})}const fl=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
  uniform float uDir;
...
`,Gs={low:260,mid:700,high:1300},gl=`
  varying vec2 vUv;
  varying vec3 vWorld;
  void main() {
    vUv = uv;
...
`,Os=1100;function wl({whirl:e,quality:o}){const n=w.useRef(),s=w.useRef(),i=we(d=>d.camera),a=w.useMemo(()=>{const d=o==="low"?24:o==="mid"?34:48,h=new xa(e.r*1.02,e.r*.07,Os,d,6,!0);return h.translate(e.x,-Os/2-3,e.z),h},[e,o]),c=w.useMemo(()=>({uTime:{value:0},uDir:{value:e.dir},uGain:{value:0},uColor:{value:new j(...ie(Z.foam))},uDeep:{value:new j(...ie(Z.underGlow))},uCameraPos:{value:new j},uFogDensity:{value:.0062},uFogColor:{value:new j(...ie(Z.underHaze))}}),[e]);return ne((d,h)=>{const p=n.current?.uniforms;if(!p)return;p.uTime.value+=h,p.uCameraPos.value.copy(d.camera.position),p.uFogDensity.value=d.scene.fog?.density??.0062;const g=d.scene.fog?.color;g&&p.uFogColor.value.set(g.r,g.g,g.b);const f=Math.hypot(i.position.x-e.x,i.position.z-e.z),m=1-T.smoothstep(f,e.r*8,e.r*24);p.uGain.value+=(y.underwater*m-p.uGain.value)*Math.min(1,h*4),s.current&&(s.current.visible=p.uGain.value>.012)}),t.jsx("mesh",{ref:s,geometry:a,frustumCulled:!1,renderOrder:2,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:gl,fragmentShader:xl,uniforms:c,transparent:!0,depthWrite:!1,side:De,blending:bt,fog:!1})})}function bl({whirl:e,quality:o}){const n=w.useRef(),s=w.useRef(),i=we(d=>d.camera),a=w.useMemo(()=>{const d=Gs[o]??Gs.high,h=new Float32Array(d*3),p=new Float32Array(d),g=new Float32Array(d),f=new Float32Array(d),m=new Float32Array(d),l=new Float32Array(d);for(let x=0;x<d;x++)p[x]=Math.random()*Math.PI*2,g[x]=Math.random(),f[x]=.07+Math.random()*.1,m[x]=.12+Math.pow(Math.random(),1.8)*.5,l[x]=2+Math.random()*5;const u=new Lt;return u.setAttribute("position",new oe(h,3)),u.setAttribute("aAngle",new oe(p,1)),u.setAttribute("aPhase",new oe(g,1)),u.setAttribute("aRate",new oe(f,1)),u.setAttribute("aRadius",new oe(m,1)),u.setAttribute("aSize",new oe(l,1)),u.boundingSphere=new ao(new j(e.x,-60,e.z),e.r+140),u},[o,e]),c=w.useMemo(()=>({uTime:{value:0},uCentre:{value:new _n(e.x,e.z)},uR:{value:e.r},uDir:{value:e.dir},uDepth:{value:340},uColor:{value:new j(...ie(Z.underGlow))},uGain:{value:0}}),[e]);return ne((d,h)=>{const p=n.current?.uniforms;if(!p)return;p.uTime.value+=h;const g=Math.hypot(i.position.x-e.x,i.position.z-e.z),f=1-T.smoothstep(g,e.r*1.2,e.r*4);p.uGain.value=y.underwater*f,s.current&&(s.current.visible=p.uGain.value>.015)}),t.jsx("points",{ref:s,geometry:a,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:fl,fragmentShader:ml,uniforms:c,transparent:!0,depthWrite:!1,blending:bt,fog:!1})})}function yl({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(pl,{quality:e}),Ne.map((o,n)=>t.jsx(bl,{whirl:o,quality:e},n)),Ne.map((o,n)=>t.jsx(wl,{whirl:o,quality:e},`w${n}`))]})}const Zo=16/9,La=96,Ga=78;function An(e,o,n=La){if(!o||o>=Zo)return e;const s=T.degToRad(e)/2,i=2*Math.atan(Math.tan(s)*Zo/o);return Math.min(n,T.radToDeg(i))}function Oa(e){return!e||e>=Zo?1:T.clamp(.72+.28*(e/Zo),.86,1)}function In(e,o,n,s=.06,i=La){const a=An(o,e.aspect,i);Math.abs(e.fov-a)<=.05||(e.fov+=(a-e.fov)*(1-Math.pow(s,n)),e.updateProjectionMatrix())}function Cn(e=1){const o=typeof window<"u"&&window.innerWidth||1280;return e*T.clamp(1280/o,.55,2.2)}const Da="oni.settings.v1";function vl(){return typeof navigator>"u"?!1:typeof window<"u"&&window.matchMedia?.("(pointer: coarse)")?.matches?!0:navigator.maxTouchPoints>0}const Me={comfort:0,lookSens:1,invertY:!1,freeCam:!1},Fn=new Set;function Na(){for(const e of Fn)e(Me)}function Ha(e){return Fn.add(e),()=>Fn.delete(e)}function Kn(e,o){e in Me&&(Me[e]=o,Sl(),Na())}function qo(e){Kn(e,!Me[e])}function Ml(){Kn("comfort",Me.comfort<.01?.55:Me.comfort<.9?1:0)}function jl(){const e=[.6,.85,1,1.35,1.8],o=e.findIndex(n=>n>=Me.lookSens-1e-6);Kn("lookSens",e[(o+1)%e.length])}function Sl(){try{localStorage.setItem(Da,JSON.stringify(Me))}catch{}}function kl(){let e=null;try{e=JSON.parse(localStorage.getItem(Da)||"null")}catch{e=null}if(e&&typeof e=="object")for(const o of Object.keys(Me))typeof e[o]==typeof Me[o]&&(Me[o]=e[o]);else Me.comfort=vl()?1:0;return Na(),Me}const Pe=(e,o)=>e+(o-e)*Me.comfort,co=e=>e<-1?-1:e>1?1:e,I={throttle:0,rudder:0,planes:0,boost:!1,walk:{x:0,z:0},surfaceQueued:!1,periscopeQueued:!1,burstQueued:!1,recentreQueued:!1,jumpQueued:!1,boardQueued:!1,pistolQueued:!1,bazookaQueued:!1,gigantQueued:!1,rocketQueued:!1,hakiQueued:!1,gear2Queued:!1,gatlingHeld:!1,balloonHeld:!1,zoom:0},zt={level:0},Pn=new Set;function zl(e){return Pn.add(e),()=>Pn.delete(e)}function Xn(e){if(zt.level===e)return e;zt.level=e;for(const o of Pn)o(e);return e}function _a(){return Xn((zt.level+1)%3)}const J={active:!1,throttle:0,rudder:0,planes:0,boost:!1,walk:{x:0,z:0},gatling:!1,balloon:!1},xo=new Set,ct=(...e)=>e.some(o=>xo.has(o));function Ba(){I.throttle=0,I.rudder=0,I.planes=0,I.boost=!1,I.walk.x=0,I.walk.z=0,I.surfaceQueued=!1,I.periscopeQueued=!1,I.burstQueued=!1,I.recentreQueued=!1,I.jumpQueued=!1,I.boardQueued=!1,I.zoom=0,I.pistolQueued=!1,I.bazookaQueued=!1,I.gigantQueued=!1,I.rocketQueued=!1,I.hakiQueued=!1,I.gear2Queued=!1,I.gatlingHeld=!1,I.balloonHeld=!1,J.gatling=!1,J.balloon=!1,Xn(0),J.throttle=0,J.rudder=0,J.planes=0,J.boost=!1,J.walk.x=0,J.walk.z=0,xo.clear()}function Tl(){const e=i=>!!i&&(i.isContentEditable||/^(input|textarea|select)$/i.test(i.tagName??"")),o=i=>{if(i.metaKey||i.ctrlKey||i.altKey||e(i.target))return;const a=i.key.toLowerCase();xo.add(a),a==="f"&&(I.surfaceQueued=!0),a==="p"&&(I.periscopeQueued=!0),a==="b"&&!i.repeat&&(I.burstQueued=!0),a==="r"&&!i.repeat&&(I.recentreQueued=!0),a==="v"&&!i.repeat&&qo("freeCam"),a==="x"&&!i.repeat&&_a(),a===" "&&!i.repeat&&(I.jumpQueued=!0),a==="t"&&!i.repeat&&(I.boardQueued=!0),a==="j"&&!i.repeat&&(I.pistolQueued=!0),a==="k"&&!i.repeat&&(I.bazookaQueued=!0),a==="l"&&!i.repeat&&(I.gigantQueued=!0),a==="g"&&!i.repeat&&(I.rocketQueued=!0),a==="h"&&!i.repeat&&(I.hakiQueued=!0),a==="n"&&!i.repeat&&(I.gear2Queued=!0),[" ","arrowup","arrowdown","arrowleft","arrowright"].includes(a)&&i.preventDefault()},n=i=>xo.delete(i.key.toLowerCase()),s=()=>Ba();return window.addEventListener("keydown",o,{passive:!1}),window.addEventListener("keyup",n),window.addEventListener("blur",s),()=>{window.removeEventListener("keydown",o),window.removeEventListener("keyup",n),window.removeEventListener("blur",s),xo.clear()}}function El(){const e=ct("w","arrowup")?1:0,o=ct("s","arrowdown")?1:0,n=ct("a","arrowleft")?1:0,s=ct("d","arrowright")?1:0,i=ct("q"," ")?1:0,a=ct("e","c")?1:0,c=co(e-o+J.throttle);c<-.05&&zt.level&&Xn(0),I.throttle=zt.level>0?Math.max(c,1):c,I.rudder=co(n-s+J.rudder),I.planes=co(i-a+J.planes),I.boost=ct("shift")||J.boost||zt.level===2,I.zoom=(ct("]","=","+")?1:0)-(ct("[","-","_")?1:0),I.gatlingHeld=ct("u")||J.gatling,I.balloonHeld=ct("i")||J.balloon,I.walk.x=co(s-n+J.walk.x),I.walk.z=co(e-o+J.walk.z)}const Ln=[0,(Ae[0].y+Ae[1].y)/2,Ae[0].z],Ua=[he.x,he.y,he.z],Jo=U.dir,Wa=[U.x+Jo[0]*300,-36,U.z+Jo[1]*300],Ya=[U.x+Jo[0]*46,34,U.z+Jo[1]*46],Va=[U.gate.x,4,U.gate.z],$a=[U.gate.x,22,U.gate.z],Rl=1.55,Gn=N/Rl,Al=1+(Gn-1)*.35,xt=[{id:"sea",title:"THE SEA IS FOR PIRATES",sub:"Wano Country · night of the Fire Festival",dur:13,fov:52,from:[-294,31,1364],to:[-186,23,1150],lookFrom:[62,140,465],lookTo:[16,108,294],swell:1},{id:"fleet",title:"THE ALLIANCE SAILS",sub:"Nine Red Scabbards · Straw Hats · Heart · Kid · Mink · Yakuza",dur:12,fov:46,from:[304,38,1299],to:[229,31,1150],lookFrom:[121,65,760],lookTo:[62,90,577],swell:1},{id:"torii",title:"THE TORII",sub:"First line of defence — the gate at sea",dur:14,fov:58,from:[53,24,877],to:[9,62,580],lookFrom:[0,115,400],lookTo:[0,205,400],swell:.7},{id:"neck",title:"THROUGH THE GATE",sub:"The channel — the only way in",dur:12,fov:64,from:[0,36,521],to:[-22,89,198],lookFrom:[0,161,186],lookTo:[-31,326,-232],swell:.35},{id:"bay",title:"ONIGASHIMA",sub:"鬼ヶ島 — the island of demons",dur:15,fov:56,from:[-31,134,276],to:[-81,182,68],lookFrom:[0,310,-264],lookTo:Ln,swell:.12},{id:"port",title:"THE PORT",sub:"Lanterns, and a sword in the ground",dur:13,fov:48,from:[143,55,102],to:[53,43,-12],lookFrom:[-149,59,-161],lookTo:[-53,205,-276],swell:.06},{id:"backdoor",title:"THE BACK DOOR",sub:"Heart Pirates — under the maelstroms, up the hidden fjord",dur:12,fov:60,from:Wa,to:Ya,lookFrom:Va,lookTo:$a,swell:0},{id:"face",title:"KAIDOU OF THE BEASTS",sub:"Skull Dome — the raid begins",dur:17,fov:50,from:[-149,41,40],to:[16,360,189],lookFrom:Ua,lookTo:Ln,swell:0}],Il=new Set([Ln,Ua,Wa,Ya,Va,$a]),Io=e=>Il.has(e)?e:[e[0]*Gn,e[1]*Al,e[2]*Gn];for(const e of xt)e.from=Io(e.from),e.to=Io(e.to),e.lookFrom=Io(e.lookFrom),e.lookTo=Io(e.lookTo);const On=xt.reduce((e,o)=>e+o.dur,0),Ds=xt,Cl=e=>e*e*(3-2*e),Fl=e=>1-Math.pow(1-e,2.2),Co=e=>new j(e[0],e[1],e[2]),Ct={dist:[24,3600],pitch:[-.95,1.44],y:[-260,1500],xz:4200};function Pl(e,o){w.useEffect(()=>{if(!e)return;const n=o.domElement,s=new Map;let i=0,a=null;const c=(f,m)=>{const l=y.orbit,u=l.dist*.0016,x=Math.cos(l.yaw),v=-Math.sin(l.yaw);l.target.x-=x*f*u,l.target.z-=v*f*u;const b=Math.cos(l.pitch),k=Math.sin(l.pitch);l.target.y+=m*u*b,l.target.x+=Math.sin(l.yaw)*m*u*k,l.target.z+=Math.cos(l.yaw)*m*u*k,Ka()},d=f=>{s.set(f.pointerId,{x:f.clientX,y:f.clientY});try{n.setPointerCapture?.(f.pointerId)}catch{}if(s.size===2){const[m,l]=[...s.values()];i=Math.hypot(m.x-l.x,m.y-l.y),a={x:(m.x+l.x)/2,y:(m.y+l.y)/2}}},h=f=>{const m=s.get(f.pointerId);if(!m)return;const l=f.clientX-m.x,u=f.clientY-m.y;if(m.x=f.clientX,m.y=f.clientY,s.size>=2){const[x,v]=[...s.values()],b=Math.hypot(x.x-v.x,x.y-v.y),k={x:(x.x+v.x)/2,y:(x.y+v.y)/2};if(i>8&&b>8){const z=y.orbit;z.dist=T.clamp(z.dist*(i/b),...Ct.dist)}a&&c(k.x-a.x,k.y-a.y),i=b,a=k,f.cancelable&&f.preventDefault();return}if(f.shiftKey||f.buttons===4)c(l,u);else{const x=y.orbit;x.yaw-=l*.005*Cn(),x.pitch=T.clamp(x.pitch+u*.004*Cn(),...Ct.pitch)}f.cancelable&&f.preventDefault()},p=f=>{s.delete(f.pointerId)&&s.size<2&&(i=0,a=null)},g=f=>{f.preventDefault();const m=y.orbit;m.dist=T.clamp(m.dist*(1+Math.sign(f.deltaY)*.11),...Ct.dist)};return n.addEventListener("pointerdown",d),n.addEventListener("pointermove",h,{passive:!1}),n.addEventListener("pointerup",p),n.addEventListener("pointercancel",p),window.addEventListener("pointerup",p),n.addEventListener("wheel",g,{passive:!1}),()=>{n.removeEventListener("pointerdown",d),n.removeEventListener("pointermove",h),n.removeEventListener("pointerup",p),n.removeEventListener("pointercancel",p),window.removeEventListener("pointerup",p),n.removeEventListener("wheel",g),s.clear()}},[e,o])}function Ka(){const e=y.orbit;e.target.x=T.clamp(e.target.x,-4200,Ct.xz),e.target.z=T.clamp(e.target.z,-4200,Ct.xz),e.target.y=T.clamp(e.target.y,...Ct.y)}function Ll({onRails:e,playing:o,speed:n=1,onShot:s,idle:i=!1}){const a=we(g=>g.camera),c=we(g=>g.gl),d=w.useRef(0),h=w.useRef(-1),p=w.useRef(new j(0,150,-260));return Pl(!e&&!i,c),w.useEffect(()=>{if(e)return;const g=y.orbit,f=a.position.clone().sub(g.target);g.dist=T.clamp(f.length(),...Ct.dist),g.yaw=Math.atan2(f.x,f.z),g.pitch=Math.asin(T.clamp(f.y/(f.length()||1),-1,1))},[e,a]),ne((g,f)=>{if(i)return;const m=Math.min(f,.05);if(y.t+=m,e){if(y.jumpTo!=null){let R=0;for(let A=0;A<y.jumpTo&&A<xt.length;A++)R+=xt[A].dur;d.current=R,y.jumpTo=null}o&&(d.current=(d.current+m*n)%On);let b=0,k=0;for(;k<xt.length&&!(d.current<b+xt[k].dur);k++)b+=xt[k].dur;const z=xt[Math.min(k,xt.length-1)],r=T.clamp((d.current-b)/z.dur,0,1);h.current!==k&&(h.current=k,y.shot=k,s?.(k,z));const M=Co(z.from).lerp(Co(z.to),Fl(r)),F=Co(z.lookFrom).lerp(Co(z.lookTo),Cl(r)),C=z.swell??0;if(C>0){const R=y.t;M.y+=Math.sin(R*.62)*3.1*C+Math.sin(R*1.31+1.2)*1.2*C,M.x+=Math.sin(R*.44+.6)*2.2*C}M.x+=Math.sin(y.t*.83)*.35,M.y+=Math.sin(y.t*1.17+2)*.28,a.position.copy(M),p.current.lerp(F,1-Math.pow(1e-4,m)),a.lookAt(p.current),C>0&&a.rotateZ(Math.sin(y.t*.51)*.024*C);const S=An(z.fov,a.aspect);Math.abs(a.fov-S)>.01&&(a.fov+=(S-a.fov)*(1-Math.pow(.02,m)),a.updateProjectionMatrix()),y.progress=d.current/On}else{const b=y.orbit;I.recentreQueued&&(I.recentreQueued=!1,b.target.set(L.x,L.baseY*.55,L.z),b.dist=T.clamp(b.dist,260,1400));const k=I.walk.x,z=I.walk.z;if(k||z||I.planes||I.zoom){const F=b.dist*(I.boost?1.9:.7)*m,C=-Math.sin(b.yaw),S=-Math.cos(b.yaw);b.target.x+=(C*z-S*k)*F,b.target.z+=(S*z+C*k)*F,b.target.y+=I.planes*F,b.dist=T.clamp(b.dist*(1-I.zoom*.9*m),...Ct.dist),Ka()}const r=Math.cos(b.pitch);a.position.set(b.target.x+Math.sin(b.yaw)*r*b.dist,b.target.y+Math.sin(b.pitch)*b.dist,b.target.z+Math.cos(b.yaw)*r*b.dist),a.lookAt(b.target);const M=An(55,a.aspect);Math.abs(a.fov-M)>.01&&(a.fov+=(M-a.fov)*(1-Math.pow(.02,m)),a.updateProjectionMatrix()),y.t+=0}const l=bo(a.position.x,a.position.z);y.shelter+=(l-y.shelter)*(1-Math.pow(.06,m)),y.fog=T.lerp(Ft.sea,Ft.bay,y.shelter),y.rain=1-y.shelter*.92;const u=ut(a.position.x,a.position.z,y.t,1),x=T.clamp((u.y-a.position.y-1)/3,0,1);y.underwater+=(x-y.underwater)*(1-Math.pow(.002,m)),y.depthBelow=Math.max(0,u.y-a.position.y);const v=T.lerp(8200,1700,y.underwater);Math.abs(a.far-v)>20&&(a.far=v,a.updateProjectionMatrix()),g.camera.updateMatrixWorld()}),null}const Ns={low:[24,16],mid:[40,26],high:[56,36]};function Gl({quality:e="high",shadows:o=!0}){const n=w.useRef(),s=w.useRef(),i=w.useMemo(()=>{const[m,l]=Ns[e]??Ns.high,u=new ur(1,m,l),x=u.attributes.position,v=new Float32Array(x.count*3),[b,k,z]=Ce.centre,[r,M,F]=Ce.radii,C=new ve("#241c22"),S=new ve(E.rockWarm),R=new ve;for(let A=0;A<x.count;A++){const B=x.getX(A),G=x.getY(A),$=x.getZ(A),q=1+(qt(B*2.4+5,$*2.4-9,3)-.5)*.14;x.setXYZ(A,b+B*r*q,k+G*M*q,z+$*F*q);const ee=T.clamp((G+.2)/1.2,0,1);R.copy(C).lerp(S,(1-ee)*.55),v[A*3]=R.r,v[A*3+1]=R.g,v[A*3+2]=R.b}return u.setAttribute("color",new oe(v,3)),u.computeVertexNormals(),u},[e]),{stairM:a,brazierM:c,bayM:d,tableM:h,jarM:p,westStairM:g}=w.useMemo(()=>{const m=new rt,l=new mt,u=new j(1,1,1),x=new j,v=[];for(let P=0;P<lt.steps;P++){const K=P/(lt.steps-1);x.set(0,T.lerp(Le.y,le.y+2,K),T.lerp(lt.zTop,lt.zBottom,K)),l.identity(),v.push(m.clone().compose(x,l,u))}const b=[],k=e==="low"?5:9;for(const P of[-1,1])for(let K=0;K<k;K++){const ae=K/(k-1);x.set(P*176,le.y+9,T.lerp(le.zFront-40,le.zBack+40,ae)),l.identity(),b.push(m.clone().compose(x,l,u))}for(let P=0;P<6;P++)x.set(-110+P*44,le.y+9,O.z+O.halfZ+54),l.identity(),b.push(m.clone().compose(x,l,u));const z=[],r=e==="low"?5:9;for(const P of[-1,1])for(let K=0;K<xe.tiers;K++)for(let ae=0;ae<r;ae++){const H=ae/(r-1);x.set(P*(xe.x-K*26),xe.y+K*xe.tierRise,T.lerp(-205,xe.halfZ,H)),l.identity(),z.push(m.clone().compose(x,l,u))}const M=[],F=[],C=new mt,S=new j(0,1,0);let R=24301;const A=()=>(R=Math.imul(R,1664525)+1013904223>>>0,R/4294967296),B=e==="low"?1:2,G=e==="low"?5:8;for(const P of[-1,1])for(let K=0;K<B;K++)for(let ae=0;ae<G;ae++){const H=P*(96+K*52+(A()-.5)*14),te=T.lerp(le.zBack+120,le.zFront-60,ae/(G-1))+(A()-.5)*16;if(!(Math.abs(H)<ke.halfX+24&&Math.abs(te-ke.z)<ke.halfZ+20)&&!(Math.abs(Math.abs(H)-me.x)<26&&te<me.zFoot+16&&te>me.zTop-8)){x.set(H,le.y+2.4,te),C.setFromAxisAngle(S,(A()-.5)*.5),M.push(m.clone().compose(x,C,u));for(let be=0;be<2;be++)x.set(H+(A()-.5)*30,le.y+3.5,te+(A()>.5?8:-8)+(A()-.5)*6),C.setFromAxisAngle(S,A()*Math.PI),F.push(m.clone().compose(x,C,u))}}const $=[],q=16,ee=P=>P*P*(3-2*P);for(let P=0;P<=q;P++){const K=P/q;x.set(-252,ee(K)*(xe.y-.5)-1.3,T.lerp(45,-45,K)),l.identity(),$.push(m.clone().compose(x,l,u))}return{stairM:v,brazierM:b,bayM:z,tableM:M,jarM:F,westStairM:$}},[e]);ne(()=>{const m=y.t;n.current&&(n.current.material.emissiveIntensity=2.6+Math.sin(m*4.1)*.3+Math.sin(m*9.3)*.15),s.current&&(s.current.material.emissiveIntensity=.85+Math.sin(m*.9)*.12)});const f=o;return t.jsxs("group",{children:[t.jsx("mesh",{geometry:i,side:vn,receiveShadow:f,frustumCulled:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,side:vn,roughness:.97,metalness:.02})}),[[0,(le.zFront+ke.z+ke.halfZ)/2,le.halfX*2,le.zFront-ke.z-ke.halfZ],[0,(le.zBack+ke.z-ke.halfZ)/2,le.halfX*2,ke.z-ke.halfZ-le.zBack],[-342/2-20,ke.z,le.halfX*2-ke.halfX*2,ke.halfZ*2],[(ke.halfX+le.halfX)/2+20,ke.z,le.halfX*2-ke.halfX*2,ke.halfZ*2]].map(([m,l,u,x],v)=>t.jsxs("mesh",{position:[m,le.y-3,l],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[Math.abs(u),6,Math.abs(x)]}),t.jsx("meshStandardMaterial",{color:"#4b3a2c",roughness:.93})]},v)),t.jsxs("mesh",{ref:s,position:[ke.x,Qe.ceiling+2,ke.z],rotation:[-Math.PI/2,0,0],children:[t.jsx("planeGeometry",{args:[ke.halfX*2,ke.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#7fd6a0",emissive:"#2f8f5c",emissiveIntensity:.85,toneMapped:!1,side:De})]}),t.jsxs("mesh",{position:[0,Le.y-4,Le.z],receiveShadow:f,castShadow:f,children:[t.jsx("boxGeometry",{args:[Le.halfX*2.6,8,Le.depth]}),t.jsx("meshStandardMaterial",{color:"#3f3126",roughness:.94})]}),t.jsxs("instancedMesh",{ref:null,args:[null,null,a.length],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[lt.halfX*2,3.2,6.4]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(Ol,{matrices:a})]}),[-1,1].map(m=>Array.from({length:xe.tiers},(l,u)=>t.jsxs("mesh",{position:[m*(xe.x-u*26),xe.y+u*xe.tierRise-4,0],receiveShadow:f,castShadow:f,children:[t.jsx("boxGeometry",{args:[76-u*6,7,xe.halfZ*2+40]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.92})]},`${m}-${u}`))),t.jsxs("instancedMesh",{args:[null,null,d.length],children:[t.jsx("boxGeometry",{args:[3,15,22]}),t.jsx("meshStandardMaterial",{color:"#e8c98d",emissive:E.lanternFar,emissiveIntensity:1.05,roughness:.9}),t.jsx(_l,{matrices:d})]}),t.jsxs("instancedMesh",{args:[null,null,h.length],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[30,4.4,10]}),t.jsx("meshStandardMaterial",{color:"#5c3f28",roughness:.9}),t.jsx(Dl,{matrices:h})]}),t.jsxs("instancedMesh",{args:[null,null,p.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[2.6,3.2,7,8]}),t.jsx("meshStandardMaterial",{color:"#b8a06a",roughness:.85}),t.jsx(Nl,{matrices:p})]}),t.jsxs("instancedMesh",{args:[null,null,g.length],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[74,2.6,6.4]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(Hl,{matrices:g})]}),t.jsxs("instancedMesh",{args:[null,null,c.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[7,4.5,12,8]}),t.jsx("meshStandardMaterial",{color:"#22201f",roughness:.7,metalness:.5}),t.jsx(Bl,{matrices:c})]}),t.jsxs("instancedMesh",{ref:n,args:[null,null,c.length],children:[t.jsx("sphereGeometry",{args:[5.4,8,6]}),t.jsx("meshStandardMaterial",{color:E.furnace,emissive:E.ember,emissiveIntensity:2.6,toneMapped:!1}),t.jsx(Ul,{matrices:c})]}),t.jsxs("mesh",{position:[0,Qe.y-4,0],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[Qe.halfX*2,8,Qe.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#2a2622",roughness:.96})]}),[-1,1].map(m=>[-1,0,1].map(l=>t.jsxs("mesh",{position:[m*120,(Qe.y+le.y)/2,l*96],castShadow:f,children:[t.jsx("boxGeometry",{args:[26,Math.abs(le.y-Qe.y),26]}),t.jsx("meshStandardMaterial",{color:Z.rock,roughness:.95})]},`${m}-${l}`)))]})}function Ol({matrices:e}){const o=w.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Dl({matrices:e}){const o=w.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Nl({matrices:e}){const o=w.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Hl({matrices:e}){const o=w.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function _l({matrices:e}){const o=w.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Bl({matrices:e}){const o=w.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Ul({matrices:e}){const o=w.useRef();return t.jsx(_t,{matrices:e,selfRef:o,offsetY:9})}function _t({matrices:e,offsetY:o=0}){const n=w.useRef(),s=w.useRef(!1);return ne(()=>{if(s.current)return;const i=n.current?.parent;if(!i?.isInstancedMesh)return;const a=new rt,c=new rt().makeTranslation(0,o,0);for(let d=0;d<Math.min(e.length,i.count);d++)a.copy(e[d]).multiply(c),i.setMatrixAt(d,a);i.instanceMatrix.needsUpdate=!0,i.computeBoundingSphere(),s.current=!0}),t.jsx("object3D",{ref:n})}const Hs=(()=>{if(typeof document>"u")return null;const e=256,o=128,n=document.createElement("canvas");n.width=e,n.height=o;const s=n.getContext("2d"),i=s.createRadialGradient(e/2,o*.62,8,e/2,o*.62,e*.62);i.addColorStop(0,"#fff3c4"),i.addColorStop(.32,"#ffc95e"),i.addColorStop(.66,"#e06120"),i.addColorStop(1,"#7e1c14"),s.fillStyle=i,s.fillRect(0,0,e,o),s.globalAlpha=.14,s.fillStyle="#fff3c4";for(let c=0;c<12;c++){const d=c/12*Math.PI*2;s.save(),s.translate(e/2,o*.62),s.rotate(d),s.fillRect(-3,0,6,e),s.restore()}s.globalAlpha=.22,s.fillStyle="#5e1610";for(let c=8;c<e;c+=22)s.fillRect(c,0,3,o);s.globalAlpha=1;const a=new no(n);return a.colorSpace=so,a})();function Wl(e,o,n,s){const i=e+s,a=o+s,c=new Float32Array([-i,0,a,i,0,a,e*.18,n,o*.18,-i,0,a,e*.18,n,o*.18,-e*.18,n,o*.18,i,0,a,i,0,-a,e*.18,n,-o*.18,i,0,a,e*.18,n,-o*.18,e*.18,n,o*.18,i,0,-a,-i,0,-a,-e*.18,n,-o*.18,i,0,-a,-e*.18,n,-o*.18,e*.18,n,-o*.18,-i,0,-a,-i,0,a,-e*.18,n,o*.18,-i,0,-a,-e*.18,n,o*.18,-e*.18,n,-o*.18]),d=new Lt;return d.setAttribute("position",new oe(c,3)),d.computeVertexNormals(),d}function Yl({quality:e="high",shadows:o=!0}){const n=w.useRef(),s=w.useRef(),i=ot("keep-hf.opt.glb"),a=w.useMemo(()=>{const d=[];for(let h=0;h<O.storeys;h++){const p=1-(h+1)*O.taper,g=O.plinth+h*O.storey;d.push({i:h,y:g,halfX:O.halfX*p,halfZ:O.halfZ*p,roof:Wl(O.halfX*p,O.halfZ*p,h===O.storeys-1?30:16,11)})}return d},[]);ne(()=>{const d=y.t;n.current&&(n.current.material.emissiveIntensity=2.2+Math.sin(d*2.2)*.3),s.current&&(s.current.material.emissiveIntensity=2.3+Math.sin(d*3.3)*.25)});const c=o;return t.jsxs("group",{position:[0,O.baseY,O.z],children:[t.jsxs("mesh",{position:[0,O.plinth/2,0],castShadow:c,receiveShadow:c,children:[t.jsx("boxGeometry",{args:[O.halfX*2.2,O.plinth,O.halfZ*2.2]}),t.jsx("meshStandardMaterial",{color:"#4a4640",roughness:.96})]}),i&&t.jsx(ge,{name:"keep-hf.opt.glb",height:O.plinth+O.storeys*O.storey+26,position:[0,O.plinth*.5,0],tint:"#9a8468",emissive:E.emberDeep,emissiveIntensity:.14}),!i&&a.map(d=>t.jsxs("group",{position:[0,d.y,0],children:[t.jsxs("mesh",{position:[0,O.storey/2,0],castShadow:c,receiveShadow:c,children:[t.jsx("boxGeometry",{args:[d.halfX*2,O.storey,d.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#d8cdb6",roughness:.9})]}),t.jsxs("mesh",{position:[0,O.storey*.55,d.halfZ+.6],children:[t.jsx("planeGeometry",{args:[d.halfX*1.75,O.storey*.38]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:1.5,toneMapped:!1})]}),t.jsxs("mesh",{position:[0,O.storey*.02,d.halfZ+8],castShadow:c,children:[t.jsx("boxGeometry",{args:[d.halfX*2+20,3,2.4]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.72})]}),t.jsxs("mesh",{position:[0,O.storey-1.4,0],children:[t.jsx("boxGeometry",{args:[d.halfX*2+3,1.6,d.halfZ*2+3]}),t.jsx("meshStandardMaterial",{color:"#c9a227",roughness:.4,metalness:.7})]}),t.jsx("mesh",{geometry:d.roof,position:[0,O.storey,0],castShadow:c,receiveShadow:c,children:t.jsx("meshStandardMaterial",{color:"#2e3038",roughness:.72,metalness:.14,flatShading:!0})})]},d.i)),[-1,1].map(d=>t.jsxs("mesh",{position:[d*14,O.plinth+O.storeys*O.storey+30,0],rotation:[0,0,d*.4],castShadow:c,children:[t.jsx("coneGeometry",{args:[5,15,5]}),t.jsx("meshStandardMaterial",{color:"#c9a227",roughness:.35,metalness:.85})]},d)),t.jsxs("group",{position:[0,Ee.y,Ee.z-O.z],children:[t.jsxs("mesh",{castShadow:c,receiveShadow:c,children:[t.jsx("boxGeometry",{args:[Ee.halfX*2,7,Ee.depth]}),t.jsx("meshStandardMaterial",{color:"#3a2a1e",roughness:.9})]}),t.jsxs("mesh",{ref:n,position:[0,26,-40/2],children:[t.jsx("planeGeometry",{args:[Ee.halfX*2,48]}),t.jsx("meshStandardMaterial",{color:E.furnace,emissive:"#ffffff",emissiveMap:Hs,map:Hs,emissiveIntensity:2.2,toneMapped:!1,side:De})]}),t.jsx(ge,{name:"oni-throne.opt.glb",height:ce("oni-throne.opt.glb"),position:[0,3.5,-8],rotation:0,tint:"#8a7f78",emissive:"#2a0e0a",emissiveIntensity:.25,fallback:t.jsxs("group",{position:[0,3.5,-8],scale:ce("oni-throne.opt.glb")/38,children:[t.jsxs("mesh",{position:[0,6,0],castShadow:c,children:[t.jsx("boxGeometry",{args:[18,12,14]}),t.jsx("meshStandardMaterial",{color:"#1c1a20",roughness:.6,metalness:.5})]}),t.jsxs("mesh",{position:[0,10.5,0],children:[t.jsx("boxGeometry",{args:[14,3,11]}),t.jsx("meshStandardMaterial",{color:"#6e1712",roughness:.9})]}),t.jsxs("mesh",{position:[0,20,-5],castShadow:c,children:[t.jsx("boxGeometry",{args:[16,20,3.4]}),t.jsx("meshStandardMaterial",{color:"#221e26",roughness:.6,metalness:.5})]}),[-1,1].map(d=>t.jsxs("mesh",{position:[d*8,32,-5],rotation:[0,0,d*-.55],castShadow:c,children:[t.jsx("coneGeometry",{args:[2.2,12,6]}),t.jsx("meshStandardMaterial",{color:"#d8cbb2",roughness:.55})]},d))]})}),t.jsx(ge,{name:"kagura-stage.opt.glb",height:ce("kagura-stage.opt.glb"),position:[0,3.5,-15],rotation:Math.PI,tint:"#c9743a",emissive:E.emberDeep,emissiveIntensity:.3,fallback:null}),[-1,1].map(d=>t.jsxs("mesh",{position:[d*Ee.halfX*.9,28,Ee.depth/2-4],castShadow:c,children:[t.jsx("cylinderGeometry",{args:[3.4,4,52,8]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.7})]},d)),t.jsxs("mesh",{position:[0,56,0],castShadow:c,children:[t.jsx("boxGeometry",{args:[Ee.halfX*2.3,5,Ee.depth+22]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.72})]}),[-1,1].map(d=>t.jsx(ge,{name:"oni-daiko.opt.glb",height:ce("oni-daiko.opt.glb"),position:[d*(Ee.halfX-22),4,4],rotation:d*.4,tint:"#c98a5a",fallback:t.jsx("group",{position:[0,ce("oni-daiko.opt.glb")/2,0],rotation:[0,0,Math.PI/2],scale:ce("oni-daiko.opt.glb")/22,children:t.jsxs("mesh",{castShadow:c,children:[t.jsx("cylinderGeometry",{args:[11,11,15,14]}),t.jsx("meshStandardMaterial",{color:"#8e2118",roughness:.7})]})})},d))]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,18],children:[t.jsx("cylinderGeometry",{args:[3.4,3.4,6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.3,toneMapped:!1}),t.jsx(Vl,{})]})]})}function Vl(){const e=w.useRef(),o=w.useRef(!1);return ne(()=>{if(o.current)return;const n=e.current?.parent;if(!n?.isInstancedMesh)return;const s=new rt,i=new j,a=new mt,c=new j(1,1,1);for(let d=0;d<n.count;d++){const h=d/(n.count-1)*2-1;i.set(h*(O.halfX+26),Ee.y+74-(1-h*h)*20,O.halfZ+22),n.setMatrixAt(d,s.compose(i,a,c))}n.instanceMatrix.needsUpdate=!0,n.computeBoundingSphere(),o.current=!0}),t.jsx("object3D",{ref:e})}function $l({shadows:e=!0}){const{slabs:o,flights:n,tower:s}=Ma,i=w.useMemo(()=>{const a=[],c=d=>d*d*(3-2*d);for(const d of n)for(let p=0;p<=9;p++){const g=p/9;a.push([(d.x0+d.x1)/2,d.y0+(d.y1-d.y0)*c(g)-1.2,T.lerp(d.z0,d.z1,g)])}return a},[n]);return t.jsxs("group",{children:[[s.x[0]+1,s.x[1]-1].map(a=>[s.z[0]+1,s.z[1]-1].map(c=>t.jsxs("mesh",{position:[a,128,c],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[2.2,3,256,6]}),t.jsx("meshStandardMaterial",{color:"#33261a",roughness:.92})]},`${a}${c}`))),t.jsxs("instancedMesh",{args:[null,null,i.length],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[9,2.4,5.6]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(Kl,{points:i})]}),o.map(([a,c,d,h,p],g)=>t.jsxs("mesh",{position:[a,c-1.6,d],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[Math.abs(h),3.2,Math.abs(p)]}),t.jsx("meshStandardMaterial",{color:"#4b3a2c",roughness:.93})]},g)),o.map(([a,c,d,h,p],g)=>t.jsxs("mesh",{position:[a,c+5,d+Math.abs(p)/2-1],children:[t.jsx("boxGeometry",{args:[Math.abs(h),1.6,1.2]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})]},`r${g}`))]})}function Kl({points:e}){const o=w.useRef(),n=w.useRef(!1);return ne(()=>{if(n.current)return;const s=o.current?.parent;if(!s?.isInstancedMesh)return;const i=new rt,a=new mt,c=new j(1,1,1),d=new j;for(let h=0;h<Math.min(e.length,s.count);h++)d.set(e[h][0],e[h][1],e[h][2]),s.setMatrixAt(h,i.compose(d,a,c));s.instanceMatrix.needsUpdate=!0,s.computeBoundingSphere(),n.current=!0}),t.jsx("object3D",{ref:o})}function Xl({shadows:e=!0}){const o=w.useMemo(()=>{const n=[],i=a=>a*a*(3-2*a);for(const a of[-1,1])for(let c=0;c<=20;c++){const d=c/20;n.push({x:a*me.x,y:i(d)*It,z:T.lerp(me.zFoot,me.zTop,d)})}return n},[]);return t.jsxs("group",{children:[o.map((n,s)=>t.jsxs("mesh",{position:[n.x,n.y-1.4,n.z],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[me.halfW*2,2.8,9]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.75})]},s)),[-1,1].map(n=>{const s=a=>a*a*(3-2*a),i=a=>{const c=[];for(let d=0;d<=16;d++){const h=d/16;c.push(new j(n*me.x+a,s(h)*It+7,T.lerp(me.zFoot,me.zTop,h)))}return new oo(new to(c),24,1.1,4,!1)};return t.jsxs("group",{children:[t.jsx("mesh",{geometry:i(-15),castShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})}),t.jsx("mesh",{geometry:i(me.halfW+1),castShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})})]},n)})]})}function Ql({shadows:e=!0}){const o=w.useMemo(()=>ko.map(([,,n,s])=>{const i=[];for(let a=0;a<=12;a++){const c=a/12*2-1;i.push(new j(c*n*.5,s*(1-c*c),0))}return new oo(new to(i),26,4.6,4,!1)}),[]);return t.jsxs(t.Fragment,{children:[ko.map(([n,s],i)=>t.jsxs("group",{position:[0,n,s],children:[t.jsx("mesh",{geometry:o[i],castShadow:e,receiveShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.74})}),[-7,7].map(a=>t.jsx("mesh",{geometry:o[i],position:[0,7,a],scale:[1,1,.3],children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})},a))]},i)),[-1,0,1].map(n=>t.jsxs("mesh",{position:[n*70,ko[0][0]-12,ko[0][1]],children:[t.jsx("cylinderGeometry",{args:[4,4,7,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1})]},n)),t.jsx("group",{position:[0,le.y,0]})]})}function Xa(e){let o=e>>>0;return()=>(o=Math.imul(o,1664525)+1013904223>>>0,o/4294967296)}function Zl({quality:e,shadows:o}){const n=w.useMemo(()=>{const i=Xa(712273),a=[],c=e==="low"?34:e==="mid"?68:108;let d=0;for(;a.length<c&&d<c*40;){d++;const h=(i()*2-1)*(le.halfX-30),p=T.lerp(le.zBack+40,le.zFront-30,i());Math.abs(h)<62&&p>O.z+120||Math.abs(h)<70&&Math.abs(p-84)<58||Math.abs(Math.abs(h)-me.x)<24&&p<me.zFoot+18&&p>me.zTop-10||a.push({x:h,z:p,kind:a.length%4,rot:i()*Math.PI*2,k:.82+i()*.5})}return a},[e]),s=o;return t.jsx(t.Fragment,{children:n.map((i,a)=>{const c=[i.x,le.y,i.z];if(i.kind===0){const h=ce("sake-tower.opt.glb")*i.k,p=h*.24;return t.jsx(ge,{name:"sake-tower.opt.glb",height:h,position:c,rotation:i.rot,tint:"#c9b48a",fallback:t.jsx("group",{position:c,children:[0,1,2].map(g=>t.jsxs("mesh",{position:[0,h*(.17+g*.3),0],castShadow:s,children:[t.jsx("cylinderGeometry",{args:[p-g*p*.16,p-g*p*.16,h*.29,10]}),t.jsx("meshStandardMaterial",{color:g%2?"#c9a86a":"#8e6a3c",roughness:.92})]},g))})},a)}if(i.kind===1){const h=ce("oni-guardian.opt.glb")*i.k;return t.jsx(ge,{name:"oni-guardian.opt.glb",height:h,position:c,rotation:i.rot,tint:"#9a9488",fallback:t.jsxs("group",{position:c,children:[t.jsxs("mesh",{position:[0,h*.17,0],castShadow:s,children:[t.jsx("boxGeometry",{args:[h*.43,h*.33,h*.43]}),t.jsx("meshStandardMaterial",{color:"#4a4a52",roughness:.95})]}),t.jsxs("mesh",{position:[0,h*.6,0],castShadow:s,children:[t.jsx("capsuleGeometry",{args:[h*.2,h*.33,4,8]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]}),[-1,1].map(p=>t.jsxs("mesh",{position:[p*h*.13,h*.93,0],rotation:[0,0,p*.5],castShadow:s,children:[t.jsx("coneGeometry",{args:[h*.067,h*.27,5]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]},p))]})},a)}if(i.kind===2){const h=ce("wisteria-trellis.opt.glb")*i.k;return t.jsx(ge,{name:"wisteria-trellis.opt.glb",height:h,position:c,rotation:i.rot,tint:"#b39ad8",fallback:t.jsxs("group",{position:c,children:[t.jsxs("mesh",{position:[0,h*.94,0],castShadow:s,children:[t.jsx("boxGeometry",{args:[h*.7,h*.07,h*.07]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.94})]}),[-.26,-.09,.09,.26].map(p=>t.jsxs("mesh",{position:[p*h,h*.47,0],children:[t.jsx("coneGeometry",{args:[h*.1,h*.88,6]}),t.jsx("meshStandardMaterial",{color:"#9d7fd0",roughness:.95,emissive:"#6b4fa0",emissiveIntensity:.22})]},p))]})},a)}const d=Hi*4*i.k;return t.jsxs("group",{position:c,rotation:[0,i.rot,0],children:[t.jsxs("mesh",{position:[0,d/2,0],castShadow:s,children:[t.jsx("cylinderGeometry",{args:[d*.021,d*.021,d,6]}),t.jsx("meshStandardMaterial",{color:"#2f2118",roughness:.92})]}),t.jsxs("mesh",{position:[d*.12,d*.65,0],children:[t.jsx("planeGeometry",{args:[d*.235,d*.7]}),t.jsx("meshStandardMaterial",{color:a%2?E.vermilion:"#e8dcc4",roughness:.95,side:De,emissive:a%2?E.vermilionDeep:"#8a8272",emissiveIntensity:.28})]})]},a)})})}function ql({shadows:e}){const o=w.useMemo(()=>{const n=Xa(10560325),s=[];for(let i=0;i<52;i++)s.push({x:(n()*2-1)*(Qe.halfX-40),z:(n()*2-1)*(Qe.halfZ-40),rot:n()*Math.PI*2,keg:i%2===0});return s},[]);return t.jsx(t.Fragment,{children:o.map((n,s)=>n.keg?t.jsx(ge,{name:"powder-keg.opt.glb",height:ce("powder-keg.opt.glb"),position:[n.x,Qe.y,n.z],rotation:n.rot,tint:"#6a6a72",fallback:t.jsxs("mesh",{position:[n.x,Qe.y+ce("powder-keg.opt.glb")*.5,n.z],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[ce("powder-keg.opt.glb")*.4,ce("powder-keg.opt.glb")*.4,ce("powder-keg.opt.glb"),10]}),t.jsx("meshStandardMaterial",{color:"#1a1a20",roughness:.6,metalness:.4})]})},s):t.jsx(ge,{name:"war-cannon.opt.glb",height:ce("war-cannon.opt.glb"),position:[n.x,Qe.y,n.z],rotation:n.rot,tint:"#7a7068",fallback:t.jsxs("mesh",{position:[n.x,Qe.y+ce("war-cannon.opt.glb")*.42,n.z],rotation:[0,n.rot,Math.PI/2],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[ce("war-cannon.opt.glb")*.18,ce("war-cannon.opt.glb")*.23,ce("war-cannon.opt.glb")*1.9,8]}),t.jsx("meshStandardMaterial",{color:"#15181f",roughness:.45,metalness:.7})]})},s))})}function Jl(){const e=we(o=>o.camera);return ne((o,n)=>{const s=Math.min(n,.05),i=(e.position.x-pe.x-Ce.centre[0])/Ce.radii[0],a=(e.position.y-pe.y-Ce.centre[1])/Ce.radii[1],c=(e.position.z-pe.z-Ce.centre[2])/Ce.radii[2],d=Math.sqrt(i*i+a*a+c*c),h=T.clamp(1-(d-1)/.5,0,1);y.inside+=(h-y.inside)*(1-Math.pow(.02,s))}),null}function ec({quality:e="high",shadows:o=!0}){return t.jsxs("group",{position:[pe.x,pe.y,pe.z],children:[t.jsx(Jl,{}),t.jsx(Gl,{quality:e,shadows:o}),t.jsx(Yl,{quality:e,shadows:o}),t.jsx(Ql,{shadows:o}),t.jsx(Xl,{shadows:o}),t.jsx($l,{shadows:o}),t.jsx(Zl,{quality:e,shadows:o}),t.jsx(ql,{shadows:o}),[-1,1].flatMap(n=>[0,1,2,3,4].map(s=>t.jsx(ge,{name:"banquet-table.opt.glb",height:ce("banquet-table.opt.glb"),position:[n*(74+s%2*22),le.y,O.z+186+s*34],rotation:n*.35+Math.PI/2,tint:"#a98c66",fallback:null},`bq-${n}-${s}`))),t.jsx(ge,{name:"treasure-kura.opt.glb",height:ce("treasure-kura.opt.glb"),position:[xe.x-74,le.y,O.z+96],rotation:-.7,tint:"#b8ab98",emissive:"#141018",emissiveIntensity:.1,fallback:t.jsx("group",{position:[xe.x-74,le.y,O.z+96],rotation:[0,-.7,0],children:(()=>{const n=ce("treasure-kura.opt.glb");return t.jsxs(t.Fragment,{children:[[-1,1].map(s=>[-1,1].map(i=>t.jsxs("mesh",{position:[s*n*.3,n*.08,i*n*.22],castShadow:o,children:[t.jsx("boxGeometry",{args:[n*.1,n*.16,n*.1]}),t.jsx("meshStandardMaterial",{color:"#3a2d20",roughness:.92})]},`${s}${i}`))),t.jsxs("mesh",{position:[0,n*.34,0],castShadow:o,children:[t.jsx("boxGeometry",{args:[n*.85,n*.38,n*.65]}),t.jsx("meshStandardMaterial",{color:"#d8d2c2",roughness:.9})]}),t.jsxs("mesh",{position:[0,n*.6,0],castShadow:o,children:[t.jsx("coneGeometry",{args:[n*.65,n*.3,4]}),t.jsx("meshStandardMaterial",{color:"#7e2a1c",roughness:.8,flatShading:!0})]})]})})()})}),[[-120,-70,.4],[60,40,2.2],[150,-100,1.1],[-64,22,1.8],[104,-46,.2],[-176,-118,2.7],[18,-142,1.4],[-30,96,.9]].map(([n,s,i],a)=>t.jsx(ge,{name:"bomb-sphere.opt.glb",height:ce("bomb-sphere.opt.glb"),position:[n,Qe.y,s],rotation:i,tint:"#5a5a64",fallback:t.jsxs("mesh",{position:[n,Qe.y+ce("bomb-sphere.opt.glb")*.5,s],castShadow:o,children:[t.jsx("sphereGeometry",{args:[ce("bomb-sphere.opt.glb")*.5,12,10]}),t.jsx("meshStandardMaterial",{color:"#14161c",roughness:.5,metalness:.5})]})},`bomb-${a}`)),[-1,1].map(n=>t.jsx(ge,{name:"keep-tier.opt.glb",height:ce("keep-tier.opt.glb"),position:[n*(xe.x-40),xe.y+xe.tiers*xe.tierRise-6,O.z+140],rotation:n*.6,tint:"#a08c74",fallback:null},`turret-${n}`)),[-1,1].map(n=>t.jsx(ge,{name:"arch-bridge.opt.glb",height:ce("arch-bridge.opt.glb"),position:[n*74,le.y,84],rotation:Math.PI/2,tint:"#b87a5a",fallback:null},`span-${n}`)),[-1,1].map(n=>t.jsx(ge,{name:"oni-guardian.opt.glb",height:Rt,position:[n*(Le.halfX+26),Le.y,Le.z-26],rotation:-n*.5,tint:"#8e8880",fallback:t.jsxs("group",{position:[n*(Le.halfX+26),Le.y,Le.z-26],children:[t.jsxs("mesh",{position:[0,Rt*.17,0],castShadow:o,children:[t.jsx("boxGeometry",{args:[Rt*.41,Rt*.33,Rt*.41]}),t.jsx("meshStandardMaterial",{color:"#43434c",roughness:.95})]}),t.jsxs("mesh",{position:[0,Rt*.59,0],castShadow:o,children:[t.jsx("capsuleGeometry",{args:[Rt*.185,Rt*.33,4,10]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]})]})},n)),t.jsx("pointLight",{position:[0,Ee.y+30,Ee.z-O.z+O.z+40],color:E.ember,intensity:42e3,distance:900,decay:2}),t.jsx("pointLight",{position:[0,xe.y+120,60],color:E.lantern,intensity:3e4,distance:820,decay:2}),t.jsx("pointLight",{position:[0,Qe.y+40,0],color:"#4fbf86",intensity:14e3,distance:420,decay:2}),t.jsx("pointLight",{position:[0,Le.y+132,Le.z-40],color:E.lantern,intensity:13e3,distance:620,decay:2})]})}const tc=Math.PI/2-.14,_s=1.5;function Qa({enabled:e,dom:o,zoomMin:n=.34,zoomMax:s=2.6,zoom0:i=1,pitch0:a=.16,pitchMin:c=-.62,pitchMax:d=tc}){const h=w.useRef({yaw:0,pitch:a,zoom:i,smYaw:0,smPitch:a,smZoom:i,since:99,dragging:!1,recentre:!1,noRecentre:!1,pitchMin:c,pitchMax:d,zoomMin:n,zoomMax:s,pitch0:a}).current;return w.useEffect(()=>{if(!e||!o)return;const p=o,g=new Map;let f=0,m=0,l=null;const u=()=>g.size,x=z=>{g.set(z.pointerId,{x:z.clientX,y:z.clientY});try{p.setPointerCapture?.(z.pointerId)}catch{}if(u()===1)h.dragging=!0,l={x:z.clientX,y:z.clientY,t:z.timeStamp};else if(u()===2){h.dragging=!1;const[r,M]=[...g.values()];f=Math.hypot(r.x-M.x,r.y-M.y),l=null}},v=z=>{const r=g.get(z.pointerId);if(!r)return;const M=z.clientX-r.x,F=z.clientY-r.y;if(r.x=z.clientX,r.y=z.clientY,u()>=2){const[S,R]=[...g.values()],A=Math.hypot(S.x-R.x,S.y-R.y);f>8&&A>8&&(h.zoom=T.clamp(h.zoom*(f/A),h.zoomMin,h.zoomMax),h.since=0),f=A;return}if(!h.dragging)return;l&&Math.hypot(z.clientX-l.x,z.clientY-l.y)>14&&(l=null);const C=Cn()*Me.lookSens;h.yaw-=M*.005*C,h.pitch=T.clamp(h.pitch+F*.004*C*(Me.invertY?-1:1),h.pitchMin,h.pitchMax),h.since=0,z.cancelable&&z.preventDefault()},b=z=>{g.has(z.pointerId)&&(g.delete(z.pointerId),u()<2&&(f=0),u()===0&&(h.dragging=!1,l&&z.timeStamp-l.t<260&&(z.timeStamp-m<340?(h.recentre=!0,m=0):m=z.timeStamp),l=null))},k=z=>{z.preventDefault(),h.zoom=T.clamp(h.zoom*(1+Math.sign(z.deltaY)*.1),h.zoomMin,h.zoomMax),h.since=0};return p.addEventListener("pointerdown",x),p.addEventListener("pointermove",v,{passive:!1}),p.addEventListener("pointerup",b),p.addEventListener("pointercancel",b),window.addEventListener("pointerup",b),p.addEventListener("wheel",k,{passive:!1}),()=>{p.removeEventListener("pointerdown",x),p.removeEventListener("pointermove",v),p.removeEventListener("pointerup",b),p.removeEventListener("pointercancel",b),window.removeEventListener("pointerup",b),p.removeEventListener("wheel",k),g.clear(),h.dragging=!1}},[e,o,h]),h}function Dn(e,o,n=0){if(e.since+=o,I.zoom&&(e.zoom=T.clamp(e.zoom*(1-I.zoom*.9*o),e.zoomMin,e.zoomMax),e.since=0),e.yaw-=n,I.recentreQueued&&(I.recentreQueued=!1,e.recentre=!0),e.recentre&&(e.recentre=!1,e.since=_s+1,e.pitch+=(e.pitch0-e.pitch)*.5,e.noRecentre&&(e.pitch=e.pitch0)),!Me.freeCam&&!e.noRecentre&&!e.dragging&&e.since>_s){for(;e.yaw>Math.PI;)e.yaw-=Math.PI*2;for(;e.yaw<-Math.PI;)e.yaw+=Math.PI*2;e.yaw*=Math.pow(Pe(.22,.48),o),Math.abs(e.yaw)<.001&&(e.yaw=0)}const s=e.dragging?6e-4:Pe(.002,.02),i=1-Math.pow(s,o);let a=e.yaw-e.smYaw;for(;a>Math.PI;)a-=Math.PI*2;for(;a<-Math.PI;)a+=Math.PI*2;e.smYaw+=a*i,e.smPitch+=(e.pitch-e.smPitch)*i,e.smZoom+=(e.zoom-e.smZoom)*(1-Math.pow(.004,o))}const Bs=[{id:"luffy",modelId:"luffy-wano",name:"Luffy",role:"Captain",capeAxis:"y",capeWiden:.66,capeLength:.78,capeUrl:wo("coat-black.opt.glb"),height:1.74,speed:7,run:15,build:"normal",skin:"#f0c191",hair:{color:"#181410",style:"spiky"},helm:{kind:"none"},top:{color:"#c22d2a",style:"open"},bottom:{color:"#d98b3a"},sash:"#8f63c4",boots:{color:"#6b5238",fur:!1},scar:!0},{id:"zoro",modelId:"zoro-wano",name:"Zoro",role:"Swordsman",capeAxis:"y",capeWiden:.82,capeLength:.56,capeUrl:wo("haori-green.opt.glb"),height:1.81,speed:6.6,run:14,build:"tall",skin:"#e8b481",hair:{color:"#4f7d3a",style:"short"},helm:{kind:"none"},top:{color:"#f2f0ea",style:"open"},bottom:{color:"#f2f0ea"},sash:"#4b3f7a",boots:{color:"#1f2229",fur:!1},weapon:"swords",scar:!0}],oc=e=>Bs.find(o=>o.id===e)??Bs[0],nc=.22,Us=13,sc=.09,ac=.34,Ws=9,rc=1.1,ic=.55,Ys=12,lc=6,cc=70,hc=.55,mn=26,dc=8,uc=5,Vs=.8,pc=12,fc=.3,mc=.13,$s=3.4,gc=32,Ks=.65,xc=1.1,wc=.5,bc=6,Xs=6,Be=new j,ht=new j,ho=new j;function yc(e,o,n,s,i,a,c,d){let p=0;for(let g=1;g<=16;g++){const f=g/16*c,m=e+s*f,l=o+i*f,u=n+a*f,x=d??re(m,u);if(l<=x){let v=p,b=f;for(let k=0;k<6;k++){const z=(v+b)/2,r=o+i*z,M=d??re(e+s*z,n+a*z);r<=M?b=z:v=z}return b}p=f}return null}function vc(e,o,n,s){const i=Math.min(e,.05),a=Ue.combat,c=ze.move,d=a.style==="sword";s.x=0,s.y=0,s.z=0,Be.set(Math.sin(o.yaw)*Math.cos(o.pitch),-Math.sin(o.pitch),Math.cos(o.yaw)*Math.cos(o.pitch)).normalize(),Ue.lookYaw=Math.atan2(Be.x,Be.z),Ue.playerFacing=o.yaw,a.bazookaCd=Math.max(0,a.bazookaCd-i),a.gigantCd=Math.max(0,a.gigantCd-i),a.hakiCd=Math.max(0,a.hakiCd-i),a.gear2Cd=Math.max(0,a.gear2Cd-i),n.gear2Queued&&(n.gear2Queued=!1,!a.gear2&&a.gear2Cd<=0&&!d&&(a.gear2=!0,a.gear2T=dc,Ut(.25),ht.set(o.x,o.y+1,o.z),Et(ht,1.6,"haki"))),a.gear2&&(a.gear2T=Math.max(0,a.gear2T-i),a.gear2T<=0&&(a.gear2=!1,a.gear2Cd=uc));const h=a.gear2;a.balloon=T.damp(a.balloon,n.balloonHeld&&!d?1:0,8,i);const p=o.y+o.height*.9,g=yc(o.x,p,o.z,Be.x,Be.y,Be.z,cc,o.floorY);Ue.aim.valid=g!=null,g!=null&&(Ue.aim.distance=g,Ue.aim.point.set(o.x,p,o.z).addScaledVector(Be,g));const f=!c.kind;if(n.rocketQueued&&(n.rocketQueued=!1,f&&g!=null&&(l(d?"flash":"rocket",hc),c.target.copy(Ue.aim.point))),n.pistolQueued&&(n.pistolQueued=!1,f&&(l(d?"onigiri":"pistol",d?fc:nc),c.target.set(o.x,p,o.z).addScaledVector(Be,d?8:16))),n.bazookaQueued&&(n.bazookaQueued=!1,f&&a.bazookaCd<=0))if(d){const u=Ue.waves.find(x=>!x.active);u&&(u.active=!0,u.k=0,u.pos.set(o.x,p*.92,o.z),u.dir.set(Be.x,Be.y*.35,Be.z).normalize(),a.bazookaCd=xc,l("wavecast",.22),c.hit=!0,c.target.copy(u.pos).addScaledVector(u.dir,8),Ut(.1))}else l("bazooka",ac),c.target.set(o.x,p,o.z).addScaledVector(Be,g!=null?Math.min(g,Ws):Ws),a.bazookaCd=rc;n.gigantQueued&&(n.gigantQueued=!1,f&&a.gigantCd<=0&&(l(d?"sanzen":"gigant",d?wc:ic),c.target.set(o.x,p,o.z).addScaledVector(Be,g!=null?Math.min(g+1.5,Ys):Ys),a.gigantCd=d?bc:lc));for(const u of Ue.waves){if(!u.active)continue;const x=u.k;u.k=Math.min(1,u.k+i/Ks),u.pos.addScaledVector(u.dir,gc/Ks*i);for(const b of[.35,.68,1])x<b&&u.k>=b&&Et(u.pos,1.6,"slash");const v=o.floorY==null?re(u.pos.x,u.pos.z):o.floorY;(u.k>=1||u.pos.y<v+.4)&&(u.k<1&&Et(u.pos,1.6,"slash"),u.active=!1)}if(n.hakiQueued&&(n.hakiQueued=!1,a.hakiCd<=0&&ze.hakiT<=0&&(ze.hakiT=Vs,ze.hakiFired=!1,a.hakiCd=pc)),ze.hakiT>0){ze.hakiT=Math.max(0,ze.hakiT-i);const u=1-ze.hakiT/Vs;if(a.haki=u,!ze.hakiFired&&u>.35&&(ze.hakiFired=!0,ht.set(o.x,o.y,o.z),Et(ht,3,"haki"),Ut(.9),d))for(let x=0;x<8;x++){const v=x/8*Math.PI*2;ht.set(o.x+Math.cos(v)*Xs,o.y+.6,o.z+Math.sin(v)*Xs),Et(ht,1.4,"slash")}}else a.haki=0;const m=n.gatlingHeld&&!c.kind;if(a.gatling=T.damp(a.gatling,m?1:0,14,i),a.gatling>.2&&Ue.gatlingAim.copy(Be),m){if(ze.gatT-=i,ze.gatT<=0)if(d)ze.gatT=mc,ze.tatsu+=1.9,ht.set(o.x+Math.cos(ze.tatsu)*$s,o.y+.6,o.z+Math.sin(ze.tatsu)*$s),Et(ht,.7,"slash"),Ut(.04);else{ze.gatT=sc*(h?.6:1);const u=g!=null?Math.min(g,Us):Us*.85;ht.set(o.x,p,o.z).addScaledVector(Be,u),Et(ht,.8,"punch"),Ut(.05)}}else ze.gatT=0;if(c.kind){c.t+=i;const u=Math.min(1,c.t/c.dur);if(!c.hit&&u>.45){c.hit=!0;const x=c.kind==="gigant"||c.kind==="sanzen"?3:1.3;if(Et(c.target,x,d?"slash":"punch"),Ut(c.kind==="gigant"||c.kind==="sanzen"?.7:.18),c.kind==="rocket"||c.kind==="flash"){ho.copy(c.target).sub(ht.set(o.x,o.y,o.z));const v=ho.length()||1;s.x=ho.x/v*mn,s.y=Math.max(0,ho.y/v*mn*.5),s.z=ho.z/v*mn}else(c.kind==="pistol"||c.kind==="onigiri")&&(s.x=Be.x*6,s.z=Be.z*6)}c.t>=c.dur&&(c.kind=null,c.t=0),a.move=c.kind,a.moveK=c.kind?Math.min(1,c.t/c.dur):0}else a.move=null,a.moveK=0;return Ue.shake=Math.max(0,Ue.shake-i*2.4),s;function l(u,x){c.kind=u,c.t=0,c.dur=x,c.hit=!1}}const ze={move:{kind:null,t:0,dur:0,hit:!1,target:new j},hakiT:0,hakiFired:!1,gatT:0,tatsu:0};function Mc(e="rubber"){const o=Ue.combat;o.style=e,o.move=null,o.moveK=0,o.gatling=0,o.gear2=!1,o.gear2T=0,o.gear2Cd=0,o.bazookaCd=0,o.gigantCd=0,o.hakiCd=0,o.balloon=0,o.haki=0,ze.move.kind=null,ze.move.t=0,ze.hakiT=0,ze.gatT=0,Ue.shake=0;for(const n of Ue.waves)n.active=!1}const Fo=64,jc=19,Qs=16,Sc=.92,Zs=.52,qs=.3,kc=.04,zc=.0016,Tc=.055,Ec=1.9,Rc=16,Ac=62,Ic=9,Js={x:-.45,z:-2.4},ea=.075,Po=new j,ta=new j;function $t(e,o){return T.clamp(-re(e,o)/26,0,1)}const Lo={x:60*N,z:1050*N},Cc=7,oa=15,$e=1.85,na=1.1,Fc=26,Pc=9.4,sa=21,Lc=.011;function Gc({mode:e,onMode:o,crew:n="luffy"}){const s=we(F=>F.camera),i=we(F=>F.gl),a=w.useRef(),c=w.useRef(),d=w.useRef({speed:0,grounded:!0,maxSpeed:15}),h=w.useRef({x:0,y:0,z:0,yaw:0,pitch:0,height:1.74,floorY:null}).current,p=w.useRef({x:0,y:0,z:0}).current,g=oc(n),f=w.useRef(),m=w.useRef(),l=w.useRef(),u=ot("ship-sunny.opt.glb"),x=ot("ship-lion.opt.glb"),v=u||x,b=u?"ship-sunny.opt.glb":x?"ship-lion.opt.glb":null,k=b?on(b,34):30,z=ot("crew-straw.opt.glb"),r=w.useRef({x:Lo.x,z:Lo.z,heading:Math.PI,speed:0,vx:0,vz:0,throttle:0,rudder:0,flank:0,deckY:0,aground:0,heel:0,trim:0,spray:0,slam:0,bowY:0,drift:0,burst:1,burstFx:0,swallowed:0,fx:0,fy:0,fz:0,fyaw:Math.PI,fpitch:0,fvx:0,fvz:0,fvy:0,airborne:!1,landing:0,fyaw0:Math.PI,stride:0,area:"hall",dx:0,dz:0,snapCam:!0,boarded:!1}).current,M=Qa({enabled:e==="helm"||e==="foot",dom:i.domElement,zoomMin:.34,zoomMax:3.4,pitch0:.16,pitchMin:-.62,pitchMax:1.44});return w.useEffect(()=>{if(e==="helm")return r.x=Lo.x,r.z=Lo.z,r.heading=Math.PI,r.speed=0,r.vx=0,r.vz=0,r.throttle=0,r.flank=0,r.deckY=0,r.snapCam=!0,M.yaw=0,M.smYaw=0,M.pitch=.16,M.smPitch=.16,M.pitch0=.16,M.zoom=1,M.smZoom=1,M.noRecentre=!1,M.pitchMin=-.62,M.pitchMax=1.44,r.swallowed=0,r.burst=1,r.burstFx=0,r.slam=0,r.drift=0,r.trim=0,r.bowY=ut(r.x,r.z,y.t,1).y,y.helm=null,Rn("helm"),()=>{y.helmActive=!1}},[e,r,M]),w.useEffect(()=>{if(e!=="foot")return;r.fvx=0,r.fvz=0,r.snapCam=!0,Y.chain!=="foot"&&Rn("foot"),Mc(g.weapon==="swords"?"sword":"rubber");const F=(S,R)=>{M.yaw=S,M.smYaw=S,M.pitch=R,M.smPitch=R,M.pitch0=0,M.noRecentre=!0,M.pitchMin=-1.28,M.pitchMax=1.28};r.fvy=0,r.airborne=!1,r.landing=0;const C=y.footSpawn;if(y.footSpawn="hall",C==="deck"){r.area="deck",r.dx=0,r.dz=-k*.2,r.fyaw=r.heading,F(r.heading+Math.PI,.24);return}if(C==="port"){r.area="island",r.fx=Q.x+40*N,r.fz=Q.z+40*N,r.fy=re(r.fx,r.fz)+$e,r.fyaw=Math.atan2(he.x-r.fx,he.z-r.fz),F(r.fyaw+Math.PI,-.06);return}if(C==="rear"){r.area="island",r.fx=U.gate.x+U.dir[0]*26,r.fz=U.gate.z+U.dir[1]*26,r.fy=re(r.fx,r.fz)+$e,r.fyaw=Math.atan2(-U.dir[0],-U.dir[1]),F(r.fyaw+Math.PI,.02);return}r.area="hall",r.fx=pe.x,r.fy=pe.y+Le.y,r.fz=pe.z+lt.zTop,r.fyaw=Math.PI,r.fpitch=-.05,F(0,.05)},[e,r,M]),ne((F,C)=>{if(e!=="helm"&&e!=="foot")return;const S=Math.min(C,.05);y.t+=S;const R=e==="helm",A=e==="foot"&&r.area==="deck";if(R||A){const B=r.heading,G=R?I.throttle:r.order,$=R?I.rudder:0;R&&(r.order=I.throttle),r.throttle+=(G-r.throttle)*(1-Math.pow(.02,S)),r.rudder+=($-r.rudder)*(1-Math.pow(.005,S)),r.flank+=((R&&I.boost?1:0)-r.flank)*(1-Math.pow(kc,S));const q=Fo*(1+qs*r.flank),ee=Math.sin(r.heading),P=Math.cos(r.heading),K=Math.cos(r.heading),ae=-Math.sin(r.heading);let H=r.vx*ee+r.vz*P,te=r.vx*K+r.vz*ae;const be=1-y.shelter,Tt=r.throttle>=0?r.throttle*q:r.throttle*jc;H+=T.clamp(Tt-H,-Qs*2.5,Qs)*S,r.burst=Math.min(1,r.burst+S/Ic),R&&I.burstQueued&&(I.burstQueued=!1,r.burst>=.999&&(r.burst=0,r.burstFx=1,H+=Ac,y.splash+=1)),r.burstFx*=Math.pow(.2,S);const Ge=ut(r.x,r.z,y.t,1);H-=(Ge.dx*ee+Ge.dz*P)*Rc*be*S,H-=H*Math.abs(H)*zc*S,te-=(te*Math.abs(te)*Tc+te*Ec)*S;const We=T.clamp(Math.abs(H)/16,0,1);H*=Math.pow(1-.11*Math.abs(r.rudder)*We,S),r.vx=ee*H+K*te,r.vz=P*H+ae*te,r.speed=H,r.drift+=(T.clamp(Math.abs(te)/11,0,1)-r.drift)*(1-Math.pow(.1,S)),r.heading+=r.rudder*Sc*We*Math.sign(H||1)*S;const Ze=r.x+r.vx*S,yt=r.z+r.vz*S,W=k*Zs,Re=Ze+ee*W,qe=yt+P*W;if($t(Re,qe)>.06)r.x=Ze,r.z=yt,r.aground+=(0-r.aground)*(1-Math.pow(.05,S));else{r.aground+=(1-r.aground)*(1-Math.pow(.02,S)),Ht(Math.abs(r.speed)*.0012*S*60,"AGROUND — SHE IS TAKING WATER");const Se=Math.pow(.06,S);r.speed*=Se,r.vx*=Se,r.vz*=Se;const st=6,Bt=$t(r.x+st,r.z)-$t(r.x-st,r.z),ro=$t(r.x,r.z+st)-$t(r.x,r.z-st),vt=Math.hypot(Bt,ro)||1;r.x+=Bt/vt*26*S,r.z+=ro/vt*26*S}const Ie=ba(r.x,r.z,0);r.x+=Ie.vx*S,r.z+=Ie.vz*S,r.x+=Js.x*be*S,r.z+=Js.z*be*S;const He=Ge.dx*K+Ge.dz*ae;r.heading+=T.clamp(He*.4,-ea,ea)*be*S;let D=Ne[0],ue=1/0;for(const Se of Ne){const st=(r.x-Se.x)**2+(r.z-Se.z)**2;st<ue&&(ue=st,D=Se)}if(Pa(S,{danger:Ie.danger,headingX:Math.sin(r.heading),headingZ:Math.cos(r.heading),toCentreX:D.x-r.x,toCentreZ:D.z-r.z,speed:r.speed,throttle:r.throttle})>=1||Ie.danger>.94){const Se=D;r.x=Se.x+(Se.x>0?Se.r*1.85:-Se.r*1.85),r.z=Se.z+Se.r*1.5,r.speed=0,r.vx=0,r.vz=0,r.throttle=0,r.heading=Math.PI,r.swallowed+=1,r.aground=1,Y.grip=0,Ht(.25,"SWALLOWED — SHE BROACHED AND ROLLED"),y.splash+=1}const _e=bo(r.x,r.z),Ye=T.lerp(1,.055,_e)*T.smoothstep($t(r.x,r.z),0,.3),Fe=ut(r.x,r.z,y.t,Ye);y.helmActive=!0,y.helmPos.set(r.x,Fe.y+k*.35,r.z),y.helmSpeed=T.clamp(Math.abs(r.speed)/Fo,0,1),y.ship.x=r.x,y.ship.y=Fe.y,y.ship.z=r.z,y.ship.heading=r.heading,y.ship.loa=k,y.ship.deckY=b?Nt(b,k):k*.16;const se=Ie.vx*Math.cos(r.heading)-Ie.vz*Math.sin(r.heading),X=T.clamp(Math.abs(r.speed)/Fo,0,1),fe=T.clamp(r.rudder*We*X*.4+se*.016,-.5,.5);r.heel+=(fe-te*.012-r.heel)*(1-Math.pow(.15,S));const Ve=k*Zs,je=ut(r.x+ee*Ve,r.z+P*Ve,y.t,Ye).y,Oe=T.clamp((r.bowY-je)/Math.max(S,.001),0,60);r.bowY=je;const Ke=T.clamp((Oe-10)/24,0,1)*X*be;if(r.slam=Math.max(r.slam*Math.pow(.05,S),Ke),Ke>.25){const Se=Math.pow(1-.3*Ke,S);r.vx*=Se,r.vz*=Se}const Mo=X*.1*Math.sign(r.speed>=0?1:-1)+r.slam*.14+r.burstFx*.16;r.trim+=(Mo-r.trim)*(1-Math.pow(.1,S));const jo=T.clamp(X*be*1.15+r.aground*.5+Ie.danger*.8+r.slam*1.3+r.burstFx,0,1);r.spray+=(jo-r.spray)*(1-Math.pow(.08,S));const So=a.current;if(So&&(So.visible=!0,So.position.set(r.x,Fe.y,r.z),So.rotation.set(T.clamp(Fe.dz*1.2,-.3,.3)-r.trim,r.heading,T.clamp(-Fe.dx,-.26,.26)+r.heel)),f.current&&(f.current.scale.z=1+Math.sin(y.t*1.6)*.08+r.burstFx*.4,f.current.scale.x=1+be*.06+r.burstFx*.12),m.current&&(m.current.material.opacity=r.spray*.42,m.current.scale.setScalar(.7+r.spray*.55)),l.current&&(l.current.material.opacity=T.clamp(.34*X+r.burstFx*.3,0,.62)*(.28+be*.72),l.current.scale.set(1+X*.75+r.drift*.6,1,1+X*.5)),r.deckY+=(Fe.y-r.deckY)*(1-Math.pow(Pe(2e-4,.05),S)),R){Dn(M,S,r.heading-B);const Se=r.heading+Math.PI+M.smYaw,st=Math.cos(M.smPitch),Bt=Math.max(k*1.9,52)*M.smZoom*(1+X*Pe(.26,.1)+r.burstFx*Pe(.34,.12))*Oa(s.aspect),ro=T.lerp(Fe.y,r.deckY,Me.comfort),vt=Po.set(r.x+Math.sin(Se)*st*Bt,ro+k*.26+Math.sin(M.smPitch)*Bt,r.z+Math.cos(Se)*st*Bt),er=ut(vt.x,vt.z,y.t,Ye);vt.y=Math.max(vt.y,er.y+6),r.snapCam?(r.snapCam=!1,s.position.copy(vt)):s.position.lerp(vt,1-Math.pow(Pe(6e-4,.02),S));const tr=Math.max(0,Math.cos(M.smYaw)),es=X*Pe(66,34)*tr;s.lookAt(ta.set(r.x+(ee+K*T.clamp(te/40,-.4,.4))*es,ro+12-r.trim*26*X*Pe(1,.35),r.z+(P+ae*T.clamp(te/40,-.4,.4))*es));const ts=Pe(1,0);ts>.001&&s.rotateZ((Math.sin(y.t*2.3)*.012*X+r.heel*.3+r.aground*Math.sin(y.t*21)*.02+r.slam*Math.sin(y.t*34)*.03+Ie.danger*Math.sin(y.t*2.7)*.03)*ts),In(s,60+X*Pe(7,2)+r.burstFx*Pe(10,3),S,.06,Ga)}const Jn=Math.hypot(r.x-(Q.x+60*N),r.z-(Q.z+60*N));Jn<90*N&&Math.abs(r.speed)<24&&(y.footSpawn="port",R?o?.("foot"):r.area==="deck"&&(r.area="island",r.fx=Q.x+40*N,r.fz=Q.z+40*N,r.fy=re(r.fx,r.fz)+$e,r.fvx=0,r.fvz=0,r.fvy=0,r.fyaw=Math.atan2(he.x-r.fx,he.z-r.fz),M.yaw=M.smYaw=r.fyaw+Math.PI)),I.boardQueued&&(I.boardQueued=!1,R?(y.footSpawn="deck",o?.("foot")):r.area==="deck"&&o?.("helm")),R&&(y.helm={speed:r.speed,heading:r.heading,throttle:r.throttle,aground:r.aground,x:r.x,z:r.z,toGate:Math.min(Math.hypot(r.x,r.z-Pt),Math.hypot(r.x,r.z-Jt)),underFire:[Pt,Jt].some(Se=>{const st=Math.hypot(r.x,r.z-Se);return st>Vo.safe&&st<Vo.range}),moored:Jn<180*N,maelstrom:Ie.danger,swallowed:r.swallowed,burst:r.burst,drift:r.drift,maxSpeed:q,cruise:zt.level,flank:r.flank,freeCam:Me.freeCam},Fa(S,y.helm)),y.shelter+=(_e-y.shelter)*(1-Math.pow(.06,S)),y.underwater+=(0-y.underwater)*(1-Math.pow(.02,S))}if(e==="foot"){Dn(M,S,0);const B=I.boost?oa:Cc;r.fpitch+=(-M.smPitch-r.fpitch)*(1-Math.pow(1e-4,S));const G=I.walk.x,$=I.walk.z,q=Math.hypot(G,$),ee=q>1?q:1,P=-Math.sin(M.smYaw),K=-Math.cos(M.smYaw),ae=-K,H=P,te=(P*($/ee)+ae*(G/ee))*B,be=(K*($/ee)+H*(G/ee))*B,Tt=(1-Math.pow(q>.02?2e-5:4e-7,S))*(r.airborne?.25:1);r.fvx+=(te-r.fvx)*Tt,r.fvz+=(be-r.fvz)*Tt;const Ge=r.fvx*S,We=r.fvz*S,Ze=r.area==="island"?(se,X)=>re(se,X):r.area==="deck"?()=>y.ship.y+y.ship.deckY:(se,X,fe)=>pe.y+Jr(se-pe.x,X-pe.z,fe-pe.y),yt=r.area==="hall"?(se,X,fe)=>ei(se-pe.x,X-pe.z,fe-pe.y)||Xr(se,fe,X)>.97:()=>!1;if(r.area==="deck"){const se=Math.cos(-y.ship.heading),X=Math.sin(-y.ship.heading);r.dx+=Ge*se+We*-X,r.dz+=Ge*X+We*se;const fe=y.ship.loa*.14,Ve=y.ship.loa*.42;Math.abs(r.dx)>fe&&(r.dx=Math.sign(r.dx)*fe,r.fvx=0,r.fvz=0),Math.abs(r.dz)>Ve&&(r.dz=Math.sign(r.dz)*Ve,r.fvx=0,r.fvz=0);const je=Math.cos(y.ship.heading),Oe=Math.sin(y.ship.heading);r.fx=y.ship.x+r.dx*je+r.dz*Oe,r.fz=y.ship.z-r.dx*Oe+r.dz*je}else if(r.area==="island"){const se=r.fx+Ge,X=r.fz+We,fe=re(r.fx,r.fz),Ve=re(se,X),je=Math.hypot(Ge,We)||1e-6,Oe=(Ve-fe)/je;(Ve<=.3||Oe>=1.2&&Ve>=fe)&&(r.fvx=0,r.fvz=0),Ve>.3&&(Oe<1.2||Ve<fe)&&(r.fx=se,r.fz=X)}else{const se=r.fx+Ge,X=r.fz+We,fe=r.fy-$e,Ve=Ze(r.fx,r.fz,fe),je=r.airborne?fe:Ve;Ze(se,X,je)-je>na||yt(se,X,fe)?(r.fvx=0,r.fvz=0):(r.fx=se,r.fz=X)}const W=r.fy-$e,Re=Ze(r.fx,r.fz,W);if(r.airborne?(r.fvy-=Fc*S,r.fy+=r.fvy*S,r.fy-$e<=Re&&(r.landing=-r.fvy,r.fy=Re+$e,r.fvy=0,r.airborne=!1,r.landing>sa&&(Ht((r.landing-sa)*Lc,"A LONG WAY DOWN"),Ue.roll=0))):W-Re>na?(r.airborne=!0,r.fvy=0):(r.fy+=(Re+$e-r.fy)*(1-Math.pow(.002,S)),r.landing=Math.max(0,r.landing-S*40),I.jumpQueued&&(I.jumpQueued=!1,r.fvy=Pc,r.airborne=!0)),I.jumpQueued=!1,r.area==="island"){const se=Math.hypot(r.fx-he.x,r.fz-he.z),X=Math.hypot(r.fx-U.gate.x,r.fz-U.gate.z);se<80?(r.area="hall",r.fx=pe.x,r.fz=pe.z+lt.zTop,r.fy=pe.y+Le.y+$e,r.fvy=0,r.airborne=!1,r.fyaw=Math.PI,M.yaw=M.smYaw=0,M.pitch=M.smPitch=.05):X<40&&(r.area="hall",r.fx=pe.x+60,r.fz=pe.z+O.z+150,r.fy=pe.y+$e,r.fvy=0,r.airborne=!1,r.fyaw=0,M.yaw=M.smYaw=Math.PI,M.pitch=M.smPitch=.04),y.helm={onFoot:!0,area:"island",x:r.fx,z:r.fz,fy:r.fy-pe.y,toMouth:se,toRear:X,nearPort:Math.hypot(r.fx-Q.x,r.fz-Q.z)<Q.r*1.4};const fe=bo(r.fx,r.fz);y.shelter+=(fe-y.shelter)*(1-Math.pow(.06,S))}else if(r.area==="deck")y.helm={onFoot:!0,area:"deck",x:r.fx,z:r.fz,speed:r.speed,heading:r.heading,throttle:r.throttle,maxSpeed:Fo*(1+qs*r.flank),moored:!1};else{const se=r.fz-pe.z;se>Le.z+34&&(r.area="island",r.fx=he.x,r.fz=he.z+130,r.fy=re(r.fx,r.fz)+$e,r.fvy=0,r.airborne=!1,r.fyaw=0,M.yaw=M.smYaw=Math.PI,M.pitch=M.smPitch=-.04),y.helm={onFoot:!0,area:"hall",x:r.fx,z:r.fz,lz:se,fy:r.fy-pe.y},y.shelter+=(1-y.shelter)*(1-Math.pow(.06,S))}const qe=Math.hypot(r.fvx,r.fvz);r.stride+=qe*S;const nt=g.height??1.74;if(qe>.4){let X=Math.atan2(r.fvx,r.fvz)-r.fyaw;for(;X>Math.PI;)X-=Math.PI*2;for(;X<-Math.PI;)X+=Math.PI*2;r.fyaw+=X*(1-Math.pow(4e-4,S))}r.fpitch+=(-M.smPitch-r.fpitch)*(1-Math.pow(1e-4,S)),r.pace=qe,d.current.speed=qe,d.current.maxSpeed=oa,d.current.grounded=!r.airborne,d.current.vy=r.fvy,d.current.landing=r.landing,Ue.playerTurn=(r.fyaw-r.fyaw0)/Math.max(S,1e-4),r.fyaw0=r.fyaw,h.x=r.fx,h.y=r.fy-$e,h.z=r.fz,h.yaw=M.smYaw+Math.PI,h.pitch=M.smPitch,h.height=nt,h.floorY=r.area==="hall"?r.fy-$e:null,vc(S,h,I,p),(p.x||p.z)&&(r.fvx+=p.x,r.fvz+=p.z);const Ie=(r.area==="deck"?Math.max(nt*2.6,y.ship.loa*.34):nt*2.6)*M.smZoom,He=Math.cos(M.smPitch),D=r.area==="deck"?T.lerp(r.fy,r.deckY+y.ship.deckY+$e,Me.comfort):r.fy,ue=D+Math.sin(r.stride*1.6)*.05*Pe(1,.3),Je=r.fx+Math.sin(M.smYaw)*He*Ie,_e=r.fz+Math.cos(M.smYaw)*He*Ie;let Ye=ue+nt*.28+Math.sin(M.smPitch)*Ie;const Fe=r.area==="island"?re(Je,_e):D-$e;Ye=Math.max(Ye,Fe+nt*.6),Po.set(Je,Ye,_e),r.snapCam?(r.snapCam=!1,s.position.copy(Po)):s.position.lerp(Po,1-Math.pow(Pe(9e-4,.02),S)),s.lookAt(ta.set(r.fx,ue-nt*.1,r.fz)),In(s,r.area==="hall"?72:64,S,.02),c.current&&(c.current.position.set(r.fx,r.fy-$e,r.fz),c.current.rotation.y=r.fyaw),y.underwater+=(0-y.underwater)*(1-Math.pow(.02,S))}y.fog=T.lerp(Ft.sea,Ft.bay,y.shelter),y.rain=1-y.shelter*.92}),t.jsxs(t.Fragment,{children:[t.jsx("group",{ref:c,position:[0,-4e3,0],visible:e==="foot",children:t.jsx(fr,{character:g,motion:d})}),t.jsxs("group",{ref:a,position:[0,-4e3,0],visible:e==="helm",children:[v&&t.jsx(ge,{name:b,loa:k,slim:nn(b),sink:vo(b),rotation:en(b),tint:u?"#9a9188":"#c98a52",emissive:"#3a2a18",emissiveIntensity:.18}),v&&z&&_o.slice(0,2).map(([F,C,S],R)=>t.jsx(ge,{name:"crew-straw.opt.glb",height:tn,rotation:S,position:[F*k,Nt(b,k),C*k]},`crew-${R}`)),t.jsxs("mesh",{position:[0,2,0],scale:[1,.74,2.7],castShadow:!0,visible:!v,children:[t.jsx("capsuleGeometry",{args:[5,9,4,12]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.84})]}),t.jsxs("mesh",{position:[0,5.4,0],visible:!v,children:[t.jsx("boxGeometry",{args:[8.6,.8,24]}),t.jsx("meshStandardMaterial",{color:"#6b4b34",roughness:.92})]}),t.jsxs("mesh",{position:[0,6.6,13],rotation:[.5,0,0],castShadow:!0,visible:!v,children:[t.jsx("boxGeometry",{args:[4,10,2.6]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.86})]}),t.jsxs("mesh",{position:[0,9,-8.5],castShadow:!0,visible:!v,children:[t.jsx("boxGeometry",{args:[8,7,7.5]}),t.jsx("meshStandardMaterial",{color:"#a85f24",roughness:.88})]}),t.jsxs("mesh",{position:[0,16,1],castShadow:!0,visible:!v,children:[t.jsx("cylinderGeometry",{args:[1.05,1.4,27,6]}),t.jsx("meshStandardMaterial",{color:"#2f2016",roughness:.9})]}),t.jsxs("mesh",{position:[0,25.5,1.2],rotation:[0,0,Math.PI/2],castShadow:!0,visible:!v,children:[t.jsx("cylinderGeometry",{args:[.6,.6,19,5]}),t.jsx("meshStandardMaterial",{color:"#241a12",roughness:.9})]}),t.jsxs("mesh",{ref:f,position:[0,17.5,1.5],visible:!v,children:[t.jsx("planeGeometry",{args:[17,15]}),t.jsx("meshStandardMaterial",{color:"#f0e6cf",roughness:1,side:De,emissive:"#f0e6cf",emissiveIntensity:.3})]}),t.jsxs("group",{position:[0,7.4,14.6],visible:!v,children:[t.jsxs("mesh",{castShadow:!0,children:[t.jsx("sphereGeometry",{args:[3.4,10,8]}),t.jsx("meshStandardMaterial",{color:"#e0a33c",roughness:.8})]}),t.jsxs("mesh",{position:[0,0,-1.2],rotation:[Math.PI/2,0,0],children:[t.jsx("torusGeometry",{args:[4.5,1.6,6,14]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.82})]})]}),[-1,1].map(F=>t.jsxs("mesh",{position:[F*k*.085,(v?Nt(b,k):8)+k*.045,-k*.19],children:[t.jsx("sphereGeometry",{args:[k*.019,8,6]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:3.4,toneMapped:!1})]},F)),t.jsx(yo,{crew:"straw",width:v?k*.24:14,position:[0,v?sn(b,k)*.88:26,-k*.06]}),t.jsxs("mesh",{ref:l,position:[0,.6,-k*1.05],rotation:[-Math.PI/2,0,0],children:[t.jsx("planeGeometry",{args:[k*.6,k*2.2]}),t.jsx("meshBasicMaterial",{map:kn,color:Z.foam,transparent:!0,opacity:.3,depthWrite:!1,toneMapped:!1})]}),t.jsxs("mesh",{ref:m,position:[0,k*.12,k*.56],rotation:[-.5,0,0],children:[t.jsx("planeGeometry",{args:[k*.85,k*.6]}),t.jsx("meshBasicMaterial",{map:Fi,color:Z.foam,transparent:!0,opacity:0,depthWrite:!1,toneMapped:!1,blending:bt})]})]})]})}const aa=76,Oc=24,ra=26,Dc=1.15,Nc=.44,Hc=.05,_c=.22,Bc=70,Go=340,ia=7,Uc=6,la=60,Oo=185,Wc=new j,ca=new j,Do={x:430*N,z:1e3*N};function Yc({mode:e,onMode:o}){const n=we(x=>x.camera),s=we(x=>x.gl),i=w.useRef(),a=w.useRef(),c=w.useRef(),d=ot("ship-tang.opt.glb"),h=ot("ship-sub.opt.glb"),p=d||h,g=ot("crew-heart.opt.glb"),f=d?"ship-tang.opt.glb":"ship-sub.opt.glb",m=on(f,28),l=w.useRef({x:Do.x,z:Do.z,heading:Math.PI,speed:0,throttle:0,rudder:0,flank:0,depth:4,orderedDepth:4,pitch:0,heel:0,scrape:0,stress:0,berthing:0,snapCam:!0}).current,u=Qa({enabled:e==="sub",dom:s.domElement,zoomMin:.42,zoomMax:2.3,pitch0:.22,pitchMin:-1,pitchMax:1.42});return w.useEffect(()=>{if(e==="sub")return l.x=Do.x,l.z=Do.z,l.heading=Math.PI,l.speed=0,l.throttle=0,l.flank=0,l.depth=4,l.orderedDepth=4,l.berthing=0,l.snapCam=!0,u.yaw=0,u.smYaw=0,u.pitch=.22,u.smPitch=.22,u.pitch0=.22,u.zoom=1,u.smZoom=1,u.noRecentre=!1,l.heel=0,y.subActive=!0,y.helm=null,Rn("sub"),()=>{y.subActive=!1,y.subThrottle=0}},[e,l,u]),ne((x,v)=>{if(e!=="sub"){i.current&&i.current.position.set(0,-4e3,0);return}const b=Math.min(v,.05);y.t+=b;const k=l.heading,z=I.boost;l.throttle+=(I.throttle-l.throttle)*(1-Math.pow(.02,b)),l.flank+=((z?1:0)-l.flank)*(1-Math.pow(Hc,b)),y.subThrottle=Math.abs(l.throttle),l.rudder+=(I.rudder-l.rudder)*(1-Math.pow(8e-4,b));const r=T.clamp(l.depth/15,0,1),M=aa*(.7+.3*r)*(1+Nc*l.flank),F=l.throttle>=0?l.throttle*M:l.throttle*Oc;l.speed+=T.clamp(F-l.speed,-ra*2,ra)*b,l.speed-=l.speed*Math.abs(l.speed)*.0016*b;const C=T.lerp(_c,1,T.clamp(Math.abs(l.speed)/7,0,1));l.heading+=l.rudder*Dc*C*Math.sign(l.speed>=0?1:-1)*b,l.orderedDepth-=I.planes*Bc*b,l.orderedDepth=T.clamp(l.orderedDepth,0,Go),I.surfaceQueued&&(I.surfaceQueued=!1,l.orderedDepth=0),I.periscopeQueued&&(I.periscopeQueued=!1,l.orderedDepth=Uc);const S=l.x+Math.sin(l.heading)*l.speed*b,R=l.z+Math.cos(l.heading)*l.speed*b,A=ba(S,R,l.depth);l.x=S+A.vx*b,l.z=R+A.vz*b;const B=A.vx*Math.cos(l.heading)-A.vz*Math.sin(l.heading);l.heading+=B*.008*b;const G=T.clamp(Math.abs(l.speed)/aa,0,1),$=T.clamp(B*.02+l.rudder*C*G*.34,-.6,.6);l.heel+=($-l.heel)*(1-Math.pow(.12,b)),A.danger>.05&&(l.speed*=Math.pow(1-.22*A.danger,b));const q=re(l.x,l.z),ee=Math.max(2,-q-ia),P=l.depth<1.5;l.depth+=(l.orderedDepth-l.depth)*(1-Math.pow(.12,b)),l.depth>ee?(l.scrape+=(1-l.scrape)*(1-Math.pow(.02,b)),l.depth=ee,l.orderedDepth=Math.min(l.orderedDepth,ee-2),Ht(Math.abs(l.speed)*.0016*b*60,"GROUNDED ON THE SHELF"),l.speed*=Math.pow(.3,b)):l.scrape+=(0-l.scrape)*(1-Math.pow(.05,b));const K=(l.depth-Oo)/(Go-Oo);l.stress=K>0?Math.min(1,K*K):0,l.stress>0&&Ht(l.stress*.06*b,"HULL UNDER PRESSURE — COME UP");const ae=l.x+Math.sin(l.heading)*26,H=l.z+Math.cos(l.heading)*26;if(re(ae,H)>-l.depth+ia*.5){l.speed*=Math.pow(.1,b);const Oe=6,Ke=re(l.x+Oe,l.z)-re(l.x-Oe,l.z),Mo=re(l.x,l.z+Oe)-re(l.x,l.z-Oe),jo=Math.hypot(Ke,Mo)||1;l.x-=Ke/jo*20*b,l.z-=Mo/jo*20*b,l.scrape=Math.max(l.scrape,.5)}const be=Math.hypot(l.x-U.x,l.z-U.z);if(be<U.pool*1.1&&l.berthing===0&&(l.berthing=1e-4),l.berthing>0){l.berthing=Math.min(1,l.berthing+b*.5),l.x+=(U.berth.x-l.x)*(1-Math.pow(.1,b)),l.z+=(U.berth.z-l.z)*(1-Math.pow(.1,b)),l.orderedDepth=0,l.speed*=Math.pow(.1,b);let Ke=Math.atan2(U.dir[0],U.dir[1])+Math.PI-l.heading;for(;Ke>Math.PI;)Ke-=Math.PI*2;for(;Ke<-Math.PI;)Ke+=Math.PI*2;l.heading+=Ke*(1-Math.pow(.2,b)),l.berthing>=1&&l.depth<1.2&&(y.footSpawn="rear",y.splash+=1,o?.("foot"))}l.depth<1.5!==P&&(y.splash+=1);const Ge=ut(l.x,l.z,y.t,1),We=1-T.clamp(l.depth/10,0,1),Ze=-l.depth+Ge.y*We,yt=T.clamp((l.orderedDepth-l.depth)*.05,-.34,.34)*Math.sign(l.speed>=0?1:-1)+Ge.dz*.8*We;l.pitch+=(yt-l.pitch)*(1-Math.pow(.05,b));const W=i.current;W&&(W.position.set(l.x,Ze,l.z),W.rotation.set(l.pitch+l.scrape*Math.sin(y.t*23)*.02,l.heading,-Ge.dx*.5*We+l.heel)),a.current&&(a.current.rotation.z+=l.throttle*9*b),c.current&&(c.current.visible=l.depth<2.5),y.subPos.set(l.x,Ze,l.z),Dn(u,b,l.heading-k);const Re=l.heading+Math.PI+u.smYaw,qe=Math.cos(u.smPitch),nt=T.clamp(l.depth/240,0,1),Ie=Math.max(m*2.6,60)*u.smZoom*(1-nt*.2)*Oa(n.aspect),He=Wc.set(l.x+Math.sin(Re)*qe*Ie,Ze+m*.2+Math.sin(u.smPitch)*Ie,l.z+Math.cos(Re)*qe*Ie),D=re(He.x,He.z);He.y=Math.max(He.y,D+5),l.depth>10&&(He.y=Math.min(He.y,Ge.y-3)),l.snapCam?(l.snapCam=!1,n.position.copy(He)):n.position.lerp(He,1-Math.pow(Pe(8e-4,.02),b));const ue=Math.max(0,Math.cos(u.smYaw)),Je=G*Pe(46,26)*ue;ca.set(l.x+Math.sin(l.heading)*Je,Ze+6-l.pitch*30*G*Pe(1,.35),l.z+Math.cos(l.heading)*Je),n.lookAt(ca);const _e=Pe(1,0);_e>.001&&n.rotateZ((l.scrape*Math.sin(y.t*19)*.015+l.heel*.35+A.danger*Math.sin(y.t*3.1)*.02)*_e),In(n,64+G*Pe(6,2)+l.flank*Pe(2,.6),b,.06,Ga);const Ye=ut(n.position.x,n.position.z,y.t,1),Fe=T.clamp((Ye.y-n.position.y-1)/3,0,1);y.underwater+=(Fe-y.underwater)*(1-Math.pow(.002,b)),y.depthBelow=Math.max(0,Ye.y-n.position.y);const se=T.lerp(8200,1700,y.underwater);Math.abs(n.far-se)>20&&(n.far=se,n.updateProjectionMatrix()),y.shelter+=((be<U.pool*3?.85:0)-y.shelter)*(1-Math.pow(.06,b));let X=Ne[0],fe=1/0;for(const Oe of Ne){const Ke=(l.x-Oe.x)**2+(l.z-Oe.z)**2;Ke<fe&&(fe=Ke,X=Oe)}Pa(b,{danger:A.danger,headingX:Math.sin(l.heading),headingZ:Math.cos(l.heading),toCentreX:X.x-l.x,toCentreZ:X.z-l.z,speed:l.speed,throttle:l.throttle})>=1&&(Ht(.22,"CAUGHT IN THE VORTEX"),l.x=X.x+(l.x>X.x?1:-1)*X.r*1.9,l.z=X.z+X.r*1.5,l.speed=0,l.orderedDepth=Math.min(Go,l.depth+18),Y.grip=0,y.splash+=1);let je=Math.atan2(U.x-l.x,U.z-l.z)-l.heading;for(;je>Math.PI;)je-=Math.PI*2;for(;je<-Math.PI;)je+=Math.PI*2;y.helm={sub:!0,speed:l.speed,maxSpeed:M,heading:l.heading,depth:l.depth,orderedDepth:l.orderedDepth,scrape:l.scrape,stress:l.stress,maelstrom:A.danger,toRear:be,relRear:je,berthing:l.berthing>0,x:l.x,z:l.z,maxDepth:Go,crushDepth:Oo,cruise:zt.level,flank:l.flank,freeCam:Me.freeCam,dark:T.clamp((l.depth-la)/(Oo-la),0,1)},Fa(b,y.helm)}),t.jsxs("group",{ref:i,position:[0,-4e3,0],children:[p&&t.jsx(ge,{name:f,loa:m,slim:nn(f),sink:vo(f),rotation:en(f),tint:d?"#a89a80":"#c9b445",emissive:"#2a2410",emissiveIntensity:.22}),t.jsxs("group",{ref:c,position:[0,Nt(f,m),-m*.07],children:[g&&t.jsx(ge,{name:"crew-heart.opt.glb",height:tn,rotation:0}),t.jsx(yo,{crew:"heart",width:m*.26,position:[0,sn(f,m)*.55,-m*.2]})]}),t.jsxs("group",{visible:!p,children:[t.jsxs("mesh",{castShadow:!0,scale:[1,.82,2.9],children:[t.jsx("capsuleGeometry",{args:[5.4,8,6,12]}),t.jsx("meshStandardMaterial",{color:"#c9b03a",roughness:.55,metalness:.18})]}),t.jsxs("mesh",{position:[0,4.6,0],children:[t.jsx("boxGeometry",{args:[7.6,.8,26]}),t.jsx("meshStandardMaterial",{color:"#8a7a3a",roughness:.8})]}),t.jsxs("mesh",{position:[0,8,5],castShadow:!0,children:[t.jsx("cylinderGeometry",{args:[2.6,3,7,8]}),t.jsx("meshStandardMaterial",{color:"#d8cebf",roughness:.6})]}),t.jsxs("mesh",{position:[0,12,5],castShadow:!0,children:[t.jsx("coneGeometry",{args:[2.8,3,8]}),t.jsx("meshStandardMaterial",{color:"#5a6b8a",roughness:.6})]}),t.jsxs("mesh",{position:[0,3,-15],castShadow:!0,children:[t.jsx("boxGeometry",{args:[.9,10,5]}),t.jsx("meshStandardMaterial",{color:"#b09a32",roughness:.6})]}),t.jsxs("mesh",{position:[0,.4,-14],rotation:[0,0,Math.PI/2],children:[t.jsx("boxGeometry",{args:[.8,12,4]}),t.jsx("meshStandardMaterial",{color:"#b09a32",roughness:.6})]}),[-1,1].map(x=>[0,1,2,3].map(v=>t.jsxs("mesh",{position:[x*5.1,1.2,8-v*5],children:[t.jsx("sphereGeometry",{args:[.55,6,5]}),t.jsx("meshStandardMaterial",{color:"#8fe8c9",emissive:"#8fe8c9",emissiveIntensity:2.6,toneMapped:!1})]},`${x}-${v}`)))]}),t.jsxs("mesh",{position:[0,m*.02,m*.5],children:[t.jsx("sphereGeometry",{args:[1.7,10,8]}),t.jsx("meshStandardMaterial",{color:"#b8ffe2",emissive:"#8fe8c9",emissiveIntensity:4.2,toneMapped:!1})]}),t.jsx("sprite",{position:[0,m*.02,m*.6],scale:[m*.9,m*.9,1],children:t.jsx("spriteMaterial",{map:Vc,color:"#7fe8c9",transparent:!0,opacity:.5,depthWrite:!1,blending:bt})}),t.jsxs("mesh",{position:[0,m*.24,-m*.42],children:[t.jsx("sphereGeometry",{args:[.9,8,6]}),t.jsx("meshStandardMaterial",{color:"#ffb066",emissive:"#ffb066",emissiveIntensity:3,toneMapped:!1})]}),t.jsxs("mesh",{ref:a,position:[0,m*.012,-m*.52],children:[t.jsx("torusGeometry",{args:[1.6,.5,6,10]}),t.jsx("meshStandardMaterial",{color:"#6b5a20",roughness:.5,metalness:.4})]}),t.jsx(Xc,{})]})}const Vc=(()=>{if(typeof document>"u")return null;const e=64,o=document.createElement("canvas");o.width=e,o.height=e;const n=o.getContext("2d"),s=n.createRadialGradient(e/2,e/2,2,e/2,e/2,e/2);s.addColorStop(0,"rgba(255,255,255,0.9)"),s.addColorStop(.4,"rgba(255,255,255,0.28)"),s.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=s,n.fillRect(0,0,e,e);const i=new no(o);return i.colorSpace=so,i})(),$c=`
  uniform float uTime;
  uniform float uGain;
  attribute float aPhase;
  attribute float aRate;
...
`;function Xc(){const e=w.useRef(),o=w.useMemo(()=>{const i=new Float32Array(780),a=new Float32Array(260),c=new Float32Array(260),d=new Float32Array(260);for(let p=0;p<260;p++)i[p*3]=(Math.random()-.5)*3.4,i[p*3+1]=(Math.random()-.5)*2.6,i[p*3+2]=-14-Math.random()*4,a[p]=Math.random(),c[p]=.25+Math.random()*.3,d[p]=2+Math.random()*4;const h=new Lt;return h.setAttribute("position",new oe(i,3)),h.setAttribute("aPhase",new oe(a,1)),h.setAttribute("aRate",new oe(c,1)),h.setAttribute("aSize",new oe(d,1)),h.boundingSphere=new ao(new j(0,0,-30),70),h},[]),n=w.useMemo(()=>({uTime:{value:0},uGain:{value:0},uColor:{value:new j(...ie(Z.underGlow))}}),[]);return ne((s,i)=>{const a=e.current?.uniforms;if(!a)return;a.uTime.value+=i;const c=y.subActive?y.subThrottle*y.underwater:0;a.uGain.value+=(c-a.uGain.value)*.06}),t.jsx("points",{geometry:o,renderOrder:3,children:t.jsx("shaderMaterial",{ref:e,vertexShader:$c,fragmentShader:Kc,uniforms:n,transparent:!0,depthWrite:!1,blending:bt,fog:!1})})}const Za=.42;let _=null,kt=null,ye=null,Nn=!1,wt=!0;function Qc(){try{const e=localStorage.getItem("oni.audio");e!==null&&(wt=e==="1")}catch{}return wt}function gn(e){wt=e;try{localStorage.setItem("oni.audio",e?"1":"0")}catch{}return kt&&_&&kt.gain.setTargetAtTime(e?Za:0,_.currentTime,.12),e&&_?.state==="suspended"&&_.resume(),wt}function Zc(e){const o=e.sampleRate*2,n=e.createBuffer(1,o,e.sampleRate),s=n.getChannelData(0);for(let i=0;i<o;i++)s[i]=Math.random()*2-1;return n}function uo(e,o,n,s,i,a,c){const d=e.createBufferSource();d.buffer=o,d.loop=!0;const h=e.createBiquadFilter();h.type=n,h.frequency.value=s,h.Q.value=i;const p=e.createGain();return p.gain.value=a,d.connect(h).connect(p).connect(c),d.start(),{src:d,filt:h,gain:p}}function xn(){if(Nn){_?.state==="suspended"&&_.resume();return}const e=window.AudioContext||window.webkitAudioContext;if(!e)return;_=new e,Nn=!0,kt=_.createGain(),kt.gain.value=wt?Za:0;const o=_.createDynamicsCompressor();o.threshold.value=-18,o.knee.value=22,o.ratio.value=3.4,o.attack.value=.006,o.release.value=.26;const n=_.createBiquadFilter();n.type="lowpass",n.frequency.value=18e3,n.Q.value=.4,kt.connect(n).connect(o).connect(_.destination);const s=Zc(_),i=_.createGain();i.gain.value=1,i.connect(kt);const a=uo(_,s,"bandpass",480,.7,.3,i),c=uo(_,s,"highpass",1900,.5,0,i),d=uo(_,s,"lowpass",220,1.1,.22,i),h=uo(_,s,"lowpass",96,1.6,0,i),p=_.createGain();p.gain.value=1,p.connect(o);const g=_.createOscillator();g.type="sawtooth",g.frequency.value=41;const f=_.createBiquadFilter();f.type="lowpass",f.frequency.value=190,f.Q.value=1.2;const m=_.createGain();m.gain.value=0,g.connect(f).connect(m).connect(p),g.start();const l=_.createOscillator(),u=_.createOscillator(),x=_.createGain();l.frequency.value=.07,u.frequency.value=.113,x.gain.value=260,l.connect(x),u.connect(x),x.connect(a.filt.frequency),l.start(),u.start();const v=_.createGain();v.gain.value=0,v.connect(kt);const b=_.createGain();b.gain.value=.16,b.connect(v);for(const[z,r]of[[146.83,1],[220,.5],[293.66,.3]]){const M=_.createOscillator();M.type="sine",M.frequency.value=z;const F=_.createGain();F.gain.value=r;const C=_.createOscillator(),S=_.createGain();C.frequency.value=.21+Math.random()*.1,S.gain.value=z*.004,C.connect(S).connect(M.frequency),C.start(),M.connect(F).connect(b),M.start()}const k=uo(_,s,"bandpass",900,3.2,.05,v);return ye={stormBus:i,festBus:v,wind:a,rain:c,sea:d,roar:h,breath:k,buf:s,comp:o,muffle:n,humGain:m,subBus:p},_}function qc(){if(!_||!ye||!wt)return;const e=_.currentTime;for(const[o,n]of[[0,.16],[.9,.045]]){const s=_.createOscillator(),i=_.createGain();s.type="sine",s.frequency.setValueAtTime(1420,e+o),s.frequency.exponentialRampToValueAtTime(1180,e+o+.5),i.gain.setValueAtTime(0,e+o),i.gain.linearRampToValueAtTime(n,e+o+.012),i.gain.exponentialRampToValueAtTime(1e-4,e+o+1.4),s.connect(i).connect(ye.subBus),s.start(e+o),s.stop(e+o+1.5)}}function Jc(e=1){if(!_||!ye||!wt)return;const o=_.currentTime,n=_.createBufferSource();n.buffer=ye.buf;const s=_.createBiquadFilter();s.type="bandpass",s.frequency.setValueAtTime(1500,o),s.frequency.exponentialRampToValueAtTime(240,o+.5),s.Q.value=.7;const i=_.createGain();i.gain.setValueAtTime(0,o),i.gain.linearRampToValueAtTime(.5*e,o+.02),i.gain.exponentialRampToValueAtTime(1e-4,o+.8),n.connect(s).connect(i).connect(kt),n.start(o),n.stop(o+.9)}function Kt(e,o=1,n=82){if(!_||!ye)return;const s=_.createOscillator(),i=_.createGain();s.type="sine",s.frequency.setValueAtTime(n*2.1,e),s.frequency.exponentialRampToValueAtTime(n,e+.06),s.frequency.exponentialRampToValueAtTime(n*.7,e+.5),i.gain.setValueAtTime(0,e),i.gain.linearRampToValueAtTime(o,e+.004),i.gain.exponentialRampToValueAtTime(1e-4,e+.62),s.connect(i).connect(ye.festBus),s.start(e),s.stop(e+.7);const a=_.createBufferSource();a.buffer=ye.buf;const c=_.createBiquadFilter();c.type="bandpass",c.frequency.value=1400,c.Q.value=.8;const d=_.createGain();d.gain.setValueAtTime(o*.5,e),d.gain.exponentialRampToValueAtTime(1e-4,e+.09),a.connect(c).connect(d).connect(ye.festBus),a.start(e),a.stop(e+.12)}function e0(e=1,o=0){if(!_||!ye||!wt)return;const n=_.currentTime+o,s=_.createBufferSource();s.buffer=ye.buf,s.loop=!0;const i=_.createBiquadFilter();i.type="lowpass",i.frequency.setValueAtTime(320,n),i.frequency.exponentialRampToValueAtTime(70,n+2.6),i.Q.value=.9;const a=_.createGain(),c=.5*e;a.gain.setValueAtTime(0,n),a.gain.linearRampToValueAtTime(c,n+.05),a.gain.exponentialRampToValueAtTime(c*.24,n+.7),a.gain.exponentialRampToValueAtTime(c*.42,n+1.35),a.gain.exponentialRampToValueAtTime(1e-4,n+3.4),s.connect(i).connect(a).connect(ye.stormBus),s.start(n),s.stop(n+3.6);const d=_.createOscillator(),h=_.createGain();d.type="sine",d.frequency.setValueAtTime(46,n),d.frequency.exponentialRampToValueAtTime(28,n+2.2),h.gain.setValueAtTime(0,n),h.gain.linearRampToValueAtTime(.32*e,n+.08),h.gain.exponentialRampToValueAtTime(1e-4,n+2.6),d.connect(h).connect(ye.stormBus),d.start(n),d.stop(n+2.8)}function t0(e=.5){if(!_||!ye||!wt)return;const o=_.currentTime;for(const[n,s,i]of[[1,1,9],[2.76,.5,6],[5.4,.28,3.6],[8.9,.15,2.2]]){const a=_.createOscillator(),c=_.createGain();a.type="sine",a.frequency.value=61*n,c.gain.setValueAtTime(0,o),c.gain.linearRampToValueAtTime(e*s,o+.008),c.gain.exponentialRampToValueAtTime(1e-4,o+i),a.connect(c).connect(kt),a.start(o),a.stop(o+i+.1)}}let dt=0,wn=0,ha=0,po=0;function o0(e){if(!Nn||!_||!ye||!wt)return;const o=_.currentTime,n=e.shelter,s=e.underwater,i=e.subActive?.12:1,a=Math.sin(n*Math.PI*.5)*i*(1-s*.92);ye.stormBus.gain.setTargetAtTime(Math.cos(n*Math.PI*.5),o,.35),ye.festBus.gain.setTargetAtTime(a,o,.35),ye.rain.gain.gain.setTargetAtTime(.22*e.rain,o,.4),ye.wind.gain.gain.setTargetAtTime(.3*(.25+e.rain*.75),o,.5),ye.sea.gain.gain.setTargetAtTime(.22*(.3+e.rain*.7),o,.5),ye.roar.gain.gain.setTargetAtTime(.55*e.whirlNear*(1-s*.55),o,.3),ye.muffle.frequency.setTargetAtTime(18e3-s*17400,o,.18);const c=e.subActive?s*(.045+e.subThrottle*.11):e.helmActive?.03+e.helmSpeed*.1:0;if(ye.humGain.gain.setTargetAtTime(c,o,.25),e.splash!==ha&&(ha=e.splash,Jc(1)),e.subActive&&s>.5?po===0?po=o+1.2:o>=po&&(qc(),po=o+6.5):po=0,n>.06){const h=.9090909090909091;for(dt<o&&(dt=o+.1);dt<o+.35;){const p=wn%8,g=n*.9;p===0?Kt(dt,.85*g,74):p===2?Kt(dt,.45*g,88):p===4?Kt(dt,.7*g,74):p===6?Kt(dt,.4*g,92):p===7&&(Kt(dt,.3*g,96),Kt(dt+h*.5,.36*g,96)),wn++,dt+=h}}else dt=0,wn=0}function n0(){const e=w.useRef(!1),o=w.useRef(-1);return ne(()=>{if(o0(y),y.flash>.55&&!e.current){e.current=!0;const n=y.flashDir,s=500+Math.abs(n.z)*900;e0(Math.min(1,.55+y.flash*.6),s/340)}else y.flash<.08&&(e.current=!1);y.shot!==o.current&&(y.shot===4&&o.current>=0&&t0(.55),o.current=y.shot)}),null}function s0({mode:e}){return y.mode=e,ne(()=>El(),-100),null}function a0(){const e=we(i=>i.gl),o=we(i=>i.camera),n=we(i=>i.setSize),s=we(i=>i.size);return w.useEffect(()=>{const i=()=>{const a=window.innerWidth,c=window.innerHeight;a<2||c<2||s.width>a*.5&&s.height>c*.5||(n(a,c),e.setSize(a,c,!1),o.aspect=a/c,o.updateProjectionMatrix())};return i(),window.addEventListener("resize",i),document.addEventListener("visibilitychange",i),()=>{window.removeEventListener("resize",i),document.removeEventListener("visibilitychange",i)}},[e,o,n,s.width,s.height]),null}function r0({every:e=12}){const o=we(s=>s.gl),n=w.useRef(0);return w.useEffect(()=>(o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0,()=>{o.shadowMap.autoUpdate=!0}),[o]),ne(()=>{n.current+=1,n.current%e===0&&(o.shadowMap.needsUpdate=!0)}),null}function i0({budget:e}){const o=we(s=>s.setDpr),n=w.useRef(e.dpr[1]);return t.jsx(sr,{bounds:s=>s>90?[50,90]:[46,58],flipflops:3,onDecline:()=>{n.current=Math.max(e.dpr[0],n.current-.25),o(n.current)},onIncline:()=>{n.current=Math.min(e.dpr[1],n.current+.25),o(n.current)},onFallback:()=>{n.current=e.dpr[0],o(e.dpr[0])}})}function l0(){const e=we(s=>s.gl),o=we(s=>s.scene),n=we(s=>s.camera);return w.useEffect(()=>{const s=setTimeout(()=>{try{e.compile(o,n)}catch(i){console.warn("[onigashima] pre-compile skipped",i)}},900);return()=>clearTimeout(s)},[e,o,n]),null}function c0(){const{camera:e,scene:o,gl:n}=we();return w.useEffect(()=>{},[e,o,n]),null}const h0=new ve(Z.haze),d0=new ve(Z.underHaze),u0=new ve(Z.abyss),da=new ve;function p0(){const e=we(o=>o.scene);return ne(()=>{if(!e.fog)return;const o=T.clamp(y.depthBelow/Ft.deepGrade,0,1),n=T.lerp(.0062,.0142,o);e.fog.density=T.lerp(y.fog,n,y.underwater),da.copy(d0).lerp(u0,o*.8),e.fog.color.lerpColors(h0,da,y.underwater)}),null}function f0({quality:e,budget:o,onRails:n,playing:s,speed:i,onShot:a,mode:c,onMode:d,crew:h}){return t.jsxs(t.Fragment,{children:[t.jsx("color",{attach:"background",args:[Z.haze]}),t.jsx("fogExp2",{attach:"fog",args:[Z.haze,y.fog]}),t.jsx(vr,{storm:y}),t.jsx(Yi,{quality:e,shadowMap:o.shadowMap,shadows:o.shadows}),t.jsx($r,{quality:e,segments:o.segments}),t.jsx(_r,{quality:e,storm:y}),t.jsx(di,{quality:e,shadows:o.shadows}),t.jsx(ds,{quality:e,shadows:o.shadows}),e!=="low"&&t.jsx(ds,{quality:e,shadows:!1,z:Jt,k:N*1.5}),t.jsx(gi,{quality:e,shadows:o.shadows}),t.jsx(wi,{quality:e,shadows:o.shadows}),t.jsx(Ni,{quality:e}),t.jsx(Bi,{shadows:o.shadows}),t.jsx(ec,{quality:e,shadows:o.shadows}),t.jsx(Ji,{quality:e}),t.jsx(nl,{quality:e}),t.jsx(hl,{quality:e}),t.jsx(yl,{quality:e}),t.jsx(Ll,{onRails:n&&c==="off",playing:s&&c==="off",speed:i,onShot:a,idle:c!=="off"}),t.jsx(s0,{mode:c}),t.jsx(mr,{}),t.jsx(gr,{}),t.jsx(xr,{}),t.jsx(Gc,{mode:c,onMode:d,crew:h}),t.jsx(Yc,{mode:c,onMode:d}),t.jsx(n0,{}),t.jsx(a0,{}),t.jsx(p0,{}),t.jsx(c0,{}),t.jsx(l0,{}),t.jsx(i0,{budget:o}),o.shadows&&t.jsx(r0,{every:o.shadowEvery})]})}const fo="#d63420",m0="rgba(8,6,16,0.72)",ua="(max-width: 860px), (max-height: 520px)",bn="min(7.5vh, 62px)";function g0(e=2600,o=!0){const[n,s]=w.useState(!1);return w.useEffect(()=>{if(!o){s(!1);return}let i;const a=()=>{s(!1),clearTimeout(i),i=setTimeout(()=>s(!0),e)};a();for(const c of["pointermove","pointerdown","keydown","touchstart","wheel"])window.addEventListener(c,a,{passive:!0});return()=>{clearTimeout(i);for(const c of["pointermove","pointerdown","keydown","touchstart","wheel"])window.removeEventListener(c,a)}},[e,o]),n}function x0(){const[e,o]=w.useState(()=>typeof window<"u"&&window.matchMedia(ua).matches);return w.useEffect(()=>{const n=window.matchMedia(ua),s=()=>o(n.matches);return n.addEventListener?n.addEventListener("change",s):n.addListener(s),()=>{n.removeEventListener?n.removeEventListener("change",s):n.removeListener(s)}},[]),e}function at({on:e,onClick:o,children:n,title:s,wide:i,block:a}){return t.jsx("button",{onClick:o,title:s,style:{appearance:"none",border:`1px solid ${e?fo:"rgba(255,255,255,0.16)"}`,background:e?"rgba(214,52,32,0.22)":"rgba(8,6,16,0.5)",color:e?"#ffd9cf":"rgba(255,255,255,0.78)",borderRadius:3,padding:i||a?"8px 13px":"8px 10px",font:"600 10px/1 ui-monospace, SFMono-Regular, Menlo, monospace",letterSpacing:"0.13em",cursor:"pointer",backdropFilter:"blur(9px)",WebkitBackdropFilter:"blur(9px)",transition:"border-color .18s, background .18s, color .18s",whiteSpace:"nowrap",width:a?"100%":void 0,textAlign:a?"right":"center",minHeight:32},children:n})}function w0({shot:e,shotIndex:o,shotCount:n,total:s,playing:i,onRails:a,speed:c,tier:d,override:h,dev:p,onPlay:g,onRailsToggle:f,onSpeed:m,onQuality:l,onRestart:u,audio:x,onAudio:v,mode:b,onMode:k,crew:z,onCrew:r,stage:M,veiled:F=!1}){const C=b!=="off",S=x0(),[R,A]=w.useState(!1),[B,G]=w.useState(()=>({...Me}));w.useEffect(()=>Ha(W=>G({...W})),[]);const $=g0(2600,!C&&!R),q=w.useRef(),ee=w.useRef(),P=w.useRef(),K=w.useRef(),ae=w.useRef(),H=w.useRef(),te=a&&!C;w.useEffect(()=>A(!1),[b]),w.useEffect(()=>{let W,Re=performance.now(),qe=0,nt=0;const Ie=He=>{if(W=requestAnimationFrame(Ie),q.current&&(q.current.style.transform=`scaleX(${M.progress||0})`),P.current&&M.helm){const D=M.helm;if(D.onFoot)P.current.textContent=D.area==="deck"?`ON DECK · ${Math.round(Math.abs(D.speed)*1.94)} KN · BRG ${String(Math.round((D.heading*180/Math.PI+360)%360)).padStart(3,"0")}°   —  nobody is at the wheel`:D.area==="island"?D.toRear<220?"ASHORE · THE REAR COVE  —  the cave gate is in the cliff":D.nearPort?"ASHORE · THE PORT  —  the mouth is up the talus":`ASHORE · ONIGASHIMA   MOUTH ${Math.round(D.toMouth)}m`:"INSIDE THE SKULL DOME  ·  LIVE FLOOR";else if(D.sub){const ue=Math.abs(D.speed)*1.94;if(D.berthing)P.current.textContent="BLOWING BALLAST — SURFACING IN THE REAR COVE";else{const Je=D.maelstrom>.22?D.depth<26?"⚠ MAELSTROM PULL — DIVE":"MAELSTROM OVERHEAD — RUNNING UNDER":D.stress>.02?"⚠ HULL UNDER PRESSURE":D.scrape>.3?"HULL ON THE ROCK":"",_e=Math.abs(D.relRear*180/Math.PI),Ye=_e<6?"· ON COURSE":D.relRear>0?`◀ ${_e.toFixed(0)}°`:`${_e.toFixed(0)}° ▶`,Fe=10,se=Math.round(D.depth/D.maxDepth*Fe),X=Math.round(D.crushDepth/D.maxDepth*Fe);let fe="";for(let je=0;je<Fe;je++)fe+=je<se?je>=X?"▓":"█":je===X?"┃":"·";const Ve=D.cruise===2?" ⟲FLK":D.cruise===1?" ⟲AHD":"";P.current.textContent=`DEPTH ${D.depth.toFixed(0).padStart(3,"0")}/${D.orderedDepth.toFixed(0).padStart(3,"0")}m ${fe}  ${ue.toFixed(0).padStart(2,"0")} KN${Ve}
...
`+(D.maelstrom>.2?"⚠ MAELSTROM — HARD OVER, FULL AHEAD":D.moored?"MOORING":D.aground>.3?"AGROUND — HELM OVER":D.underFire?`⚠ UNDER FIRE — STRAIGHT FOR THE ARCH    GATE ${Math.round(D.toGate)}m`:D.drift>.62?`MAKING LEEWAY — EASE THE HELM    GATE ${Math.round(D.toGate)}m`:`GATE ${Math.round(D.toGate)}m`)}}if(K.current){const D=al(),ue=sl(Y.chain);K.current.textContent=Y.done?"✔ OBJECTIVE COMPLETE":D?`▸ ${Y.step+1}/${ue}  ${D.text}`:"",K.current.style.color=Y.done?"#8fe0a0":"#ffd9cf"}if(ae.current){const D=Math.max(0,Math.min(1,Y.hull)),ue=Math.max(0,Math.min(1,Y.grip)),Je=Fe=>{const se=Math.round(Fe*12);return"█".repeat(se)+"·".repeat(12-se)},_e=D>.6?"#8fe0a0":D>.3?"#ffc46b":"#ff6b5a",Ye=ue>.66?"#ff6b5a":ue>.33?"#ffc46b":"rgba(255,255,255,0.45)";ae.current.innerHTML=`<span style="color:${_e}">HULL ${Je(D)}</span>`+(ue>.02?`<span style="color:${Ye};margin-left:14px">VORTEX ${Je(ue)}</span>`:"")}if(H.current){const D=Y.banner,ue=H.current;D?(ue.dataset.text!==D.text&&(ue.dataset.text=D.text,ue.innerHTML=`<div class="og-banner-main">${D.text}</div>`+(D.sub?`<div class="og-banner-sub">${D.sub}</div>`:""),ue.style.animation="none",ue.offsetWidth,ue.style.animation=""),ue.style.opacity="1"):(ue.style.opacity="0",ue.dataset.text="")}p&&ee.current?(nt++,qe+=He-Re,Re=He,qe>400&&(ee.current.textContent=`${Math.round(nt*1e3/qe)} fps · shelter ${M.shelter.toFixed(2)} · fog ${(M.fog*1e4).toFixed(1)}e-4 · flash ${M.flash.toFixed(2)}`,qe=0,nt=0)):Re=He};return W=requestAnimationFrame(Ie),()=>cancelAnimationFrame(W)},[M,p]);const be={opacity:$?.16:1,transform:$?"translateY(6px)":"none",transition:"opacity .5s ease, transform .5s ease"},Tt=[{key:"rails",on:!a,label:a?"FREE LOOK":"ON RAILS",title:"Take the camera off rails and look around",click:f,cinematicOnly:!0},{key:"helm",on:b==="helm",label:b==="helm"?"LEAVE HELM":"TAKE THE HELM",title:"Take the helm and sail the approach yourself",click:()=>k(b==="helm"?"off":"helm")},{key:"deck",on:!1,label:"WALK THE DECK",title:"Step back from the wheel and walk the deck as your pirate — she sails on",click:()=>{M.footSpawn="deck",k("foot")},helmOnly:!0},{key:"sub",on:b==="sub",label:b==="sub"?"LEAVE THE TANG":"DIVE THE POLAR TANG",title:"Dive under the maelstroms and take the back way in",click:()=>k(b==="sub"?"off":"sub")},{key:"foot",on:b==="foot",label:b==="foot"?"LEAVE DOME":"ENTER THE DOME",title:"Walk the Live Floor inside the Skull Dome",click:()=>k(b==="foot"?"off":"foot")}],Ge=W=>b==="foot"?t.jsx(at,{on:!0,wide:!0,block:W,title:"Swap between Luffy and Zoro, in their Wano gear",onClick:()=>r?.(z==="zoro"?"luffy":"zoro"),children:z==="zoro"?"ZORO · 和":"LUFFY · 和"}):null,We=(W,Re)=>t.jsx(at,{on:W.on,onClick:W.click,title:W.title,wide:!0,block:Re,children:W.label},W.key),Ze=W=>C?t.jsxs(t.Fragment,{children:[t.jsx(at,{on:B.comfort>.01,wide:!0,block:W,title:"Steady the camera: less roll, less shake, less lens movement. The fix if the motion is making you queasy.",onClick:Ml,children:B.comfort>.9?"COMFORT · FULL":B.comfort>.01?"COMFORT · SOME":"COMFORT · OFF"}),t.jsx(at,{on:B.freeCam,wide:!0,block:W,title:"Free camera: the view stays where you put it instead of swinging back behind the ship (V)",onClick:()=>qo("freeCam"),children:B.freeCam?"CAM · FREE":"CAM · CHASE"}),t.jsx(at,{on:Math.abs(B.lookSens-1)>.01,wide:!0,block:W,title:"How far a drag turns the view",onClick:jl,children:`LOOK ${B.lookSens.toFixed(2).replace(/0$/,"")}×`}),t.jsx(at,{on:B.invertY,wide:!0,block:W,title:"Invert the vertical look axis",onClick:()=>qo("invertY"),children:B.invertY?"Y · INVERTED":"Y · NORMAL"})]}):null,yt=W=>t.jsxs(t.Fragment,{children:[!C&&t.jsxs(t.Fragment,{children:[t.jsx(at,{on:i,onClick:g,title:"Play / pause the cinematic",block:W,children:i?W?"❙❙  PAUSE":"❙❙":W?"▶  PLAY":"▶"}),[.5,1,2].map(Re=>t.jsxs(at,{on:c===Re,onClick:()=>m(Re),title:`${Re}× speed`,block:W,children:[Re,"×"]},Re))]}),t.jsx(at,{on:!1,onClick:u,title:"Restart from the open sea",block:W,children:W?"↺  RESTART":"↺"}),t.jsx(at,{on:x,onClick:v,title:"Storm, taiko and a temple bell — all synthesised",block:W,children:x?W?"♪  SOUND ON":"♪":W?"♪̸  SOUND OFF":"♪̸"}),t.jsx(at,{on:h!=="auto",wide:!0,block:W,title:"Render tier",onClick:()=>l(h==="auto"?"low":h==="low"?"mobile":h==="mobile"?"high":"auto"),children:h==="auto"?`AUTO · ${d.toUpperCase()}`:h.toUpperCase()})]});return t.jsxs(t.Fragment,{children:[!F&&t.jsxs(t.Fragment,{children:[[0,1].map(W=>t.jsx("div",{style:{position:"fixed",left:0,right:0,[W?"bottom":"top"]:0,height:te?bn:0,background:"#05040a",zIndex:8,pointerEvents:"none",transition:"height .7s cubic-bezier(.6,0,.2,1)"}},W)),t.jsxs("div",{className:"og-tategaki",style:{opacity:C||R?0:1,transition:"opacity .6s ease"},children:["鬼ヶ島",t.jsx("span",{className:"og-tategaki-sub",children:"ONIGASHIMA"})]}),t.jsx("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 26px)",zIndex:10,pointerEvents:"none",animation:"ogCaption .85s cubic-bezier(.2,.9,.2,1) both",transition:"bottom .7s cubic-bezier(.6,0,.2,1)",maxWidth:"min(70vw, 620px)",display:C?"none":"block"},children:t.jsxs("div",{style:{display:"inline-block",borderLeft:`2px solid ${fo}`,paddingLeft:12},children:[t.jsx("div",{style:{font:'700 clamp(15px, 2.5vw, 27px)/1.15 "Hiragino Mincho ProN", "Yu Mincho", Georgia, serif',letterSpacing:"0.07em",color:"#fff6f0",textShadow:"0 2px 22px rgba(0,0,0,0.95), 0 0 44px rgba(0,0,0,0.7)"},children:e?.title}),t.jsx("div",{style:{marginTop:5,font:"500 clamp(9px, 1.15vw, 12px)/1.5 ui-monospace, Menlo, monospace",letterSpacing:"0.19em",color:"rgba(255,225,215,0.66)",textShadow:"0 1px 12px rgba(0,0,0,0.95)"},children:e?.sub})]})},e?.id),t.jsx("div",{style:{position:"fixed",left:0,right:0,bottom:"var(--og-bottom)",height:2,zIndex:10,background:"rgba(255,255,255,0.08)",pointerEvents:"none",opacity:C?0:1,transition:"bottom .7s cubic-bezier(.6,0,.2,1), opacity .4s ease"},children:t.jsx("div",{ref:q,style:{height:"100%",background:`linear-gradient(90deg, ${fo}, #ff9c2e)`,transformOrigin:"0 50%",transform:"scaleX(0)",boxShadow:`0 0 14px ${fo}`}})}),t.jsx("div",{className:`og-chrome${C?"":" og-chrome-bottom"}`,style:{...C?{top:"calc(var(--og-top) + 14px)"}:{bottom:"calc(var(--og-bottom) + 22px)"},...be},children:S?t.jsxs(t.Fragment,{children:[C&&t.jsx(at,{on:!0,onClick:()=>k("off"),wide:!0,title:"Back to the cinematic",children:"✕ EXIT"}),t.jsx(at,{on:R,onClick:()=>A(W=>!W),title:"Menu",children:R?"✕":"☰"}),R&&t.jsxs("div",{className:"og-menu",children:[C&&t.jsxs(t.Fragment,{children:[Ge(!0),Ze(!0),t.jsx("div",{className:"og-menu-rule"})]}),Tt.filter(W=>!(W.cinematicOnly&&C)&&!(W.helmOnly&&b!=="helm")).map(W=>We(W,!0)),t.jsx("div",{className:"og-menu-rule"}),yt(!0)]})]}):t.jsxs(t.Fragment,{children:[Ge(!1),Ze(!1),yt(!1),Tt.filter(W=>!(W.cinematicOnly&&C)&&!(W.helmOnly&&b!=="helm")).map(W=>We(W,!1))]})}),!C&&t.jsxs("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",top:"calc(var(--og-top) + 18px)",zIndex:10,font:"600 10px/1 ui-monospace, Menlo, monospace",letterSpacing:"0.3em",color:"rgba(255,255,255,0.4)",textShadow:"0 1px 10px #000",transition:"top .7s cubic-bezier(.6,0,.2,1)",...be,pointerEvents:"none"},children:[a?`SHOT ${String(o+1).padStart(2,"0")} / ${String(n).padStart(2,"0")}`:"FREE LOOK · DRAG ORBIT · WASD FLY · 2-FINGER / SHIFT-DRAG PAN · PINCH ZOOM · R HOME",t.jsx("span",{style:{opacity:.5},children:a?`  ·  ${Math.round(s)}s`:""})]}),C&&t.jsxs("div",{className:"og-instruments",children:[t.jsx("div",{ref:K,className:"og-objective"}),t.jsx("div",{ref:P,className:"og-readout"}),t.jsx("div",{ref:ae,className:"og-gauges"}),t.jsx("div",{className:"og-keys",children:b==="helm"?"W/S THROTTLE · A/D RUDDER · SHIFT FLANK · X ENGINE LATCH · B BURST · T WALK THE DECK · DRAG LOOK · R RECENTRE · V FREE CAM · WHEEL ZOOM":b==="sub"?"W/S THROTTLE · A/D RUDDER · SPACE RISE · C DIVE · SHIFT FLANK · X LATCH · F SURFACE · P PERISCOPE · DRAG LOOK · R RECENTRE · V FREE CAM":z==="zoro"?"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J ONIGIRI · U TATSUMAKI · K YAKKODORI · L SANZEN · G FLASH · H ASURA · DRAG ORBIT":"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J PISTOL · U GATLING · K BAZOOKA · L GIGANT · G ROCKET · H HAKI · N GEAR 2 · I BALLOON · DRAG ORBIT"})]}),C&&t.jsx("div",{ref:H,className:"og-banner"}),p&&t.jsx("div",{ref:ee,style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 96px)",zIndex:14,font:"500 10px/1 ui-monospace, Menlo, monospace",color:"#7fe0a0",background:m0,padding:"5px 8px",borderRadius:3,pointerEvents:"none"}})]}),t.jsx("style",{children:`
      ...
      `})]})}const Qn="#d63420",Zn="#4aa9c9",v0=(e,o,n)=>e<o?o:e>n?n:e;function qa(e,o,n){const s=w.useRef(o);s.current=o;const i=w.useRef(null),a=w.useRef({x:0,y:0});w.useEffect(()=>{const c=e.current;if(!c||!n)return;const d=f=>{if(i.current===null){i.current=f.pointerId,a.current={x:f.clientX,y:f.clientY};try{c.setPointerCapture?.(f.pointerId)}catch{}s.current.onMove(0,0,f.clientX,f.clientY),f.preventDefault()}},h=f=>{if(f.pointerId!==i.current)return;const m=a.current;s.current.onMove(f.clientX-m.x,f.clientY-m.y,m.x,m.y),f.preventDefault()},p=f=>{f.pointerId===i.current&&(i.current=null,s.current.onEnd(),f.cancelable&&f.preventDefault())};c.addEventListener("pointerdown",d),c.addEventListener("pointermove",h),c.addEventListener("pointerup",p),c.addEventListener("pointercancel",p),window.addEventListener("pointerup",p),window.addEventListener("pointercancel",p);const g=()=>{i.current!==null&&(i.current=null,s.current.onEnd())};return window.addEventListener("blur",g),()=>{c.removeEventListener("pointerdown",d),c.removeEventListener("pointermove",h),c.removeEventListener("pointerup",p),c.removeEventListener("pointercancel",p),window.removeEventListener("pointerup",p),window.removeEventListener("pointercancel",p),window.removeEventListener("blur",g)}},[e,n])}function pa({label:e,sub:o,onDown:n,onUp:s,tone:i="plain",wide:a=!1}){const[c,d]=w.useState(!1),h=w.useRef();w.useEffect(()=>{const g=h.current;if(!g)return;let f=null;const m=u=>{f=u.pointerId;try{g.setPointerCapture?.(f)}catch{}d(!0),n(),u.preventDefault(),u.stopPropagation()},l=u=>{u.pointerId===f&&(f=null,d(!1),s(),u.preventDefault(),u.stopPropagation())};return g.addEventListener("pointerdown",m),g.addEventListener("pointerup",l),g.addEventListener("pointercancel",l),g.addEventListener("pointerleave",l),()=>{g.removeEventListener("pointerdown",m),g.removeEventListener("pointerup",l),g.removeEventListener("pointercancel",l),g.removeEventListener("pointerleave",l)}},[n,s]);const p=i==="hot"?Qn:i==="cool"?Zn:"rgba(255,255,255,0.22)";return t.jsxs("div",{ref:h,className:`og-btn${a?" og-btn-wide":""}`,style:{border:`1px solid ${c?p:"rgba(255,255,255,0.18)"}`,background:c?`color-mix(in srgb, ${p} 34%, rgba(8,6,16,0.5))`:"rgba(8,6,16,0.46)",color:c?"#fff6f0":"rgba(255,255,255,0.8)"},children:[t.jsx("span",{style:{fontSize:"1em",letterSpacing:"0.1em"},children:e}),o&&t.jsx("span",{className:"og-btn-sub",children:o})]})}function tt({label:e,sub:o,onTap:n,on:s,tone:i="plain",wide:a=!1}){const c=w.useRef(),d=w.useRef(n);d.current=n,w.useEffect(()=>{const p=c.current;if(!p)return;const g=f=>{d.current(),f.preventDefault(),f.stopPropagation()};return p.addEventListener("pointerdown",g),()=>p.removeEventListener("pointerdown",g)},[]);const h=i==="hot"?Qn:i==="cool"?Zn:"rgba(255,255,255,0.22)";return t.jsxs("div",{ref:c,className:`og-btn${a?" og-btn-wide":""}`,style:{border:`1px solid ${s?h:"rgba(255,255,255,0.18)"}`,background:s?`color-mix(in srgb, ${h} 30%, rgba(8,6,16,0.5))`:"rgba(8,6,16,0.46)",color:s?"#fff6f0":"rgba(255,255,255,0.8)"},children:[t.jsx("span",{style:{fontSize:"1em",letterSpacing:"0.1em"},children:e}),o&&t.jsx("span",{className:"og-btn-sub",children:o})]})}function M0(){const[e,o]=w.useState(zt.level);return w.useEffect(()=>zl(o),[]),t.jsx(tt,{label:e===2?"FLANK":e===1?"AHEAD":"ENGINE",sub:e?"set · tap":"latch",tone:e===2?"hot":"cool",on:e>0,onTap:_a})}function j0({simple:e=!1}){const[o,n]=w.useState(Me.freeCam);w.useEffect(()=>Ha(i=>n(i.freeCam)),[]);const s=w.useRef(null);return e?t.jsx(tt,{label:"LEVEL",sub:"view",onTap:()=>I.recentreQueued=!0}):t.jsx(tt,{label:o?"CAM FREE":"RECENTRE",sub:o?"tap×2 chase":"tap×2 free",on:o,onTap:()=>{const i=performance.now();if(s.current&&i-s.current<420){s.current=null,qo("freeCam"),I.recentreQueued=!0;return}s.current=i,I.recentreQueued=!0}})}function S0({active:e}){const o=w.useRef(),n=w.useRef(),s=w.useRef(),i=78;return w.useEffect(()=>{if(!e)return;let a;const c=()=>{a=requestAnimationFrame(c);const d=s.current,h=y.helm;d&&(d.textContent=h?.sub?String(Math.round(h.orderedDepth)):"⇕")};return a=requestAnimationFrame(c),()=>cancelAnimationFrame(a)},[e]),qa(o,{onMove:(a,c,d,h)=>{const p=o.current;if(!p)return;const g=p.getBoundingClientRect(),f=g.top+g.height/2,m=v0((h+c-f)/i,-1,1),l=Math.abs(m)<.1?0:m;J.active=!0,J.planes=-l;const u=n.current;u&&(u.style.transform=`translate(-50%, calc(-50% + ${m*i}px))`,u.style.borderColor=Zn,u.style.background="rgba(74,169,201,0.34)")},onEnd:()=>{J.planes=0;const a=n.current;a&&(a.style.transform="translate(-50%, -50%)",a.style.borderColor="rgba(255,255,255,0.3)",a.style.background="rgba(8,6,16,0.55)")}},e),t.jsxs("div",{ref:o,className:"og-planes",children:[t.jsx("div",{className:"og-planes-rail"}),t.jsx("span",{className:"og-planes-cap og-planes-up",children:"RISE"}),t.jsx("span",{className:"og-planes-cap og-planes-dn",children:"DIVE"}),t.jsxs("div",{ref:n,className:"og-planes-knob",children:[t.jsx("span",{ref:s,children:"⇕"}),t.jsx("span",{className:"og-planes-unit",children:"m"})]})]})}function k0({mode:e,crew:o="luffy"}){const[n,s]=w.useState(!1);w.useEffect(()=>{if(e!=="foot"){s(!1);return}const x=setInterval(()=>s(y.helm?.area==="deck"),200);return()=>clearInterval(x)},[e]);const i=w.useRef(),a=w.useRef(),c=w.useRef(),d=w.useRef(),h=62,p=7,g=w.useRef(e);if(g.current=e,qa(i,{onMove:(x,v,b,k)=>{const z=Math.hypot(x,v),r=z>h?h/z:1,M=x*r,F=v*r,C=a.current,S=c.current;C&&(C.style.transform=`translate(${b-h}px, ${k-h}px)`,C.style.opacity="1"),S&&(S.style.transform=`translate(${b+M-26}px, ${k+F-26}px)`,S.style.opacity="1"),d.current&&(d.current.style.opacity="0");const R=Math.abs(M)<p?0:M/h,A=Math.abs(F)<p?0:F/h;J.active=!0,g.current==="foot"?(J.walk.x=R,J.walk.z=-A):(J.throttle=-A,J.rudder=-R)},onEnd:()=>{a.current&&(a.current.style.opacity="0"),c.current&&(c.current.style.opacity="0"),d.current&&(d.current.style.opacity=""),J.throttle=0,J.rudder=0,J.walk.x=0,J.walk.z=0}},e!=="off"),w.useEffect(()=>(document.documentElement.classList.add("og-touch"),()=>document.documentElement.classList.remove("og-touch")),[]),w.useEffect(()=>()=>{J.throttle=0,J.rudder=0,J.planes=0,J.boost=!1,J.walk.x=0,J.walk.z=0},[e]),e==="off")return null;const f=e==="sub",m=e==="foot",l=n,u=o==="zoro";return t.jsxs(t.Fragment,{children:[t.jsx("div",{ref:i,style:{position:"fixed",left:0,top:0,width:"50vw",height:"100vh",zIndex:12,touchAction:"none",background:"transparent"}}),t.jsx("div",{ref:a,style:{position:"fixed",left:0,top:0,width:h*2,height:h*2,borderRadius:"50%",border:"1.5px solid rgba(255,255,255,0.22)",background:"rgba(8,6,16,0.3)",pointerEvents:"none",opacity:0,zIndex:12,transition:"opacity .18s"}}),t.jsx("div",{ref:c,style:{position:"fixed",left:0,top:0,width:52,height:52,borderRadius:"50%",border:`1.5px solid ${Qn}`,background:"rgba(214,52,32,0.3)",boxShadow:"0 0 22px rgba(214,52,32,0.45)",pointerEvents:"none",opacity:0,zIndex:12,transition:"opacity .18s"}}),t.jsxs("div",{ref:d,className:"og-hint",style:{left:"max(26px, 5vw)"},children:[t.jsx("div",{className:"og-ring"}),t.jsx("span",{children:m?"DRAG TO WALK":"DRAG TO STEER"})]}),t.jsx("div",{className:"og-hint og-hint-right",children:t.jsx("span",{children:"LOOK · PINCH TO ZOOM · TAP×2 RECENTRE"})}),t.jsxs("div",{className:"og-right",children:[f&&t.jsx(S0,{active:!0}),t.jsxs("div",{className:"og-actions",children:[f&&t.jsx(tt,{label:"SURFACE",sub:"blow all",onTap:()=>I.surfaceQueued=!0}),f&&t.jsx(tt,{label:"PERISCOPE",sub:"6m",tone:"cool",onTap:()=>I.periscopeQueued=!0}),e==="helm"&&t.jsx(tt,{label:"BURST",sub:"coup de",tone:"cool",onTap:()=>I.burstQueued=!0}),(e==="helm"||l)&&t.jsx(tt,{label:l?"TAKE WHEEL":"WALK DECK",sub:l?"back to it":"she sails on",onTap:()=>I.boardQueued=!0}),m&&t.jsx(tt,{label:"JUMP",sub:"↑",onTap:()=>I.jumpQueued=!0}),m&&t.jsxs(t.Fragment,{children:[t.jsx(tt,{label:u?"ONIGIRI":"PISTOL",sub:"strike",tone:"hot",onTap:()=>I.pistolQueued=!0}),t.jsx(tt,{label:u?"YAKKO":"BAZOOKA",sub:u?"flying cut":"both fists",tone:"cool",onTap:()=>I.bazookaQueued=!0}),t.jsx(tt,{label:u?"SANZEN":"GIGANT",sub:"heavy",tone:"hot",onTap:()=>I.gigantQueued=!0}),t.jsx(tt,{label:u?"FLASH":"ROCKET",sub:"dash",tone:"cool",onTap:()=>I.rocketQueued=!0}),t.jsx(tt,{label:u?"ASURA":"HAKI",sub:"burst",onTap:()=>I.hakiQueued=!0}),!u&&t.jsx(tt,{label:"GEAR 2",sub:"overdrive",onTap:()=>I.gear2Queued=!0}),t.jsx(pa,{label:u?"TATSUMAKI":"GATLING",sub:"hold",tone:"hot",onDown:()=>J.gatling=!0,onUp:()=>J.gatling=!1})]}),!m&&t.jsx(M0,{}),t.jsx(pa,{label:m?"RUN":"FLANK",sub:m?"»":"over",tone:"hot",onDown:()=>J.boost=!0,onUp:()=>J.boost=!1}),t.jsx(j0,{simple:m})]})]}),t.jsx("style",{children:`
        .og-btn {
          border-radius: 10px;
      ...
      `})]})}const Te=168,qn=1950,Ja={x:0,z:340},it={sea:"rgba(8,10,22,0.72)",ring:"#57506a",land:"#2e2836",skull:"#8a7358",fairway:"rgba(160,200,255,0.12)",gate:"#e8402a",port:"#f0ad50",rear:"#8fd4f2",whirl:"rgba(140,170,235,0.55)",you:"#ffe6a0"},At=e=>(e-Ja.x)/qn*(Te/2)+Te/2,Ot=e=>(e-Ja.z)/qn*(Te/2)+Te/2,Xt=e=>e/qn*(Te/2);function z0(e,o){e.save(),e.scale(o,o),e.clearRect(0,0,Te,Te),e.fillStyle=it.sea,e.fillRect(0,0,Te,Te),e.fillStyle=it.fairway,e.fillRect(At(-Yo.halfWidth),0,Xt(Yo.halfWidth*2),Te),e.strokeStyle=it.ring,e.lineWidth=Xt(ft*.34),e.beginPath(),e.arc(At(de.x),Ot(de.z),Xt(ft),Math.PI*.34,Math.PI*.66,!0),e.stroke(),e.fillStyle=it.skull,e.beginPath(),e.ellipse(At(L.x),Ot(L.z),Xt(L.r*L.squash[0]),Xt(L.r*L.squash[2]),0,0,Math.PI*2),e.fill(),e.strokeStyle=it.gate,e.lineWidth=2;for(const[s,i]of[[Pt,1],[Jt,1.5]])e.beginPath(),e.moveTo(At(-95*N*i),Ot(s)),e.lineTo(At(95*N*i),Ot(s)),e.stroke();e.strokeStyle=it.whirl,e.lineWidth=1;for(const s of Ne)e.beginPath(),e.arc(At(s.x),Ot(s.z),Xt(s.r),0,Math.PI*2),e.stroke();const n=(s,i,a,c=2.6)=>{e.fillStyle=a,e.beginPath(),e.arc(At(s),Ot(i),c,0,Math.PI*2),e.fill()};n(Q.x,Q.z,it.port),n(he.x,he.z,it.land,2),n(U.gate.x,U.gate.z,it.rear),e.restore()}function T0({mode:e}){const o=w.useRef(),n=w.useRef(),s=typeof window>"u"?1:Math.min(2,window.devicePixelRatio||1),i=w.useMemo(()=>{if(typeof document>"u")return null;const a=document.createElement("canvas");return a.width=Te*s,a.height=Te*s,z0(a.getContext("2d"),s),a},[s]);return w.useEffect(()=>{if(!n.current||!i)return;const a=n.current.getContext("2d");let c;const d=()=>{c=requestAnimationFrame(d);const h=y.helm;if(a.setTransform(1,0,0,1,0,0),a.clearRect(0,0,Te*s,Te*s),a.drawImage(i,0,0),!h||h.x===void 0)return;a.save(),a.scale(s,s);const p=At(h.x),g=Ot(h.z),f=h.sub&&h.depth>4;a.translate(p,g),h.heading!==void 0?(a.rotate(h.heading+Math.PI),a.beginPath(),a.moveTo(0,-5.5),a.lineTo(3.4,4),a.lineTo(0,2),a.lineTo(-3.4,4),a.closePath()):(a.beginPath(),a.arc(0,0,3,0,Math.PI*2)),a.fillStyle=f?"rgba(0,0,0,0)":it.you,a.strokeStyle=it.you,a.lineWidth=1.2,a.fill(),a.stroke(),a.restore(),f&&(a.save(),a.scale(s,s),a.fillStyle=it.rear,a.font="600 9px ui-monospace, SFMono-Regular, Menlo, monospace",a.textAlign="right",a.fillText(`${Math.round(h.depth)}m DOWN`,Te-6,Te-6),a.restore())};return d(),()=>cancelAnimationFrame(c)},[i,s,e]),e==="off"?null:t.jsxs("div",{className:"og-minimap",style:{position:"fixed",left:14,bottom:14,zIndex:12,width:Te,height:Te,borderRadius:4,overflow:"hidden",border:"1px solid rgba(255,255,255,0.16)",backdropFilter:"blur(9px)",WebkitBackdropFilter:"blur(9px)",pointerEvents:"none"},children:[t.jsx("canvas",{ref:n,width:Te*s,height:Te*s,style:{width:Te,height:Te,display:"block"}}),t.jsx("div",{style:{position:"absolute",top:4,left:6,font:"600 8px/1 ui-monospace, SFMono-Regular, Menlo, monospace",letterSpacing:"0.16em",color:"rgba(255,255,255,0.5)"},children:"鬼ヶ島"}),t.jsx("canvas",{ref:o,style:{display:"none"}})]})}const fa={low:{dpr:[1,1.1],shadows:!1,aa:!1,shadowMap:512,segments:110,shadowEvery:24,scene:"low"},mobile:{dpr:[1,1.5],shadows:!0,aa:!1,shadowMap:1024,segments:168,shadowEvery:16,scene:"mid"},high:{dpr:[1,2],shadows:!0,aa:!0,shadowMap:2048,segments:240,shadowEvery:10,scene:"high"}};function E0(){if(typeof navigator>"u")return"high";const e=navigator.hardwareConcurrency||4,o=typeof navigator.deviceMemory=="number"?navigator.deviceMemory:null;return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&/Macintosh/.test(navigator.userAgent)?e<=3||o!==null&&o<=2?"low":"mobile":e<=2||o!==null&&o<=2?"low":"high"}const R0=null;function P0(){const e=w.useMemo(()=>!1,[]),[o]=w.useState(E0),[n,s]=w.useState("auto"),i=n==="auto"?o:n,a=fa[i]??fa.high;w.useEffect(()=>{oi(a.scene!=="low")},[a.scene]),w.useMemo(()=>wa(a.scene),[a.scene]),w.useMemo(()=>kl(),[]),w.useEffect(()=>Tl(),[]);const c=w.useMemo(()=>typeof navigator>"u"?!1:typeof location<"u"&&new URLSearchParams(location.search).has("touch")?!0:navigator.maxTouchPoints>0,[]),[d,h]=w.useState(0),[p,g]=w.useState(!0),[f,m]=w.useState(!0),[l,u]=w.useState(1),[x,v]=w.useState(Ds[0]),[b,k]=w.useState(0),[z,r]=w.useState(Qc),[M,F]=w.useState(()=>{if(typeof location>"u")return"off";const H=new URLSearchParams(location.search).get("mode");return H==="helm"||H==="sub"||H==="foot"?H:"off"}),[C,S]=w.useState(()=>typeof location>"u"?"luffy":new URLSearchParams(location.search).get("crew")==="zoro"?"zoro":"luffy");w.useEffect(()=>{if(!z)return;const H=()=>{xn(),gn(!0)};for(const te of["pointerdown","keydown","touchstart"])window.addEventListener(te,H,{once:!0,passive:!0});return()=>{for(const te of["pointerdown","keydown","touchstart"])window.removeEventListener(te,H)}},[z]);const R=w.useCallback(()=>{r(H=>{const te=!H;return te&&xn(),gn(te),te})},[]),[A,B]=w.useState(()=>typeof location<"u"&&new URLSearchParams(location.search).has("enter")),G=w.useCallback(H=>{z&&(xn(),gn(!0)),H==="off"?(y.jumpTo=0,g(!0),m(!0)):F(H),B(!0)},[z]),[$,q]=w.useState(!1),ee=w.useRef(!0);w.useEffect(()=>{if(Ba(),ee.current){ee.current=!1;return}q(!0);const H=setTimeout(()=>q(!1),210);return()=>clearTimeout(H)},[M]);const P=w.useCallback((H,te)=>{k(H),v(te)},[]),K=w.useCallback(()=>{ti(),h(H=>H+1),g(!0),m(!0)},[]),ae=w.useMemo(()=>typeof location<"u"&&new URLSearchParams(location.search).has("dev"),[]);return e?t.jsx(w.Suspense,{fallback:null,children:t.jsx(R0,{})}):t.jsxs(t.Fragment,{children:[t.jsx(ar,{shadows:a.shadows,dpr:a.dpr,gl:{antialias:a.aa,powerPreference:"high-performance",toneMapping:pr,toneMappingExposure:wr,preserveDrawingBuffer:!0},camera:{fov:52,near:1,far:8200,position:[-190,26,880]},frameloop:"always",children:t.jsx(w.Suspense,{fallback:null,children:t.jsx(f0,{quality:a.scene,budget:a,onRails:f,playing:p,speed:l,onShot:P,mode:M,onMode:F,crew:C},d)})}),c&&A&&t.jsx(k0,{mode:M,crew:C}),A&&t.jsx(T0,{mode:M}),t.jsx("div",{"aria-hidden":!0,style:{position:"fixed",inset:0,zIndex:30,background:"#05040a",pointerEvents:"none",opacity:$?1:0,transition:$?"opacity .2s ease-in":"opacity .42s ease-out"}}),!A&&t.jsx(y0,{onPick:G}),t.jsx(w0,{veiled:!A,shot:x,shotIndex:b,shotCount:Ds.length,total:On,playing:p,onRails:f,speed:l,tier:i,override:n,dev:ae,onPlay:()=>g(H=>!H),onRailsToggle:()=>m(H=>!H),onSpeed:u,onQuality:s,onRestart:K,audio:z,onAudio:R,mode:M,onMode:F,crew:C,onCrew:S,stage:y})]})}export{P0 as default};
