var ar=Object.defineProperty;var rr=(e,o,n)=>o in e?ar(e,o,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[o]=n;var ns=(e,o,n)=>rr(e,typeof o!="symbol"?o+"":o,n);import{r as b,u as ne,j as t,d as ba,f as be,h as ir,i as lr}from"./vendor-C2HIMx-P.js";import{t as ve,c as S,aD as vn,au as Hn,d as _n,a5 as He,aJ as cr,f as hr,Y as ss,a0 as as,ag as T,h as oe,aK as dr,ay as ur,az as to,aA as oo,aq as wa,R as pr,M as rt,o as mt,at as Dt,ax as wt,aL as no,aM as so,a4 as fr,a8 as Lt,ar as ao,av as ya,aC as mr,A as gr}from"./three-Zo_RlN_K.js";import{f as qt,m as bo,w as Ye,a as Ut,e as Et,P as xr,G as br,S as wr,I as yr}from"./index-BZWIftax.js";const Z={skyHigh:"#140f2b",skyLow:"#3a2a5c",cloud:"#2a2244",cloudLit:"#6b3f5e",seaDeep:"#080d1c",seaShallow:"#16294a",foam:"#c8d6e8",rock:"#2b2f3f",rockLit:"#4c5468",snow:"#aebdd4",pine:"#16202c",bolt:"#e9a8ff",boltGlow:"#a855f7",haze:"#1d1936",abyss:"#04161f",underGlow:"#7fc9c0",underHaze:"#0a2e35"},E={furnace:"#fff1c4",ember:"#ff9c2e",emberDeep:"#c9411a",lantern:"#ff7a3c",lanternFar:"#ffb066",vermilion:"#d63420",vermilionDeep:"#7e1c14",rockWarm:"#6d3a2c",gilt:"#e8a33d",sakura:"#f2a8c4",timber:"#6b4b34"},Yo={dir:[.72,.52,-.44],col:"#f2e9cf"},Ft={sea:.00105,bay:48e-5,deepGrade:210},vr=1.15;function ie(e){const o=new ve(e);return[o.r,o.g,o.b]}const Mr=`
  varying vec3 vDir;
  void main() {
    vDir = position;
...
`;function Sr({storm:e}){const o=b.useRef(),n=b.useMemo(()=>({uTime:{value:0},uHigh:{value:new S(...ie(Z.skyHigh))},uLow:{value:new S(...ie(Z.skyLow))},uCloud:{value:new S(...ie(Z.cloud))},uCloudLit:{value:new S(...ie(Z.cloudLit))},uEmber:{value:new S(...ie(E.ember))},uFlash:{value:0},uFlashColor:{value:new S(...ie(Z.boltGlow))},uFlashDir:{value:new S(0,.4,-1)},uGlow:{value:1},uMoonDir:{value:new S(...Yo.dir).normalize()},uMoonCol:{value:new S(...ie(Yo.col))},uUnder:{value:0},uUnderCol:{value:new S(...ie(Z.underHaze))}}),[]);return ne((s,i)=>{const a=o.current?.uniforms;a&&(a.uTime.value+=i,a.uFlash.value=e?.flash??0,e?.flashDir&&a.uFlashDir.value.copy(e.flashDir),a.uUnder.value=e?.underwater??0)}),t.jsxs("mesh",{frustumCulled:!1,renderOrder:-1,children:[t.jsx("sphereGeometry",{args:[1,32,20]}),t.jsx("shaderMaterial",{ref:o,vertexShader:Mr,fragmentShader:jr,uniforms:n,side:vn,depthWrite:!1,depthTest:!1,fog:!1})]})}const N=1.9,V=e=>e*N,de={x:0,z:V(-60)},ft=V(300),Ho=V(175),kr=118,L={x:0,z:V(-402),r:V(215),baseY:300,squash:[1.18,1.04,.98]},mo=[[-.361,.301,.883],[.361,.301,.883]],Bn=[0,.02,.9998],Un=[0,-.419,.908];function Wn(e,o=1){const[n,s,i]=L.squash;return{x:L.x+e[0]*L.r*n*o,y:L.baseY+e[1]*L.r*s*o,z:L.z+e[2]*L.r*i*o}}const Ae=mo.map(e=>Wn(e)),he={...Wn(Un),halfWidth:74,height:62};Wn(Bn,.94);const Q={x:V(-152),y:4.5,z:V(-104),r:V(78)},rs=2.35,Gt=[Math.sin(rs),Math.cos(rs)],U=(()=>{const e=ft+Ho*.35,o=de.x+Gt[0]*e,n=de.z+Gt[1]*e;return{x:o,z:n,pool:V(46),benchY:3.6,reach:V(560),gate:{x:o-Gt[0]*V(44),z:n-Gt[1]*V(44)},berth:{x:o+Gt[0]*V(12),z:n+Gt[1]*V(12)},dir:Gt}})(),zr=[{rank:1,role:"east-south",ang:.75,dist:V(730),r:V(146),depth:36,dir:-1,speed:33},{rank:2,role:"west-south",ang:-.75,dist:V(730),r:V(144),depth:35,dir:1,speed:33},{rank:3,role:"back-door",ang:2.18,dist:V(770),r:V(142),depth:40,dir:1,speed:34},{rank:4,role:"east",ang:1.35,dist:V(690),r:V(155),depth:40,dir:1,speed:35},{rank:5,role:"west",ang:-1.35,dist:V(690),r:V(150),depth:38,dir:-1,speed:34},{rank:6,role:"west-north",ang:-2.05,dist:V(765),r:V(150),depth:42,dir:1,speed:35}],_e=[];function va(e){const o=e==="low"?3:e==="mid"?5:7;_e.length=0;for(const n of zr)n.rank>o||_e.push({role:n.role,x:de.x+Math.sin(n.ang)*n.dist,z:de.z+Math.cos(n.ang)*n.dist,r:n.r,depth:n.depth,dir:n.dir,speed:n.speed});return _e}const Tr=e=>_e.find(o=>o.role===e)??_e[0];va("high");function Ma(e,o,n=0){let s=0,i=0;const a=1-Xe(8,34,n);if(a<=0)return{vx:s,vz:i,danger:0};let c=0;for(const d of _e){const h=e-d.x,p=o-d.z,g=Math.hypot(h,p);if(g>d.r*1.7||g<.001)continue;const f=g/d.r,m=1-Xe(1,1.6,f),l=d.speed*(f/.3)*Math.exp(1-f/.3)*.62*m,u=d.speed*.55*Math.exp(-f*f*2.6)*m+d.speed*.1*m,x=1/g;s+=(-p*x*l*d.dir-h*x*u)*a,i+=(h*x*l*d.dir-p*x*u)*a,c=Math.max(c,(1-Xe(.15,1.15,f))*a)}return{vx:s,vz:i,danger:c}}const Vo={x:0,halfWidth:V(96)},Pt=V(258),Jt=V(624),$o={safe:260,range:1150},Er=0,_o=V(1500),Ko=e=>e<0?0:e>1?1:e;function Rr(e,o,n=4){let s=0,i=1,a=1,c=0;for(let d=0;d<n;d++){const h=1-Math.abs(qt(e*a,o*a,1)*2-1);s+=h*h*i,c+=i,i*=.52,a*=2.07}return s/c}const Xe=(e,o,n)=>{const s=Ko((n-e)/(o-e));return s*s*(3-2*s)};function Ar(e){if(e>V(430))return 1e4;const o=1-Xe(V(430),V(205),e),n=Xe(V(150),V(-30),e);return Vo.halfWidth+o*V(620)+n*V(300)}function Ir(e){const o=(1-Math.cos(e))*.5,n=Math.sin(e);let s=kr;return s+=o*190,s+=Math.max(0,n)*46,s-=Math.max(0,-n)*26,s}function re(e,o){const n=e-de.x,s=o-de.z,i=Math.hypot(n,s),a=Math.atan2(n,s),c=(i-ft)/Ho,d=Math.exp(-c*c*1.35)*Ir(a),h=Math.max(0,i-ft-Ho*.55),p=-Math.pow(h/210,1.6)*175,g=Math.max(0,ft-Ho*.5-i),f=-Xe(0,150,g)*46,m=Ko(d/60),l=(Rr(e*.0052/N+13,o*.0052/N-21,4)-.42)*168*m,u=(qt(e*.0042/N+31,o*.0042/N-17,4)-.5)*84*m,x=(qt(e*.021-5,o*.021+9,3)-.5)*17*m;let v=d+p+f+l+u+x;const w=Ar(o),k=1-Xe(w,w+V(105),Math.abs(e-Vo.x)),z=1-Xe(V(-40),V(-190),o),r=k*z;v=v*(1-r)+Math.min(v,-34)*r;const M=Math.hypot(e-L.x,o-L.z);v+=Math.exp(-Math.pow(M/(L.r*1.55),2))*62;const F=(e-Q.x)/V(76),C=(o-Q.z)/V(58),j=(1-Xe(.72,1.18,Math.hypot(F,C)))*Ko((v+34)/34);v=v*(1-j)+Q.y*j;const R=e-U.x,I=o-U.z;if(Math.abs(R)+Math.abs(I)<U.reach+V(140)){const B=Math.max(0,Math.min(U.reach,R*U.dir[0]+I*U.dir[1])),G=R-U.dir[0]*B,$=I-U.dir[1]*B,q=Math.hypot(G,$),ee=V(30)+B/U.reach*V(48),P=1-Xe(ee,ee+V(62),q);v=v*(1-P)+Math.min(v,-26)*P;const K=Math.hypot(R,I),ae=1-Xe(U.pool*.55,U.pool,K);v=v*(1-ae)+Math.min(v,-14)*ae;const H=(e-U.gate.x)/V(30),te=(o-U.gate.z)/V(24),we=1-Xe(.72,1.18,Math.hypot(H,te));v=v*(1-we)+U.benchY*we}return v}function Yn(e,o,n=3){const s=re(e+n,o)-re(e-n,o),i=re(e,o+n)-re(e,o-n),a=-s,c=2*n,d=-i,h=Math.hypot(a,c,d)||1;return[a/h,c/h,d/h]}function Cr(e,o,n=3){return Math.acos(Yn(e,o,n)[1])}function wo(e,o){const n=Xe(V(250),V(40),o),s=1-Xe(ft-V(40),ft+V(90),Math.hypot(e-de.x,o-de.z)),i=(1-Xe(V(60),V(170),Math.hypot(e-U.x,o-U.z)))*.85;return Ko(Math.max(Math.min(n,s),i))}const ja=[{dir:[.1,-1],amp:9.4,len:187},{dir:[-.42,-.91],amp:4.3,len:97},{dir:[.71,-.7],amp:2.1,len:61},{dir:[-.86,-.51],amp:1.15,len:37}],Fr=Math.PI*2;function Pr(e,o,n){let s=0,i=0,a=0;for(const c of _e){const d=e-c.x,h=o-c.z,p=Math.max(1,Math.hypot(d,h));if(p>c.r*1.75)continue;const g=p/c.r,f=Math.exp(-3*g*g);s-=c.depth*f;const m=c.depth*6*g*f/c.r;i+=m*(d/p),a+=m*(h/p);const l=Math.atan2(h,d),u=Math.sin(l*3*c.dir+g*14-n*2.2),x=g*Math.exp(1-g)*(1-Lr(g));s+=u*x*1.6}return{y:s,dx:i,dz:a}}function Lr(e){const o=Math.min(1,Math.max(0,(e-1)/.6));return o*o*(3-2*o)}function ut(e,o,n,s=1){let i=0,a=0,c=0;for(const h of ja){const p=Fr/h.len,g=Math.sqrt(9.81/p),f=Math.hypot(h.dir[0],h.dir[1]),m=h.dir[0]/f,l=h.dir[1]/f,u=p*(m*e+l*o-g*n),x=h.amp*s;i+=x*Math.sin(u);const v=x*p*Math.cos(u);a+=v*m,c+=v*l}const d=Pr(e,o,n);return i+=d.y,a+=d.dx,c+=d.dz,{y:i,dx:a,dz:c}}const Gr=ja.map(e=>`    gerstner(p, vec2(${e.dir[0].toFixed(3)}, ${e.dir[1].toFixed(3)}), ${e.amp.toFixed(2)} * amp, ${e.len.toFixed(1)}, uTime, disp, tangent, binormal, total);`).join(`
`),Or=()=>_e.map(e=>`    whirl(p, vec2(${e.x.toFixed(1)}, ${e.z.toFixed(1)}), ${e.r.toFixed(1)}, ${e.depth.toFixed(1)}, ${e.dir.toFixed(1)}, uTime, disp, tangent, binormal);`).join(`
`),Dr=()=>_e.map(e=>`    wm += whirlMark(vWorld.xz, vec2(${e.x.toFixed(1)}, ${e.z.toFixed(1)}), ${e.r.toFixed(1)}, ${e.dir.toFixed(1)}, uTime);`).join(`
`),Nr=`
...
`;function Br(e,o){const n=new Uint8Array(e*e*4);for(let i=0;i<e;i++)for(let a=0;a<e;a++){const c=de.x+((a+.5)/e-.5)*o,d=de.z+((i+.5)/e-.5)*o,h=re(c,d),p=T.clamp(-h/46,0,1),g=(i*e+a)*4;n[g]=Math.round(p*255),n[g+1]=n[g],n[g+2]=n[g],n[g+3]=255}const s=new cr(n,e,e,hr);return s.minFilter=ss,s.magFilter=ss,s.wrapS=as,s.wrapT=as,s.needsUpdate=!0,s}const Xo={low:112,mid:190,high:286},Mn=6400;function Ur(e){const o=b.useRef(),n=Mn/(Xo[e]??Xo.high);return ne(s=>{const i=o.current;i&&(i.position.x=Math.round((s.camera.position.x-de.x)/n)*n,i.position.z=Math.round((s.camera.position.z-de.z)/n)*n)}),o}function Wr({quality:e="high",storm:o}){const n=b.useRef(),s=Ur(e),{geometry:i,uniforms:a,landTex:c,vert:d,frag:h}=b.useMemo(()=>{const p=Xo[e]??Xo.high,g=new Hn(Mn,Mn,p,p);g.rotateX(-Math.PI/2),g.translate(de.x,0,de.z);const f=_o*1.05,m=Br(e==="low"?160:256,f),l={uTime:{value:0},uLand:{value:m},uSpan:{value:f},uCentre:{value:new _n(de.x,de.z)},uDeep:{value:new S(...ie(Z.seaDeep))},uShallow:{value:new S(...ie(Z.seaShallow))},uFoam:{value:new S(...ie(Z.foam))},uSkyLow:{value:new S(...ie(Z.skyLow))},uGilt:{value:new S(...ie(E.gilt))},uEmber:{value:new S(...ie(E.ember))},uFogColor:{value:new S(...ie(Z.haze))},uFogDensity:{value:.0011},uUnderDeep:{value:new S(...ie(Z.abyss))},uUnderGlow:{value:new S(...ie(Z.underGlow))},uDepthFade:{value:0},uMoonDir:{value:Yr.clone()},uMoonCol:{value:new S(...ie(Vr))},uEyeA:{value:new S(Ae[0].x,Ae[0].y,Ae[0].z)},uEyeB:{value:new S(Ae[1].x,Ae[1].y,Ae[1].z)},uFlash:{value:0},uFlashColor:{value:new S(...ie(Z.boltGlow))},uCameraPos:{value:new S}};return{geometry:g,uniforms:l,landTex:m,vert:Hr(),frag:_r()}},[e]);return ne((p,g)=>{const f=n.current?.uniforms;if(!f)return;f.uTime.value+=g,f.uCameraPos.value.copy(p.camera.position),f.uFlash.value=o?.flash??0,f.uFogDensity.value=o?.fog??.0011;const m=Math.min(1,Math.max(0,(o?.depthBelow??0)/Ft.deepGrade));f.uDepthFade.value=m,is.copy(Kr).lerp(Xr,m*.8),f.uFogColor.value.lerpVectors($r,is,o?.underwater??0)}),t.jsx("mesh",{ref:s,geometry:i,frustumCulled:!1,renderOrder:1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:d,fragmentShader:h,uniforms:a,transparent:!1,side:He},c.uuid)})}const Yr=new S(...Yo.dir).normalize(),Vr=Yo.col,$r=new S(...ie(Z.haze)),Kr=new S(...ie(Z.underHaze)),Xr=new S(...ie(Z.abyss)),is=new S;function Qr({quality:e="high",segments:o=200}){const n=b.useMemo(()=>{const s=o,i=new Hn(_o,_o,s,s);i.rotateX(-Math.PI/2);const a=i.attributes.position,c=a.count,d=new Float32Array(c*3),h=new ve(Z.rock),p=new ve(Z.rockLit),g=new ve("#0b0e18"),f=new ve(Z.snow),m=new ve(E.rockWarm),l=new ve;for(let u=0;u<c;u++){const x=a.getX(u)+de.x,v=a.getZ(u)+de.z,w=re(x,v);a.setX(u,x),a.setY(u,w),a.setZ(u,v);const k=Yn(x,v,_o/s)[1],z=Math.max(0,(k-.55)/.45);l.copy(h).lerp(p,T.clamp(w/190,0,1));const r=1-T.clamp((w-Er)/13,0,1);l.lerp(g,r*.85);const M=T.clamp((x-de.x)/260,0,1),F=96-M*42,C=T.clamp((w-F)/60,0,1)*z;l.lerp(f,C*(.45+M*.5));const j=Math.hypot(x-L.x,v-L.z),R=Math.exp(-Math.pow(j/330,2)),I=T.clamp((v-L.z)/260,0,1);l.lerp(m,R*I*.6*(1-C)),d[u*3]=l.r,d[u*3+1]=l.g,d[u*3+2]=l.b}return i.setAttribute("color",new oe(d,3)),i.computeVertexNormals(),i.computeBoundingSphere(),i},[o]);return t.jsx("mesh",{geometry:n,receiveShadow:e!=="low",castShadow:!1,frustumCulled:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,roughness:.86,metalness:.02,flatShading:e==="low"})})}const Vn=-30,$n=330,Zr=150,pe={x:he.x,y:he.y-40,z:he.z-Zr-(Vn+$n)},Ce={centre:[0,96,Vn],radii:[350,235,$n]},jt={x:pe.x+Ce.centre[0],y:pe.y+Ce.centre[1],z:pe.z+Ce.centre[2]};function qr(e,o,n){const s=(e-jt.x)/Ce.radii[0],i=(o-jt.y)/Ce.radii[1],a=(n-jt.z)/Ce.radii[2];return Math.sqrt(s*s+i*i+a*a)}function jn(e,o=.06){const n=(e.x-jt.x)/Ce.radii[0],s=(e.y-jt.y)/Ce.radii[1],i=(e.z-jt.z)/Ce.radii[2],a=Math.sqrt(n*n+s*s+i*i),c=1+o;if(a>=c)return null;const d=a<1e-4?0:c/a;return e.x=jt.x+(d?n*d:0)*Ce.radii[0],e.y=jt.y+(d?s*d:c)*Ce.radii[1],e.z=jt.z+(d?i*d:0)*Ce.radii[2],e}const le={y:0,halfX:290,zFront:228,zBack:-240},Ge={y:40,z:Vn+$n-40,halfX:96,depth:120},lt={zTop:Ge.z-54,zBottom:140,halfX:74,steps:16},D={z:-290,baseY:0,halfX:130,halfZ:76,plinth:34,storey:36,storeys:6,taper:.11},Re={y:74,z:D.z+D.halfZ+26,halfX:96,depth:40},It=Re.y+3.5,Qe={y:-95,halfX:220,halfZ:175,ceiling:-34},ze={x:0,z:84,halfX:52,halfZ:40},xe={y:52,halfZ:205,x:252,tiers:3,tierRise:46},zo=[[96,46,340,40],[140,-64,300,34],[70,-150,240,26],[196,-8,220,28]],me={x:74,halfW:14,zFoot:D.z+D.halfZ+158,zTop:Re.z+Re.depth/2-6},Sa=[{kind:"rampZ",x0:-74-me.halfW,x1:-74+me.halfW,z0:me.zFoot,z1:me.zTop,y0:0,y1:It},{kind:"rampZ",x0:me.x-me.halfW,x1:me.x+me.halfW,z0:me.zFoot,z1:me.zTop,y0:0,y1:It},{kind:"flat",x0:-96,x1:Re.halfX,z0:Re.z-Re.depth/2-2,z1:me.zTop,y:It},{kind:"rampZ",x0:-290,x1:-214,z0:45,z1:-45,y0:0,y1:xe.y-.5},{kind:"flat",x0:-290,x1:-214,z0:-225,z1:-45,y:xe.y-.5},{kind:"flat",x0:xe.x-38,x1:xe.x+38,z0:-225,z1:xe.halfZ+20,y:xe.y-.5}],Jr=e=>e<=0?0:e>=1?1:e*e*(3-2*e),ka=(()=>{const e=[],o=[],n=[],s=D.halfX+6,i=[s,s+9],a=[s+11,s+20],c=[s,s+20],d=[-212,-200],h=[-264,-252],p=[It];for(let f=2;f<=D.storeys;f++)p.push(D.plinth+f*D.storey+1.5);e.push({kind:"flat",x0:Re.halfX-6,x1:s+20,z0:-212,z1:-196,y:It}),o.push([(Re.halfX-6+s+20)/2,It,-204,s+26-Re.halfX,16]);for(let f=0;f<p.length-1;f++){const m=p[f],l=p[f+1],u=(m+l)/2;e.push({kind:"rampZ",x0:i[0],x1:i[1],z0:d[0],z1:h[1],y0:m,y1:u}),n.push({x0:i[0],x1:i[1],z0:d[0],z1:h[1],y0:m,y1:u}),e.push({kind:"flat",x0:c[0],x1:c[1],z0:h[0],z1:h[1],y:u}),o.push([(c[0]+c[1])/2,u,(h[0]+h[1])/2,c[1]-c[0],h[1]-h[0]]),e.push({kind:"rampZ",x0:a[0],x1:a[1],z0:h[1],z1:d[0],y0:u,y1:l}),n.push({x0:a[0],x1:a[1],z0:h[1],z1:d[0],y0:u,y1:l}),e.push({kind:"flat",x0:c[0],x1:c[1],z0:d[0],z1:d[1],y:l}),o.push([(c[0]+c[1])/2,l,(d[0]+d[1])/2,c[1]-c[0],d[1]-d[0]])}for(let f=1;f<p.length-1;f++){const l=1-Math.min(D.storeys,f+2)*D.taper,u=D.halfX*l,x=D.z+D.halfZ*l,v=p[f];e.push({kind:"flat",x0:u-4,x1:s,z0:-224,z1:-212,y:v}),o.push([(u-4+s)/2,v,-218,s-u+4,12]),e.push({kind:"flat",x0:-u-6,x1:u+6,z0:x,z1:-212,y:v}),o.push([0,v,(x-212)/2,u*2+12,-212-x])}const g=p[p.length-1];return e.push({kind:"flat",x0:58,x1:s,z0:-248,z1:-212,y:g}),o.push([(s+58)/2,g,-230,s-58,36]),{walks:e,slabs:o,flights:n,tower:{x:[s,s+20],z:[h[0],d[1]]}}})();Sa.push(...ka.walks);const ei=1.1;function ti(e,o,n=1/0){const s=n+ei;let i=-1/0;for(const a of Sa){if(e<a.x0||e>a.x1)continue;const c=Math.min(a.z0,a.z1),d=Math.max(a.z0,a.z1);if(o<c||o>d)continue;const h=a.kind==="flat"?a.y:a.y0+(a.y1-a.y0)*Jr((o-a.z0)/(a.z1-a.z0));h<=s&&h>i&&(i=h)}return i===-1/0?0:Math.max(0,i)}function oi(e,o,n=1/0){const s=o>lt.zTop?Ge.y:o>lt.zBottom?Ge.y*(o-lt.zBottom)/(lt.zTop-lt.zBottom):0,i=ti(e,o,n);return Math.max(s,i)}function ni(e,o,n){const s=D.plinth+D.storeys*D.storey;if(n>s)return!1;const a=1-(n<=D.plinth?0:Math.min(D.storeys,Math.ceil((n-D.plinth)/D.storey)))*D.taper;return Math.abs(e)<D.halfX*a&&Math.abs(o-D.z)<D.halfZ*a}const y={t:0,flash:0,flashDir:new S(0,.4,-1),fog:Ft.sea,rain:1,progress:0,shelter:0,inside:0,shot:0,underwater:0,depthBelow:0,whirlNear:0,subActive:!1,subPos:new S(0,0,0),helmActive:!1,helmPos:new S(0,0,0),helmSpeed:0,ship:{x:0,y:0,z:0,heading:Math.PI,loa:64,deckY:8.3,mastY:42},subThrottle:0,footSpawn:"hall",splash:0,onRails:!0,orbit:{yaw:0,pitch:.12,dist:120,target:new S(0,60,-200)}};function si(){y.t=0,y.progress=0,y.flash=0,y.fog=Ft.sea,y.rain=1,y.shot=0,y.underwater=0,y.depthBelow=0,y.whirlNear=0,y.subActive=!1,y.subThrottle=0}const an=new Map;let za=!0;function ai(e){za=!!e}function ri(e){const o=bo(e);return an.has(o)||an.set(o,fetch(o,{method:"HEAD"}).then(n=>n.ok?!(n.headers.get("content-type")||"").includes("text/html"):!1).catch(()=>!1)),an.get(o)}function ot(e){const[o,n]=b.useState(!1);return b.useEffect(()=>{let s=!0;return ri(e).then(i=>{s&&n(i&&za)}),()=>{s=!1}},[e]),o}const St=mo.map(e=>new S(...e).normalize()),Ta=new S(...Bn).normalize(),Sn=new S(...Un).normalize();function ii(e){let o=1;o+=Math.max(0,e.y)*.1,o-=Math.pow(Math.max(0,e.y),4)*.2;const n=Math.exp(-Math.pow((e.y-.52)/.16,2))*Math.max(0,e.z);o+=n*.13;for(const h of St){const p=e.dot(h),g=Math.pow(Math.max(0,p),46);o-=g*.3}const s=Math.max(0,e.dot(Ta)),i=Math.pow(s,150)*(1-Math.max(0,e.y)*.5);o-=i*.19;for(const h of St){const p=new S(h.x*1.5,h.y-.55,h.z*.7).normalize().dot(e);o+=Math.pow(Math.max(0,p),26)*.075}const a=Math.max(0,e.dot(Sn));o-=Math.pow(a,30)*.11,o-=Math.pow(Math.max(0,-e.y),3)*.28;const c=Math.pow(Math.max(0,e.dot(St[0])),30)+Math.pow(Math.max(0,e.dot(St[1])),30),d=1-Math.min(1,c);return o+=(qt(e.x*3.1+7,e.z*3.1-3,3)-.5)*.085*d,o+=(qt(e.x*9.4-2,e.y*9.4+5,2)-.5)*.032*d,o}const li=178*1.9,et=L.r/li;function ls(e,o){const n=e*et,s=[new S(n*74,96*et,-20*et),new S(n*142,176*et,-58*et),new S(n*196,268*et,-76*et),new S(n*222,356*et,-52*et),new S(n*206,424*et,8*et),new S(n*154,462*et,72*et)],i=new S;for(const g of s)i.set(L.x+g.x,L.baseY+g.y,L.z+g.z),jn(i,.12)&&g.set(i.x-L.x,i.y-L.baseY,i.z-L.z);const a=new to(s),c=o==="low"?14:o==="mid"?22:34,d=o==="low"?6:10,h=new oo(a,c,1,d,!1),p=h.attributes.position;for(let g=0;g<=c;g++){const f=g/c,m=34*et*Math.pow(1-f,.72)*(1+Math.sin(f*Math.PI)*.16),l=a.getPoint(f);for(let u=0;u<=d;u++){const x=g*(d+1)+u;if(x>=p.count)continue;const v=p.getX(x)-l.x,w=p.getY(x)-l.y,k=p.getZ(x)-l.z;p.setXYZ(x,l.x+v*m,l.y+w*m,l.z+k*m)}}return p.needsUpdate=!0,h.computeVertexNormals(),h}const ci={low:4,mid:6,high:7},Ea="skull-island.opt.glb",io={height:1,yaw:0,lift:.02},rn=new pr,cs=new S,To=new S;function hi(e,o,n){To.set(o[0],o[1],o[2]).normalize(),cs.copy(To).multiplyScalar(L.r*4),rn.set(cs,To.clone().negate()),rn.far=L.r*8;const s=rn.intersectObject(e,!0)[0];return s?s.point.clone().addScaledVector(To,-n):null}function di({shadows:e}){const{scene:o}=ba(bo(Ea)),{object:n,eyes:s,nose:i,mouth:a}=b.useMemo(()=>{const c=o.clone(!0),d=new wa().setFromObject(c),h=new S,p=new S;d.getSize(h),d.getCenter(p);const g=L.r*L.squash[1]*1.62,f=h.y>1e-4?g*io.height/h.y:1,m=L.r*L.squash[1]*io.lift;c.scale.setScalar(f),c.rotation.set(0,io.yaw,0),c.position.set(0,-p.y*f+m,0);const l=p.x*f,u=p.z*f,x=Math.cos(io.yaw),v=Math.sin(io.yaw);c.position.x=-(l*x+u*v),c.position.z=-(-l*v+u*x),c.updateMatrixWorld(!0);let w=0,k=0;const z={x:0,y:0,z:0},r=new S,M=[];c.traverse(G=>{G.isMesh&&M.push(G)});for(const G of M){const $=G.geometry.clone();for(const P of["position","normal"]){const K=$.attributes[P];if(!K||K.array instanceof Float32Array)continue;const ae=new Float32Array(K.count*3);for(let H=0;H<K.count;H++)r.fromBufferAttribute(K,H),ae[H*3]=r.x,ae[H*3+1]=r.y,ae[H*3+2]=r.z;$.setAttribute(P,new oe(ae,3))}$.applyMatrix4(G.matrixWorld);const q=$.attributes.position;k+=q.count;for(let P=0;P<q.count;P++)z.x=q.getX(P)+L.x,z.y=q.getY(P)+L.baseY,z.z=q.getZ(P)+L.z,jn(z,.05)&&(q.setXYZ(P,z.x-L.x,z.y-L.baseY,z.z-L.z),w++);w&&$.computeVertexNormals(),q.needsUpdate=!0,$.computeBoundingSphere(),$.computeBoundingBox(),G.geometry=$,G.castShadow=e,G.receiveShadow=!1;const ee=Array.isArray(G.material)?G.material:[G.material];for(const P of ee)P.color?.multiply(ui),P.roughness=.94,P.metalness=.02}for(const G of[c,...M])G.position.set(0,0,0),G.quaternion.identity(),G.scale.set(1,1,1),G.updateMatrix();c.updateMatrixWorld(!0);const F=(G,$=1)=>{const[q,ee,P]=L.squash;return new S(G[0]*L.r*q*$,G[1]*L.r*ee*$,G[2]*L.r*P*$)},C=mo.map(G=>hi(c,G,L.r*.1)??F(G,.82)),j=new S().addVectors(C[0],C[1]).multiplyScalar(.5),R=new S().addVectors(F(mo[0],.82),F(mo[1],.82)).multiplyScalar(.5),I=j.clone().sub(R),B=G=>{const $={x:G.x+L.x,y:G.y+L.baseY,z:G.z+L.z};return jn($,.22)&&G.set($.x-L.x,$.y-L.baseY,$.z-L.z),G};return{object:c,eyes:C.map(B),nose:B(F(Bn,.87).add(I)),mouth:B(F(Un,.9).add(I))}},[o,e]);return t.jsxs(t.Fragment,{children:[t.jsx("primitive",{object:n}),t.jsx(Ra,{eyes:s,nose:i,mouth:a,teeth:null,cast:e})]})}const ui=new ve("#8f8a84");function Ra({eyes:e,nose:o,mouth:n,teeth:s,cast:i}){const a=b.useRef(),c=b.useRef(),d=b.useRef();return ne(()=>{const h=y.t,p=.82+.18*Math.sin(h*2.3)*Math.sin(h*.71),g=.82+.18*Math.sin(h*1.9+2.1)*Math.sin(h*.63),f=.86+.14*Math.sin(h*1.4+.8);a.current&&(a.current.emissiveIntensity=5.2*p+y.flash*2),c.current&&(c.current.emissiveIntensity=5.2*g+y.flash*2),d.current&&(d.current.emissiveIntensity=3.4*f)}),t.jsxs(t.Fragment,{children:[e.map((h,p)=>t.jsxs("mesh",{position:h,rotation:[-.24,0,0],children:[t.jsx("sphereGeometry",{args:[L.r*.108,20,14,0,Math.PI*2,0,Math.PI*.5]}),t.jsx("meshStandardMaterial",{ref:p===0?a:c,color:E.furnace,emissive:E.ember,emissiveIntensity:5.2,toneMapped:!1,side:He,roughness:1})]},p)),t.jsxs("mesh",{position:o,rotation:[Math.PI*.54,0,0],children:[t.jsx("coneGeometry",{args:[L.r*.046,L.r*.083,3]}),t.jsx("meshStandardMaterial",{color:E.emberDeep,emissive:E.emberDeep,emissiveIntensity:2.4,toneMapped:!1})]}),t.jsxs("group",{position:n,children:[t.jsxs("mesh",{position:[0,L.r*.05,-L.r*.16],children:[t.jsx("planeGeometry",{args:[L.r*.62,L.r*.34]}),t.jsx("meshStandardMaterial",{ref:d,color:E.ember,emissive:E.emberDeep,emissiveIntensity:3.4,toneMapped:!1,side:He})]}),s?.map((h,p)=>t.jsxs("mesh",{position:h.pos,scale:h.scale,rotation:[0,0,h.rot],castShadow:i,children:[t.jsx("boxGeometry",{args:[1,1,1]}),t.jsx("meshStandardMaterial",{color:"#e6d9bc",emissive:E.emberDeep,emissiveIntensity:.42,roughness:.78})]},p))]})]})}const pi=typeof location<"u"?new URLSearchParams(location.search).get("skull"):null;function fi({quality:e="high",shadows:o=!0}){const s=ot(Ea)&&e!=="low"&&pi!=="proc",{dome:i,hornL:a,hornR:c,teeth:d}=b.useMemo(()=>{const l=new dr(L.r,ci[e]??7),u=l.attributes.position,x=new Float32Array(u.count*3),v=new ve(Z.rock),w=new ve(E.rockWarm),k=new ve("#120b10"),z=new ve,r=new S;for(let j=0;j<u.count;j++){r.set(u.getX(j),u.getY(j),u.getZ(j)).normalize();const R=L.r*ii(r),[I,B,G]=L.squash;u.setXYZ(j,r.x*R*I,r.y*R*B,r.z*R*G);const $=Math.max(Math.pow(Math.max(0,r.dot(St[0])),5),Math.pow(Math.max(0,r.dot(St[1])),5),Math.pow(Math.max(0,r.dot(Sn)),6)*.9);z.copy(v).lerp(w,Math.min(1,$*1.5+Math.max(0,r.z)*.22));const q=Math.max(Math.pow(Math.max(0,r.dot(St[0])),40),Math.pow(Math.max(0,r.dot(St[1])),40));z.lerp(k,q),x[j*3]=z.r,x[j*3+1]=z.g,x[j*3+2]=z.b}l.setAttribute("color",new oe(x,3)),l.computeVertexNormals();const M=new ur(1,1,1),F=[],C=9;for(let j=0;j<C;j++){const R=j/(C-1)*2-1,I=he.halfWidth*2.1,B=R*I*.5,G=Math.pow(Math.abs(R),1.7)*14,$=46-Math.abs(R)*13+j%2*7;F.push({pos:[B,he.height*.5-G-$*.5,6],scale:[I/C*.76,$,52],rot:R*.13})}return M.dispose?.(),{dome:l,hornL:ls(-1,e),hornR:ls(1,e),teeth:F}},[e]),h=o,[p,g,f]=L.squash,m=(l,u)=>[l.x*L.r*p*u,l.y*L.r*g*u,l.z*L.r*f*u];return t.jsx("group",{position:[L.x,L.baseY,L.z],children:s?t.jsx(b.Suspense,{fallback:t.jsx(hs,{dome:i,hornL:a,hornR:c,cast:h}),children:t.jsx(di,{shadows:h})}):t.jsxs(t.Fragment,{children:[t.jsx(hs,{dome:i,hornL:a,hornR:c,cast:h}),t.jsx(Ra,{eyes:St.map(l=>m(l,.82)),nose:m(Ta,.87),mouth:m(Sn,.96),teeth:d,cast:h})]})})}function hs({dome:e,hornL:o,hornR:n,cast:s}){return t.jsxs(t.Fragment,{children:[t.jsx("mesh",{geometry:e,castShadow:s,receiveShadow:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,roughness:.92,metalness:.03})}),t.jsx("mesh",{geometry:o,castShadow:s,children:t.jsx("meshStandardMaterial",{color:"#241d28",roughness:.55,metalness:.12})}),t.jsx("mesh",{geometry:n,castShadow:s,children:t.jsx("meshStandardMaterial",{color:"#241d28",roughness:.55,metalness:.12})})]})}function pt({matrices:e,target:o}){const n=b.useRef(!1);return ne(()=>{if(n.current||!o.current)return;const s=Math.min(e.length,o.current.count);for(let i=0;i<s;i++)o.current.setMatrixAt(i,e[i]);o.current.instanceMatrix.needsUpdate=!0,o.current.computeBoundingSphere(),n.current=!0}),null}const Wt=190,gt=130,Eo=9.5;function ds(e,o,n,s=24){const i=new to(e),a=new oo(i,s,1,4,!1),c=a.attributes.position,d=new S(0,1,0),h=new S,p=new S,g=new S,f=new S,m=new S;for(let l=0;l<=s;l++){const u=l/s;i.getPointAt(u,p),i.getTangentAt(u,h),f.crossVectors(h,d).normalize(),g.crossVectors(f,h).normalize();for(let x=0;x<=4;x++){const v=l*5+x;if(v>=c.count)continue;const w=x/4*Math.PI*2+Math.PI/4,k=Math.cos(w)*o*.7071,z=Math.sin(w)*n*.7071;m.copy(p).addScaledVector(f,k).addScaledVector(g,z),c.setXYZ(v,m.x,m.y,m.z)}}return c.needsUpdate=!0,a.computeVertexNormals(),a}function mi(e,o,n,s=40){const i=[];for(let h=0;h<=10;h++){const p=h/10*2-1;i.push(new S(p*e,-30*(1-p*p),0))}const a=new to(i),c=new oo(a,s,n,8,!1),d=c.attributes.position;for(let h=0;h<=s;h++){const p=h/s*2-1,g=1+(1-p*p)*.85,f=a.getPointAt(h/s);for(let m=0;m<=8;m++){const l=h*9+m;l>=d.count||d.setXYZ(l,f.x+(d.getX(l)-f.x)*g,f.y+(d.getY(l)-f.y)*g,f.z+(d.getZ(l)-f.z)*g)}}return d.needsUpdate=!0,c.computeVertexNormals(),c}function us({quality:e="high",shadows:o=!0,z:n=Pt,k:s=N}){const i=b.useRef(),a=b.useRef(),c=b.useRef(),d=b.useRef(),h=b.useMemo(()=>{const x=Wt/2,v=gt,w=ds([new S(-x-40,v+6,0),new S(-x-22,v+15.5,0),new S(0,v+20,0),new S(x+22,v+15.5,0),new S(x+40,v+6,0)],16,9,30),k=ds([new S(-x-30,v+2,0),new S(0,v+8,0),new S(x+30,v+2,0)],11,5,18);return{kasagi:w,shimaki:k,rope:mi(x-6,30,6.4,44)}},[]),{tileM:p,merlonM:g,cannonM:f,lanternM:m}=b.useMemo(()=>{const x=new rt,v=new mt,w=new S,k=new S,z=[],r=e==="low"?26:54;for(let R=0;R<r;R++){const I=R/(r-1)*2-1,B=I*(Wt/2+40),G=gt+20-Math.pow(Math.abs(I),1.9)*14+5,$=-Math.sign(I)*Math.pow(Math.abs(I),3)*.5;k.set(B,G,0),v.setFromEuler(new Dt(0,0,$)),w.set(1,1,1),z.push(x.clone().compose(k,v,w))}const M=[];for(const R of[-1,1])for(let I=0;I<7;I++)k.set(R*(58+I*12),26,0),v.identity(),w.set(1,1,1),M.push(x.clone().compose(k,v,w));const F=[];for(const R of[-1,1])for(let I=0;I<2;I++)for(let B=0;B<4-I;B++)k.set(R*(64+B*13+I*6),32+I*10,8),v.setFromEuler(new Dt(Math.PI/2-.16,0,0)),w.set(1,1,1),F.push(x.clone().compose(k,v,w));const C=[],j=e==="low"?10:22;for(let R=0;R<j;R++){const I=R/(j-1)*2-1,B=I*(Wt/2-12),G=30*(1-I*I);k.set(B,gt-34-G-7.5,0),v.identity(),w.set(1,1,1),C.push(x.clone().compose(k,v,w))}return{tileM:z,merlonM:M,cannonM:F,lanternM:C}},[e]);ne(()=>{const x=y.t;i.current&&(i.current.material.emissiveIntensity=2.6+Math.sin(x*3.1)*.22+Math.sin(x*7.7)*.1+y.flash*1.4)});const l=Wt/2,u=o;return t.jsxs("group",{position:[0,0,n],scale:s,children:[[-1,1].map(x=>t.jsxs("group",{position:[x*l,0,0],children:[t.jsxs("mesh",{position:[0,gt/2-30,0],castShadow:u,children:[t.jsx("cylinderGeometry",{args:[Eo*.86,Eo,gt+60,14]}),t.jsx("meshStandardMaterial",{color:"#6d4d86",roughness:.72})]}),t.jsxs("mesh",{position:[0,6,0],castShadow:u,children:[t.jsx("cylinderGeometry",{args:[Eo*1.5,Eo*1.85,20,14]}),t.jsx("meshStandardMaterial",{color:"#3b3547",roughness:.94})]})]},x)),t.jsxs("mesh",{position:[0,gt-26,0],castShadow:u,children:[t.jsx("boxGeometry",{args:[Wt+56,12,13]}),t.jsx("meshStandardMaterial",{color:"#6d4d86",roughness:.72})]}),t.jsx("mesh",{geometry:h.shimaki,castShadow:u,children:t.jsx("meshStandardMaterial",{color:"#5c3f72",roughness:.76})}),t.jsx("mesh",{geometry:h.kasagi,castShadow:u,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.68})}),t.jsxs("instancedMesh",{ref:a,args:[null,null,p.length],castShadow:u,children:[t.jsx("cylinderGeometry",{args:[3.4,3.4,9.5,6,1,!1,0,Math.PI]}),t.jsx("meshStandardMaterial",{color:"#8c2a1c",roughness:.6}),t.jsx(pt,{matrices:p,target:a})]}),t.jsxs("mesh",{position:[0,gt-6,0],castShadow:u,children:[t.jsx("boxGeometry",{args:[13,30,9]}),t.jsx("meshStandardMaterial",{color:"#4b3560",roughness:.8})]}),t.jsxs("mesh",{position:[0,gt-6,5.2],children:[t.jsx("planeGeometry",{args:[17,24]}),t.jsx("meshStandardMaterial",{color:"#2f4438",emissive:"#1d3326",emissiveIntensity:.5,roughness:.9})]}),t.jsx("mesh",{geometry:h.rope,position:[0,gt-34,2],castShadow:u,children:t.jsx("meshStandardMaterial",{color:"#cdc5b2",emissive:"#6a6053",emissiveIntensity:.55,roughness:.97})}),[-52,-18,18,52].map(x=>{const v=30*(1-(x/(Wt/2-6))**2);return t.jsx("group",{position:[x,gt-34-v-4,2],children:[0,1,2].map(w=>t.jsxs("mesh",{position:[w%2?1.1:-1.1,-2.4-w*3.6,0],children:[t.jsx("boxGeometry",{args:[3.4,3.4,.35]}),t.jsx("meshStandardMaterial",{color:"#efece2",emissive:"#cfc9b8",emissiveIntensity:.5,roughness:1,side:He})]},w))},x)}),[-1,1].map(x=>t.jsxs("group",{children:[t.jsxs("mesh",{position:[x*108,6,0],castShadow:u,receiveShadow:u,children:[t.jsx("boxGeometry",{args:[126,44,62]}),t.jsx("meshStandardMaterial",{color:"#39404f",roughness:.95})]}),t.jsxs("mesh",{position:[x*108,30,6],castShadow:u,children:[t.jsx("boxGeometry",{args:[118,12,44]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.88})]}),t.jsxs("mesh",{position:[x*162,44,10],children:[t.jsx("boxGeometry",{args:[9,13,9]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1})]})]},x)),t.jsxs("instancedMesh",{ref:d,args:[null,null,g.length],castShadow:u,children:[t.jsx("boxGeometry",{args:[8,11,44]}),t.jsx("meshStandardMaterial",{color:"#2f3542",roughness:.95}),t.jsx(pt,{matrices:g,target:d})]}),t.jsxs("instancedMesh",{ref:c,args:[null,null,f.length],castShadow:u,children:[t.jsx("cylinderGeometry",{args:[3.4,4.4,30,10]}),t.jsx("meshStandardMaterial",{color:"#15181f",roughness:.42,metalness:.75}),t.jsx(pt,{matrices:f,target:c})]}),t.jsxs("instancedMesh",{ref:i,args:[null,null,m.length],children:[t.jsx("cylinderGeometry",{args:[3.6,3.6,6.4,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.6,toneMapped:!1}),t.jsx(pt,{matrices:m,target:i})]})]})}const gi=(()=>{if(typeof document>"u")return null;const e=128,o=document.createElement("canvas");o.width=o.height=e;const n=o.getContext("2d"),s=n.createRadialGradient(e/2,e/2,0,e/2,e/2,e/2);s.addColorStop(0,"rgba(255,255,255,1)"),s.addColorStop(.12,"rgba(255,255,255,0.55)"),s.addColorStop(.4,"rgba(255,255,255,0.06)"),s.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=s,n.fillRect(0,0,e,e),n.translate(e/2,e/2);for(let a=0;a<4;a++){const c=n.createLinearGradient(0,0,e/2,0);c.addColorStop(0,"rgba(255,255,255,0.95)"),c.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=c,n.beginPath(),n.moveTo(0,-2.5),n.lineTo(e/2,0),n.lineTo(0,2.5),n.closePath(),n.fill(),n.rotate(Math.PI/2)}const i=new no(o);return i.colorSpace=so,i})();function xi(e,o,n,s){const i=[];for(let a=0;a<=s;a++){const c=a/s,d=c*2-1;i.push(new S(e[0]+(o[0]-e[0])*c,e[1]+(o[1]-e[1])*c-n*(1-d*d),e[2]+(o[2]-e[2])*c))}return i}const bi=[[[-62,34,26],[-6,42,-12],14],[[-6,42,-12],[52,32,18],13],[[-46,28,-30],[18,36,-40],11],[[18,36,-40],[68,26,-20],11],[[-70,22,-4],[-16,30,36],10],[[16,30,40],[72,22,12],10],[[-36,48,-62],[34,50,-66],14]];function wi({quality:e="high",shadows:o=!0}){const n=b.useRef(),s=b.useRef(),i=b.useRef(),a=b.useRef(),{lanternM:c,lampM:d,pilingM:h,katanaY:p,ground:g}=b.useMemo(()=>{const l=new rt,u=new mt,x=new S(1,1,1),v=new S,w=[],k=e==="low"?.42:e==="mid"?.72:1;for(const[F,C,j]of bi){const R=Math.max(4,Math.round(j*k)),I=xi(F,C,14,R);for(let B=1;B<I.length-1;B++){const G=.78+B*37%11/22;v.copy(I[B]).add(new S(0,-4.2*G,0)),u.setFromEuler(new Dt(0,B*1.7%Math.PI,(B%3-1)*.06)),w.push(l.clone().compose(v,u,x.clone().multiplyScalar(G)))}}const z=[],r=e==="low"?6:11;for(let F=0;F<r;F++){const C=F/(r-1);for(const j of[-1,1]){const R=T.lerp(Q.x+46,he.x-6,C)+j*(26-C*9),I=T.lerp(Q.z-26,he.z+32,C);v.set(R,re(R,I)+5,I),u.identity(),z.push(l.clone().compose(v,u,x))}}const M=[];for(let F=0;F<16;F++){const C=F%2,j=Math.floor(F/2);v.set(Q.x+30+j*17,-2,Q.z+34+C*26),u.setFromEuler(new Dt(0,0,(F%3-1)*.035)),M.push(l.clone().compose(v,u,x))}return{lanternM:w,lampM:z,pilingM:M,katanaY:re(Q.x+118,Q.z-58),ground:Q.y}},[e]);ne(()=>{const l=y.t;if(n.current&&(n.current.material.emissiveIntensity=2.4+Math.sin(l*2.7)*.2+Math.sin(l*6.1+1.3)*.12+y.flash*1.6),a.current){const u=46*(1+Math.sin(l*1.3)*.13);a.current.scale.set(u,u,1),a.current.material.rotation=l*.07}});const f=o,m=(l,u)=>re(Q.x+l,Q.z+u);return t.jsxs("group",{children:[t.jsxs("group",{position:[Q.x,0,Q.z],children:[t.jsxs("mesh",{position:[85,7.5,47],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[128,3,60]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.92})]}),t.jsxs("mesh",{position:[18,7,4],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[96,2.4,82]}),t.jsx("meshStandardMaterial",{color:"#5a4230",roughness:.94})]}),[0,1,2,3].map(l=>t.jsxs("group",{position:[52+l*26,1.5,92+l%2*13],rotation:[0,.4+l*.3,0],children:[t.jsxs("mesh",{castShadow:f,children:[t.jsx("boxGeometry",{args:[18,5,6.5]}),t.jsx("meshStandardMaterial",{color:"#4a3524",roughness:.9})]}),t.jsxs("mesh",{position:[0,9,0],children:[t.jsx("boxGeometry",{args:[.7,14,.7]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.9})]}),t.jsxs("mesh",{position:[1.5,12,0],children:[t.jsx("planeGeometry",{args:[9,11]}),t.jsx("meshStandardMaterial",{color:"#cbbfa4",roughness:1,side:He})]})]},l))]}),t.jsxs("instancedMesh",{ref:i,args:[null,null,h.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.8,2.1,22,7]}),t.jsx("meshStandardMaterial",{color:"#33251a",roughness:.95}),t.jsx(pt,{matrices:h,target:i})]}),t.jsxs("group",{position:[Q.x+118,p,Q.z-58],rotation:[0,.5,.34],scale:.6,children:[t.jsxs("mesh",{position:[0,52,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[7,132,2.1]}),t.jsx("meshStandardMaterial",{color:"#cfd8e2",roughness:.16,metalness:.92})]}),t.jsxs("mesh",{position:[0,116,0],rotation:[Math.PI/2,0,0],castShadow:f,children:[t.jsx("torusGeometry",{args:[9,2.4,6,18]}),t.jsx("meshStandardMaterial",{color:"#2a2118",roughness:.4,metalness:.75})]}),t.jsxs("mesh",{position:[0,138,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[4.4,4.9,42,10]}),t.jsx("meshStandardMaterial",{color:"#20232b",roughness:.85})]}),t.jsxs("mesh",{position:[0,161,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[5.2,5.2,5,10]}),t.jsx("meshStandardMaterial",{color:"#8a7a4e",roughness:.5,metalness:.6})]}),t.jsx("sprite",{ref:a,position:[0,116,0],scale:[46,46,1],children:t.jsx("spriteMaterial",{map:gi,color:E.furnace,transparent:!0,opacity:.75,blending:wt,depthWrite:!1,toneMapped:!1})})]}),[-1,1].map(l=>{const u=96+l*4,x=88*l;return t.jsxs("group",{position:[Q.x+u,m(u,x),Q.z+x],rotation:[0,-l*.5,0],children:[t.jsxs("mesh",{position:[0,7,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[13,14,13]}),t.jsx("meshStandardMaterial",{color:"#4a4a52",roughness:.95})]}),t.jsxs("mesh",{position:[0,21,1],rotation:[.22,0,0],castShadow:f,children:[t.jsx("capsuleGeometry",{args:[5,12,4,8]}),t.jsx("meshStandardMaterial",{color:"#c9c4b4",roughness:.86})]}),t.jsxs("mesh",{position:[0,32,5],castShadow:f,children:[t.jsx("sphereGeometry",{args:[5.4,12,10]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]}),[-1,1].map(v=>t.jsxs("mesh",{position:[v*3,37,4],rotation:[0,0,v*.3],castShadow:f,children:[t.jsx("coneGeometry",{args:[2.1,6.5,4]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]},v)),t.jsxs("mesh",{position:[0,26,-8],rotation:[-.7,0,0],castShadow:f,children:[t.jsx("coneGeometry",{args:[4,20,6]}),t.jsx("meshStandardMaterial",{color:"#cfcabb",roughness:.86})]}),t.jsxs("mesh",{position:[0,26,6.4],rotation:[.3,0,0],children:[t.jsx("planeGeometry",{args:[9,8]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.9,side:He})]})]},l)}),[-1,1].map(l=>{const u=40+l*34,x=-18+l*46;return t.jsxs("group",{position:[Q.x+u,m(u,x)+12,Q.z+x],rotation:[0,l*.8,0],children:[t.jsxs("mesh",{castShadow:f,children:[t.jsx("sphereGeometry",{args:[9,12,10]}),t.jsx("meshStandardMaterial",{color:"#7c6a52",roughness:.9})]}),[-1,1].map(v=>t.jsxs("mesh",{position:[v*5,7,-1],rotation:[0,0,v*-.5],castShadow:f,children:[t.jsx("coneGeometry",{args:[1.8,8,5]}),t.jsx("meshStandardMaterial",{color:"#4c4038",roughness:.85})]},v)),t.jsxs("mesh",{position:[0,-1,8],children:[t.jsx("sphereGeometry",{args:[4.2,10,8]}),t.jsx("meshStandardMaterial",{color:E.ember,emissive:E.ember,emissiveIntensity:2.2,toneMapped:!1})]}),t.jsxs("mesh",{position:[0,-8,13],rotation:[.4,0,0],children:[t.jsx("cylinderGeometry",{args:[1.5,2.6,20,6,1,!0]}),t.jsx("meshStandardMaterial",{color:"#cfe4ee",transparent:!0,opacity:.42,roughness:.25,side:He})]})]},l)}),t.jsxs("group",{position:[Q.x-34,m(-34,30)+2,Q.z+30],children:[t.jsxs("mesh",{position:[0,30,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.1,1.4,60,8]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.92})]}),t.jsxs("mesh",{position:[0,58,0],castShadow:f,children:[t.jsx("coneGeometry",{args:[34,17,20,1,!0]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.88,side:He,emissive:E.vermilionDeep,emissiveIntensity:.4})]}),Array.from({length:10},(l,u)=>{const x=u/10*Math.PI*2;return t.jsxs("mesh",{position:[Math.cos(x)*26,55.5,Math.sin(x)*26],rotation:[0,-x,-.42],children:[t.jsx("boxGeometry",{args:[34,.6,.6]}),t.jsx("meshStandardMaterial",{color:"#2a1c12",roughness:.9})]},u)}),Array.from({length:10},(l,u)=>{const x=u/10*Math.PI*2+.31;return t.jsxs("mesh",{position:[Math.cos(x)*32,44,Math.sin(x)*32],children:[t.jsx("cylinderGeometry",{args:[2.6,2.6,4.6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.5,toneMapped:!1})]},u)})]}),[0,1,2,3].map(l=>{const u=8+l*30,x=-70-l%2*14;return t.jsxs("group",{position:[Q.x+u,m(u,x),Q.z+x],children:[t.jsxs("mesh",{position:[0,26,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[.6,.6,52,6]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.9})]}),t.jsxs("mesh",{position:[5,34,0],children:[t.jsx("planeGeometry",{args:[10,34]}),t.jsx("meshStandardMaterial",{color:l%2?"#e8dcc4":E.vermilion,roughness:.95,side:He})]})]},l)}),[0,1,2].map(l=>{const u=.28+l*.24,x=T.lerp(Q.x+46,he.x,u),v=T.lerp(Q.z-26,he.z+26,u),w=re(x,v),k=1-l*.1;return t.jsxs("group",{position:[x,w,v],scale:k,children:[[-1,1].map(z=>t.jsxs("mesh",{position:[z*15,17,0],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[1.7,2.1,34,10]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.7})]},z)),t.jsxs("mesh",{position:[0,36,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[44,3.4,4]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.68})]}),t.jsxs("mesh",{position:[0,29,0],castShadow:f,children:[t.jsx("boxGeometry",{args:[36,2.4,3]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.75})]})]},l)}),t.jsx("group",{position:[Q.x,g,Q.z],children:t.jsxs("instancedMesh",{ref:n,args:[null,null,c.length],children:[t.jsx("cylinderGeometry",{args:[3.1,3.1,5.6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1}),t.jsx(pt,{matrices:c,target:n})]})}),t.jsxs("instancedMesh",{ref:s,args:[null,null,d.length],castShadow:f,children:[t.jsx("boxGeometry",{args:[6,12,6]}),t.jsx("meshStandardMaterial",{color:"#6c6458",emissive:E.lanternFar,emissiveIntensity:1.1,roughness:.95}),t.jsx(pt,{matrices:d,target:s})]})]})}const ps={low:{pine:150,sakura:90,rock:60},mid:{pine:340,sakura:190,rock:130},high:{pine:620,sakura:340,rock:240}};function yi(e){let o=e>>>0;return()=>(o=Math.imul(o,1664525)+1013904223>>>0,o/4294967296)}function vi({quality:e="high",shadows:o=!0}){const n=b.useRef(),s=b.useRef(),i=b.useRef(),a=b.useRef(),{pineTrunkM:c,pineCanopyM:d,sakuraM:h,rockM:p}=b.useMemo(()=>{const f=ps[e]??ps.high,m=yi(20250801),l=new rt,u=new mt,x=new S,v=new S,w=new S(0,1,0),k=new S,z=[],r=[],M=[],F=f.pine+f.sakura+f.rock;let C=0,j=0;for(;C<F&&j<F*60;){j++;const R=m()*Math.PI*2,I=ft*(.55+m()*.62),B=de.x+Math.sin(R)*I,G=de.z+Math.cos(R)*I,$=re(B,G);if($<5||$>300||Cr(B,G,6)>.72||Math.hypot(B-L.x,G-L.z)<L.r*1.35)continue;const q=B>de.x+(m()-.5)*90,ee=C;if(C++,v.set(B,$,G),ee<f.rock){const P=Yn(B,G,5);k.set(P[0],P[1],P[2]),u.setFromUnitVectors(w,k),u.multiply(new mt().setFromEuler(new Dt(m()*.5,m()*6.28,m()*.5)));const K=2.5+m()*7;x.set(K*(.7+m()*.6),K*(.5+m()*.5),K*(.7+m()*.6)),v.y-=K*.25,M.push(l.clone().compose(v,u,x))}else if(q){if(z.length>=f.pine)continue;u.setFromEuler(new Dt(0,m()*6.28,(m()-.5)*.09));const P=.72+m()*.7;x.set(P,P*(.85+m()*.45),P),z.push(l.clone().compose(v,u,x))}else{if(r.length>=f.sakura)continue;u.setFromEuler(new Dt(0,m()*6.28,(m()-.5)*.13));const P=.7+m()*.75;x.set(P,P*(.8+m()*.5),P),r.push(l.clone().compose(v,u,x))}}return{pineTrunkM:z.map(R=>R.clone().multiply(Mi)).concat(r.map(R=>R.clone().multiply(ki))),pineCanopyM:z.map(R=>R.clone().multiply(ji)),sakuraM:r.map(R=>R.clone().multiply(Si)),rockM:M}},[e]),g=o;return t.jsxs(t.Fragment,{children:[t.jsxs("instancedMesh",{ref:n,args:[null,null,c.length],castShadow:g,children:[t.jsx("cylinderGeometry",{args:[.9,1.7,14,5]}),t.jsx("meshStandardMaterial",{color:"#1d1a1c",roughness:.96}),t.jsx(pt,{matrices:c,target:n})]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,d.length],castShadow:g,children:[t.jsx("coneGeometry",{args:[8.5,30,7]}),t.jsx("meshStandardMaterial",{color:Z.pine,roughness:.93,flatShading:!0}),t.jsx(pt,{matrices:d,target:s})]}),t.jsxs("instancedMesh",{ref:i,args:[null,null,h.length],castShadow:g,children:[t.jsx("sphereGeometry",{args:[7.5,8,6]}),t.jsx("meshStandardMaterial",{color:E.sakura,roughness:.95,flatShading:!0,emissive:E.sakura,emissiveIntensity:.1}),t.jsx(pt,{matrices:h,target:i})]}),t.jsxs("instancedMesh",{ref:a,args:[null,null,p.length],castShadow:g,receiveShadow:g,children:[t.jsx("dodecahedronGeometry",{args:[1,0]}),t.jsx("meshStandardMaterial",{color:Z.rock,roughness:.97,flatShading:!0}),t.jsx(pt,{matrices:p,target:a})]})]})}const Mi=new rt().makeTranslation(0,7,0),ji=new rt().makeTranslation(0,26,0),Si=new rt().compose(new S(0,13,0),new mt,new S(1,.72,1)),ki=new rt().compose(new S(0,5,0),new mt,new S(.75,.62,.75)),Mt=Math.PI,fs={"ship-sunny.opt.glb":Mt/2,"ship-tang.opt.glb":Mt/2,"ship-punk.opt.glb":Mt/2,"ship-lion.opt.glb":Mt/2,"ship-bone.opt.glb":Mt/2,"ship-junk.opt.glb":Mt/2,"ship-warjunk.opt.glb":Mt/2,"ship-sub.opt.glb":-Mt/2},tn=e=>e&&fs[e]!==void 0?fs[e]:Mt/2,zi={"ship-sunny.opt.glb":40,"ship-lion.opt.glb":40,"ship-punk.opt.glb":52,"ship-tang.opt.glb":32,"ship-sub.opt.glb":32,"ship-bone.opt.glb":50,"ship-junk.opt.glb":38,"ship-warjunk.opt.glb":60},Aa=1.6,ms=Object.fromEntries(Object.entries(zi).map(([e,o])=>[e,Math.round(o*Aa)])),gs={"ship-sunny.opt.glb":.6,"ship-lion.opt.glb":.8,"ship-punk.opt.glb":.62,"ship-tang.opt.glb":.62,"ship-sub.opt.glb":.72,"ship-bone.opt.glb":.72,"ship-junk.opt.glb":.53,"ship-warjunk.opt.glb":.6},on=2,xs={"ship-sunny.opt.glb":.513,"ship-lion.opt.glb":.213,"ship-punk.opt.glb":.118,"ship-tang.opt.glb":.208,"ship-sub.opt.glb":.256,"ship-bone.opt.glb":.308,"ship-junk.opt.glb":.313,"ship-warjunk.opt.glb":.415},bs={"ship-sunny.opt.glb":1.044,"ship-lion.opt.glb":.824,"ship-punk.opt.glb":.673,"ship-tang.opt.glb":1,"ship-sub.opt.glb":.641,"ship-bone.opt.glb":.771,"ship-junk.opt.glb":.915,"ship-warjunk.opt.glb":.702},ws={"ship-sunny.opt.glb":.13,"ship-lion.opt.glb":.13,"ship-punk.opt.glb":.075,"ship-bone.opt.glb":.13,"ship-junk.opt.glb":.13,"ship-warjunk.opt.glb":.13,"ship-tang.opt.glb":.05,"ship-sub.opt.glb":.05},Bo=[[0,.26,0],[-.1,.02,.7],[.1,-.08,-.9],[0,-.27,Math.PI*.85]],Ia=e=>e==="low"?Bo.slice(0,1):e==="mid"?Bo.slice(0,2):Bo,ys={"ship-sunny.opt.glb":"#e6ded0","ship-punk.opt.glb":"#c9bfae","ship-tang.opt.glb":"#d8cdb4","ship-lion.opt.glb":"#9a9188","ship-sub.opt.glb":"#9a9188","ship-bone.opt.glb":"#9a9188"},Kn=(e,o="#9a9188")=>e&&ys[e]!==void 0?ys[e]:o,nn=(e,o=34)=>e&&ms[e]!==void 0?ms[e]:o,sn=e=>e&&gs[e]!==void 0?gs[e]:1,Ti=e=>e&&xs[e]!==void 0?xs[e]:.2,Ca=e=>e&&ws[e]!==void 0?ws[e]:.13,Mo=e=>Math.max(0,Ti(e)-Ca(e)),Nt=(e,o)=>Ca(e)*o,yo=(e,o)=>((e&&bs[e]!==void 0?bs[e]:.8)-Mo(e))*o,Fa=210,vs={off:1,lead:.98*Aa*.77},Ms={SPREAD:28,SWEEP:14},js=(e,o=0)=>({off:e*Ms.SPREAD,lead:o-Math.abs(e)*Ms.SWEEP}),Ei={scabbards:[0,Fa],"straw-hats":[-1,150],kid:[1,150],heart:[0,60]},Ri=430*N;function Ai(e,o=0){const n=(820+-670*e)*N+o;return[(Math.sin(e*2.4)*54-e*26)*N,n]}function Ii(e,o,n,s){const[i,a]=Ai(n,s);return[i+o*N*vs.off,a-e*N*vs.lead]}const Ci=[{x:-300*N,z:100*N,yaw:.35},{x:330*N,z:360*N,yaw:-.55},{x:-390*N,z:470*N,yaw:.12},{x:420*N,z:830*N,yaw:-.28},{x:-455*N,z:930*N,yaw:.48},{x:400*N,z:1120*N,yaw:-.16},{x:-520*N,z:690*N,yaw:.22},{x:540*N,z:1290*N,yaw:-.42}],Fi=[{x:Q.x+132*N*.72,z:Q.z+96*N*.72,yaw:2.3},{x:Q.x+168*N*.72,z:Q.z+40*N*.72,yaw:1.9},{x:Q.x+96*N*.72,z:Q.z+150*N*.72,yaw:2.7}];function Pi({url:e,height:o,loa:n,slim:s=1,sink:i=0,rotation:a,tint:c,emissive:d,emissiveIntensity:h}){const{scene:p}=ba(e),g=b.useMemo(()=>p.clone(!0),[p]),f=b.useMemo(()=>{const m=new wa().setFromObject(g),l=new S;m.getSize(l);const u=new S;if(m.getCenter(u),n){const v=l.x>=l.z,w=Math.max(v?l.x:l.z,1e-4),k=n/w,z=v?[k,k,k*s]:[k*s,k,k];return{scale:z,offset:[-u.x*z[0],-m.min.y*z[1]-n*i,-u.z*z[2]]}}const x=l.y>1e-4?o/l.y:1;return{scale:[x,x,x],offset:[-u.x*x,-m.min.y*x,-u.z*x]}},[g,o,n,s,i]);return b.useEffect(()=>{g.traverse(m=>{if(m.isMesh&&(m.castShadow=!0,m.receiveShadow=!0,c&&m.material)){const l=Array.isArray(m.material)?m.material:[m.material];for(const u of l)u.color?.multiply(new ve(c)),d&&u.emissive&&(u.emissive.set(d),u.emissiveIntensity=h??.2)}})},[g,c,d,h]),t.jsx("group",{rotation:[0,a,0],scale:f.scale,position:f.offset,children:t.jsx("primitive",{object:g})})}class Li extends b.Component{constructor(){super(...arguments);ns(this,"state",{failed:!1})}static getDerivedStateFromError(){return{failed:!0}}componentDidCatch(n){}render(){return this.state.failed?this.props.fallback:this.props.children}}function ge({name:e,height:o,loa:n=null,slim:s=1,sink:i=0,rotation:a=0,position:c=[0,0,0],tint:d=null,emissive:h=null,emissiveIntensity:p=.2,fallback:g=null}){const f=bo(e);return ot(e)?t.jsx("group",{position:c,children:t.jsx(Li,{url:f,fallback:g,children:t.jsx(b.Suspense,{fallback:g,children:t.jsx(Pi,{url:f,height:o,loa:n,slim:s,sink:i,rotation:a,tint:d,emissive:h,emissiveIntensity:p})})})}):t.jsx("group",{position:c,children:g})}const kn=(()=>{if(typeof document>"u")return null;const e=64,o=128,n=document.createElement("canvas");n.width=e,n.height=o;const s=n.getContext("2d"),i=s.createImageData(e,o);for(let c=0;c<o;c++){const d=c/(o-1),h=Math.pow(1-d,1.7);for(let p=0;p<e;p++){const g=p/(e-1)*2-1,f=Math.max(0,1-Math.abs(g)/(.35+d*.65)),m=.45+.55*Math.pow(Math.abs(g)/(.35+d*.65),1.5),l=h*Math.pow(f,1.4)*m,u=(c*e+p)*4;i.data[u]=255,i.data[u+1]=255,i.data[u+2]=255,i.data[u+3]=Math.round(Math.min(1,l)*255)}}s.putImageData(i,0,0);const a=new no(n);return a.colorSpace=so,a})(),Gi=(()=>{if(typeof document>"u")return null;const e=64,o=document.createElement("canvas");o.width=e,o.height=e;const n=o.getContext("2d"),s=n.createImageData(e,e);for(let a=0;a<e;a++){const c=a/(e-1),d=Math.pow(1-c,1.5);for(let h=0;h<e;h++){const p=h/(e-1)*2-1,g=Math.max(0,1-Math.abs(p)),f=d*Math.pow(g,1.3),m=(a*e+h)*4;s.data[m]=255,s.data[m+1]=255,s.data[m+2]=255,s.data[m+3]=Math.round(Math.min(1,f)*255)}}n.putImageData(s,0,0);const i=new no(o);return i.colorSpace=so,i})(),Uo=160,Qt=112,go="#e6dfcf",Pa="#0c0a15",Zt=Pa;typeof CanvasRenderingContext2D<"u"&&!CanvasRenderingContext2D.prototype.roundRect&&(CanvasRenderingContext2D.prototype.roundRect=function(e,o,n,s,i){const a=Math.min(i??0,Math.abs(n)/2,Math.abs(s)/2);return this.moveTo(e+a,o),this.arcTo(e+n,o,e+n,o+s,a),this.arcTo(e+n,o+s,e,o+s,a),this.arcTo(e,o+s,e,o,a),this.arcTo(e,o,e+n,o,a),this.closePath(),this});function Yt(e){if(typeof document>"u")return null;const o=document.createElement("canvas");o.width=Uo,o.height=Qt;const n=o.getContext("2d"),s=n.createLinearGradient(0,0,0,Qt);s.addColorStop(0,"#14101f"),s.addColorStop(.5,Pa),s.addColorStop(1,"#08060f"),n.fillStyle=s,n.fillRect(0,0,Uo,Qt),n.fillStyle="rgba(255,255,255,0.07)",n.fillRect(0,0,5,Qt),n.save(),n.translate(Uo/2+4,Qt/2);try{e(n)}catch(a){console.warn("[onigashima] flag emblem skipped",a)}n.restore();const i=new no(o);return i.colorSpace=so,i.anisotropy=4,i}function ln(e,o,n=go){e.fillStyle=n,e.beginPath(),e.ellipse(0,-o*.12,o,o*.92,0,0,Math.PI*2),e.fill(),e.beginPath(),e.roundRect(-o*.52,o*.6,o*1.04,o*.5,o*.16),e.fill()}function cn(e,o,n=1){e.save(),e.fillStyle=Zt,e.beginPath(),e.ellipse(-o*.38,-o*.2,o*.27*n,o*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.ellipse(o*.38,-o*.2,o*.27*n,o*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.moveTo(0,o*.06),e.lineTo(-o*.14,o*.34),e.lineTo(o*.14,o*.34),e.closePath(),e.fill(),e.restore()}function Ss(e,o,n=4){e.save(),e.fillStyle=Zt;for(let s=1;s<n;s++){const i=-o*.5+s*o/n;e.fillRect(i-o*.035,o*.6,o*.07,o*.5)}e.fillRect(-o*.52,o*.78,o*1.04,o*.05),e.restore()}function ks(e,o,n=go){e.save(),e.strokeStyle=n,e.lineWidth=o*.17,e.lineCap="round";for(const s of[1,-1]){e.save(),e.rotate(s*Math.PI/4.4),e.beginPath(),e.moveTo(-o*1.55,o*.55),e.lineTo(o*1.55,o*.55),e.stroke(),e.fillStyle=n;for(const i of[-1,1])for(const a of[-.16,.16])e.beginPath(),e.arc(i*o*1.55,o*.55+a*o,o*.15,0,Math.PI*2),e.fill();e.restore()}e.restore()}const Oi={straw:Yt(e=>{ks(e,26),ln(e,26),cn(e,26),Ss(e,26),e.fillStyle="#e8c86a",e.beginPath(),e.ellipse(0,-26*.86,26*1.5,26*.3,0,0,Math.PI*2),e.fill(),e.beginPath(),e.roundRect(-26*.78,-26*1.5,26*1.56,26*.7,26*.22),e.fill(),e.fillStyle="#d63420",e.fillRect(-26*.8,-26*1.06,26*1.6,26*.22)}),heart:Yt(e=>{const n="#a8e8d4";e.fillStyle=n,e.beginPath(),e.ellipse(0,0,27*1.02,27*1,0,0,Math.PI*2),e.fill(),e.save(),e.fillStyle=Zt;for(const s of[-1,1])e.beginPath(),e.arc(s*27*.36,-27*.2,27*.2,0,Math.PI*2),e.fill();e.lineWidth=27*.13,e.strokeStyle=Zt,e.beginPath(),e.arc(0,27*.12,27*.52,.24*Math.PI,.76*Math.PI),e.stroke(),e.restore(),e.fillStyle="#d63420",e.beginPath(),e.moveTo(0,-27*1.34),e.bezierCurveTo(27*.5,-27*1.9,27*.9,-27*1.2,0,-27*.78),e.bezierCurveTo(-27*.9,-27*1.2,-27*.5,-27*1.9,0,-27*1.34),e.fill()}),kid:Yt(e=>{ks(e,26,"#d8cfc0"),e.fillStyle=go,e.beginPath(),e.moveTo(-26*1.05,-26*.5),e.lineTo(-26*.7,-26*1.05),e.lineTo(26*.7,-26*1.05),e.lineTo(26*1.05,-26*.5),e.lineTo(26*.72,26*.5),e.lineTo(-26*.72,26*.5),e.closePath(),e.fill(),e.beginPath(),e.roundRect(-26*.62,26*.42,26*1.24,26*.62,26*.1),e.fill(),e.save(),e.fillStyle=Zt;for(const n of[-1,1])e.save(),e.translate(n*26*.4,-26*.3),e.rotate(n*.35),e.beginPath(),e.roundRect(-26*.28,-26*.2,26*.56,26*.4,26*.1),e.fill(),e.restore();for(let n=0;n<6;n++){const s=-15.6+n*26*1.2/5;e.beginPath(),e.moveTo(s,26*.42),e.lineTo(s+26*.1,26*1.04),e.lineTo(s-26*.1,26*1.04),e.closePath(),e.fill()}e.restore()}),kozuki:Yt(e=>{e.strokeStyle="#e8b06a",e.lineWidth=30*.1,e.beginPath(),e.arc(0,0,30*1.06,0,Math.PI*2),e.stroke(),e.fillStyle="#d63420";for(let n=0;n<5;n++){const s=n/5*Math.PI*2-Math.PI/2;e.save(),e.rotate(s),e.beginPath(),e.ellipse(0,-30*.52,30*.26,30*.42,0,0,Math.PI*2),e.fill(),e.restore()}e.fillStyle="#e8c86a",e.beginPath(),e.arc(0,0,30*.24,0,Math.PI*2),e.fill()}),mink:Yt(e=>{e.fillStyle=go;for(const n of[-1,1])e.beginPath(),e.moveTo(n*25*.5,-25*.85),e.lineTo(n*25*1.02,-25*1.72),e.lineTo(n*25*1.06,-25*.6),e.closePath(),e.fill();ln(e,25),e.beginPath(),e.roundRect(-25*.34,25*.42,25*.68,25*.78,25*.2),e.fill(),cn(e,25,.85),e.save(),e.fillStyle=Zt,e.fillRect(-25*.32,25*.72,25*.64,25*.06),e.restore(),e.fillStyle=go;for(const n of[-1,1])e.beginPath(),e.moveTo(n*25*.3,25*.7),e.lineTo(n*25*.42,25*1.42),e.lineTo(n*25*.16,25*.78),e.closePath(),e.fill()}),beasts:Yt(e=>{e.fillStyle="#cfd8e4";for(const n of[-1,1])e.beginPath(),e.moveTo(n*26*.62,-26*.78),e.quadraticCurveTo(n*26*1.5,-26*1.5,n*26*1.18,-26*2),e.quadraticCurveTo(n*26*1.42,-26*1.35,n*26*.86,-26*.5),e.closePath(),e.fill();ln(e,26,"#cfd8e4"),cn(e,26),Ss(e,26,5),e.fillStyle="#c9411a",e.beginPath(),e.roundRect(-26*.74,26*.34,26*1.48,26*.2,26*.1),e.fill()})},La={value:0},zs=new Map;function Di(e){const o=zs.get(e);if(o)return o;const n=Oi[e],s=new fr({map:n,emissiveMap:n,emissive:new ve("#9fb4d8"),emissiveIntensity:.62,roughness:.94,metalness:0,side:He,transparent:!1});return s.onBeforeCompile=i=>{i.uniforms.uTime=La,i.vertexShader=`uniform float uTime;
...
`,As={low:1600,mid:3800,high:7e3},Ao=460;function qi({quality:e}){const o=b.useRef(),n=be(a=>a.camera),s=b.useMemo(()=>{const a=As[e]??As.high,c=new Float32Array(a*3),d=new Float32Array(a),h=new Float32Array(a);for(let g=0;g<a;g++)c[g*3]=Math.random()*Ao,c[g*3+1]=Math.random()*Ao,c[g*3+2]=Math.random()*Ao,d[g]=.7+Math.random()*.6,h[g]=.55+Math.random()*.85;const p=new Lt;return p.setAttribute("position",new oe(c,3)),p.setAttribute("aSpeed",new oe(d,1)),p.setAttribute("aLen",new oe(h,1)),p.boundingSphere=new ao(new S,1e6),p},[e]),i=b.useMemo(()=>({uTime:{value:0},uCam:{value:new S},uBox:{value:Ao},uFall:{value:118},uSize:{value:2.4},uColor:{value:new S(...ie("#b9c8e4"))},uOpacity:{value:.5}}),[]);return ne((a,c)=>{const d=o.current?.uniforms;d&&(d.uTime.value+=c,d.uCam.value.copy(n.position),d.uOpacity.value=.5*y.rain*y.rain+y.flash*.3)}),t.jsx("points",{geometry:s,frustumCulled:!1,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:Qi,fragmentShader:Zi,uniforms:i,transparent:!0,depthWrite:!1,fog:!1})})}const Ji=`
  uniform float uTime;
...
`,Is={low:120,mid:340,high:700};function tl({quality:e}){const o=b.useRef(),n=b.useMemo(()=>{const i=Is[e]??Is.high,a=[Ae[0],Ae[1],he,he],c=new Float32Array(i*3),d=new Float32Array(i),h=new Float32Array(i),p=new Float32Array(i);for(let f=0;f<i;f++){const m=a[f%a.length];c[f*3]=m.x+(Math.random()-.5)*74,c[f*3+1]=m.y+(Math.random()-.5)*30,c[f*3+2]=m.z+(Math.random()-.5)*26,d[f]=Math.random(),h[f]=.045+Math.random()*.055,p[f]=2+Math.random()*4}const g=new Lt;return g.setAttribute("position",new oe(c,3)),g.setAttribute("aPhase",new oe(d,1)),g.setAttribute("aRise",new oe(h,1)),g.setAttribute("aSize",new oe(p,1)),g.boundingSphere=new ao(new S(0,300,-260),700),g},[e]),s=b.useMemo(()=>({uTime:{value:0},uColor:{value:new S(...ie(E.ember))}}),[]);return ne((i,a)=>{o.current&&(o.current.uniforms.uTime.value+=a)}),t.jsx("points",{geometry:n,renderOrder:3,children:t.jsx("shaderMaterial",{ref:o,vertexShader:Ji,fragmentShader:el,uniforms:s,transparent:!0,depthWrite:!1,blending:wt,fog:!1})})}function ol({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(Xi,{quality:e}),t.jsx(qi,{quality:e}),t.jsx(tl,{quality:e})]})}const nl=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
...
`,Cs={low:150,mid:380,high:620};function al({whirl:e,quality:o}){const n=b.useRef(),s=b.useRef(),i=b.useMemo(()=>{const c=Cs[o]??Cs.high,d=new Float32Array(c*3),h=new Float32Array(c),p=new Float32Array(c),g=new Float32Array(c),f=new Float32Array(c),m=new Float32Array(c);for(let u=0;u<c;u++)h[u]=Math.random()*Math.PI*2,p[u]=Math.random(),g[u]=.05+Math.random()*.05,f[u]=3+Math.random()*6,m[u]=Math.random();const l=new Lt;return l.setAttribute("position",new oe(d,3)),l.setAttribute("aAngle",new oe(h,1)),l.setAttribute("aPhase",new oe(p,1)),l.setAttribute("aRate",new oe(g,1)),l.setAttribute("aSize",new oe(f,1)),l.setAttribute("aJitter",new oe(m,1)),l.boundingSphere=new ao(new S(e.x,0,e.z),e.r*1.6+40),l},[o,e]),a=b.useMemo(()=>({uTime:{value:0},uCentre:{value:new _n(e.x,e.z)},uR:{value:e.r},uDepth:{value:e.depth},uDir:{value:e.dir},uColor:{value:new S(...ie(Z.foam))},uGain:{value:1}}),[e]);return ne((c,d)=>{const h=n.current?.uniforms;if(!h)return;h.uTime.value+=d;const p=Math.hypot(c.camera.position.x-e.x,c.camera.position.z-e.z);h.uGain.value=1-T.smoothstep(p,1600,2400),s.current&&(s.current.visible=h.uGain.value>.02)}),t.jsx("points",{ref:s,geometry:i,renderOrder:2,children:t.jsx("shaderMaterial",{ref:n,vertexShader:nl,fragmentShader:sl,uniforms:a,transparent:!0,depthWrite:!1,blending:wt,fog:!1})})}function rl({quality:e="high"}){const o=be(n=>n.camera);return ne(()=>{let n=0;for(const s of _e){const i=Math.hypot(o.position.x-s.x,o.position.z-s.z);n=Math.max(n,1-T.smoothstep(i,s.r*.3,s.r*2.2))}y.whirlNear+=(n-y.whirlNear)*.05}),t.jsx(t.Fragment,{children:_e.map((n,s)=>t.jsx(al,{whirl:n,quality:e},s))})}const Y={rev:0,chain:null,step:0,hull:1,grip:0,clock:0,banner:null,done:!1,hits:0},eo={helm:[{text:"PASS THE OUTER GATE",hint:"The island’s marker, alone in open water. Straight through it.",test:e=>e.z<Jt-60},{text:"HOLD THE FAIRWAY",hint:"Whirlpools both flanks — the middle is the only clean water.",test:e=>e.toGate<420*N},{text:"RUN THE TORII",hint:"Between the columns — the batteries cannot depress that far.",test:e=>e.z<Pt-40},{text:"THREAD THE NECK",hint:"The walls close to a hundred metres. Mind your helm.",test:e=>e.z<120*N},{text:"MOOR AT THE PORT",hint:"Under the burning face. Come in slow.",test:e=>e.moored}],sub:[{text:"TAKE HER DOWN",hint:"Below thirty-five metres the maelstroms cannot reach you.",test:e=>e.depth>35},{text:"RUN UNDER THE BACK-DOOR MAELSTROM",hint:"Straight through where the surface is turning. Stay deep.",test:e=>{const o=Tr("back-door");return Math.hypot(e.x-o.x,e.z-o.z)<o.r*1.1&&e.depth>30}},{text:"FIND THE FJORD",hint:"North-east flank, a crack in the cliffs. It is not on any chart.",test:e=>e.toRear<420},{text:"SURFACE IN THE COVE",hint:"Blow ballast. The back door is above you.",test:e=>e.toRear<U.pool*1.3&&e.depth<3}],foot:[{text:"GET INSIDE THE SKULL",hint:"The mouth above the port, or the gate at the back of the cove.",test:e=>e.area==="hall"},{text:"CROSS THE LIVE FLOOR",hint:"The stage is at the far end, under the keep.",test:e=>e.area==="hall"&&e.lz!=null&&e.lz<40},{text:"CLIMB TO THE STAGE",hint:"The vermilion ramps either side of the approach.",test:e=>e.fy!=null&&e.fy>60},{text:"TAKE THE ROOF",hint:"The stair tower on the east flank goes all the way up.",test:e=>e.fy!=null&&e.fy>230}]},il=e=>eo[e]?eo[e].length:0,ll=()=>Y.chain&&eo[Y.chain]?eo[Y.chain][Y.step]??null:null;function Rn(e){Y.chain=eo[e]?e:null,Y.step=0,Y.hull=1,Y.grip=0,Y.clock=0,Y.done=!1,Y.banner=null,Y.rev++}function Zo(e,o,n=3.4){Y.banner={text:e,sub:o,until:Y.clock+n},Y.rev++}function Ht(e,o){Y.hull<=0||(Y.hull=Math.max(0,Y.hull-e),Y.hits++,Y.hull<=0?Zo("HULL BREACHED","She is going down — the raid goes on without you",5):o&&e>.04&&Zo(o,null,2.2),Y.rev++)}function Ga(e,o){if(Y.clock+=e,Y.banner&&Y.clock>Y.banner.until&&(Y.banner=null,Y.rev++),!Y.chain||Y.done||!o)return;const n=eo[Y.chain],s=n[Y.step];if(!s)return;let i=!1;try{i=!!s.test(o)}catch{i=!1}i&&(Y.step++,Y.step>=n.length?(Y.done=!0,Zo("OBJECTIVE COMPLETE",cl[Y.chain]??"",6)):Zo(n[Y.step].text,n[Y.step].hint,3.6),Y.rev++)}const cl={helm:"Moored under the face. The alliance is ashore.",sub:"Surfaced at the back door, unseen. Law would approve.",foot:"The roof of the demon castle. The whole bay is below you."};function Oa(e,{danger:o,headingX:n,headingZ:s,toCentreX:i,toCentreZ:a,speed:c,throttle:d}){if(o<=.001)return Y.grip=Math.max(0,Y.grip-e*.5),Y.grip;const h=Math.hypot(i,a)||1,p=-i/h,g=-a/h,f=n*p+s*g,m=Math.min(1,Math.abs(c)/22),l=o*.42,u=Math.max(0,f)*m*(.35+.45*Math.min(1,Math.abs(d)));return Y.grip=Math.max(0,Math.min(1,Y.grip+(l-u)*e)),Y.grip}const Fs=24,un=$o.safe,Ps=$o.range,lo=2.1,hl=1.5,Ls=22,dl=[Pt,Jt],ul=new rt,pn=new S,Gs=new mt,fn=new S;function pl({quality:e="high"}){const o=b.useRef(),n=b.useMemo(()=>Array.from({length:Fs},()=>({live:!1,x:0,z:0,y0:0,t:0})),[]),s=b.useRef(0),i=b.useMemo(()=>{const a=new ya(.55,1,1,e==="low"?6:10,1,!0);return a.translate(0,.5,0),a},[e]);return ne((a,c)=>{const d=o.current;if(!d)return;const h=Math.min(c,.05),p=y.helm;if(y.helmActive&&p&&!p.onFoot&&!p.sub&&!p.moored){let m=null,l=1/0;for(const u of dl){const x=Math.hypot(p.x,p.z-u);x<un||x>Ps||x<l&&(l=x,m=u)}if(m!==null&&(s.current-=h,s.current<=0)){const u=1-T.clamp((l-un)/(Ps-un),0,1);s.current=T.lerp(4.5,1.9,u);const x=n.find(v=>!v.live);if(x){const v=lo*.55,w=T.lerp(230,105,u);x.x=p.x+Math.sin(p.heading)*p.speed*v+(Math.random()-.5)*w,x.z=p.z+Math.cos(p.heading)*p.speed*v+(Math.random()-.5)*w,x.y0=210+Math.random()*60,x.t=0,x.live=!0}}}let f=0;for(const m of n){if(!m.live)continue;const l=m.t;if(m.t+=h,m.t<lo){const u=m.t/lo;pn.set(m.x,m.y0*(1-u*u),m.z),fn.set(2.2,9,2.2)}else{if(l<lo){const v=Math.hypot(m.x-p.x,m.z-p.z);v<Ls&&Ht(.03*(1-v/Ls)+.008,"HIT — SHOT THROUGH THE RIGGING"),y.splash+=1}const u=(m.t-lo)/hl;if(u>=1){m.live=!1;continue}const x=Math.min(1,u*4);pn.set(m.x,ut(m.x,m.z,y.t,1).y-4,m.z),fn.set(11+u*9,78*x*(1-u*u*.75),11+u*9)}Gs.identity(),d.setMatrixAt(f,ul.compose(pn,Gs,fn)),f++}d.count=f,d.instanceMatrix.needsUpdate=!0,d.visible=f>0}),t.jsx("instancedMesh",{ref:o,args:[i,void 0,Fs],frustumCulled:!1,renderOrder:2,visible:!1,children:t.jsx("meshBasicMaterial",{color:Z.foam,transparent:!0,opacity:.42,depthWrite:!1,toneMapped:!1,blending:wt,side:He})})}const fl=`
  uniform float uTime;
  uniform vec3  uCam;
  uniform float uBox;
  attribute float aSpeed;
...
`,Os={low:700,mid:1800,high:3200},Io=260;function gl({quality:e}){const o=b.useRef(),n=b.useRef(),s=be(c=>c.camera),i=b.useMemo(()=>{const c=Os[e]??Os.high,d=new Float32Array(c*3),h=new Float32Array(c),p=new Float32Array(c),g=new Float32Array(c);for(let m=0;m<c;m++)d[m*3]=Math.random()*Io,d[m*3+1]=Math.random()*Io,d[m*3+2]=Math.random()*Io,h[m]=.5+Math.random()*1.4,p[m]=1.2+Math.random()*3.2,g[m]=Math.random();const f=new Lt;return f.setAttribute("position",new oe(d,3)),f.setAttribute("aSpeed",new oe(h,1)),f.setAttribute("aSize",new oe(p,1)),f.setAttribute("aPhase",new oe(g,1)),f.boundingSphere=new ao(new S,1e6),f},[e]),a=b.useMemo(()=>({uTime:{value:0},uCam:{value:new S},uBox:{value:Io},uColor:{value:new S(...ie("#cfeee6"))},uGain:{value:0}}),[]);return ne((c,d)=>{const h=o.current?.uniforms;h&&(h.uTime.value+=d,h.uCam.value.copy(s.position),h.uGain.value=y.underwater,n.current&&(n.current.visible=y.underwater>.02))}),t.jsx("points",{ref:n,geometry:i,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:o,vertexShader:fl,fragmentShader:ml,uniforms:a,transparent:!0,depthWrite:!1,fog:!1})})}const xl=`
  uniform float uTime;
  uniform vec2  uCentre;
  uniform float uR;
  uniform float uDir;
...
`,Ds={low:260,mid:700,high:1300},wl=`
  varying vec2 vUv;
  varying vec3 vWorld;
  void main() {
    vUv = uv;
...
`,Ns=1100;function vl({whirl:e,quality:o}){const n=b.useRef(),s=b.useRef(),i=be(d=>d.camera),a=b.useMemo(()=>{const d=o==="low"?24:o==="mid"?34:48,h=new ya(e.r*1.02,e.r*.07,Ns,d,6,!0);return h.translate(e.x,-Ns/2-3,e.z),h},[e,o]),c=b.useMemo(()=>({uTime:{value:0},uDir:{value:e.dir},uGain:{value:0},uColor:{value:new S(...ie(Z.foam))},uDeep:{value:new S(...ie(Z.underGlow))},uCameraPos:{value:new S},uFogDensity:{value:.0062},uFogColor:{value:new S(...ie(Z.underHaze))}}),[e]);return ne((d,h)=>{const p=n.current?.uniforms;if(!p)return;p.uTime.value+=h,p.uCameraPos.value.copy(d.camera.position),p.uFogDensity.value=d.scene.fog?.density??.0062;const g=d.scene.fog?.color;g&&p.uFogColor.value.set(g.r,g.g,g.b);const f=Math.hypot(i.position.x-e.x,i.position.z-e.z),m=1-T.smoothstep(f,e.r*8,e.r*24);p.uGain.value+=(y.underwater*m-p.uGain.value)*Math.min(1,h*4),s.current&&(s.current.visible=p.uGain.value>.012)}),t.jsx("mesh",{ref:s,geometry:a,frustumCulled:!1,renderOrder:2,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:wl,fragmentShader:yl,uniforms:c,transparent:!0,depthWrite:!1,side:He,blending:wt,fog:!1})})}function Ml({whirl:e,quality:o}){const n=b.useRef(),s=b.useRef(),i=be(d=>d.camera),a=b.useMemo(()=>{const d=Ds[o]??Ds.high,h=new Float32Array(d*3),p=new Float32Array(d),g=new Float32Array(d),f=new Float32Array(d),m=new Float32Array(d),l=new Float32Array(d);for(let x=0;x<d;x++)p[x]=Math.random()*Math.PI*2,g[x]=Math.random(),f[x]=.07+Math.random()*.1,m[x]=.12+Math.pow(Math.random(),1.8)*.5,l[x]=2+Math.random()*5;const u=new Lt;return u.setAttribute("position",new oe(h,3)),u.setAttribute("aAngle",new oe(p,1)),u.setAttribute("aPhase",new oe(g,1)),u.setAttribute("aRate",new oe(f,1)),u.setAttribute("aRadius",new oe(m,1)),u.setAttribute("aSize",new oe(l,1)),u.boundingSphere=new ao(new S(e.x,-60,e.z),e.r+140),u},[o,e]),c=b.useMemo(()=>({uTime:{value:0},uCentre:{value:new _n(e.x,e.z)},uR:{value:e.r},uDir:{value:e.dir},uDepth:{value:340},uColor:{value:new S(...ie(Z.underGlow))},uGain:{value:0}}),[e]);return ne((d,h)=>{const p=n.current?.uniforms;if(!p)return;p.uTime.value+=h;const g=Math.hypot(i.position.x-e.x,i.position.z-e.z),f=1-T.smoothstep(g,e.r*1.2,e.r*4);p.uGain.value=y.underwater*f,s.current&&(s.current.visible=p.uGain.value>.015)}),t.jsx("points",{ref:s,geometry:a,frustumCulled:!1,renderOrder:3,visible:!1,children:t.jsx("shaderMaterial",{ref:n,vertexShader:xl,fragmentShader:bl,uniforms:c,transparent:!0,depthWrite:!1,blending:wt,fog:!1})})}function jl({quality:e="high"}){return t.jsxs(t.Fragment,{children:[t.jsx(gl,{quality:e}),_e.map((o,n)=>t.jsx(Ml,{whirl:o,quality:e},n)),_e.map((o,n)=>t.jsx(vl,{whirl:o,quality:e},`w${n}`))]})}const qo=16/9,Da=96,Na=78;function An(e,o,n=Da){if(!o||o>=qo)return e;const s=T.degToRad(e)/2,i=2*Math.atan(Math.tan(s)*qo/o);return Math.min(n,T.radToDeg(i))}function Ha(e){return!e||e>=qo?1:T.clamp(.72+.28*(e/qo),.86,1)}function In(e,o,n,s=.06,i=Da){const a=An(o,e.aspect,i);Math.abs(e.fov-a)<=.05||(e.fov+=(a-e.fov)*(1-Math.pow(s,n)),e.updateProjectionMatrix())}function Cn(e=1){const o=typeof window<"u"&&window.innerWidth||1280;return e*T.clamp(1280/o,.55,2.2)}const _a="oni.settings.v1";function Sl(){return typeof navigator>"u"?!1:typeof window<"u"&&window.matchMedia?.("(pointer: coarse)")?.matches?!0:navigator.maxTouchPoints>0}const Me={comfort:0,lookSens:1,invertY:!1,freeCam:!1},Fn=new Set;function Ba(){for(const e of Fn)e(Me)}function Ua(e){return Fn.add(e),()=>Fn.delete(e)}function Xn(e,o){e in Me&&(Me[e]=o,Tl(),Ba())}function Jo(e){Xn(e,!Me[e])}function kl(){Xn("comfort",Me.comfort<.01?.55:Me.comfort<.9?1:0)}function zl(){const e=[.6,.85,1,1.35,1.8],o=e.findIndex(n=>n>=Me.lookSens-1e-6);Xn("lookSens",e[(o+1)%e.length])}function Tl(){try{localStorage.setItem(_a,JSON.stringify(Me))}catch{}}function El(){let e=null;try{e=JSON.parse(localStorage.getItem(_a)||"null")}catch{e=null}if(e&&typeof e=="object")for(const o of Object.keys(Me))typeof e[o]==typeof Me[o]&&(Me[o]=e[o]);else Me.comfort=Sl()?1:0;return Ba(),Me}const Le=(e,o)=>e+(o-e)*Me.comfort,co=e=>e<-1?-1:e>1?1:e,A={throttle:0,rudder:0,planes:0,boost:!1,walk:{x:0,z:0},surfaceQueued:!1,periscopeQueued:!1,burstQueued:!1,recentreQueued:!1,jumpQueued:!1,boardQueued:!1,pistolQueued:!1,bazookaQueued:!1,gigantQueued:!1,rocketQueued:!1,hakiQueued:!1,gear2Queued:!1,gatlingHeld:!1,balloonHeld:!1,zoom:0},zt={level:0},Pn=new Set;function Rl(e){return Pn.add(e),()=>Pn.delete(e)}function Qn(e){if(zt.level===e)return e;zt.level=e;for(const o of Pn)o(e);return e}function Wa(){return Qn((zt.level+1)%3)}const J={active:!1,throttle:0,rudder:0,planes:0,boost:!1,walk:{x:0,z:0},gatling:!1,balloon:!1},xo=new Set,ct=(...e)=>e.some(o=>xo.has(o));function Ya(){A.throttle=0,A.rudder=0,A.planes=0,A.boost=!1,A.walk.x=0,A.walk.z=0,A.surfaceQueued=!1,A.periscopeQueued=!1,A.burstQueued=!1,A.recentreQueued=!1,A.jumpQueued=!1,A.boardQueued=!1,A.zoom=0,A.pistolQueued=!1,A.bazookaQueued=!1,A.gigantQueued=!1,A.rocketQueued=!1,A.hakiQueued=!1,A.gear2Queued=!1,A.gatlingHeld=!1,A.balloonHeld=!1,J.gatling=!1,J.balloon=!1,Qn(0),J.throttle=0,J.rudder=0,J.planes=0,J.boost=!1,J.walk.x=0,J.walk.z=0,xo.clear()}function Al(){const e=i=>!!i&&(i.isContentEditable||/^(input|textarea|select)$/i.test(i.tagName??"")),o=i=>{if(i.metaKey||i.ctrlKey||i.altKey||e(i.target))return;const a=i.key.toLowerCase();xo.add(a),a==="f"&&(A.surfaceQueued=!0),a==="p"&&(A.periscopeQueued=!0),a==="b"&&!i.repeat&&(A.burstQueued=!0),a==="r"&&!i.repeat&&(A.recentreQueued=!0),a==="v"&&!i.repeat&&Jo("freeCam"),a==="x"&&!i.repeat&&Wa(),a===" "&&!i.repeat&&(A.jumpQueued=!0),a==="t"&&!i.repeat&&(A.boardQueued=!0),a==="j"&&!i.repeat&&(A.pistolQueued=!0),a==="k"&&!i.repeat&&(A.bazookaQueued=!0),a==="l"&&!i.repeat&&(A.gigantQueued=!0),a==="g"&&!i.repeat&&(A.rocketQueued=!0),a==="h"&&!i.repeat&&(A.hakiQueued=!0),a==="n"&&!i.repeat&&(A.gear2Queued=!0),[" ","arrowup","arrowdown","arrowleft","arrowright"].includes(a)&&i.preventDefault()},n=i=>xo.delete(i.key.toLowerCase()),s=()=>Ya();return window.addEventListener("keydown",o,{passive:!1}),window.addEventListener("keyup",n),window.addEventListener("blur",s),()=>{window.removeEventListener("keydown",o),window.removeEventListener("keyup",n),window.removeEventListener("blur",s),xo.clear()}}function Il(){const e=ct("w","arrowup")?1:0,o=ct("s","arrowdown")?1:0,n=ct("a","arrowleft")?1:0,s=ct("d","arrowright")?1:0,i=ct("q"," ")?1:0,a=ct("e","c")?1:0,c=co(e-o+J.throttle);c<-.05&&zt.level&&Qn(0),A.throttle=zt.level>0?Math.max(c,1):c,A.rudder=co(n-s+J.rudder),A.planes=co(i-a+J.planes),A.boost=ct("shift")||J.boost||zt.level===2,A.zoom=(ct("]","=","+")?1:0)-(ct("[","-","_")?1:0),A.gatlingHeld=ct("u")||J.gatling,A.balloonHeld=ct("i")||J.balloon,A.walk.x=co(s-n+J.walk.x),A.walk.z=co(e-o+J.walk.z)}const Ln=[0,(Ae[0].y+Ae[1].y)/2,Ae[0].z],Va=[he.x,he.y,he.z],en=U.dir,$a=[U.x+en[0]*300,-36,U.z+en[1]*300],Ka=[U.x+en[0]*46,34,U.z+en[1]*46],Xa=[U.gate.x,4,U.gate.z],Qa=[U.gate.x,22,U.gate.z],Cl=1.55,Gn=N/Cl,Fl=1+(Gn-1)*.35,xt=[{id:"sea",title:"THE SEA IS FOR PIRATES",sub:"Wano Country · night of the Fire Festival",dur:13,fov:52,from:[-294,31,1364],to:[-186,23,1150],lookFrom:[62,140,465],lookTo:[16,108,294],swell:1},{id:"fleet",title:"THE ALLIANCE SAILS",sub:"Nine Red Scabbards · Straw Hats · Heart · Kid · Mink · Yakuza",dur:12,fov:46,from:[304,38,1299],to:[229,31,1150],lookFrom:[121,65,760],lookTo:[62,90,577],swell:1},{id:"torii",title:"THE TORII",sub:"First line of defence — the gate at sea",dur:14,fov:58,from:[53,24,877],to:[9,62,580],lookFrom:[0,115,400],lookTo:[0,205,400],swell:.7},{id:"neck",title:"THROUGH THE GATE",sub:"The channel — the only way in",dur:12,fov:64,from:[0,36,521],to:[-22,89,198],lookFrom:[0,161,186],lookTo:[-31,326,-232],swell:.35},{id:"bay",title:"ONIGASHIMA",sub:"鬼ヶ島 — the island of demons",dur:15,fov:56,from:[-31,134,276],to:[-81,182,68],lookFrom:[0,310,-264],lookTo:Ln,swell:.12},{id:"port",title:"THE PORT",sub:"Lanterns, and a sword in the ground",dur:13,fov:48,from:[143,55,102],to:[53,43,-12],lookFrom:[-149,59,-161],lookTo:[-53,205,-276],swell:.06},{id:"backdoor",title:"THE BACK DOOR",sub:"Heart Pirates — under the maelstroms, up the hidden fjord",dur:12,fov:60,from:$a,to:Ka,lookFrom:Xa,lookTo:Qa,swell:0},{id:"face",title:"KAIDOU OF THE BEASTS",sub:"Skull Dome — the raid begins",dur:17,fov:50,from:[-149,41,40],to:[16,360,189],lookFrom:Va,lookTo:Ln,swell:0}],Pl=new Set([Ln,Va,$a,Ka,Xa,Qa]),Co=e=>Pl.has(e)?e:[e[0]*Gn,e[1]*Fl,e[2]*Gn];for(const e of xt)e.from=Co(e.from),e.to=Co(e.to),e.lookFrom=Co(e.lookFrom),e.lookTo=Co(e.lookTo);const On=xt.reduce((e,o)=>e+o.dur,0),Hs=xt,Ll=e=>e*e*(3-2*e),Gl=e=>1-Math.pow(1-e,2.2),Fo=e=>new S(e[0],e[1],e[2]),Ct={dist:[24,3600],pitch:[-.95,1.44],y:[-260,1500],xz:4200};function Ol(e,o){b.useEffect(()=>{if(!e)return;const n=o.domElement,s=new Map;let i=0,a=null;const c=(f,m)=>{const l=y.orbit,u=l.dist*.0016,x=Math.cos(l.yaw),v=-Math.sin(l.yaw);l.target.x-=x*f*u,l.target.z-=v*f*u;const w=Math.cos(l.pitch),k=Math.sin(l.pitch);l.target.y+=m*u*w,l.target.x+=Math.sin(l.yaw)*m*u*k,l.target.z+=Math.cos(l.yaw)*m*u*k,Za()},d=f=>{s.set(f.pointerId,{x:f.clientX,y:f.clientY});try{n.setPointerCapture?.(f.pointerId)}catch{}if(s.size===2){const[m,l]=[...s.values()];i=Math.hypot(m.x-l.x,m.y-l.y),a={x:(m.x+l.x)/2,y:(m.y+l.y)/2}}},h=f=>{const m=s.get(f.pointerId);if(!m)return;const l=f.clientX-m.x,u=f.clientY-m.y;if(m.x=f.clientX,m.y=f.clientY,s.size>=2){const[x,v]=[...s.values()],w=Math.hypot(x.x-v.x,x.y-v.y),k={x:(x.x+v.x)/2,y:(x.y+v.y)/2};if(i>8&&w>8){const z=y.orbit;z.dist=T.clamp(z.dist*(i/w),...Ct.dist)}a&&c(k.x-a.x,k.y-a.y),i=w,a=k,f.cancelable&&f.preventDefault();return}if(f.shiftKey||f.buttons===4)c(l,u);else{const x=y.orbit;x.yaw-=l*.005*Cn(),x.pitch=T.clamp(x.pitch+u*.004*Cn(),...Ct.pitch)}f.cancelable&&f.preventDefault()},p=f=>{s.delete(f.pointerId)&&s.size<2&&(i=0,a=null)},g=f=>{f.preventDefault();const m=y.orbit;m.dist=T.clamp(m.dist*(1+Math.sign(f.deltaY)*.11),...Ct.dist)};return n.addEventListener("pointerdown",d),n.addEventListener("pointermove",h,{passive:!1}),n.addEventListener("pointerup",p),n.addEventListener("pointercancel",p),window.addEventListener("pointerup",p),n.addEventListener("wheel",g,{passive:!1}),()=>{n.removeEventListener("pointerdown",d),n.removeEventListener("pointermove",h),n.removeEventListener("pointerup",p),n.removeEventListener("pointercancel",p),window.removeEventListener("pointerup",p),n.removeEventListener("wheel",g),s.clear()}},[e,o])}function Za(){const e=y.orbit;e.target.x=T.clamp(e.target.x,-4200,Ct.xz),e.target.z=T.clamp(e.target.z,-4200,Ct.xz),e.target.y=T.clamp(e.target.y,...Ct.y)}function Dl({onRails:e,playing:o,speed:n=1,onShot:s,idle:i=!1}){const a=be(g=>g.camera),c=be(g=>g.gl),d=b.useRef(0),h=b.useRef(-1),p=b.useRef(new S(0,150,-260));return Ol(!e&&!i,c),b.useEffect(()=>{if(e)return;const g=y.orbit,f=a.position.clone().sub(g.target);g.dist=T.clamp(f.length(),...Ct.dist),g.yaw=Math.atan2(f.x,f.z),g.pitch=Math.asin(T.clamp(f.y/(f.length()||1),-1,1))},[e,a]),ne((g,f)=>{if(i)return;const m=Math.min(f,.05);if(y.t+=m,e){if(y.jumpTo!=null){let R=0;for(let I=0;I<y.jumpTo&&I<xt.length;I++)R+=xt[I].dur;d.current=R,y.jumpTo=null}o&&(d.current=(d.current+m*n)%On);let w=0,k=0;for(;k<xt.length&&!(d.current<w+xt[k].dur);k++)w+=xt[k].dur;const z=xt[Math.min(k,xt.length-1)],r=T.clamp((d.current-w)/z.dur,0,1);h.current!==k&&(h.current=k,y.shot=k,s?.(k,z));const M=Fo(z.from).lerp(Fo(z.to),Gl(r)),F=Fo(z.lookFrom).lerp(Fo(z.lookTo),Ll(r)),C=z.swell??0;if(C>0){const R=y.t;M.y+=Math.sin(R*.62)*3.1*C+Math.sin(R*1.31+1.2)*1.2*C,M.x+=Math.sin(R*.44+.6)*2.2*C}M.x+=Math.sin(y.t*.83)*.35,M.y+=Math.sin(y.t*1.17+2)*.28,a.position.copy(M),p.current.lerp(F,1-Math.pow(1e-4,m)),a.lookAt(p.current),C>0&&a.rotateZ(Math.sin(y.t*.51)*.024*C);const j=An(z.fov,a.aspect);Math.abs(a.fov-j)>.01&&(a.fov+=(j-a.fov)*(1-Math.pow(.02,m)),a.updateProjectionMatrix()),y.progress=d.current/On}else{const w=y.orbit;A.recentreQueued&&(A.recentreQueued=!1,w.target.set(L.x,L.baseY*.55,L.z),w.dist=T.clamp(w.dist,260,1400));const k=A.walk.x,z=A.walk.z;if(k||z||A.planes||A.zoom){const F=w.dist*(A.boost?1.9:.7)*m,C=-Math.sin(w.yaw),j=-Math.cos(w.yaw);w.target.x+=(C*z-j*k)*F,w.target.z+=(j*z+C*k)*F,w.target.y+=A.planes*F,w.dist=T.clamp(w.dist*(1-A.zoom*.9*m),...Ct.dist),Za()}const r=Math.cos(w.pitch);a.position.set(w.target.x+Math.sin(w.yaw)*r*w.dist,w.target.y+Math.sin(w.pitch)*w.dist,w.target.z+Math.cos(w.yaw)*r*w.dist),a.lookAt(w.target);const M=An(55,a.aspect);Math.abs(a.fov-M)>.01&&(a.fov+=(M-a.fov)*(1-Math.pow(.02,m)),a.updateProjectionMatrix()),y.t+=0}const l=wo(a.position.x,a.position.z);y.shelter+=(l-y.shelter)*(1-Math.pow(.06,m)),y.fog=T.lerp(Ft.sea,Ft.bay,y.shelter),y.rain=1-y.shelter*.92;const u=ut(a.position.x,a.position.z,y.t,1),x=T.clamp((u.y-a.position.y-1)/3,0,1);y.underwater+=(x-y.underwater)*(1-Math.pow(.002,m)),y.depthBelow=Math.max(0,u.y-a.position.y);const v=T.lerp(8200,1700,y.underwater);Math.abs(a.far-v)>20&&(a.far=v,a.updateProjectionMatrix()),g.camera.updateMatrixWorld()}),null}const _s={low:[24,16],mid:[40,26],high:[56,36]};function Nl({quality:e="high",shadows:o=!0}){const n=b.useRef(),s=b.useRef(),i=b.useMemo(()=>{const[m,l]=_s[e]??_s.high,u=new mr(1,m,l),x=u.attributes.position,v=new Float32Array(x.count*3),[w,k,z]=Ce.centre,[r,M,F]=Ce.radii,C=new ve("#241c22"),j=new ve(E.rockWarm),R=new ve;for(let I=0;I<x.count;I++){const B=x.getX(I),G=x.getY(I),$=x.getZ(I),q=1+(qt(B*2.4+5,$*2.4-9,3)-.5)*.14;x.setXYZ(I,w+B*r*q,k+G*M*q,z+$*F*q);const ee=T.clamp((G+.2)/1.2,0,1);R.copy(C).lerp(j,(1-ee)*.55),v[I*3]=R.r,v[I*3+1]=R.g,v[I*3+2]=R.b}return u.setAttribute("color",new oe(v,3)),u.computeVertexNormals(),u},[e]),{stairM:a,brazierM:c,bayM:d,tableM:h,jarM:p,westStairM:g}=b.useMemo(()=>{const m=new rt,l=new mt,u=new S(1,1,1),x=new S,v=[];for(let P=0;P<lt.steps;P++){const K=P/(lt.steps-1);x.set(0,T.lerp(Ge.y,le.y+2,K),T.lerp(lt.zTop,lt.zBottom,K)),l.identity(),v.push(m.clone().compose(x,l,u))}const w=[],k=e==="low"?5:9;for(const P of[-1,1])for(let K=0;K<k;K++){const ae=K/(k-1);x.set(P*176,le.y+9,T.lerp(le.zFront-40,le.zBack+40,ae)),l.identity(),w.push(m.clone().compose(x,l,u))}for(let P=0;P<6;P++)x.set(-110+P*44,le.y+9,D.z+D.halfZ+54),l.identity(),w.push(m.clone().compose(x,l,u));const z=[],r=e==="low"?5:9;for(const P of[-1,1])for(let K=0;K<xe.tiers;K++)for(let ae=0;ae<r;ae++){const H=ae/(r-1);x.set(P*(xe.x-K*26),xe.y+K*xe.tierRise,T.lerp(-205,xe.halfZ,H)),l.identity(),z.push(m.clone().compose(x,l,u))}const M=[],F=[],C=new mt,j=new S(0,1,0);let R=24301;const I=()=>(R=Math.imul(R,1664525)+1013904223>>>0,R/4294967296),B=e==="low"?1:2,G=e==="low"?5:8;for(const P of[-1,1])for(let K=0;K<B;K++)for(let ae=0;ae<G;ae++){const H=P*(96+K*52+(I()-.5)*14),te=T.lerp(le.zBack+120,le.zFront-60,ae/(G-1))+(I()-.5)*16;if(!(Math.abs(H)<ze.halfX+24&&Math.abs(te-ze.z)<ze.halfZ+20)&&!(Math.abs(Math.abs(H)-me.x)<26&&te<me.zFoot+16&&te>me.zTop-8)){x.set(H,le.y+2.4,te),C.setFromAxisAngle(j,(I()-.5)*.5),M.push(m.clone().compose(x,C,u));for(let we=0;we<2;we++)x.set(H+(I()-.5)*30,le.y+3.5,te+(I()>.5?8:-8)+(I()-.5)*6),C.setFromAxisAngle(j,I()*Math.PI),F.push(m.clone().compose(x,C,u))}}const $=[],q=16,ee=P=>P*P*(3-2*P);for(let P=0;P<=q;P++){const K=P/q;x.set(-252,ee(K)*(xe.y-.5)-1.3,T.lerp(45,-45,K)),l.identity(),$.push(m.clone().compose(x,l,u))}return{stairM:v,brazierM:w,bayM:z,tableM:M,jarM:F,westStairM:$}},[e]);ne(()=>{const m=y.t;n.current&&(n.current.material.emissiveIntensity=2.6+Math.sin(m*4.1)*.3+Math.sin(m*9.3)*.15),s.current&&(s.current.material.emissiveIntensity=.85+Math.sin(m*.9)*.12)});const f=o;return t.jsxs("group",{children:[t.jsx("mesh",{geometry:i,side:vn,receiveShadow:f,frustumCulled:!1,children:t.jsx("meshStandardMaterial",{vertexColors:!0,side:vn,roughness:.97,metalness:.02})}),[[0,(le.zFront+ze.z+ze.halfZ)/2,le.halfX*2,le.zFront-ze.z-ze.halfZ],[0,(le.zBack+ze.z-ze.halfZ)/2,le.halfX*2,ze.z-ze.halfZ-le.zBack],[-342/2-20,ze.z,le.halfX*2-ze.halfX*2,ze.halfZ*2],[(ze.halfX+le.halfX)/2+20,ze.z,le.halfX*2-ze.halfX*2,ze.halfZ*2]].map(([m,l,u,x],v)=>t.jsxs("mesh",{position:[m,le.y-3,l],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[Math.abs(u),6,Math.abs(x)]}),t.jsx("meshStandardMaterial",{color:"#4b3a2c",roughness:.93})]},v)),t.jsxs("mesh",{ref:s,position:[ze.x,Qe.ceiling+2,ze.z],rotation:[-Math.PI/2,0,0],children:[t.jsx("planeGeometry",{args:[ze.halfX*2,ze.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#7fd6a0",emissive:"#2f8f5c",emissiveIntensity:.85,toneMapped:!1,side:He})]}),t.jsxs("mesh",{position:[0,Ge.y-4,Ge.z],receiveShadow:f,castShadow:f,children:[t.jsx("boxGeometry",{args:[Ge.halfX*2.6,8,Ge.depth]}),t.jsx("meshStandardMaterial",{color:"#3f3126",roughness:.94})]}),t.jsxs("instancedMesh",{ref:null,args:[null,null,a.length],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[lt.halfX*2,3.2,6.4]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(Hl,{matrices:a})]}),[-1,1].map(m=>Array.from({length:xe.tiers},(l,u)=>t.jsxs("mesh",{position:[m*(xe.x-u*26),xe.y+u*xe.tierRise-4,0],receiveShadow:f,castShadow:f,children:[t.jsx("boxGeometry",{args:[76-u*6,7,xe.halfZ*2+40]}),t.jsx("meshStandardMaterial",{color:E.timber,roughness:.92})]},`${m}-${u}`))),t.jsxs("instancedMesh",{args:[null,null,d.length],children:[t.jsx("boxGeometry",{args:[3,15,22]}),t.jsx("meshStandardMaterial",{color:"#e8c98d",emissive:E.lanternFar,emissiveIntensity:1.05,roughness:.9}),t.jsx(Wl,{matrices:d})]}),t.jsxs("instancedMesh",{args:[null,null,h.length],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[30,4.4,10]}),t.jsx("meshStandardMaterial",{color:"#5c3f28",roughness:.9}),t.jsx(_l,{matrices:h})]}),t.jsxs("instancedMesh",{args:[null,null,p.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[2.6,3.2,7,8]}),t.jsx("meshStandardMaterial",{color:"#b8a06a",roughness:.85}),t.jsx(Bl,{matrices:p})]}),t.jsxs("instancedMesh",{args:[null,null,g.length],castShadow:f,receiveShadow:f,children:[t.jsx("boxGeometry",{args:[74,2.6,6.4]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(Ul,{matrices:g})]}),t.jsxs("instancedMesh",{args:[null,null,c.length],castShadow:f,children:[t.jsx("cylinderGeometry",{args:[7,4.5,12,8]}),t.jsx("meshStandardMaterial",{color:"#22201f",roughness:.7,metalness:.5}),t.jsx(Yl,{matrices:c})]}),t.jsxs("instancedMesh",{ref:n,args:[null,null,c.length],children:[t.jsx("sphereGeometry",{args:[5.4,8,6]}),t.jsx("meshStandardMaterial",{color:E.furnace,emissive:E.ember,emissiveIntensity:2.6,toneMapped:!1}),t.jsx(Vl,{matrices:c})]}),t.jsxs("mesh",{position:[0,Qe.y-4,0],receiveShadow:f,children:[t.jsx("boxGeometry",{args:[Qe.halfX*2,8,Qe.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#2a2622",roughness:.96})]}),[-1,1].map(m=>[-1,0,1].map(l=>t.jsxs("mesh",{position:[m*120,(Qe.y+le.y)/2,l*96],castShadow:f,children:[t.jsx("boxGeometry",{args:[26,Math.abs(le.y-Qe.y),26]}),t.jsx("meshStandardMaterial",{color:Z.rock,roughness:.95})]},`${m}-${l}`)))]})}function Hl({matrices:e}){const o=b.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function _l({matrices:e}){const o=b.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Bl({matrices:e}){const o=b.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Ul({matrices:e}){const o=b.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Wl({matrices:e}){const o=b.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Yl({matrices:e}){const o=b.useRef();return t.jsx(_t,{matrices:e,selfRef:o})}function Vl({matrices:e}){const o=b.useRef();return t.jsx(_t,{matrices:e,selfRef:o,offsetY:9})}function _t({matrices:e,offsetY:o=0}){const n=b.useRef(),s=b.useRef(!1);return ne(()=>{if(s.current)return;const i=n.current?.parent;if(!i?.isInstancedMesh)return;const a=new rt,c=new rt().makeTranslation(0,o,0);for(let d=0;d<Math.min(e.length,i.count);d++)a.copy(e[d]).multiply(c),i.setMatrixAt(d,a);i.instanceMatrix.needsUpdate=!0,i.computeBoundingSphere(),s.current=!0}),t.jsx("object3D",{ref:n})}const Bs=(()=>{if(typeof document>"u")return null;const e=256,o=128,n=document.createElement("canvas");n.width=e,n.height=o;const s=n.getContext("2d"),i=s.createRadialGradient(e/2,o*.62,8,e/2,o*.62,e*.62);i.addColorStop(0,"#fff3c4"),i.addColorStop(.32,"#ffc95e"),i.addColorStop(.66,"#e06120"),i.addColorStop(1,"#7e1c14"),s.fillStyle=i,s.fillRect(0,0,e,o),s.globalAlpha=.14,s.fillStyle="#fff3c4";for(let c=0;c<12;c++){const d=c/12*Math.PI*2;s.save(),s.translate(e/2,o*.62),s.rotate(d),s.fillRect(-3,0,6,e),s.restore()}s.globalAlpha=.22,s.fillStyle="#5e1610";for(let c=8;c<e;c+=22)s.fillRect(c,0,3,o);s.globalAlpha=1;const a=new no(n);return a.colorSpace=so,a})();function $l(e,o,n,s){const i=e+s,a=o+s,c=new Float32Array([-i,0,a,i,0,a,e*.18,n,o*.18,-i,0,a,e*.18,n,o*.18,-e*.18,n,o*.18,i,0,a,i,0,-a,e*.18,n,-o*.18,i,0,a,e*.18,n,-o*.18,e*.18,n,o*.18,i,0,-a,-i,0,-a,-e*.18,n,-o*.18,i,0,-a,-e*.18,n,-o*.18,e*.18,n,-o*.18,-i,0,-a,-i,0,a,-e*.18,n,o*.18,-i,0,-a,-e*.18,n,o*.18,-e*.18,n,-o*.18]),d=new Lt;return d.setAttribute("position",new oe(c,3)),d.computeVertexNormals(),d}function Kl({quality:e="high",shadows:o=!0}){const n=b.useRef(),s=b.useRef(),i=ot("keep-hf.opt.glb"),a=b.useMemo(()=>{const d=[];for(let h=0;h<D.storeys;h++){const p=1-(h+1)*D.taper,g=D.plinth+h*D.storey;d.push({i:h,y:g,halfX:D.halfX*p,halfZ:D.halfZ*p,roof:$l(D.halfX*p,D.halfZ*p,h===D.storeys-1?30:16,11)})}return d},[]);ne(()=>{const d=y.t;n.current&&(n.current.material.emissiveIntensity=2.2+Math.sin(d*2.2)*.3),s.current&&(s.current.material.emissiveIntensity=2.3+Math.sin(d*3.3)*.25)});const c=o;return t.jsxs("group",{position:[0,D.baseY,D.z],children:[t.jsxs("mesh",{position:[0,D.plinth/2,0],castShadow:c,receiveShadow:c,children:[t.jsx("boxGeometry",{args:[D.halfX*2.2,D.plinth,D.halfZ*2.2]}),t.jsx("meshStandardMaterial",{color:"#4a4640",roughness:.96})]}),i&&t.jsx(ge,{name:"keep-hf.opt.glb",height:D.plinth+D.storeys*D.storey+26,position:[0,D.plinth*.5,0],tint:"#9a8468",emissive:E.emberDeep,emissiveIntensity:.14}),!i&&a.map(d=>t.jsxs("group",{position:[0,d.y,0],children:[t.jsxs("mesh",{position:[0,D.storey/2,0],castShadow:c,receiveShadow:c,children:[t.jsx("boxGeometry",{args:[d.halfX*2,D.storey,d.halfZ*2]}),t.jsx("meshStandardMaterial",{color:"#d8cdb6",roughness:.9})]}),t.jsxs("mesh",{position:[0,D.storey*.55,d.halfZ+.6],children:[t.jsx("planeGeometry",{args:[d.halfX*1.75,D.storey*.38]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:1.5,toneMapped:!1})]}),t.jsxs("mesh",{position:[0,D.storey*.02,d.halfZ+8],castShadow:c,children:[t.jsx("boxGeometry",{args:[d.halfX*2+20,3,2.4]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.72})]}),t.jsxs("mesh",{position:[0,D.storey-1.4,0],children:[t.jsx("boxGeometry",{args:[d.halfX*2+3,1.6,d.halfZ*2+3]}),t.jsx("meshStandardMaterial",{color:"#c9a227",roughness:.4,metalness:.7})]}),t.jsx("mesh",{geometry:d.roof,position:[0,D.storey,0],castShadow:c,receiveShadow:c,children:t.jsx("meshStandardMaterial",{color:"#2e3038",roughness:.72,metalness:.14,flatShading:!0})})]},d.i)),[-1,1].map(d=>t.jsxs("mesh",{position:[d*14,D.plinth+D.storeys*D.storey+30,0],rotation:[0,0,d*.4],castShadow:c,children:[t.jsx("coneGeometry",{args:[5,15,5]}),t.jsx("meshStandardMaterial",{color:"#c9a227",roughness:.35,metalness:.85})]},d)),t.jsxs("group",{position:[0,Re.y,Re.z-D.z],children:[t.jsxs("mesh",{castShadow:c,receiveShadow:c,children:[t.jsx("boxGeometry",{args:[Re.halfX*2,7,Re.depth]}),t.jsx("meshStandardMaterial",{color:"#3a2a1e",roughness:.9})]}),t.jsxs("mesh",{ref:n,position:[0,26,-40/2],children:[t.jsx("planeGeometry",{args:[Re.halfX*2,48]}),t.jsx("meshStandardMaterial",{color:E.furnace,emissive:"#ffffff",emissiveMap:Bs,map:Bs,emissiveIntensity:2.2,toneMapped:!1,side:He})]}),t.jsx(ge,{name:"oni-throne.opt.glb",height:ce("oni-throne.opt.glb"),position:[0,3.5,-8],rotation:0,tint:"#8a7f78",emissive:"#2a0e0a",emissiveIntensity:.25,fallback:t.jsxs("group",{position:[0,3.5,-8],scale:ce("oni-throne.opt.glb")/38,children:[t.jsxs("mesh",{position:[0,6,0],castShadow:c,children:[t.jsx("boxGeometry",{args:[18,12,14]}),t.jsx("meshStandardMaterial",{color:"#1c1a20",roughness:.6,metalness:.5})]}),t.jsxs("mesh",{position:[0,10.5,0],children:[t.jsx("boxGeometry",{args:[14,3,11]}),t.jsx("meshStandardMaterial",{color:"#6e1712",roughness:.9})]}),t.jsxs("mesh",{position:[0,20,-5],castShadow:c,children:[t.jsx("boxGeometry",{args:[16,20,3.4]}),t.jsx("meshStandardMaterial",{color:"#221e26",roughness:.6,metalness:.5})]}),[-1,1].map(d=>t.jsxs("mesh",{position:[d*8,32,-5],rotation:[0,0,d*-.55],castShadow:c,children:[t.jsx("coneGeometry",{args:[2.2,12,6]}),t.jsx("meshStandardMaterial",{color:"#d8cbb2",roughness:.55})]},d))]})}),t.jsx(ge,{name:"kagura-stage.opt.glb",height:ce("kagura-stage.opt.glb"),position:[0,3.5,-15],rotation:Math.PI,tint:"#c9743a",emissive:E.emberDeep,emissiveIntensity:.3,fallback:null}),[-1,1].map(d=>t.jsxs("mesh",{position:[d*Re.halfX*.9,28,Re.depth/2-4],castShadow:c,children:[t.jsx("cylinderGeometry",{args:[3.4,4,52,8]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.7})]},d)),t.jsxs("mesh",{position:[0,56,0],castShadow:c,children:[t.jsx("boxGeometry",{args:[Re.halfX*2.3,5,Re.depth+22]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.72})]}),[-1,1].map(d=>t.jsx(ge,{name:"oni-daiko.opt.glb",height:ce("oni-daiko.opt.glb"),position:[d*(Re.halfX-22),4,4],rotation:d*.4,tint:"#c98a5a",fallback:t.jsx("group",{position:[0,ce("oni-daiko.opt.glb")/2,0],rotation:[0,0,Math.PI/2],scale:ce("oni-daiko.opt.glb")/22,children:t.jsxs("mesh",{castShadow:c,children:[t.jsx("cylinderGeometry",{args:[11,11,15,14]}),t.jsx("meshStandardMaterial",{color:"#8e2118",roughness:.7})]})})},d))]}),t.jsxs("instancedMesh",{ref:s,args:[null,null,18],children:[t.jsx("cylinderGeometry",{args:[3.4,3.4,6,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.3,toneMapped:!1}),t.jsx(Xl,{})]})]})}function Xl(){const e=b.useRef(),o=b.useRef(!1);return ne(()=>{if(o.current)return;const n=e.current?.parent;if(!n?.isInstancedMesh)return;const s=new rt,i=new S,a=new mt,c=new S(1,1,1);for(let d=0;d<n.count;d++){const h=d/(n.count-1)*2-1;i.set(h*(D.halfX+26),Re.y+74-(1-h*h)*20,D.halfZ+22),n.setMatrixAt(d,s.compose(i,a,c))}n.instanceMatrix.needsUpdate=!0,n.computeBoundingSphere(),o.current=!0}),t.jsx("object3D",{ref:e})}function Ql({shadows:e=!0}){const{slabs:o,flights:n,tower:s}=ka,i=b.useMemo(()=>{const a=[],c=d=>d*d*(3-2*d);for(const d of n)for(let p=0;p<=9;p++){const g=p/9;a.push([(d.x0+d.x1)/2,d.y0+(d.y1-d.y0)*c(g)-1.2,T.lerp(d.z0,d.z1,g)])}return a},[n]);return t.jsxs("group",{children:[[s.x[0]+1,s.x[1]-1].map(a=>[s.z[0]+1,s.z[1]-1].map(c=>t.jsxs("mesh",{position:[a,128,c],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[2.2,3,256,6]}),t.jsx("meshStandardMaterial",{color:"#33261a",roughness:.92})]},`${a}${c}`))),t.jsxs("instancedMesh",{args:[null,null,i.length],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[9,2.4,5.6]}),t.jsx("meshStandardMaterial",{color:"#5a4736",roughness:.92}),t.jsx(Zl,{points:i})]}),o.map(([a,c,d,h,p],g)=>t.jsxs("mesh",{position:[a,c-1.6,d],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[Math.abs(h),3.2,Math.abs(p)]}),t.jsx("meshStandardMaterial",{color:"#4b3a2c",roughness:.93})]},g)),o.map(([a,c,d,h,p],g)=>t.jsxs("mesh",{position:[a,c+5,d+Math.abs(p)/2-1],children:[t.jsx("boxGeometry",{args:[Math.abs(h),1.6,1.2]}),t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})]},`r${g}`))]})}function Zl({points:e}){const o=b.useRef(),n=b.useRef(!1);return ne(()=>{if(n.current)return;const s=o.current?.parent;if(!s?.isInstancedMesh)return;const i=new rt,a=new mt,c=new S(1,1,1),d=new S;for(let h=0;h<Math.min(e.length,s.count);h++)d.set(e[h][0],e[h][1],e[h][2]),s.setMatrixAt(h,i.compose(d,a,c));s.instanceMatrix.needsUpdate=!0,s.computeBoundingSphere(),n.current=!0}),t.jsx("object3D",{ref:o})}function ql({shadows:e=!0}){const o=b.useMemo(()=>{const n=[],i=a=>a*a*(3-2*a);for(const a of[-1,1])for(let c=0;c<=20;c++){const d=c/20;n.push({x:a*me.x,y:i(d)*It,z:T.lerp(me.zFoot,me.zTop,d)})}return n},[]);return t.jsxs("group",{children:[o.map((n,s)=>t.jsxs("mesh",{position:[n.x,n.y-1.4,n.z],castShadow:e,receiveShadow:e,children:[t.jsx("boxGeometry",{args:[me.halfW*2,2.8,9]}),t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.75})]},s)),[-1,1].map(n=>{const s=a=>a*a*(3-2*a),i=a=>{const c=[];for(let d=0;d<=16;d++){const h=d/16;c.push(new S(n*me.x+a,s(h)*It+7,T.lerp(me.zFoot,me.zTop,h)))}return new oo(new to(c),24,1.1,4,!1)};return t.jsxs("group",{children:[t.jsx("mesh",{geometry:i(-15),castShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})}),t.jsx("mesh",{geometry:i(me.halfW+1),castShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})})]},n)})]})}function Jl({shadows:e=!0}){const o=b.useMemo(()=>zo.map(([,,n,s])=>{const i=[];for(let a=0;a<=12;a++){const c=a/12*2-1;i.push(new S(c*n*.5,s*(1-c*c),0))}return new oo(new to(i),26,4.6,4,!1)}),[]);return t.jsxs(t.Fragment,{children:[zo.map(([n,s],i)=>t.jsxs("group",{position:[0,n,s],children:[t.jsx("mesh",{geometry:o[i],castShadow:e,receiveShadow:e,children:t.jsx("meshStandardMaterial",{color:E.vermilion,roughness:.74})}),[-7,7].map(a=>t.jsx("mesh",{geometry:o[i],position:[0,7,a],scale:[1,1,.3],children:t.jsx("meshStandardMaterial",{color:E.vermilionDeep,roughness:.8})},a))]},i)),[-1,0,1].map(n=>t.jsxs("mesh",{position:[n*70,zo[0][0]-12,zo[0][1]],children:[t.jsx("cylinderGeometry",{args:[4,4,7,8]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:2.4,toneMapped:!1})]},n)),t.jsx("group",{position:[0,le.y,0]})]})}function qa(e){let o=e>>>0;return()=>(o=Math.imul(o,1664525)+1013904223>>>0,o/4294967296)}function ec({quality:e,shadows:o}){const n=b.useMemo(()=>{const i=qa(712273),a=[],c=e==="low"?34:e==="mid"?68:108;let d=0;for(;a.length<c&&d<c*40;){d++;const h=(i()*2-1)*(le.halfX-30),p=T.lerp(le.zBack+40,le.zFront-30,i());Math.abs(h)<62&&p>D.z+120||Math.abs(h)<70&&Math.abs(p-84)<58||Math.abs(Math.abs(h)-me.x)<24&&p<me.zFoot+18&&p>me.zTop-10||a.push({x:h,z:p,kind:a.length%4,rot:i()*Math.PI*2,k:.82+i()*.5})}return a},[e]),s=o;return t.jsx(t.Fragment,{children:n.map((i,a)=>{const c=[i.x,le.y,i.z];if(i.kind===0){const h=ce("sake-tower.opt.glb")*i.k,p=h*.24;return t.jsx(ge,{name:"sake-tower.opt.glb",height:h,position:c,rotation:i.rot,tint:"#c9b48a",fallback:t.jsx("group",{position:c,children:[0,1,2].map(g=>t.jsxs("mesh",{position:[0,h*(.17+g*.3),0],castShadow:s,children:[t.jsx("cylinderGeometry",{args:[p-g*p*.16,p-g*p*.16,h*.29,10]}),t.jsx("meshStandardMaterial",{color:g%2?"#c9a86a":"#8e6a3c",roughness:.92})]},g))})},a)}if(i.kind===1){const h=ce("oni-guardian.opt.glb")*i.k;return t.jsx(ge,{name:"oni-guardian.opt.glb",height:h,position:c,rotation:i.rot,tint:"#9a9488",fallback:t.jsxs("group",{position:c,children:[t.jsxs("mesh",{position:[0,h*.17,0],castShadow:s,children:[t.jsx("boxGeometry",{args:[h*.43,h*.33,h*.43]}),t.jsx("meshStandardMaterial",{color:"#4a4a52",roughness:.95})]}),t.jsxs("mesh",{position:[0,h*.6,0],castShadow:s,children:[t.jsx("capsuleGeometry",{args:[h*.2,h*.33,4,8]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]}),[-1,1].map(p=>t.jsxs("mesh",{position:[p*h*.13,h*.93,0],rotation:[0,0,p*.5],castShadow:s,children:[t.jsx("coneGeometry",{args:[h*.067,h*.27,5]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]},p))]})},a)}if(i.kind===2){const h=ce("wisteria-trellis.opt.glb")*i.k;return t.jsx(ge,{name:"wisteria-trellis.opt.glb",height:h,position:c,rotation:i.rot,tint:"#b39ad8",fallback:t.jsxs("group",{position:c,children:[t.jsxs("mesh",{position:[0,h*.94,0],castShadow:s,children:[t.jsx("boxGeometry",{args:[h*.7,h*.07,h*.07]}),t.jsx("meshStandardMaterial",{color:"#3a2a1c",roughness:.94})]}),[-.26,-.09,.09,.26].map(p=>t.jsxs("mesh",{position:[p*h,h*.47,0],children:[t.jsx("coneGeometry",{args:[h*.1,h*.88,6]}),t.jsx("meshStandardMaterial",{color:"#9d7fd0",roughness:.95,emissive:"#6b4fa0",emissiveIntensity:.22})]},p))]})},a)}const d=Ui*4*i.k;return t.jsxs("group",{position:c,rotation:[0,i.rot,0],children:[t.jsxs("mesh",{position:[0,d/2,0],castShadow:s,children:[t.jsx("cylinderGeometry",{args:[d*.021,d*.021,d,6]}),t.jsx("meshStandardMaterial",{color:"#2f2118",roughness:.92})]}),t.jsxs("mesh",{position:[d*.12,d*.65,0],children:[t.jsx("planeGeometry",{args:[d*.235,d*.7]}),t.jsx("meshStandardMaterial",{color:a%2?E.vermilion:"#e8dcc4",roughness:.95,side:He,emissive:a%2?E.vermilionDeep:"#8a8272",emissiveIntensity:.28})]})]},a)})})}function tc({shadows:e}){const o=b.useMemo(()=>{const n=qa(10560325),s=[];for(let i=0;i<52;i++)s.push({x:(n()*2-1)*(Qe.halfX-40),z:(n()*2-1)*(Qe.halfZ-40),rot:n()*Math.PI*2,keg:i%2===0});return s},[]);return t.jsx(t.Fragment,{children:o.map((n,s)=>n.keg?t.jsx(ge,{name:"powder-keg.opt.glb",height:ce("powder-keg.opt.glb"),position:[n.x,Qe.y,n.z],rotation:n.rot,tint:"#6a6a72",fallback:t.jsxs("mesh",{position:[n.x,Qe.y+ce("powder-keg.opt.glb")*.5,n.z],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[ce("powder-keg.opt.glb")*.4,ce("powder-keg.opt.glb")*.4,ce("powder-keg.opt.glb"),10]}),t.jsx("meshStandardMaterial",{color:"#1a1a20",roughness:.6,metalness:.4})]})},s):t.jsx(ge,{name:"war-cannon.opt.glb",height:ce("war-cannon.opt.glb"),position:[n.x,Qe.y,n.z],rotation:n.rot,tint:"#7a7068",fallback:t.jsxs("mesh",{position:[n.x,Qe.y+ce("war-cannon.opt.glb")*.42,n.z],rotation:[0,n.rot,Math.PI/2],castShadow:e,children:[t.jsx("cylinderGeometry",{args:[ce("war-cannon.opt.glb")*.18,ce("war-cannon.opt.glb")*.23,ce("war-cannon.opt.glb")*1.9,8]}),t.jsx("meshStandardMaterial",{color:"#15181f",roughness:.45,metalness:.7})]})},s))})}function oc(){const e=be(o=>o.camera);return ne((o,n)=>{const s=Math.min(n,.05),i=(e.position.x-pe.x-Ce.centre[0])/Ce.radii[0],a=(e.position.y-pe.y-Ce.centre[1])/Ce.radii[1],c=(e.position.z-pe.z-Ce.centre[2])/Ce.radii[2],d=Math.sqrt(i*i+a*a+c*c),h=T.clamp(1-(d-1)/.5,0,1);y.inside+=(h-y.inside)*(1-Math.pow(.02,s))}),null}function nc({quality:e="high",shadows:o=!0}){return t.jsxs("group",{position:[pe.x,pe.y,pe.z],children:[t.jsx(oc,{}),t.jsx(Nl,{quality:e,shadows:o}),t.jsx(Kl,{quality:e,shadows:o}),t.jsx(Jl,{shadows:o}),t.jsx(ql,{shadows:o}),t.jsx(Ql,{shadows:o}),t.jsx(ec,{quality:e,shadows:o}),t.jsx(tc,{shadows:o}),[-1,1].flatMap(n=>[0,1,2,3,4].map(s=>t.jsx(ge,{name:"banquet-table.opt.glb",height:ce("banquet-table.opt.glb"),position:[n*(74+s%2*22),le.y,D.z+186+s*34],rotation:n*.35+Math.PI/2,tint:"#a98c66",fallback:null},`bq-${n}-${s}`))),t.jsx(ge,{name:"treasure-kura.opt.glb",height:ce("treasure-kura.opt.glb"),position:[xe.x-74,le.y,D.z+96],rotation:-.7,tint:"#b8ab98",emissive:"#141018",emissiveIntensity:.1,fallback:t.jsx("group",{position:[xe.x-74,le.y,D.z+96],rotation:[0,-.7,0],children:(()=>{const n=ce("treasure-kura.opt.glb");return t.jsxs(t.Fragment,{children:[[-1,1].map(s=>[-1,1].map(i=>t.jsxs("mesh",{position:[s*n*.3,n*.08,i*n*.22],castShadow:o,children:[t.jsx("boxGeometry",{args:[n*.1,n*.16,n*.1]}),t.jsx("meshStandardMaterial",{color:"#3a2d20",roughness:.92})]},`${s}${i}`))),t.jsxs("mesh",{position:[0,n*.34,0],castShadow:o,children:[t.jsx("boxGeometry",{args:[n*.85,n*.38,n*.65]}),t.jsx("meshStandardMaterial",{color:"#d8d2c2",roughness:.9})]}),t.jsxs("mesh",{position:[0,n*.6,0],castShadow:o,children:[t.jsx("coneGeometry",{args:[n*.65,n*.3,4]}),t.jsx("meshStandardMaterial",{color:"#7e2a1c",roughness:.8,flatShading:!0})]})]})})()})}),[[-120,-70,.4],[60,40,2.2],[150,-100,1.1],[-64,22,1.8],[104,-46,.2],[-176,-118,2.7],[18,-142,1.4],[-30,96,.9]].map(([n,s,i],a)=>t.jsx(ge,{name:"bomb-sphere.opt.glb",height:ce("bomb-sphere.opt.glb"),position:[n,Qe.y,s],rotation:i,tint:"#5a5a64",fallback:t.jsxs("mesh",{position:[n,Qe.y+ce("bomb-sphere.opt.glb")*.5,s],castShadow:o,children:[t.jsx("sphereGeometry",{args:[ce("bomb-sphere.opt.glb")*.5,12,10]}),t.jsx("meshStandardMaterial",{color:"#14161c",roughness:.5,metalness:.5})]})},`bomb-${a}`)),[-1,1].map(n=>t.jsx(ge,{name:"keep-tier.opt.glb",height:ce("keep-tier.opt.glb"),position:[n*(xe.x-40),xe.y+xe.tiers*xe.tierRise-6,D.z+140],rotation:n*.6,tint:"#a08c74",fallback:null},`turret-${n}`)),[-1,1].map(n=>t.jsx(ge,{name:"arch-bridge.opt.glb",height:ce("arch-bridge.opt.glb"),position:[n*74,le.y,84],rotation:Math.PI/2,tint:"#b87a5a",fallback:null},`span-${n}`)),[-1,1].map(n=>t.jsx(ge,{name:"oni-guardian.opt.glb",height:Rt,position:[n*(Ge.halfX+26),Ge.y,Ge.z-26],rotation:-n*.5,tint:"#8e8880",fallback:t.jsxs("group",{position:[n*(Ge.halfX+26),Ge.y,Ge.z-26],children:[t.jsxs("mesh",{position:[0,Rt*.17,0],castShadow:o,children:[t.jsx("boxGeometry",{args:[Rt*.41,Rt*.33,Rt*.41]}),t.jsx("meshStandardMaterial",{color:"#43434c",roughness:.95})]}),t.jsxs("mesh",{position:[0,Rt*.59,0],castShadow:o,children:[t.jsx("capsuleGeometry",{args:[Rt*.185,Rt*.33,4,10]}),t.jsx("meshStandardMaterial",{color:"#8d8778",roughness:.9})]})]})},n)),t.jsx("pointLight",{position:[0,Re.y+30,Re.z-D.z+D.z+40],color:E.ember,intensity:42e3,distance:900,decay:2}),t.jsx("pointLight",{position:[0,xe.y+120,60],color:E.lantern,intensity:3e4,distance:820,decay:2}),t.jsx("pointLight",{position:[0,Qe.y+40,0],color:"#4fbf86",intensity:14e3,distance:420,decay:2}),t.jsx("pointLight",{position:[0,Ge.y+132,Ge.z-40],color:E.lantern,intensity:13e3,distance:620,decay:2})]})}const sc=Math.PI/2-.14,Us=1.5;function Ja({enabled:e,dom:o,zoomMin:n=.34,zoomMax:s=2.6,zoom0:i=1,pitch0:a=.16,pitchMin:c=-.62,pitchMax:d=sc}){const h=b.useRef({yaw:0,pitch:a,zoom:i,smYaw:0,smPitch:a,smZoom:i,since:99,dragging:!1,recentre:!1,noRecentre:!1,pitchMin:c,pitchMax:d,zoomMin:n,zoomMax:s,pitch0:a}).current;return b.useEffect(()=>{if(!e||!o)return;const p=o,g=new Map;let f=0,m=0,l=null;const u=()=>g.size,x=z=>{g.set(z.pointerId,{x:z.clientX,y:z.clientY});try{p.setPointerCapture?.(z.pointerId)}catch{}if(u()===1)h.dragging=!0,l={x:z.clientX,y:z.clientY,t:z.timeStamp};else if(u()===2){h.dragging=!1;const[r,M]=[...g.values()];f=Math.hypot(r.x-M.x,r.y-M.y),l=null}},v=z=>{const r=g.get(z.pointerId);if(!r)return;const M=z.clientX-r.x,F=z.clientY-r.y;if(r.x=z.clientX,r.y=z.clientY,u()>=2){const[j,R]=[...g.values()],I=Math.hypot(j.x-R.x,j.y-R.y);f>8&&I>8&&(h.zoom=T.clamp(h.zoom*(f/I),h.zoomMin,h.zoomMax),h.since=0),f=I;return}if(!h.dragging)return;l&&Math.hypot(z.clientX-l.x,z.clientY-l.y)>14&&(l=null);const C=Cn()*Me.lookSens;h.yaw-=M*.005*C,h.pitch=T.clamp(h.pitch+F*.004*C*(Me.invertY?-1:1),h.pitchMin,h.pitchMax),h.since=0,z.cancelable&&z.preventDefault()},w=z=>{g.has(z.pointerId)&&(g.delete(z.pointerId),u()<2&&(f=0),u()===0&&(h.dragging=!1,l&&z.timeStamp-l.t<260&&(z.timeStamp-m<340?(h.recentre=!0,m=0):m=z.timeStamp),l=null))},k=z=>{z.preventDefault(),h.zoom=T.clamp(h.zoom*(1+Math.sign(z.deltaY)*.1),h.zoomMin,h.zoomMax),h.since=0};return p.addEventListener("pointerdown",x),p.addEventListener("pointermove",v,{passive:!1}),p.addEventListener("pointerup",w),p.addEventListener("pointercancel",w),window.addEventListener("pointerup",w),p.addEventListener("wheel",k,{passive:!1}),()=>{p.removeEventListener("pointerdown",x),p.removeEventListener("pointermove",v),p.removeEventListener("pointerup",w),p.removeEventListener("pointercancel",w),window.removeEventListener("pointerup",w),p.removeEventListener("wheel",k),g.clear(),h.dragging=!1}},[e,o,h]),h}function Dn(e,o,n=0){if(e.since+=o,A.zoom&&(e.zoom=T.clamp(e.zoom*(1-A.zoom*.9*o),e.zoomMin,e.zoomMax),e.since=0),e.yaw-=n,A.recentreQueued&&(A.recentreQueued=!1,e.recentre=!0),e.recentre&&(e.recentre=!1,e.since=Us+1,e.pitch+=(e.pitch0-e.pitch)*.5,e.noRecentre&&(e.pitch=e.pitch0)),!Me.freeCam&&!e.noRecentre&&!e.dragging&&e.since>Us){for(;e.yaw>Math.PI;)e.yaw-=Math.PI*2;for(;e.yaw<-Math.PI;)e.yaw+=Math.PI*2;e.yaw*=Math.pow(Le(.22,.48),o),Math.abs(e.yaw)<.001&&(e.yaw=0)}const s=e.dragging?6e-4:Le(.002,.02),i=1-Math.pow(s,o);let a=e.yaw-e.smYaw;for(;a>Math.PI;)a-=Math.PI*2;for(;a<-Math.PI;)a+=Math.PI*2;e.smYaw+=a*i,e.smPitch+=(e.pitch-e.smPitch)*i,e.smZoom+=(e.zoom-e.smZoom)*(1-Math.pow(.004,o))}const Ws=[{id:"luffy",modelId:"luffy-wano",name:"Luffy",role:"Captain",capeAxis:"y",capeWiden:.66,capeLength:.78,capeUrl:bo("coat-black.opt.glb"),height:1.74,speed:7,run:15,build:"normal",skin:"#f0c191",hair:{color:"#181410",style:"spiky"},helm:{kind:"none"},top:{color:"#c22d2a",style:"open"},bottom:{color:"#d98b3a"},sash:"#8f63c4",boots:{color:"#6b5238",fur:!1},scar:!0},{id:"zoro",modelId:"zoro-wano",name:"Zoro",role:"Swordsman",capeAxis:"y",capeWiden:.82,capeLength:.56,capeUrl:bo("haori-green.opt.glb"),height:1.81,speed:6.6,run:14,build:"tall",skin:"#e8b481",hair:{color:"#4f7d3a",style:"short"},helm:{kind:"none"},top:{color:"#f2f0ea",style:"open"},bottom:{color:"#f2f0ea"},sash:"#4b3f7a",boots:{color:"#1f2229",fur:!1},weapon:"swords",scar:!0}],ac=e=>Ws.find(o=>o.id===e)??Ws[0],rc=.22,Ys=13,ic=.09,lc=.34,Vs=9,cc=1.1,hc=.55,$s=12,dc=6,uc=70,pc=.55,mn=26,fc=8,mc=5,Ks=.8,gc=12,xc=.3,bc=.13,Xs=3.4,wc=32,Qs=.65,yc=1.1,vc=.5,Mc=6,Zs=6,We=new S,ht=new S,ho=new S;function jc(e,o,n,s,i,a,c,d){let p=0;for(let g=1;g<=16;g++){const f=g/16*c,m=e+s*f,l=o+i*f,u=n+a*f,x=d??re(m,u);if(l<=x){let v=p,w=f;for(let k=0;k<6;k++){const z=(v+w)/2,r=o+i*z,M=d??re(e+s*z,n+a*z);r<=M?w=z:v=z}return w}p=f}return null}function Sc(e,o,n,s){const i=Math.min(e,.05),a=Ye.combat,c=Te.move,d=a.style==="sword";s.x=0,s.y=0,s.z=0,We.set(Math.sin(o.yaw)*Math.cos(o.pitch),-Math.sin(o.pitch),Math.cos(o.yaw)*Math.cos(o.pitch)).normalize(),Ye.lookYaw=Math.atan2(We.x,We.z),Ye.playerFacing=o.yaw,a.bazookaCd=Math.max(0,a.bazookaCd-i),a.gigantCd=Math.max(0,a.gigantCd-i),a.hakiCd=Math.max(0,a.hakiCd-i),a.gear2Cd=Math.max(0,a.gear2Cd-i),n.gear2Queued&&(n.gear2Queued=!1,!a.gear2&&a.gear2Cd<=0&&!d&&(a.gear2=!0,a.gear2T=fc,Ut(.25),ht.set(o.x,o.y+1,o.z),Et(ht,1.6,"haki"))),a.gear2&&(a.gear2T=Math.max(0,a.gear2T-i),a.gear2T<=0&&(a.gear2=!1,a.gear2Cd=mc));const h=a.gear2;a.balloon=T.damp(a.balloon,n.balloonHeld&&!d?1:0,8,i);const p=o.y+o.height*.9,g=jc(o.x,p,o.z,We.x,We.y,We.z,uc,o.floorY);Ye.aim.valid=g!=null,g!=null&&(Ye.aim.distance=g,Ye.aim.point.set(o.x,p,o.z).addScaledVector(We,g));const f=!c.kind;if(n.rocketQueued&&(n.rocketQueued=!1,f&&g!=null&&(l(d?"flash":"rocket",pc),c.target.copy(Ye.aim.point))),n.pistolQueued&&(n.pistolQueued=!1,f&&(l(d?"onigiri":"pistol",d?xc:rc),c.target.set(o.x,p,o.z).addScaledVector(We,d?8:16))),n.bazookaQueued&&(n.bazookaQueued=!1,f&&a.bazookaCd<=0))if(d){const u=Ye.waves.find(x=>!x.active);u&&(u.active=!0,u.k=0,u.pos.set(o.x,p*.92,o.z),u.dir.set(We.x,We.y*.35,We.z).normalize(),a.bazookaCd=yc,l("wavecast",.22),c.hit=!0,c.target.copy(u.pos).addScaledVector(u.dir,8),Ut(.1))}else l("bazooka",lc),c.target.set(o.x,p,o.z).addScaledVector(We,g!=null?Math.min(g,Vs):Vs),a.bazookaCd=cc;n.gigantQueued&&(n.gigantQueued=!1,f&&a.gigantCd<=0&&(l(d?"sanzen":"gigant",d?vc:hc),c.target.set(o.x,p,o.z).addScaledVector(We,g!=null?Math.min(g+1.5,$s):$s),a.gigantCd=d?Mc:dc));for(const u of Ye.waves){if(!u.active)continue;const x=u.k;u.k=Math.min(1,u.k+i/Qs),u.pos.addScaledVector(u.dir,wc/Qs*i);for(const w of[.35,.68,1])x<w&&u.k>=w&&Et(u.pos,1.6,"slash");const v=o.floorY==null?re(u.pos.x,u.pos.z):o.floorY;(u.k>=1||u.pos.y<v+.4)&&(u.k<1&&Et(u.pos,1.6,"slash"),u.active=!1)}if(n.hakiQueued&&(n.hakiQueued=!1,a.hakiCd<=0&&Te.hakiT<=0&&(Te.hakiT=Ks,Te.hakiFired=!1,a.hakiCd=gc)),Te.hakiT>0){Te.hakiT=Math.max(0,Te.hakiT-i);const u=1-Te.hakiT/Ks;if(a.haki=u,!Te.hakiFired&&u>.35&&(Te.hakiFired=!0,ht.set(o.x,o.y,o.z),Et(ht,3,"haki"),Ut(.9),d))for(let x=0;x<8;x++){const v=x/8*Math.PI*2;ht.set(o.x+Math.cos(v)*Zs,o.y+.6,o.z+Math.sin(v)*Zs),Et(ht,1.4,"slash")}}else a.haki=0;const m=n.gatlingHeld&&!c.kind;if(a.gatling=T.damp(a.gatling,m?1:0,14,i),a.gatling>.2&&Ye.gatlingAim.copy(We),m){if(Te.gatT-=i,Te.gatT<=0)if(d)Te.gatT=bc,Te.tatsu+=1.9,ht.set(o.x+Math.cos(Te.tatsu)*Xs,o.y+.6,o.z+Math.sin(Te.tatsu)*Xs),Et(ht,.7,"slash"),Ut(.04);else{Te.gatT=ic*(h?.6:1);const u=g!=null?Math.min(g,Ys):Ys*.85;ht.set(o.x,p,o.z).addScaledVector(We,u),Et(ht,.8,"punch"),Ut(.05)}}else Te.gatT=0;if(c.kind){c.t+=i;const u=Math.min(1,c.t/c.dur);if(!c.hit&&u>.45){c.hit=!0;const x=c.kind==="gigant"||c.kind==="sanzen"?3:1.3;if(Et(c.target,x,d?"slash":"punch"),Ut(c.kind==="gigant"||c.kind==="sanzen"?.7:.18),c.kind==="rocket"||c.kind==="flash"){ho.copy(c.target).sub(ht.set(o.x,o.y,o.z));const v=ho.length()||1;s.x=ho.x/v*mn,s.y=Math.max(0,ho.y/v*mn*.5),s.z=ho.z/v*mn}else(c.kind==="pistol"||c.kind==="onigiri")&&(s.x=We.x*6,s.z=We.z*6)}c.t>=c.dur&&(c.kind=null,c.t=0),a.move=c.kind,a.moveK=c.kind?Math.min(1,c.t/c.dur):0}else a.move=null,a.moveK=0;return Ye.shake=Math.max(0,Ye.shake-i*2.4),s;function l(u,x){c.kind=u,c.t=0,c.dur=x,c.hit=!1}}const Te={move:{kind:null,t:0,dur:0,hit:!1,target:new S},hakiT:0,hakiFired:!1,gatT:0,tatsu:0};function kc(e="rubber"){const o=Ye.combat;o.style=e,o.move=null,o.moveK=0,o.gatling=0,o.gear2=!1,o.gear2T=0,o.gear2Cd=0,o.bazookaCd=0,o.gigantCd=0,o.hakiCd=0,o.balloon=0,o.haki=0,Te.move.kind=null,Te.move.t=0,Te.hakiT=0,Te.gatT=0,Ye.shake=0;for(const n of Ye.waves)n.active=!1}const Po=64,zc=19,qs=16,Tc=.92,Js=.52,ea=.3,Ec=.04,Rc=.0016,Ac=.055,Ic=1.9,Cc=16,Fc=62,Pc=9,ta={x:-.45,z:-2.4},oa=.075,Lo=new S,na=new S;function $t(e,o){return T.clamp(-re(e,o)/26,0,1)}const Go={x:60*N,z:1050*N},Lc=7,sa=15,Pe=1.85,aa=1.1,Gc=26,ra=9.4,ia=21,Oc=.011;function Dc({mode:e,onMode:o,crew:n="luffy"}){const s=be(F=>F.camera),i=be(F=>F.gl),a=b.useRef(),c=b.useRef(),d=b.useRef({speed:0,grounded:!0,maxSpeed:15}),h=b.useRef({x:0,y:0,z:0,yaw:0,pitch:0,height:1.74,floorY:null}).current,p=b.useRef({x:0,y:0,z:0}).current,g=ac(n),f=b.useRef(),m=b.useRef(),l=b.useRef(),u=ot("ship-sunny.opt.glb"),x=ot("ship-lion.opt.glb"),v=u||x,w=u?"ship-sunny.opt.glb":x?"ship-lion.opt.glb":null,k=w?nn(w,34):30,z=ot("crew-straw.opt.glb"),r=b.useRef({x:Go.x,z:Go.z,heading:Math.PI,speed:0,vx:0,vz:0,throttle:0,rudder:0,flank:0,deckY:0,aground:0,heel:0,trim:0,spray:0,slam:0,bowY:0,drift:0,burst:1,burstFx:0,swallowed:0,fx:0,fy:0,fz:0,fyaw:Math.PI,fpitch:0,fvx:0,fvz:0,fvy:0,airborne:!1,landing:0,fyaw0:Math.PI,stride:0,area:"hall",dx:0,dz:0,snapCam:!0,boarded:!1}).current,M=Ja({enabled:e==="helm"||e==="foot",dom:i.domElement,zoomMin:.34,zoomMax:3.4,pitch0:.16,pitchMin:-.62,pitchMax:1.44});return b.useEffect(()=>{if(e==="helm")return r.x=Go.x,r.z=Go.z,r.heading=Math.PI,r.speed=0,r.vx=0,r.vz=0,r.throttle=0,r.flank=0,r.deckY=0,r.snapCam=!0,M.yaw=0,M.smYaw=0,M.pitch=.16,M.smPitch=.16,M.pitch0=.16,M.zoom=1,M.smZoom=1,M.noRecentre=!1,M.pitchMin=-.62,M.pitchMax=1.44,r.swallowed=0,r.burst=1,r.burstFx=0,r.slam=0,r.drift=0,r.trim=0,r.bowY=ut(r.x,r.z,y.t,1).y,y.helm=null,Rn("helm"),()=>{y.helmActive=!1}},[e,r,M]),b.useEffect(()=>{if(e!=="foot")return;r.fvx=0,r.fvz=0,r.snapCam=!0,Y.chain!=="foot"&&Rn("foot"),kc(g.weapon==="swords"?"sword":"rubber");const F=(j,R)=>{M.yaw=j,M.smYaw=j,M.pitch=R,M.smPitch=R,M.pitch0=0,M.noRecentre=!0,M.pitchMin=-1.28,M.pitchMax=1.28};r.fvy=0,r.airborne=!1,r.landing=0;const C=y.footSpawn;if(y.footSpawn="hall",C==="deck"){r.area="deck",r.dx=0,r.dz=-k*.2,r.fy=y.ship.y+y.ship.deckY+Pe,r.fyaw=r.heading,F(r.heading+Math.PI,.44);return}if(C==="port"){r.area="island",r.fx=Q.x+40*N,r.fz=Q.z+40*N,r.fy=re(r.fx,r.fz)+Pe,r.fyaw=Math.atan2(he.x-r.fx,he.z-r.fz),F(r.fyaw+Math.PI,-.06);return}if(C==="rear"){r.area="island",r.fx=U.gate.x+U.dir[0]*26,r.fz=U.gate.z+U.dir[1]*26,r.fy=re(r.fx,r.fz)+Pe,r.fyaw=Math.atan2(-U.dir[0],-U.dir[1]),F(r.fyaw+Math.PI,.02);return}r.area="hall",r.fx=pe.x,r.fy=pe.y+Ge.y,r.fz=pe.z+lt.zTop,r.fyaw=Math.PI,r.fpitch=-.05,F(0,.05)},[e,r,M]),ne((F,C)=>{if(e!=="helm"&&e!=="foot")return;const j=Math.min(C,.05);y.t+=j;const R=e==="helm",I=e==="foot"&&r.area==="deck";if(R||I){const B=r.heading,G=R?A.throttle:r.order,$=R?A.rudder:0;R&&(r.order=A.throttle),r.throttle+=(G-r.throttle)*(1-Math.pow(.02,j)),r.rudder+=($-r.rudder)*(1-Math.pow(.005,j)),r.flank+=((R&&A.boost?1:0)-r.flank)*(1-Math.pow(Ec,j));const q=Po*(1+ea*r.flank),ee=Math.sin(r.heading),P=Math.cos(r.heading),K=Math.cos(r.heading),ae=-Math.sin(r.heading);let H=r.vx*ee+r.vz*P,te=r.vx*K+r.vz*ae;const we=1-y.shelter,Tt=r.throttle>=0?r.throttle*q:r.throttle*zc;H+=T.clamp(Tt-H,-qs*2.5,qs)*j,r.burst=Math.min(1,r.burst+j/Pc),R&&A.burstQueued&&(A.burstQueued=!1,r.burst>=.999&&(r.burst=0,r.burstFx=1,H+=Fc,y.splash+=1)),r.burstFx*=Math.pow(.2,j);const Oe=ut(r.x,r.z,y.t,1);H-=(Oe.dx*ee+Oe.dz*P)*Cc*we*j,H-=H*Math.abs(H)*Rc*j,te-=(te*Math.abs(te)*Ac+te*Ic)*j;const Ve=T.clamp(Math.abs(H)/16,0,1);H*=Math.pow(1-.11*Math.abs(r.rudder)*Ve,j),r.vx=ee*H+K*te,r.vz=P*H+ae*te,r.speed=H,r.drift+=(T.clamp(Math.abs(te)/11,0,1)-r.drift)*(1-Math.pow(.1,j)),r.heading+=r.rudder*Tc*Ve*Math.sign(H||1)*j;const Ze=r.x+r.vx*j,yt=r.z+r.vz*j,W=k*Js,je=Ze+ee*W,qe=yt+P*W;if($t(je,qe)>.06)r.x=Ze,r.z=yt,r.aground+=(0-r.aground)*(1-Math.pow(.05,j));else{r.aground+=(1-r.aground)*(1-Math.pow(.02,j)),Ht(Math.abs(r.speed)*.0012*j*60,"AGROUND — SHE IS TAKING WATER");const ke=Math.pow(.06,j);r.speed*=ke,r.vx*=ke,r.vz*=ke;const st=6,Bt=$t(r.x+st,r.z)-$t(r.x-st,r.z),ro=$t(r.x,r.z+st)-$t(r.x,r.z-st),vt=Math.hypot(Bt,ro)||1;r.x+=Bt/vt*26*j,r.z+=ro/vt*26*j}const Ie=Ma(r.x,r.z,0);r.x+=Ie.vx*j,r.z+=Ie.vz*j,r.x+=ta.x*we*j,r.z+=ta.z*we*j;const Be=Oe.dx*K+Oe.dz*ae;r.heading+=T.clamp(Be*.4,-oa,oa)*we*j;let O=_e[0],ue=1/0;for(const ke of _e){const st=(r.x-ke.x)**2+(r.z-ke.z)**2;st<ue&&(ue=st,O=ke)}if(Oa(j,{danger:Ie.danger,headingX:Math.sin(r.heading),headingZ:Math.cos(r.heading),toCentreX:O.x-r.x,toCentreZ:O.z-r.z,speed:r.speed,throttle:r.throttle})>=1||Ie.danger>.94){const ke=O;r.x=ke.x+(ke.x>0?ke.r*1.85:-ke.r*1.85),r.z=ke.z+ke.r*1.5,r.speed=0,r.vx=0,r.vz=0,r.throttle=0,r.heading=Math.PI,r.swallowed+=1,r.aground=1,Y.grip=0,Ht(.25,"SWALLOWED — SHE BROACHED AND ROLLED"),y.splash+=1}const Ue=wo(r.x,r.z),De=T.lerp(1,.055,Ue)*T.smoothstep($t(r.x,r.z),0,.3),Fe=ut(r.x,r.z,y.t,De);y.helmActive=!0,y.helmPos.set(r.x,Fe.y+k*.35,r.z),y.helmSpeed=T.clamp(Math.abs(r.speed)/Po,0,1),y.ship.x=r.x,y.ship.y=Fe.y,y.ship.z=r.z,y.ship.heading=r.heading,y.ship.loa=k,y.ship.deckY=w?Nt(w,k):k*.16,y.ship.mastY=w?yo(w,k):k*.6;const se=Ie.vx*Math.cos(r.heading)-Ie.vz*Math.sin(r.heading),X=T.clamp(Math.abs(r.speed)/Po,0,1),fe=T.clamp(r.rudder*Ve*X*.4+se*.016,-.5,.5);r.heel+=(fe-te*.012-r.heel)*(1-Math.pow(.15,j));const $e=k*Js,Se=ut(r.x+ee*$e,r.z+P*$e,y.t,De).y,Ne=T.clamp((r.bowY-Se)/Math.max(j,.001),0,60);r.bowY=Se;const Ke=T.clamp((Ne-10)/24,0,1)*X*we;if(r.slam=Math.max(r.slam*Math.pow(.05,j),Ke),Ke>.25){const ke=Math.pow(1-.3*Ke,j);r.vx*=ke,r.vz*=ke}const jo=X*.1*Math.sign(r.speed>=0?1:-1)+r.slam*.14+r.burstFx*.16;r.trim+=(jo-r.trim)*(1-Math.pow(.1,j));const So=T.clamp(X*we*1.15+r.aground*.5+Ie.danger*.8+r.slam*1.3+r.burstFx,0,1);r.spray+=(So-r.spray)*(1-Math.pow(.08,j));const ko=a.current;if(ko&&(ko.visible=!0,ko.position.set(r.x,Fe.y,r.z),ko.rotation.set(T.clamp(Fe.dz*1.2,-.3,.3)-r.trim,r.heading,T.clamp(-Fe.dx,-.26,.26)+r.heel)),f.current&&(f.current.scale.z=1+Math.sin(y.t*1.6)*.08+r.burstFx*.4,f.current.scale.x=1+we*.06+r.burstFx*.12),m.current&&(m.current.material.opacity=r.spray*.42,m.current.scale.setScalar(.7+r.spray*.55)),l.current&&(l.current.material.opacity=T.clamp(.34*X+r.burstFx*.3,0,.62)*(.28+we*.72),l.current.scale.set(1+X*.75+r.drift*.6,1,1+X*.5)),r.deckY+=(Fe.y-r.deckY)*(1-Math.pow(Le(2e-4,.05),j)),R){Dn(M,j,r.heading-B);const ke=r.heading+Math.PI+M.smYaw,st=Math.cos(M.smPitch),Bt=Math.max(k*1.9,52)*M.smZoom*(1+X*Le(.26,.1)+r.burstFx*Le(.34,.12))*Ha(s.aspect),ro=T.lerp(Fe.y,r.deckY,Me.comfort),vt=Lo.set(r.x+Math.sin(ke)*st*Bt,ro+k*.26+Math.sin(M.smPitch)*Bt,r.z+Math.cos(ke)*st*Bt),nr=ut(vt.x,vt.z,y.t,De);vt.y=Math.max(vt.y,nr.y+6),r.snapCam?(r.snapCam=!1,s.position.copy(vt)):s.position.lerp(vt,1-Math.pow(Le(6e-4,.02),j));const sr=Math.max(0,Math.cos(M.smYaw)),ts=X*Le(66,34)*sr;s.lookAt(na.set(r.x+(ee+K*T.clamp(te/40,-.4,.4))*ts,ro+12-r.trim*26*X*Le(1,.35),r.z+(P+ae*T.clamp(te/40,-.4,.4))*ts));const os=Le(1,0);os>.001&&s.rotateZ((Math.sin(y.t*2.3)*.012*X+r.heel*.3+r.aground*Math.sin(y.t*21)*.02+r.slam*Math.sin(y.t*34)*.03+Ie.danger*Math.sin(y.t*2.7)*.03)*os),In(s,60+X*Le(7,2)+r.burstFx*Le(10,3),j,.06,Na)}const es=Math.hypot(r.x-(Q.x+60*N),r.z-(Q.z+60*N));es<90*N&&Math.abs(r.speed)<24&&(y.footSpawn="port",R?o?.("foot"):r.area==="deck"&&(r.area="island",r.fx=Q.x+40*N,r.fz=Q.z+40*N,r.fy=re(r.fx,r.fz)+Pe,r.fvx=0,r.fvz=0,r.fvy=0,r.fyaw=Math.atan2(he.x-r.fx,he.z-r.fz),M.yaw=M.smYaw=r.fyaw+Math.PI)),A.boardQueued&&(A.boardQueued=!1,R?(y.footSpawn="deck",o?.("foot")):r.area==="deck"&&o?.("helm")),R&&(y.helm={speed:r.speed,heading:r.heading,throttle:r.throttle,aground:r.aground,x:r.x,z:r.z,toGate:Math.min(Math.hypot(r.x,r.z-Pt),Math.hypot(r.x,r.z-Jt)),underFire:[Pt,Jt].some(ke=>{const st=Math.hypot(r.x,r.z-ke);return st>$o.safe&&st<$o.range}),moored:es<180*N,maelstrom:Ie.danger,swallowed:r.swallowed,burst:r.burst,drift:r.drift,maxSpeed:q,cruise:zt.level,flank:r.flank,freeCam:Me.freeCam},Ga(j,y.helm)),y.shelter+=(Ue-y.shelter)*(1-Math.pow(.06,j)),y.underwater+=(0-y.underwater)*(1-Math.pow(.02,j))}if(e==="foot"){Dn(M,j,0);const B=A.boost?sa:Lc;r.fpitch+=(-M.smPitch-r.fpitch)*(1-Math.pow(1e-4,j));const G=A.walk.x,$=A.walk.z,q=Math.hypot(G,$),ee=q>1?q:1,P=-Math.sin(M.smYaw),K=-Math.cos(M.smYaw),ae=-K,H=P,te=(P*($/ee)+ae*(G/ee))*B,we=(K*($/ee)+H*(G/ee))*B,Tt=(1-Math.pow(q>.02?2e-5:4e-7,j))*(r.airborne?.25:1);r.fvx+=(te-r.fvx)*Tt,r.fvz+=(we-r.fvz)*Tt;const Oe=r.fvx*j,Ve=r.fvz*j,Ze=r.area==="island"?(se,X)=>re(se,X):r.area==="deck"?()=>y.ship.y+y.ship.deckY:(se,X,fe)=>pe.y+oi(se-pe.x,X-pe.z,fe-pe.y),yt=r.area==="hall"?(se,X,fe)=>ni(se-pe.x,X-pe.z,fe-pe.y)||qr(se,fe,X)>.97:()=>!1;if(r.area==="deck"){const se=Math.cos(-y.ship.heading),X=Math.sin(-y.ship.heading);r.dx+=Oe*se+Ve*-X,r.dz+=Oe*X+Ve*se;const fe=y.ship.loa*.14,$e=y.ship.loa*.42;Math.abs(r.dx)>fe&&(r.dx=Math.sign(r.dx)*fe,r.fvx=0,r.fvz=0),Math.abs(r.dz)>$e&&(r.dz=Math.sign(r.dz)*$e,r.fvx=0,r.fvz=0);const Se=Math.cos(y.ship.heading),Ne=Math.sin(y.ship.heading);r.fx=y.ship.x+r.dx*Se+r.dz*Ne,r.fz=y.ship.z-r.dx*Ne+r.dz*Se}else if(r.area==="island"){const se=r.fx+Oe,X=r.fz+Ve,fe=re(r.fx,r.fz),$e=re(se,X),Se=Math.hypot(Oe,Ve)||1e-6,Ne=($e-fe)/Se;($e<=.3||Ne>=1.2&&$e>=fe)&&(r.fvx=0,r.fvz=0),$e>.3&&(Ne<1.2||$e<fe)&&(r.fx=se,r.fz=X)}else{const se=r.fx+Oe,X=r.fz+Ve,fe=r.fy-Pe,$e=Ze(r.fx,r.fz,fe),Se=r.airborne?fe:$e;Ze(se,X,Se)-Se>aa||yt(se,X,fe)?(r.fvx=0,r.fvz=0):(r.fx=se,r.fz=X)}const W=r.fy-Pe,je=Ze(r.fx,r.fz,W);if(r.airborne?(r.fvy-=Gc*j,r.fy+=r.fvy*j,r.fy-Pe<=je&&(r.landing=-r.fvy,r.fy=je+Pe,r.fvy=0,r.airborne=!1,r.landing>ia&&(Ht((r.landing-ia)*Oc,"A LONG WAY DOWN"),Ye.roll=0))):r.area==="deck"?(r.fy=je+Pe,r.fvy=0,r.landing=Math.max(0,r.landing-j*40),A.jumpQueued&&(A.jumpQueued=!1,r.fvy=ra,r.airborne=!0)):W-je>aa?(r.airborne=!0,r.fvy=0):(r.fy+=(je+Pe-r.fy)*(1-Math.pow(.002,j)),r.landing=Math.max(0,r.landing-j*40),A.jumpQueued&&(A.jumpQueued=!1,r.fvy=ra,r.airborne=!0)),A.jumpQueued=!1,r.area==="island"){const se=Math.hypot(r.fx-he.x,r.fz-he.z),X=Math.hypot(r.fx-U.gate.x,r.fz-U.gate.z);se<80?(r.area="hall",r.fx=pe.x,r.fz=pe.z+lt.zTop,r.fy=pe.y+Ge.y+Pe,r.fvy=0,r.airborne=!1,r.fyaw=Math.PI,M.yaw=M.smYaw=0,M.pitch=M.smPitch=.05):X<40&&(r.area="hall",r.fx=pe.x+60,r.fz=pe.z+D.z+150,r.fy=pe.y+Pe,r.fvy=0,r.airborne=!1,r.fyaw=0,M.yaw=M.smYaw=Math.PI,M.pitch=M.smPitch=.04),y.helm={onFoot:!0,area:"island",x:r.fx,z:r.fz,fy:r.fy-pe.y,toMouth:se,toRear:X,nearPort:Math.hypot(r.fx-Q.x,r.fz-Q.z)<Q.r*1.4};const fe=wo(r.fx,r.fz);y.shelter+=(fe-y.shelter)*(1-Math.pow(.06,j))}else if(r.area==="deck")y.helm={onFoot:!0,area:"deck",x:r.fx,z:r.fz,speed:r.speed,heading:r.heading,throttle:r.throttle,maxSpeed:Po*(1+ea*r.flank),moored:!1};else{const se=r.fz-pe.z;se>Ge.z+34&&(r.area="island",r.fx=he.x,r.fz=he.z+130,r.fy=re(r.fx,r.fz)+Pe,r.fvy=0,r.airborne=!1,r.fyaw=0,M.yaw=M.smYaw=Math.PI,M.pitch=M.smPitch=-.04),y.helm={onFoot:!0,area:"hall",x:r.fx,z:r.fz,lz:se,fy:r.fy-pe.y},y.shelter+=(1-y.shelter)*(1-Math.pow(.06,j))}const qe=Math.hypot(r.fvx,r.fvz);r.stride+=qe*j;const nt=g.height??1.74;if(qe>.4){let X=Math.atan2(r.fvx,r.fvz)-r.fyaw;for(;X>Math.PI;)X-=Math.PI*2;for(;X<-Math.PI;)X+=Math.PI*2;r.fyaw+=X*(1-Math.pow(4e-4,j))}r.fpitch+=(-M.smPitch-r.fpitch)*(1-Math.pow(1e-4,j)),r.pace=qe,d.current.speed=qe,d.current.maxSpeed=sa,d.current.grounded=!r.airborne,d.current.vy=r.fvy,d.current.landing=r.landing,Ye.playerTurn=(r.fyaw-r.fyaw0)/Math.max(j,1e-4),r.fyaw0=r.fyaw,h.x=r.fx,h.y=r.fy-Pe,h.z=r.fz,h.yaw=M.smYaw+Math.PI,h.pitch=M.smPitch,h.height=nt,h.floorY=r.area==="hall"?r.fy-Pe:null,Sc(j,h,A,p),(p.x||p.z)&&(r.fvx+=p.x,r.fvz+=p.z);const Ie=(r.area==="deck"?Math.max(nt*2.6,y.ship.loa*.75):nt*2.6)*M.smZoom,Be=Math.cos(M.smPitch),O=r.area==="deck"?T.lerp(r.fy,r.deckY+y.ship.deckY+Pe,Me.comfort):r.fy,ue=O+Math.sin(r.stride*1.6)*.05*Le(1,.3),Je=r.fx+Math.sin(M.smYaw)*Be*Ie,Ue=r.fz+Math.cos(M.smYaw)*Be*Ie;let De=ue+nt*.28+Math.sin(M.smPitch)*Ie;const Fe=r.area==="island"?re(Je,Ue):O-Pe;De=Math.max(De,Fe+nt*.6),r.area==="deck"&&(De=Math.max(De,O-Pe+y.ship.mastY*1.06)),Lo.set(Je,De,Ue),r.snapCam?(r.snapCam=!1,s.position.copy(Lo)):s.position.lerp(Lo,1-Math.pow(Le(9e-4,.02),j)),s.lookAt(na.set(r.fx,ue-nt*.1,r.fz)),In(s,r.area==="hall"?72:64,j,.02),c.current&&(c.current.position.set(r.fx,r.fy-Pe,r.fz),c.current.rotation.y=r.fyaw),y.underwater+=(0-y.underwater)*(1-Math.pow(.02,j))}y.fog=T.lerp(Ft.sea,Ft.bay,y.shelter),y.rain=1-y.shelter*.92}),t.jsxs(t.Fragment,{children:[t.jsx("group",{ref:c,position:[0,-4e3,0],visible:e==="foot",children:t.jsx(xr,{character:g,motion:d})}),t.jsxs("group",{ref:a,position:[0,-4e3,0],visible:e==="helm",children:[v&&t.jsx(ge,{name:w,loa:k,slim:sn(w),sink:Mo(w),rotation:tn(w),tint:Kn(w,"#c98a52"),emissive:"#3a2a18",emissiveIntensity:.24}),v&&z&&Bo.slice(0,2).map(([F,C,j],R)=>t.jsx(ge,{name:"crew-straw.opt.glb",height:on,rotation:j,position:[F*k,Nt(w,k),C*k]},`crew-${R}`)),t.jsxs("mesh",{position:[0,2,0],scale:[1,.74,2.7],castShadow:!0,visible:!v,children:[t.jsx("capsuleGeometry",{args:[5,9,4,12]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.84})]}),t.jsxs("mesh",{position:[0,5.4,0],visible:!v,children:[t.jsx("boxGeometry",{args:[8.6,.8,24]}),t.jsx("meshStandardMaterial",{color:"#6b4b34",roughness:.92})]}),t.jsxs("mesh",{position:[0,6.6,13],rotation:[.5,0,0],castShadow:!0,visible:!v,children:[t.jsx("boxGeometry",{args:[4,10,2.6]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.86})]}),t.jsxs("mesh",{position:[0,9,-8.5],castShadow:!0,visible:!v,children:[t.jsx("boxGeometry",{args:[8,7,7.5]}),t.jsx("meshStandardMaterial",{color:"#a85f24",roughness:.88})]}),t.jsxs("mesh",{position:[0,16,1],castShadow:!0,visible:!v,children:[t.jsx("cylinderGeometry",{args:[1.05,1.4,27,6]}),t.jsx("meshStandardMaterial",{color:"#2f2016",roughness:.9})]}),t.jsxs("mesh",{position:[0,25.5,1.2],rotation:[0,0,Math.PI/2],castShadow:!0,visible:!v,children:[t.jsx("cylinderGeometry",{args:[.6,.6,19,5]}),t.jsx("meshStandardMaterial",{color:"#241a12",roughness:.9})]}),t.jsxs("mesh",{ref:f,position:[0,17.5,1.5],visible:!v,children:[t.jsx("planeGeometry",{args:[17,15]}),t.jsx("meshStandardMaterial",{color:"#f0e6cf",roughness:1,side:He,emissive:"#f0e6cf",emissiveIntensity:.3})]}),t.jsxs("group",{position:[0,7.4,14.6],visible:!v,children:[t.jsxs("mesh",{castShadow:!0,children:[t.jsx("sphereGeometry",{args:[3.4,10,8]}),t.jsx("meshStandardMaterial",{color:"#e0a33c",roughness:.8})]}),t.jsxs("mesh",{position:[0,0,-1.2],rotation:[Math.PI/2,0,0],children:[t.jsx("torusGeometry",{args:[4.5,1.6,6,14]}),t.jsx("meshStandardMaterial",{color:"#c9762e",roughness:.82})]})]}),[-1,1].map(F=>t.jsxs("mesh",{position:[F*k*.085,(v?Nt(w,k):8)+k*.045,-k*.19],children:[t.jsx("sphereGeometry",{args:[k*.019,8,6]}),t.jsx("meshStandardMaterial",{color:E.lantern,emissive:E.lantern,emissiveIntensity:3.4,toneMapped:!1})]},F)),t.jsx(vo,{crew:"straw",width:v?k*.24:14,position:[0,v?yo(w,k)*.88:26,-k*.06]}),t.jsxs("mesh",{ref:l,position:[0,.6,-k*1.05],rotation:[-Math.PI/2,0,0],children:[t.jsx("planeGeometry",{args:[k*.6,k*2.2]}),t.jsx("meshBasicMaterial",{map:kn,color:Z.foam,transparent:!0,opacity:.3,depthWrite:!1,toneMapped:!1})]}),t.jsxs("mesh",{ref:m,position:[0,k*.12,k*.56],rotation:[-.5,0,0],children:[t.jsx("planeGeometry",{args:[k*.85,k*.6]}),t.jsx("meshBasicMaterial",{map:Gi,color:Z.foam,transparent:!0,opacity:0,depthWrite:!1,toneMapped:!1,blending:wt})]})]})]})}const la=76,Nc=24,ca=26,Hc=1.15,_c=.44,Bc=.05,Uc=.22,Wc=70,Oo=340,ha=7,Yc=6,da=60,Do=185,Vc=new S,ua=new S,No={x:430*N,z:1e3*N};function $c({mode:e,onMode:o}){const n=be(x=>x.camera),s=be(x=>x.gl),i=b.useRef(),a=b.useRef(),c=b.useRef(),d=ot("ship-tang.opt.glb"),h=ot("ship-sub.opt.glb"),p=d||h,g=ot("crew-heart.opt.glb"),f=d?"ship-tang.opt.glb":"ship-sub.opt.glb",m=nn(f,28),l=b.useRef({x:No.x,z:No.z,heading:Math.PI,speed:0,throttle:0,rudder:0,flank:0,depth:4,orderedDepth:4,pitch:0,heel:0,scrape:0,stress:0,berthing:0,snapCam:!0}).current,u=Ja({enabled:e==="sub",dom:s.domElement,zoomMin:.42,zoomMax:2.3,pitch0:.22,pitchMin:-1,pitchMax:1.42});return b.useEffect(()=>{if(e==="sub")return l.x=No.x,l.z=No.z,l.heading=Math.PI,l.speed=0,l.throttle=0,l.flank=0,l.depth=4,l.orderedDepth=4,l.berthing=0,l.snapCam=!0,u.yaw=0,u.smYaw=0,u.pitch=.22,u.smPitch=.22,u.pitch0=.22,u.zoom=1,u.smZoom=1,u.noRecentre=!1,l.heel=0,y.subActive=!0,y.helm=null,Rn("sub"),()=>{y.subActive=!1,y.subThrottle=0}},[e,l,u]),ne((x,v)=>{if(e!=="sub"){i.current&&i.current.position.set(0,-4e3,0);return}const w=Math.min(v,.05);y.t+=w;const k=l.heading,z=A.boost;l.throttle+=(A.throttle-l.throttle)*(1-Math.pow(.02,w)),l.flank+=((z?1:0)-l.flank)*(1-Math.pow(Bc,w)),y.subThrottle=Math.abs(l.throttle),l.rudder+=(A.rudder-l.rudder)*(1-Math.pow(8e-4,w));const r=T.clamp(l.depth/15,0,1),M=la*(.7+.3*r)*(1+_c*l.flank),F=l.throttle>=0?l.throttle*M:l.throttle*Nc;l.speed+=T.clamp(F-l.speed,-ca*2,ca)*w,l.speed-=l.speed*Math.abs(l.speed)*.0016*w;const C=T.lerp(Uc,1,T.clamp(Math.abs(l.speed)/7,0,1));l.heading+=l.rudder*Hc*C*Math.sign(l.speed>=0?1:-1)*w,l.orderedDepth-=A.planes*Wc*w,l.orderedDepth=T.clamp(l.orderedDepth,0,Oo),A.surfaceQueued&&(A.surfaceQueued=!1,l.orderedDepth=0),A.periscopeQueued&&(A.periscopeQueued=!1,l.orderedDepth=Yc);const j=l.x+Math.sin(l.heading)*l.speed*w,R=l.z+Math.cos(l.heading)*l.speed*w,I=Ma(j,R,l.depth);l.x=j+I.vx*w,l.z=R+I.vz*w;const B=I.vx*Math.cos(l.heading)-I.vz*Math.sin(l.heading);l.heading+=B*.008*w;const G=T.clamp(Math.abs(l.speed)/la,0,1),$=T.clamp(B*.02+l.rudder*C*G*.34,-.6,.6);l.heel+=($-l.heel)*(1-Math.pow(.12,w)),I.danger>.05&&(l.speed*=Math.pow(1-.22*I.danger,w));const q=re(l.x,l.z),ee=Math.max(2,-q-ha),P=l.depth<1.5;l.depth+=(l.orderedDepth-l.depth)*(1-Math.pow(.12,w)),l.depth>ee?(l.scrape+=(1-l.scrape)*(1-Math.pow(.02,w)),l.depth=ee,l.orderedDepth=Math.min(l.orderedDepth,ee-2),Ht(Math.abs(l.speed)*.0016*w*60,"GROUNDED ON THE SHELF"),l.speed*=Math.pow(.3,w)):l.scrape+=(0-l.scrape)*(1-Math.pow(.05,w));const K=(l.depth-Do)/(Oo-Do);l.stress=K>0?Math.min(1,K*K):0,l.stress>0&&Ht(l.stress*.06*w,"HULL UNDER PRESSURE — COME UP");const ae=l.x+Math.sin(l.heading)*26,H=l.z+Math.cos(l.heading)*26;if(re(ae,H)>-l.depth+ha*.5){l.speed*=Math.pow(.1,w);const Ne=6,Ke=re(l.x+Ne,l.z)-re(l.x-Ne,l.z),jo=re(l.x,l.z+Ne)-re(l.x,l.z-Ne),So=Math.hypot(Ke,jo)||1;l.x-=Ke/So*20*w,l.z-=jo/So*20*w,l.scrape=Math.max(l.scrape,.5)}const we=Math.hypot(l.x-U.x,l.z-U.z);if(we<U.pool*1.1&&l.berthing===0&&(l.berthing=1e-4),l.berthing>0){l.berthing=Math.min(1,l.berthing+w*.5),l.x+=(U.berth.x-l.x)*(1-Math.pow(.1,w)),l.z+=(U.berth.z-l.z)*(1-Math.pow(.1,w)),l.orderedDepth=0,l.speed*=Math.pow(.1,w);let Ke=Math.atan2(U.dir[0],U.dir[1])+Math.PI-l.heading;for(;Ke>Math.PI;)Ke-=Math.PI*2;for(;Ke<-Math.PI;)Ke+=Math.PI*2;l.heading+=Ke*(1-Math.pow(.2,w)),l.berthing>=1&&l.depth<1.2&&(y.footSpawn="rear",y.splash+=1,o?.("foot"))}l.depth<1.5!==P&&(y.splash+=1);const Oe=ut(l.x,l.z,y.t,1),Ve=1-T.clamp(l.depth/10,0,1),Ze=-l.depth+Oe.y*Ve,yt=T.clamp((l.orderedDepth-l.depth)*.05,-.34,.34)*Math.sign(l.speed>=0?1:-1)+Oe.dz*.8*Ve;l.pitch+=(yt-l.pitch)*(1-Math.pow(.05,w));const W=i.current;W&&(W.position.set(l.x,Ze,l.z),W.rotation.set(l.pitch+l.scrape*Math.sin(y.t*23)*.02,l.heading,-Oe.dx*.5*Ve+l.heel)),a.current&&(a.current.rotation.z+=l.throttle*9*w),c.current&&(c.current.visible=l.depth<2.5),y.subPos.set(l.x,Ze,l.z),Dn(u,w,l.heading-k);const je=l.heading+Math.PI+u.smYaw,qe=Math.cos(u.smPitch),nt=T.clamp(l.depth/240,0,1),Ie=Math.max(m*2.6,60)*u.smZoom*(1-nt*.2)*Ha(n.aspect),Be=Vc.set(l.x+Math.sin(je)*qe*Ie,Ze+m*.2+Math.sin(u.smPitch)*Ie,l.z+Math.cos(je)*qe*Ie),O=re(Be.x,Be.z);Be.y=Math.max(Be.y,O+5),l.depth>10&&(Be.y=Math.min(Be.y,Oe.y-3)),l.snapCam?(l.snapCam=!1,n.position.copy(Be)):n.position.lerp(Be,1-Math.pow(Le(8e-4,.02),w));const ue=Math.max(0,Math.cos(u.smYaw)),Je=G*Le(46,26)*ue;ua.set(l.x+Math.sin(l.heading)*Je,Ze+6-l.pitch*30*G*Le(1,.35),l.z+Math.cos(l.heading)*Je),n.lookAt(ua);const Ue=Le(1,0);Ue>.001&&n.rotateZ((l.scrape*Math.sin(y.t*19)*.015+l.heel*.35+I.danger*Math.sin(y.t*3.1)*.02)*Ue),In(n,64+G*Le(6,2)+l.flank*Le(2,.6),w,.06,Na);const De=ut(n.position.x,n.position.z,y.t,1),Fe=T.clamp((De.y-n.position.y-1)/3,0,1);y.underwater+=(Fe-y.underwater)*(1-Math.pow(.002,w)),y.depthBelow=Math.max(0,De.y-n.position.y);const se=T.lerp(8200,1700,y.underwater);Math.abs(n.far-se)>20&&(n.far=se,n.updateProjectionMatrix()),y.shelter+=((we<U.pool*3?.85:0)-y.shelter)*(1-Math.pow(.06,w));let X=_e[0],fe=1/0;for(const Ne of _e){const Ke=(l.x-Ne.x)**2+(l.z-Ne.z)**2;Ke<fe&&(fe=Ke,X=Ne)}Oa(w,{danger:I.danger,headingX:Math.sin(l.heading),headingZ:Math.cos(l.heading),toCentreX:X.x-l.x,toCentreZ:X.z-l.z,speed:l.speed,throttle:l.throttle})>=1&&(Ht(.22,"CAUGHT IN THE VORTEX"),l.x=X.x+(l.x>X.x?1:-1)*X.r*1.9,l.z=X.z+X.r*1.5,l.speed=0,l.orderedDepth=Math.min(Oo,l.depth+18),Y.grip=0,y.splash+=1);let Se=Math.atan2(U.x-l.x,U.z-l.z)-l.heading;for(;Se>Math.PI;)Se-=Math.PI*2;for(;Se<-Math.PI;)Se+=Math.PI*2;y.helm={sub:!0,speed:l.speed,maxSpeed:M,heading:l.heading,depth:l.depth,orderedDepth:l.orderedDepth,scrape:l.scrape,stress:l.stress,maelstrom:I.danger,toRear:we,relRear:Se,berthing:l.berthing>0,x:l.x,z:l.z,maxDepth:Oo,crushDepth:Do,cruise:zt.level,flank:l.flank,freeCam:Me.freeCam,dark:T.clamp((l.depth-da)/(Do-da),0,1)},Ga(w,y.helm)}),t.jsxs("group",{ref:i,position:[0,-4e3,0],children:[p&&t.jsx(ge,{name:f,loa:m,slim:sn(f),sink:Mo(f),rotation:tn(f),tint:Kn(f,"#c9b445"),emissive:"#2a2410",emissiveIntensity:.22}),t.jsxs("group",{ref:c,position:[0,Nt(f,m),-m*.07],children:[g&&t.jsx(ge,{name:"crew-heart.opt.glb",height:on,rotation:0}),t.jsx(vo,{crew:"heart",width:m*.26,position:[0,yo(f,m)*.55,-m*.2]})]}),t.jsxs("group",{visible:!p,children:[t.jsxs("mesh",{castShadow:!0,scale:[1,.82,2.9],children:[t.jsx("capsuleGeometry",{args:[5.4,8,6,12]}),t.jsx("meshStandardMaterial",{color:"#c9b03a",roughness:.55,metalness:.18})]}),t.jsxs("mesh",{position:[0,4.6,0],children:[t.jsx("boxGeometry",{args:[7.6,.8,26]}),t.jsx("meshStandardMaterial",{color:"#8a7a3a",roughness:.8})]}),t.jsxs("mesh",{position:[0,8,5],castShadow:!0,children:[t.jsx("cylinderGeometry",{args:[2.6,3,7,8]}),t.jsx("meshStandardMaterial",{color:"#d8cebf",roughness:.6})]}),t.jsxs("mesh",{position:[0,12,5],castShadow:!0,children:[t.jsx("coneGeometry",{args:[2.8,3,8]}),t.jsx("meshStandardMaterial",{color:"#5a6b8a",roughness:.6})]}),t.jsxs("mesh",{position:[0,3,-15],castShadow:!0,children:[t.jsx("boxGeometry",{args:[.9,10,5]}),t.jsx("meshStandardMaterial",{color:"#b09a32",roughness:.6})]}),t.jsxs("mesh",{position:[0,.4,-14],rotation:[0,0,Math.PI/2],children:[t.jsx("boxGeometry",{args:[.8,12,4]}),t.jsx("meshStandardMaterial",{color:"#b09a32",roughness:.6})]}),[-1,1].map(x=>[0,1,2,3].map(v=>t.jsxs("mesh",{position:[x*5.1,1.2,8-v*5],children:[t.jsx("sphereGeometry",{args:[.55,6,5]}),t.jsx("meshStandardMaterial",{color:"#8fe8c9",emissive:"#8fe8c9",emissiveIntensity:2.6,toneMapped:!1})]},`${x}-${v}`)))]}),t.jsxs("mesh",{position:[0,m*.02,m*.5],children:[t.jsx("sphereGeometry",{args:[1.7,10,8]}),t.jsx("meshStandardMaterial",{color:"#b8ffe2",emissive:"#8fe8c9",emissiveIntensity:4.2,toneMapped:!1})]}),t.jsx("sprite",{position:[0,m*.02,m*.6],scale:[m*.9,m*.9,1],children:t.jsx("spriteMaterial",{map:Kc,color:"#7fe8c9",transparent:!0,opacity:.5,depthWrite:!1,blending:wt})}),t.jsxs("mesh",{position:[0,m*.24,-m*.42],children:[t.jsx("sphereGeometry",{args:[.9,8,6]}),t.jsx("meshStandardMaterial",{color:"#ffb066",emissive:"#ffb066",emissiveIntensity:3,toneMapped:!1})]}),t.jsxs("mesh",{ref:a,position:[0,m*.012,-m*.52],children:[t.jsx("torusGeometry",{args:[1.6,.5,6,10]}),t.jsx("meshStandardMaterial",{color:"#6b5a20",roughness:.5,metalness:.4})]}),t.jsx(Zc,{})]})}const Kc=(()=>{if(typeof document>"u")return null;const e=64,o=document.createElement("canvas");o.width=e,o.height=e;const n=o.getContext("2d"),s=n.createRadialGradient(e/2,e/2,2,e/2,e/2,e/2);s.addColorStop(0,"rgba(255,255,255,0.9)"),s.addColorStop(.4,"rgba(255,255,255,0.28)"),s.addColorStop(1,"rgba(255,255,255,0)"),n.fillStyle=s,n.fillRect(0,0,e,e);const i=new no(o);return i.colorSpace=so,i})(),Xc=`
  uniform float uTime;
  uniform float uGain;
  attribute float aPhase;
  attribute float aRate;
...
`+(O.maelstrom>.2?"⚠ MAELSTROM — HARD OVER, FULL AHEAD":O.moored?"MOORING":O.aground>.3?"AGROUND — HELM OVER":O.underFire?`⚠ UNDER FIRE — STRAIGHT FOR THE ARCH    GATE ${Math.round(O.toGate)}m`:O.drift>.62?`MAKING LEEWAY — EASE THE HELM    GATE ${Math.round(O.toGate)}m`:`GATE ${Math.round(O.toGate)}m`)}}if(K.current){const O=ll(),ue=il(Y.chain);K.current.textContent=Y.done?"✔ OBJECTIVE COMPLETE":O?`▸ ${Y.step+1}/${ue}  ${O.text}`:"",K.current.style.color=Y.done?"#8fe0a0":"#ffd9cf"}if(ae.current){const O=Math.max(0,Math.min(1,Y.hull)),ue=Math.max(0,Math.min(1,Y.grip)),Je=Fe=>{const se=Math.round(Fe*12);return"█".repeat(se)+"·".repeat(12-se)},Ue=O>.6?"#8fe0a0":O>.3?"#ffc46b":"#ff6b5a",De=ue>.66?"#ff6b5a":ue>.33?"#ffc46b":"rgba(255,255,255,0.45)";ae.current.innerHTML=`<span style="color:${Ue}">HULL ${Je(O)}</span>`+(ue>.02?`<span style="color:${De};margin-left:14px">VORTEX ${Je(ue)}</span>`:"")}if(H.current){const O=Y.banner,ue=H.current;O?(ue.dataset.text!==O.text&&(ue.dataset.text=O.text,ue.innerHTML=`<div class="og-banner-main">${O.text}</div>`+(O.sub?`<div class="og-banner-sub">${O.sub}</div>`:""),ue.style.animation="none",ue.offsetWidth,ue.style.animation=""),ue.style.opacity="1"):(ue.style.opacity="0",ue.dataset.text="")}p&&ee.current?(nt++,qe+=Be-je,je=Be,qe>400&&(ee.current.textContent=`${Math.round(nt*1e3/qe)} fps · shelter ${M.shelter.toFixed(2)} · fog ${(M.fog*1e4).toFixed(1)}e-4 · flash ${M.flash.toFixed(2)}`,qe=0,nt=0)):je=Be};return W=requestAnimationFrame(Ie),()=>cancelAnimationFrame(W)},[M,p]);const we={opacity:$?.16:1,transform:$?"translateY(6px)":"none",transition:"opacity .5s ease, transform .5s ease"},Tt=[{key:"rails",on:!a,label:a?"FREE LOOK":"ON RAILS",title:"Take the camera off rails and look around",click:f,cinematicOnly:!0},{key:"helm",on:w==="helm",label:w==="helm"?"LEAVE HELM":"TAKE THE HELM",title:"Take the helm and sail the approach yourself",click:()=>k(w==="helm"?"off":"helm")},{key:"deck",on:!1,label:"WALK THE DECK",title:"Step back from the wheel and walk the deck as your pirate — she sails on",click:()=>{M.footSpawn="deck",k("foot")},helmOnly:!0},{key:"sub",on:w==="sub",label:w==="sub"?"LEAVE THE TANG":"DIVE THE POLAR TANG",title:"Dive under the maelstroms and take the back way in",click:()=>k(w==="sub"?"off":"sub")},{key:"foot",on:w==="foot",label:w==="foot"?"LEAVE DOME":"ENTER THE DOME",title:"Walk the Live Floor inside the Skull Dome",click:()=>k(w==="foot"?"off":"foot")}],Oe=W=>w==="foot"?t.jsx(at,{on:!0,wide:!0,block:W,title:"Swap between Luffy and Zoro, in their Wano gear",onClick:()=>r?.(z==="zoro"?"luffy":"zoro"),children:z==="zoro"?"ZORO · 和":"LUFFY · 和"}):null,Ve=(W,je)=>t.jsx(at,{on:W.on,onClick:W.click,title:W.title,wide:!0,block:je,children:W.label},W.key),Ze=W=>C?t.jsxs(t.Fragment,{children:[t.jsx(at,{on:B.comfort>.01,wide:!0,block:W,title:"Steady the camera: less roll, less shake, less lens movement. The fix if the motion is making you queasy.",onClick:kl,children:B.comfort>.9?"COMFORT · FULL":B.comfort>.01?"COMFORT · SOME":"COMFORT · OFF"}),t.jsx(at,{on:B.freeCam,wide:!0,block:W,title:"Free camera: the view stays where you put it instead of swinging back behind the ship (V)",onClick:()=>Jo("freeCam"),children:B.freeCam?"CAM · FREE":"CAM · CHASE"}),t.jsx(at,{on:Math.abs(B.lookSens-1)>.01,wide:!0,block:W,title:"How far a drag turns the view",onClick:zl,children:`LOOK ${B.lookSens.toFixed(2).replace(/0$/,"")}×`}),t.jsx(at,{on:B.invertY,wide:!0,block:W,title:"Invert the vertical look axis",onClick:()=>Jo("invertY"),children:B.invertY?"Y · INVERTED":"Y · NORMAL"})]}):null,yt=W=>t.jsxs(t.Fragment,{children:[!C&&t.jsxs(t.Fragment,{children:[t.jsx(at,{on:i,onClick:g,title:"Play / pause the cinematic",block:W,children:i?W?"❙❙  PAUSE":"❙❙":W?"▶  PLAY":"▶"}),[.5,1,2].map(je=>t.jsxs(at,{on:c===je,onClick:()=>m(je),title:`${je}× speed`,block:W,children:[je,"×"]},je))]}),t.jsx(at,{on:!1,onClick:u,title:"Restart from the open sea",block:W,children:W?"↺  RESTART":"↺"}),t.jsx(at,{on:x,onClick:v,title:"Storm, taiko and a temple bell — all synthesised",block:W,children:x?W?"♪  SOUND ON":"♪":W?"♪̸  SOUND OFF":"♪̸"}),t.jsx(at,{on:h!=="auto",wide:!0,block:W,title:"Render tier",onClick:()=>l(h==="auto"?"low":h==="low"?"mobile":h==="mobile"?"high":"auto"),children:h==="auto"?`AUTO · ${d.toUpperCase()}`:h.toUpperCase()})]});return t.jsxs(t.Fragment,{children:[!F&&t.jsxs(t.Fragment,{children:[[0,1].map(W=>t.jsx("div",{style:{position:"fixed",left:0,right:0,[W?"bottom":"top"]:0,height:te?wn:0,background:"#05040a",zIndex:8,pointerEvents:"none",transition:"height .7s cubic-bezier(.6,0,.2,1)"}},W)),t.jsxs("div",{className:"og-tategaki",style:{opacity:C||R?0:1,transition:"opacity .6s ease"},children:["鬼ヶ島",t.jsx("span",{className:"og-tategaki-sub",children:"ONIGASHIMA"})]}),t.jsx("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 26px)",zIndex:10,pointerEvents:"none",animation:"ogCaption .85s cubic-bezier(.2,.9,.2,1) both",transition:"bottom .7s cubic-bezier(.6,0,.2,1)",maxWidth:"min(70vw, 620px)",display:C?"none":"block"},children:t.jsxs("div",{style:{display:"inline-block",borderLeft:`2px solid ${fo}`,paddingLeft:12},children:[t.jsx("div",{style:{font:'700 clamp(15px, 2.5vw, 27px)/1.15 "Hiragino Mincho ProN", "Yu Mincho", Georgia, serif',letterSpacing:"0.07em",color:"#fff6f0",textShadow:"0 2px 22px rgba(0,0,0,0.95), 0 0 44px rgba(0,0,0,0.7)"},children:e?.title}),t.jsx("div",{style:{marginTop:5,font:"500 clamp(9px, 1.15vw, 12px)/1.5 ui-monospace, Menlo, monospace",letterSpacing:"0.19em",color:"rgba(255,225,215,0.66)",textShadow:"0 1px 12px rgba(0,0,0,0.95)"},children:e?.sub})]})},e?.id),t.jsx("div",{style:{position:"fixed",left:0,right:0,bottom:"var(--og-bottom)",height:2,zIndex:10,background:"rgba(255,255,255,0.08)",pointerEvents:"none",opacity:C?0:1,transition:"bottom .7s cubic-bezier(.6,0,.2,1), opacity .4s ease"},children:t.jsx("div",{ref:q,style:{height:"100%",background:`linear-gradient(90deg, ${fo}, #ff9c2e)`,transformOrigin:"0 50%",transform:"scaleX(0)",boxShadow:`0 0 14px ${fo}`}})}),t.jsx("div",{className:`og-chrome${C?"":" og-chrome-bottom"}`,style:{...C?{top:"calc(var(--og-top) + 14px)"}:{bottom:"calc(var(--og-bottom) + 22px)"},...we},children:j?t.jsxs(t.Fragment,{children:[C&&t.jsx(at,{on:!0,onClick:()=>k("off"),wide:!0,title:"Back to the cinematic",children:"✕ EXIT"}),t.jsx(at,{on:R,onClick:()=>I(W=>!W),title:"Menu",children:R?"✕":"☰"}),R&&t.jsxs("div",{className:"og-menu",children:[C&&t.jsxs(t.Fragment,{children:[Oe(!0),Ze(!0),t.jsx("div",{className:"og-menu-rule"})]}),Tt.filter(W=>!(W.cinematicOnly&&C)&&!(W.helmOnly&&w!=="helm")).map(W=>Ve(W,!0)),t.jsx("div",{className:"og-menu-rule"}),yt(!0)]})]}):t.jsxs(t.Fragment,{children:[Oe(!1),Ze(!1),yt(!1),Tt.filter(W=>!(W.cinematicOnly&&C)&&!(W.helmOnly&&w!=="helm")).map(W=>Ve(W,!1))]})}),!C&&t.jsxs("div",{style:{position:"fixed",left:"max(20px, 3.2vw)",top:"calc(var(--og-top) + 18px)",zIndex:10,font:"600 10px/1 ui-monospace, Menlo, monospace",letterSpacing:"0.3em",color:"rgba(255,255,255,0.4)",textShadow:"0 1px 10px #000",transition:"top .7s cubic-bezier(.6,0,.2,1)",...we,pointerEvents:"none"},children:[a?`SHOT ${String(o+1).padStart(2,"0")} / ${String(n).padStart(2,"0")}`:"FREE LOOK · DRAG ORBIT · WASD FLY · 2-FINGER / SHIFT-DRAG PAN · PINCH ZOOM · R HOME",t.jsx("span",{style:{opacity:.5},children:a?`  ·  ${Math.round(s)}s`:""})]}),C&&t.jsxs("div",{className:"og-instruments",children:[t.jsx("div",{ref:K,className:"og-objective"}),t.jsx("div",{ref:P,className:"og-readout"}),t.jsx("div",{ref:ae,className:"og-gauges"}),t.jsx("div",{className:"og-keys",children:w==="helm"?"W/S THROTTLE · A/D RUDDER · SHIFT FLANK · X ENGINE LATCH · B BURST · T WALK THE DECK · DRAG LOOK · R RECENTRE · V FREE CAM · WHEEL ZOOM":w==="sub"?"W/S THROTTLE · A/D RUDDER · SPACE RISE · C DIVE · SHIFT FLANK · X LATCH · F SURFACE · P PERISCOPE · DRAG LOOK · R RECENTRE · V FREE CAM":z==="zoro"?"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J ONIGIRI · U TATSUMAKI · K YAKKODORI · L SANZEN · G FLASH · H ASURA · DRAG ORBIT":"WASD MOVE · SHIFT RUN · SPACE JUMP · T TAKE THE WHEEL · J PISTOL · U GATLING · K BAZOOKA · L GIGANT · G ROCKET · H HAKI · N GEAR 2 · I BALLOON · DRAG ORBIT"})]}),C&&t.jsx("div",{ref:H,className:"og-banner"}),p&&t.jsx("div",{ref:ee,style:{position:"fixed",left:"max(20px, 3.2vw)",bottom:"calc(var(--og-bottom) + 96px)",zIndex:14,font:"500 10px/1 ui-monospace, Menlo, monospace",color:"#7fe0a0",background:x0,padding:"5px 8px",borderRadius:3,pointerEvents:"none"}})]}),t.jsx("style",{children:`
      ...
      `})]})}const Ee=168,Jn=1950,or={x:0,z:340},it={sea:"rgba(8,10,22,0.72)",ring:"#57506a",land:"#2e2836",skull:"#8a7358",fairway:"rgba(160,200,255,0.12)",gate:"#e8402a",port:"#f0ad50",rear:"#8fd4f2",whirl:"rgba(140,170,235,0.55)",you:"#ffe6a0"},At=e=>(e-or.x)/Jn*(Ee/2)+Ee/2,Ot=e=>(e-or.z)/Jn*(Ee/2)+Ee/2,Xt=e=>e/Jn*(Ee/2);function E0(e,o){e.save(),e.scale(o,o),e.clearRect(0,0,Ee,Ee),e.fillStyle=it.sea,e.fillRect(0,0,Ee,Ee),e.fillStyle=it.fairway,e.fillRect(At(-Vo.halfWidth),0,Xt(Vo.halfWidth*2),Ee),e.strokeStyle=it.ring,e.lineWidth=Xt(ft*.34),e.beginPath(),e.arc(At(de.x),Ot(de.z),Xt(ft),Math.PI*.34,Math.PI*.66,!0),e.stroke(),e.fillStyle=it.skull,e.beginPath(),e.ellipse(At(L.x),Ot(L.z),Xt(L.r*L.squash[0]),Xt(L.r*L.squash[2]),0,0,Math.PI*2),e.fill(),e.strokeStyle=it.gate,e.lineWidth=2;for(const[s,i]of[[Pt,1],[Jt,1.5]])e.beginPath(),e.moveTo(At(-95*N*i),Ot(s)),e.lineTo(At(95*N*i),Ot(s)),e.stroke();e.strokeStyle=it.whirl,e.lineWidth=1;for(const s of _e)e.beginPath(),e.arc(At(s.x),Ot(s.z),Xt(s.r),0,Math.PI*2),e.stroke();const n=(s,i,a,c=2.6)=>{e.fillStyle=a,e.beginPath(),e.arc(At(s),Ot(i),c,0,Math.PI*2),e.fill()};n(Q.x,Q.z,it.port),n(he.x,he.z,it.land,2),n(U.gate.x,U.gate.z,it.rear),e.restore()}function R0({mode:e}){const o=b.useRef(),n=b.useRef(),s=typeof window>"u"?1:Math.min(2,window.devicePixelRatio||1),i=b.useMemo(()=>{if(typeof document>"u")return null;const a=document.createElement("canvas");return a.width=Ee*s,a.height=Ee*s,E0(a.getContext("2d"),s),a},[s]);return b.useEffect(()=>{if(!n.current||!i)return;const a=n.current.getContext("2d");let c;const d=()=>{c=requestAnimationFrame(d);const h=y.helm;if(a.setTransform(1,0,0,1,0,0),a.clearRect(0,0,Ee*s,Ee*s),a.drawImage(i,0,0),!h||h.x===void 0)return;a.save(),a.scale(s,s);const p=At(h.x),g=Ot(h.z),f=h.sub&&h.depth>4;a.translate(p,g),h.heading!==void 0?(a.rotate(h.heading+Math.PI),a.beginPath(),a.moveTo(0,-5.5),a.lineTo(3.4,4),a.lineTo(0,2),a.lineTo(-3.4,4),a.closePath()):(a.beginPath(),a.arc(0,0,3,0,Math.PI*2)),a.fillStyle=f?"rgba(0,0,0,0)":it.you,a.strokeStyle=it.you,a.lineWidth=1.2,a.fill(),a.stroke(),a.restore(),f&&(a.save(),a.scale(s,s),a.fillStyle=it.rear,a.font="600 9px ui-monospace, SFMono-Regular, Menlo, monospace",a.textAlign="right",a.fillText(`${Math.round(h.depth)}m DOWN`,Ee-6,Ee-6),a.restore())};return d(),()=>cancelAnimationFrame(c)},[i,s,e]),e==="off"?null:t.jsxs("div",{className:"og-minimap",style:{position:"fixed",left:14,bottom:14,zIndex:12,width:Ee,height:Ee,borderRadius:4,overflow:"hidden",border:"1px solid rgba(255,255,255,0.16)",backdropFilter:"blur(9px)",WebkitBackdropFilter:"blur(9px)",pointerEvents:"none"},children:[t.jsx("canvas",{ref:n,width:Ee*s,height:Ee*s,style:{width:Ee,height:Ee,display:"block"}}),t.jsx("div",{style:{position:"absolute",top:4,left:6,font:"600 8px/1 ui-monospace, SFMono-Regular, Menlo, monospace",letterSpacing:"0.16em",color:"rgba(255,255,255,0.5)"},children:"鬼ヶ島"}),t.jsx("canvas",{ref:o,style:{display:"none"}})]})}const xa={low:{dpr:[1,1.1],shadows:!1,aa:!1,shadowMap:512,segments:110,shadowEvery:24,scene:"low"},mobile:{dpr:[1,1.5],shadows:!0,aa:!1,shadowMap:1024,segments:168,shadowEvery:16,scene:"mid"},high:{dpr:[1,2],shadows:!0,aa:!0,shadowMap:2048,segments:240,shadowEvery:10,scene:"high"}};function A0(){if(typeof navigator>"u")return"high";const e=navigator.hardwareConcurrency||4,o=typeof navigator.deviceMemory=="number"?navigator.deviceMemory:null;return/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&/Macintosh/.test(navigator.userAgent)?e<=3||o!==null&&o<=2?"low":"mobile":e<=2||o!==null&&o<=2?"low":"high"}const I0=null;function G0(){const e=b.useMemo(()=>!1,[]),[o]=b.useState(A0),[n,s]=b.useState("auto"),i=n==="auto"?o:n,a=xa[i]??xa.high;b.useEffect(()=>{ai(a.scene!=="low")},[a.scene]),b.useMemo(()=>va(a.scene),[a.scene]),b.useMemo(()=>El(),[]),b.useEffect(()=>Al(),[]);const c=b.useMemo(()=>typeof navigator>"u"?!1:typeof location<"u"&&new URLSearchParams(location.search).has("touch")?!0:navigator.maxTouchPoints>0,[]),[d,h]=b.useState(0),[p,g]=b.useState(!0),[f,m]=b.useState(!0),[l,u]=b.useState(1),[x,v]=b.useState(Hs[0]),[w,k]=b.useState(0),[z,r]=b.useState(qc),[M,F]=b.useState(()=>{if(typeof location>"u")return"off";const H=new URLSearchParams(location.search).get("mode");return H==="helm"||H==="sub"||H==="foot"?H:"off"}),[C,j]=b.useState(()=>typeof location>"u"?"luffy":new URLSearchParams(location.search).get("crew")==="zoro"?"zoro":"luffy");b.useEffect(()=>{if(!z)return;const H=()=>{xn(),gn(!0)};for(const te of["pointerdown","keydown","touchstart"])window.addEventListener(te,H,{once:!0,passive:!0});return()=>{for(const te of["pointerdown","keydown","touchstart"])window.removeEventListener(te,H)}},[z]);const R=b.useCallback(()=>{r(H=>{const te=!H;return te&&xn(),gn(te),te})},[]),[I,B]=b.useState(()=>typeof location<"u"&&new URLSearchParams(location.search).has("enter")),G=b.useCallback(H=>{z&&(xn(),gn(!0)),H==="off"?(y.jumpTo=0,g(!0),m(!0)):F(H),B(!0)},[z]),[$,q]=b.useState(!1),ee=b.useRef(!0);b.useEffect(()=>{if(Ya(),ee.current){ee.current=!1;return}q(!0);const H=setTimeout(()=>q(!1),210);return()=>clearTimeout(H)},[M]);const P=b.useCallback((H,te)=>{k(H),v(te)},[]),K=b.useCallback(()=>{si(),h(H=>H+1),g(!0),m(!0)},[]),ae=b.useMemo(()=>typeof location<"u"&&new URLSearchParams(location.search).has("dev"),[]);return e?t.jsx(b.Suspense,{fallback:null,children:t.jsx(I0,{})}):t.jsxs(t.Fragment,{children:[t.jsx(lr,{shadows:a.shadows,dpr:a.dpr,gl:{antialias:a.aa,powerPreference:"high-performance",toneMapping:gr,toneMappingExposure:vr,preserveDrawingBuffer:!0},camera:{fov:52,near:1,far:8200,position:[-190,26,880]},frameloop:"always",children:t.jsx(b.Suspense,{fallback:null,children:t.jsx(g0,{quality:a.scene,budget:a,onRails:f,playing:p,speed:l,onShot:P,mode:M,onMode:F,crew:C},d)})}),c&&I&&t.jsx(T0,{mode:M,crew:C}),I&&t.jsx(R0,{mode:M}),t.jsx("div",{"aria-hidden":!0,style:{position:"fixed",inset:0,zIndex:30,background:"#05040a",pointerEvents:"none",opacity:$?1:0,transition:$?"opacity .2s ease-in":"opacity .42s ease-out"}}),!I&&t.jsx(M0,{onPick:G}),t.jsx(y0,{veiled:!I,shot:x,shotIndex:w,shotCount:Hs.length,total:On,playing:p,onRails:f,speed:l,tier:i,override:n,dev:ae,onPlay:()=>g(H=>!H),onRailsToggle:()=>m(H=>!H),onSpeed:u,onQuality:s,onRestart:K,audio:z,onAudio:R,mode:M,onMode:F,crew:C,onCrew:j,stage:y})]})}export{G0 as default};
